...
String wherebfcs=null;
wherefgsbh=cf.GB2Uni(request.getParameter("wherefgsbh"));
wherebfcs=cf.GB2Uni(request.getParameter("wherebfcs"));
Connection conn  = null;
PreparedStatement ps=null;
String ls_sql=null;
try {
	conn=cf.getConnection();
	ls_sql="update dm_sgdjscsb set fgsbh=?,bfcs=?,bfjs=?,bfbl=?,sdlbfbl=?,kzbjjs=?,sfwgjs=?,sdljsfs=?,sfkclk=?,sfkgdyp=?,sfkyfgf=?,sfkzbj=?,sgdjbxg=?,sfhzjx=?,kzbjbl=? ";
