...
String sfksb=cf.GB2Uni(request.getParameter("sfksb"));
String sfkywx=cf.GB2Uni(request.getParameter("sfkywx"));
...
try {
	...
	ls_sql="insert into rs_gzb ( khzq,ssfgs,fxrq,ksrq,zzrq,qqts,lrr,lrsj,lrbm,bz,sfksb,sfkywx ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,? ) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,khzq);
	...
	ps.setString(9,lrbm);
	ps.setString(10,bz);
	ps.setString(11,sfksb);
	ps.setString(12,sfkywx);
