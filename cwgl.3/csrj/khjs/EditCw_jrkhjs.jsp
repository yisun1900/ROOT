...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="khpck" value="<%=khpck%>" size="20" maxlength="17" ></td>
  <td align="right"><font color="#FF0000">*</font>延期费</td>
  <td><input type="text" name="yqf" value="<%=yqf%>" size="20" maxlength="17" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="18%" align="right"><font color="#FF0000">*</font>结算优惠</td>
  <td width="32%"><input type="text" name="jsyh" value="<%=jsyh%>" size="20" maxlength="17" ></td>
