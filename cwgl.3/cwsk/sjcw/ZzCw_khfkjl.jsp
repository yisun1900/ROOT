...
%>
            ...
            <tr align="center"> 
              <td colspan="4"><p>
                <input type="hidden" name="khbh2"  value="<%=khbh%>" >
                <input type="button" name="bc" value="开始转帐" onClick="f_do(insertform)">
                <input type="reset"  value="重输" name="reset">
                </p>
                <p>
                  <input type="button" onClick="f_zc(insertform)" value="查看转出客户收款信息"  >
                  <input type="button" value="查看转入客户收款信息" onClick="f_zr(insertform)"  >
                  </p></td>
            </tr>
        </table>
</form>
...
{
	window.open("/khxx/ViewCwxx.jsp?khbh="+insertform.khbh2.value);
}

function f_zr(FormName)//参数FormName:Form的名称
{
	window.open("/khxx/ViewCwxx.jsp?khbh="+insertform.khbh.value);
}
