            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="cw_gdjkjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx in('A0','A1','F0','F1') and ssfgs='"+ssfgs+"' and cxbz='N' order by dwbh","");
%> 
                </select>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="radio" name="gdjsjd" value="0">未结算
                <input type="radio" name="gdjsjd" value="1">已结算
              </td>
              <td width="18%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                ...
                未删除 </td>
              <td width="18%" align="right">是否导出数据</td>
              <td width="32%"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="导出凭证" onClick="f_do(selectform,'dc')">
                <input type="button"  value="查看数据" onClick="f_do(selectform,'cx')" name="button">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (lx=='cx')
	{
		FormName.action="Cw_gdjkjlCxList.jsp";
	}
	else{
		FormName.action="ExpGdjkjl.jsp";
	}
	FormName.submit();
	return true;
}
