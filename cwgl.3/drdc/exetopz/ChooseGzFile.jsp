...
<body bgcolor="#FFFFFF">
<CENTER><B>工资单－导入</B><BR><HR>
<form method="post" action="DisChooseGzFile.jsp" name="loadform" enctype="multipart/form-data" >
...
%></td>
      ...
      <tr> 
        ...
        <td width="85%" height="49">科 目代 码 
          <select name="kmdm" style="FONT-SIZE:13PX;WIDTH:340PX" >
            <option value=""></option>
            <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		cf.selectItem(out,"select kmdm,kmdm||' '||kmmc from cw_jzkmdm order by fgsbh,kmdm","211.02.01");
	}
	else{
		cf.selectItem(out,"select kmdm,kmdm||' '||kmmc from cw_jzkmdm where fgsbh='"+ssfgs+"' order by kmdm","211.02.01");
	}
%> 
          </select>
        </td>
      ...
      <tr> 
        ...
        <td width="85%" height="48">凭 证摘 要 
          <input type="text" name="fexp" maxlength="254" size="47" value="月份工资">
        </td>
      </tr>
      <tr>
        <td width="15%" height="45" align="right">&nbsp;</td>
