...
%> 
<form method="post" action="SaveChooseJzfkFile.jsp" name="editform" target="_blank">
  <div align="center"><b>家装计提返款－导入（科目代码：<%=kmdm%>） <BR>
    （注意：数据从第2行开始，[序号]第1列，[档案号]第2列，[客户姓名]第3列，[金额]第4列）</b></div>
