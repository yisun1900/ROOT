...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="14%" align="right">客户编号</td>
              <td width="36%"> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="qyrq" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.qyrq2)=="") {
		alert("请输入[签约日期]！");
		FormName.qyrq2.focus();
		return false;
	}
	...
	FormName.action="Crm_khxxSghtList.jsp";
	FormName.submit();
	return true;
}
