...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_chbgfjl.bgfjlh,cw_chbgfjl.khbh,crm_khxx.khxm,sq_sgd.sgdmc,cw_chbgfjl.sgbz,gdjsjdmc,cw_chbgfjl.bfrq,cw_chbgfjl.bfbl||'%',cw_chbgfjl.bfje,TO_CHAR(cw_chbgfjl.qye),TO_CHAR(cw_chbgfjl.zhhtzcbj),TO_CHAR(cw_chbgfjl.ssk),TO_CHAR(cw_chbgfjl.yfgf),cw_chbgfjl.lrr,cw_chbgfjl.lrsj,cw_chbgfjl.shr,cw_chbgfjl.shsj,dwmc,cw_chbgfjl.bz  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by cw_chbgfjl.shsj desc";
    pageObj.sql=ls_sql;
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Cw_chbgfjlXgShList.jsp","","","");
//	pageObj.setPageRow(10);//设置每页显示记录数
/*
//设置显示列
	String[] disColName={"jsjlh","cw_chbgfjl_khbh","sq_sgd_sgdmc","cw_chbgfjl_sgbz","cw_chbgfjl_jsrq","cw_chbgfjl_jsbl","cw_chbgfjl_jsje","cw_chbgfjl_clf","cw_chbgfjl_gdyp","cw_chbgfjl_sjbk","cw_chbgfjl_lx","cw_chbgfjl_lrr","cw_chbgfjl_lrsj","cw_chbgfjl_lrbm","cw_chbgfjl_bz","cw_chbgfjl_jsjs","cw_chbgfjl_htje","cw_chbgfjl_zjxje","cw_chbgfjl_jsjsze"};
