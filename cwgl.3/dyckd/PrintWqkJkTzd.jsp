...
<table width="100%" border="0">
  ...
  <tr>
    <td><div align="center"><b><font size="6" face="楷体_GB2312">尾期款交款通知单</font></b></div></td>
  </tr>
</table>
<table border="1" width="100%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 18px'>
  <tr height="35"> 
    <td width="12%" height="41" align="center"><b>客户姓名</b></td>
    <td width="30%" align="center"><b><%=khxm%></b></td>
    <td width="11%" align="center"><b>合同号</b></td>
    <td width="21%" align="center"><%=hth%></td>
    <td width="10%" align="center"><b>工长</b></td>
  ...
  <tr height="35">
    ...
    <td colspan="4" align="center"><%=df.format(sssqk)%></td>
  </tr>
  <tr height="35">
    <td height="16" colspan="2" align="center">(11)已收中期款</td>
    <td colspan="4" align="center"><%=df.format(sszqk)%></td>
  </tr>
  <tr height="35">
    <td height="16" colspan="2" align="center">(12)应收尾期款=(9)-(10)-(11)</td>
    <td colspan="4" align="center"><%=df.format(yswqk)%></td>
  </tr>
</table>
<p align="left">
