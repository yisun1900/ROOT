...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>直接成本管理费比例</td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">①材料费</span></td>
  <td><input type="text" name="sgcbclf" value="<%=sgcbclf%>" size="20" maxlength="17" >  </td>
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">②人工费</span></td>
  <td><input type="text" name="sgcbrgf" value="<%=sgcbrgf%>" size="20" maxlength="17" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">实收设计费</span></td>
  <td><input type="text" name="sssjf" value="<%=sssjf%>" size="20" maxlength="17" >  </td>
  <td align="right"><font color="#FF0000">*</font>设计费提成比例</td>
  <td><input type="text" name="sjfbl" value="<%=sjfbl%>" size="10" maxlength="9" >
    % </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">补设计费提成</span></td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">补施工组长远程费</span></td>
  <td colspan="3"><input type="text" name="bycf" value="<%=bycf%>" size="20" maxlength="17" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">施工组长成本合计金额</span></td>
  <td colspan="3"><input type="text" name="cbhjje" value="<%=cbhjje%>" size="20" maxlength="17" >
      <BR>
      <strong>施工组长成本合计金额=直接成本管理费+水电路增加直接成本费+合同外项目增加直接成本费+施工成本人工费 <BR>
        <BR>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+补设计费提成+空气治理协调费+补保洁费+补其他费用+补施工组长水电成本+补施工组长远程费 </strong></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>扣风险保证金比例</td>
  <td><input type="text" name="kfxbzjbl" value="<%=kfxbzjbl%>" size="10" maxlength="9" onChange="f_jsje(insertform)">
    % </td>
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">扣风险保证金</span></td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE4">实际支付施工组长金额</span></td>
  <td colspan="3"><input type="text" name="sjzfe" value="<%=sjzfe%>" size="20" maxlength="17" >
      <BR>
      <strong>实际支付施工组长金额=施工组长成本合计金额-扣工地质保金-扣风险保证金-施工组长信息返回-材料成本 <BR>
