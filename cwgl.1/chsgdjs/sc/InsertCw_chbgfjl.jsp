...
try {
	...
	bfje=cf.round(ssk*0.35*bfbl/100-zhhtzcbj,2);
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><select name="lx" style="FONT-SIZE:12PX;WIDTH:152PX">
      <%
	cf.selectItem(out,"select gdjsjd,gdjsjdmc from dm_gdjsjd where gdjsjd='H'","");
%>
    </select></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="bfje" value="<%=bfje%>" size="20" maxlength="17" readonly>
    <span class="STYLE5">拨付金额=实收×35％×拨付比例－橱柜木门</span></td>
  </tr>
...
{
	var bfje=FormName.ssk.value*0.35*FormName.bfbl.value/100.0-FormName.zhhtzcbj.value*1.0 ;
	bfje=round(bfje,2);
