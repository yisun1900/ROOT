...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_chbgfjlXgShList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="cw_chbgfjl_bgfjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">类型</td> 
  <td width="32%"><select name="cw_chbgfjl_lx" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="cw_chbgfjl_bfrq" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到 </td>
  <td><input type="text" name="cw_chbgfjl_bfrq2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入时间 从</td> 
  <td width="32%"><input type="text" name="cw_chbgfjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="cw_chbgfjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入人</td>
  <td><input type="text" name="cw_chbgfjl_lrr" size="20" maxlength="20" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
...
{
	if(!(isDatetime(FormName.cw_chbgfjl_bfrq, "拨付日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_chbgfjl_bfrq2, "拨付日期"))) {
		return false;
	}

	if(!(isDatetime(FormName.cw_chbgfjl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_chbgfjl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
