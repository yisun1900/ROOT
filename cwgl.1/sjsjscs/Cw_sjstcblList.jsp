...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sjstcbl.xh,cw_sjstcbl.fdmc,cw_sjstcbl.qd,cw_sjstcbl.zd,cw_sjstcbl.tcbfb, DECODE(cw_sjstcbl.qdlx,'1','非市场部家装','2','市场部家装','3','工装'),cw_sjstcbl.fgsbh,sq_dwxx.dwmc  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Cw_sjstcblList.jsp?"};//按钮单击调用的网页，可以增加参数
