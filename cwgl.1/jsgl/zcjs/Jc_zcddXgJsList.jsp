...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgJsList.jsp","","","XgJsJc_zcdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJs.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">主材订单处理－－修改厂商结算</font></B>
</CENTER>
<%
	pageObj.out=out;
