...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_jrbgf.jsjlh,gdjsjdmc, DECODE(cw_jrbgf.clzt,'1','结算','2','审批同意','3','审批不同意'),crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,sgdmc,cw_jrbgf.rgfbfb||'%',TO_CHAR(cw_jrbgf.yfrgf),cw_jrbgf.bcrgf,cw_jrbgf.spr,cw_jrbgf.spsj,cw_jrbgf.spyj,cw_jrbgf.jsrq,cw_jrbgf.khbh,TO_CHAR(cw_jrbgf.ysglk),cw_jrbgf.lrr,cw_jrbgf.lrsj,dwmc,cw_jrbgf.bz ";
	ls_sql+=" FROM crm_khxx,cw_jrbgf,dm_gdjsjd,sq_sgd,sq_dwxx  ";
