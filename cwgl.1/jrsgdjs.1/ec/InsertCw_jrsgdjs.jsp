...
try {
	...
	bcrgf=cf.round(zqgczjf*rgfbfb/100-yfrgf,0);
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="yfrgf" value="<%=yfrgf%>" size="20" maxlength="17" readonly></td>
</tr>
<tr bgcolor="#FFFFFF">
...
{  
	var bcrgf=FormName.ysglk.value/100*FormName.rgfbfb.value-FormName.yfrgf.value*1.0;
