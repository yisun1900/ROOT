...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%">合同开工日期</td>
              <td width="32%"><%=kgrq%></td>
              <td align="right" width="18%">合同竣工日期</td>
              <td width="32%"><%=jgrq%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%">实际开工日期</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">参加公司促销活动</font></td>
              <td colspan="3"> 
                <input type="text" name="cxhdbm" value="<%=cxhdbm%>" size="73" maxlength="17" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">参加小区促销活动</font></td>
              <td colspan="3"> 
                <input type="text" name="cxhdbmxq" value="<%=cxhdbmxq%>" size="73" maxlength="17" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">参加展会促销活动</font></td>
              <td colspan="3"> 
                <input type="text" name="cxhdbmzh" value="<%=cxhdbmzh%>" size="73" maxlength="17" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">施工队</font></td>
              <td width="32%"> 
...
%> 
              ...
              <td align="right" width="18%"><font color="#0000FF">客户类型</font></td>
              <td width="32%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">折扣率</font></td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%"><font color="#0000FF">结算类型</font></td>
              <td width="32%"> 
                <select name="jslx" style="FONT-SIZE:12PX;WIDTH:152PX" >
                  <option value="1">完工结算</option>
                </select>
              </td>
              <td align="right" width="18%"><font color="#0000FF">结算单位</font></td>
              <td width="32%"> 
