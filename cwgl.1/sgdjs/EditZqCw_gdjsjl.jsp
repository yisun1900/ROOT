...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                ...
                &nbsp;&nbsp<b>应付工费=</b><font color="#003399">实际收款额×38% </font> </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF" align="center"> 
              <td colspan="4"><b>应拨工费=</b><font color="#003399">应付工费-材料费+标准材料费比率-配送工具工服费-运输费-立邦成本-其它扣款-前期已拨工费</font></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_jsglf(FormName)//参数FormName:Form的名称
{
	...
	sqgz=FormName.gdjskze.value-FormName.clf.value*1.0-FormName.psgjgff.value-FormName.ysf.value;
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditZqCw_gdjsjl.jsp";
	FormName.submit();
	return true;
}
