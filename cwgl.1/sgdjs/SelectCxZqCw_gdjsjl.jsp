...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_gdjsjlCxZqList.jsp" name="selectform">
<div align="center">施工队中期结算--查询</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"> 客户编号 </td>
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_khbh" size="20" maxlength="20" >
      </td>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_gdjsjlh" size="20" maxlength="9" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="19%">家装标志</td>
      <td width="31%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"> 提点基数 </td>
      <td width="33%"> 
...
%> 
      ...
      <td align="right" width="19%"> 管理费提点 </td>
      <td width="31%"> 
        <input type="text" name="cw_gdjsjl_glftd" size="20" maxlength="17" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">结算部结算人</td>
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_jsr" size="20" maxlength="20" >
      </td>
      <td align="right" width="19%">结算单位</td>
      <td width="31%"> 
        <select name="cw_gdjsjl_jsdw" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_jssj" size="20" maxlength="10" >
      </td>
      <td align="right" width="19%">到</td>
      <td width="31%"> 
        <input type="text" name="cw_gdjsjl_jssj2" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">审批时间 从</td>
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_spsj" size="20" maxlength="10" >
      </td>
      <td align="right" width="19%">到</td>
      <td width="31%"> 
        <input type="text" name="cw_gdjsjl_spsj2" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">审批人</td>
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_spr" size="20" maxlength="20" >
      </td>
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_cwjssj" size="20" maxlength="10" >
      </td>
      <td align="right" width="19%">到</td>
      <td width="31%"> 
        <input type="text" name="cw_gdjsjl_cwjssj2" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"> 财务结算人 </td>
      <td width="33%"> 
        <input type="text" name="cw_gdjsjl_cwjsr" size="20" maxlength="20" >
      </td>
      <td align="right" width="19%">结算进度 </td>
      <td width="31%"> 
        <select name="cw_gdjsjl_jsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
      ...
      <td align="right" width="19%">结算类型</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">是否已拨工费</td>
      <td colspan="3"> 
        <input type="radio" name="sfybgf" value="1">
        未拨工费 
        <input type="radio" name="sfybgf" value="2">
        拨部分工费 
        <input type="radio" name="sfybgf" value="3">
        拨完工费 </td>
    </tr>
    <tr align="center"> 
      <td colspan="4"> 
