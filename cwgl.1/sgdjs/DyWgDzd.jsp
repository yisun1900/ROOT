...
try {
	...
	ls_sql="select fgsbh,jzbz,khxm,fwdz,lxfs,sjs,hth,qyrq,crm_khxx.dwbh,dwmc,crm_khxx.sgd,sgdmc,zjxm,kgrq,sjkgrq,jgrq,sjjgrq,sjwjrq";
...
<table width="100%" border="1" style="FONT-SIZE:14" cellpadding="1" cellspacing="0">
  ...
  <tr> 
    ...
    <td colspan="2" width="34%">客户名：<%=khbh%></td>
  </tr>
  <tr> 
    <td colspan="2">完工造价：<%=zhwgzj%></td>
  ...
  <tr> 
    <td colspan="6"><b>应拨工费：<%=sqgz%>元，其中：</b></td>
  </tr>
</table>
<table width="100%" border="0" style="FONT-SIZE:14" cellpadding="0" cellspacing="0">
 ...
 <%
	...
	while (rs.next())
	{
		...
		%>
        <tr> 
          <td width="20%" align="center"><%=jkblsj%></td>
          <td width="14%"><%=jkje%></td>
        </tr>
		<%
	}
...
<table width="100%" border="1" style="FONT-SIZE:14" cellpadding="1" cellspacing="0">
  <tr> 
    <td colspan="6" align="center" height="25"><b>远 程 费 拨 款</b></td>
  </tr>
 <%
	alljkje=0;
	ls_sql="select jklxmc,jkblsj,jkje";
	...
	while (rs.next())
	{
		...
		%>
		  <tr> 
			<td colspan="3">付款日期：<%=jkblsj%></td>
			
    <td colspan="3" width="83%">付款金额（元）：<%=jkje%></td>
		  </tr>
		<%
	}
	rs.close();
...
%>
	<tr> 
	  <td colspan="6">已拨远程费小计：<%=alljkje%>元</td>
	</tr>
  <tr align="center"> 
    <td colspan="6" height="29"><b>工 程 增 项 奖 励 款</b></td>
  </tr>
 <%
	alljkje=0;
	ls_sql="select jklxmc,jkblsj,jkje";
...
%>
	<tr> 
	  <td colspan="6">已拨增项奖励小计：<%=alljkje%>元</td>
	</tr>
</table>
</body>
</html>
