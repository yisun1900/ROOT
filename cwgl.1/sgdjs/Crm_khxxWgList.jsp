...
<%
    ...
    ls_sql+=" where (crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)) and (gdjsjd='2' or gdjsjd is null)";//0：未结算；1：完工结算；2：中期结算
    ls_sql+=wheresql;
    ls_sql+=" order by lrsj desc";
	//out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","InsertWgCw_gdjsjl.jsp","");
