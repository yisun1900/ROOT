...
<CENTER >
  <B><font size="3">二期款未交（开工后15天）</font></B>
</CENTER>
...
<%
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.wdzgce,crm_khxx.qye,NVL(crm_khxx.zjxje,0),NVL(crm_khxx.cwsfke,0),NVL2(cwjzkfkcs,cwjzkfkcs||'期','无收款'),jzkfksj,sjkgrq,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,c.gcyszxmmc ybysxmbm,zkl,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.fwmj,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_gcyszxmbm c";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+)";
    ls_sql+=" and crm_khxx.ybysxmbm=c.gcyszxmbm(+) ";
    ls_sql+=" and crm_khxx.zt='2' ";
    ls_sql+=" and SYSDATE-crm_khxx.sjkgrq>15";
    ls_sql+=" and (crm_khxx.cwjzkfkcs in(0,1) OR crm_khxx.cwjzkfkcs is null)";
    ls_sql+=wheresql;
    ls_sql+=" order by sjkgrq";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
...
<CENTER >
  <B><font size="3">工地未结算（完工后30天内）</font></B>
</CENTER>
...
<%
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.wdzgce,crm_khxx.qye,NVL(crm_khxx.zjxje,0),NVL(crm_khxx.cwsfke,0),NVL2(cwjzkfkcs,cwjzkfkcs||'期','无收款'),jzkfksj,sjjgrq,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,c.gcyszxmmc ybysxmbm,zkl,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.fwmj,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_gcyszxmbm c";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+)";
    ls_sql+=" and crm_khxx.ybysxmbm=c.gcyszxmbm(+) ";
    ls_sql+=" and crm_khxx.zt='2' ";
    ls_sql+=" and SYSDATE-crm_khxx.sjjgrq>30";
    ls_sql+=" and crm_khxx.khjsbz='N'";
    ls_sql+=wheresql;
...
<CENTER >
  <B><font size="3">工人未结算（客户结帐后15天内）</font></B>
</CENTER>
...
<%
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.wdzgce,crm_khxx.qye,NVL(crm_khxx.zjxje,0),NVL(crm_khxx.cwsfke,0),NVL2(cwjzkfkcs,cwjzkfkcs||'期','无收款'),jzkfksj,cw_gdsgjsd.jsrq,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,c.gcyszxmmc ybysxmbm,zkl,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.fwmj,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_gcyszxmbm c,cw_gdsgjsd";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+)";
    ls_sql+=" and crm_khxx.ybysxmbm=c.gcyszxmbm(+) ";
    ls_sql+=" and crm_khxx.zt='2' ";
    ls_sql+=" and crm_khxx.khbh=cw_gdsgjsd.khbh";
    ls_sql+=" and SYSDATE-cw_gdsgjsd.jsrq>15";
    ls_sql+=" and crm_khxx.gcjdbm!='5'";
    ls_sql+=wheresql;
    ls_sql+=" order by cw_gdsgjsd.jsrq";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxQkList.jsp","SelectQkCrm_khxx.jsp","","");
