...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,DECODE(crm_khxx.kgzbz,'Y','充卡','N','未充卡'),hth,khxm,fwdz,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>'),qyrq,dwmc,sgdmc";
...
//    ls_sql+=" and crm_khxx.gcjdbm!='5' ";
    //ls_sql+=" and crm_khxx.kgzbz='N'";
    ls_sql+=wheresql;
	ls_sql+=" order by lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertCw_khfqdj.jsp");
