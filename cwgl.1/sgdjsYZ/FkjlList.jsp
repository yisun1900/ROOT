...
<%
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,sgdmc,crm_khxx.khxm,fkze,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,xjlxmc,DECODE(cfspbz,'2','未审批','3','审批通过','4','审批未通过'),DECODE(kp_xjgdjl.kpbz,'N','未考评','Y','已考评'),DECODE(kp_xjgdjl.jsbz,'N','未结算','Y','已结算'),kp_xjgdjl.jsjlh,kp_xjgdjl.bz ";
    ...
    ls_sql+=" and kp_xjgdjl.jsjlh='"+jsjlh+"' ";
