...
try {
	...
	ls_sql="select cwjssm,cwjsr,cwjssj,dejsje,wxjbfb,wxj,spr,spsj,spjl,spyj,khbh,khjskze,khsskze,sjcb,tdjs,glftd,ksdf,bk,bz,tdjsje,gckk,sjsfy,sgdfy,zjfy,gsfy,qtfy,sj,glf,jkje,zgclf,kqtk,fakuan,kwxf,clf ";
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%">扣维修费</td>
              <td width="31%"> 
                <input type="text" name="kwxf" value="<%=kwxf%>" size="20" maxlength="17" >
              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%">借款金额</td>
              <td width="31%"> 
                <input type="text" name="jkje" value="<%=jkje%>" size="20" maxlength="17" >
              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input name="ksdf" type="text" id="ksdf" value="<%=ksdf%>" size="20" maxlength="17" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <p> 
                  ...
                  <input type="button" value="查看结算信息" onClick="f_ck(insertform)" name="ck" >
