...
String[] dzjssjftc=request.getParameterValues("dzjssjftc");
String[] dzzxftcbl=request.getParameterValues("dzzxftcbl");
String[] dzqyzxtc=request.getParameterValues("dzqyzxtc");
String[] dzjszxtc=request.getParameterValues("dzjszxtc");
...
String[] sjsjssjftc=request.getParameterValues("sjsjssjftc");
String[] sjszxftcbl=request.getParameterValues("sjszxftcbl");
String[] sjsqyzxtc=request.getParameterValues("sjsqyzxtc");
String[] sjsjszxtc=request.getParameterValues("sjsjszxtc");
String[] sjsycftcbl=request.getParameterValues("sjsycftcbl");
String[] sjsycftc=request.getParameterValues("sjsycftc");
...
String[] zjjszxtc=request.getParameterValues("zjjszxtc");
String[] zjycftcbl=request.getParameterValues("zjycftcbl");
String[] zjycftc=request.getParameterValues("zjycftc");
...
String[] clyjszxtc=request.getParameterValues("clyjszxtc");
...
String[] xqzgjszxtc=request.getParameterValues("xqzgjszxtc");
...
String[] xqzzjszxtc=request.getParameterValues("xqzzjszxtc");
...
String[] xqzyjszxtc=request.getParameterValues("xqzyjszxtc");
...
String[] wlyxzgjszxtc=request.getParameterValues("wlyxzgjszxtc");
...
String[] wztgyjszxtc=request.getParameterValues("wztgyjszxtc");
...
*/
		...
		ps.setString(34,dzjssjftc[i]);
		ps.setString(35,dzzxftcbl[i]);
		ps.setString(36,dzqyzxtc[i]);
		ps.setString(37,dzjszxtc[i]);
		...
		ps.setString(55,sjsjssjftc[i]);
		ps.setString(56,sjszxftcbl[i]);
		ps.setString(57,sjsqyzxtc[i]);
		ps.setString(58,sjsjszxtc[i]);
		ps.setString(59,sjsycftcbl[i]);
		ps.setString(60,sjsycftc[i]);
		ps.setString(61,sjstchj[i]);

		ps.setString(62,zjzxftcbl[i]);
		ps.setString(63,zjqyzxtc[i]);
		ps.setString(64,zjjszxtc[i]);
		ps.setString(65,zjycftcbl[i]);
		ps.setString(66,zjycftc[i]);
		...
		ps.setString(107,wztgyjszxtc[i]);
