...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_jrtcphCxList.jsp" name="selectform">
<div align="center">提成－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<INPUT type="radio" name="cw_jrtcph_clzt" value="1">结算
	<INPUT type="radio" name="cw_jrtcph_clzt" value="2">审批同意
	<INPUT type="radio" name="cw_jrtcph_clzt" value="3">审批不同意
  </td>
  </tr>
<tr align="center"> 
  <td colspan="4"> 
