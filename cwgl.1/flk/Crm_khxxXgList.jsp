...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_cflkjl.jlh,hth,khxm,fwdz,DECODE(crm_khxx.kgzbz,'Y','充卡','N','未充卡'),cw_cflkjl.clfbfb||'%',cw_cflkjl.clf+cw_cflkjl.fwmjcz+cw_cflkjl.zccz,cw_cflkjl.czkh,cw_cflkjl.clf,cw_cflkjl.cfje,cw_cflkjl.fwmjcz,cw_cflkjl.zccz,dwmc,sjs,cw_cflkjl.lrr,cw_cflkjl.lrsj,cw_cflkjl.bz";
	ls_sql+=" FROM crm_khxx,sq_dwxx,cw_cflkjl  ";
    ls_sql+=" where crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.khbh=cw_cflkjl.khbh";
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by cw_cflkjl.lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgList.jsp","","","EditXgCrm_khxx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteFlk.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="14%">房屋地址</td>
	<td  width="4%">充卡状态</td>
	<td  width="4%">材料费百分比</td>
	<td  width="5%">充值总额</td>
	<td  width="5%">充值卡号</td>
	<td  width="5%">材料费</td>
	<td  width="5%">拆除金额</td>
	<td  width="5%">地锢金额</td>
	<td  width="5%">工长套餐主材充值</td>
	<td  width="7%">签约店面</td>
	<td  width="3%">设计师</td>
	<td  width="3%">录入人</td>
	<td  width="5%">录入时间</td>
