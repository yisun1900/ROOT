...
//设置按钮参数
	String[] buttonName={"扣款"};//按钮的显示名称
	String[] buttonLink={"SaveCzkk.jsp?"};//按钮单击调用的网页，可以增加参数
