...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">退补货序号</td>
              <td><input type="text" name="zjxxh" size="20" maxlength="9" ></td>
              <td align="right">录入人</td>
              <td><input type="text" name="lrr" size="20" maxlength="20" value="" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">退补货发生时间 从</td>
              <td><input type="text" name="fssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="fssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">发生阶段</td>
...
%>
              ...
              <td align="right"><strong><font color="#FF0000">客户结算标志</font></strong></td>
              <td><input type="radio" name="khjsbz" value="1" >未结算
			  <input type="radio" name="khjsbz" value="2">结算</td>
            </tr>
...
{
	if(!(isDatetime(FormName.fssj, "退补货发生时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.fssj2, "退补货发生时间"))) {
		return false;
	}
	...
	FormName.action="Crm_zjxdjCxList.jsp";
