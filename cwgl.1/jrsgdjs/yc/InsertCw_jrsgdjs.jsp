...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>扣其它款</td>
  <td><input type="text" name="kqtk" value="0" size="20" maxlength="17" onChange="calValue(insertform)"></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="kqtksm" value="" size="74" maxlength="200" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><span class="STYLE6">本次付款合计</span></td>
  <td colspan="3"><input type="text" name="bcfkhj" value="<%=cf.round(bcfkhj,0)%>" size="20" maxlength="17" readonly>
