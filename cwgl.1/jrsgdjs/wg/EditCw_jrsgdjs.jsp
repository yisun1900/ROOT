...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="kzbjbl" size="10" maxlength="9"  value="<%=kzbjbl%>" readonly>
    %</td>
  <td align="right" width="18%"><font color="#FF0000">*</font><span class="STYLE6">扣质保金</span></td> 
  <td width="32%"><input type="text" name="kzbj" size="20" maxlength="17"  value="<%=kzbj%>" readonly></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"> 
    ...
    <span class="STYLE6">本次付款合计</span><span class="STYLE6">=本次应付人工费-公司辅料-配送辅料-扣质保金-场地保险-人员保险-赔偿款-罚款-扣其它款-磁砖补货</span> </td>
  </tr>
<tr bgcolor="#FFFFFF">
...
{  
	...
	var bcfkhj=FormName.bcrgf.value*1.0-FormName.gsfl.value*1.0-FormName.psfl.value*1.0-FormName.kzbj.value*1.0-FormName.kqtk.value*1.0-FormName.fk.value*1.0-FormName.bx.value*1.0-FormName.rybx.value*1.0-FormName.pck.value*1.0-FormName.czbh.value*1.0;
