...
try {
	...
	ls_sql="select jsjlh,khbh,sgd,sgbz,jsrq,ysglk,rgfbfb,yfrgf,bcrgf,lrr,lrsj,lrbm,bz ";
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">已付人工费</td> 
  <td width="32%"> 
    <input type="text" name="yfrgf" size="20" maxlength="17"  value="<%=yfrgf%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
