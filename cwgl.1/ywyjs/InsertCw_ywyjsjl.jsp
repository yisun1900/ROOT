...
try {
	...
	if (khbh!=null)
	{
		...
		{
			ls_sql="SELECT hth,khxm,fwdz,sgdmc,zjxm,qyrq,sjjgrq,tdsj,qye,sfke,ywyqdjsbl,ywyqdjsje,ysgcjdmc,DECODE(ywyjsbz,'0','未结算','1','签单结算','2','完工结算') ywyjsbz,DECODE(crm_khxx.zt,'2','家装客户','3','退单客户','4','非家装客户','5','设计客户') zt";
...
<DIV align="center">业务员结算（结算记录号：<%=jsjlh%>）</DIV>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="30%"> 
        <input type="text" name="ywy" size="20" maxlength="20"  value="<%=ywy%>" readonly>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertCw_ywyjsjl.jsp";
	FormName.submit();
...
function f_ksjs(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="";
	FormName.action="EditCw_ywyjsjl.jsp";
	FormName.submit();
	return true;
}
