...
try {
	...
	ls_sql="select fgsbh,dwbh,sjsbh,ywy,sjfw,sjfw2,xdsskbfb,tcze ,lrr,lrsj,lrbm,bz ";
	...
	while (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>"  align="center">
			<td><A HREF="EditCw_ywyjsmx.jsp?jsjlh=<%=jsjlh%>&khbh=<%=khbh%>" target="_blank">扣款</A></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditCw_ywyjsjl.jsp";
	FormName.submit();
	return true;
}
...
function f_tlsbl(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="_blank";
	FormName.action="EndCw_ywyjsjl.jsp";
	FormName.submit();
	return true;
}
