...
<form method="post" action="" name="selectform" target="_back">
  <div align="center"><b>业务员结算－－增减其它费用（结算记录号：<%=jsjlh%>）</b></div>
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2" >
	...
	ls_sql=" SELECT sjsxmbm,cw_ywyjszjfy.sjsxmmc,cw_ywyqtfymx.zjbfb,cw_ywyqtfymx.zjje,cw_ywyqtfymx.bz";
	ls_sql+=" FROM cw_ywyjszjfy,cw_ywyqtfymx";
	ls_sql+=" where cw_ywyjszjfy.sjsxmmc=cw_ywyqtfymx.sjsxmmc(+) and cw_ywyqtfymx.jsjlh(+)='"+jsjlh+"' and cw_ywyqtfymx.khbh(+)='"+khbh+"'";
...
*/
	FormName.action="SaveEditCw_ywyjsmx.jsp";
	FormName.submit();
	return true;
}
