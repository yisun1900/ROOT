...
//定 额结 算：结算款＝   定额结算金额－税金－材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 －需补材料款 
	...
	gdjskze=tdjsje-glf-sj-clf-zgclf-sgdfy-ksdf+bk-sgdfk;
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td colspan="4"> <font color="#0000FF">工队结算款总额</font>＝提点基数－管理费－税金－材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <p> 
                  ...
                  <input type="button" value="查看结算信息" onClick="window.open('/cwgl/sgdjs/ViewCw_gdjsjl.jsp?gdjsjlh=<%=gdjsjlh%>')" name="ck" disabled>
