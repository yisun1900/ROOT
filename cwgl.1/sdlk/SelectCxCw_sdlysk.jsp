...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sdlyskCxList.jsp" name="selectform">
<div align="center"> 查询水电路应收款</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="cw_sdlysk_lrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">水电路应收款</td> 
  <td width="32%"><input type="text" name="cw_sdlysk_sdlysk" size="20" maxlength="17" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从</td>
  <td><input type="text" name="cw_sdlysk_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="cw_sdlysk_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"> 
    <select name="cw_sdlysk_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
{
	if(!(isFloat(FormName.cw_sdlysk_sdlysk, "水电路应收款"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sdlysk_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sdlysk_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
