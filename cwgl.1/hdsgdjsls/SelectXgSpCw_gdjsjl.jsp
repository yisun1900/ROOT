...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队结算--修改审批</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Cw_gdjsjlXgSpList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"><select name="cw_gdjsjl_jsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value="2">结算审批</option>
  </select></td>
  <td width="15%"> 
    <div align="right">审批结论</div>  </td>
  <td width="35%"><%
	cf.radioToken(out, "cw_gdjsjl_spjl","3+通过&4+未通过","");
%></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td><div align="right">结算记录号</div></td>
  <td><input type="text" name="cw_gdjsjl_gdjsjlh" size="20" maxlength="9" ></td>
  <td><div align="right">付款标志</div></td>
  <td><select name="cw_gdjsjl_fkbz" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <%
