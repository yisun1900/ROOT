...
<form method="post" action="SaveInsertCw_gckkjl.jsp" name="insertform">
    ...
    <div align="right"></div></td>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="hidden" name="gdjsjlh" value="<%=gdjsjlh%>" size="20" readonly>
                <input type="hidden" name="kkjlh" value="<%=kkjlh%>" size="20" readonly>
                <input type="hidden" name="khbh" value="<%=khbh%>" size="20" readonly ></td>
            </tr>
          </table>
</form>
	  </div>
