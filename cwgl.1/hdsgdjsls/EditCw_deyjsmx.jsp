...
<table border="1" width="150%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td colspan="18" > 
		  <input type=button value='修改预结算' onClick="cf_submit(listform)" >
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%
	...
	//输出项目明细
	ls_sql="SELECT xmbh,xh,xmmc,cw_deyjsmx.jldwbm,jldwmc,sl,dwbjdj,dwbjje,cbdj,cbje,mll,mle,jsblxs,nbjsdj,nbjsje,gsmll,gsmlr,clfbfb,bjlx ";
...
%>	
  <tr bgcolor="#FFFFFF" align="center"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td colspan="18" > 
		  <input type=button value='修改预结算' onClick="cf_submit(listform)" name="jsblxs">
      </td>
  </tr>
</table>
</form>
...
{
	formName.action="SaveEditCw_deyjsmx.jsp";
	formName.submit();
	return true;
} 
//修改：自定义项目成本百分比
