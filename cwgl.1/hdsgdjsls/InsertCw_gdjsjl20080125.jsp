...
%> 
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td><input type="text" name="sgdglftd" value="0" size="8" maxlength="8" onChange="calValue(insertform)">
                <font color="#993300">%</font><font color="#990000">(定额结算费率</font><font color="#993300">）</font></td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right"><font color="#993300">施工队结算金额</font> </td>
              <td><input type="text" name="sgdjsje" value="" size="12" maxlength="12" readonly>
              <font color="#990000">(系统自动计算）</font></td>
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td><input type="text" name="glftd" value="" size="8" maxlength="8" ><font color="#993300">%</font>(<font color="#993300">计提管理费率费率）</font></td>
            </tr>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <p> 
                  ...
                  <input name="sjcb" type="hidden" value="" size="20" maxlength="17" onChange="f_jsglf(insertform)">
                </p>
                <p> 
...
{  
	var sgdjsje=FormName.cbje.value*FormName.sgdglftd.value/100.0+FormName.cbje.value*1.00;
	sgdjsje=round(sgdjsje,2);
	var khjskze=FormName.khjskze.value*1.0;
	jsglftd=parseInt(sgdjsje*100.0)/khjskze;
	jsglftd=round(jsglftd,2);
	FormName.sgdjsje.value=sgdjsje;
...
function f_do(FormName)//参数FormName:Form的名称
{
    ...
    if (FormName.jsfs[1].checked)
	{
		...
		if (parseFloat(FormName.khjskze.value)<parseFloat(FormName.cbje.value))
		{
			alert("[客户结算金额]不能小于[基价金额]！");
			FormName.gsfje.select();
			return false;
		}
		if (FormName.sgdglftd.value<0 || FormName.sgdglftd.value>=100)
		{
			alert("错误！[管理费提点]应该在0和100之间！");
			FormName.sgdglftd.select();
			return false;
		}
	...
	{	
		...
		if(!(isFloat(FormName.glftd, "基价金额"))) {
			return false;
		}
		if (FormName.sgdglftd.value<0 || FormName.sgdglftd.value>=100)
		{
