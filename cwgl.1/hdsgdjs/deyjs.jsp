...
<table border="1" width="60%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 14px'>
  ...
  <tr align="center"> 
    <td width="69%" height="147"> 
      <p> 
        <input type="button" name="Button" value="调工料分析" onclick="window.open('Cw_deyjsmxClTsxm.jsp?khbh=<%=khbh%>')">
      </p>
      <p> 
        <input type="button" name="Button" value="预结算" onclick="window.open('Cw_deyjsmxList.jsp?khbh=<%=khbh%>')">
      </p>
      <p> 
