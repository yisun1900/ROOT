...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (crm_zjxdj_lrr!=null)
	{
		...
		if (!(crm_zjxdj_lrr.equals("")))	wheresql+=" and  (jsr='"+crm_zjxdj_lrr+"')";
	}
	ls_sql="SELECT cw_gdjsjl.gdjsjlh,DECODE(cw_gdjsjl.jsfs,'1','计提管理费','2','定额结算'),DECODE(cw_gdjsjl.jsjd,'0','未结算','1','结算部结算','2','结算审批','3','财务结算'),DECODE(cw_gdjsjl.spjl,'3','通过','4','未通过'),crm_khxx.khxm,crm_khxx.fwdz,sgdmc,cw_gdjsjl.wdzgce,cw_gdjsjl.qye,cw_gdjsjl.zkl,cw_gdjsjl.zjxje,cw_gdjsjl.khjskze,cw_gdjsjl.khsskze, DECODE(cw_gdjsjl.tdjs,'1','客户结算金额','2','实收款','3','签约额','4','实际成本'),cw_gdjsjl.tdjsje,cw_gdjsjl.glftd,cw_gdjsjl.glf,cw_gdjsjl.dejsje,cw_gdjsjl.xbclk,cw_gdjsjl.gckk,cw_gdjsjl.sgdfk,cw_gdjsjl.sjsfk,cw_gdjsjl.wxj,cw_gdjsjl.bk,cw_gdjsjl.gdjskze,cw_gdjsjl.jsr,cw_gdjsjl.jssj,dwmc,cw_gdjsjl.khbh,cw_gdjsjl.bz";
    ...
    ls_sql+=" and (cw_gdjsjl.jsjd in('1','0') or (cw_gdjsjl.jsjd='2' and cw_gdjsjl.spjl='4'))";//1：结算；2：结算审批；3：财务结算//3：通过；4：未通过
    ls_sql+=" and cw_gdjsjl.jsfs='2'";//：计提管理费；2：定额结算
    ls_sql+=wheresql;
	ls_sql+=" order by cw_gdjsjl.jssj desc ";
	//out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_gdjsjlList.jsp","SelectCw_gdjsjl.jsp","","EditCw_gdjsjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCw_gdjsjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">提点基数</td>
	<td  width="3%">提点基数金额</td>
	<td  width="3%">管理费提点</td>
	<td  width="3%">管理费</td>
	<td  width="3%">定额结算金额</td>
	<td  width="3%">需补材料款</td>
	<td  width="3%">工程扣款</td>
	<td  width="3%">施工队罚款</td>
	<td  width="3%">设计师罚款</td>
