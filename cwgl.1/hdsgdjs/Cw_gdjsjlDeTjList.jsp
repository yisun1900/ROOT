...
<CENTER >
  <B><font size="3">项目经理结算统计表（定额结算）</font></B> 
</CENTER>
...
try {
	...
	ls_sql+=" ,cw_gdjsjl.clf,cw_gdjsjl.zgclf,cw_gdjsjl.kqtk,cw_gdjsjl.gdjskze,cw_gdjsjl.bz ";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"  > 
    <td  width="15%"><b>签单部门（设计师）</b></td>
    <td  width="5%"><b>折扣</b></td>
    <td  width="7%"><b>签单日期</b></td>
    <td  width="20%"><b>工程名称</b></td>
    <td  width="7%"><b>结算金额</b></td>
    <td  width="7%"><b>已收款</b></td>
    <td  width="6%"><b>税金</b></td>
    <td  width="6%"><b>维修金</b></td>
    <td  width="7%"><b>物流材料</b></td>
    <td  width="6%"><b>外构材料</b></td>
    <td  width="6%"><b>扣款</b></td>
    <td  width="7%"><b>内部定额数</b></td>
  </tr>
  <tr bgcolor="#FFFFFF" > 
    <td><%=dwmc%>（<%=sjs%>）</td>
    <td><%=zkl%></td>
