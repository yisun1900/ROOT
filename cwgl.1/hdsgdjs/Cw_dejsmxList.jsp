    ...
    <tr bgcolor="#FFFFFF"> 
      <td colspan="18" > 
	   <input type=button value='定额结算' onClick="cf_submit(listform)" >
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value='查看基价单价' onClick="window.open('ViewCw_dejsxmclmx.jsp?khbh=<%=khbh%>')" >
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%
	...
	ls_sql+=" and bj_khglfxb.glflbm='1' and bj_khglfxb.wlllbz='Y' ";//只取材料类，包括不需要物流领料
	...
	while (rs.next())
	{
		...
		*/
		...
		ls_sql+=" and ( bj_khglfxb.glflbm!='1' OR (bj_khglfxb.glflbm='1' and bj_khglfxb.wlllbz='N')  ) ";
//			out.print(ls_sql);
		ps1= conn.prepareStatement(ls_sql);
		rs1 =ps1.executeQuery();
		if (rs1.next())
...
//			out.print(ls_sql);
		...
		%> 
		  <tr bgcolor="#FFFFFF" align="center"> 
			...
			<td ><A HREF="ViewXmCw_dejsxmclmx.jsp?khbh=<%=khbh%>&xmbh=<%=xmbh%>" target="_blank"><%=xmbh%></A>
