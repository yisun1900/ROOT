...
try {
	...
	ls_sql+=" where bj_bjxmmx.khbh='"+khbh+"' and bj_bjxmmx.xmbh='"+xmbh+"' and bj_bjxmmx.bjjb='"+bjjbbm+"'";
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertYjsBj_jzglfxb.jsp";
	FormName.submit();
	return true;
}
function f_sc(FormName)//参数FormName:Form的名称
{
	...
	if ( confirm("确实要继续吗?") )	{
		...
		if (choo == 0){
			...
			FormName.action="DeleteYjsBj_jzglfxb.jsp";
			FormName.submit();
			return true;
		}
	}
