...
try {
	...
	/**
        //int pjje111=0;
        ls_sql="select  (sum(((cw_gdjsjl.glftd*cw_gdjsjl.tdjsje)/100))/sum(tdjsje))*100 pjje,sum(((cw_gdjsjl.glftd*cw_gdjsjl.tdjsje)/100)) as sum_glf from cw_gdjsjl,sq_sgd,crm_khxx where";
    ...
    **/
	//
		...
		ls_sql="select sgdmc,cw_gdjsjl.sgd,count(*) jskh,sum(tdjsje) gdjskze,sum(((cw_gdjsjl.glftd*cw_gdjsjl.tdjsje)/100)) as sum_glf,trunc(sum(((cw_gdjsjl.glftd*cw_gdjsjl.tdjsje)/100))/count(*)) pjtdje,sum((cw_gdjsjl.glftd*cw_gdjsjl.tdjsje))/sum(tdjsje) pjtdl  from cw_gdjsjl,sq_sgd,crm_khxx where";
		ls_sql+=" cw_gdjsjl.sgd=sq_sgd.sgd(+) and cw_gdjsjl.khbh=crm_khxx.khbh and tdjsje>0 and glftd>0 ";
		ls_sql+=wheresql;
