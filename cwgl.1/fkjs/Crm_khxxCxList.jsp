...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and ( (crm_khxx.zt='2' and crm_khxx.gcjdbm='4') OR (crm_khxx.zt='4' and  crm_khxx.gcjdbm!='5') )";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","InsertCrm_gcjddjjl.jsp","");
...
<CENTER >
  <B><font size="3">完结登记(<font color="#FF0000">注意：只有完工登记的客户才能被查询到</font>)</font></B> 
</CENTER>
<%
	pageObj.out=out;
