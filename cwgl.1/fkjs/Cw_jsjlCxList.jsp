...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,TO_CHAR(cw_jsjl.qye) qye,cw_jsjl.jsjlh,DECODE(scbz,'N','未删除','Y','<font color=\"#FF0000\">已删除</font>'),cw_jsjl.zjje,cw_jsjl.jsl||'%',cw_jsjl.bqyfkze,cw_jsjl.jsr,cw_jsjl.jssj,b.dwmc jsdw,cw_jsjl.scr,cw_jsjl.scsj,cw_jsjl.bz,crm_khxx.sjs,crm_khxx.zjxm,sgdmc sgd  ";
...
//设置列超级连接
	...
	coluParm.link="/cwgl/fkjs/ViewCw_jsjl.jsp";//为列参数：coluParm.link设置超级链接
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">结算记录号</td>
	<td  width="4%">删除标志</td>
	<td  width="5%">本期增减金额</td>
	<td  width="4%">本期结算率</td>
	<td  width="6%">本期应收款总额</td>
	<td  width="4%">结算人</td>
	<td  width="6%">结算时间</td>
	<td  width="7%">结算单位</td>
	<td  width="4%">删除人</td>
