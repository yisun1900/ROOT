...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and cw_gckkjl.spbz in('3','4')";
    ls_sql+=wheresql;
    ls_sql+=" order by cw_gckkjl.lrsj desc";
    pageObj.sql=ls_sql;

//进行对象初始化
	pageObj.initPage("Cw_gckkjlXgSpList.jsp","SelectXgSpCw_gckkjl.jsp","","XgSpCw_gckkjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSp_Cwgckkjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">审批工程扣款--修改</font></B>
</CENTER>
<%
	pageObj.out=out;
