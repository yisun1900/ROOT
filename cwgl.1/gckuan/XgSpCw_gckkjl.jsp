...
try {
	...
	ls_sql="select kkjlh,khbh,gckk,sjsfy,sgdfy,zjfy,gsfy,qtfy,spgckk,spsjsfy,spsgdfy,spzjfy,spgsfy,spqtfy,lrr,lrsj,lrbm,bz,spbz,spyj,spr,spsj ";
	...
	ls_sql="select fgsbh,sjsbh,khxm,fwdz,lxfs,xb,sjs,hth,qyrq,dwbh,sgd,zjxm,wdzgce,qye,sjf,glf,sfke,zjxje,sgbz,jgrq,qye";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审批工程扣款--修改（扣款记录号：<%=kkjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveXgSpCw_gckkjl.jsp" name="editform">
