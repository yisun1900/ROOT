...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,khxm,fwdz,DECODE(zt,'2','家装','3','退单','4','集成','5','设计'),yjjzsj,tdsj,a.dwmc sbdm,sjs,sgdmc sgd,zjxm,kgrq,jgrq ";
...
<CENTER >
  <B><font size="3">修改－记入业绩时间</font></B>
</CENTER>
<%
	pageObj.out=out;
