...
<tr bgcolor="#FFFFFF">
  ...
  <td align="center"><%=cf.round(tcbzjg+tcmjzjje+tczcsjcj+tczccljj+tcxsfzc-tczcjm+tcdpsj+tcwsgzj+tcwgccljj+tcqtsf,2)%>
    <input name="button7" type="button" onClick="window.open('/dhzx/sjszxone/dybj.jsp?khbh=<%=khbh%>')" value="合同报价"></td>
  <td align="center"><%=cf.round(tcbzjgzjx+tcmjzjjezjx+tczcsjcjzjx+tczccljjzjx+tcxsfzczjx-tczcjmzjx+tcdpsjzjx+tcwsgzjzjx+tcwgccljjzjx+tcqtsfzjx,2)%>
    <input name="button8" type="button" onClick="window.open('/khxx/ViewZjxxx.jsp?khbh=<%=khbh%>')" value="增减项"></td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><strong>
    <input name="button6" type="button" onClick=window.open("/cwgl/jrkhjs/Jc_zcddTcwCxList.jsp?khbh=<%=khbh%>") value="套餐外增加主材">
  </strong></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="yjzck" value="<%=yjzck%>" size="20" maxlength="17" readonly>
    <strong>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><font color="#0000FF">
    ...
    <strong>
    <input name="button3" type="button" onClick=window.open("/cwgl/jrkhjs/Jc_zcddJddxCxList.jsp?khbh=<%=khbh%>") value="机电代销">
    </strong></font></td>
