...
<form method="post" action="Cw_khfkjlFklxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%">
                ...
                <input type="radio" name="sfcd" value="N">否
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="zffs" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select zffsbm,zffsmc from cw_zffsbm where zffsbm!='31' order by zffsbm","");
%> 
                </select>              </td>
