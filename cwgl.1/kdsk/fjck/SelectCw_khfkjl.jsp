...
<%
	...
	String mmgysstr=cf.getItemData("select sq_gysxx.gysbh,sq_gysxx.gysmc from sq_gysxx,sq_ppgyssqfgs where sq_gysxx.gysbh=sq_ppgyssqfgs.gysbh and sq_ppgyssqfgs.ssfgs='"+ssfgs+"' and sq_gysxx.gyslb='1' order by sq_gysxx.gysmc");
	String cggysstr=cf.getItemData("select sq_gysxx.gysbh,sq_gysxx.gysmc from sq_gysxx,sq_ppgyssqfgs where sq_gysxx.gysbh=sq_ppgyssqfgs.gysbh and sq_ppgyssqfgs.ssfgs='"+ssfgs+"' and sq_gysxx.gyslb='2' order by sq_gysxx.gysmc");
	String jjgysstr=cf.getItemData("select sq_gysxx.gysbh,sq_gysxx.gysmc from sq_gysxx,sq_ppgyssqfgs where sq_gysxx.gysbh=sq_ppgyssqfgs.gysbh and sq_ppgyssqfgs.ssfgs='"+ssfgs+"' and sq_gysxx.gyslb='3' order by sq_gysxx.gysmc");
...
<form method="post" action="Cw_khfkjlList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <INPUT type="radio" name="fklxbm" value="21" onClick="makeItem('1',gysbh,<%=mmgysstr%>)">
                木门款 
                <INPUT type="radio" name="fklxbm" value="22" onClick="makeItem('2',gysbh,<%=cggysstr%>)">
                橱柜款 
                <INPUT type="radio" name="fklxbm" value="23">
                主材款 
                <INPUT type="radio" name="fklxbm" value="24" onClick="makeItem('3',gysbh,<%=jjgysstr%>)">
                家具款 </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%> 
	...
	if (yhjs.equals("A0") )
	{
		...
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwflbm in('06') and cxbz='N' order by ssfgs,dwbh","");
	}
	else{
...
{
	if(	javaTrim(FormName.crm_khxx_hth)=="") {
		alert("请输入[合同号]！");
		FormName.crm_khxx_hth.focus();
		return false;
	}
