...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT fkxh,crm_khxx.khxm,a.fklxmc fklxbm,gysbh,cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,zcgysbh,cw_khfkjl.fkje,crm_khxx.fwdz,crm_khxx.hth,cw_khfkjl.skr,cw_khfkjl.sksj,cw_khfkjl.sjr,cw_khfkjl.sjsj,dwmc,cw_khfkjl.bz  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khfkjlList.jsp","SelectCw_khfkjl.jsp","","/cwgl/fcwdsk/fjck/EditCw_khfkjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"/cwgl/fcwdsk/fjck/DeleteCw_khfkjl.jsp"};//按钮单击调用的网页，可以增加参数
