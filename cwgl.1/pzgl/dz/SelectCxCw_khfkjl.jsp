...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><span class="STYLE1">支付方式是否转款</span></td>
              <td colspan="3">
			  <input name="sfzk" type="radio" value="1" checked>
			  非转款支付
			  <input type="radio" name="sfzk" value="2">转款支付
			  <input type="radio" name="sfzk" value="3">全部
			  </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right">签单状态</td>
              <td width="32%"> 
