...
<form method="post" action="Cw_lfbgfjlCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">拨工费记录号</td>
              <td><input type="text" name="bgfjlh" value="" size="20" maxlength="9" ></td>
              <td align="right">录入人</td>
              <td><input type="text" name="lrr" value="" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">拨付次数</td>
	...
	%>
              ...
              <td align="right">拨付基数</td>
              <td><select name="bfjs" style="FONT-SIZE:12PX;WIDTH:152PX">
                 <%
 		out.println("<option value=\"\"></option>");
		cf.selectToken(out,"1+折前工程费&2+折后工程费","");
	%>
              </select></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">拨付日期 从 </td>
              <td><input type="text" name="bfrq" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
              <td><input type="text" name="bfrq2" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.bfrq2, "拨付日期"))) {
		return false;
	}
