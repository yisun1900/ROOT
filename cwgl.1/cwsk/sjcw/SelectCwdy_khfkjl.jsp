...
<form method="post" action="Cwdy_khfkjlList.jsp" name="selectform">
...
%> 
              ...
              <td width="33%"> 
                <input type="text" name="cw_khfkjl_fkxh" size="20" maxlength="9" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">财务收款时间 从</td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
                <div align="right">是否财务收款</div>
              </td>
              <td width="32%"> 
                <select name="skdd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="1">财务收款</option>
                  <option value="2">非财务代收款</option>
                </select>
              </td>
              <td width="17%" align="right">审核结果</td>
              <td width="33%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.sjsj2, "财务收款时间"))) {
		return false;
	}
