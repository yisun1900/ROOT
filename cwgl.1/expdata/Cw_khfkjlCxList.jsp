...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,DECODE(cw_khfkjl.khlx,'1','咨询客户','2','家装客户','4','非家装客户','5','设计客户') khlx,crm_khxx.fwdz,a.fklxmc fklxbm,fkxh,DECODE(scbz,'N','未删除','Y','删除'),DECODE(skdd,'1','财务收款','2','非财务代收款'),DECODE(dsksjbz,'N','未审核','Y',' 审核通过','M','审核未通过'),cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,cw_khfkjl.fkje,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,scr,scsj,cw_khfkjl.bz  ";
	...
	ls_sql+=" SELECT '&nbsp;',crm_zxkhxx.khxm,DECODE(cw_khfkjl.khlx,'1','咨询客户','2','家装客户','4','非家装客户','5','设计客户') khlx,crm_zxkhxx.fwdz,a.fklxmc fklxbm,cw_khfkjl.fkxh,DECODE(scbz,'N','未删除','Y','删除'),DECODE(skdd,'1','财务收款','2','非财务代收款'),DECODE(dsksjbz,'N','未审核','Y',' 审核通过','M','审核未通过'),cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,cw_khfkjl.fkje,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,scr,scsj,cw_khfkjl.bz  ";
...
//设置列超级连接
	...
	coluParm.link="ViewCw_khfkjl.jsp";//为列参数：coluParm.link设置超级链接
