...
<form method="post" action="" name="insertform" target="_blank">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" height="27" align="right"> 
...
%> 
              ...
              <td width="19%" height="27" bgcolor="#FFFFFF" align="right">&nbsp;</td>
              <td width="31%" height="27">&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"><font color="#FF0000">*</font>收款金额</td>
              <td width="31%"><input type="text" name="fkje" value="" size="20" maxlength="17" onChange="checkZkje(insertform)"></td>
              <td width="19%" align="right"><font color="#FF0000">*</font>支付方式</td>
              <td width="31%"><select name="zffs" style="FONT-SIZE:12PX;WIDTH:152PX">
                <option value=""></option>
                <%
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"><select name="zckx" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeZckx(insertform)">
                <option value=""></option>
                <%
	cf.selectItem(out,"select fklxbm,fklxmc from cw_fklxbm order by fklxbm","");
%>
              </select></td>
              <td width="19%" align="right">银行转帐帐号</td>
              <td width="31%"><input name="zzyhkh" type="text" value="" size="20" maxlength="40"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"><font color="#FF0000">*</font>收款人</td>
              <td width="31%"> 
                <input type="text" name="skr" value="<%=yhmc%>" size="20" maxlength="20" >              </td>
              <td width="19%" align="right"><font color="#FF0000">*</font>收款时间</td>
              <td width="31%"> 
...
%> 
              ...
              <td width="31%"><input type="text" name="sjbh" value="" size="20" maxlength="20" ></td>
            </tr>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input name="pr" type="button" value="打印收据" onClick="window.open('/cwgl/qyecx/PrintQtSj.jsp?fkxh=<%=fkxh%>&khbh=<%=khbh%>')" disabled>
                <input name="pr2" type="button" value="选择打印" onClick="window.open('/cwgl/qyecx/PrintChooseQtSj.jsp?fkxh=<%=fkxh%>')" disabled>              </td>
            </tr>
        </table>
</form>
...
function f_new(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="InsertCw_khfkjl1.jsp";
	FormName.target="";
	FormName.submit();
