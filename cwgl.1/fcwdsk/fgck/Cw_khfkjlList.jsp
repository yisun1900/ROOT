...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT fkxh,crm_khxx.khxm,DECODE(cw_khfkjl.dsksjbz,'N','未审核','Y','审核通过','M','审核未通过'),fkcsmc,cw_khfkjl.fkje,cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,zcgysbh,zcddbh,zczjxbh,crm_khxx.fwdz,crm_khxx.khbh,cw_khfkjl.yfkbl||'%',cw_khfkjl.yfkje,cw_khfkjl.skr,cw_khfkjl.sksj,cw_khfkjl.sjr,cw_khfkjl.sjsj,dwmc,a.fklxmc fklxbm,cw_khfkjl.shyj,cw_khfkjl.bz  ";
