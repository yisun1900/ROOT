...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="17%" align="right">收款单位</td>
              <td width="33%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td align="right" width="17%">收款类型</td>
              <td width="33%"> 
...
%> 
              ...
              <td align="right" width="17%">收款品牌</td>
              <td width="33%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="radio" name="skdd" value="1">财务收款
                <input type="radio" name="skdd" value="2">非财务代收款
              </td>
              <td width="17%"> 
                <div align="right">审核标志</div>
              </td>
              <td width="33%"> 
                <input type="radio" name="dsksjbz" value="N">否
                <input type="radio" name="dsksjbz" value="Y">是
              </td>
            </tr>
            <tr bgcolor="#CCFFFF"> 
            ...
            <tr bgcolor="#CCFFFF"> 
              ...
              <td width="32%"> 
                ...
                工程款</td>
              <td width="17%" align="right">支付方式</td>
              <td width="33%"> 
                <input type="radio" name="zffsfl" value="1" checked>
                现金 
                <input type="radio" name="zffsfl" value="2">
                非现金 
                <input type="radio" name="zffsfl" value="3">
                转出</td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
