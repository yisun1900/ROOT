...
<%
	...
	String fklxfl=null;
	fklxfl=request.getParameter("fklxfl");
	if (fklxfl!=null)
	{
		if (fklxfl.equals("1"))//非集成款
		{
			wheresql+=" and  cw_khfkjl.fklxbm not in('21','22','23','24')";
		}
		else if (fklxfl.equals("2"))//集成款
		{
			wheresql+=" and  cw_khfkjl.fklxbm in('21','22','23','24')";
		}
		else if (fklxfl.equals("0"))//全部
		{
		}
	}
