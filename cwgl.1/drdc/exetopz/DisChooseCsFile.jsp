...
<form method="post" action="SaveChooseCsFile.jsp" name="editform" target="_blank">
  <div align="center"><b>厂商结款单－导入（科目代码：<%=kmdm%>） <BR>
    （注意：数据从第2行开始，[档案号]第2列，[实收款]第5列）</b></div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#CCCCCC" align="center"> 
      ...
      <td width="10%">材料顾问</td>
	  <td width="12%">客户姓名</td>
      <td width="10%" bgcolor="#FFCCFF">实收款</td>
      <td width="10%">结算款</td>
      <td width="10%">毛利</td>
      <td width="8%">毛利率</td>
    </tr>
...
*/
		...
		if (sskstr!=null && !sskstr.trim().equals(""))
		{
			try{
				...
				out.print("序号["+xuhao+"]出错！[实收款]非数字：" + sskstr);
				return;
			}
		}
		...
		if (jskstr!=null && !jskstr.trim().equals(""))
		{
			try{
				...
				out.print("序号["+xuhao+"]出错！[结算款]非数字：" + jskstr);
				return;
			}
		}
