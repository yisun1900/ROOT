...
<body bgcolor="#FFFFFF">
<CENTER><B>家装计提返款－导入</B><BR><HR>
<form method="post" action="DisChooseJzfkFile.jsp" name="loadform" enctype="multipart/form-data" >
...
%> 
      ...
      <tr>
        ...
        <td height="48">凭 证摘 要
          <input type="text" name="fexp" maxlength="254" size="47" value="月末调整返款差异">
        </td>
      </tr>
      <tr> 
