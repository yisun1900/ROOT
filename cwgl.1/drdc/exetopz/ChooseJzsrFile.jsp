...
<body bgcolor="#FFFFFF">
<CENTER><B>家装收入－导入</B><BR><HR>
<form method="post" action="DisChooseJzsrFile.jsp" name="loadform" enctype="multipart/form-data" >
...
%> 
      ...
      <tr>
        ...
        <td height="48">凭 证摘 要
          <input type="text" name="fexp" maxlength="254" size="47" value="月末计提本月家装产值">
        </td>
      </tr>
      <tr> 
