...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">批量维护提成记入比例</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddPlWhTcblList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"><INPUT type="radio" name="ddlx" value="9">
                代购主材
                  <INPUT type="radio" name="ddlx" value="E">
              散客 </td>
            </tr>
<%
if (yhjs.equals("A0"))
{
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td>
		  <input type="text" name="jc_zcdd_lrr" size="20" maxlength="20" value="" >              </td>
	  <td align="right">录入部门</td>
	  <td><select name="jc_zcdd_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
		</select>              </td>
	</tr>
	<%
	...
	<tr bgcolor="#FFFFFF">
	  <td align="right"> 录入人 </td>
	  <td>
		  <input type="text" name="jc_zcdd_lrr" size="20" maxlength="20" value="" readonly="true">              </td>
	  <td align="right">录入部门</td>
	  <td><select name="jc_zcdd_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
		  <%
