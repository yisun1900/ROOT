...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单－－厂商批量结算 </div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddPlJsList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <select name="clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="11">交款已确认</option>
                  <option value="13">工厂已接收</option>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="19%" align="right"><strong><font color="#0000FF">是否已结算</font></strong></td>
              <td width="31%"><select name="sfjs" style="FONT-SIZE:12PX;WIDTH:152PX">
                <option value=""></option>
                <option value="N">未结算</option>
                <option value="C">设置选择标志</option>
              </select></td>
            </tr>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              未审核 </td>
              <td align="right"><strong><font color="#FF0000">是否散客</font></strong></td>
              <td><input name="ddlx" type="radio" value="E">
是
  <input type="radio" name="ddlx" value="9"> 
  否</td>
            </tr>
			<tr bgcolor="#E8E8FF">
              <td align="right">购买时间 从</td>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="sshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="sshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.qhtsj2, "签合同时间"))) {
		return false;
	}
