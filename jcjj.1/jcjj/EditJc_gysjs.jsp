...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="ycfzj" size="20" maxlength="17"  value="<%=ycfzj%>" readonly></td>
  <td align="right"><font color="#FF0000">*</font><font color="#0000CC">其它费</font></td>
  <td><input type="text" name="qtfzj" size="20" maxlength="17"  value="<%=qtfzj%>" readonly></td>
</tr>
<tr bgcolor="#FFFFFF">
...
{
	var jsje=<%=(jsje+kcfy)%>-FormName.kcfy.value*1.0;
	jsje=round(jsje,2);
