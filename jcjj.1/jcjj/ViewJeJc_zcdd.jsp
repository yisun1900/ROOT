...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFCC">
    ...
    <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">财务审核付款金额</span></td>
    <td bgcolor="#FFFFFF"><strong><%=sskje%></strong></td>
  </tr>
  <tr bgcolor="#FFFFCC">
    <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">记入业绩时间</span></td>
    <td bgcolor="#FFFFFF"><strong><%=yjjzsj%></strong></td>
    <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">退单记入业绩时间</span></td>
