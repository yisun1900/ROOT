    ...
    <tr> 
      ...
      <td height="34" width="38%" valign="middle"> 
        <table width="100%" border="0" bgcolor="#FFFFCC"  id="xllb" >
          <tr> 
		  <td > 
          <input type="radio" name="zt" value="1" checked>签家装合同客户
			<p> 
          <input type="radio" name="zt" value="2">咨询客户
			<p> 
          <input type="radio" name="zt" value="3">新散客
			<p> 
          <input type="radio" name="zt" value="4">散客退补货
		  </td>
    </tr>
  </table>      </td>
    </tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	else if (FormName.zt[1].checked)
	{
		FormName.action="SelectCxCrm_zxkhxx.jsp";
	}
	else if (FormName.zt[2].checked)
	{
		FormName.action="InsertJc_zcdd1.jsp";
	}
	else{
		FormName.action="SelectSkCrm_zxkhxx.jsp";
	}
