...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','店面退回客户','3','已签约','4','公司签单失败','5','重新分配店面'),khxm,fwdz,a.dwmc zxdm,sjs,crm_zxkhxx.clgw,lrsj,b.dwmc zxdjbm";
	...
	if (zwbm.equals("08"))//08:家居顾问
	{
		ls_sql+=" and crm_zxkhxx.clgw='"+yhmc+"'";
	}
    ls_sql+=wheresql;
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxCxList.jsp","","InsertJc_zcdd.jsp?zt=4","");
/*
//设置显示列
