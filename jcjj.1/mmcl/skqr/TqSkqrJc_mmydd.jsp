...
try {
	...
	if (mmfk < (zjhze-11))
	{
		out.println("<B><font color=\"#FF0000\">提醒！付款不足，实付款＝『"+mmfk+"』，合同总额＋增减项＝『"+zjhze+"』</font></B>");
	}
}
catch (Exception e) {
...
<div align="center">木门预订单---收款确认－特权（预订单编号：<%=jc_mmydd_yddbh%>）</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    
    <tr bgcolor="#CCCCFF">
      <td align="right" bgcolor="#FFFFFF"><b>打折原因</b></td>
      <td colspan="4" bgcolor="#FFFFFF"><%=dzyy%></td>
    </tr>
    <tr bgcolor="#CCCCFF">
      <td align="right" bgcolor="#FFFFFF"><strong>木门合同金额-折前</strong></td>
      <td bgcolor="#FFFFFF"><%=zqmmhtje%></td>
      <td align="center" bgcolor="#FFFFFF">木门折扣率：<%=mmzkl%></td>
      <td align="right" bgcolor="#FFFFFF"><strong>木门合同金额-折后</strong></td>
      <td bgcolor="#FFFFFF"><%=mmhtje%></td>
    </tr>
    <tr bgcolor="#CCCCFF">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#FFFFFF"><b><font color="#0000FF">家居预付款</font></b></td>
      <td bgcolor="#FFFFFF"><%=yfkze%></td>
      <td align="center" bgcolor="#FFFFFF"><font color="#CC0033"><strong>欠款：<%=cf.round(zjhze-mmfk,2)%></strong></font></td>
      <td align="right" bgcolor="#FFFFFF"><b><font color="#0000FF">订单已付款</font></b></td>
      <td bgcolor="#FFFFFF"><%=mmfk%></td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td width="18%" align="right" bgcolor="#FFFFFF">收款确认时间</td>
      <td width="21%" bgcolor="#FFFFFF"> 
      <input type="text" name="skqrsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>      </td>
      <td width="21%" bgcolor="#FFFFFF" align="right">&nbsp;</td>
      <td width="18%" bgcolor="#FFFFFF" align="right">收款确认人</td>
      <td width="22%" bgcolor="#FFFFFF"> 
      <input type="text" name="skqrr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
%></td>
      <td width="22%" align="right">设计师</td>
...
%></td>
    ...
    <tr bgcolor="#FFFFCC"> 
      ...
      <td width="22%" align="right"> 
        木门测量技师      </td>
      <td width="28%"><%=jc_mmydd_mmcljs%> </td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      <td width="22%" align="right">派单人</td>
      <td width="28%"><%=paidr%></td>
      <td width="22%" align="right">派单时间</td>
      <td width="28%"><%=paidsj%></td>
    </tr>
    <tr bgcolor="#CCCCFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveSkqrJc_mmydd.jsp";
	FormName.submit();
	return true;
}
