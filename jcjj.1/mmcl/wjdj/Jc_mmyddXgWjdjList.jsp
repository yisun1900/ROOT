...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,DECODE(jc_mmydd.ycclzt,'1','延迟未核实','2','延迟原因属实','3','原因不属实') ycclzt,a.mmycyymc mmycyybm,b.mmycyymc zsycyybm,jc_mmydd.pdgcmc,paidr,ychssj,wjsj,aztzsj,azkssj,azjssj,jhazsj,mmcljs,sshsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.pdgc,jc_mmydd.ppmc,jc_mmydd.gys,jc_mmydd.bz  ";
...
//	ls_sql+=" and jc_mmydd.ycclzt in('2','3')";
	if (yhjs.equals("G0"))
	{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgWjdjList.jsp","","","XgWjdjJc_mmydd.jsp");
//设置显示列
	String[] disColName={"yddbh","khxm","fwdz","clztmc","wjsj","ycclzt","mmycyybm","zsycyybm","ychssj","azkssj","azjssj","aztzsj","jhazsj","pdgcmc","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","pdgc","ppmc","gys","bz"};
...
//设置按钮参数
	String[] buttonName={"删除完结登记"};//按钮的显示名称
	String[] buttonLink={"DeleteWjdjJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---完结登记</font></B>
</CENTER>
<%
	pageObj.out=out;
