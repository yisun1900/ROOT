...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jc_mmydd_kazsj=request.getParameter("jc_mmydd_kazsj");
	if (jc_mmydd_kazsj!=null)
	{
		jc_mmydd_kazsj=jc_mmydd_kazsj.trim();
		if (!(jc_mmydd_kazsj.equals("")))	wheresql+="  and (jc_mmydd.kazsj>=TO_DATE('"+jc_mmydd_kazsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_kazsj=request.getParameter("jc_mmydd_kazsj2");
	if (jc_mmydd_kazsj!=null)
	{
		jc_mmydd_kazsj=jc_mmydd_kazsj.trim();
		if (!(jc_mmydd_kazsj.equals("")))	wheresql+="  and (jc_mmydd.kazsj<=TO_DATE('"+jc_mmydd_kazsj+"','YYYY-MM-DD'))";
	...
	ls_sql="SELECT yddbh,jc_mmydd.pdgcmc,paidr,kazsj,srksj,mmcljs,jhazsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.lxfs,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz, clztmc,jc_mmydd.lrsj,jc_mmydd.azsjbz,jc_mmydd.pdgc,jc_mmydd.ppmc,jc_mmydd.gys  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddAztzList.jsp","","","AztzJc_mmydd.jsp");
	pageObj.setPageRow(Integer.parseInt(myxssl));
	pageObj.setEditStr("通知");
//设置显示列
	String[] disColName={"yddbh","khxm","clztmc","kazsj","jhazsj","srksj","pdgcmc","lxfs","fwdz","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","azsjbz","pdgc","ppmc","gys"};
...
//设置按钮参数
	...
	String[] buttonLink={"SavePlAztzJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单--发安装通知</font></B>
</CENTER>
<%
	pageObj.out=out;
