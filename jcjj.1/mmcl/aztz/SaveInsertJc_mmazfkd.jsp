...
try {
	...
	ls_sql="insert into jc_mmazfkd ( yddbh,spks,spzl,spgn,spfw,azjs,fwtd,fwgf,mfsh,mfaz,zssm,syxt,sydb,wzzq,qlxc,cscp,jsbyzs,bzgkjxy,bzgkjcf,bsdtt,bjsgkxf,bsygksb,bjsgkyq,azhs,bz ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
