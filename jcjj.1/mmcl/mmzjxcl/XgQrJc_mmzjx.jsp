...
try {
	...
	ls_sql="select qrsj,qrr,jc_mmzjx.yddbh as yddbh,jc_mmzjx.zjxxh as jc_mmzjx_zjxxh,jc_mmzjx.khbh as jc_mmzjx_khbh,crm_khxx.khxm as crm_khxx_khxm,crm_khxx.fwdz as crm_khxx_fwdz,crm_khxx.hth as crm_khxx_hth,crm_khxx.sjs as crm_khxx_sjs,crm_khxx.qyrq as crm_khxx_qyrq,crm_khxx.dwbh as crm_khxx_dwbh,crm_khxx.zjxm as crm_khxx_zjxm,crm_khxx.sgd as crm_khxx_sgd,jc_mmzjx.mmzjxyybm as jc_mmzjx_mmzjxyybm,jc_mmzjx.mmzjxje as jc_mmzjx_mmzjxje,jc_mmzjx.wjzjxje as jc_mmzjx_wjzjxje,jc_mmzjx.blzjxje as jc_mmzjx_blzjxje,jc_mmzjx.zjxze as jc_mmzjx_zjxze,jc_mmzjx.srksj as jc_mmzjx_srksj,jc_mmzjx.rkr as jc_mmzjx_rkr,jc_mmzjx.rksm as jc_mmzjx_rksm,jc_mmzjx.jhazsj as jc_mmzjx_jhazsj,jc_mmzjx.azwcsj as jc_mmzjx_azwcsj,jc_mmzjx.clzt as jc_mmzjx_clzt,jc_mmzjx.lrr as jc_mmzjx_lrr,jc_mmzjx.lrsj as jc_mmzjx_lrsj,jc_mmzjx.dwbh as jc_mmzjx_dwbh,jc_mmzjx.bz as jc_mmzjx_bz ";
...
<div align="center">木门增减项处理-工厂确认 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">确认时间</td>
      <td width="28%"> 
        <input type="text" name="qrsj" size="20" maxlength="20" value="<%=qrsj%>" readonly>
      </td>
      <td width="23%" align="right">确认人</td>
      <td width="27%"> 
        <input type="text" name="qrr" size="20" maxlength="20" value="<%=qrr%>" readonly>
      </td>
    </tr>
    <tr> 
      <td colspan="4" align="center" bgcolor="#E8E8FF"> 
		<input type="button"  value="确认" onClick="f_do(selectform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgQrJc_mmzjx.jsp";
	FormName.submit();
	return true;
