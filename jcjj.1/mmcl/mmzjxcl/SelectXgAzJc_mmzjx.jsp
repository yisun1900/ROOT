...
<form method="post" action="Jc_mmzjxXgAzList.jsp" name="selectform">
<div align="center">木门增减项处理－修改安装</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  <td align="right"> 安装完成时间 从 </td>
	  <td><input type="text" name="jc_mmzjx_azwcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	  <td align="right"> 到 </td>
	  <td><input type="text" name="jc_mmzjx_azwcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	</tr>
	<tr align="center"> 
	  <td colspan="4"> 
