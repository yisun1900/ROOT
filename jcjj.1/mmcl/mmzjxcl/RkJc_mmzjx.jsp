...
<div align="center">木门增减项处理-增项入库 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">入库时间</td>
      <td width="28%"> 
        <input type="text" name="srksj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      <td colspan="4" align="center" > 
          <input type="button"  value="存 盘" onClick="f_do(selectform)" name="button2">
...
%></td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="18%" align="right">确认时间</td>
    <td width="32%"><%=qrsj%></td>
    <td width="18%" align="right">确认人</td>
    <td width="32%"><%=qrr%></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width="18%" align="right"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveRkJc_mmzjx.jsp";
	FormName.submit();
	return true;
