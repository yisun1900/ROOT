...
<html>
<head>
<title>木门增减项处理-工厂确认</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>

<body bgcolor="#FFFFFF">
<div align="center">木门增减项处理-增减项确认（增减项序号：<%=zjxxh%>）</div>
...
%></td>
    <td width="18%" align="right">增减项发生时间</td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><strong> 折前-木门增减项金额 </strong></td>
    <td><%=zqmmzjxje%> </td>
    <td align="right"><font color="#0000CC"><strong> 折后-木门增减项金额 </strong></font></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><strong> 折前-玻璃增减项金额 </strong></td>
    <td><%=zqblzjxje%> </td>
    <td align="right"><font color="#0000CC"><strong> 折后-玻璃增减项金额 </strong></font></td>
