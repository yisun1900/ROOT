...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---修改初测单</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="text" name="jc_mmydd_sccsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_sccsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_mmyddXgCcList.jsp";
