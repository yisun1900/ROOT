    ...
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><span class="STYLE1">*</span>计划初测时间</td>
              <td width="29%"> 
                <input type="text" name="jhccsj" size="20" maxlength="20"  value="<%=jhccsj%>" onDblClick="JSCalendar(this)">
              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><span class="STYLE1">*</span><span class="STYLE3">计划初测时间修改人</span></td>
              <td width="29%">
                <input type="text" name="jhccxgr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>
              </td>
              <td width="22%" align="right"><span class="STYLE1">*</span><span class="STYLE3">修改时间</span></td>
              <td width="28%"> 
                <input type="text" name="jhccxgsj" size="20" maxlength="20"  value="<%=cf.today()%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right"><span class="STYLE1">*</span>修改原因</td>
              <td colspan="3"> 
...
/*
*/
	FormName.action="SaveXgJhCcJc_mmydd.jsp";
	FormName.submit();
	return true;
}
//-->
