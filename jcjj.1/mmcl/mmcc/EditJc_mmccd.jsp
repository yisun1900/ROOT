...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">修改木门初测单（<font color="#FF6699">注意：红色部分会影响到价格，[门/窗洞高]为未减[地材厚]值</font>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3" bgcolor="#FFCCFF"> 
                <select name="ysbm" style="FONT-SIZE:12PX;WIDTH:452PX" onChange="getDj(insertform)">
                  <option value=""></option>
                  <%
		if (mmdglxbm.equals("01"))//整樘门，计价不分单双口
		{
		...
		//11:双口哑口,12:单口哑口,13:双口窗套，14：单口窗套，15：双口外飘窗的立口，16：单口外飘窗的立口
		...
		else if (mmdglxbm.equals("41") || mmdglxbm.equals("42") || mmdglxbm.equals("43") || mmdglxbm.equals("44") || mmdglxbm.equals("45") || mmdglxbm.equals("46") || mmdglxbm.equals("47") || mmdglxbm.equals("48"))//41:踢脚线，42:外飘窗的平台上口,43-48:欧式上帽
		{
		...
		else if (mmdglxbm.equals("51"))//41:护角（扣角、边条）
		{
