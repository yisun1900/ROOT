...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,jc_mmydd.pdgc,mmcljs,sccsj,jc_mmydd.jhccsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,sq_dwxx.dwmc,jc_mmydd.bz  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.sccsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgCcList.jsp","","","XgCcJc_mmydd.jsp");

//设置显示列
	String[] disColName={"clztmc","pdgc","mmcljs","sccsj","jhccsj","yddbh","khxm","hth","fwdz","wjqk","xmzy","clgw","ztjjgw","dwmc","bz"};
...
//设置按钮参数
	String[] buttonName={"删除初测明细"};//按钮的显示名称
	String[] buttonLink={"DeleteCcJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改初测单</font></B>
</CENTER>
<%
	pageObj.out=out;
