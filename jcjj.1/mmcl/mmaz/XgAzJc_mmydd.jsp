...
<div align="center">木门预订单---修改木门安装信息</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF">
      ...
      <td width="23%" bgcolor="#E8E8FF" align="right">送货时间</td>
      <td width="27%">
        <input type="text" name="sshsj" size="20" maxlength="10" value="<%=jc_mmydd_sshsj%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">安装开始时间</td>
      <td width="28%"> 
        <input type="text" name="azkssj" size="20" maxlength="10" value="<%=jc_mmydd_azkssj%>" onDblClick="JSCalendar(this)">
      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">安装结束时间</td>
      <td width="27%"> 
        <input type="text" name="azjssj" size="20" maxlength="10" value="<%=jc_mmydd_azjssj%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">延迟原因</td>
      <td width="28%">
...
%> 
      ...
      <td width="23%" bgcolor="#E8E8FF" align="right">安装状态</td>
      <td width="27%"><%
	cf.radioToken(out, "clzt","11+正在安装&15+安装完成","");
%> </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">延迟说明</td>
      <td colspan="3"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      <td height="39" colspan="4" align="center"> 
          ...
          <p> 
            <input type="button"  value="录入安装售服单" onClick="f_do1(selectform)" name="lr" >
            <input type="button"  value="修改安装售服单" onClick="f_do2(selectform)" name="ck" >
...
%> </td>
  ...
  <tr bgcolor="#99CCFF"> 
    <td width="19%" align="right" bgcolor="#99CCFF"> 
      安装开始时间    </td>
    <td width="31%"> <%=jc_mmydd_azkssj%> </td>
    <td width="18%" align="right"> 
      安装结束时间    </td>
...
%> </td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="19%" align="right">延迟说明</td>
    <td colspan="3"><%=jc_mmydd_ycsm%></td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="19%" align="right">真实延迟原因</td>
    <td width="31%"><%
...
%></td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="19%" align="right">延迟核实情况</td>
    <td colspan="3"><%=jc_mmydd_ychsqk%></td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="19%" align="right"> 
      延迟核实人    </td>
    <td width="31%"> <%=jc_mmydd_ychsr%> </td>
    <td width="18%" align="right"> 
      延迟核实时间    </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgAzJc_mmydd.jsp";
	FormName.submit();
	return true;
}
