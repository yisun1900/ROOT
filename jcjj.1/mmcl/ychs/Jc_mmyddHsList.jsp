...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,DECODE(jc_mmydd.ycclzt,'1','延迟未核实','2','延迟原因属实','3','延迟原因不属实','4','延迟已处理') ycclzt,mmycyymc,jc_mmydd.ycsm,jc_mmydd.pdgcmc,paidr,azkssj,kazsj,aztzsj,azjssj,jhazsj,mmcljs,sshsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.lxfs,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.pdgc,jc_mmydd.ppmc,jc_mmydd.gys,jc_mmydd.bz  ";
	ls_sql+=" FROM crm_khxx,jc_mmydd,jdm_mmyddzt,jdm_mmycyybm";
    ls_sql+=" where jc_mmydd.khbh=crm_khxx.khbh(+)";
    ls_sql+=" and jc_mmydd.mmycyybm=jdm_mmycyybm.mmycyybm(+)";
	ls_sql+=" and jc_mmydd.clzt=jdm_mmyddzt.clzt(+)";
    ls_sql+=" and (jc_mmydd.ycclzt='1' or jc_mmydd.ycclzt is null) ";
	if (yhjs.equals("G0"))
	{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddHsList.jsp","","","HsJc_mmydd.jsp");
	pageObj.setEditStr("处理");
//设置显示列
	String[] disColName={"yddbh","khxm","ycclzt","mmycyymc","ycsm","azkssj","azjssj","aztzsj","kazsj","jhazsj","pdgcmc","lxfs","fwdz","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","pdgc","ppmc","gys","bz"};
...
<CENTER >
  <B><font size="3">木门预订单--延迟处理</font></B>
</CENTER>
<%
	pageObj.out=out;
