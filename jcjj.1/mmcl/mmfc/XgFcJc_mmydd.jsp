...
<div align="center">木门预订单---修改复测 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="18%" bgcolor="#E8E8FF" align="right">实复测时间</td>
      <td width="32%"> 
        <input type="text" name="sfcsj" size="20" maxlength="20" value="<%=sfcsj%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="18%" bgcolor="#E8E8FF" align="right">复测录入时间</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      <td colspan="4" align="center"> 
          ...
          <input type="button"  value="录入复测单明细" onClick="f_do2(selectform)" name="ck" >
...
*/
	FormName.action="SaveXgFcJc_mmydd.jsp";
	FormName.submit();
	return true;
}
