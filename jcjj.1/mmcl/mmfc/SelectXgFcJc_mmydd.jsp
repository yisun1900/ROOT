...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---修改复测</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">实复测时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_sfcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_sfcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">复测录入时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_fclrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_fclrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_sfcsj, "实复测时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_sfcsj2, "实复测时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_fclrsj, "复测录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_fclrsj2, "复测录入时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddXgFcList.jsp";
