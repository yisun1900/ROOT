...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.tzfcsj,jc_mmydd.ffctzr,jc_mmydd.pdgcmc,mmcljs,jc_mmydd.htje,jc_mmydd.mmhtje,jc_mmydd.wjhtje,jc_mmydd.blhtje,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.lrsj,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.tzfcsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddFcList.jsp","","","FcJc_mmydd.jsp");


//设置主键
	String[] keyName={"yddbh"};
	pageObj.setKey(keyName);
	pageObj.setEditStr("复测");
...
<CENTER >
  <B><font size="3">木门预订单---木门复测</font></B>
</CENTER>
<%
	pageObj.out=out;
