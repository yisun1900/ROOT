...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jc_mmydd_sfcsj=request.getParameter("jc_mmydd_sfcsj");
	if (jc_mmydd_sfcsj!=null)
	{
		jc_mmydd_sfcsj=jc_mmydd_sfcsj.trim();
		if (!(jc_mmydd_sfcsj.equals("")))	wheresql+="  and (jc_mmydd.sfcsj>=TO_DATE('"+jc_mmydd_sfcsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_sfcsj=request.getParameter("jc_mmydd_sfcsj2");
	if (jc_mmydd_sfcsj!=null)
	{
		jc_mmydd_sfcsj=jc_mmydd_sfcsj.trim();
		if (!(jc_mmydd_sfcsj.equals("")))	wheresql+="  and (jc_mmydd.sfcsj<=TO_DATE('"+jc_mmydd_sfcsj+"','YYYY-MM-DD'))";
	...
	String jc_mmydd_fclrsj=null;
	jc_mmydd_fclrsj=request.getParameter("jc_mmydd_fclrsj");
	if (jc_mmydd_fclrsj!=null)
	{
		jc_mmydd_fclrsj=jc_mmydd_fclrsj.trim();
		if (!(jc_mmydd_fclrsj.equals("")))	wheresql+="  and (jc_mmydd.fclrsj>=TO_DATE('"+jc_mmydd_fclrsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_fclrsj=request.getParameter("jc_mmydd_fclrsj2");
	if (jc_mmydd_fclrsj!=null)
	{
		jc_mmydd_fclrsj=jc_mmydd_fclrsj.trim();
		if (!(jc_mmydd_fclrsj.equals("")))	wheresql+="  and (jc_mmydd.fclrsj<=TO_DATE('"+jc_mmydd_fclrsj+"','YYYY-MM-DD'))";
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.fclrsj,jc_mmydd.sfcsj,jc_mmydd.fclrr,jc_mmydd.pdgcmc,mmcljs,jc_mmydd.htje,jc_mmydd.mmhtje,jc_mmydd.wjhtje,jc_mmydd.blhtje,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.fclrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgFcList.jsp","","","XgFcJc_mmydd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除复测"};//按钮的显示名称
	String[] buttonLink={"DeleteFcJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改复测</font></B>
</CENTER>
<%
	pageObj.out=out;
