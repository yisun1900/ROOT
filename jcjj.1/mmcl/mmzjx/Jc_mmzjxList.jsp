...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and jc_mmzjx.clzt in('00','01')";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by jc_mmzjx.lrsj desc";

//	out.println(ls_sql);

    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmzjxList.jsp","","","EditJc_mmzjx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteEndJc_mmzjx.jsp","DeleteJc_mmzjx.jsp?"};//按钮单击调用的网页，可以增加参数
...
//设置列超级连接
	...
	coluParm.link="ViewJc_mmzjx.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
