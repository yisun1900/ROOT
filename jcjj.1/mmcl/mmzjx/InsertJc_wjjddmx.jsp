...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">请录入五金件增项明细（增减项序号：<%=zjxxh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
              ...
              <td width="16%" align="right">锁把手</td>
              <td width="34%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="xinghao" value="" size="71" maxlength="50" >
                <input type="hidden" name="xinghao1" value="" size="30" maxlength="30" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right"><font color="#0000CC">单价</font></td>
              <td width="33%"> 
                <input type="text" name="dj" value="" size="20" maxlength="9" readonly>
              </td>
              <td width="16%" align="right">订购数量</td>
              <td width="34%"> 
                <input type="text" name="zjhsl" value="" size="20" maxlength="8" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.zjhsl, "订购数量"))) {
		return false;
	}
