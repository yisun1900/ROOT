...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveQxYddJc_mmydd.jsp" name="selectform">

<div align="center">木门预订单---取消预订单(预订单编号：<%=yddbh%>) 
...
if (count>0)
{
	%>
	<BR>
	<font color="#FF0033"><b>错误！本订单未签合同，确发生过增减项，请检查原因</b></font> 
	<%
	return;
}
%>
