...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		jc_mmydd_paidsj=jc_mmydd_paidsj.trim();
	...
	ls_sql="SELECT yddbh,jc_mmydd.pdgcmc,jc_mmydd.tdlrr,jc_mmydd.tdsj,jc_mmydd.kclf,jctdyymc,jc_mmydd.tdsm,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.gys,jc_mmydd.ppmc,sq_dwxx.dwmc,jc_mmydd.bz  ";
	ls_sql+=" FROM crm_khxx,jc_mmydd,sq_dwxx,jdm_mmyddzt,jdm_jctdyybm";
    ls_sql+=" where jc_mmydd.khbh=crm_khxx.khbh(+) and crm_khxx.dwbh=sq_dwxx.dwbh(+)";
	ls_sql+=" and jc_mmydd.clzt=jdm_mmyddzt.clzt(+)";
	ls_sql+=" and jc_mmydd.jctdyybm=jdm_jctdyybm.jctdyybm(+)";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.tdsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgQxYddList.jsp","","","ScQxYdd.jsp");
//设置显示列
	String[] disColName={"clztmc","khxm","hth","fwdz","yddbh","pdgcmc","tdlrr","tdsj","kclf","jctdyymc","tdsm","wjqk","sqdj","xmzy","clgw","ztjjgw","gys","ppmc","lrsj","dwmc","bz"};
...
<CENTER >
  <B><font size="3">木门预订单---修改取消预订单</font> 
</CENTER>
<%
	pageObj.out=out;
