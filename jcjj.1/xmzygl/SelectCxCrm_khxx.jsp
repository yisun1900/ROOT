...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="31%"> 
                <input type="text" name="crm_khxx_qyrq" size="20" maxlength="10" value="" >              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="crm_khxx_qyrq2" size="20" maxlength="10" >              </td>
            </tr>
            <tr bgcolor="#CCFFFF"> 
...
%> 
            ...
            <tr bgcolor="#E8E8FF"> 
              ...
              <td width="31%"> 
                <input type="text" name="crm_khxx_khbh" size="20" maxlength="20" >              </td>
              <td width="17%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="text" name="ywy" size="20" maxlength="20" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right">施工队是否在职</div>              </td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" bgcolor="#FFFFCC"> 
                <div align="right">合同开工日期 从</div>              </td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="crm_khxx_sjkgrq" size="20" maxlength="10" >              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="crm_khxx_sjkgrq2" size="20" maxlength="10" >              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="crm_khxx_sjjgrq" size="20" maxlength="10" >              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="crm_khxx_sjjgrq2" size="20" maxlength="10" >              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">实完结日期 从</td>
              <td width="31%"> 
                <input type="text" name="sjwjrq" size="20" maxlength="10" >              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="sjwjrq2" size="20" maxlength="10" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
