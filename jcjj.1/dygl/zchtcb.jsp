...
<%
	...
	if (yhjs.equals("G0"))
	{
		if (xclbz.equals("1"))//1：非定制式产品；2：定制式产品
		{
			if (clzt.compareTo("13")<0 || clzt.equals("99"))//13：工厂已接收
			{
				out.println("错误！非定制式产品工厂未接收或退单的合同不能打印:"+clzt.compareTo("13"));
				return;
			}
		}
	}
...
//设置按钮参数
	...
	String[] buttonLink={"zcfjhbcb.jsp"};//按钮单击调用的网页，可以增加参数
