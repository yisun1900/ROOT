...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgjgbList.jsp","SelectJc_cgjgb.jsp","","EditJc_cgjgb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Jc_cgjgbList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[1]="delete from jc_dgjgb where "+chooseitem;
		sql[2]="delete from jc_cgjgb where "+chooseitem;
