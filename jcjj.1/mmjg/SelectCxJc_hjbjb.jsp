...
<form method="post" action="Jc_hjbjbCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">所属地区</td>
              <td width="33%"> 
                <select name="dqbm" style="FONT-SIZE:12PX;WIDTH:180PX" >
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <select name="jc_hjbjb_mmdglxbm" style="FONT-SIZE:12PX;WIDTH:180PX">
                  <option value=""></option>
                  <%
...
%> 
              ...
              <td width="33%"> 
                <select name="jc_hjbjb_kdjgqjbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3">
                <select name="jc_hjbjb_ysbm" style="FONT-SIZE:12PX;WIDTH:520PX">
                  <option value=""></option>
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%">
                <input type="text" name="jc_hjbjb_dj" size="20" maxlength="17" >
              </td>
              <td width="17%"> 
                <div align="right"></div>
              </td>
...
{
	if(!(isFloat(FormName.jc_hjbjb_dj, "单价"))) {
		return false;
	}
	FormName.submit();
	return true;
