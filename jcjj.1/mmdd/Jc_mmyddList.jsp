...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,clztmc,jc_mmydd.lrsj,a.dwmc lrdw ";
...
//设置按钮参数
	...
	String[] buttonLink={"Jc_mmyddList.jsp?"};//按钮单击调用的网页，可以增加参数
