...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmdgdmxList.jsp?yddbh="+yddbh,"","","EditJc_mmdgdmxMain.jsp");
	pageObj.setPageRow(1000);//设置每页显示记录数

//设置显示列
	String[] disColName={"mmdglxmc","mlxmc","mmxh","mmczmc","czmc","azwzmc","kqfxmc","mtxmc","mxxmc","dczlmc","dbh","md","tjx","blxh","ctbs","sfsmjcc","sfydc","sl","bzdj","dj","zj","zp","bz","sfzdjj"};
...
<CENTER >
  <B><font size="3">木门合同明细（单号：<%=yddbh%>）</font></B>
</CENTER>
<%
	pageObj.out=out;
