...
try {
	...
	ls_sql+=" ,zjhmmje,zjhwjje,zjhblje,zqzjhmmje,zqzjhwjje,zqzjhblje,jc_mmydd.zqzjhze,jc_mmydd.zjhze,mmzkl,wjzkl,blzkl,dzyy,aztxbz,jc_mmydd.khjl ";
	...
	ls_sql=" select dh ";
	ls_sql+=" from sq_yhxx";
	ls_sql+=" where zwbm='05' and ssfgs='"+ssfgs+"' and yhmc ='"+crm_khxx_zjxm+"'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
	if (rs.next())
	{
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门订单（订单编号：<%=jc_mmydd_yddbh%>）
    </div></td>
  </tr>
  <tr>
    <td width="100%" > 
...
%></td>
            <td width="17%" align="right">家装设计师</td>
...
%>（<%=dzdh%>） </td>
          ...
          <tr bgcolor="#CCFFCC"> 
            <td width="17%" align="right" bgcolor="#CCFFCC">参加促销活动</td>
          ...
          <tr bgcolor="#99CCFF"> 
            <td width="17%" align="right" bgcolor="#CCFFCC"> 
              订单状态            </td>
...
%> </td>
            <td width="17%" align="right" bgcolor="#CCFFCC">家装设计师 </td>
            <td width="33%" bgcolor="#CCFFCC"><%=jzsjs%> </td>
          </tr>
          <tr bgcolor="#99CCFF">
            <td align="right" bgcolor="#CCFFCC">所属分公司</td>
            <td bgcolor="#CCFFCC"><%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwbh='"+mmfgsbh+"'",mmfgsbh,true);
%>            </td>
            <td align="right" bgcolor="#CCFFCC">所属店面</td>
            <td bgcolor="#CCFFCC"><%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwbh='"+qddm+"'",qddm,true);
%>            </td>
          </tr>
          <tr bgcolor="#99CCFF">
            <td align="right" bgcolor="#CCFFCC">客户经理</td>
            <td bgcolor="#CCFFCC"><%=khjl%></td>
          ...
          <tr bgcolor="#99CCFF">
            <td align="right"><span class="STYLE6">五金情况</span></td>
            <td><%
	cf.radioToken(out, "1+客户自购&2+公司购买",jc_mmydd_wjqk,true);
%></td>
            <td align="right"><span class="STYLE6">自购五金件送到公司 </span></td>
            <td><%
	cf.selectToken(out,"Y+已送公司&N+未送公司",jc_mmydd_wjsgsbz,true);
%></td>
          </tr>
          <tr bgcolor="#99CCFF">
            <td align="right"><span class="STYLE6"> 送五金时间 </span></td>
            <td bgcolor="#99CCFF"><%=jc_mmydd_swjsj%> </td>
            <td align="right"><span class="STYLE6"> 五金接收人 </span></td>
            <td><%=jc_mmydd_wjjsr%> </td>
          </tr>
          <tr bgcolor="#99CCFF">
            <td align="right"><span class="STYLE6">五金接收情况</span></td>
          ...
          <tr align="right" bgcolor="#FFFFFF">
            <td colspan="4" align="center" bgcolor="#FFFFFF"><div align="center">
                ...
                <input type="button" value="增减项" onClick="window.open('/jcjj/mmdd/ViewJc_mmzjx.jsp?yddbh=<%=yddbh%>')" >            </td>
          </tr>
          <tr bgcolor="#CCCCFF">
          ...
          <tr bgcolor="#CCCCFF">
			...
			<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
                ...
                <tr align="center" bgcolor="#FFFFFF">
                  <td>&nbsp;</td>
                  <td>折扣率</td>
                  <td><strong>合同金额－折前</strong></td>
                  <td><span class="STYLE1"><strong>合同金额</strong>－折后</span></td>
                  <td><strong>增减后总额－折前</strong></td>
                  <td><span class="STYLE2"><strong>增减后总额－折后</strong></span></td>
                </tr>
                <tr align="center" bgcolor="#FFFFFF">
                  <td width="11%">木门</td>
                  <td width="9%"><%=mmzkl%></td>
                  <td width="20%"><%=zqmmhtje%> </td>
                  <td width="20%"><span class="STYLE2"><%=mmhtje%> </span></td>
                  <td width="20%"><%=zqzjhmmje%></td>
                  <td width="20%"><span class="STYLE2"><%=zjhmmje%></span></td>
                </tr>
                <tr align="center" bgcolor="#FFFFFF">
                  <td>五金</td>
                  <td><%=wjzkl%></td>
                  <td><%=zqwjhtje%></td>
                  <td><span class="STYLE2"><%=wjhtje%></span></td>
                  <td><%=zqzjhwjje%></td>
                ...
                <tr align="center" bgcolor="#FFFFFF">
                  <td width="11%">玻璃</td>
                  <td width="9%"><%=blzkl%></td>
                  <td width="20%"><%=zqblhtje%> </td>
                  <td width="20%"><span class="STYLE2"><%=blhtje%> </span></td>
                  <td width="20%"><%=zqzjhblje%></td>
                  <td width="20%"><span class="STYLE2"><%=zjhblje%></span></td>
                </tr>
                 <tr align="center" bgcolor="#FFFFFF">
                  <td bgcolor="#FFFFFF">合计</td>
                  <td bgcolor="#FFFFFF">&nbsp;</td>
                  <td bgcolor="#FFFFFF"><U><%=wdzje%></U></td>
                  <td bgcolor="#FFFFFF" class="STYLE2"><U><%=htje%></U></td>
                  <td bgcolor="#FFFFFF"><U><%=zqzjhze%></U></td>
                  <td bgcolor="#FFFFFF"><span class="STYLE1"><U><%=zjhze%></U></span></td>
                </tr>
           </table></td>
          </tr>
          <tr bgcolor="#CCCCFF">
