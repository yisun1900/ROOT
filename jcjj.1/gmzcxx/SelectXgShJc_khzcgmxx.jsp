...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_khzcgmxxXgShList.jsp" name="selectform">
<div align="center">主材购买信息－审核修改</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td><div align="right"><font color="#0000CC"><b>联系方式</b></font></div></td>
...
<tr bgcolor="#FFFFFF">
  <td height="26" colspan="4" align="center">主材购买信息</td> 
  </tr>
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%"><input name="jc_khzcgmxx_clzt" type="radio" value="Y" checked>
    审核</td>
</tr>
<tr bgcolor="#FFFFFF">
