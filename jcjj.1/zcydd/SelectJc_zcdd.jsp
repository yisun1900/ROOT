...
<form method="post" action="Jc_zcddList.jsp" name="selectform">
...
if (yhjs.equals("A0"))
{
	...
	<tr bgcolor="#FFFFFF">
	  <td align="right"> 录入人 </td>
	  <td>
		  <input type="text" name="jc_zcdd_lrr" size="20" maxlength="20" value="<%=yhmc%>" readonly="true">              </td>
	  <td align="right">录入部门</td>
	  <td><select name="jc_zcdd_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
		  <%
