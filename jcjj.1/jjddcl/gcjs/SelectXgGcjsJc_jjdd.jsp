...
<form method="post" action="Jc_jjddXgGcjsList.jsp" name="selectform">
      <div align="center">家具订单处理--修改工厂接收</div>
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input name="gcjssj" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
              <td align="right">到</td>
              <td><input name="gcjssj2" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
            </tr>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                工厂接收人              </td>
              <td width="31%"> 
                <input type="text" name="jc_jjdd_gcjsr" size="20" maxlength="20" >              </td>
              <td width="19%" align="right"> 
                录入部门              </td>
              <td width="31%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.gcjssj2, "工厂接收时间"))) {
		return false;
	}
