...
try {
	...
	ls_sql="select jjsjs,pdgc,jc_jjdd.pdr,jc_jjdd.pdsj,jc_jjdd.pdsm,sjsgpyybm,fgsbh";
	ls_sql+=" from  jc_jjdd";
...
<form method="post" action="SaveXgPdJc_cgdd.jsp" name="insertform" >
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">家具订单处理--修改设计师（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="hidden" name="oldjjsjs" value="<%=jjsjs%>">
...
%> 
              ...
              <td width="32%">
                <select name="sjsgpyybm" style="FONT-SIZE:12PX;WIDTH:180PX">
                  <option value=""></option>
                  <%
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (FormName.oldjjsjs.value!=FormName.jjsjs.value)
	{
