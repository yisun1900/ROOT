...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.sccsj,jc_jjdd.jhccsj,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.ccbz,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.lrr,sq_dwxx.dwmc,jc_jjdd.khbh,crm_khxx.sjs,cxhdbm ";
	ls_sql+=" FROM jc_jjdd,jdm_jjddzt,sq_dwxx,crm_khxx";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.sccsj";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddHtList.jsp","","","HtJc_jjdd.jsp");
...
<CENTER >
  <B><font size="3">家具订单处理--签订合同</font></B>
</CENTER>
<%
	pageObj.out=out;
