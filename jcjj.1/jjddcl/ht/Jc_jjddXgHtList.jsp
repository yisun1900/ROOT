...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jc_jjdd_qhtr=request.getParameter("jc_jjdd_qhtr");
	if (jc_jjdd_qhtr!=null)
	{
		jc_jjdd_qhtr=cf.GB2Uni(jc_jjdd_qhtr);
		if (!(jc_jjdd_qhtr.equals("")))	wheresql+=" and  (jc_jjdd.qhtr='"+jc_jjdd_qhtr+"')";
	}
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.qhtsj,jc_jjdd.qhtr,crm_khxx.khxm khxm,crm_khxx.fwdz,TO_CHAR(jc_jjdd.jjzkl) jjzkl,jc_jjdd.dzyy,jc_jjdd.htze,jc_jjdd.jjje,jc_jjdd.xcmje,jc_jjdd.cpjjje,jc_jjdd.wdzje,jc_jjdd.zqjjje,jc_jjdd.zqxcmje,jc_jjdd.zqcpjjje,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.khbh,crm_khxx.sjs,cxhdbm ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.qhtsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgHtList.jsp","","","XgHtJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteHtJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改合同</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">折扣率</td>
	<td  width="10%">打折原因</td>
	<td  width="4%"><font color="#0000CC"><strong>合同总额</strong></font></td>
	<td  width="4%"><font color="#0000CC"><strong>家具合同额-折后</strong></font></td>
	<td  width="4%"><font color="#0000CC"><strong>型材门金额-折后</strong></font></td>
	<td  width="4%"><font color="#0000CC"><strong>成品家具-折后</strong></font></td>
	<td  width="4%"><strong>未打折金额</strong></td>
	<td  width="4%"><strong>家具合同额-折前</strong></td>
	<td  width="4%"><strong>型材门金额-折前</strong></td>
	<td  width="4%"><strong>成品家具-折前</strong></td>
	<td  width="3%">家居设计师</td>
	<td  width="3%">项目专员</td>
