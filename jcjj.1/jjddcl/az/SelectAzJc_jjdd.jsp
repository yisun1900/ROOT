...
<form method="post" action="Jc_jjddAzList.jsp" name="selectform">
      <div align="center">家具订单处理--安装</div>
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="31%"> 
                <input type="text" name="aztzsj" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
                <input type="text" name="aztzsj2" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
