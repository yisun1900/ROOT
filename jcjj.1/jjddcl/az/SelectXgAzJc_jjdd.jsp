...
<form method="post" action="Jc_jjddXgAzList.jsp" name="selectform">
      <div align="center">家具订单处理--修改安装</div>
...
%>
	...
	<tr bgcolor="#FFFFCC"> 
	  ...
	  <td width="31%"> 
	  <input type="text" name="jc_jjdd_ksazsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_jjdd_ksazsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_jjdd_ksazsj, "开始安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_jjdd_ksazsj2, "开始安装时间"))) {
		return false;
	}
