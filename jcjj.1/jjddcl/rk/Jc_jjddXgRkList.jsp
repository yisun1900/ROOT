...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		rksj=cf.GB2Uni(rksj);
		if (!(rksj.equals("")))  wheresql+="  and (jc_jjdd.rksj>=TO_DATE('"+rksj+"','YYYY/MM/DD'))";
	}
	...
	jc_jjdd_rkr=request.getParameter("jc_jjdd_rkr");
	if (jc_jjdd_rkr!=null)
	{
		jc_jjdd_rkr=cf.GB2Uni(jc_jjdd_rkr);
		if (!(jc_jjdd_rkr.equals("")))	wheresql+=" and  (jc_jjdd.rkr='"+jc_jjdd_rkr+"')";
	}
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.rksj,jc_jjdd.rkr,jc_jjdd.htze,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.khbh,crm_khxx.sjs ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.rksj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgRkList.jsp","","","XgRkJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRkJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改入库</font></B>
</CENTER>
<%
	pageObj.out=out;
