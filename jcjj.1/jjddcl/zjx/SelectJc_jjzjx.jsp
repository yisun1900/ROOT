...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_jjzjxList.jsp" name="selectform">
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">家具工厂</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">家具品牌</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">家具供应商</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">型材门工厂</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">型材门品牌</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">型材门供应商</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">确认时间</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">实入库时间</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="jc_jjzjx_lrr" size="20" maxlength="20" value="<%=yhmc%>" readonly>
      </td>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">增减项发生时间 从</td>
      <td width="32%"> 
