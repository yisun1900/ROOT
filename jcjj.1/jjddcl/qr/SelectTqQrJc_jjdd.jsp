...
<form method="post" action="Jc_jjddTqQrList.jsp" name="selectform">
      <div align="center">家具订单处理--交款确认--特权</div>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                签合同人              </td>
              <td width="31%"> 
                <input type="text" name="jc_jjdd_qhtr" size="20" maxlength="20" >              </td>
              <td width="19%" align="right"> 
                录入部门              </td>
              <td width="31%"> 
