...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		tdsj=cf.GB2Uni(tdsj);
		if (!(tdsj.equals("")))  wheresql+="  and (jc_jjdd.tdsj>=TO_DATE('"+tdsj+"','YYYY/MM/DD'))";
	}
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.tdsj,jc_jjdd.tdblr,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.lrr,jc_jjdd.lrsj,dwmc,jc_jjdd.jjsjs,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.xmzy,jc_jjdd.khbh";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.tdsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgQxYddList.jsp","","","XgQxYddJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQxYddJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改取消预订单</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">订单编号</td>
	<td  width="7%">处理状态</td>
	<td  width="7%">取消预订单时间</td>
	<td  width="5%">取消预订单办理人</td>
	<td  width="5%">客户姓名</td>
	<td  width="17%">房屋地址</td>
	<td  width="5%">录入人</td>
	<td  width="7%">录入时间</td>
