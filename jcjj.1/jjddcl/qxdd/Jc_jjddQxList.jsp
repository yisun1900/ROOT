...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.kazsj,jc_jjdd.kazsjlrr,jc_jjdd.azsjbz,jc_jjdd.jjsjs,jc_jjdd.aztzsj,jc_jjdd.qhtsj,jc_jjdd.jhazrq  ,jc_jjdd.htze,jc_jjdd.zjhze,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.xmzy,crm_khxx.hth,jc_jjdd.khbh ";
	ls_sql+=" FROM jc_jjdd,jdm_jjddzt,crm_khxx";
	ls_sql+=" where jc_jjdd.clzt=jdm_jjddzt.clzt(+)";
	ls_sql+=" and jc_jjdd.khbh=crm_khxx.khbh(+)";
    ls_sql+=" and jc_jjdd.clzt not in('00','01','03','05','07','35','98','99')";
	if (yhjs.equals("G0"))
	{
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddQxList.jsp","","","QxddJc_jjdd.jsp");
...
<CENTER >
  <B><font size="3">家具订单处理--退单</font></B>
</CENTER>
<%
	pageObj.out=out;
