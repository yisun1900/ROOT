...
<form method="post" action="Jc_jjddXgPgcList.jsp" name="selectform">
      <div align="center">家具订单处理--修改工厂</div>
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">派工厂时间 从</td>
              <td><input name="pgcsj" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
              <td align="right">到</td>
              <td><input name="pgcsj2" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
            </tr>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                派工厂人              </td>
              <td width="31%"> 
                <input type="text" name="jc_jjdd_pgcr" size="20" maxlength="20" >              </td>
              <td width="19%" align="right"> 
                录入部门              </td>
              <td width="31%"> 
