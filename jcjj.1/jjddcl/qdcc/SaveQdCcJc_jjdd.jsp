...
try {
	...
	ls_sql="update jc_jjdd set jhccxgsj=?,jhccxgr=?,jhccxgyy=?,jhccsj=?,clzt=?";
	...
	ls_sql="insert into jc_jjsjslxjl (jlh,ddbh,jjsjs,jhclsj,clzt,lrr,lrsj,bz) ";
	ls_sql+=" values(?,?,?,?,?,?,?,?)";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,jlh);
	ps.setString(2,ddbh);
	ps.setString(3,jjsjs);
	ps.setDate(4,jhccsj);
	ps.setString(5,clzt);
