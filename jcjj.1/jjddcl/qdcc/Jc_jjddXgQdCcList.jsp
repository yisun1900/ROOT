...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.pdsj,jc_jjdd.jhccsj,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.lrr,sq_dwxx.dwmc,jc_jjdd.khbh,crm_khxx.hth,ysgcjdmc,crm_khxx.sjs,cxhdbm ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.jhccsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgQdCcList.jsp","","","XgQdCcJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQdCcJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改初测时间</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">订单编号</td>
	<td  width="6%">处理状态</td>
	<td  width="5%">派设计师时间</td>
	<td  width="5%">计划初测时间</td>
	<td  width="5%">客户姓名</td>
	<td  width="13%">房屋地址</td>
	<td  width="4%">家居设计师</td>
	<td  width="4%">项目专员</td>
