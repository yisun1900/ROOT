...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.kazsj";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddAztzList.jsp","","","AztzJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"SavePlAztzJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--安装通知</font></B>
</CENTER>
<%
	pageObj.out=out;
