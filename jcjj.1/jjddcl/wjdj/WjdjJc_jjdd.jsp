...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">完结（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF">完结录入人</td>
              <td width="29%"> 
                <input type="text" name="wjlrr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>
              </td>
              <td width="21%" align="right">完结时间</td>
              <td width="29%"> 
                <input type="text" name="wjsj" size="20" maxlength="20"  value="<%=cf.today()%>" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveWjdjJc_jjdd.jsp";
	FormName.submit();
	return true;
}
//-->
