...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_jjdd_kazsjlrr=null;
	jc_jjdd_kazsjlrr=request.getParameter("jc_jjdd_kazsjlrr");
	if (jc_jjdd_kazsjlrr!=null)
	{
		jc_jjdd_kazsjlrr=cf.GB2Uni(jc_jjdd_kazsjlrr);
		if (!(jc_jjdd_kazsjlrr.equals("")))	wheresql+=" and  (jc_jjdd.kazsjlrr='"+jc_jjdd_kazsjlrr+"')";
	}
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.kazsj,jc_jjdd.kazsjlrr,jc_jjdd.azsjbz,jc_jjdd.jjsjs,jc_jjdd.rksj,jc_jjdd.qhtsj,jc_jjdd.jhazrq  ,jc_jjdd.htze,jc_jjdd.zjhze,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.xmzy,crm_khxx.hth,jc_jjdd.khbh ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.kazsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgQdsjList.jsp","","","XgQdsjJc_jjdd.jsp");
//	pageObj.setEditStr("安装时间");//设置每页显示记录数

//设置主键
	String[] keyName={"ddbh"};
	pageObj.setKey(keyName);
//设置按钮参数
	String[] buttonName={"删除安装时间"};//按钮的显示名称
	String[] buttonLink={"DeleteQdsjJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改安装时间</font></B>
</CENTER>
<%
	pageObj.out=out;
