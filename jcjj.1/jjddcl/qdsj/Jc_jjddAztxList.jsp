...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.jhazrq,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.rksj,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.khbh,crm_khxx.sjs ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddAztxList.jsp","","","AztxJc_jjdd.jsp");
...
<CENTER >
  <B><font size="3">家具订单处理--安装提醒</font></B>
</CENTER>
<%
	pageObj.out=out;
