...
<form method="post" action="Jc_jjddXgYcclList.jsp" name="selectform">
      <div align="center">家具订单处理--修改延迟处理</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#FFFFFF">延迟核实时间 从</td>
	  <td><input type="text" name="jc_jjdd_ychssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
	  <td align="right">到</td>
	  <td><input type="text" name="jc_jjdd_ychssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
	  </tr>
	<tr bgcolor="#FFFFFF">
	  <td align="right" bgcolor="#FFFFFF">延迟处理状态</td>
	  <td><select name="ycclzt" style="FONT-SIZE:12PX;WIDTH:152PX">
        <option value=""></option>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_jjdd_sazrq, "安装完成时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_jjdd_sazrq2, "安装完成时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_jjdd_ychssj, "延迟核实时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_jjdd_ychssj2, "延迟核实时间"))) {
		return false;
	}
