...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_jjdd_ychssj=null;
	jc_jjdd_ychssj=request.getParameter("jc_jjdd_ychssj");
	if (jc_jjdd_ychssj!=null)
	{
		jc_jjdd_ychssj=jc_jjdd_ychssj.trim();
		if (!(jc_jjdd_ychssj.equals("")))	wheresql+="  and (jc_jjdd.ychssj>=TO_DATE('"+jc_jjdd_ychssj+"','YYYY/MM/DD'))";
	}
	jc_jjdd_ychssj=request.getParameter("jc_jjdd_ychssj2");
	if (jc_jjdd_ychssj!=null)
	{
		jc_jjdd_ychssj=jc_jjdd_ychssj.trim();
		if (!(jc_jjdd_ychssj.equals("")))	wheresql+="  and (jc_jjdd.ychssj<=TO_DATE('"+jc_jjdd_ychssj+"','YYYY/MM/DD'))";
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,DECODE(jc_jjdd.ycclzt,'0','未延迟','1','延迟未核实','2','延迟原因属实','3','延迟原因不属实') as ycclzt,b.mmycyymc zsycyybm,crm_khxx.khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.ychssj,jc_jjdd.ychsr,jc_jjdd.kazsj,jc_jjdd.aztzsj,jc_jjdd.ksazsj,jc_jjdd.sazrq,a.mmycyymc,clgw,jc_jjdd.ztjjgw,jc_jjdd.xmzy,jc_jjdd.jjsjs,jc_jjdd.khbh  ";
	ls_sql+=" FROM jc_jjdd,jdm_jjddzt,crm_khxx,jdm_mmycyybm a,jdm_mmycyybm b";
    ls_sql+=" where jc_jjdd.khbh=crm_khxx.khbh(+) and jc_jjdd.clzt=jdm_jjddzt.clzt(+)";
    ls_sql+=" and jc_jjdd.ycyybm=a.mmycyybm(+) and jc_jjdd.zsycyybm=b.mmycyybm(+)";
    ls_sql+=" and jc_jjdd.ycclzt in('2','3')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.ychssj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgYcclList.jsp","","","XgHsJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQrJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改延迟处理</font></B>
</CENTER>
<%
	pageObj.out=out;
