  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        通知测量时间      </td>
      <td width="32%"> 
        <input type="text" name="tzclsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
      <td width="18%" align="right"> 
        计划测量时间      </td>
    ...
    <tr> 
      <td colspan="4"> 
        <div align="center"> 
          ...
          <input type="button"  value="打印客户信息" onClick="window.open('/khxx/dyKhJbxx.jsp?khbh=<%=khbh%>')" >
