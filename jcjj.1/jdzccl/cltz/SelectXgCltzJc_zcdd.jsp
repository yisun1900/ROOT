...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－修改测量通知</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddXgCltzList.jsp" name="selectform">
...
{
	if(!(isDatetime(FormName.jc_zcdd_tzclsj, "通知测量时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_tzclsj2, "通知测量时间"))) {
		return false;
	}
