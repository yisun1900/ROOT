...
try {
	...
	ls_sql="select tzclsj,ztjjgw,htcxhdje,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,zjhze,ddqrr,ddqrsj";
	ls_sql+=" from  jc_zcdd";
...
<div align="center">修改测量通知（订单编号：<%=ddbh%>） 
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        通知测量时间      </td>
      <td width="32%"> 
        <input type="text" name="tzclsj" value="<%=tzclsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
      <td width="18%" align="right"> 
        计划测量时间      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        测量通知人      </td>
      <td width="32%"> 
        <input type="text" name="cltzr" value="<%=yhmc%>" size="20" maxlength="20" readonly>
      </td>
      <td width="18%"> 
    ...
    <tr> 
      ...
      <input type="button"  value="打印客户信息" onClick="window.open('/khxx/dyKhJbxx.jsp?khbh=<%=khbh%>')" name="button2" >      </td>
    </tr>
  </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.tzclsj, "通知测量时间"))) {
		return false;
	}

	FormName.action="SaveXgCltzJc_zcdd.jsp";
	FormName.submit();
	return true;
}
