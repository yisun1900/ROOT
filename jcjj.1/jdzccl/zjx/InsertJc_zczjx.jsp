...
try {
	...
	ls_sql="select wdzje,jc_zcdd.hkze,zczkl,dzyy,htcxhdje,zjxcxhdje,zqzjhze,zjhze,dzyy,zczkl,ddlx,ztjjgw,zcdlbm,zcxlbm,ppbm,gys,ppmc,khbh,clgw,jjsjs,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz";
	ls_sql+=" from  jc_zcdd";
...
%> </td>
            ...
            <tr bgcolor="#CCFFCC"> 
              <td width="16%" align="right" bgcolor="#CCFFCC"> 
                合同总额              </td>
              <td width="40%"> <%=hkze%> </td>
              <td width="18%" align="right"> 
                增减项金额              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#FF0033">*</font><font color="#0000CC"></font><font color="#0000CC">品牌供应商</font></td>
              <td width="40%"> 
                <input type="text" name="ppbm" value="<%=ppbm%>" readonly>              </td>
              <td width="18%" align="right"><font color="#FF0033">*</font><font color="#0000CC">&nbsp;</font><font color="#0000CC">增减项总额</font></td>
              <td width="26%"><input type="text" name="zjxze" value="0" size="20" maxlength="9" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#FF0000">*</font>增减项折扣</td>
              <td width="40%"><input type="text" name="zjxzkl" size="8" maxlength="8" value="<%=zczkl%>" readonly>
...
%>
              ...
              <td width="18%" align="right"><font color="#FF0033">*</font><font color="#0000CC">&nbsp;</font>合同送货时间</td>
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <BR>
                <BR>
                <input type="button"  value="增减[已购买]项目" onClick="f_oldp(insertform)" name="oldp" disabled>
                <input type="button"  value="新购－录入型号" onClick="f_lrxh(insertform)" name="lrxh" disabled>
                <input type="button"  value="新购－查询型号" onClick="f_cxxh(insertform)" name="cxxh" disabled>
                <input type="button"  value="新购[系统外]主材" onClick="f_newpsx(insertform)" name="newpsx" disabled>
