...
try {
	...
	if (zcbm!=null)
	{
		ls_sql="select cbj,zcbm,cxcbj,zcmc,zclbbm,xh,gg,zcysbm,yhj,sfbhpj,DECODE(sfbhpj,'Y','包含','N','不包含') sfbhpjmc,pjts,jldwbm,lsj,yhj,cxhdbl,sfycx,DECODE(sfycx,'N','没促销','Y','有促销') sfycxmc,cxj,cxkssj,cxjzsj,lscxhdbl,gys,bz";
