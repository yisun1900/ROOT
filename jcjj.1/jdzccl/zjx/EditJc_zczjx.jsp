    ...
    <tr> 
      <td height="2" colspan="4" align="center"> 
		<input type="hidden" name="ddlx" value="<%=ddlx%>" >
          ...
          <BR>
          <BR>
          <input type="button"  value="增减[已购买]项目" onClick="f_oldp(editform)" name="oldp" >
          <input type="button"  value="新购[系统内]主材" onClick="f_lrxh(editform)" name="newpbz" >
          <input type="button"  value="新购－查询型号" onClick="f_cxxh(editform)" name="cxxh" >
<%
	if (zdyhbz.equals("Y"))//Y：重点用户；N：非重点用户
	{
		%> 
          <input type="button"  value="新购[系统外]主材" onClick="f_newpsx(editform)" name="newpsx" >
          <%
	}
	else{
		%> 
          <input type="button"  value="新购[系统外]主材" onClick="f_newpsx(editform)" name="newpsx" disabled>
          <%
	}
%> 
      <input type="button"  value="修改明细" onClick="f_ck(editform)" name="ck" >      </td>
    </tr>
  </table>
</form>
