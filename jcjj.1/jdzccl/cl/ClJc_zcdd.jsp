...
try {
	...
	ls_sql="select ztjjgw,htcxhdje,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,zjhze,ddqrr,ddqrsj,cltzr,tzclsj ";
	ls_sql+=" from  jc_zcdd";
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="19%" align="right"> 
        实测量人      </td>
      <td width="31%"> 
        <input type="text" name="sclr" value="<%=yhmc%>" size="20" maxlength="20" >
      </td>
      <td width="19%" align="right"> 
        实测量时间      </td>
      <td width="31%"> 
        <input type="text" name="sclsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr> 
...
%></td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="19%" align="right">产品类型</td>
    <td width="31%"><%
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.sclsj, "实测量时间"))) {
		return false;
	}
