...
if (DBpageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT SEOrder.fbillno,clztmc,CONVERT(char(10),SEOrder.jhshsj,111 ),CONVERT(char(10),SEOrder.tzshsj,111 ),ppbm,t_Organization.fnumber khbh,t_Organization.FName,t_Organization.FAddress,SEOrder.clgw,SEOrder.xmzy ,CONVERT(char(10),SEOrder.FDate,111 ) ";
    ...
    ls_sql+=" and SEOrder.clzt in('15','17')";
...
//进行对象初始化
	DBpageObj.initPage("Jc_zcddShList.jsp","","","ShJc_zcdd.jsp","sqlserver","sa","");
	DBpageObj.setEditStr("送货");//设置每页显示记录数
/*
//设置显示列
