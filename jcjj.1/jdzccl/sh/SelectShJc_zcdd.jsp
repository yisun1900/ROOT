...
%>
 ...
 %>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td width="31%"><input type="text" name="jhshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"><input type="text" name="jhshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr> 
