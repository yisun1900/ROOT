...
try {
	...
	ls_sql="select t_Organization.fnumber,SEOrder.ppbm,SEOrder.clgw,SEOrder.xmzy,SEOrder.FDate,SEOrder.jhshsj,SEOrder.tzry,SEOrder.shtzsm,SEOrder.tzshsj,SEOrder.tzshr";
...
<body bgcolor="#FFFFFF">
<div align="center">送货（订单编号：<%=fbillno%>） </div>

<form method="post" action="" name="editform">
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF">
      <td><div align="right">计划送货时间</div></td>
      <td><%=jhshsj%> </td>
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%"> 
        <div align="right">实送货人</div>      </td>
      <td width="32%"> 
        <input type="text" name="sshr" value="<%=yhmc%>" size="20" maxlength="20" >      </td>
      <td width="18%"> 
        <div align="right">实送货时间</div>      </td>
      <td width="32%"> 
        <input type="text" name="sshsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%"> 
