...
%>
<div align="center"><br> <b>骏工工地明细 （<%=tjrq%>----<%=tjrq2%>）</b></div>
...
try {
	...
	ls_sql+=" where crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm and crm_khxx.zt='2' and crm_khxx.gcjdbm='5'";
