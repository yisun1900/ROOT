...
<table width="100%" border="1" cellpadding="1" cellspacing="0" style="FONT-SIZE:14" >
  ...
  <tr align="center"> 
    <td width="10%" >目前在施工程总数</td>
    <td width="10%" ><%=allzsgs%></td>
    <td width="10%" >本期内完工总数</td>
    <td width="10%" ><%=allwggs%></td>
  
  
    <td width="10%" align="center" >新开工工地总数</td>
    <td width="10%" align="center" ><%=allxkgds%></td>
    <td width="10%" align="right" >
      <div align="center">未开工总数</div>
    </td>
    <td width="10%" >
...
<div align="center"><br><b>目前在施工程明细</b></div>
