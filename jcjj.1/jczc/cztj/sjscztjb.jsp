...
//		out.println(ls_sql);
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=zqye*90/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
...
//		ls_sql+=" having sum(wdzgce)!=0 and sum(fwmj)!=0";
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="right"><%=cf.formatDouble((int)sjf)%></td>
				<td  align="right"><%=cf.round(zkl,1)%></td>
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=qys*90/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
...
//		ls_sql+=" having sum(wdzgce)!=0 and sum(fwmj)!=0";
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="right"><%=cf.formatDouble((int)sjf)%></td>
				<td  align="right"><%=cf.round(zkl,1)%></td>
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=pjde*90/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
...
//		out.println(ls_sql);
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="right"><%=cf.formatDouble((int)sjf)%></td>
				<td  align="right"><%=cf.round(zkl,1)%></td>
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=pmjj*90/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
	...
	else if (px.equals("sjf"))
	{
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="right"><%=cf.formatDouble((int)sjf)%></td>
				<td  align="right"><%=cf.round(zkl,1)%></td>
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=sjf*90/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
	...
	else if (px.equals("zkl"))
	{
		...
		while (rs.next())
		{
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td  align="right"><%=cf.formatDouble((int)sjf)%></td>
				<td  align="right"><%=cf.round(zkl,1)%></td>
				<td  align="left"><A HREF="ViewSjscz.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>&jzbz=<%=jzbz%>" target="_blank"><img src="/images/ColuGif.gif" width="<%=zkl*900/maxqye%>" height="14"></A></td>
			</tr>
			<%	
		}
		rs.close();
...
<tr align="center">
	...
	<input type=button value='查看家装、集成签单明细' onclick="f_do(listform)">
	</td>
