...
try {
	...
	ls_sql="select jmje,dzyy,lrsj,sfyyh,yhkssj,yhjzsj,yhnr,zczkl,jjsjs,htcxhdje,wdzje,zcdlbm,zcxlbm,ppbm,khbh,clgw,ztjjgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,jhtzshsj ";
	ls_sql+=" from  jc_zcdd";
...
%></td>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="18%" align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font>减免金额</td>
              <td width="32%"><input type="text" name="jmje" value="<%=jmje%>" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="zczkl" size="8" maxlength="8" value="<%=zczkl%>" readonly>
