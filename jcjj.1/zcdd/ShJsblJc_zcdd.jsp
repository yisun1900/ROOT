...
try {
	...
	ls_sql="select sxhtsfysh,sfjs,zjxcbze,cbze,zqclf,zhclf,zqzjxclf,zhzjxclf,dzyy,lrsj,sfyyh,yhkssj,yhjzsj,yhnr,zczkl,jjsjs,htcxhdje,wdzje,zcdlbm,zcxlbm,ppbm,khbh,clgw,ztjjgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,jhtzshsj ";
	ls_sql+=" from  jc_zcdd";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审核手写项目结算比例（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
function f_plxg(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="PlLrJsblJc_zcddmx.jsp";
	FormName.submit();
...
function f_zxxg(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_zcddmxLrJsblList.jsp";
	FormName.submit();
//	FormName.wc.disabled=false;
	return true;
}
