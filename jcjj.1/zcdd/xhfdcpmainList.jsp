...
<%
	if (exh.equals(""))
	{
		...
		ls_sql+=" where jc_zcjgb.dwbh='"+getdwbh+"' and jc_zcjgb.dqbm='"+getdqbm+"' and jc_zcjgb.xh>='"+sxh+"'";
		...
		ls_sql="SELECT zcbm,zcmc,zclbbm,xh,gg,zcysbm,jldwbm,yhj,sfycx,cxj,cxkssj,cxjzsj,sfyh  ";
		ls_sql+=" FROM jc_zcjgb  ";
		ls_sql+=" where jc_zcjgb.dwbh='"+getdwbh+"' and jc_zcjgb.dqbm='"+getdqbm+"' and jc_zcjgb.xh>='"+sxh+"' and jc_zcjgb.xh<='"+exh+"'";
		ls_sql+=" and zcbm in(select zcbm from jc_zcddmx where ddbh='"+ddbh+"')";
		ls_sql+=" order by xh";
	}
