...
try {
	...
	for (int i=0;i<xzxh.length ;i++ )
	{
		...
		ls_sql+=" ,zcpzwzbm='"+cf.GB2Uni(zcpzwzbm[i])+"',zcysbm='"+cf.GB2Uni(zcysbm[i])+"',bz='"+cf.GB2Uni(bz[i])+"',lrr='"+yhmc+"',lrsj=SYSDATE,sfzp='"+cf.GB2Uni(sfzp[i])+"',zsdj="+zsdj+",htyjjrje=yjjrbl/100*"+je+",zjhyjjrje=yjjrbl/100*"+je;
