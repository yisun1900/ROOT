...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	//进行对象初始化
		...
		ls_sql="SELECT  jc_zcdd.ddbh,clztmc,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,ysgcjdmc,ppmc,gys,zcdlbm,zcxlbm,c.dwmc dm,jc_zcdd.clgw,jc_zcdd.xmzy,jc_zcdd.jjsjs,jc_zcdd.cbze,jc_zcdd.zjxcbze,jc_zcdd.qhtsj,jc_zcdd.ddqrsj,jc_zcdd.htshsj,jc_zcdd.jhshsj,jc_zcdd.tzshsj,jc_zcdd.sshsj,jc_zcdd.wjsj,tzry,shqk, DECODE(jc_zcdd.ddshbz,'1','不需待电','2','待电未通知','3','待电已通知'),jc_zcdd.lrr,jc_zcdd.lrsj,a.dwmc lrdw,jc_zcdd.bz,jc_zcdd.khbh";
		ls_sql+=" FROM crm_khxx,jc_zcdd,sq_dwxx a,sq_dwxx c ,jdm_zcddzt,dm_gcjdbm ";
		ls_sql+=" where jc_zcdd.khbh=crm_khxx.khbh(+) and jc_zcdd.dwbh=a.dwbh(+) and crm_khxx.dwbh=c.dwbh(+)";
		ls_sql+=" and jc_zcdd.clzt=jdm_zcddzt.clzt(+) ";
		ls_sql+=" and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+)";
...
<CENTER >
  <B><font size="3">查询－全部订单(金额)</font></B>
</CENTER>
<%
	pageObj.out=out;
