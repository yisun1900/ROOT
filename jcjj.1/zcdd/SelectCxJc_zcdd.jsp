            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
                  ...
                  <option value="jc_zcdd.zczkl">折扣率</option>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="crm_khxx_sjs" size="20" maxlength="20" value="<%=sjs%>" <% if (!sjs.equals("")) out.println("readonly");%>>              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="19%" align="right">手写合同是否已审核 </td>
              <td width="31%">
                <input type="radio" name="sxhtsfysh" value="M">非手写合同             
                <input type="radio" name="sxhtsfysh" value="Y">已审核             
                <input type="radio" name="sxhtsfysh" value="N">未审核				</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">套餐主材变更单编号</td>
              <td colspan="3"><input name="zjxxh" type="text" id="zjxxh" onDblClick="JSCalendar(this)" size="20" maxlength="9"></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3">
				...
				<INPUT type="radio" name="ddlx" value="1">代销品
				<INPUT type="radio" name="ddlx" value="4">有库存订单
				<INPUT type="radio" name="ddlx" value="9">代购主材			  
				<INPUT type="radio" name="ddlx" value="D">套餐外主材			  
				<INPUT type="radio" name="ddlx" value="E">散客			  
				<BR>
				<input type="radio" name="ddlx" value="5">标准套餐
				<input type="radio" name="ddlx" value="A">顶配升级
				<input type="radio" name="ddlx" value="B">顶配独立收费
				<input type="radio" name="ddlx" value="AB">顶配主材合计（顶配升级、顶配独立收费）
				<input type="radio" name="ddlx" value="C">选配主材
				<BR>
				<input type="radio" name="ddlx" value="61">家具套餐
				<input type="radio" name="ddlx" value="62">健康套餐
				<input type="radio" name="ddlx" value="71">温暖套餐
				<input type="radio" name="ddlx" value="72">静音套餐
				<input type="radio" name="ddlx" value="81">窗帘套餐
				<BR>
				<input type="radio" name="ddlx" value="99">主材套餐合计（家具、健康、温暖、静音、窗帘）			</td>
            </tr>
            <tr bgcolor="#CCCCFF">
              ...
              已结算</td>
              <td align="right">是否计入家装合同</td>
              <td><INPUT type="radio" name="sfjrht" value="Y">计入
                  <INPUT type="radio" name="sfjrht" value="N">不计入</td>
            </tr>
            <tr bgcolor="#CCCCFF">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">折扣率 从 </td>
              <td><input name="zczkl" type="text" id="zczkl" size="10" maxlength="8" >
              （0与10之间）</td>
              <td align="right">到</td>
              <td><input name="zczkl2" type="text" id="zczkl2" size="10" maxlength="8" ></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                产品类型              </td>
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"> 供应商接收时间 从 </td>
              <td><input type="text" name="gysjslrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right"> 到 </td>
              <td><input type="text" name="gysjslrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
              <td width="19%" align="right" bgcolor="#E8E8FF">可减项截止时间 从</td>
              <td width="31%"> 
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.gysjslrsj, "供应商接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.gysjslrsj2, "供应商接收时间"))) {
		return false;
	}
	
	
	
	if(!(isFloat(FormName.zczkl, "折扣率"))) {
		return false;
	}
	if(!(isFloat(FormName.zczkl2, "折扣率"))) {
		return false;
	}
	...
	if (lx=="cx")
	{
		FormName.action="Jc_zcddCxList.jsp";
	}
	else if (lx=="tj")
	{
