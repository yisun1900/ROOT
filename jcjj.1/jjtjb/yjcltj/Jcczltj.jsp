...
<%
	...
	//按外主材各类产品进行分类统计
	ls_sql="select gysmc,(sum(hkze+zjhze)) from jc_zcdd,crm_khxx,jdm_zcdlbm,sq_gysxx where jc_zcdd.khbh=crm_khxx.khbh and jc_zcdd.zcdlbm=jdm_zcdlbm.zcdlbm  and jc_zcdd.ppbm=sq_gysxx.gysbh and jc_zcdd.zcdlbm='01' and jc_zcdd.lrsj<=TO_DATE('"+sjfw2+"','YYYY-MM-DD') and jc_zcdd.lrsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')  ";
