...
%>
    ...
    <tr> 
      <td align="right" width="42%" height="39">时间 从</td>
      <td width="58%" height="39"> 
    ...
    <input type="button"  value="各类产品实收款所占比例" onClick="f_do(selectform)">
	<input type="button"  value="完结额所占比例" onClick="f_do1(selectform)">
	<input type="button"  value="外主材洁具类所占比例" onClick="f_do2(selectform)">
	
	<input type="button"  value="外主材瓷砖类所占比例" onClick="f_do3(selectform)">
	<input type="button"  value="外主材地板类所占比例" onClick="f_do4(selectform)">
