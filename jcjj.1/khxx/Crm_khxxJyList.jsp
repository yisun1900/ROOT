...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ckjgbz.equals("Y"))
	{
		ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,khlxmc,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,crm_khxx.lxfs,c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,zkl,ywy,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.qye,crm_khxx.khbh";
	}
	else{
		ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,khlxmc,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,crm_khxx.lxfs,c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,zkl,ywy,a.dwmc qydm,crm_khxx.qyrq,jgrq,0,crm_khxx.khbh ";
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxJyList.jsp","SelectJyCrm_khxx.jsp","/jcjj/dygl/dyydd.jsp","");
	pageObj.setViewStr("打印");//设置每页显示记录数
/*
//设置显示列
