...
<form method="post" action="Jc_cgddXgWjdjList.jsp" name="selectform">
<div align="center">橱柜订单处理--修改完结登记</div>
...
%>
	...
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right" bgcolor="#FFFFFF">完结时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_wjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_wjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_wjsj, "完结时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_wjsj2, "完结时间"))) {
		return false;
	}
