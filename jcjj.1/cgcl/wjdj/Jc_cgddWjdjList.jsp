...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jc_cgdd.ycclzt in('0','2','3') ";
	if (yhjs.equals("G0"))
	{
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddWjdjList.jsp","","","WjdjJc_cgdd.jsp");
...
//设置按钮参数
	String[] buttonName={"批量登记"};//按钮的显示名称
	String[] buttonLink={"SavePlWjdjJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单处理--完结登记</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
