...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jc_cgdd.clzt in('27','29')";
	if (yhjs.equals("G0"))
	{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_cgdd.aztzsj,jc_cgdd.jhazrq";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddAzList.jsp","","","AzJc_cgdd.jsp");
//	pageObj.setPageRow(1000);//设置每页显示记录数
	pageObj.setEditStr("安装");
...
<CENTER >
  <B><font size="3">橱柜订单处理--橱柜安装</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
