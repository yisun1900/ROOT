...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_cgzjx_qrsj=null;
	jc_cgzjx_qrsj=request.getParameter("jc_cgzjx_qrsj");
	if (jc_cgzjx_qrsj!=null)
	{
		jc_cgzjx_qrsj=jc_cgzjx_qrsj.trim();
		if (!(jc_cgzjx_qrsj.equals("")))	wheresql+="  and (jc_cgzjx.qrsj>=TO_DATE('"+jc_cgzjx_qrsj+"','YYYY/MM/DD'))";
	}
	jc_cgzjx_qrsj=request.getParameter("jc_cgzjx_qrsj2");
	if (jc_cgzjx_qrsj!=null)
	{
		jc_cgzjx_qrsj=jc_cgzjx_qrsj.trim();
		if (!(jc_cgzjx_qrsj.equals("")))	wheresql+="  and (jc_cgzjx.qrsj<=TO_DATE('"+jc_cgzjx_qrsj+"','YYYY/MM/DD'))";
	...
	ls_sql="SELECT jc_cgzjx.ddbh,jc_cgzjx.zjxxh,DECODE(jc_cgzjx.clzt,'00','录入未完成','01','录入完成','02','工厂已确认','04','安装完成','99','退单'),jc_cgzjx.khbh,crm_khxx.khxm,crm_khxx.fwdz,jc_cgzjx.pdgcmc,crm_khxx.hth,mmzjxyymc,TO_CHAR(jc_cgzjx.cgzkl) cgzkl,TO_CHAR(jc_cgzjx.tmzkl) tmzkl,TO_CHAR(jc_cgzjx.wjzkl) wjzkl,TO_CHAR(jc_cgzjx.dqzkl) dqzkl,jc_cgzjx.dzyy,jc_cgzjx.zqzjxze,jc_cgzjx.zqgtzjxje,jc_cgzjx.zqtmzjxje,jc_cgzjx.zqwjzjxje,jc_cgzjx.zqdqzjxje,jc_cgzjx.zjxze,jc_cgzjx.gtzjxje,jc_cgzjx.tmzjxje,jc_cgzjx.wjzjxje,jc_cgzjx.dqzjxje,jc_cgzjx.zjxfssj,jc_cgzjx.qrsj,jc_cgzjx.qrr,jc_cgzjx.jhazsj,jc_cgzjx.azwcsj,jc_cgzjx.lrr,jc_cgzjx.lrsj,dwmc,jc_cgzjx.bz  ";
	...
	if (yhjs.equals("G0"))
	{
		ls_sql+=" and jc_cgzjx.clzt in('02','04')";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgzjxCxList.jsp","","","");
