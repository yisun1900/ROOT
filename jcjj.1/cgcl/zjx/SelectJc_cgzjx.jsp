...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_cgzjxList.jsp" name="selectform">
<div align="center">橱柜增减项－维护</div>
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"><select name="jc_cgzjx_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" >
          <%
