      ...
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%"> 
                <input type="text" name="jhfcsj" size="20" maxlength="20"  value="<%=jhfcsj%>" >
              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF">计划复测时间修改人</td>
              <td width="29%">
                <input type="text" name="jhfcxgr" size="20" maxlength="20"  value="<%=yhdlm%>" readonly>
              </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jhfcxgsj, "修改时间"))) {
		return false;
	}
...
/*
*/
	FormName.action="SaveXgJhFcJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
