...
<form method="post" action="SaveEditJc_cgdqccdmx.jsp" name="editform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"> 
                <input type="text" name="sl" size="30" maxlength="8"  value="<%=sl%>" onChange="f_jsjg(editform)">
              </td>
              <td width="15%"> 
