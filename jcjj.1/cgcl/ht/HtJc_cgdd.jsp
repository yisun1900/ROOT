...
try {
	...
	ls_sql="select jc_cgdd.khbh,qhtr,qhtsj,htbz,gtbfje,tmbfje,wjhtze,dqhtze,htze,wdzje,sdks,xtbc,cghs,tmpp,tmhs,blcz,jiaolian,kjxsj,jhazrq";
	ls_sql+=" ,jc_cgdd.cgzkl,jc_cgdd.tmzkl,jc_cgdd.wjzkl,jc_cgdd.dqzkl,jc_cgdd.dzyy,dqpp,dqxh ";
	ls_sql+=" from  jc_cgdd";
...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">签订合同（订单号：<%=ddbh%>）（<font color="#0000FF"><b>注意：<font color="#FF0000">*</font>项必添</b></font>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>柜体部分金额-折前</td>
              <td> 
                <input name="zqgtbfje" type="text" id="zqgtbfje" onChange="f_jsjg(insertform)"  value="" size="20" maxlength="20" >              </td>
              <td align="right"><font color="#FF0033">*</font><font color="#0000CC">柜体部分金额-折后</font></td>
              <td><input type="text" name="gtbfje" size="20" maxlength="20"  value="" readonly>              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>台面部分金额-折前</td>
              <td><input type="text" name="zqtmbfje" size="20" maxlength="20"  value=""  onChange="f_jsjg(insertform)"></td>
              <td align="right"><font color="#FF0033">*</font><font color="#0000CC">台面部分金额-折后</font></td>
              <td><input type="text" name="tmbfje" size="20" maxlength="20"  value=""  readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>电器部分金额-折前</td>
              <td width="30%"> 
                <input type="text" name="zqdqhtze" size="20" maxlength="20"  value="" onChange="f_jsjg(insertform)" >              </td>
              <td width="20%" align="right"><font color="#FF0033">*</font><font color="#0000CC">电器部分金额-折后</font></td>
              <td width="30%"><input type="text" name="dqhtze" size="20" maxlength="20"  value="" readonly >              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>五金合同总额-折前</td>
              <td><input type="text" name="zqwjhtze" size="20" maxlength="20"  value="" onChange="f_jsjg(insertform)" ></td>
              <td align="right"><font color="#FF0033">*</font><font color="#0000CC">五金合同总额-折后</font></td>
              <td><input type="text" name="wjhtze" size="20" maxlength="20"  value="" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font><font color="#0000CC">未打折金额</font></td>
              <td width="30%"> 
                <input type="text" name="wdzje" size="20" maxlength="20"  value="" readonly>              </td>
              <td width="20%" align="right"><font color="#FF0033">*</font><font color="#0000CC">合同总额</font></td>
              <td width="30%"> 
                <input type="text" name="htze" size="20" maxlength="20"  value="" readonly>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="text" name="qhtsj" size="20" maxlength="10"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)" onBlur="f_getrq(insertform)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
