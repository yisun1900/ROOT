...
<%
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","JsJc_cgdd.jsp");
	pageObj.setPageRow(1000);//设置每页显示记录数
	pageObj.setEditStr("接收");//设置每页显示记录数
//设置显示列
	String[] disColName={"ddbh","clztmc","gysmc","sfpsjs","jc_cgdd_cgsjs","pgcr","pgcsj","gcjsr","gcjssj","jhazrq","kjxsj","htze","gtbfje","tmbfje","wjhtze","dqhtze","jc_cgdd_khlx","khxm","fwdz","hth","clgw","ztjjgw","xmzy","sq_dwxx_dwmc"};
...
//设置按钮参数
	...
	String[] buttonLink={"SavePlJsJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单处理--车间接收</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
