      ...
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%"> 
                <input type="text" name="cjjsr" size="20" maxlength="20"  value="<%=cjjsr%>" readonly>
              </td>
              <td width="21%" align="right">车间接收时间</td>
              <td width="29%"> 
                <input type="text" name="cjjssj" size="20" maxlength="20"  value="<%=cjjssj%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgJsJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
