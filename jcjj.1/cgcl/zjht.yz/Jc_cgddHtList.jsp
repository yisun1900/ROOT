...
//设置显示列
	String[] disColName={"ddbh","clztmc","pdgcmc","sfpsjs","jc_cgdd_cgsjs","pdsj","jhfcsj","sfcsj","khxm","fwdz","hth","jc_cgdd_khlx","clgw","ztjjgw","xmzy","jc_cgdd_dj","sq_dwxx_dwmc"};
