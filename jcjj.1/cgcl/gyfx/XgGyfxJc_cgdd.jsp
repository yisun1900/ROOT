      ...
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%"> 
                <input type="text" name="gyfxr" size="20" maxlength="20"  value="<%=gyfxr%>" readonly>
              </td>
              <td width="21%" align="right">工艺分析时间</td>
              <td width="29%"> 
                <input type="text" name="gyfxsj" size="20" maxlength="20"  value="<%=gyfxsj%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgGyfxJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
