...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_cgzjx_azwcsj=null;
	jc_cgzjx_azwcsj=request.getParameter("jc_cgzjx_azwcsj");
	if (jc_cgzjx_azwcsj!=null)
	{
		jc_cgzjx_azwcsj=jc_cgzjx_azwcsj.trim();
		if (!(jc_cgzjx_azwcsj.equals("")))	wheresql+="  and (jc_cgzjx.azwcsj>=TO_DATE('"+jc_cgzjx_azwcsj+"','YYYY/MM/DD'))";
	}
	jc_cgzjx_azwcsj=request.getParameter("jc_cgzjx_azwcsj2");
	if (jc_cgzjx_azwcsj!=null)
	{
		jc_cgzjx_azwcsj=jc_cgzjx_azwcsj.trim();
		if (!(jc_cgzjx_azwcsj.equals("")))	wheresql+="  and (jc_cgzjx.azwcsj<=TO_DATE('"+jc_cgzjx_azwcsj+"','YYYY/MM/DD'))";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgzjxQrList.jsp","","","QrJc_cgzjx.jsp");
...
<CENTER >
  <B><font size="3">增减项处理---工厂确认</font></B>
</CENTER>
<%
	pageObj.out=out;
