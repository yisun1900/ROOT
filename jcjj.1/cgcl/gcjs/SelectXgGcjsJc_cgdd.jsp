...
<form method="post" action="Jc_cgddXgGcjsList.jsp" name="selectform">
<div align="center">橱柜订单处理--修改工厂接收</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td align="right">工厂接收人</td>
	  <td><input name="jc_cgdd_gcjsr" type="text" size="20" maxlength="20" ></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
%>
	...
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right" bgcolor="#FFFFFF">派设计师时间 从</td>
	  <td width="31%"> 
	...
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right">工厂接收时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_gcjssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_gcjssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_gcjssj, "工厂接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_gcjssj2, "工厂接收时间"))) {
		return false;
	}
