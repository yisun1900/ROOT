...
try {
	...
	ls_sql="select cgsjs,pdgc,jc_cgdd.pgcr,jc_cgdd.pgcsj,jc_cgdd.pgcsm,fgsbh,khbh,htze,wdzje,fkfs,cgzkl,dzyy";
	ls_sql+=" from  jc_cgdd";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgFpgcJc_cgdd.jsp" name="insertform" >
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">橱柜订单处理--修改工厂（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
