...
<form method="post" action="Jc_cgddXgFpgcList.jsp" name="selectform">
<div align="center">橱柜订单处理--修改工厂</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td align="right">派工厂人</td>
	  <td><input name="jc_cgdd_pgcr" type="text" id="jc_cgdd_qhtr" size="20" maxlength="20" ></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFCC"> 
	  <td width="19%" align="right">派工厂时间 从</td>
	  <td width="31%"> 
		<input type="text" name="jc_cgdd_pgcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
		<input type="text" name="jc_cgdd_pgcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_pgcsj, "派工厂时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_pgcsj2, "派工厂时间"))) {
		return false;
	}
