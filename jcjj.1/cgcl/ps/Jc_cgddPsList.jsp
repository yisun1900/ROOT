...
<%
	...
	ls_sql="SELECT jc_cgdd.ddbh as ddbh,gysmc,DECODE(jc_cgdd.sfpsjs,'1','是','2','否') sfpsjs,jc_cgdd.khbh as khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,clgw,jc_cgdd.ztjjgw,jc_cgdd.xmzy,jc_cgdd.dj as jc_cgdd_dj,jc_cgdd.cgsjs as jc_cgdd_cgsjs,clztmc,DECODE(jc_cgdd.khlx,'2','家装客户','4','非家装') as jc_cgdd_khlx,jc_cgdd.rksj,jc_cgdd.rkr,jc_cgdd.kazsjlrr,jc_cgdd.kazsj,jc_cgdd.jhazrq,jc_cgdd.ksazsj,jc_cgdd.htze,jc_cgdd.gtbfje,jc_cgdd.tmbfje,jc_cgdd.wjhtze,jc_cgdd.dqhtze,a.dwmc as sq_dwxx_dwmc  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_cgdd.clzt,jc_cgdd.kazsj";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","PsJc_cgdd.jsp");
	pageObj.setPageRow(1000);//设置每页显示记录数
	pageObj.setEditStr("配送");
//设置显示列
	String[] disColName={"ddbh","clztmc","khxm","fwdz","gysmc","sfpsjs","jc_cgdd_cgsjs","ksazsj","rkr","rksj","kazsjlrr","kazsj","jhazrq","htze","gtbfje","tmbfje","wjhtze","dqhtze","jc_cgdd_khlx","hth","clgw","ztjjgw","xmzy","sq_dwxx_dwmc"};
...
//设置按钮参数
	String[] buttonName={"批量配送"};//按钮的显示名称
	String[] buttonLink={"SavePlPsJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单处理--配送</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
