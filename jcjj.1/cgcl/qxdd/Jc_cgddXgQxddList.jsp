...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddXgQxddList.jsp","","","XgQxddJc_cgdd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除退单信息"};//按钮的显示名称
	String[] buttonLink={"DeleteQxddJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单--修改退单</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
