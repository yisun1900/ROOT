...
try {
	...
	ls_sql="select jc_cgdd.jctdyybm,jc_cgdd.tdsm,jc_cgdd.kclf,jc_cgdd.tdblr,jc_cgdd.tdsj,jc_cgdd.khbh,crm_khxx.khxm,crm_khxx.lxfs,crm_khxx.fwdz,crm_khxx.hth";
...
<form method="post" action="SaveXgQxddJc_cgdd.jsp" name="selectform">
<div align="center">橱柜订单---修改退单（订单编号：<%=ddbh%>）</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="17%" align="right"><font color="#FF0000">*</font>扣测量费</td>
      <td width="33%"> 
        <input type="text" name="kclf" value="<%=kclf%>" size="20" maxlength="16" >
      </td>
      <td width="16%" align="right"><font color="#FF0000">*</font>退单原因</td>
      <td width="34%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="17%" align="right"><font color="#FF0000">*</font>退单说明</td>
      <td colspan="3"> 
