    ...
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><font color="#0000CC">协商安装时间</font></td>
              <td width="29%"><input type="text" name="kazsj" size="20" maxlength="20"  value="<%=kazsj%>" readonly></td>
              <td width="21%" align="right"><font color="#0000CC">合同安装时间</font></td>
              <td width="29%"><input type="text" name="jhazrq" size="20" maxlength="10"  value="<%=jhazrq%>" readonly></td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right" width="21%"><font color="#0000CC">发安装通知人</font></td>
              <td width="29%">
<input type="text" name="aztzr" size="20" maxlength="20"  value="<%=yhmc%>" readonly></td>
              <td width="21%"> 
                <div align="right"><font color="#0000CC">发安装通知时间</font></div>
              </td>
              <td width="29%">
<input type="text" name="aztzsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">安装提醒</td>
              <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgAztzJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
