...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center"><strong>确定初测时间</strong> </div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>联系结果</td>
              <td width="29%"><input type="radio" name="clzt" value="03">
未确定
<input type="radio" name="clzt" value="05">
确定时间 </td>
              <td width="22%" align="right"><font color="#FF0000">*</font>计划初测时间</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveQdCcJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
