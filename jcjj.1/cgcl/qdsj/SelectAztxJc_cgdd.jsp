...
<form method="post" action="Jc_cgddAztxList.jsp" name="selectform">
<div align="center">橱柜订单处理--安装提醒</div>
...
%> 
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td align="right">安装时间录入人</td>
	  <td><input name="jc_cgdd_kazsjlrr" type="text" size="20" maxlength="20" ></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
%>
	...
	<tr bgcolor="#FFFFFF"> 
	  ...
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_jhazrq" size="20" maxlength="10" value="<%=cf.today()%>" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_jhazrq2" size="20" maxlength="10" value="<%=cf.addDay(3)%>" onDblClick="JSCalendar(this)">              </td>
	</tr>
