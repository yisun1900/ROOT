...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_cgdd.ddbh,clztmc,crm_khxx.khxm,crm_khxx.fwdz,jc_cgdd.pdgcmc,jc_cgdd.jhazrq,jc_cgdd.rksj,jc_cgdd.azsjbz,clgw,jc_cgdd.ztjjgw,jc_cgdd.xmzy,jc_cgdd.cgsjs,sdks,jc_cgdd.khbh  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddQdsjList.jsp","","","QdsjJc_cgdd.jsp");
