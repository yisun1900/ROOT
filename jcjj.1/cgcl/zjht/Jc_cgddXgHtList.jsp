...
//设置显示列
	String[] disColName={"ddbh","clztmc","hth","khxm","sdks","xtbc","cghs","tmpp","tmhs","blcz","jiaolian","htze","gtbfje","tmbfje","wjhtze","dqhtze","gysmc","sfpsjs","jc_cgdd_cgsjs","pdsj","sccsj","sfcsj","qhtsj","jhazrq","kjxsj","jc_cgdd_khlx","fwdz","clgw","ztjjgw","xmzy","sq_dwxx_dwmc"};
