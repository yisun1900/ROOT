...
<table width="100%" border="0">
 ...
 <tr align="right">
    <td><div align="left">橱柜类问题</div></td>
  </tr>
...
<%
    ...
    ls_sql+=" where crm_tsjl.tslxbm=dm_tslxbm.tslxbm and b.dwbh=crm_tsjl.dwbh and crm_tsjl.tsyybm=dm_tsyybm.tsyybm and slbm='FBJ13' and crm_tsclqk.tsjlh=crm_tsjl.tsjlh and crm_tspp.tsjlh=crm_tsjl.tsjlh and  a.dwbh=crm_tspp.tspp";
	ls_sql+=" and crm_tsjl.tslxbm='32' ";
	ls_sql+=wheresql;
    ls_sql+=" order by lx";
	//out.print(ls_sql);
    pageObj.sql=ls_sql;
