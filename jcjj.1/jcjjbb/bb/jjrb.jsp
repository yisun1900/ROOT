...
//计算橱柜当日订单数
ls_sql="select count(*) from jc_cgdd,crm_khxx  where crm_khxx.khbh=jc_cgdd.khbh and jc_cgdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"' ";
hjzs=cf.executeQuery(ls_sql);
drdds_cg=Integer.parseInt(hjzs);

//计算橱柜当日累计订单数
ls_sql="select count(*) from jc_cgdd,crm_khxx  where crm_khxx.khbh=jc_cgdd.khbh and jc_cgdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_cgdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drdds_cg2=Integer.parseInt(hjzs);

//计算木门当日订单数
ls_sql="select count(*) from jc_mmydd,crm_khxx where crm_khxx.khbh=jc_mmydd.khbh  and jc_mmydd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"' ";
hjzs=cf.executeQuery(ls_sql);
drdds_mm=Integer.parseInt(hjzs);
//计算木门当日累计订单数
ls_sql="select count(*) from jc_mmydd,crm_khxx where crm_khxx.khbh=jc_mmydd.khbh  and jc_mmydd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_mmydd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drdds_mm2=Integer.parseInt(hjzs);

//计算家具当日订单数
ls_sql="select count(*) from jc_jjdd,crm_khxx  where crm_khxx.khbh=jc_jjdd.khbh and jc_jjdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"' ";
hjzs=cf.executeQuery(ls_sql);
drdds_jj=Integer.parseInt(hjzs);
//计算家具当日累计订单数
ls_sql="select count(*) from jc_jjdd,crm_khxx  where crm_khxx.khbh=jc_jjdd.khbh and jc_jjdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_jjdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drdds_jj2=Integer.parseInt(hjzs);

//计算主材当日订单数
ls_sql="select count(*) from jc_zcdd,crm_khxx  where crm_khxx.khbh=jc_zcdd.khbh  and jc_zcdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD')  and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drdds_zc=Integer.parseInt(hjzs);
//计算主材当日累计订单数
ls_sql="select count(*) from jc_zcdd,crm_khxx  where crm_khxx.khbh=jc_zcdd.khbh  and jc_zcdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_zcdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
...
//计算橱柜当日
ls_sql="select ROUND(sum(jc_cgdd.htze)+0) from jc_cgdd,crm_khxx  where crm_khxx.khbh=jc_cgdd.khbh and jc_cgdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD')  and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_cg=Double.parseDouble('0'+cf.fillNull(hjzs));
//计算橱柜当日累计
ls_sql="select ROUND(sum(jc_cgdd.zjhze)) from jc_cgdd,crm_khxx  where crm_khxx.khbh=jc_cgdd.khbh and jc_cgdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_cgdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_cg2=Double.parseDouble('0'+cf.fillNull(hjzs));

//计算木门当日
ls_sql="select ROUND(sum(jc_mmydd.zjhze)) from jc_mmydd,crm_khxx  where crm_khxx.khbh=jc_mmydd.khbh  and jc_mmydd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD')  and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_mm=Double.parseDouble('0'+cf.fillNull(hjzs));
//计算木门当日累计
ls_sql="select ROUND(sum(jc_mmydd.zjhze)) from jc_mmydd,crm_khxx  where crm_khxx.khbh=jc_mmydd.khbh  and jc_mmydd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_mmydd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_mm2=Double.parseDouble('0'+cf.fillNull(hjzs));

//计算家具当日
ls_sql="select ROUND(sum(jc_jjdd.zjhze)) from jc_jjdd,crm_khxx  where crm_khxx.khbh=jc_jjdd.khbh and jc_jjdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD')  and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_jj=Double.parseDouble('0'+cf.fillNull(hjzs));
//计算家具当日累计
ls_sql="select ROUND(sum(jc_jjdd.zjhze)) from jc_jjdd,crm_khxx  where crm_khxx.khbh=jc_jjdd.khbh and jc_jjdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_jjdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_jj2=Double.parseDouble('0'+cf.fillNull(hjzs));


//计算主材当日
ls_sql="select ROUND(sum(jc_zcdd.hkze+jc_zcdd.zjhze)) from jc_zcdd,crm_khxx  where crm_khxx.khbh=jc_zcdd.khbh  and jc_zcdd.lrsj=TO_DATE('"+cxrq2+"','YYYY-MM-DD')  and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
drssk_zc=Double.parseDouble('0'+cf.fillNull(hjzs));
//计算主材当日累计
ls_sql="select ROUND(sum(jc_zcdd.hkze+jc_zcdd.zjhze)) from jc_zcdd,crm_khxx  where crm_khxx.khbh=jc_zcdd.khbh  and jc_zcdd.lrsj<=TO_DATE('"+cxrq2+"','YYYY-MM-DD') and jc_zcdd.lrsj>=TO_DATE('"+cxrq+"','YYYY-MM-DD') and crm_khxx.fgsbh='"+fgsbh+"'";
hjzs=cf.executeQuery(ls_sql);
...
%>
 ...
 <CENTER>
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
    ...
    <td width="20%" > 
      <div align="center"><font face="宋体" size="3">当日订单</font></div>
    </td>
    <td width="20%" > 
      <div align="center"><font face="宋体" size="3">当日实收款</font></div>
    </td>
    <td width="20%" > 
      <div align="center"><font face="宋体" size="3">截止当日总订单</font></div>
    </td>
    <td width="20%" > 
      <div align="center"><font face="宋体" size="3">截止当日总实收款</font></div>
    </td>
    </tr>
    <tr> 
      <td width="20%" > 
...
<p><font size="3">　新增客户数量（网页）<!-- (以前未定过任何集成产品) -->：
<A HREF="xzkhList.jsp?cxrq=<%=cxrq%>&cxrq2=<%=cxrq2%>&fgsbh=<%=fgsbh%>" target='_blank'><%=xzkhs%></A></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3">新增客户数量（EXECEL）
<!-- (以前未定过任何集成产品) -->
： <A HREF="xzkhList1.jsp?cxrq=<%=cxrq%>&cxrq2=<%=cxrq2%>&fgsbh=<%=fgsbh%>" target='_blank'><%=xzkhs%></A></font></p>
<p>　</p>
<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<%=zgsmc%>家居管理中心</p>
