...
<%
	...
	ls_sql="SELECT jc_jjdd.ddbh as ddbh,jc_jjdd.clgw,jc_jjdd.xmzy,jc_jjdd.khbh as khbh,jc_jjdd.dj as jc_jjdd_dj,jc_jjdd.jjsjs as jc_jjdd_jjsjs,jgrq,clztmc, DECODE(jc_jjdd.khlx,'1','装修客户','2','家具客户') as jc_jjdd_khlx,crm_khxx.khxm as khxm,crm_khxx.fwdz as fwdz,crm_khxx.hth as hth,sq_dwxx.dwmc as sq_dwxx_dwmc  ";
...
<CENTER >
  <B><font size="3">家具签合同延期（项目专员：<%=xmzymc%>）</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
