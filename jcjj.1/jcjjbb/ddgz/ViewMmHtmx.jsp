...
//设置显示列
	String[] disColName={"yddbh","khxm","hth","jgrq","wjqk","sqdj","clgw","xmzy","pdgc","wjsgsbz","clzt","lrsj","lrbm"};
...
<CENTER >
  <B><font size="3">木门签合同延期（项目专员：<%=xmzymc%>）</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
