...
<%
	...
	ls_sql="SELECT yddbh,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.jgrq,DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.clgw,jc_mmydd.xmzy,b.dwmc pdgc,jhccsj, DECODE(jc_mmydd.clzt,'00','录入未完成','01','预订单完成','02','已派单','03','已完成初测','04','签订合同','05','已入库','06','安装完成','99','取消订单') clzt,jc_mmydd.lrsj,a.dwmc lrbm ";
	...
	ls_sql+=" and clzt<'03'";
	ls_sql+=wheresql;
	ls_sql+=" order by jhccsj";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
	pageObj.setPageRow(10000);//设置每页显示记录数
//设置显示列
	String[] disColName={"yddbh","khxm","hth","jgrq","wjqk","sqdj","clgw","xmzy","pdgc","jhccsj","clzt","lrsj","lrbm"};
