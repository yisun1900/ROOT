...
<table width="100%" border="0">
  <tr  align="center">
    <td height="90"><span class="STYLE1">打印电子报价（调换产品序号：<%=zjxxh%>）</span></td>
  </tr>
...
<%
	if (lx.equals("1"))//1：非套餐；2：套餐
	{
		...
		%>
		  ...
		  <tr align="center" >
			<td height="36">
			<input type="button"  value="主材套餐" onClick="window.open('dzbj/zxbjmx/Bj_zctcmcDyListH.jsp?khbh=<%=khbh%>&zjxxh=<%=zjxxh%>')"  /></td>
		  </tr>
		  <tr align="center" >
			<td height="36">
