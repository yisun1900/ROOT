...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF" align="center"> 
    ...
    <td  width="7%" ><strong>项目编号</strong></td>
    <td  width="16%" ><strong>项目名称</strong></td>
    <td  width="6%" ><span class="STYLE5">水电路</span></td>
    <td  width="6%" ><strong>项目分类</strong></td>
	...
	<td  width="42%" ><strong>工艺说明</strong></td>
  </tr>
...
<%
	...
	while (rs1.next())
	{
		...
		double zhje=0;
		String sdl=null;
		ls_sql="SELECT DECODE(bj_bjxmmxh.xmflbm,'01','水电路','') sdl ,bj_gclmxh.sl*bj_bjxmmxh.cbenj cbj,bj_gclmxh.sl*bj_bjxmmxh.sgcbj sgcbj,bj_gclmxh.sl*bj_bjxmmxh.sgdbj sgdbj,bj_bjxmmxh.xh,xmflmc,bj_bjxmmxh.xmbh,xmmc,jldwmc,bj_bjxmmxh.zqdj,bj_bjxmmxh.zk,bj_bjxmmxh.dj,bj_gclmxh.sl,bj_gclmxh.sl*bj_bjxmmxh.zqdj as zqje,bj_gclmxh.sl*bj_bjxmmxh.dj as zhje,gycl,bj_bjxmmxh.flmcgg,bj_bjxmmxh.bz";
	...
	//	out.println(ls_sql);
		...
		%> 
		  <tr bgcolor="#FFFFFF" align="center"> 
			<td colspan="5"><span class="STYLE1"><<%=jgwzmc%>>小计</span></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
...
%> 
  ...
  <tr bgcolor="#FFFFFF" align="center"> 
	<td colspan="5"><span class="STYLE1">工 程 总 计</span></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
