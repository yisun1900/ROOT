...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(crm_zxkhxx.fjtcbz,'Y','分解','N','未分解','M','非套餐'),DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','店面退回客户','3','已签约','4','公司签单失败','5','重新分配店面'),hth,khxm,fwdz,bjjbmc,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,lrsj,khbh,clgw ";
