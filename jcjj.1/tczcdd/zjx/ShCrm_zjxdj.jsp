...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">工程扣款审核（退补货序号：<%=zjxxh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"><%=qye%></td>
              <td align="right" width="17%"><font color="#0000CC">累计退补货总额</font></td>
              <td width="33%"><%=zjxje%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%"><font color="#0000CC">退补货发生阶段</font></td>
              <td width="35%"> 
...
%> 
              ...
              <td align="right" width="17%"><font color="#0000CC">退补货发生时间</font></td>
              <td width="33%"> 
                <input type="text" name="fssj" value="<%=fssj%>" size="20" maxlength="10" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%"><font color="#0000CC">退补货发生总额</font></td>
              <td width="35%"> 
              ...
              <td rowspan="6" width="17%"> 
                <div align="right"><font color="#0000CC">退补货原因</font></div>
                <div align="right"></div>
              </td>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right"><font color="#0000CC">退补货完成标志</font></td>
              <td width="35%"><%
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
                <div align="right"><font color="#0000CC">退补货说明</font></div>
              </td>
              <td colspan="3"> 
