...
<form method="post" action="Crm_zjxdjXgShList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
			...
			<tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">退补货序号</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">退补货发生时间 从</td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">发生阶段</td>
...
{
	if(!(isNumber(FormName.zjxxh, "退补货序号"))) {
		return false;
	}
