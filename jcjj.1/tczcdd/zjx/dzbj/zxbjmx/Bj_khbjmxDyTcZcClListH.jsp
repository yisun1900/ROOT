...
<%
	...
	String clxlmc=null;
	double getxlsl=0;
	ls_sql="SELECT bj_khzcxmxjh.tccplbbm,clxlmc,sum(sjsl)";
	ls_sql+=" FROM bj_khzcxmxjh,jxc_clxlbm";
    ls_sql+=" where bj_khzcxmxjh.tccplbbm=jxc_clxlbm.clxlbm and zjxxh='"+zjxxh+"'";//1：可增项；2：不可增项；3：不控制
	ls_sql+=" group by bj_khzcxmxjh.tccplbbm,clxlmc";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	while (rs.next())
	{
