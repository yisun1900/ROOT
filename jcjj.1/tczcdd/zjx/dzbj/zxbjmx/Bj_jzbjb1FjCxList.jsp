...
<%
	...
	ls_sql+=" and bj_zdyxmb.xmbh in(select xmbh from bj_gclmx where khbh='"+khbh+"' and jgwzbm='"+jgwzbm+"')";
...
<%
	...
	ls_sql+=" and bj_zdyxmb.xmbh not in(select xmbh from bj_gclmx where khbh='"+khbh+"' and jgwzbm='"+jgwzbm+"')";
	ls_sql+=" order by bj_zdyxmb.dqbm,bj_zdyxmb.xh,bj_zdyxmb.xmbh";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
