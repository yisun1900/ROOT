...
<%
		...
		String sjsfycx=null;
	int i=0;
	ls_sql="SELECT bj_khzcxmxjh.sjsfycx,jgwzbm,clxlmc,bj_khzcxmxjh.tcsjflbm,tcsjflmc,bzsl,sjsl,sjjshsl,bjjbmc,bj_khzcxmxjh.khbjjbbm,bj_khzcxmxjh.bjjbbm,bj_khzcxmxjh.sjsfsl,bj_khzcxmxjh.sjcj,bj_khzcxmxjh.sjsfje";
	ls_sql+=" FROM bj_khzcxmxjh,bj_tcsjflbm,jxc_clxlbm,bdm_bjjbbm ";
    ls_sql+=" where bj_khzcxmxjh.tcsjflbm=bj_tcsjflbm.tcsjflbm and bj_khzcxmxjh.tccplbbm=jxc_clxlbm.clxlbm";
    ls_sql+=" and bj_khzcxmxjh.bjjbbm=bdm_bjjbbm.bjjbbm ";
    ls_sql+=" and bj_khzcxmxjh.zjxxh='"+zjxxh+"' and bj_khzcxmxjh.khbjjbbm!=bj_khzcxmxjh.bjjbbm";
