...
String tcbm=cf.GB2Uni(cf.getParameter(request,"tcbm"));
...
try {
	...
	ls_sql="select xh,gg,ppmc,gysmc,jldw,ydj,tcdj,sjzj,jsj,sl,lrr,lrsj,bz ";
	ls_sql+=" from  bj_khzctcmxh";
    ls_sql+=" where zjxxh='"+zjxxh+"' and tcbm='"+tcbm+"' and cpmc='"+cpmc+"'";
	ps= conn.prepareStatement(ls_sql);
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditBj_zctcmx.jsp" name="editform">
