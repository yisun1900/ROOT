...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 请录入主材报价信息</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
              ...
              <td width="32%"> 
                <select name="zcxlbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="selectItem(zcxlbm,dwbh,<%=ppstr%>);selectItem(zcxlbm,gys,<%=ppstr%>)">
                  <option value=""></option>
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><font color="#FF0000">*</font><font color="#0000CC"></font>品牌供应商</td>
              <td width="32%"> 
