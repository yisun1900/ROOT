...
{
	ppstr=cf.getItemData("select sq_gysxx.gysmc c1,sq_gysxx.gysmc||'('||dwmc||')' c2,zclb from sq_gysxx,sq_dwxx where sq_gysxx.ssdw=sq_dwxx.dwbh(+) and sq_gysxx.gyslb='4' order by sq_gysxx.zclb,sq_gysxx.gysmc,sq_gysxx.ssfgs");
}
else{
	ppstr=cf.getItemData("select sq_gysxx.gysmc c1,sq_gysxx.gysmc||'('||dwmc||')' c2,zclb from sq_gysxx,sq_dwxx where sq_gysxx.ssdw=sq_dwxx.dwbh(+) and sq_gysxx.gyslb='4' and sq_gysxx.dqbm='"+dqbm+"' order by sq_gysxx.ssfgs,sq_gysxx.zclb,sq_gysxx.gysmc");
}
%>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="zclbbm" value="" size="72" maxlength="100" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <select name="jgpx" style="FONT-SIZE:14PX;WIDTH:515PX">
                  ...
                  <option  value="jc_zcjgb.zcdlbm,jc_zcjgb.dwbh,jc_zcjgb.zclbbm,jc_zcjgb.xh,jc_zcjgb.zcbm">大类,品牌,类别系列，型号</option>
                  <option  value="jc_zcjgb.zcdlbm,jc_zcjgb.dwbh,jc_zcjgb.zclbbm,jc_zcjgb.xh,jc_zcjgb.gg,jc_zcjgb.zcbm">大类,品牌,类别系列，型号，规格</option>
                  <option  value="jc_zcjgb.zcdlbm,jc_zcjgb.dwbh,jc_zcjgb.xh,jc_zcjgb.gg,jc_zcjgb.zcbm">大类,品牌，型号，规格</option>
