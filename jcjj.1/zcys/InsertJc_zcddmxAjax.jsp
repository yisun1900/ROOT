...
%> </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="79%"> 
        <textarea name="bz" cols="42" rows="3"></textarea>      </td>
    </tr>
    <tr> 
...
{   
	...
	if(event.keyCode==13)
	{
		...
		ajaxlx=2;
		actionStr="/jcjj/zcdd/GetCpxxByAjax.jsp?jc_zcjgb_xh="+FormName.jc_zcjgb_xh.value+"&dqbm=<%=dqbm%>&ppbm=<%=ppbm%>";
...
//		window.open(actionStr);
	...
	else if(event.keyCode==40)
	{
		...
		//获取型号列表
		ajaxlx=1;
		actionStr="/jcjj/zcdd/GetXhListByAjax.jsp?jc_zcjgb_xh="+FormName.jc_zcjgb_xh.value+"&dqbm=<%=dqbm%>&ppbm=<%=ppbm%>";
//		window.open(actionStr);
		openAjax(actionStr);  
	}
...
function changeItem(FormName,field)
{
	...
	else if(event.keyCode==13)
	{
		...
		ajaxlx=2;
		actionStr="/jcjj/zcdd/GetCpxxByAjax.jsp?zcbm="+FormName.zcbm.value;
//		window.open(actionStr);
		openAjax(actionStr);
	}
}
