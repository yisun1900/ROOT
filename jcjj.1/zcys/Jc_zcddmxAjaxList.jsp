...
<%	
	...
	ls_sql ="SELECT jc_zcysdmx.xh xh,zclbbm,jc_zcysdmx.zcbm zcbm,zcmc,jc_zcysdmx.xinghao,jc_zcysdmx.gg,zcpzwzbm,jc_zcysdmx.zcysbm,DECODE(xzjg,'0','手写','1','销售限价','2','<font color=\"#FF0000\">促销价</font>') xzjg,TO_CHAR(jc_zcysdmx.zqdj) zqdj,TO_CHAR(jc_zcysdmx.dpzk) dpzk,TO_CHAR(jc_zcysdmx.dj) dj,jldwbm,jc_zcysdmx.sl,jc_zcysdmx.zqje,jc_zcysdmx.je,ycf,qtfyje,DECODE(jc_zcysdmx.sfbhpj,'Y','<font color=\"#FF0000\">包含</font>','N','不含') sfbhpj,jc_zcysdmx.pjts*jc_zcysdmx.sl pjzs, DECODE(jc_zcysdmx.cxhdbz,'Y','<font color=\"#FF0000\">参加</font>','N','不参加') cxhdbz,cxhdbl||'%' cxhdbl,cxhdje,DECODE(jc_zcysdmx.sxbz,'1','非手写','2','手写') sxbz, jc_zcysdmx.sxhtyy,jc_zcysdmx.bz  ";
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJc_zcddmxAjax.jsp?ddbh="+ddbh};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%" bgcolor="#CC99FF">计入活动比率</td>
