...
%> 
              ...
              <td width="19%" align="right"><font color="#FF0000">*</font>展厅家居顾问</td>
              <td width="31%"> 
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
				  ...
				  <input type="button" value="打印预订单" onClick="window.open('/jcjj/dygl/dyydd.jsp?lx=cg&ddbh=<%=ddbh%>&khbh=<%=khbh%>')" name="dy" disabled>                </td>
            </tr>
        </table>
</form>
