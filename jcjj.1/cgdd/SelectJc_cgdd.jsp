...
<form method="post" action="Jc_cgddList.jsp" name="selectform">
<div align="center">橱柜订单－维护</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><select name="jc_cgdd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX" >
		  <option value=""></option>
		  <option value="00">预订单未完成</option>
		  <option value="01">预订单已完成</option>
	  </select></td>
	</tr>
	...
	<tr bgcolor="#FFFFFF"> 
	  ...
	  <td width="31%"><select name="jc_cgdd_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" >
			  <%
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.pgcsj2, "派单时间"))) {
		return false;
	}
