...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddPlWhFdblList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"设置客户返点比例","设置厂商结算比例","设置提成记入比例"};//按钮的显示名称
	String[] buttonLink={"PlEditWhFdblJc_zcdd.jsp","PlEditWhJsblJc_zcdd.jsp","PlEditWhTcblJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">远程费</td>
	<td  width="2%">正常品结算比例</td>
	<td  width="2%">特价品结算比例</td>
	<td  width="2%">安装费结算比例</td>
	<td  width="2%">远程费结算比例</td>
	<td  width="4%">结算金额</td>
	<td  width="2%">正常品客户返点比例</td>
	<td  width="2%">特价品客户返点比例</td>
	<td  width="4%">客户优惠金额</td>
	<td  width="2%">正常品提成记入比例</td>
	<td  width="2%">特价品提成记入比例</td>
