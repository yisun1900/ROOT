...
if (dds>0)
{
	...
	<%
		...
		ls_sql+=" and jc_zcdd.ddlx='C'";//9:集成家居主材
...
<input name="zzczkzkje" type="text" onChange="f_jsjg(insertform)" value="" size="10" maxlength="20"  style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td colspan="3">&nbsp;③、<strong>主材预付款</strong>，已付金额：
			   <input type="text" name="zcyfk" size="8" value="<%=zcyfk%>" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"  >
			  ，本次转款金额
              <input name="yfkzkje" type="text" onChange="f_jsjg(insertform)" value="" size="10" maxlength="20"  style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              ，本次使用金额
              <input name="djqje" type="text" onChange="f_jsjg(insertform)" value="" size="10" maxlength="20" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid">
			  <BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凭证号
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertJc_zcddTh.jsp";
	FormName.submit();
