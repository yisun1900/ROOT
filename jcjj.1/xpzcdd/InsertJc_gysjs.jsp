...
<CENTER >
  <B><font size="3">松下亿达选配主材主材商户结算单</font></B>
</CENTER>
...
<tr bgcolor="#CCCCCC"  align="center" height="23">
  ...
  <%
	...
	ls_sql+=" ,jc_zcdd.hkze,jc_zcdd.zqclf,jc_zcdd.zcpclf,jc_zcdd.tjpclf,jc_zcdd.fdbl,jc_zcdd.tjpfdbl,round(jc_zcdd.zcpclf*jc_zcdd.fdbl/100+jc_zcdd.tjpclf*jc_zcdd.tjpfdbl/100,2)+round(jc_zcdd.ycf*jc_zcdd.ycfjsbl/100,2)+round(jc_zcdd.qtf*jc_zcdd.azfjsbl/100,2) fdje,jc_zcdd.bz,jc_zcdd.qtf,jc_zcdd.ycf,decode(jc_zcdd.ddlx,'C','选配主材')ddlx,jc_zcdd.zcdlbm";
	ls_sql+=" ,jc_zcdd.azfjsbl,jc_zcdd.ycfjsbl";
	ls_sql+=" FROM jc_zcdd,crm_khxx,sq_dwxx,bdm_bjjbbm";
	ls_sql+=" where jc_zcdd.khbh=crm_khxx.khbh and jc_zcdd.ddlx in('C')";//9：选配主材主材;E;散客
...
{
	FormName.action="ViewJc_gysjs.jsp";
	FormName.submit();
	return true;
}
