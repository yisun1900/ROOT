...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">修改套餐客户主材清单</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_khxxXgzcList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right" bgcolor="#FFFFCC"> 
                <font color="#FF0000">*</font>分公司              </td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="16%" align="right">材料顾问</td>
              <td width="34%"> 
