...
<div align="center">套餐客户主材查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFCC">
    <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font>分公司 </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><%
	cf.radioToken(out, "sfcscp","Y+是&N+否","");
%></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	  <input type="radio" name="fjtcbz" value="Y">分解
	  <input type="radio" name="fjtcbz" value="N">未分解  </td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
