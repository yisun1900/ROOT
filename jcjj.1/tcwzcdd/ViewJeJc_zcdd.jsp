...
try {
	...
	ls_sql+=" ,yddjsr,yddjssj,sxhtsfysh,sxhtshr,sxhtshsj,ckr,cksj,khjl";
	ls_sql+=" from  jc_zcdd";
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFCC"> 
	...
	<td width="21%" align="right"><b>&nbsp</b></td>
    <td width="29%">&nbsp</td>
  ...
  <tr bgcolor="#FFFFCC">
	...
	<td align="right"><font color="#0000CC">&nbsp</font></td>
    <td>&nbsp<font color="#FF0000">&nbsp</font></td>
...
%> </td>
  ...
  <!--<tr bgcolor="#E8E8FF">
    <td align="right" bgcolor="#E8E8FF">出库人</td>
    <td><%=ckr%></td>
...
%> </td>
    <td width="21%" align="right"> 
      结算提醒    </td>
    <td width="29%" bgcolor="#FFFFFF"> <%=jc_zcdd_jstx%> </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width="20%" align="right" bgcolor="#FFFFFF"> 
      录入人    </td>
...
<tr bgcolor="#CCCCCC"  align="center">
  ...
  <td  width="2%" rowspan="2">最小起订量</td>
	<td  width="2%" rowspan="2" >铺装位置</td>
	<td  width="2%" rowspan="2" >颜色</td>
  <td colspan="9"><strong>实际单价</strong></td>
  <td colspan="11"><strong>合同情况</strong></td>
  <td colspan="10" bgcolor="#CC99FF"><strong>合同＋增减项</strong></td>
  <td  width="1%" rowspan="2">配件数</td>
  <td  width="5%" rowspan="2">系列</td>
  <td  width="3%" rowspan="2">手写合同原因</td>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="1%"><strong><font color="#FF0000">(材料-成本)/材料费</font></strong></td>

	<td  width="1%" bgcolor="#CC99FF">数量</td>
	<td  width="2%" bgcolor="#CC99FF">折前材料费</td>
	<td  width="2%" bgcolor="#CC99FF">折后材料费</td>
	<td  width="2%" bgcolor="#CC99FF">远程费</td>
	<td  width="2%" bgcolor="#CC99FF">其它费</td>
	...
	<td  width="1%" bgcolor="#CC99FF"><strong><font color="#FF0000">(材料-成本)/材料费</font></strong></td>
...
<%
	...
	ls_sql ="SELECT DECODE(jc_zcddmx.lx,'1','合同','2','增项') lx,DECODE(jc_zcddmx.sxbz,'1','否','2','手写') sxbz ";
	...
	ls_sql+=" ,TO_CHAR(jc_zcddmx.zqdj) zqdj,TO_CHAR(jc_zcddmx.dpzk) dpzk,TO_CHAR(jc_zcddmx.dj) dj,jc_zcddmx.jsbl||'%',TO_CHAR(jc_zcddmx.cbj) cbj,jldwbm,decode(cxhdbz,'Y','参加','N','不参加'),cxhdbl||'%' cxhdbl,jc_zcddmx.sl";
	ls_sql+=" ,jc_zcddmx.zqje,jc_zcddmx.je,ycf,DECODE(qtfy,'1','安装费','2','加工费','3','其它收费'),qtfyje,NVL(zqje,0)+NVL(ycf,0)+NVL(qtfyje,0) zqhtze,NVL(je,0)+NVL(ycf,0)+NVL(qtfyje,0) zhhtze,cxhdje,ROUND(cbj*sl,2) htcbj,DECODE(jc_zcddmx.je,0,'',ROUND(100-ROUND(cbj*sl,2)*100/jc_zcddmx.je)||'%'   ) htmll";
	ls_sql+=" ,zjhsl,zqzjhje,zjhje,zjhycf,zjhqtfy,NVL(zqzjhje,0)+NVL(zjhycf,0)+NVL(zjhqtfy,0) zqzjhze,NVL(zjhje,0)+NVL(zjhycf,0)+NVL(zjhqtfy,0) zjhze,zjhcxhdje,ROUND(cbj*zjhsl,2) zjhcbj,DECODE(jc_zcddmx.zjhje,0,'',ROUND(100-ROUND(cbj*zjhsl,2)*100/jc_zcddmx.zjhje)||'%'   ) zjhmll";
