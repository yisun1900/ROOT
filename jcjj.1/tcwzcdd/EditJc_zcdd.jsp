            ...
            <tr> 
              <td colspan="4" height="2"> 
                <div align="center">
                  ...
                  <input type="button"  value="套餐" onClick="f_tc(editform)" name="tc" <%if (ddlx.equals("5") || ddlx.equals("6") || ddlx.equals("7") || ddlx.equals("8")) out.println("disabled");%>>
                  <input type="button"  value="顶配" onClick="f_dp(editform)" name="dp" disabled>
                </div> 
              </td>
            </tr>
        </table>
