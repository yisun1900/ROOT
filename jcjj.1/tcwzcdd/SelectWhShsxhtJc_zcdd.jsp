...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">维护-审核手写合同</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td align="right"><strong><font color="#FF0000">*手写合同审核标志</font></strong></td>
              <td><input name="sxhtsfysh" type="radio" value="N" >
              未审核
              <input type="radio" name="sxhtsfysh" value="Y" checked>已审核</td>
            </tr>
            <tr bgcolor="#E8E8FF">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (FormName.sxhtsfysh[0].checked)
	{
		FormName.action="Jc_zcddWhShsxhtList.jsp";
	}
	else{
		FormName.action="Jc_zcddWhXgShsxhtList.jsp";
	}
	FormName.submit();
	return true;
}
