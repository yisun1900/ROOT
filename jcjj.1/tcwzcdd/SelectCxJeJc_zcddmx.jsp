...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">查询－订单明细(金额)</div></td>
  </tr>
  <tr>
    <td width="100%" > 
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td colspan="3"> 第一列
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
                    ...
                    <option value="jc_zcddmx.sftjcp desc">是否推荐产品</option>
              ...
              <td colspan="3"> 第一列
                <input type="hidden" name="tj1name" value="">
                  <select name="tj1" style="FONT-SIZE:12PX;WIDTH:100PX" onChange="tj1name.value=tj1.options[tj1.selectedIndex].text">
                    ...
                    <option value="jc_zcddmx.gys">供应商</option>
                    <option value="jc_zcddmx.ppmc">品牌</option>
                    <option value="DECODE(jc_zcddmx.sftjcp,'Y','推荐','N','否')">是否推荐产品</option>
                    <option value="jc_zcddmx.zclbbm">主材类别系列</option>
                    <option value="jc_zcddmx.xinghao" >主材型号</option>
                    <option value="jc_zcddmx.gg">主材规格</option>
                    <option value="jc_zcddmx.zcysbm">主材颜色</option>
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><strong>是否单项完结</strong></td>
              <td><input type="radio" name="jc_zcdd_sfwj" value="Y">
                完结
                  <input type="radio" name="jc_zcdd_sfwj" value="N">
              未完结</td>
              <td align="right"><strong>是否推荐产品</strong></td>
              <td><input type="radio" name="jc_zcddmx_sftjcp" value="Y">
                是
                  <input type="radio" name="jc_zcddmx_sftjcp" value="N">
                  否</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">单项完结时间 从 </td>
              <td><input name="jc_zcdd_wjsj" type="text"  onDblClick="JSCalendar(this)" size="20" maxlength="10"></td>
              <td align="right">到</td>
              <td><input name="jc_zcdd_wjsj2" type="text"  onDblClick="JSCalendar(this)" size="20" maxlength="10"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_zcdd_wjsj, "单项完结时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_wjsj2, "单项完结时间"))) {
		return false;
	}
	...
	if (lx=="cx")
	{
		FormName.action="Jc_zcddmxCxJeList.jsp";
	}
	else if (lx=="tj")
	{
		...
		FormName.action="Jc_zcddmxTjJeList.jsp";
	}
