            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="63%" height="54"> 
                <select name="gysmc" style="FONT-SIZE:12PX;WIDTH:300PX">
                  <option value=""></option>
<%
	cf.selectItem(out,"select distinct jxc_gysxx.gysmc c1,jxc_gysxx.gysmc c2 from jxc_ppxx,jxc_ppsqfgs,jxc_ppgysdzb,jxc_gysxx where jxc_ppxx.ppbm=jxc_ppsqfgs.ppbm and jxc_ppxx.ppbm=jxc_ppgysdzb.ppbm and jxc_ppgysdzb.gysbm=jxc_gysxx.gysbm and jxc_ppsqfgs.ssfgs='"+ssfgs+"' order by jxc_gysxx.gysmc","");
%> 
                </select>
              </td>
            </tr>
