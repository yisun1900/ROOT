...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String crm_khxx_fjtcbz=null;
	crm_khxx_fjtcbz=request.getParameter("crm_khxx_fjtcbz");
	if (crm_khxx_fjtcbz!=null)
	{
		crm_khxx_fjtcbz=cf.GB2Uni(crm_khxx_fjtcbz);
		if (!(crm_khxx_fjtcbz.equals("")))	wheresql+=" and  (crm_khxx.fjtcbz='"+crm_khxx_fjtcbz+"')";
	}
