...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,crm_khxx.khxm,crm_khxx.fwdz,ppbm,jc_zcdd.htshsj,jc_zcdd.jhshsj,jc_zcdd.sshsj,jc_zcdd.sshr,jc_zcdd.tzry,crm_khxx.lxfs||','||crm_khxx.qtdh,crm_khxx.hth,crm_khxx.sgbz,sq_bzxx.dh,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy, DECODE(jc_zcdd.jkxz,'1','未付款','2','全款','3','材料商收余款','4','预付款减出','5','退货款减出'), DECODE(jc_zcdd.jkdd,'1','材料商现场收余款','2','店面收款','3','公司财务收款'),jc_zcdd.hkze,jc_zcdd.zjhze,jc_zcdd.shqk,jc_zcdd.gys,DECODE(jc_zcdd.ddshbz,'1','不需待电','2','待电未通知','3','待电已通知')";
