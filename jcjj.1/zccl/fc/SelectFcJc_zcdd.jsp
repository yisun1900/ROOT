...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－复尺</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddFcList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right">发复尺通知时间 从</td>
              <td><input type="text" name="jc_zcdd_tzfcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_tzfcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_zcdd_tzfcsj, "发复尺通知时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_tzfcsj2, "发复尺通知时间"))) {
		return false;
	}
