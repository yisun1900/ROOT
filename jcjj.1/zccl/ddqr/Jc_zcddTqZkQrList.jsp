...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddTqZkQrList.jsp","","","TqZkQrJc_zcdd.jsp");
//	pageObj.setPageRow(3);//设置每页显示记录数
...
//设置按钮参数
	...
	String[] buttonLink={"SaveAllQrJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">主材订单处理－－特权确认</font></B>
</CENTER>
<%
	pageObj.out=out;
