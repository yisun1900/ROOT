...
try {
	...
	ls_sql="select shqk,sshr,sshsj,wjsj,stbhsj,stbhr,tbhtzry,jhtbhsj,tbhqk,tztbhsj,tztbhr,shtzsm,jhshsj,tzry,ztjjgw,htcxhdje,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,zjhze,ddqrr,ddqrsj,cltzr,tzclsj,sclr,sclsj,tzshr,tzshsj ";
	ls_sql+=" from  jc_zcdd";
...
<div align="center">修改完结登记（订单编号：<%=ddbh%>） </div>
...
%>  
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#CCCCFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="wjlrr" value="<%=yhmc%>" size="20" maxlength="20" >
      </td>
      <td width="18%"> 
        <div align="right">完结时间</div>
      </td>
      <td width="32%"> 
        <input type="text" name="wjsj" value="<%=wjsj%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
      </td>
    </tr>
    <tr> 
      <td colspan="4">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgWjdjJc_zcdd.jsp";
	FormName.submit();
	return true;
}
