...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">财务帐期</td> 
  <td width="32%"><input type="text" name="cwzq" value="<%=cwzq%>" size="20" maxlength="20" /></td>
</tr>
<tr bgcolor="#FFFFFF">
...
{
	var jsje=FormName.cbzj.value*1.0+FormName.ycfzj.value*1.0+FormName.qtfzj.value*1.0-FormName.kcfy.value*1.0;
	jsje=round(jsje,2);
