...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－修改入库</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddXgRkList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="jc_zcdd_rksj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_rksj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#E8E8FF">
...
{
	if(!(isDatetime(FormName.jc_zcdd_rksj, "入库时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_rksj2, "入库时间"))) {
		return false;
	}
