...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－入库</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddRkList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right">计划复尺时间 从</td>
              <td><input type="text" name="jc_zcdd_jhfcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_jhfcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right">复尺时间 从</td>
              <td><input type="text" name="jc_zcdd_fcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_fcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
...
{
	if(!(isDatetime(FormName.jc_zcdd_jhfcsj, "计划复尺时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_jhfcsj2, "计划复尺时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_fcsj, "复尺时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_fcsj2, "复尺时间"))) {
		return false;
	}
