...
try {
	...
	ls_sql+=" ,tzclsj,cltzr,sclsj,sclr,jhfcsj";
	ls_sql+=" from  jc_zcdd";
...
<body bgcolor="#FFFFFF">
<div align="center">通知复尺（订单编号：<%=ddbh%>） 
...
<form method="post" action="" name="editform" >
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"><input type="text" name="tzfcsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveFcTzJc_zcdd.jsp";
	FormName.submit();
	return true;
}
