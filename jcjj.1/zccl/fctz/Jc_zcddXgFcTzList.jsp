...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zcdd.tzfcsj desc";

//	out.println(ls_sql);

	pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgFcTzList.jsp","","","XgFcTzJc_zcdd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除复尺通知"};//按钮的显示名称
	String[] buttonLink={"DeleteFcTzJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">主材订单处理－－修改通知复尺</font></B>
</CENTER>
<%
	pageObj.out=out;
