...
<body bgcolor="#FFFFFF">
<div align="center">预订单接收（订单编号：<%=ddbh%>） 

</div>
<form method="post" action="" name="editform" >
<table border="1" width="100%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 14px'>
  <tr > 
    <td width="18%" align="right"><b>客户编号</b></td>
    <td ><%=khbh%></td>
    <td width="18%" align="right"><b>合 同 号</b></td>
    <td  width="32%"><%=hth%></td>
  </tr>
  <tr > 
    <td width="18%" align="right"><b>客户姓名</b></td>
    <td ><%=khxm%>（<%=lxfs%>）</td>
    <td width="18%" align="right"><b>质检姓名</b></td>
    <td  width="32%"><%=zjxm%></td>
  </tr>
  <tr > 
    <td width="18%" align="right"><b>房屋地址</b></td>
    <td colspan="5"><%=fwdz%></td>
  </tr>
  <tr > 
    <td width="18%" align="right"><b>设 计 师</b></td>
    <td ><%=sjs%></td>
    <td width="18%" align="right"><b>签约日期</b></td>
    <td  width="32%"><%=qyrq%></td>
  </tr>
  <tr > 
    <td width="18%" align="right"><b>合同开工日期</b></td>
    <td ><%=kgrq%></td>
    <td width="18%" align="right"><b>合同竣工日期</b></td>
    <td  width="32%"><%=jgrq%></td>
  </tr>
  <tr > 
    <td width="18%" align="right"><b>施 工 队</b></td>
    <td ><%
	cf.selectItem(out,"select sgd,sgdmc||'（'||dh||'）' from sq_sgd where sgd='"+sgd+"'",sgd,true);
%></td>
    <td width="18%" align="right"><b>班 &nbsp;长</b></td>
    <td  width="32%"><%=sgbz%>（<%=bzdh%>）</td>
  </tr>

    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        <span class="STYLE1">*</span><span class="STYLE2">接收时间      </span></td>
      <td width="32%"> 
      <input type="text" name="yddjssj" value="<%=cf.today()%>" size="20" maxlength="10" readonly>      </td>
      <td width="18%" align="right"><span class="STYLE1">*</span><span class="STYLE2">接收人</span></td>
    ...
    <tr> 
      <td colspan="4" align="center"> 
          ...
          <input type="button"  value="接收" onClick="f_do(editform)" name="button">
          <input name="button2" type="button" onClick="window.open('/khxx/dyKhJbxx.jsp?khbh=<%=khbh%>')"  value="打印客户信息" ></td>
    </tr>
  </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.yddjssj, "接收时间"))) {
		return false;
	}
