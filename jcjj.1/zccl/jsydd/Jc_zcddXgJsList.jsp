...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,jc_zcdd.lrsj,ppbm,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcdd.bz,jc_zcdd.ppmc,jc_zcdd.gys,zcxlbm,DECODE(jc_zcdd.xclbz,'1','非定制式产品','2','定制式产品')";
...
//	out.println(ls_sql);
	...
	pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgJsList.jsp","","","");
/*
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJsJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
