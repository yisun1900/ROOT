...
<html>
<head>
<title>修改计划测量时间</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>

<body bgcolor="#FFFFFF">
<div align="center">修改计划测量时间（订单编号：<%=ddbh%>） 
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td width="15%" align="right"> 
        计划测量时间      </td>
      <td width="35%">
        <input type="text" name="jhclsj" value="<%=jhclsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
      <td width="15%"> 
    ...
    <tr> 
      <td colspan="4">
          <div align="center">
            ...
            <input type="button"  value="打印客户信息" onClick="window.open('/khxx/dyKhJbxx.jsp?khbh=<%=khbh%>')" name="button2" >
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveJhclJc_zcdd.jsp";
	FormName.submit();
	return true;
}
