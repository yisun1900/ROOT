...
//	out.println(ls_sql);
	...
	pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddJhclList.jsp","","","JhclJc_zcdd.jsp");
...
<CENTER >
  <B><font size="3">主材订单处理－－修改计划测量时间</font></B>
</CENTER>
<%
	pageObj.out=out;
