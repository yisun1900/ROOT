...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (sfjs!=null)
	{
		if (sfjs.equals("Y"))
		{
			wheresql+=" and  (jc_zczjx.sfjs in('Y','M'))";
		}
		else if (sfjs.equals("N"))
		{
			wheresql+=" and  (jc_zczjx.sfjs not in('Y','M'))";
		}
	}
	...
	if (sfjrht!=null)
	{
		...
		if (!(sfjrht.equals("")))	wheresql+=" and  (jc_zczjx.sfjrht='"+sfjrht+"')";
	}
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),DECODE(jc_zczjx.sfjrht,'Y','计入','N','不计入') sfjrht,crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,DECODE(jc_zczjx.sfjs,'N','未结算','C','已选择结算','Y','已结算','M','结算已审核'),jc_zczjx.zqzjxze,jc_zczjx.zjxze,TO_CHAR(jc_zczjx.zjxzkl) zjxzkl,jc_zczjx.zjxcxhdje,jc_zczjx.jissj,jc_zczjx.jisr,jc_zczjx.dzyy,jc_zczjx.ddbh,jc_zczjx.zcxlbm,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,jc_zczjx.qrsj,zczjxyymc,jc_zczjx.lrsj,dwmc lrbm,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.bz";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jc_zczjxCxList.jsp","","","/jcjj/dygl/DyZcZjx.jsp");
