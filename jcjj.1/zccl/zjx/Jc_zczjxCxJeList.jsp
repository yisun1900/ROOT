...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,DECODE(jc_zczjx.sfjs,'N','未结算','C','已选择结算','Y','已结算','M','结算已审核'),jc_zczjx.zqzjxze,jc_zczjx.zjxze,jc_zczjx.zjxcxhdje,jc_zczjx.zjxcbze,jc_zczjx.jissj,jc_zczjx.jisr,TO_CHAR(jc_zczjx.zjxzkl) zjxzkl,jc_zczjx.dzyy,jc_zczjx.ddbh,jc_zczjx.zcxlbm,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,jc_zczjx.qrsj,zczjxyymc,jc_zczjx.lrsj,dwmc lrbm,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.bz";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jc_zczjxCxJeList.jsp","","","/jcjj/dygl/zcfjzjx.jsp");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%" bgcolor="#CC99FF">增减项成本总额</td>
	<td  width="3%">结算时间</td>
	<td  width="2%">结算人</td>
