...
<form method="post" action="Jc_zczjxCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF">是否计入家装合同</td>
              <td><INPUT type="radio" name="sfjrht" value="Y">
                计入
                  <INPUT type="radio" name="sfjrht" value="N">
              不计入</td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td>
			  <input type="radio" name="sfjs" value="Y">已结算
			  <input type="radio" name="sfjs" value="N">未结算			  </td>
            </tr>
            <tr bgcolor="#FFFFFF">
