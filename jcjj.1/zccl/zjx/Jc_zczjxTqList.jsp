...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ddbh,jc_zczjx.zcxlbm,jc_zczjx.ppbm,jc_zczjx.zqzjxze,jc_zczjx.zjxze,TO_CHAR(jc_zczjx.zjxzkl) zjxzkl,jc_zczjx.zjxcxhdje,jc_zczjx.zjxfssj,jc_zczjx.lrsj,a.dwmc lrbm,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.bz";
	ls_sql+=" FROM crm_khxx,jc_zczjx,sq_dwxx a ";
    ls_sql+=" where jc_zczjx.khbh=crm_khxx.khbh and jc_zczjx.dwbh=a.dwbh";
    ls_sql+=" and jc_zczjx.clzt in('00','01')";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zczjxTqList.jsp","","","EditJc_zczjx.jsp");
...
//设置主键
	...
	pageObj.setEditBolt("");
//设置按钮参数
	String[] buttonName={"删除完成标志","删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"DeleteEndJc_zczjx.jsp","DeleteJc_zczjx.jsp"};//按钮单击调用的网页，可以增加参数
