...
try {
	...
	ls_sql+=" ,jsfs,sfycx,cxj,cxkssj,cxjzsj,qtfyje,cxhdbl,cxhdje,gys,ppmc,bzcxhdbl,lscxhdbl,jsbl,cbj,DECODE(sftjcp,'Y','是','N','否') sftjcp ";
	...
	ls_sql="select zjsl,zjje,zjycf,zjqtfy,zjcbje,zjcxhdje,bz,lx,sxbz ";
	...
	{
		out.println("错误！老项目不能改结算价");
		return;
	}
	if (!sxbz.equals("2"))//1：非手写；2：手写
	{
		out.println("错误！非手写项目不能改结算价");
		return;
	}
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审核手写合同－录入结算价（增减项编号：<%=zjxbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveLrjsjEditJc_zcddmx.jsp" name="editform">
