...
<body bgcolor="#ffffff" text="#000000" style='FONT-SIZE: 14px'>
 ...
 <div align="center">审核手写合同－批量录入结算比例（订单编号：<%=ddbh%>）</div>
...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#E8E8FF"  align="center">
			...
			<td>
				<A HREF="LrJsblJc_zczjxmx.jsp?zjxbh=<%=zjxbh%>&ddbh=<%=ddbh%>&xh=<%=xh%>" target="_blank">修改</A>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SavePlLrJsblJc_zczjxmx.jsp";
	FormName.submit();
	return true;
}
