...
<form method="post" action="Jc_zczjxList.jsp" name="selectform">
...
%> 
			...
			{
				%>
				<input type="text" name="jc_zczjx_lrr" size="20" maxlength="20" value="" >              
				<%
			}
			else{
				%>
				<input type="text" name="jc_zczjx_lrr" size="20" maxlength="20" value="<%=yhmc%>" readonly="true">              
				<%
			}
			%>
				</td>
              <td align="right" bgcolor="#FFFFFF">录入部门</td>
              <td><select name="jc_zczjx_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
