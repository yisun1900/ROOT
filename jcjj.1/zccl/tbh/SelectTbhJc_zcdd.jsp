...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－退补货
    </div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddTbhList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="19%" align="right">&nbsp</td>
              <td width="31%"> 
              </td>
            </tr>
            <!--<tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right">约定退补货时间 从</td>
              <td><input type="text" name="jhtbhsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jhtbhsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jhtbhsj2, "约定退补货时间"))) {
		return false;
	}
