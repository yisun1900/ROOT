...
//	out.println(ls_sql);
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddShsjList.jsp","","","ShsjJc_zcdd.jsp");
//	pageObj.setPageRow(1000);//设置每页显示记录数
	pageObj.setEditStr("确定");//设置每页显示记录数
/*
//设置显示列
