...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jc_zcdd.clzt in('11','13','15','17','25','26','27')";
    ls_sql+=" and SYSDATE-jc_zcdd.ddqrsj>="+shsj;
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddShtxList.jsp","","","");
...
<CENTER >
  <B><font size="3">主材订单处理－－送货提醒</font></B>
</CENTER>
<%
	pageObj.out=out;
