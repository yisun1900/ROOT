...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),DECODE(jc_zczjx.sfjs,'N','未结算','C','已选择结算','Y','已结算','M','结算已审核'),crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,jc_zczjx.ddbh,jc_zczjx.wjr,jc_zczjx.wjsj,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,jc_zczjx.lrsj,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.bz";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zczjxXgWjList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"删除完结"};//按钮的显示名称
	String[] buttonLink={"DeleteWjJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
