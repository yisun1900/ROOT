...
<form method="post" action="" name="editform" target="_blank">
    ...
    <td width="100%" align="center" bgcolor="#CCCCCC"><div align="center">
      <p><strong>增减项－厂家接收</strong>（增减项编号：<%=zjxbh%>）</p>
      <p class="STYLE1">点【接收】后才能查看明细</p>
    </div></td>
...
%></td>
          ...
          <tr bgcolor="#FFFFFF">
            <td colspan="4" align="center"><input type="hidden" name="zjxbh" value="<%=zjxbh%>" >
              <input name="button" type="button" onClick="f_do(editform)"  value="接收">
              <input type="reset"  value="重输" name="reset">
              <input type="button" name="ckmx" disabled value="查看打印" onClick="window.open('/jcjj/dygl/gyszcfjzjx.jsp?zjxbh=<%=zjxbh%>')" ></td>
          </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveGcjsJc_zczjx.jsp";
	FormName.submit();
