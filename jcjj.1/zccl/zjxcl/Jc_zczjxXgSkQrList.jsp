...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String qrsj=null;
	qrsj=request.getParameter("qrsj");
	if (qrsj!=null)
	{
		qrsj=qrsj.trim();
		if (!(qrsj.equals("")))	wheresql+="  and (jc_zczjx.qrsj>=TO_DATE('"+qrsj+"','YYYY-MM-DD'))";
	}
	qrsj=request.getParameter("qrsj2");
	if (qrsj!=null)
	{
		qrsj=qrsj.trim();
		if (!(qrsj.equals("")))	wheresql+="  and (jc_zczjx.qrsj<=TO_DATE('"+qrsj+" 23:59:59','YYYY-MM-DD hh24:mi:ss'))";
	}




	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),jc_zczjx.qrsj,crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,jc_zczjx.zqzjxze,jc_zczjx.zjxze,TO_CHAR(jc_zczjx.zjxzkl) zjxzkl,jc_zczjx.zjxcxhdje,jc_zczjx.ddbh,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.lrr,jc_zczjx.bz";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zczjx.qrsj desc,jc_zczjx.zjxbh";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zczjxXgSkQrList.jsp","","","");
/*
//设置显示列
...
//设置按钮参数
	String[] buttonName={"删除确认"};//按钮的显示名称
	String[] buttonLink={"DeleteSkQrJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">增减项－删除确认<font color="#FF0000"><strong>（客户未付款不能确认）</strong></font></font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="9%">房屋地址</td>
	<td  width="8%">子品牌</td>
	<td  width="4%">折前增减项总额</td>
	<td  width="4%">折后增减项总额</td>
	<td  width="2%">折扣</td>
