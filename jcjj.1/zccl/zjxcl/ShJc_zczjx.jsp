...
<form method="post" action="" name="editform"  >
    ...
    <td width="100%" align="center" bgcolor="#CCCCCC"><div align="center">
      <p><strong>增减项－送货</strong>（增减项编号：<%=zjxbh%>）</p>
      </div></td>
...
%></td>
          ...
          <tr bgcolor="#FFFFFF">
            <td colspan="4" align="center"><input type="hidden" name="zjxbh" value="<%=zjxbh%>" >
              <input name="button" type="button" onClick="f_do(editform)"  value="送货">
              <input type="reset"  value="重输" name="reset">
              <input type="button" name="ckmx" value="查看明细" onClick="window.open('/jcjj/dygl/zcfjzjx.jsp?zjxbh=<%=zjxbh%>')" ></td>
          </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShJc_zczjx.jsp";
	FormName.submit();
