...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and jc_zcdd.clzt not in('00','02','03','05','07','19','21','23','30','98','99')";
	ls_sql+=" and jc_zcdd.ddlx in('1','3','4','9','C')";//1：代销品；3：补录合同；4：有库存订单；9：代购主材
...
/*
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zcdd.qhtsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddQxList.jsp","","","Qxdd.jsp");
	pageObj.setEditStr("退单");//设置每页显示记录数
...
<CENTER >
  <B><font size="3">主材订单处理－－退单</font></B>
</CENTER>
<%
	pageObj.out=out;
