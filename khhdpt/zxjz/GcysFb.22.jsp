...
<table width="137" border="0" cellpadding="0" cellspacing="0">
	...
	ls_sql=" select ysjlh,yssj,ysr,gcyszxmmc,bz";
	...
	while (rs.next())
	{
		...
		if (rs1.next())
		{
			...
			yszpmc="<A HREF=\"viewPhoto.jsp?ysjlh="+ysjlh+"\" target=\"_blank\"><img src='http://210.75.102.130:8090/gcgl/gcjdgz/images/"+yszpmc+"' width=\"280\"></A>";
		}
		rs1.close();
		ps1.close();
		...
		if (count>0)
		{
			gcyszxmmc=gcyszxmmc+"<P><A HREF=\"viewPhoto.jsp?ysjlh="+ysjlh+"\" target=\"_blank\">有照片"+count+"张</A>";
		}
		else{
			gcyszxmmc=gcyszxmmc+"<P><font color=\"#000099\">无照片</font>";
		}

		%> 
                    <tr bgcolor="#FFFFFF"> 
                      <td rowspan="2" align="center"><b><%=gcyszxmmc%></b></td>
                      <td align="center"><%=ysjlh%></td>
                      <td align="center"><%=yssj%></td>
                      <td align="center"><%=ysr%></td>
