			...
			<TBODY>
                <TR> 
                  <TD width=640> <DIV align=center class=css><a href="/khhdpt/khxx/HhxxIndex.jsp">我的资料</a> 
                      | <a href="../zytx/ZytxIndex.jsp">重要提醒</a> | <a href="4.html">快乐装修</a> 
                      | <a href="zxjz-1.html">我家装修进展</a> | <a href="jichengcp.html">购买集成产品</a> 
                      | <a href="../yhys/YhysIndex.jsp">有话要说 </a>| <a href="/khhdpt/wgpj/WgpjIndex.jsp">完工评价</a> | <a href="/khhdpt/yjdc/YjdcIndex.jsp">客户调查</a> 
...
<table width="282" height="61%" border="0" cellpadding="0" cellspacing="0">
    ...
    <TD width="617" valign="top"><table width="100%" height="766" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="26">&nbsp;</td>
        </tr>
        <tr> 
          <td height="28"> <div align="left"><img src="../images/youjiangdiaoc.jpg" width="534" height="174"></div></td>
        </tr>
        <tr> 
          <td height="566" valign="top"> <br>
            <table width="100%" border="0" height="649">
              <tr> 
                <td width="82%" height="550" valign="top"> 
                  <%@ include file="ckjg1.jsp"%>
                  <br>
                </td>
              </tr>
            </table></td>
