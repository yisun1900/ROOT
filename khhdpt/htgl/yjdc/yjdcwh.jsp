...
%>
	...
	<tr  bgcolor="#FFFFFF">
      ...
      <td width="28%"><input type="text" name="lrsj1" >
       </td>
	         <td align="right" width="14%">到</td>
      <td width="28%"><input type="text" name="lrsj2" >
       </td>
    </tr>
	<tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%">录入人</td>
      <td width="44%" colspan="3"><input type="text" name="lrr"   >
...
{
	if(!(isDatetime(FormName.lrsj1, "录入时间"))) {
		return false;
	}
