...
<body bgcolor="#FFFFFF">
<form method="post" action="Hd_khlyCxList1.jsp" name="selectform">
<div align="center">工程留言查询</div>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%">
        <input type="radio" name="hd_khly_lysfyck" value="N">
        未查看 
        <input type="radio" name="hd_khly_lysfyck" value="Y">
        已查看 </td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
	 ...
	 <tr bgcolor="#FFFFFF"> <td ALIGN="right" >留言类型</td>
	<td ><select name="hd_khly_lylx">
	<option value=""></option>
	<option value="1">工程留言</option>
	<option value="2">集成留言</option>
	<option value="3">客户投诉</option>
	<option value="4">客户表扬</option>
	<option value="5">客户建议</option>
	<option value="6">总经理信箱</option>
	<option value="9">其它留言</option>
	</td>
	<td colspan="2"></td>
</SELECT>
    <tr align="center"> 
