...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hd_khly.lyxh,DECODE(hd_khly.lylx,'1','工程留言','2','集成留言','3','客户投诉','4','客户表扬','5','客户建议','6','总经理信箱','9','其它留言'),DECODE(hd_khly.sfyqhf,'1','不需回复','2','必须回复','3','无要求'),DECODE(hd_khly.lysfyck,'N','未查看','Y','已看'),crm_khxx.khxm,crm_khxx.fwdz,hd_khly.lysj,hd_khly.lynr,crm_khxx.hth,crm_khxx.sjs,crm_khxx.qyrq,sgdmc,crm_khxx.zjxm,dwmc";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hd_khlyLyHfList1.jsp","SelectLyHfHd_khly1.jsp","","LyHfHd_khly.jsp");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">留言序号</td>
	<td  width="4%">留言类型</td>
	<td  width="4%">是否要求回复</td>
	<td  width="4%">留言是否已查看</td>
	<td  width="4%">客户姓名</td>
	<td  width="16%">房屋地址</td>
	<td  width="5%">留言时间</td>
	<td  width="26%">留言内容</td>
