...
<body bgcolor="#FFFFFF">
<form method="post" action="Hd_zyxxtxLyHfList.jsp" name="selectform">
  <div align="center">重要提醒---回复客户留言</div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="radio" name="hd_zyxxtxly_lysfyck" value="N" checked>
        未查看
      </td>
