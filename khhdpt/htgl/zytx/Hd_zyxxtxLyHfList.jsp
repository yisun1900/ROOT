...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hd_zyxxtxly.lyxh, DECODE(hd_zyxxtxly.lysfyck,'N','未查看','Y','已查看'),hd_zyxxtxly.lysj,hd_zyxxtxly.lynr,hd_zyxxtx.txxh,DECODE(hd_zyxxtx.txdj,1,'一般',2,'重要',3,'特别重要') txdj,hd_zyxxtx.txbt,hd_zyxxtx.txnr,hd_zyxxtx.lrr,hd_zyxxtx.lrsj,a.dwmc lrbm,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hd_zyxxtxLyHfList.jsp","SelectLyHfHd_zyxxtx.jsp","","LyHfHd_zyxxtxly.jsp");
...
//设置显示合并列
	...
	spanColHash.put("hth","2");//列参数对象加入Hash表
...
<CENTER >
  <B><font size="3">重要提醒---回复客户留言</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%" bgcolor="#CCCCFF">留言序号</td>
	<td  width="3%" bgcolor="#CCCCFF">是否已查看</td>
	<td  width="4%" bgcolor="#CCCCFF">留言时间</td>
	<td  width="19%" bgcolor="#CCCCFF">客户留言内容</td>
	<td  width="4%" bgcolor="#FFCCFF">提醒序号</td>
	<td  width="4%" bgcolor="#FFCCFF">提醒等级</td>
	<td  width="11%" bgcolor="#FFCCFF">提醒标题</td>
	<td  width="19%" bgcolor="#FFCCFF">提醒内容</td>
	<td  width="3%" bgcolor="#FFCCFF">提醒人</td>
	<td  width="4%" bgcolor="#FFCCFF">提醒时间</td>
	<td  width="6%" bgcolor="#FFCCFF">提醒部门</td>
	<td  width="4%" bgcolor="#CCCCFF">合同号</td>
	<td  width="3%" bgcolor="#CCCCFF">客户姓名</td>
	<td  width="11%" bgcolor="#CCCCFF">房屋地址</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
