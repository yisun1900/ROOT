...
<body bgcolor="#FFFFFF">
<form method="post" action="Hd_zyxxtxXgLyHfList.jsp" name="selectform">
  <div align="center">重要提醒---维护留言回复</div>
...
%> </td>
      <td align="right" width="19%">客户查看人</td>
      <td width="31%"> 
        <input type="text" name="hd_zyxxtx_khckr" size="20" maxlength="20" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="radio" name="hd_zyxxtxly_lysfyck" value="Y" checked>已查看
      </td>
