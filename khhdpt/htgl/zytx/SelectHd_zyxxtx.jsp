...
<body bgcolor="#FFFFFF">
<form method="post" action="Hd_zyxxtxList.jsp" name="selectform">
  <div align="center">重要提醒维护 </div>
...
%> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="32%">
        ...
        特别重要 </td>
      <td align="right" width="19%">客户是否已查看</td>
      <td width="31%">
        <input type="radio" name="hd_zyxxtx_khsfyck" value="N" checked>
        未查看 </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
