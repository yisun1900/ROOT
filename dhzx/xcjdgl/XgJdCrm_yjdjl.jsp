...
try {
	...
	ls_sql="select sgdmc,crm_yjdjl.zjxm,crm_yjdjl.sjjdqk,khbh,sqrq,sqr,sqrlxdh,jhjdrq,jhjdsj,sqsm,lrr,lrsj,dwmc,zzqrjdrq,zzqrjdsj,fbr,fbsj,sjjdsj,jdsfcg ";
...
%></td>
  ...
  <td><input type="text" name="sjjdsj" size="20" maxlength="10"  value="<%=sjjdsj%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">实际交底情况</td>
  <td colspan="3"><textarea name="sjjdqk" cols="71" rows="3"><%=sjjdqk%></textarea>  </td>
</tr>
...
<input type="hidden" name="jdjlh"  value="<%=jdjlh%>" >
    ...
    <tr> 
      <td colspan="4" >
	<div align="center">
	  <input type="button" onClick="f_do1(editform)"  value="预交底单">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="";
	FormName.action="SaveXgJdCrm_yjdjl.jsp";
	FormName.submit();
	return true;
}
