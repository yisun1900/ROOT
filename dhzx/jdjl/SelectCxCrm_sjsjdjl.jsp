...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_sjsjdjlCxList.jsp" name="selectform">
...
%> 
      ...
      <td width="33%"> 
        <select name="crm_sjsjdjl_zxdm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		out.println("<option value=\"\"></option>");
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_khbh" size="20" maxlength="20" >
      </td>
      <td align="right" width="17%">设计师</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_sjs" size="20" maxlength="20" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">设计师接单记录号</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_sjsjdjlh" size="20" maxlength="10" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_kssj" size="20" maxlength="10" >
      </td>
      <td align="right" width="17%">到</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_kssj2" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">开始录入人</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_kslrr" size="20" maxlength="20" value="<%=yhmc%>">
      </td>
      <td align="right" width="17%">结束录入人</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_jslrr" size="20" maxlength="20" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">结束时间 从</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_jssj" size="20" maxlength="10" >
      </td>
      <td align="right" width="17%">到</td>
      <td width="33%"> 
        <input type="text" name="crm_sjsjdjl_jssj2" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">失败原因</td>
      <td width="33%"> 
        <select name="crm_sjsjdjl_sbyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
      ...
      <td width="33%"> 
        <select name="crm_sjsjdjl_zxzt" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.crm_sjsjdjl_kssj, "开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_sjsjdjl_kssj2, "开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_sjsjdjl_jssj, "结束时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_sjsjdjl_jssj2, "结束时间"))) {
		return false;
	}
	FormName.submit();
	return true;
