...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxXgtchtList.jsp","","","XgEditCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"删除套餐合同"};//按钮的显示名称
	String[] buttonLink={"Crm_zxkhxxXgTchtList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from crm_tchtxx where "+chooseitem;
		sql[1]="update crm_zxkhxx set qtchtbz='N',qtchtsj=null,tchtje=null,hth=null,hyh=null where "+chooseitem;
