...
try {
	...
	ls_sql="select qtchtsj,tchtje,lrr,lrsj,bz ";
	ls_sql+=" from  crm_tchtxx";
	ls_sql+=" where  (khbh='"+khbh+"')  ";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
		qtchtsj=cf.fillNull(rs.getDate("qtchtsj"));
		tchtje=cf.fillNull(rs.getString("tchtje"));
...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
      <div align="center"><strong>修改－套餐合同</strong></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%></td>
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>套餐合同号</td>
              <td bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#E8E8FF">
              <td width="18%" align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font><font color="#CC0000">套餐合同金额</font></td>
              <td width="32%" bgcolor="#FFFFFF"><input type="text" name="tchtje" value="<%=tchtje%>" size="20" maxlength="16"  readonly></td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><input type="text" name="lrr" value="<%=yhmc%>" size="20" maxlength="20" readonly></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>签套餐合同时间 </td>
              <td><input type="text" name="qtchtsj" value="<%=qtchtsj%>" size="20" maxlength="10" readonly"></td>
            ...
            <tr> 
              <td colspan="4" height="2"> 
				...
				<input type="hidden" name="khbh"  value="<%=khbh%>" >
				  ...
				  <input type="button"  value="套餐合同打印预览" onClick="f_dytchtfj(editform)" name="dytchtfj">
...
function f_dytchtfj(FormName)//参数FormName:Form的名称
{
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.tchtje, "套餐合同金额"))) {
		return false;
	}
