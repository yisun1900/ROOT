...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
      <div align="center"><strong>签套餐合同</strong></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%></td>
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>合同号</td>
              <td bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              <td width="18%" align="right" bgcolor="#FFFFFF">套餐意向书金额</font></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>签套餐意向书时间</td>
            ...
            <tr> 
              <td colspan="4" height="2"> 
				...
				<input type="hidden" name="khbh"  value="<%=khbh%>" >
				  ...
				  <input type="button"  value="套餐合同打印预览" onClick="f_dytchtfj(editform)" name="dytchtfj" disabled>
...
function f_dytchtfj(FormName)//参数FormName:Form的名称打印合同预览按钮
{
