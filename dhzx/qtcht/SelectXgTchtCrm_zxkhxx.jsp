...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">修改－套餐合同</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Crm_zxkhxxXgTchtList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">套餐合同号</td>
              <td><input type="text" name="hth" size="20" maxlength="20" >              </td>
              <td align="right">签套餐合同标志</td>
              <td><input type="radio" name="qtchtbz" value="Y">
                签合同
                  <input type="radio" name="qtchtbz" value="N">
              未签 </td>
            </tr>
            <tr bgcolor="#FFFFFF">
