...
<form method="post" action="" name="editform">
		  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC" align="center"> 
              <td colspan="4"><b><font color="#000066">更换店面</font></b></td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="17%" align="right"><font color="#FF0033">*</font>客户所属分公司</td>
              <td width="33%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td align="right"><font color="#FF0033">*</font>咨询店面</td>
              <td> 
                <input type="hidden" name="oldzxdm"  value="<%=zxdm%>" >
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td align="right"><font color="#FF0033">*</font>更换店面原因</td>
              <td colspan="3"> 
                <textarea name="ghdmyy" rows="3" cols="71"></textarea>
              </td>
            </tr>
            <input type="hidden" name="wherekhbh"  value="<%=wherekhbh%>" >
            <tr align="center"> 
              <td colspan="4" height="2"> 
                <input type="button"  value="更换店面（设计师不变）" onClick="f_do(editform)">
                <input type="button"  value="更换店面（设计师置空）" onClick="f_do1(editform)">
              </td>
            </tr>
          </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (FormName.zxdm.value==FormName.oldzxdm.value)
	{
		alert("错误！请选择不同的[咨询店面]！");
		FormName.zxdm.focus();
		return false;
	}
	...
	if ('<%=zxzt%>'=='设计师提交飞单' && FormName.zxdm.value=='<%=zxdm%>')
	{
		alert("该店已签单失败，请更换店面！");
		FormName.zxdm.focus();
		return false;
	...
	FormName.action="SaveGhDmCrm_zxkhxx.jsp";
	FormName.submit();
	return true;
}
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveGhDmCrm_zxkhxxNoSjs.jsp";
	FormName.submit();
	return true;
}
//-->
