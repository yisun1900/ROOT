...
<form method="post" action="SavePlGhDm.jsp" name="editform">
		  
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2" align="center" height="41"><b><font color="#000066">批量更换店面（设计师不变）</font></b></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
...
%> 
    ...
    <tr bgcolor="#FFFFCC"> 
      ...
      <td width="68%" height="45"> 
        <textarea name="ghdmyy" rows="6" cols="45"></textarea>
      </td>
    </tr>
    <tr> 
