...
<form method="post" action="SavePlGhDmNoSjs.jsp" name="editform">
		  
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2" align="center" height="41"><b><font color="#000066">批量更换店面（设计师为空）</font></b></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      <td width="34%" align="right" height="52">客户所属分公司</td>
...
%> 
    ...
    <tr bgcolor="#FFFFCC"> 
      <td width="34%" align="right" height="45"><font color="#FF0033">*</font>咨询店面</td>
...
%> 
    ...
    <tr bgcolor="#FFFFCC"> 
      <td width="34%" align="right" height="45"><font color="#FF0033">*</font>更换店面原因</td>
      <td width="66%" height="45"> 
