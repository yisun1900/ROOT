...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxGhList.jsp","","","GhDmCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"批量更换（设计师不变）","批量更换（设计师置空）"};//按钮的显示名称
	String[] buttonLink={"PlGhDm.jsp","PlGhDmNoSjs.jsp"};//按钮单击调用的网页，可以增加参数
