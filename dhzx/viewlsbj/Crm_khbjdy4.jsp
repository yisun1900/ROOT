		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td width="52%" align="left" ><%=gycl%></td>
			  </tr>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <tr><td width="948">1、所有物业押金及各种形式的管理款项敬请您承担，我方承担因施工违反物业规定而扣出的部分费用。</td>
  </tr>
   <tr><td>2、施工中如有漏报项目或增加项目，则按实际施工项目结算工程款。</td><tr>
   <tr><td>3、乳胶漆每户除白色外可另选两色（浅色），另外每增加一色按150元/色收费，深色按450元/色收费。</td><tr>
    <tr>
      <td>4、水电路改造费用在中期时按实际发生工程量结算。电路施工：明走管26元/米；原墙线管抽线20元/米（长度计量若走线不足0.5米忽略不计，大于0.5米按一米计算；新安装暗盒7元/个，更改暗盒4元/个）水电施工；PPR管走65元/米、暗走管80元/米。（祥见合同附件）</td>
    <tr>
	<tr>
      <td>5、本报价不含税金。（税金按工程总价的百分之七收取）开机打发票，不再收取费用。</td>
    <tr>
  </table>
  </td>
  </tr>
