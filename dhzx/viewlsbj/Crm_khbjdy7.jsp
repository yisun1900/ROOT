...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
 ...
 <tr bgcolor="#FFFFFF"> 
 <td colspan="8" align="center" style='FONT-SIZE: 20px' > &nbsp;<B>工程（预）结算表</B></td>
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td width="10%" align="center"><%=cf.formatDouble(sl)%></td>
				
				<td width="3%" align="center"> <%=zcf%>&nbsp;</td>
				...
				<td width="29%" align="left" ><%=gycl%></td>
			  </tr>
...
*/
  ...
  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
    ...
    <tr bgcolor="#CCCCCC"> 
		    ...
		    <td><div align="center">数量(平米)</div></td>
  ...
  <%  
	...
	String sfkdz=null;
	double zdzk=0;
	ls_sql="SELECT dj,sl,sfxmbm,sfxmmc,DECODE(sflx,'1','工程直接费百分比','2','固定金额(可改)','3','税金（折后按基数计算）','8','税金（折后按折扣计算）','4','固定金额(不可改)','5','管理费','6','公司购主材百分比','7','自购主材百分比','9','按百分比收设计费') sflx,sfbfb,sfje,bz,DECODE(sfbxx,'1','必选','2','非必选') sfbxx,DECODE(sfjrqye,'1','记入','2','不记入') sfjrqye,DECODE(jrsjbz,'1','记入','2','不记入') jrsjbz,DECODE(jrglfbz,'1','记入','2','不记入') jrglfbz,zqsfje,dxzkl,DECODE(sfkdz,'N','不可打折','Y','可打折') sfkdz,zdzk";
	ls_sql+=" FROM bj_sfxmmx  ";
