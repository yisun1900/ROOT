...
//	ls_sql+=" and (crm_zxkhxx.bjdysq='0' OR crm_zxkhxx.bjdysq='1' OR crm_zxkhxx.bjdysq is null)";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxDybjSqList.jsp","","DySq.jsp","");
...
//设置主键
	...
	pageObj.setViewStr("授权");

//设置按钮参数
	String[] buttonName={"批量授权授权"};//按钮的显示名称
	String[] buttonLink={"PlDySq.jsp"};//按钮单击调用的网页，可以增加参数
