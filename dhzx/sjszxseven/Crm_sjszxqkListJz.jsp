...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sjs,DECODE(sfzdzbj,'N','未做','Y','已做'),dzbjze,bjjbmc,DECODE(crm_zxkhxx.ysshbz,'N','未申请','B','申请审核','C','受理申请','Y','审核通过','M','审核未通过'),crm_zxkhxx.ysshsj,crm_zxkhxx.ysshr,crm_zxkhxx.ysshyj,lrsj,dwmc,ysy,crm_zxkhxx.hfrq,crm_zxkhxx.khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_sjszxqkListJz.jsp","","","EditSjsZxCrm_zxkhxxJz.jsp");
