...
%> 
	...
	if (bjjb!=null && !bjjb.equals(""))
	{
		...
		cf.selectItem(out,"select bjjbbm,bjjbmc from bdm_bjjbbm where lx='1' and  bjjbbm in(select sq_sjsbjjb.bjjbbm from sq_sjsbjjb,sq_yhxx where sq_sjsbjjb.ygbh=sq_yhxx.ygbh and sq_yhxx.yhdlm='"+yhdlm+"') order by bjjbbm","");
	}
%> 
                </select>              </td>
...
%></td>
            ...
            <tr> 
              <td colspan="4" align="center" >
                    ...
                    <input type="hidden" name="sfxjz"  value="<%=sfxjz%>" >
                  ...
                  <input type="button"  value="选报价项目" onClick="f_xzxm(editform)" name="lr" disabled>
                  <input type="button"  value="调项目顺序" onClick="f_fjxmpx(editform)" name="fjxmpx" disabled>
...
function f_ewlr(FormName)//参数FormName:Form的名称
{
	...
	if ("<%=jzbz%>"=="1")
	{
		FormName.action="/dzbjseven/zxbjmx/InsertBj_sfxmmx.jsp?dqbm=<%=dqbm%>";
	}
	else{
		FormName.action="/dzbjseven/zxbjmx/InsertBj_sfxmmx.jsp?dqbm=<%=dqbm%>";
	}
...
function f_ewck(FormName)//参数FormName:Form的名称
{
	...
	if ("<%=jzbz%>"=="1")
	{
		FormName.action="/dzbjseven/zxbjmx/Bj_sfxmmxList.jsp";
	}
	else{
		FormName.action="/dzbjseven/zxbjmx/Bj_sfxmmxList.jsp";
	}
