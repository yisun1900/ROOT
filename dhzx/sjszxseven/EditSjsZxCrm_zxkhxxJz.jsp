...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <input name="button3" type="button" onClick="window.open('/dhzx/tqwh/xgcxhd/EditCrm_zxkhxx.jsp?khbh=<%=khbh%>')"  value="调整活动"></td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
            ...
            <tr> 
              <td colspan="4" > 
                <div align="center"> 
                    ...
                    <input type="button"  value="精装主材" onClick="f_jzzc(editform)" name="jzzc" >
                        <input type="button"  value="精装工程" onClick="f_jzgc(editform)" name="jzgc" >
