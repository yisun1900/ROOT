...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,DECODE(qsjhtbz,'N','未签','Y','签合同'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_zxkhxx.khjl,crm_zxkhxx.ywy,dwmc,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,lrsj";
    ...
    ls_sql+=" and (crm_zxkhxx.qsjhtbz='N' OR crm_zxkhxx.qsjhtbz is null)";
	ls_sql+=" and (crm_zxkhxx.qtchtbz='N' or crm_zxkhxx.qtchtbz is null)";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxCxList.jsp","","","EditCrm_zxkhxx.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数

//设置主键
	String[] keyName={"khbh"};
	pageObj.setKey(keyName);
	pageObj.setEditStr("合同");
