...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,DECODE(qsjhtbz,'N','未签','Y','签合同'),crm_zxkhxx.qsjhtsj,crm_zxkhxx.hth,crm_zxkhxx.sjhtje,crm_sjhtxx.pms,crm_sjhtxx.dj,crm_sjhtxx.lrr,crm_sjhtxx.lrsj,b.dwmc lrbm,crm_sjhtxx.bz,khjl,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,a.dwmc zxdm";
