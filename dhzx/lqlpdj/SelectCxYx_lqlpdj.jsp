...
<body bgcolor="#FFFFFF">
<form method="post" action="Yx_lqlpdjCxList.jsp" name="selectform">
  <div align="center">领取礼品--查询</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="radio" name="yx_lqlpdj_shth" value="1">
        领取 
        <input type="radio" name="yx_lqlpdj_shth" value="2">
        退回 </td>
