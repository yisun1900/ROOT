...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	yx_lqlpdj_lrbm=request.getParameter("yx_lqlpdj_lrbm");
	if (yx_lqlpdj_lrbm!=null)
	{
		yx_lqlpdj_lrbm=cf.GB2Uni(yx_lqlpdj_lrbm);
		if (!(yx_lqlpdj_lrbm.equals("")))	wheresql+=" and  (yx_lqlpdj.lrbm='"+yx_lqlpdj_lrbm+"')";
	}
	...
	ls_sql="SELECT crm_zxkhxx.khxm,crm_zxkhxx.fwdz,yx_lqlpdj.lpmc,yx_lqlpdj.lpsl,yx_lqlpdj.lqsj,crm_zxkhxx.sjs,b.dwmc zxdm, DECODE(yx_lqlpdj.shth,'1','领取','2','退回'),yx_lqlpdj.lrr,yx_lqlpdj.lrsj,a.dwmc lrbm,yx_lqlpdj.bz,yx_lqlpdj.khbh";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Yx_lqlpdjList.jsp","SelectYx_lqlpdj.jsp","","EditYx_lqlpdj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Yx_lqlpdjList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from yx_lqlpdj where "+chooseitem;
