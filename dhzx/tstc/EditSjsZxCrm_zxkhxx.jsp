            ...
            <tr> 
              <td colspan="4" > 
                <div align="center"> 
                    ...
                    <input type="button"  value="促销项目" onClick="f_lrfj(editform)" >
                    <input type="button"  value="优惠礼包" onClick="f_xgfj(editform)">
                    <input type="button" onClick="f_xzxm(editform)"  value="套餐外主材增项">
                    <input type="button" onClick="f_fjxmpx(editform)"  value="套餐外工程增项" >
                    <input name="button5" type="button" onClick="f_fjxmpx(editform)"  value="主材清单" >
                    <p>
                      <input name="button" type="button" onClick="f_ewlr(editform)"  value="选其它收费">
                      <input name="button" type="button" onClick="f_ewck(editform)"  value="修改其它收费">
