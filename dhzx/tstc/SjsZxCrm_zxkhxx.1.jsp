...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td colspan="3" bgcolor="#CCCCFF"><%=cxhdbm%></td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="32%"> 
                <select name="bjjb" style="FONT-SIZE:12PX;WIDTH:120PX">
                  <%
	if (sfzdzbj.equals("Y") && bjjb!=null && !bjjb.equals(""))
	{
...
%></td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right"><font color="#CC0000">*</font>咨询情况</td>
              <td colspan="3"> 
...
function f_fjxmpx(FormName)//参数FormName:Form的名称
{
	...
	if ("<%=jzbz%>"=="1")
	{
		winOpen("/dzbj/zxbjmx/TzFjXhBjxmList.jsp?khbh=<%=khbh%>",900,600,'YES',"NO");
	}
	else{
		winOpen("/dzbj/zxbjmx/TzFjXhBjxmList.jsp?khbh=<%=khbh%>",900,600,'YES',"NO");
	}
...
function f_xmdj(FormName)//参数FormName:Form的名称
{
	...
	if ("<%=jzbz%>"=="1")
	{
		winOpen("/dzbj/zxbjmx/TzDjBjxmList.jsp?khbh=<%=khbh%>",900,600,'YES',"NO");
	}
	else{
		winOpen("/dzbj/zxbjmx/TzDjBjxmList.jsp?khbh=<%=khbh%>",900,600,'YES',"NO");
	}
...
function f_dxzk(FormName)//参数FormName:Form的名称
{
	...
	window.open("/dzbj/zxbjmx/Bj_sfxmmxZklList.jsp?khbh=<%=khbh%>");
}
...
function f_zjsl(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/dzbj/zxbjmx/zjtccl.jsp";
	FormName.submit();
	return true;
}
...
function f_zj(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/dzbj/zxbjmx/BjDyList.jsp?dqbm=<%=dqbm%>";
