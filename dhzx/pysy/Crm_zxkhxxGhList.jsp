...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.ysy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),crm_zxkhxx.fwdz,a.dwmc zxdm,sjs,khjl,ywy,fwlxmc,lrsj,b.dwmc as ssfgs";
    ...
    ls_sql+=" and crm_zxkhxx.ysy is not null ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxGhList.jsp","","","PdCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"删除预算员"};//按钮的显示名称
	String[] buttonLink={"Crm_zxkhxxGhList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_zxkhxx set ysy=null where zxzt in('1','2','5') and "+chooseitem;
