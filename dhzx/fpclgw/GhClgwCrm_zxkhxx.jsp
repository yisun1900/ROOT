...
try {
	...
	ls_sql="select clgw,sjsbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') zxzt,zxdjbm,sjs,khxm,xb,fwdz,lxfs,fwlxbm,hxbm,fwmj,fgyqbm,zxysbm,zxdm,sbyybm,sfxhf,hfrq,hdbz,khlxbm,bz,cqbm,cgdz,hdr ";
...
<form method="post" action="SaveGhClgwCrm_zxkhxx.jsp" name="editform">
		  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC" align="center"> 
              <td colspan="4"><b><font color="#000066">更换材料顾问</font></b></td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td> 
                <input type="hidden" name="oldclgw"  value="<%=clgw%>" >
                <select name="clgw" style="FONT-SIZE:12PX;WIDTH:152PX"  >
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select sq_yhxx.yhmc,sq_yhxx.yhmc||'（'||sq_yhxx.dh||'）' from sq_yhxx,sq_sqbm where sq_yhxx.ygbh=sq_sqbm.ygbh and sq_sqbm.dwbh='"+zxdm+"' and sq_yhxx.zwbm='08' and sq_yhxx.sfzszg in('Y','N') order by yhmc",clgw);
%> 
                </select>              </td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
