...
try {
	...
	//取客户信息
	String getbjjb="";
	ls_sql="select bjjb,ssfgs,zxdm,zxzt,sjs,sbyybm,sfxhf,hfrq,lfbz,lfsj,ctbz,ctsj,khfwjlh,dmjdjlh,sjsjdjlh,sfzdzbj";
	...
	ps.setString(38,ysy);
	ps.setString(39,zcsfss);
	ps.setString(40,sfyckh);
	...
	{
		ls_sql="update crm_zxkhxx set";
		ls_sql+=" sczbjsj=TRUNC(SYSDATE),bjbbh=? ";
		ls_sql+=" where khbh='"+khbh+"'";
		ps= conn.prepareStatement(ls_sql);
