	...
	if (lx.equals("1"))//1：非套餐；2：套餐
	{
		%>
		  <tr  align="center">
			<td height="46">
			  <p>
			    <input type="button" <%=mark%> onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=khbh%>')"  value="打印工程报价"   />
			  </p>
		    <p>
			    <input type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxDyLsBjList.jsp?khbh=<%=khbh%>')"  value="打印临时报价"   />
			  </p>
		    <p>
		      <input type="button" onClick="window.open('/dzbjone/zxbjmx/ViewBj.jsp?khbh=<%=khbh%>','','toolbar=no,menubar=no,scrollbars=yes,resizable=yes')"  value="预览工程报价"   />			    
            </p></td>
		  </tr>
		<%
	}
		...
		%>
		  <tr align="center" >
			<td height="46"><input name="button3" type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxTcDyKhList.jsp?khbh=<%=khbh%>')"  value="套餐－打印工程报价（客户）"   /></td>
		  </tr>
		  <tr align="center" >
			<td height="46"><input name="button32" type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxTcDySgdList.jsp?khbh=<%=khbh%>')"  value="套餐－打印工程报价（工长）"   /></td>
		  </tr>
		  <tr align="center" >
			<td  height="46">
