...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">飞单登记－撤销(不需审核)</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_qysbdjList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
                <div align="right">失败登记时间 从</div>
              </td>
              <td width="32%"> 
                <input type="text" name="sbsj" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
              <td width="16%"> 
                <div align="right">到</div>
              </td>
              <td width="34%"> 
                <input type="text" name="sbsj2" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">失败登记人</td>
              <td width="32%"> 
                <input type="text" name="djr" size="20" maxlength="20" value="" >
              </td>
              <td width="16%" align="right">失败原因</td>
              <td width="34%"> 
...
{
	if(!(isDatetime(FormName.sbsj, "登记时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.sbsj2, "登记时间"))) {
		return false;
	}
	FormName.submit();
	return true;
