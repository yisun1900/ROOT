...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_fdkhhf.hfjlh, DECODE(crm_fdkhhf.lx,'1','飞单回访','2','随机回访','3','信息人回访'),crm_fdkhhf.khbh,a.dwmc,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_fdkhhf.hfr,crm_fdkhhf.hfsj,sbyymc,crm_fdkhhf.hfsbkhlx,crm_fdkhhf.hfsbyyxs,crm_fdkhhf.lrr,crm_fdkhhf.lrsj,b.dwmc lrbm  ";
