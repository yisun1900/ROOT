...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','提交飞单','2','飞单审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sbyymc,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,b.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_qysbdj.clzt='1'";//1：提交飞单、2：飞单审核、5：回访
