...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','提交飞单','2','飞单审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_qysbdj.sjbshjl,'Y','通过','N','未通过'),b.sbyymc,sjbsbkhlx,crm_qysbdj.sjbshr,crm_qysbdj.sjbshsj,crm_qysbdj.sjbshyj,a.sbyymc sjsyy,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,c.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_qysbdj.clzt='2'";//1：提交飞单、2：飞单审核、5：回访
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="10%">房屋地址</td>
	<td  width="3%">审核结论</td>
	<td  width="5%">审核失败原因</td>
	<td  width="5%">审核失败客户流向</td>
	<td  width="3%">审核人</td>
	<td  width="4%">审核时间</td>
	<td  width="13%">审核意见</td>
	<td  width="5%">失败原因</td>
