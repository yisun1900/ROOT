...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过','6','散客'),lrsj,crm_zxkhxx.khxm,DECODE(sfzdzbj,'N','未做','Y','已做') sfzdzbj,dzbjze,bjjbmc,crm_zxkhxx.fwdz as crm_zxkhxx_fwdz,sjs,ywy,a.dwmc zxdjbm,b.dwmc as zxdm,fwlxmc as crm_zxkhxx_fwlxbm,crm_zxkhxx.hfrq as crm_zxkhxx_hfrq";
	...
	ls_sql+=" and crm_zxkhxx.zxzt not in('3','4','6')";

    ls_sql+=" order by crm_zxkhxx.lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxCxList.jsp","","","qdsbdj.jsp");
...
<CENTER >
  <B><font size="3">飞单登记(不需审核)</font></B>
</CENTER>
<%
	pageObj.out=out;
