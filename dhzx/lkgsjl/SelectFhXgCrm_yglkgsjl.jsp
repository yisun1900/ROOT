...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_yglkgsjlFhXgList.jsp" name="selectform">
<div align="center">返回登记－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td bgcolor="#FFFFCC">
  <select name="crm_yglkgsjl_ygbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeBm(selectform)">
	  <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
  <select name="crm_yglkgsjl_yhmc" style="FONT-SIZE:12PX;WIDTH:152PX">
	<option value=""></option>
    </select>
  </td>
