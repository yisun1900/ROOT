...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yglkgsjlFhList.jsp","","","FhCrm_yglkgsjl.jsp");
...
//设置按钮参数
	String[] buttonName={"批量返回登记"};//按钮的显示名称
	String[] buttonLink={"SavePlFhCrm_yglkgsjl.jsp?"};//按钮单击调用的网页，可以增加参数
