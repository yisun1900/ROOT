...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (crm_yglkgsjl_yhmc!=null)
	{
		...
		if (!(crm_yglkgsjl_yhmc.equals("")))	wheresql+=" and  (crm_yglkgsjl.yhmc like '%"+crm_yglkgsjl_yhmc+"%')";
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yglkgsjlList.jsp","","","EditCrm_yglkgsjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_yglkgsjl.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">离开公司申请－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
