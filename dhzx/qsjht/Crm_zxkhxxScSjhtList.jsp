...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,DECODE(qsjhtbz,'N','未签','Y','签合同'),crm_zxkhxx.qsjhtsj,crm_zxkhxx.hth,crm_zxkhxx.sjhtje,crm_sjhtxx.pms,crm_sjhtxx.dj,crm_sjhtxx.lrr,crm_sjhtxx.lrsj,b.dwmc lrbm,crm_sjhtxx.bz,khjl,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','店面退回客户','3','已签约','4','公司签单失败','5','重新分配店面') as crm_zxkhxx_zxzt,a.dwmc zxdm";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxXgSjhtList.jsp","","","XgEditCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"删除设计合同"};//按钮的显示名称
	String[] buttonLink={"Crm_zxkhxxXgSjhtList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from crm_sjhtxx where "+chooseitem;
		sql[1]="update crm_zxkhxx set qsjhtbz='N',qsjhtsj=null,sjhtje=null,hth=null,hyh=null where "+chooseitem;
