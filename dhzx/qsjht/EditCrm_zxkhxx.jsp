...
%></td>
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font><font color="#0000CC">合同号</font></td>
              <td bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              <td width="18%" align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font><font color="#0000CC">折前设计合同金额</font></td>
              <td width="32%" bgcolor="#FFFFFF"><input type="text" name="zqsjhtje" value="" size="20" maxlength="16" readonly></td>
              <td width="18%" align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>折后设计合同金额</td>
