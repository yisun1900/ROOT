...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">查询实收设计费</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Crm_zxkhxxCxSjfList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">交款标志</td>
              <td><input type="radio" name="jkbz" value="1">
未交款
  <input type="radio" name="jkbz" value="2">
交款
  <input type="radio" name="jkbz" value="3">
退款</td>
              <td align="right">收款审核标志</td>
              <td><input type="radio" name="shbz" value="N">
未审核
...
审核</td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"> 退款时间 从 </td>
              <td><input name="tksj" type="text"  onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
              <td align="right"> 到 </td>
              <td><input type="text" name="tksj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"> 退款审核时间 从 </td>
              <td><input type="text" name="tkshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right"> 到 </td>
              <td><input type="text" name="tkshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
                  <option value="crm_zxkhxx.qsjhtsj ">签设计合同时间</option>
                  <option value="cw_khfkjl.sjsj ">审核时间</option>
                  <option value="crm_zxkhxx.khbh ">客户编号</option>
