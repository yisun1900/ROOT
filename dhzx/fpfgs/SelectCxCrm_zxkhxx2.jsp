...
<form method="post" action="Crm_zxkhxxCxList2.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right"> 
                是否分配分公司              </td>
              <td width="32%">
				<INPUT type="radio" name="sffp" value="Y" CHECKED>已分配</td>
              <td width="17%" align="right">设计师</td>
              <td width="33%"><input type="text" name="sjs" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right"> 客户所属分公司 </td>
              <td bgcolor="#FFFFCC"><select name="ssfgs" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeFgs(selectform)">
                  <%
