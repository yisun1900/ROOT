...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and  (crm_zxkhxx.ssfgs is null)";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_zxkhxx.khxm";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxCxList1.jsp","","","FpDmCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"批量分配"};//按钮的显示名称
	String[] buttonLink={"plfgs.jsp"};//按钮单击调用的网页，可以增加参数
