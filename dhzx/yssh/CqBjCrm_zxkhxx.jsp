...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
    <div align="center"><strong>重取报价项目单价</strong></div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">

<form method="post" action="SaveCqBj.jsp" name="editform" target="_blank">
...
%>              </td>
            ...
            <tr>
              <td bgcolor="#FFFFFF" align="right">报价版本号</td>
            ...
            <tr> 
              ...
              <input type="button"  value="重取报价" onClick="f_do(editform)">
