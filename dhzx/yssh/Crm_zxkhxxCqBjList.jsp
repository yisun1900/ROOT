...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.bjbbh,crm_zxkhxx.dzbjze,crm_zxkhxx.zjzbjsj,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,lrsj,dwmc as zxdm";
...
//	ls_sql+=" and crm_zxkhxx.ysshbz!='Y'";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxCqBjList.jsp","","","CqBjCrm_zxkhxx.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数

//设置主键
	String[] keyName={"khbh"};
	pageObj.setKey(keyName);
	pageObj.setEditStr("单价");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="8%">电子报价总额</td>
	<td  width="8%">最近做电子报价时间</td>
	<td  width="8%">姓名</td>
	<td  width="20%">房屋地址</td>
	<td  width="6%">设计师</td>
	<td  width="9%">咨询状态</td>
