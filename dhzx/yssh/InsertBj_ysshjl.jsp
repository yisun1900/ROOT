...
try {
	...
	if (!ysshbz.equals("N") && !ysshbz.equals("M") && !ysshbz.equals("S"))////N：未申请；B：申请审核；C：受理申请；Y：审核通过；M：审核未通过;S：修改方案授权
	{
		out.println("错误！已申请了预算审核申请");
		return;
	}
	...
	int count=0;
	ls_sql="select NVL(max(substr(ysshjl,8,3)),0)";
	...
	ysshjl=khbh+cf.addZero(count+1,3);
}
catch (Exception e) {
...
<%
	...
	ls_sql="SELECT bj_ysshjl.ysshjl, DECODE(bj_ysshjl.ysshbz,'B','申请审核','C','受理申请','Y','审核通过','M','审核未通过') ysshbz,bj_ysshjl.lrr,bj_ysshjl.lrsj,bj_ysshjl.slr,bj_ysshjl.slsj,bj_ysshjl.ysshr,bj_ysshjl.ysshsj,bj_ysshjl.ysshyj,bj_ysshjl.shdf";
	ls_sql+=" FROM bj_ysshjl,crm_zxkhxx  ";
    ls_sql+=" where bj_ysshjl.khbh=crm_zxkhxx.khbh";
    ls_sql+=" and bj_ysshjl.khbh='"+khbh+"'";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
...
//设置列超级连接
	...
	String[] coluKey1={"ysshjl"};//设置列参数：coluParm.key的主键
	coluParm.key=coluKey1;//设置列参数：coluParm.key的主键
	coluParm.link="/dhzx/yssh/ViewBj_ysshmx.jsp?khbh="+khbh;//为列参数：coluParm.link设置超级链接
...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
    <div align="center"><strong>申请预算审核（预算审核记录：<%=ysshjl%>）</strong></div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">

<form method="post" action="SaveInsertBj_ysshjl.jsp" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
...
%>              </td>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF"><textarea name="sqsm" cols="71" rows="3"></textarea></td>
            </tr>
            <tr>
