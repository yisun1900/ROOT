...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">查询－预算审核</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Crm_zxkhxxCxYsShList.jsp" name="selectform">
...
签合同</td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="ysshr" size="20" maxlength="20" >
              </td>
              <td align="right">预算审核标志</td>
              <td><input type="radio" name="ysshbz" value="Y">
                审核通过
                  <input type="radio" name="ysshbz" value="M">
              审核未通过 </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"> 预算审核时间 从 </td>
              <td><input type="text" name="ysshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right"> 到 </td>
              <td><input type="text" name="ysshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
                  <option value="crm_zxkhxx.ysshsj desc">预算审核时间</option>
                  ...
                  <option value="crm_zxkhxx.qsjhtsj desc">签设计合同时间</option>
                </select>
                第二列 
