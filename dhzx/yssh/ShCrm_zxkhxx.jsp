...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
    <div align="center"><strong>预算审核</strong></div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>              </td>
            ...
            <tr>
              <td bgcolor="#FFFFFF" align="right"><font color="#CC0000">*</font>预算审核结论</td>
              <td bgcolor="#FFFFFF">
<%
	cf.radioToken(out, "ysshbz","Y+审核通过&M+审核未通过",ysshbz);
%>			  </td>
              <td align="right" bgcolor="#FFFFFF">报价版本号</td>
              <td bgcolor="#FFFFFF">
			  <%=bjbbh%></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFFF" align="right">预算审核意见</td>
              <td colspan="3" bgcolor="#FFFFFF"><textarea name="ysshyj" cols="71" rows="3"><%=ysshyj%></textarea></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFFF" align="right"><font color="#CC0000">*</font><font color="#0000CC">预算审核人</font></td>
              <td bgcolor="#FFFFFF"><input type="text" name="ysshr" value="<%=yhmc%>" size="20" maxlength="10" readonly></td>
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font><font color="#0000CC">预算审核时间</font></td>
              <td bgcolor="#FFFFFF"><input type="text" name="ysshsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
            </tr>
            <tr> 
              <td height="2" colspan="4" align="center"> 
				<input type="hidden" name="wherekhbh"  value="<%=wherekhbh%>" >
              <input type="button"  value="完成审核" onClick="f_do(editform)">
              <input type="button" onClick="window.open('/dzbj/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=wherekhbh%>','','toolbar=no,menubar=no,scrollbars=yes,resizable=yes')" value="查看电子报价"></td>
            </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.ysshsj, "预算审核时间"))) {
		return false;
	}
	FormName.submit();
	return true;
