...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_bjbbsqjl.bjbbh,crm_bjbbsqjl.sqr,crm_bjbbsqjl.sqsj,crm_bjbbsqjl.sqbz,crm_zxkhxx.dzbjze,crm_zxkhxx.zjzbjsj,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,lrsj,dwmc as zxdm";
	ls_sql+=" FROM crm_zxkhxx,dm_fwlxbm,sq_dwxx,crm_bjbbsqjl";
    ls_sql+=" where crm_zxkhxx.fwlxbm=dm_fwlxbm.fwlxbm(+) ";
    ls_sql+=" and crm_zxkhxx.zxdm=sq_dwxx.dwbh(+)";
    ls_sql+=" and crm_zxkhxx.khbh=crm_bjbbsqjl.khbh";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by crm_bjbbsqjl.sqsj desc";

    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_bjbbsqjlList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteBjsq.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="15%">房屋地址</td>
	<td  width="4%">设计师</td>
	<td  width="10%">授权报价版本号</td>
	<td  width="4%">授权人</td>
	<td  width="5%">授权时间</td>
	<td  width="20%">授权备注</td>
	<td  width="6%">电子报价总额</td>
	<td  width="5%">最近做电子报价时间</td>
	<td  width="6%">咨询状态</td>
	<td  width="5%">录入时间</td>
	<td  width="8%">咨询店面</td>
</tr>
