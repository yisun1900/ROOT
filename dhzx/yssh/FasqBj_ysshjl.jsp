...
try {
	...
	ls_sql="select khbh,sqsm,lrr,lrsj,ysshbz,slr,slsj,slsm,ysshr,ysshsj,ysshyj,jygq,jykgsj,jyjgsj,shdf,zlksfwz,zcxqsflr,jsy,xgfasqsm ";
	...
	if (rs.next())
	{
		...
		zlksfwz=cf.fillNull(rs.getString("zlksfwz"));
		zcxqsflr=cf.fillNull(rs.getString("zcxqsflr"));
		jsy=cf.fillNull(rs.getString("jsy"));
		xgfasqsm=cf.fillNull(rs.getString("xgfasqsm"));
	}
	rs.close();
	ps.close();
...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
    <div align="center"><strong>修改方案授权（预算审核记录：<%=ysshjl%>）</strong></div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>              </td>
            ...
            <tr align="center" bgcolor="#CCCCFF">
              <td height="17" colspan="4" bgcolor="#CCCCFF">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">审核结论</font></td>
              <td><%
	cf.radioToken(out,"Y+审核通过&M+审核未通过",ysshbz,true);
%>              </td>
              <td align="right"><font color="#0000CC">价审员</font></td>
              <td><%=jsy%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">审核意见</font></td>
              <td colspan="3"><%=ysshyj%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">建议开工时间</font></td>
              <td><%=jykgsj%></td>
              <td align="right"><font color="#0000CC">建议竣工时间</font></td>
              <td><%=jyjgsj%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">建议工期</font></td>
              <td><%=jygq%></td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">设计资料库是否完整</font></td>
              <td><%
	cf.radioToken(out,"Y+是&N+否",zlksfwz,true);
%></td>
              <td align="right"><font color="#0000CC">是否录入客户主材需求</font></td>
              <td><%
	cf.radioToken(out,"Y+是&N+否",zcxqsflr,true);
%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">审核人</font></td>
              <td><%=ysshr%></td>
              <td align="right"><font color="#0000CC">审核时间</font></td>
              <td><%=ysshsj%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#CC0000">*</font><font color="#0000CC">修改方案授权人</font></td>
              <td><input type="text" name="xgfasqr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>              </td>
              <td align="right"><font color="#CC0000">*</font><font color="#0000CC">修改方案授权时间</font></td>
              <td><input type="text" name="xgfasqsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">修改方案授权说明</td>
              <td colspan="3"><textarea name="xgfasqsm" cols="71" rows="3"><%=xgfasqsm%></textarea>              </td>
            </tr>
            <tr> 
              <td height="2" colspan="4" align="center"> 
				<input type="hidden" name="ysshjl"  value="<%=ysshjl%>" >
				<input type="hidden" name="khbh"  value="<%=khbh%>" >
              <input type="button"  value="授权" onClick="f_do(editform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.xgfasqr)=="") {
		alert("请输入[修改方案授权人]！");
		FormName.xgfasqr.focus();
		return false;
	}
	if(	javaTrim(FormName.xgfasqsj)=="") {
		alert("请输入[修改方案授权时间]！");
		FormName.xgfasqsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.xgfasqsj, "修改方案授权时间"))) {
		return false;
	}

	FormName.target="";
	FormName.action="SaveFasqBj_ysshjl.jsp";
	FormName.submit();
	return true;
}
