...
try {
	...
	ls_sql="select sqhxbm,zxzt,bjbbh,khjl,ysshbz,ysshyj,ssfgs,louhao,ysrbm,rddqbm,hxwzbm,sjsbh,jzbz,jhjfsj,hdr,ywy,sjs,khxm,xb,fwdz,lxfs,fwlxbm,hxbm,fwmj,fgyqbm,zxysbm,zxdm,sfxhf,hfrq,hdbz,khlxbm,bz,cqbm,cgdz,yzxxbz,nlqjbm,zybm,fj,yjzxsj,xqbm ";
...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
    <div align="center"><strong>套餐户型授权 </strong></div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">

<form method="post" action="SaveHxsq.jsp" name="editform">
...
%>              </td>
            ...
            <tr>
              <td bgcolor="#FFFFFF" align="right"><font color="#CC0000">*</font>户型</td>
              <td colspan="3" bgcolor="#FFFFFF">
				<select name="sqhxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select hxbm,hxmc from dm_hxbm order by hxbm",sqhxbm);
%>
                </select></td>
            </tr>
            <tr> 
              ...
              <input type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=khbh%>','','toolbar=no,menubar=no,scrollbars=yes,resizable=yes')" value="查看电子报价"></td>
            </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.sqhxbm)=="") {
		alert("请输入[户型]！");
		FormName.sqhxbm.focus();
		return false;
	}
