...
try {
	...
	ls_sql="select zxzt,bjbbh,khjl,ysshbz,ysshyj,ssfgs,louhao,ysrbm,rddqbm,hxwzbm,sjsbh,jzbz,jhjfsj,hdr,ywy,sjs,khxm,xb,fwdz,lxfs,fwlxbm,hxbm,fwmj,fgyqbm,zxysbm,zxdm,sfxhf,hfrq,hdbz,khlxbm,bz,cqbm,cgdz,yzxxbz,nlqjbm,zybm,fj,yjzxsj,xqbm ";
...
<form method="post" action="SaveBjsq.jsp" name="editform">
...
%>              </td>
            ...
            <tr>
              <td bgcolor="#FFFFFF" align="right"><font color="#CC0000">*</font>报价版本号</td>
              <td colspan="3" bgcolor="#FFFFFF">
				<input type="hidden" name="ybjbbh"  value="<%=bjbbh%>" >
			  <select name="bjbbh" style="FONT-SIZE:12PX;WIDTH:522PX">
                <%
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select bjbbh c1,bjbbh||'（'||dqmc||'）（'||DECODE(bj_dzbjbb.sfzybb,'1','未启用','2','当前版','3','可用版','4','停用')||'）' c2 from bj_dzbjbb,dm_dqbm where bj_dzbjbb.dqbm=dm_dqbm.dqbm and bj_dzbjbb.dqbm='"+dqbm+"' order by bj_dzbjbb.dqbm,bjbbh",bjbbh);
%>
              </select></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><input type="text" name="sqr" value="<%=yhmc%>" size="20" maxlength="10" readonly></td>
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font><font color="#0000CC">授权时间</font></td>
              <td bgcolor="#FFFFFF"><input type="text" name="sqsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
            </tr>
            <tr> 
              <td height="2" colspan="4" align="center"> 
				<input type="hidden" name="wherekhbh"  value="<%=wherekhbh%>" >
              <input type="button"  value="存盘" onClick="f_do(editform)">
              <input type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=wherekhbh%>','','toolbar=no,menubar=no,scrollbars=yes,resizable=yes')" value="查看电子报价"></td>
            </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (FormName.bjbbh.value!=FormName.ybjbbh.value)
	{
		if ( !confirm("注意！！！！你改变了[报价版本]，是否继续？") )	
		{
			return false;
		}
	}
