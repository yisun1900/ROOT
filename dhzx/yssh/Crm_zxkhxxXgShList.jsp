...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT bj_ysshjl.ysshjl,DECODE(crm_zxkhxx.ysshbz,'N','未申请','B','申请审核','C','受理申请','Y','审核通过','M','未通过','S','修改方案授权','1','等待总监预算审核','2','总监预算审核未通过'),crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,bj_ysshjl.jsy,bj_ysshjl.ysshr,bj_ysshjl.ysshsj,bj_ysshjl.ysshyj,khjl,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,sq_dwxx.dwmc";
	...
	ls_sql+=" and (bj_ysshjl.ysshbz='M' OR bj_ysshjl.ysshbz='1' OR (bj_ysshjl.ysshbz='Y' and bj_ysshjl.zjysshr is null))";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by bj_ysshjl.ysshsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxXgShList.jsp","","","XgShBj_ysshjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteShBj_ysshjl.jsp"};//按钮单击调用的网页，可以增加参数
