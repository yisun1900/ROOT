...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,DECODE(crm_zxkhxx.ysshbz,'N','未申请','B','申请审核','C','受理申请','Y','审核通过','M','未通过','S','修改方案授权','1','等待总监预算审核','2','总监预算审核未通过'),crm_zxkhxx.ysshr,crm_zxkhxx.ysshsj,crm_zxkhxx.dzbjze,crm_zxkhxx.zjzbjsj,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_zxkhxx.khjl,crm_zxkhxx.ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,lrsj,dwmc as zxdm";
	...
	ls_sql+=" and crm_zxkhxx.dzbjze>0";
	ls_sql+=" and crm_zxkhxx.ysshbz in('N','M','S')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxSqList.jsp","","","InsertBj_ysshjl.jsp");
