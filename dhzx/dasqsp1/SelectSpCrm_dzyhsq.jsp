...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">申请时间 从</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><b><font color="#0000CC">申请折扣率 从</font></b></td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        ...
        否 </td>
      <td align="right" width="17%">审批标志</td>
      <td width="33%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.sqzkl2, "折扣率"))) {
		return false;
	}
