...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxXgList.jsp","","","InsertCrm_tzzkjl.jsp");
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_zxkhxx set rfsgcb=0,rfjz=0,rfmll=0,zcxse=0,zccb=0,zcmll=0,khmll=0,mlspbz='M',mlspr=null,mlspsj=null,mlspyj=null where "+chooseitem;
...
<CENTER >
  <B><font size="3">审批客户毛利－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
