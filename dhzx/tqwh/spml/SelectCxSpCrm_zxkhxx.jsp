...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审批客户毛利－查询</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_zxkhxxCxSpList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">客户所属分公司</td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right">客户资料录入时间 从</div>              </td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td><input type="radio" name="mlspbz" value="Y">
                同意
                <input type="radio" name="mlspbz" value="N">
                不同意</td>
              <td align="right">审批人</td>
              <td><input type="text" name="mlspr" value="" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">审批时间 从</td>
              <td><input type="text" name="mlspsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="mlspsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.mlspsj2, "审批时间"))) {
		return false;
	}
	FormName.submit();
	return true;
