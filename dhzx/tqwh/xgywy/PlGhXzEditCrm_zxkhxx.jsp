...
<form method="post" action="SavePlGhXzEditCrm_zxkhxx.jsp" name="editform">
		  
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2" align="center" height="41"><b><font color="#000066">更换小组清空业务员</font></b></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
