...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),sjs,ywy,scbjl,b.dwmc as ywybm,c.dwmc as ywyssxz,a.dwmc as zxdm ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxXgYwyList.jsp","","","XgYwyEditCrm_zxkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"批量修改","删除业务员"};//按钮的显示名称
	String[] buttonLink={"PlGhYwyEditCrm_zxkhxx.jsp","DeleteYwy.jsp"};//按钮单击调用的网页，可以增加参数
