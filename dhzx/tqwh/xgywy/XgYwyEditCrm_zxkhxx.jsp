...
try {
	...
	ls_sql="select ssfgs,scbjl,ywy,ywyssxz,ywybm,sjsbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') zxzt,zxdjbm,sjs,khxm,xb,fwdz,lxfs,fwlxbm,hxbm,fwmj,fgyqbm,zxysbm,zxdm,sbyybm,sfxhf,hfrq,hdbz,khlxbm,bz,cqbm,cgdz,hdr ";
...
%> 
		...
		ldsql =" select *";
		ldsql+=" from (";
		ldsql+=" select distinct sq_dwxx.dwbh,sq_dwxx.dwmc from sq_dwxx,sq_sqbm,sq_yhxx where sq_dwxx.dwbh=sq_yhxx.dwbh and sq_sqbm.ygbh=sq_yhxx.ygbh and sq_sqbm.ssfgs='"+ssfgs+"' and sq_yhxx.zwbm='19' and sq_yhxx.sfzszg in('Y','N') and cxbz='N' ";
		ldsql+=" union all";
		ldsql+=" select distinct sq_dwxx.dwbh,sq_dwxx.dwmc from sq_dwxx,sq_sqfgs,sq_yhxx where sq_dwxx.dwbh=sq_yhxx.dwbh and sq_sqfgs.ygbh=sq_yhxx.ygbh and sq_sqfgs.ssfgs='"+ssfgs+"' and sq_yhxx.zwbm='19' and sq_yhxx.sfzszg in('Y','N') and cxbz='N' ";
		ldsql+=" )";
		ldsql+=" order by dwbh";
		cf.selectItem(out,ldsql,ywybm);
	%>
              </select></td>
