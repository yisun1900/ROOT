...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">咨询客户--修改业务员</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFCC">
			  <select name="ywybm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeScb(selectform)">
                  <%
		if (yhjs.equals("A0"))
		{
		    out.println("<option value=\"\"></option>");
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="text" name="sjs" value="" size="20" maxlength="100" >              </td>
              <td width="18%" align="right">&nbsp;</td>
              <td width="32%">&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%"> 
                <div align="right">店面分配时间 从</div>              </td>
              <td width="30%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%"> 
                <div align="right">设计师分配时间 从</div>              </td>
              <td width="30%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%"> 
                <div align="right">计划交房时间 从</div>              </td>
              <td width="30%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%"> 
                <div align="right">预计装修时间 从</div>              </td>
              <td width="30%"> 
...
function getScb(FormName) 
{
	...
	var sql;
	sql="select dwbh,dwmc from sq_dwxx where ssfgs='"+FormName.ssfgs.value+"' and dwflbm='07' and dwlx!='F4' and cxbz='N' order by dwbh";
...
function getYwy(FormName) 
{
	...
	sql =" select yhmc c1,yhmc c2";
	sql+=" from sq_yhxx ";
	sql+=" where dwbh='"+FormName.ywybm.value+"'";
	sql+=" and sq_yhxx.zwbm in('19','24','25','26') and sq_yhxx.sfzszg in('Y','N') ";
	sql+=" ORDER BY yhmc";
...
function getAjax(ajaxRetStr) 
{
	...
	{
		strToSelect(selectform.ywy,ajaxRetStr);
	}
}
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_zxkhxxGhYwyList.jsp";
	FormName.submit();
	return true;
}
