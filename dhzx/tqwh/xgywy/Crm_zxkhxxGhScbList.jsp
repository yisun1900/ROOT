...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxGhScbList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"PlGhScbEditCrm_zxkhxx.jsp","PlGhScbEditCrm_zxkhxx1.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">咨询客户--更换市场部</font></B>
</CENTER>
