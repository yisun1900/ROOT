...
//进行对象初始化
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxGhXzList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"PlGhXzEditCrm_zxkhxx.jsp","PlGhXzEditCrm_zxkhxx1.jsp"};//按钮单击调用的网页，可以增加参数
