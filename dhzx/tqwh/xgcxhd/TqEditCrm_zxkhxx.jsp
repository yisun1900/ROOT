...
<%
	...
	ls_sql="SELECT zsxm,jldw,cbdj,scdj,zsslsx,zsslxx,bz,zxzssl,zsjz ";
	...
	while (rs.next())
	{
		...
		zxzssl=cf.fillNull(rs.getString("zxzssl"));
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <select name="cxhdbm" style="FONT-SIZE:12PX;WIDTH:520PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select distinct jc_cxhd.cxhdmc c1,jc_cxhd.cxhdmc||'(订金：'||jc_cxhd.dj||'￥)' c2 from jc_cxhd,jc_cxhdsj where jc_cxhd.cxhdbm=jc_cxhdsj.cxhdbm  and jc_cxhd.fgsbh='"+ssfgs+"' and  jc_cxhd.hdlx in('1','2') order by jc_cxhd.cxhdmc",cxhdbm);
%> 
                </select>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <select name="cxhdbmxq" style="FONT-SIZE:12PX;WIDTH:520PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select distinct jc_cxhd.cxhdmc c1,jc_cxhd.cxhdmc||'(订金：'||jc_cxhd.dj||'￥)' c2 from jc_cxhd,jc_cxhdsj where jc_cxhd.cxhdbm=jc_cxhdsj.cxhdbm  and jc_cxhd.fgsbh='"+ssfgs+"' and  jc_cxhd.hdlx='3'  order by jc_cxhd.cxhdmc",cxhdbmxq);
%> 
                </select>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <select name="cxhdbmzh" style="FONT-SIZE:12PX;WIDTH:520PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select distinct jc_cxhd.cxhdmc c1,jc_cxhd.cxhdmc||'(订金：'||jc_cxhd.dj||'￥)' c2 from jc_cxhd,jc_cxhdsj where jc_cxhd.cxhdbm=jc_cxhdsj.cxhdbm  and jc_cxhd.fgsbh='"+ssfgs+"' and  jc_cxhd.hdlx='4'  order by jc_cxhd.cxhdmc",cxhdbmzh);
%> 
                </select>              </td>
            </tr>
