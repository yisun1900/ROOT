...
try {
	...
	ls_sql="SELECT khxm,ssfgs,cxhdbm";
...
<body bgcolor="#FFFFFF">
<CENTER >
  <B><font size="3">调整客户代金券</font></B>
</CENTER>
<form method="post" action="SaveInsertCrm_khdjj.jsp" name="insertform">
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span><span class="STYLE2">客户</span></td> 
  <td width="32%"><%=khxm%> </td>
