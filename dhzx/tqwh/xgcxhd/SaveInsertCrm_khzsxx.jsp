...
try {
	...
	for (int i=0;i<zsxm.length ;i++ )
	{
		...
		if (lx[i].equals("1"))
		{
			...
			ls_sql+=" select ?,zsxm,jldw,cbdj,scdj,zsslsx,zsslxx,bz,?,?*cbdj,?,?*cbdj,'1','"+yhmc+"',SYSDATE";
			...
			ls_sql="insert into crm_khzsxx (khbh,zsxm,jldw,cbdj,scdj,zsslsx,zsslxx,bz,sjsl,zsjz,zxzssl,zxzsjz,lx,lrr,lrsj)";
			ls_sql+=" select ?,zsxm,jldw,cbdj,scdj,zsslsx,zsslxx,bz,?,?*cbdj,?,?*cbdj,'2','"+yhmc+"',SYSDATE";
