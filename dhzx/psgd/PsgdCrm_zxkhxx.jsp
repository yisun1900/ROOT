...
<form method="post" action="SavePsgdCrm_zxkhxx.jsp" name="editform">
		  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right"><span class="STYLE1">*</span>施工队</td>
              <td width="82%">
                <select name="sgd" style="FONT-SIZE:12PX;WIDTH:352PX"  >
                  <option value=""></option>
                  <%
	String sgdStr =" select sq_sgd.sgd,sq_sgd.sgdmc||'（'||sq_sgd.dh||'）'||'（'||sq_sgd.kjdsm||'）（'||DECODE(sq_sgd.sgdlx,'S0','非直属队','S1','直属队')||'）'  ";
	sgdStr+=" from sq_sgd ";
...
%> 
            ...
            <tr bgcolor="#FFFFCC">
              <td align="right"><span class="STYLE1">*</span>质检</td>
