...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_dzyhsq.zklx='1'";//1：全额折扣；2：单项折扣
    ls_sql+=wheresql;
    ls_sql+=" order by crm_dzyhsq.sqsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_dzyhsqXgSpList.jsp","SelectXgSpCrm_dzyhsq.jsp","","XgSpCrm_dzyhsq.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_dzyhsqSp.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">打折优惠申请--修改审批</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">审批标志</td>
	<td  width="2%">审批结果</td>
	<td  width="2%" bgcolor="#CCCCFF">申请合同折扣</td>
	<td  width="2%" bgcolor="#CCCCFF">申请增减项折扣</td>
	<td  width="2%">折扣类型</td>
	<td  width="2%" bgcolor="#CCCCFF">是否申请其它优惠</td>
	<td  width="2%" bgcolor="#FFCCFF">审批合同折扣</td>
	<td  width="2%" bgcolor="#FFCCFF">审批增减项折扣</td>
	<td  width="2%" bgcolor="#FFCCFF">是否批准其它优惠</td>
	<td  width="9%" bgcolor="#CCCCFF">申请其它优惠内容</td>
	<td  width="12%" bgcolor="#CCCCFF">申请原因说明</td>
	...
	<td  width="10%" bgcolor="#FFCCFF">批准其它优惠内容</td>
	<td  width="8%">房屋地址</td>
	<td  width="3%">设计师</td>
	<td  width="4%">咨询店面</td>
	<td  width="2%">录入人</td>
