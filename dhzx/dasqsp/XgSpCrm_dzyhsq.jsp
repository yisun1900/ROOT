...
try {
	...
	ls_sql="select sqr,sqsj,sqzkl,sqzjxzkl,sfsqqtyh,sqqtyhnr,sqyysm,lrr,lrsj,lrbm ,spbz,spr,spsj,spjg,spsm,spzkl,spzjxzkl,sfpzqtyh,pzqtyhnr,zklx ";
	...
	if (rs.next())
	{
		...
		spjg=cf.fillNull(rs.getString("spjg"));
		spsm=cf.fillNull(rs.getString("spsm"));
		spzkl=rs.getDouble("spzkl");
		spzjxzkl=rs.getDouble("spzjxzkl");
...
<html>
<head>
<title>打折优惠申请--修改审批</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>

<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSpCrm_dzyhsq.jsp" name="editform">
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><input type="radio" name="spjg" value="1" <% if (spjg.equals("1")) out.println("checked");%>>
同意
  <input type="radio" name="spjg" value="2" <% if (spjg.equals("2")) out.println("checked");%> >
不同意 </td>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><input type="text" name="spzkl" size="12" maxlength="9"  value="<%=spzkl%>" >
（>0且<=10）</td>
      <td align="right"><font color="#FF0000">*</font>审批增减项折扣率</td>
      <td><input type="text" name="spzjxzkl" value="<%=spzjxzkl%>" size="12" maxlength="9" >
（>0且<=10）</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#FF0000">*</font>是否批准其它优惠</td>
      <td width="31%"><%
	cf.radioToken(out, "sfpzqtyh","Y+是&N+否",sfpzqtyh);
%></td>
      <td align="right" width="19%">&nbsp;</td>
      <td width="31%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <textarea name="pzqtyhnr" cols="74" rows="3"><%=pzqtyhnr%></textarea>      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">审批说明</td>
      <td colspan="3"> 
        <textarea name="spsm" cols="74" rows="3"><%=spsm%></textarea>      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#FF0000">*</font><font color="#000099">审批人</font></td>
      <td width="31%"> 
        <input type="text" name="spr" size="20" maxlength="20"  value="<%=spr%>"readonly >      </td>
      <td align="right" width="19%"><font color="#FF0000">*</font><font color="#000099">审批时间</font></td>
      <td width="31%"> 
        <input type="text" name="spsj" size="20" maxlength="10"  value="<%=spsj%>" readonly>      </td>
    </tr>
