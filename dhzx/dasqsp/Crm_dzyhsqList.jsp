...
//设置按钮参数
	...
	String[] buttonLink={"Crm_dzyhsqList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">打折优惠申请--修改</font></B>
</CENTER>
<%
	pageObj.out=out;
