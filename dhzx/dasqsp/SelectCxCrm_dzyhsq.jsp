...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_dzyhsqCxList.jsp" name="selectform">
<div align="center">打折优惠申请--查询</div>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="18%">是否申请其它优惠</td>
      <td width="32%"><%
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="18%">审批结果</td>
      <td width="32%"><%
