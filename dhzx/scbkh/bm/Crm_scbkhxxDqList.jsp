...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_scbkhxx.zt in('1','3','5','6','7')";//1：跟踪；2：失败；3：移交；4：已接收；5：准备移交；6：准备失败；7：移交过期
    ls_sql+=" and (crm_scbkhxx.zjgzsj is null OR (SYSDATE-crm_scbkhxx.zjgzsj)>crm_scbkhxx.hfjg)";
    ls_sql+=wheresql;
    ls_sql+=" order by crm_scbkhxx.scbkhbh desc";
    pageObj.sql=ls_sql;
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxDqList.jsp","","","InsertCrm_scbkhgzjl.jsp");
