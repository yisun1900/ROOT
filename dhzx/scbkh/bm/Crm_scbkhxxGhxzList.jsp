...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxGhxzList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"更换小组清空业务员","更换小组且保留业务员"};//按钮的显示名称
	String[] buttonLink={"PlGhXz.jsp","PlGhXz1.jsp"};//按钮单击调用的网页，可以增加参数
