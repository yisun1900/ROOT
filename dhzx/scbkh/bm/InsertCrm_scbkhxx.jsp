...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_scbkhxx.jsp" name="insertform" target="_blank">
<div align="center">业务员－录入</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="ywy" style="FONT-SIZE:12PX;WIDTH:152PX"  >
    <option value=""></option>
    <%
		String sql=null;
...
%>
  ...
  <td width="18%" align="right">业务员所属小组</td> 
  <td width="32%"><select name="ywyssxz" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where ssdw='"+lrbm+"' and cxbz='N' order by dwbh","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="ywybm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwbh='"+lrbm+"' order by dwbh",lrbm);
%>
  </select></td>
