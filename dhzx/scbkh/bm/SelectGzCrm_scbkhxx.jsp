...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhxxGzList.jsp" name="selectform">
<div align="center">根据设置时间回访客户</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="radio" name="crm_scbkhxx_sfxhf" value="Y" checked>
    需要</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right">到</td>
  <td><input type="text" name="crm_scbkhxx_xchfsj2" size="20" maxlength="10" value="<%=cf.today()%>" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
