...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhxxJlSbdjXgList.jsp" name="selectform">
<div align="center">部门－失败维护</div>
...
%>
  ...
  <select name="crm_scbkhxx_ywyssxz" style="FONT-SIZE:12PX;WIDTH:152PX">
     <option value=""></option>
   <%
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx='F4' and ssdw='"+dwbh+"' and cxbz='N' order by dwbh","");
%>
  </select>
  </td>
</tr>
