...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <%=crm_scbkhxx_ywy%>  </td>
  <td align="right" width="18%"><span class="STYLE1">业务员所属小组</span></td>
  <td width="32%"><%=crm_scbkhxx_ywyssxz%></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
<%
	cf.selectItem(out,"select sbyybm,sbyymc from dm_sbyybm order by sbyybm",crm_scbkhxx_sbyybm,true);
%>  </td>
  <td align="right" width="18%">&nbsp;</td>
  <td width="32%">&nbsp;</td>
</tr>
