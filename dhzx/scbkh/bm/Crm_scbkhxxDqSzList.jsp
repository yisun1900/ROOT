...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxDqSzList.jsp","","","DqszCrm_scbkhgzjl.jsp");
...
//设置主键
	...
	pageObj.setEditStr("设置 ");

//设置按钮参数
	String[] buttonName={"批量设置"};//按钮的显示名称
	String[] buttonLink={"PlDqszCrm_scbkhxx.jsp"};//按钮单击调用的网页，可以增加参数
