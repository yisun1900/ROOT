...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhgzjlCxList.jsp" name="selectform">
<div align="center">客户回访－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="31%"> 
    <input type="text" name="crm_scbkhgzjl_lrr" size="20" maxlength="20" value="" >  </td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%">
  <select name="crm_scbkhgzjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option  value=""></option>
    <%
