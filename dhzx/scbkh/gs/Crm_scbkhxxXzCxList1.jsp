...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_scbkhxx.scbkhbh, DECODE(crm_scbkhxx.zt,'1','跟踪','6','准备失败','2','失败','5','准备移交','3','移交','4','已接收','7','移交过期'),crm_scbkhxx.xqlx,crm_scbkhxx.khzyxz, DECODE(crm_scbkhxx.sfxhf,'Y','需要','N','否'),crm_scbkhxx.xchfsj,crm_scbkhxx.khxm,crm_scbkhxx.fwdz,crm_scbkhxx.ywy,c.dwmc ywyssxz,crm_scbkhxx.lrr,crm_scbkhxx.lrsj,b.dwmc lrbm,a.dwmc fgs,crm_scbkhxx.bz,sbyymc,crm_scbkhxx.sbyysm,crm_scbkhxx.sbdjr,crm_scbkhxx.sbdjsj,crm_scbkhxx.yjr,crm_scbkhxx.yjsj,d.dwmc yjbm,crm_scbkhxx.yjsm,crm_scbkhxx.jsr,crm_scbkhxx.jssj,crm_scbkhxx.khbh,cqmc,crm_scbkhxx.jiedao,crm_scbkhxx.xqbm,crm_scbkhxx.louhao,crm_scbkhxx.fwmj,hxmc,crm_scbkhxx.fj,crm_scbkhxx.yjzxsj,crm_scbkhxx.jzdsmc,crm_scbkhxx.zjgzsj, DECODE(crm_scbkhxx.sfxxq,'Y','是','N','否')  ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxXzCxList1.jsp","","","");
