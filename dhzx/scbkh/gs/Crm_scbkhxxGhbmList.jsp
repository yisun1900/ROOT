...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_scbkhxx.scbkhbh, DECODE(crm_scbkhxx.zt,'1','跟踪','6','准备失败','2','失败','5','准备移交','3','移交','4','已接收','7','移交过期'), crm_scbkhxx.khxm,crm_scbkhxx.fwdz,crm_scbkhxx.ywy,c.dwmc ywyssxz,e.dwmc ywybm,sckhyxmc,crm_scbkhxx.yyddsj,crm_scbkhxx.xqlx,crm_scbkhxx.khzyxz,crm_scbkhxx.fwmj,hxmc,crm_scbkhxx.fj,crm_scbkhxx.yjzxsj,crm_scbkhxx.jzdsmc,DECODE(crm_scbkhxx.sfxxq,'Y','是','N','否')  ,crm_scbkhxx.lrr,crm_scbkhxx.lrsj,b.dwmc lrbm,a.dwmc fgs,crm_scbkhxx.bz";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxGhbmList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"更换部门清空业务员","更换部门且保留业务员"};//按钮的显示名称
	String[] buttonLink={"PlGhScb.jsp","PlGhScb1.jsp"};//按钮单击调用的网页，可以增加参数
