...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxJlYjXgList.jsp","","","YjXgCrm_scbkhxx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_scbkhxxJlYjXgList.jsp"};//按钮单击调用的网页，可以增加参数
