...
try {
	...
	ls_sql="select yjbm,yjsm,khxm,fwdz,lxfs,ywy,zt,sbyybm,sbyysm,sbdjr,sbdjsj,lrr,lrsj,lrbm,crm_scbkhxx.ssfgs,crm_scbkhxx.bz,cqmc,jiedao,xqbm,louhao,dwmc ywyssxz,xqlx,fwmj,hxmc,fj,khzyxz,yjzxsj,jzdsmc,sfxhf,xchfsj ";
	...
	if (rs.next())
	{
		...
		yjsm=cf.fillNull(rs.getString("yjsm"));
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveYjXgCrm_scbkhxx.jsp" name="editform">
<div align="center">市场部客户－移交维护（市场部客户编号：<%=scbkhbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    ...
    <option value=""></option>
<%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx='F2' and cxbz='N' and ssfgs='"+ssfgs+"' order by dwbh",yjbm);
%>
    </select>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">移交说明</td>
  <td colspan="3"><textarea name="yjsm" cols="72" rows="3"><%=yjsm%></textarea></td>
  </tr>
<tr bgcolor="#FFFFFF">
