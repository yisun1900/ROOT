...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxXzYjXgList.jsp","","","YjXgCrm_scbkhxx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_scbkhxxXzYjXgList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_scbkhxx set zt='1',yjbm=null,yjsm=null,yjr=null,yjsj=null where zt='3' and "+chooseitem;
