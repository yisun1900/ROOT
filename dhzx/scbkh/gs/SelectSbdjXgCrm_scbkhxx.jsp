...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhxxSbdjXgList.jsp" name="selectform">
<div align="center">业务员－失败维护</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>
		  <input type="text" name="crm_scbkhxx_lrr" size="20" maxlength="20" value="">  
	</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
    <INPUT type="radio" name="crm_scbkhxx_zt" value="2" checked>失败
  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	  <input type="text" name="crm_scbkhxx_ywy" value="<%=yhmc%>" size="20" maxlength="20" readonly>
  </td>
