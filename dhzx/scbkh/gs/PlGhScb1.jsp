...
<form method="post" action="SavePlGhScb1.jsp" name="editform">
		  
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2" align="center" height="41"><p><b><font color="#000066">更换市场部</font></b></p>
      <p class="STYLE2"><strong>注意：小组信息将被清空，业务员将被保留,不需重新派业务员</strong></p></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
