...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhxxCxList.jsp" name="selectform">
<div align="center">导出客户资料</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr align="center">
    <td colspan="4"><input type="button"  value="导出客户资料" onClick="f_do(selectform,'zl')">
        <input name="button" type="button" onClick="f_do(selectform,'hf')"  value="导出回访模板">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<INPUT type="radio" name="crm_scbkhxx_zt" value="1">跟踪
	<INPUT type="radio" name="crm_scbkhxx_zt" value="6">准备失败
	<INPUT type="radio" name="crm_scbkhxx_zt" value="2">失败
	<INPUT type="radio" name="crm_scbkhxx_zt" value="5">准备移交
	<INPUT type="radio" name="crm_scbkhxx_zt" value="3">移交
	<INPUT type="radio" name="crm_scbkhxx_zt" value="4">已接收 
	<INPUT type="radio" name="crm_scbkhxx_zt" value="7">移交过期  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
function changeFgs(FormName)
{
	...
	var sql;
	sql="select dwbh,dwmc from sq_dwxx where ssfgs='"+FormName.crm_scbkhxx_ssfgs.value+"' and dwflbm='07' and dwlx!='F4' and cxbz='N' order by cxbz,dwbh";
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (lx=='zl')
	{
		FormName.action="Crm_scbkhxxExpList.jsp"
	}
	else if (lx=='hf')
	{
		FormName.action="Crm_scbkhxxExpHfList.jsp"
	}
	FormName.submit();
	return true;
}
