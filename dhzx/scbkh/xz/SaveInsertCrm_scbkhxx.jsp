...
try {
	...
	ls_sql="insert into crm_scbkhxx (scbkhbh,khxm,cqbm,jiedao,xqbm,louhao,fwdz,lxfs,ywy,ywyssxz  ";
	ls_sql+=" ,xqlx,fwmj,hxbm,fj,khzyxz,yjzxsj,jzdsmc,sfxhf,xchfsj,lrr ";
	ls_sql+=" ,lrsj,lrbm,ssfgs,bz,sfxxq,zt,ywybm) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?  ) ";
	ps= conn.prepareStatement(ls_sql);
	...
	ps.setString(8,lxfs);
	ps.setString(9,ywy);
	ps.setString(10,ywyssxz);

	ps.setString(11,xqlx);
	ps.setLong(12,fwmj);
	ps.setString(13,hxbm);
	ps.setLong(14,fj);
	ps.setString(15,khzyxz);
	ps.setDate(16,yjzxsj);
	ps.setString(17,jzdsmc);
	ps.setString(18,sfxhf);
	ps.setDate(19,xchfsj);
	ps.setString(20,lrr);
	...
	ps.setString(24,bz);
	ps.setString(25,sfxxq);
	ps.setString(26,zt);
	ps.setString(27,ywybm);
	ps.executeUpdate();
	ps.close();
