...
try {
	...
	ls_sql="update crm_scbkhxx set khxm=?,fwdz=?,lxfs=?,ywy=?,zt=?,lrr=?,lrsj=?,lrbm=?,ssfgs=?,bz=?   ,cqbm=?,jiedao=?,xqbm=?,louhao=?,qtdh=?,ywyssxz=?,xqlx=?,fwmj=?,hxbm=?,fj=?  ,khzyxz=?,yjzxsj=?,jzdsmc=?,sfxhf=?,xchfsj=? ";
	...
	ps.setString(15,qtdh);
	ps.setString(16,ywyssxz);
