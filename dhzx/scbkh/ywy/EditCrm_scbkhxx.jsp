...
try {
	...
	ls_sql="select khxm,fwdz,lxfs,ywy,zt,sbyybm,sbyysm,sbdjr,sbdjsj,lrr,lrsj,lrbm,ssfgs,bz,cqbm,jiedao,xqbm,louhao,ywybm,ywyssxz,xqlx,fwmj,hxbm,fj,khzyxz,yjzxsj,jzdsmc,sfxhf,xchfsj ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCrm_scbkhxx.jsp" name="insertform">
<div align="center">业务员－维护（市场部客户编号：）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	<input type="text" name="xqbm" value="<%=xqbm%>" size="20" maxlength="50" onKeyUp="changheIn(insertform)"  onblur="cf_fwdz(insertform)">  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <select name="valuelist" id="sel" style="position:absolute;WIDTH:300; left:19%;FONT-SIZE:12px;display:none" size="20" onKeyUp="changeItem(insertform,this)" onclick ="selectCk(insertform,this)">
    ...
    <span class="STYLE3">注意：房屋地址（城区＋街道＋小区＋楼号）自动生成，不需录入 </span></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#CC0000">*</font><span class="STYLE2">业务员</span></td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#CC0000">*</font><span class="STYLE2">业务员部门</span></td>
