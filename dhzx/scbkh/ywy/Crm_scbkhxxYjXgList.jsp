...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_scbkhxx.scbkhbh, DECODE(crm_scbkhxx.zt,'1','跟踪','6','准备失败','2','失败','5','准备移交','3','移交','4','已接收','7','移交过期'),sckhyxmc,crm_scbkhxx.yyddsj,crm_scbkhxx.yjr,crm_scbkhxx.yjsj,d.dwmc yjbm, crm_scbkhxx.khxm,crm_scbkhxx.fwdz,crm_scbkhxx.ywy,crm_scbkhxx.yjsm,crm_scbkhxx.xqlx,crm_scbkhxx.khzyxz,c.dwmc ywyssxz,e.dwmc ywybm,crm_scbkhxx.yjzxsj,crm_scbkhxx.jzdsmc,crm_scbkhxx.lrr,crm_scbkhxx.lrsj,a.dwmc fgs";
	ls_sql+=" FROM crm_scbkhxx,sq_dwxx a,sq_dwxx c,sq_dwxx d,sq_dwxx e,dm_sckhyxbm  ";
    ls_sql+=" where crm_scbkhxx.ssfgs=a.dwbh(+) and crm_scbkhxx.yjbm=d.dwbh(+)";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxYjXgList.jsp","","","YjXgCrm_scbkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"删除移交"};//按钮的显示名称
	String[] buttonLink={"DeleteCrm_scbkhxxYj.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">市场部客户——移交维护</font></B>
</CENTER>
<%
	pageObj.out=out;
