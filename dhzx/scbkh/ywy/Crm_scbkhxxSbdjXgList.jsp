...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_scbkhxx.scbkhbh, DECODE(crm_scbkhxx.zt,'1','跟踪','6','准备失败','2','失败','5','准备移交','3','移交','4','已接收','7','移交过期'),sckhyxmc,crm_scbkhxx.yyddsj,crm_scbkhxx.sbdjr,crm_scbkhxx.sbdjsj,sbyymc, crm_scbkhxx.khxm,crm_scbkhxx.fwdz,crm_scbkhxx.ywy,crm_scbkhxx.sbyysm,crm_scbkhxx.xqlx,crm_scbkhxx.khzyxz,c.dwmc ywyssxz,e.dwmc ywybm,crm_scbkhxx.yjzxsj,crm_scbkhxx.jzdsmc,crm_scbkhxx.lrr,crm_scbkhxx.lrsj,a.dwmc fgs";
	ls_sql+=" FROM crm_scbkhxx,sq_dwxx a,sq_dwxx c,dm_sckhyxbm,sq_dwxx e,dm_sckhsbyybm  ";
    ls_sql+=" where crm_scbkhxx.ssfgs=a.dwbh(+) and crm_scbkhxx.sbyybm=dm_sckhsbyybm.sbyybm(+)";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxSbdjXgList.jsp","","","XgDjCrm_scbkhxx.jsp");
...
//设置按钮参数
	String[] buttonName={"删除失败登记"};//按钮的显示名称
	String[] buttonLink={"DeleteCrm_scbkhxxSbdj.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">市场部客户——失败维护</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">失败登记人</td>
	<td  width="4%">失败登记时间</td>
	<td  width="5%">失败原因</td>

	<td  width="3%">客户姓名</td>
	<td  width="9%">房屋地址</td>
	<td  width="3%">业务员</td>
	<td  width="14%">失败原因说明</td>
	<td  width="3%">小区类型</td>
