...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT '查看' qd,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(ysshbz,'N','未审核','Y','通过','M','审核未通过'),DECODE(sfzdzbj,'N','未做','Y','已做'),dzbjze,bjjbmc,khjl,sjs,ywy,DECODE(shbz,'N','未审核','Y','审核'),lrsj,b.dwmc as zxdm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,crm_zxkhxx.khbh as khbh  ";
