...
<form method="post" action="SavePlhjl.jsp" name="editform">
		  
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2" align="center" height="41"><b><font color="#000066">换营业经理</font></b></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      <td width="32%" align="right" height="52">客户所属分公司</td>
      <td width="68%" height="52"> 
...
%> 
    ...
    <tr bgcolor="#FFFFCC"> 
      <td width="32%" align="right" height="45"><font color="#FF0033">*</font>咨询店面</td>
...
%> 
    ...
    <tr bgcolor="#FFFFCC">
      <td align="right" height="45"><font color="#FF0033">*</font>营业经理</td>
      <td height="45"><select name="dianz" style="FONT-SIZE:12PX;WIDTH:152PX"  >
        <option value=""></option>
        <%
		cf.selectItem(out,"select sq_yhxx.yhmc c1,sq_yhxx.yhmc c2 from sq_yhxx where ssfgs='"+ssfgs+"' and xzzwbm='设计部经理' and sq_yhxx.sfzszg in('Y','N') order by yhmc","");
%>
      </select></td>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      <td width="32%" align="right" height="45"><font color="#FF0033">*</font>更换店面原因</td>
      <td width="68%" height="45"> 
        <textarea name="ghdmyy" rows="6" cols="45"></textarea>      </td>
    </tr>
    <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.ghdmyy)=="") {
		alert("请输入[更换店面原因]！");
		FormName.ghdmyy.focus();
		return false;
	}
