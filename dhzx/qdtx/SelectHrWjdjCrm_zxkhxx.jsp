...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">换签单人后逾期未交订金客户</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_zxkhxxHrWjdjList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">签单人</td>
              <td width="32%"><input name="qdr" type="text" id="qdr" size="20" maxlength="20" ></td>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="hfrq2" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" >逾期未交订金时间</td>
              <td ><input name="yqwjdjsj" type="text" id="yqwjdjsj" onDblClick="JSCalendar(this)" value="3" size="20" maxlength="10"></td>
              <td colspan="2" >换签单人后，客户逾期未交订金</td>
            </tr>
            <tr bgcolor="#FFFFFF">
