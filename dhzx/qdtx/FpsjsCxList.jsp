...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String fpsjs=request.getParameter("fpsjs");
	if (!(fpsjs.equals("")))  wheresql+="  and (SYSDATE-crm_zxkhxx.sjsfpsj>="+fpsjs+")";
	

	ls_sql="SELECT crm_zxkhxx.khbh as khbh,crm_zxkhxx.khxm as crm_zxkhxx_khxm, DECODE(crm_zxkhxx.xb,'M','男','W','女') as crm_zxkhxx_xb,crm_zxkhxx.fwdz as crm_zxkhxx_fwdz,sjs,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,sjsfpsj,b.dwmc as zxdm,a.dwmc zxdjbm,fwlxmc as crm_zxkhxx_fwlxbm,crm_zxkhxx.hfrq as crm_zxkhxx_hfrq";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by crm_zxkhxx.ssfgs,crm_zxkhxx.sjsfpsj";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("FpsjsCxList.jsp","","","");
...
<CENTER >
  <B><font size="3">签单提醒－分配设计师时间</font></B>
</CENTER>
<%
	pageObj.out=out;
