...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	wheresql+="  and (SYSDATE-crm_zxkhxx.gdczsj>"+yqwjdjsj+")";
    ...
    ls_sql+=" and crm_zxkhxx.gdczlx='6'";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxHjlWjdjList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"换营业经理"};//按钮的显示名称
	String[] buttonLink={"plhjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">换经理后逾期未交订金客户</font></B>
</CENTER>
<%
	pageObj.out=out;
