...
<table width="100%">
  <tr>
    <td width="100%" align="center"> 
      <div align="center">市场部经理定期回访客户</td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">

<form method="post" action="Crm_zxkhxxDqScbList.jsp" name="selectform">
	...
	ywysql+=" and sq_yhxx.zwbm in('23','04') and sq_yhxx.sfzszg in('Y','N') ";
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"><input type="text" name="sjs" value="<%=sjs%>" size="20" maxlength="100" <% if (!sjs.equals("")) out.println("readonly");%>></td>
