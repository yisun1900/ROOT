...
<form method="post" action="SaveInsertCrm_zxhfjlDq.jsp" name="insertform" >
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button" onClick="window.open('/dhzx/shfsj/HfsjCrm_zxkhxx.jsp?khbh=<%=khbh%>')"  value="设回访时间">
