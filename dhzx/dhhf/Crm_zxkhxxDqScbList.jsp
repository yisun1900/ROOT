...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,NVL2(crm_zxkhxx.hfzq,crm_zxkhxx.hfzq||'天',''),crm_zxkhxx.zxhfsj,khjl,sjs,ywy,xqlx,khzyxz,sbyymc,sbsj,lrsj,dwmc,crm_zxkhxx.khbh ";
	...
	ls_sql+=" and  ((SYSDATE-crm_zxkhxx.zxhfsj)>=crm_zxkhxx.hfzq OR (crm_zxkhxx.zxhfsj is null and crm_zxkhxx.hfzq>0))";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxDqScbList.jsp","","InsertCrm_zxhfjlDq.jsp","");
