...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khsmjl.jlh,DECODE(crm_khsmjl.sfhf,'Y','回访','N','未回访'),crm_khsmjl.khbh,crm_zxkhxx.khxm,crm_khsmjl.lfcs,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,TO_CHAR(crm_khsmjl.smsj,'YYYY-MM-DD'),crm_khsmjl.smmd,crm_khsmjl.jdr,a.dwmc jdrbm,crm_khsmjl.sjjdqk,crm_khsmjl.lrr,crm_khsmjl.lrsj,b.dwmc ssfgs,crm_khsmjl.bz  ";
...
//设置列超级连接
	...
	coluParm.link="/dhzx/smjl/ViewCrm_khsmjl.jsp";//为列参数：coluParm.link设置超级链接
