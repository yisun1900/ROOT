...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_zxkhxxSmList.jsp" name="selectform">
<div align="center">上门客户回访</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input name="crm_zxkhxx_sjs" type="text" id="crm_zxkhxx_sjs" value="<%=sjs%>" size="20" maxlength="100" <% if (!sjs.equals("")) out.println("readonly");%>></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
  <INPUT type="radio" name="sfhf" value="N" checked>
未回访 </td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
