...
<form method="post" action="SaveInsertCrm_zxhfjl.jsp" name="insertform" >
...
%>
              ...
              <td>
				  <input type="text" name="hfcs" value="<%=hfcs%>" size="10" maxlength="10" readonly>次
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right"> 
              <font color="#CC0000">*</font>是否继续回访              </td>
              <td width="30%"> 
                <input type="radio" name="sfjxhf" value="Y">
                继续回访 
