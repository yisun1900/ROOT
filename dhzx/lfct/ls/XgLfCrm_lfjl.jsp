...
try {
	...
	ls_sql="select lfjlh,crm_lfjl.khbh,khxm,lflxbm,smmb,jhsmsj,jhsmry,sjlfsj,sjlfr,lfjg,lfjgsm,cfwsjcs,bz";
	...
	if (rs.next())
	{
		...
		sjlfsj=cf.fillNull(rs.getDate("sjlfsj"));
		sjlfr=cf.fillNull(rs.getString("sjlfr"));
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#FFFFFF">
      <input name="sjlfr" type="text" size="71" value="<%=sjlfr%>">    </td>
    </tr>
  <tr>
