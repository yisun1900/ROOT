...
try {
	...
	int xh=0;
	ls_sql="select lfjlh,crm_lfjl.khbh,lflxbm,smmb,jhsmsj,jhsmry,xfxqr,lrr,lrsj,lrbm,bz,qrjg,qrsm";
...
<body>
<form name="form1" action="SaveQrCrm_lfjl.jsp" method="post">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  <tr>
    <td colspan="4" bgcolor="#cccccc"><div align="center" class="STYLE1">量房计划确认</div></td>
  </tr>
  <tr>
    <td height="25" align="right" bgcolor="#FFFFCC" ><span class="STYLE2">客户编号</span></td>
    <td width="30%" bgcolor="#FFFFCC"><%=khbh%></td>
    <td align="right" bgcolor="#FFFFCC"><span class="STYLE2">客户姓名</span> </td>
    <td bgcolor="#FFFFCC"><%=khxm%></td>
  </tr>
  <tr>
    <td height="25" align="right" bgcolor="#FFFFCC"><span class="STYLE2">房屋地址</span></td>
...
%>     </td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td colspan="3" bgcolor="#FFFFCC"><%=bz%></td>
  </tr>
  <tr bgcolor="#FFFFFF">
