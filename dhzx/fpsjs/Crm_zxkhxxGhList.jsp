...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (sffp!=null)
	{
		if (sffp.equals("Y"))	
		{
			wheresql+=" and  (crm_zxkhxx.sjs is not null)";
		}
		else{
			wheresql+=" and  (crm_zxkhxx.sjs is null)";
		}
	}
	String sjs=null;
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxGhList.jsp","","","GhSjsCrm_zxkhxx.jsp");
	pageObj.setPageRow(150);//设置每页显示记录数
/*
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"PlGhSjs.jsp"};//按钮单击调用的网页，可以增加参数
