...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  <tr>
    <td colspan="4" bgcolor="#cccccc"><div align="center" class="STYLE1">碰方案进度</div></td>
  </tr>

  <tr>
   
    <td bgcolor="#FFFFFF" height=20><div align="right">客户编号</div></td>
  ...
  <tr>
    <td height="20" bgcolor="#FFFFFF"><div align="right">实际参加人员</div></td>
    <td bgcolor="#FFFFFF"><%=sjry%></td>
    <td bgcolor="#FFFFFF"><div align="right">实际碰方案时间</div></td>
    <td bgcolor="#FFFFFF"><%=sjsj%></td>
  </tr>
  <tr>
    <td height="20" bgcolor="#FFFFFF"><div align="right">进度</div></td>
    <td colspan=3 bgcolor="#FFFFFF"><%=jd%></td>
    </tr>
  <tr>
    <td height="20" bgcolor="#FFFFFF"><div align="right">过程</div></td>
    <td colspan=3 bgcolor="#FFFFFF"><%=gc%></td>
  </tr>
