...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("PfaglList_edit.jsp","","EditCrm_pfagcgl.jsp","");
...
//设置主键
	...
	String[] buttonLink={"PfaglList_edit.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from crm_pfagcgl where "+chooseitem;
