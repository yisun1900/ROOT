...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  ...
  <tr>
    <td height="25" width="20%" bgcolor="#FFFFFF" ><div align="right">碰方案类型       </div></td>
    <td height="20" width="30%" bgcolor="#FFFFFF">  <%
		cf.selectItem(out,"select pfalxbm,pfalxmc from dm_pfalxbm where pfalxbm='"+pfalxbm+"'","");
	  %> </td>
   ...
   <tr>
    <td height="25" bgcolor="#FFFFFF"><div align="right">计划参加人员</div></td>
    <td height="20" bgcolor="#FFFFFF" colspan=3><%=jhry%></td>
  </tr>
 
  <tr>
	 <td height="25" width="20%" bgcolor="#FFFFFF"><div align="right">碰方案内容</div></td>
