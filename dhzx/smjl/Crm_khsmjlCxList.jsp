...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khsmjl.jlh,DECODE(crm_khsmjl.zt,'1','未录结果','2','已录结果','3','已审核'),crm_khsmjl.khbh,crm_zxkhxx.khxm,crm_khsmjl.lfcs,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_zxkhxx.ywy,TO_CHAR(crm_khsmjl.smsj,'YYYY-MM-DD'),crm_khsmjl.smmd,crm_khsmjl.jdr,a.dwmc jdrbm,crm_khsmjl.sjjdqk,DECODE(crm_khsmjl.sfhf,'Y','回访','N','未回访'),crm_khsmjl.hfr,crm_khsmjl.hfsj,crm_khsmjl.hfsm,crm_khsmjl.lrr,crm_khsmjl.lrsj,b.dwmc ssfgs,crm_khsmjl.bz  ";
