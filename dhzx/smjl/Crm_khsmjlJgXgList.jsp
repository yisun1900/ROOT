...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khsmjlJgXgList.jsp","","","XgJgCrm_khsmjl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除结果"};//按钮的显示名称
	String[] buttonLink={"Crm_khsmjlJgXgList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khsmjl set sjjdqk=null,jdjglrr=null,jdjglrsj=null,zt='1' where zt='2' and "+chooseitem;
