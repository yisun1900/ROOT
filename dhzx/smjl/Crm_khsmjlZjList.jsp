...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	//DECODE(crm_khsmjl.zt,'1','未录结果','2','已录结果','3','已审核'),
	ls_sql="SELECT crm_khsmjl.jlh,crm_khsmjl.khbh,crm_zxkhxx.khxm,crm_khsmjl.lfcs,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,TO_CHAR(crm_khsmjl.smsj,'YYYY-MM-DD'),crm_khsmjl.smmd,crm_khsmjl.jdr,crm_khsmjl.jdrbh,a.dwmc jdrbm,crm_khsmjl.lrr,crm_khsmjl.lrsj,b.dwmc ssfgs,crm_khsmjl.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khsmjlZjList.jsp","","","EditCrm_khsmjlZj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_khsmjlZj.jsp?"};//按钮单击调用的网页，可以增加参数
