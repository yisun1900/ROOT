...
try {
	...
	ls_sql="select DECODE(djjzsfs,'1','固定金额','2','工程费百分比','3','整单百分比') djjzsfs,DECODE(zsjs,'1','折前合同额','2','折后合同额','3','折前工程费','4','折后工程费','5','结算金额') zsjs,khfqbfb,khfqje ";
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td colspan="4" align="center" bgcolor="#FFFFCC">代金券赠送方式</td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right">客户返券百分比</td>
    <td><%=khfqbfb%>%</td>
    <td align="right">客户返券金额</td>
    <td><%=khfqje%></td>
  </tr>
</table>
