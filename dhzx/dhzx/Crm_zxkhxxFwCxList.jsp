...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sjs,khjl,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),jhzbjsj,sczbjsj,dzbjze,qsjhtsj,sjhtje,lfdj,jlfdjsj,sjf,jsjfsj,lfsj,jhctsj,ctsj,jhcxgtsj,cxgtsj,jhcsgtsj,csgtsj,khzyxz,sq_dwxx.dwmc,lrsj";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxFwCxList.jsp","","","");
	if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
	{
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">客户经理</td>
	<td  width="4%">咨询状态</td>
	<td  width="4%">计划做报价时间</td>
	<td  width="4%">实做报价时间</td>
	...
	<td  width="4%">量房时间</td>
	<td  width="4%">计划出平面图时间</td>
	<td  width="4%">实出平面图时间</td>
	<td  width="4%">计划出效果图时间</td>
	<td  width="4%">实出效果图时间</td>
	<td  width="4%">计划出施工图时间</td>
	<td  width="4%">实出施工图时间</td>
