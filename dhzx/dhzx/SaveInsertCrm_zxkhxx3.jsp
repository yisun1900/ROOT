...
//		out.println(ls_sql);
	...
	ps.setString(75,scbkhbh);
	ps.setString(76,ywybm);
	ps.setString(77,pdqybm);
	ps.setString(78,sfyckh);
	ps.setString(79,dianz);
	ps.setString(80,scbjl);
	ps.setString(81,hxmjbm);
	ps.setString(82,xxly);

	ps.executeUpdate();
	ps.close();

	ls_sql="update crm_scbkhxx set zt='4',jsr=?,jssj=SYSDATE,khbh=?";
	ls_sql+=" where scbkhbh='"+scbkhbh+"'";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,lrr);
	ps.setString(2,khbh);
