...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right">厨房折扣</td>
    <td><%=mjzjzk%></td>
    <td align="right">卫生间折扣</td>
    <td><%=zcclzk%></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">主材升级折扣</td>
    <td><%=zcsjzk%></td>
    <td align="right">主材减免折扣</td>
    <td><%=zcjmzk%></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">套餐外主材</td>
    <td><%=zcsfzk%></td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
ls_sql="select DECODE(lx,'1','多选','2','单选'),zsxm,jldw,TO_CHAR(scdj),TO_CHAR(zsslsx),TO_CHAR(zsslxx),sjsl,bz  ";
