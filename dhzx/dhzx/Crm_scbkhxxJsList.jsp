...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_scbkhxx.scbkhbh,crm_scbkhxx.khxm,crm_scbkhxx.fwdz,crm_scbkhxx.yjr,crm_scbkhxx.yjsj,c.dwmc yjbm,crm_scbkhxx.yjsm,crm_scbkhxx.ywy, DECODE(crm_scbkhxx.zt,'1','跟踪','2','失败','3','移交','4','已接收'),sbyymc,crm_scbkhxx.sbyysm,crm_scbkhxx.sbdjr,crm_scbkhxx.sbdjsj,crm_scbkhxx.lrr,crm_scbkhxx.lrsj,b.dwmc lrbm,a.dwmc ssfgs,crm_scbkhxx.bz  ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_scbkhxxJsList.jsp","","","InsertCrm_zxkhxx3.jsp");
