...
String kfgssq=(String)session.getAttribute("kfgssq");//0：不授权；1：授权单个分公司；2：授权多个分公司；3：授权单个店面；4：授权某一分公司多个店面；5：授权多个分公司多个店面
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,'TEL:'||lxfs,sjs,ysy,khjl,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),DECODE(ysshbz,'N','未审核','Y','通过','M','审核未通过'),zjzbjsj,bjjbmc,qsjhtsj,sjhtje,lfdj,jlfdjsj,cxhdbm,hddj,jhddjsj,sjf,jsjfsj,lfsj,ctsj,cxgtsj,csgtsj,DECODE(crm_zxkhxx.jzbz,'1','家装','2','公装'),b.dwmc as zxdm,ywy,a.dwmc ywybm,sbyymc,lrsj,fwlxmc,xxlysm";
	...
	ls_sql+=" and crm_zxkhxx.ywybm=a.dwbh(+) and crm_zxkhxx.zxdm=b.dwbh(+) ";
