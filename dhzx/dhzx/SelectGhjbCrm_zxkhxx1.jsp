...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
			...
			if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
			{
				%> 
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="20%" >每页显示数量</td>
              <td colspan="3" > 
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="30%"> 
                ...
                未做报价 
                <input type="radio" name="sfzdzbj" value="Y" checked>
                已做 </td>
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="32%"> 
                <input type="radio" name="sfqd" value="1" checked>
                未签单 
...
%> 
              ...
              <td width="18%" align="right">是否交活动订金</td>
              <td width="32%"> 
                <input type="radio" name="sfjhddj" value="Y">
                已交订金 
                <input type="radio" name="sfjhddj" value="N">
                未交订金 </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_zxkhxxGhjbList.jsp";
