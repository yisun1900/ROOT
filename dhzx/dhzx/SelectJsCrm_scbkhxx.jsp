...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_scbkhxxJsList.jsp" name="selectform">
<div align="center">接收市场部客户</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%"><input type="radio" name="crm_scbkhxx_zt" value="3" checked>
    移交</td>
</tr>
<tr bgcolor="#FFFFFF">
