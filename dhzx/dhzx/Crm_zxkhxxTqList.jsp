...
<%
if (cf.check((String)session.getAttribute("yhdlm"),request.getRemoteHost(),"030704")==0) 
{
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and zxzt!='3'";//0：未分配店面；1: 分配店面；2: 设计师提交飞单；3：已签约；4：飞单；5：飞单审核未通过
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxTqList.jsp","","","EditCrm_zxkhxxTq.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_zxkhxx.jsp"};//按钮单击调用的网页，可以增加参数
