...
<form method="post" action="" name="selectform">
      <div align="center">查询全部市场部客户</div>
		  ...
		  <%
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="34%"><input type="text" name="sjs" value="" size="20" maxlength="20" ></td>
            </tr>
...
%>
	          ...
	          <td bgcolor="#FFFFCC">
				<input type="text" name="ywy" value="" size="20" maxlength="20">
			  </td>
            </tr>
	        <tr bgcolor="#FFFFFF">
	  ...
	  <td>&nbsp;</td>
		  ...
		  <tr bgcolor="#FFFFCC"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td><input type="radio" name="zklx" value="1">
                全额
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right" bgcolor="#FFFFFF">交量房订金标志</td>
              <td colspan="3"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">交量房订金时间 从</td>
              <td width="31%"> 
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_zxkhxxScbAllCxList.jsp";
