...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and crm_zxkhxx.zxzt not in (3,4) ";
...
<CENTER >
  <B><font size="3">未签单客户（未含飞单）--查询</font></B>
</CENTER>
