...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sjs,khjl,khzyxz,xqlx,DECODE(ysshbz,'N','未审核','Y','审核通过','M','审核未通过'),DECODE(shbz,'N','未审核','Y','审核'),DECODE(sfzdzbj,'N','未做','Y','已做'),dzbjze,crm_zxkhxx.jlfdjsj,crm_zxkhxx.cxhdbm,ywy,fwlxmc as crm_zxkhxx_fwlxbm,a.dwmc zxdjbm,b.dwmc as zxdm,crm_zxkhxx.hfrq as crm_zxkhxx_hfrq,DECODE(crm_zxkhxx.hdbz,'1','非回单','2','设计师回单','3','施工队回单','4','老客户回单','5','员工回单','6','班长回单','7','售楼处','8','材料商','9','其他') as crm_zxkhxx_hdbz,crm_zxkhxx.lrsj,crm_zxkhxx.bz  ";
