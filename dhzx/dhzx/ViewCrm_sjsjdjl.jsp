...
<%
	...
	ls_sql="SELECT crm_sjsjdjl.sjsjdjlh,DECODE(crm_sjsjdjl.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),crm_sjsjdjl.khbh,a.dwmc ssfgs,b.dwmc zxdm,crm_sjsjdjl.sjs,kssj,kslrr,jssj,jslrr,dm_sbyybm.sbyymc,crm_sjsjdjl.sbyyxs";
