...
try {
	...
	ls_sql="select lfjlh,crm_lfjl.khbh,khxm,lflxbm,smmb,jhsmsj,jhsmry,bzsm";
...
<body>
<form name="editform" action="SaveLfCrm_lfjl.jsp" method="post" target="_blank">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><input name="sjsmsj2" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10"/></td>
    <td align="right" bgcolor="#FFFFFF">初步预算金额</td>
    <td bgcolor="#FFFFFF"><input name="sjsmsj22" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10"/></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>实际上门时间</td>
    <td bgcolor="#FFFFFF"><input name="sjsmsj" type="text" onDblClick="JSCalendar(this)" value="<%=cf.today()%>" size="20" maxlength="10"/></td>
    <td align="right" bgcolor="#FFFFFF">是否又回到店中</td>
...
是
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#FFFFFF">
      <input name="sjsmry" type="text" size="71" >    </td>
    </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF">户型功能关注点</td>
    <td bgcolor="#FFFFFF" colspan=3><textarea name="textarea" cols="70"  rows="3"></textarea></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF">关注哪个房间</td>
    <td bgcolor="#FFFFFF" colspan=3><input name="textarea2" type="text" value="" size="70"></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF">各房间关注点描述</td>
    <td bgcolor="#FFFFFF" colspan=3><textarea name="textarea4" cols="70"  rows="3"></textarea></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF">单项关注点（门、床等）</td>
    <td bgcolor="#FFFFFF" colspan=3><textarea name="textarea3" cols="70"  rows="3"></textarea></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>上门结果 </td>
    <td bgcolor="#FFFFFF" colspan=3><textarea name="lfjgsm" cols="70"  rows="6"></textarea></td>
  </tr>
  <tr>
