...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_lfjlXgLfList.jsp","","","XgLfCrm_lfjl.jsp");
...
//	pageObj.setViewStr("录入");
	...
	//设置按钮参数
	String[] buttonName={"删除量房信息"};//按钮的显示名称
	String[] buttonLink={"Crm_lfjlXgLfList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_lfjl set sjsmsj=null,sjsmry=null,lfjgsm=null,cfwsjcs=null,zt='2' where "+chooseitem;
