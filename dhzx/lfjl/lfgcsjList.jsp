...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and crm_lfjl.sjsmsj is not null";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("lfgcsjList.jsp","","lfgcsj_edit.jsp","");
...
//设置主键
	...
	String[] buttonLink={"lfgcsjList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_lfjl  set sjsmsj=null,sjsmry=null,lfjgsm=null,cfwsjcs=null,bzsm=null  where "+chooseitem;
