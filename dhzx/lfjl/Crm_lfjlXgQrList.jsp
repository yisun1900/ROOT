...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_lfjl.qrjg is not null ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_lfjlXgQrList.jsp","","","XgQrCrm_lfjl.jsp");
...
//设置主键
	...
	String[] buttonLink={"Crm_lfjlXgQrList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_lfjl set qrjg=null,qrr=null,qrsj=null,zt='1',qrsm=null where "+chooseitem;
...
<CENTER >
  <font size="4"><b>量房计划确认－修改</b></font>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="8%">相关人员确认说明</td>
	<td  width="3%">实际上门时间</td>
	<td  width="5%">实际上门人员</td>
	<td  width="2%">量房结果</td>
