...
try {
	...
	if (rs.next())
	{
		...
		sjsmry=rs.getString("sjsmry");
		sjsmsj=rs.getDate("sjsmsj");
		lfjgsm=rs.getString("lfjgsm");
		cfwsjcs=rs.getString("cfwsjcs");
		bzsm=rs.getString("bzsm");
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC" style="FONT-SIZE:12">
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#FFFFFF">
      <input name="sjsmry" type="text" value="<%=sjsmry%>" size="71" maxlength="50" >    </td>
    </tr>
  <tr>
