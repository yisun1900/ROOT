...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td colspan="3" bgcolor="#CCCCFF"><%=cxhdbm%><%--<input name="button3" type="button" onClick="window.open('/dhzx/tqwh/xgcxhd/EditCrm_zxkhxx.jsp?khbh=<%=khbh%>')"  value="调整活动">
                <input name="button42" type="button" onClick="window.open('/dhzx/tqwh/xgcxhd/InsertCrm_khzsxx.jsp?khbh=<%=khbh%>')"  value="活动赠送信息">
...
%> 
            ...
            <tr bgcolor="#E8E8D4"> 
              ...
              <td width="32%"> 
                <select name="hxbm" style="FONT-SIZE:12PX;WIDTH:150PX">
                  <%
	if (hxbm!=null && !hxbm.equals(""))
	{
...
%></td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right">优惠说明</td>
              <td colspan="3"> 
            ...
            <tr> 
              <td colspan="4" align="center" > 
                ...
                <p>
                    ...
                    <%--<input name="button4" type="button" onClick="f_tzk(editform)"  value="调折扣" >--%>
                    <input type="button" onClick="f_dybj(editform)"  value="预览报价" >
...
function f_zj(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/dzbjone/zxbjmx/BjDyList.jsp?dqbm=<%=dqbm%>";
