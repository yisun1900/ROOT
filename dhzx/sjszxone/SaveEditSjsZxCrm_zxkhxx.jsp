...
try {
	...
	String sqhxbm=null;
	ls_sql="select zxdm,sfxhf,hfrq,zxzt,sjs,zxjlh,sqhxbm";
	...
	ls_sql+=" ,bjjb=?,jzbz=?,lfbz=?,lfsj=?,ctbz=?,ctsj=?,cxgtbz=?,cxgtsj=?,csgtbz=?,csgtsj=?,ysy=?,zcsfss=?";//设计师咨询情况
