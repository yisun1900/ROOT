	...
	if (lx.equals("2"))//1：非套餐；2：套餐
	{
		...
		%>
		  <tr  align="center">
			<td height="36">
			  <p>
			    <input type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=khbh%>')"  value="预览打印临时人辅报价"   />
			  </p>
			  <p>
			    <input type="button" onClick="window.open('/dzbjone/zxbjmx/Bj_khzcmxDy.jsp?khbh=<%=khbh%>')"  value="预览打印临时主材报价"   />
			  </p>
			  <p>
