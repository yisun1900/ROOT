...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_yjdjl.jdjlh, DECODE(crm_yjdjl.clzt,'1','申请','2','派单','3','已预交底'),crm_yjdjl.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sgdmc,crm_yjdjl.zjxm,crm_yjdjl.fbr,crm_yjdjl.fbsj,crm_yjdjl.zzqrjdrq,crm_yjdjl.zzqrjdsj,crm_zxkhxx.hth,crm_zxkhxx.sjs,dwmc,crm_yjdjl.sqrq,crm_yjdjl.sqr,crm_yjdjl.sqrlxdh,crm_yjdjl.jhjdrq,crm_yjdjl.jhjdsj,crm_yjdjl.sqsm,crm_yjdjl.lrr,crm_yjdjl.lrsj";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yjdjlJdList.jsp","","","JdCrm_yjdjl.jsp");
