...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_yjdjl.jdjlh, DECODE(crm_yjdjl.clzt,'1','申请','2','派单','3','已预交底'),crm_yjdjl.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sgdmc,crm_yjdjl.sgbz,crm_yjdjl.zjxm,crm_yjdjl.fbr,crm_yjdjl.fbsj,crm_yjdjl.zzqrjdrq,crm_yjdjl.zzqrjdsj,crm_zxkhxx.hth,crm_zxkhxx.sjs,dwmc,crm_yjdjl.sqrq,crm_yjdjl.sqr,crm_yjdjl.sqrlxdh,crm_yjdjl.jhjdrq,crm_yjdjl.jhjdsj,crm_yjdjl.sqsm,crm_yjdjl.lrr,crm_yjdjl.lrsj";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_yjdjl.fbsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yjdjlXgFbList.jsp","","","XgFbCrm_yjdjl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除派单"};//按钮的显示名称
	String[] buttonLink={"DeleteFbCrm_yjdjl.jsp"};//按钮单击调用的网页，可以增加参数
