...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_yjdjl.jdjlh, DECODE(crm_yjdjl.clzt,'1','申请','2','派单','3','已预交底'),crm_yjdjl.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.hth,crm_zxkhxx.sjs,dwmc,crm_yjdjl.sqrq,crm_yjdjl.sqr,crm_yjdjl.sqrlxdh,crm_yjdjl.jhjdrq,crm_yjdjl.jhjdsj,crm_yjdjl.sqsm,sgdmc,crm_yjdjl.zjxm,crm_yjdjl.fbr,crm_yjdjl.fbsj,crm_yjdjl.zzqrjdrq,crm_yjdjl.zzqrjdsj,crm_yjdjl.sjjdsj,DECODE(crm_yjdjl.jdsfcg,'Y','成功','N','否'),crm_yjdjl.sjjdqk,crm_yjdjl.lrr,crm_yjdjl.lrsj";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_yjdjl.sjjdsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yjdjlXgJdList.jsp","","","XgJdCrm_yjdjl.jsp");
...
//	pageObj.setEditStr("预交底");

//设置按钮参数
	String[] buttonName={"删除预交底"};//按钮的显示名称
	String[] buttonLink={"DeleteJdCrm_yjdjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">交底是否成功</td>
	<td  width="14%">实际交底情况</td>
	<td  width="2%">录入人</td>
	<td  width="3%">录入时间</td>
</tr>
<%
