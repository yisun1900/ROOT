...
try {
	...
	ls_sql="select cqbm,khjl,crm_zxkhxx.ssfgs,khxm,fwdz,hth,sjs,crm_zxkhxx.zxdm,dwmc,sgd,zjxm,xcjdbz,fwmj,hxbm,sjhtje,tchtje,DECODE(trim(xjf),'1','新房','2','旧房')xjf,bjjb,hdr,hdbz ";
...
<div align="center">预交底派单（预交底记录号：<%=jdjlh%>）</div>
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE2">是否套餐</span></td>
    <td><%=khqdzt%></td>
  ...
  <tr bgcolor="#FFFFFF">
   <td align="right"><span class="STYLE2">新/旧房</span></td>
    <td><%=xjf%></td>
	<td align="right">&nbsp;</td>
    <td>&nbsp; </td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF">
   <td align="right"><span class="STYLE2">是否回单</span></td>
    <td><%
	cf.selectItem(out,"select hdlxbm,hdlxmc from dm_hdlxbm order by hdlxbm",hdbz,true);
%></td>
	<td align="right"><span class="STYLE2">回单人</span></td>
    <td><%=hdr%></td>
  </tr>
...
//	}
	...
	FormName.action="SaveFbCrm_yjdjl.jsp";
	FormName.submit();
	return true;
}
