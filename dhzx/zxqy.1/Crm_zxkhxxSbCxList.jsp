...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  crm_zxkhxx.khxm,crm_zxkhxx.fwdz,a.sbyymc sbyybm,sbsj,crm_zxkhxx.sbkhlx,crm_zxkhxx.sbyyxs,b.sbyymc hfsbyybm,crm_zxkhxx.hfsbsj,crm_zxkhxx.hfsbkhlx,crm_zxkhxx.hfsbyyxs,crm_zxkhxx.sjs,khjl,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,dwmc,crm_zxkhxx.khbh ";
	ls_sql+=" FROM crm_zxkhxx,sq_dwxx,dm_sbyybm a,dm_sbyybm b";
    ls_sql+=" where  crm_zxkhxx.sbyybm=a.sbyybm(+)";
    ls_sql+=" and  crm_zxkhxx.hfsbyybm=b.sbyybm(+)";
    ls_sql+=" and crm_zxkhxx.zxdm=sq_dwxx.dwbh(+) ";
	ls_sql+=" and crm_zxkhxx.zxzt in('4')  ";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by crm_zxkhxx.sbsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxSbCxList.jsp","","","");
...
<html>
<head><title>飞单查询</title></head>
<body bgcolor="#ffffff" text="#000000" style='FONT-SIZE: 12px'>
<CENTER >
  <strong><font size="3">飞单查询</font></strong>
</CENTER>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="14%">失败原因详述</td>
	<td  width="6%">回访失败原因</td>
	<td  width="4%">回访失败时间</td>
	<td  width="7%">回访失败客户流向</td>
	<td  width="14%">回访失败原因详述</td>
	<td  width="3%">设计师</td>
	<td  width="3%">客户经理</td>
	<td  width="3%">业务员</td>
	<td  width="5%">咨询状态</td>
