...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and crm_qysbdj.clzt='1'";//1：设计师提交、2：设计部审核、3：市场部审核、4：接待主管审核、5：回访
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjSjsList.jsp","","","DeleteCrm_qysbdj.jsp");
...
<CENTER >
  <B><font size="3">设计师提交飞单－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
