...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','设计师提交','2','设计部审核','3','市场部审核','4','接待主管审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sbyymc,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,b.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_zxkhxx.zxzt in('2','4')";//0：未分配店面；1: 分配店面；2: 设计师提交飞单；3：已签约；4：飞单；5：飞单审核未通过
	ls_sql+=" and crm_qysbdj.xxrsfhf='N'";
	ls_sql+=" and crm_zxkhxx.lrr='"+yhmc+"'";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjXxrHfList.jsp","","","InsertCrm_fdkhhf.jsp?lx=3");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="15%">房屋地址</td>
	<td  width="9%">失败原因</td>
	<td  width="9%">失败客户流向</td>
	<td  width="17%">飞单原因详述</td>
	<td  width="4%">设计师</td>
	<td  width="10%">咨询店面</td>
	<td  width="4%">业务员</td>
	<td  width="6%">登记时间</td>
