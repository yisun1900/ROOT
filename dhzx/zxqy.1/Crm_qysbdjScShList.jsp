...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','设计师提交','2','设计部审核','3','市场部审核','4','接待主管审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,ywy,DECODE(crm_qysbdj.sjbshjl,'Y','通过','N','未通过'),crm_qysbdj.sjbshr,crm_qysbdj.sjbshsj,crm_qysbdj.sjbshyj,sbyymc,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,b.dwmc,crm_qysbdj.lrsj,crm_qysbdj.lrr";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjScShList.jsp","","","ScShCrm_qysbdj.jsp");
