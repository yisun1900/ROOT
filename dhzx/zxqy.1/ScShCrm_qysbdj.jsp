...
<form method="post" action="SaveScShCrm_qysbdj.jsp" name="selectform">
...
%>		</td>
      ...
      <tr bgcolor="#FFFFFF">
        <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">*</span>市场部审核结论</td>
        <td><%
...
%>
      ...
      <tr bgcolor="#FFFFFF">
        <td align="right"><span class="STYLE1">*</span><span class="STYLE2">市场部审核人</span></td>
        <td><input type="text" name="scbshr" value="<%=yhmc%>" size="20" maxlength="10" readonly>        </td>
        <td align="right"><span class="STYLE2"><span class="STYLE1">*</span>市场部审核时间</span></td>
        <td><input type="text" name="scbshsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly>        </td>
      </tr>
      <tr bgcolor="#FFFFFF" >
        <td align="right" ><span class="STYLE1">*</span>市场部审核意见</td>
        <td colspan="3" ><textarea name="scbshyj" cols="73" rows="3"></textarea></td>
      </tr>
      <tr bgcolor="#FFFFFF" > 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.scbshsj, "审核时间"))) {
		return false;
	}
