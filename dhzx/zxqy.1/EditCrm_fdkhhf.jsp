...
try {
	...
	ls_sql="select khbh,hfr,hfsj,hfsbyybm,hfsbkhlx,hfsbyyxs,hfsbsj,lx,hfwhkh ";
...
%>
      ...
      <tr bgcolor="#FFFFFF">
        <td align="right">飞单时间</td>
        <td><input type="text" name="hfsbsj" value="<%=hfsbsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
        <td align="right">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr bgcolor="#FFFFFF">
