...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','设计师提交','2','设计部审核','3','市场部审核','4','接待主管审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_qysbdj.zgshjl,'Y','通过','N','未通过'),crm_qysbdj.zgshr,crm_qysbdj.zgshsj,crm_qysbdj.zgshyj,sbyymc,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,b.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_qysbdj.clzt='4'";//1：设计师提交、2：设计部审核、3：市场部审核、4：接待主管审核、5：回访
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjXgZgShList.jsp","","","XgZgShCrm_qysbdj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteZgShCrm_qysbdj.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">接待主管审核－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">姓名</td>
	<td  width="10%">房屋地址</td>
	<td  width="3%">接待主管审核结论</td>
	<td  width="3%">接待主管审核人</td>
	<td  width="4%">接待主管审核时间</td>
	<td  width="13%">接待主管审核意见</td>
	<td  width="7%">失败原因</td>
