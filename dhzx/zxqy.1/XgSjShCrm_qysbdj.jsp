...
String sjbshsj=null;
String sjbshyj=null;
String sjbsbyybm=null;
String sjbsbkhlx=null;
...
try {
	...
	ls_sql+=" ,sjbshjl,sjbshr,sjbshsj,sjbshyj,sjbsbyybm,sjbsbkhlx";
	...
	if (rs.next())
	{
		...
		sjbsbyybm=cf.fillNull(rs.getString("sjbsbyybm"));
		sjbsbkhlx=cf.fillNull(rs.getString("sjbsbkhlx"));
	}
	rs.close();
	ps.close();
...
<form method="post" action="SaveXgSjShCrm_qysbdj.jsp" name="selectform">
...
%></td>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td>
<%
	cf.radioToken(out, "sjbshjl","Y+通过&N+未通过",sjbshjl);
%>		</td>
        <td align="right">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr bgcolor="#FFFFFF">
        ...
        <td><select name="sjbsbyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
            <option value=""></option>
            <%
			cf.selectItem(out,"select sbyybm,sbyymc from dm_sbyybm order by sbyybm",sjbsbyybm);
			%>
          </select>
        </td>
        ...
        <td><select name="sjbsbkhlx" style="FONT-SIZE:12PX;WIDTH:152PX" >
            <option value=""></option>
            <%
	cf.selectItem(out,"select sbkhlx c1,sbkhlx c2 from crm_sbkhlx where ssfgs='"+ssfgs+"' order by xh",sjbsbkhlx);
%>
        </select></td>
      </tr>
      <tr bgcolor="#FFFFFF">
      ...
      <tr bgcolor="#FFFFFF" >
        ...
        <td colspan="3" ><textarea name="sjbshyj" cols="73" rows="3"><%=sjbshyj%></textarea></td>
      </tr>
      <tr bgcolor="#FFFFFF" > 
