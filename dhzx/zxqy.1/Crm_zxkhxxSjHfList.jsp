...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khxm,crm_zxkhxx.fwdz,sbyymc,sbsj,sbkhlx,sbyyxs,sjs,khjl,ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,dwmc,crm_zxkhxx.khbh ";
	...
	ls_sql+=" and crm_zxkhxx.zxzt in('2','4')";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxSjHfList.jsp","","SbSjHf.jsp","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="8%">失败原因</td>
	<td  width="6%">失败时间</td>
	<td  width="8%">失败客户流向</td>
	<td  width="24%">失败原因详述</td>
	<td  width="4%">设计师</td>
	<td  width="4%">客户经理</td>
	<td  width="4%">业务员</td>
	<td  width="7%">咨询状态</td>
