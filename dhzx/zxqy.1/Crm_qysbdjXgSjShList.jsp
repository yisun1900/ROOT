...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','设计师提交','2','设计部审核','3','市场部审核','4','接待主管审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_qysbdj.sjbshjl,'Y','通过','N','未通过'),b.sbyymc,sjbsbkhlx,crm_qysbdj.sjbshr,crm_qysbdj.sjbshsj,crm_qysbdj.sjbshyj,a.sbyymc sjsyy,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,c.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_qysbdj.clzt='2'";//1：设计师提交、2：设计部审核、3：市场部审核、4：接待主管审核、5：回访
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjXgSjShList.jsp","","","XgSjShCrm_qysbdj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSjShCrm_qysbdj.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">姓名</td>
	<td  width="10%">房屋地址</td>
	<td  width="3%">设计部审核结论</td>
	<td  width="5%">设计部审核失败原因</td>
	<td  width="5%">设计部审核失败客户流向</td>
	<td  width="3%">设计部审核人</td>
	<td  width="4%">设计部审核时间</td>
	<td  width="13%">设计部审核意见</td>
	<td  width="5%">失败原因</td>
	<td  width="5%">失败客户流向</td>
	<td  width="16%">飞单原因详述</td>
	<td  width="3%">设计师</td>
	<td  width="5%">咨询店面</td>
	<td  width="3%">业务员</td>
	<td  width="4%">登记时间</td>
