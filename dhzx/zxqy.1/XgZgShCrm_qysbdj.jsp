...
String zgshsj=null;
String zgshyj=null;
String jdzgsbyybm=null;
String jdzgsbkhlx=null;
...
try {
	...
	ls_sql+=" ,zgshjl,zgshr,zgshsj,zgshyj,jdzgsbyybm,jdzgsbkhlx";
	...
	if (rs.next())
	{
		...
		jdzgsbyybm=cf.fillNull(rs.getString("jdzgsbyybm"));
		jdzgsbkhlx=cf.fillNull(rs.getString("jdzgsbkhlx"));
	}
	rs.close();
	ps.close();
...
<div align="center">接待主管审核－修改</div>
...
<form method="post" action="SaveXgZgShCrm_qysbdj.jsp" name="selectform">
...
%>        </td>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td><%
	cf.radioToken(out, "zgshjl","Y+通过&N+未通过",zgshjl);
%>        </td>
        <td align="right">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr bgcolor="#FFFFFF">
        ...
        <td><select name="jdzgsbyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
            <option value=""></option>
            <%
			cf.selectItem(out,"select sbyybm,sbyymc from dm_sbyybm order by sbyybm",jdzgsbyybm);
			%>
          </select>        </td>
        ...
        <td><select name="jdzgsbkhlx" style="FONT-SIZE:12PX;WIDTH:152PX" >
            <option value=""></option>
            <%
	cf.selectItem(out,"select sbkhlx c1,sbkhlx c2 from crm_sbkhlx where ssfgs='"+ssfgs+"' order by xh",jdzgsbkhlx);
%>
        </select></td>
      </tr>
      <tr bgcolor="#FFFFFF">
      ...
      <tr bgcolor="#FFFFFF" >
        ...
        <td colspan="3" ><textarea name="zgshyj" cols="73" rows="3"><%=zgshyj%></textarea></td>
      </tr>
      <tr bgcolor="#FFFFFF" > 
