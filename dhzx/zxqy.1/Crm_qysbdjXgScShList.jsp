...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_qysbdj.khbh,DECODE(crm_qysbdj.clzt,'1','设计师提交','2','设计部审核','3','市场部审核','4','接待主管审核','5','回访'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_qysbdj.scbshjl,'Y','通过','N','未通过'),crm_qysbdj.scbshr,crm_qysbdj.scbshsj,crm_qysbdj.scbshyj,sbyymc,crm_qysbdj.sbkhlx,crm_qysbdj.sbyyxs,crm_zxkhxx.sjs,b.dwmc,ywy,crm_qysbdj.lrsj,crm_qysbdj.lrr";
	...
	ls_sql+=" and crm_qysbdj.clzt='3'";//1：设计师提交、2：设计部审核、3：市场部审核、4：接待主管审核、5：回访
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_qysbdjXgScShList.jsp","","","XgScShCrm_qysbdj.jsp");
