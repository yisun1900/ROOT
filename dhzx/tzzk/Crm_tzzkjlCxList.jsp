...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_tzzkjl.tzjlh, DECODE(crm_tzzkjl.clzt,'1','未完成','2','直接修改折扣成功','3','需审批','4','审批通过已改折扣','5','审批未通过'),crm_tzzkjl.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs, DECODE(crm_tzzkjl.zklx,'1','整单打折','2','单项打折','3','部分费用打折'),crm_tzzkjl.zdzk,crm_tzzkjl.gcfqdzk,crm_tzzkjl.glfzk,crm_tzzkjl.sjzk,crm_tzzkjl.sjfzk,crm_tzzkjl.qtsfxmzk, DECODE(crm_tzzkjl.zjxzklx,'1','同合同','2','独立折扣'), DECODE(crm_tzzkjl.bfxmdldz,'Y','是','N','否'),crm_tzzkjl.hdzsjz,crm_tzzkjl.djjbfb,crm_tzzkjl.djjje,crm_tzzkjl.spsj,crm_tzzkjl.tzyy,crm_tzzkjl.spr,crm_tzzkjl.spsm,crm_tzzkjl.tzhmll||'%',crm_tzzkjl.rfmll||'%',crm_tzzkjl.zcmll||'%',crm_tzzkjl.lrr,crm_tzzkjl.lrsj,dwmc  ";
...
//设置主键
	...
	coluParm.link="/dhzx/ckml/InsertCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">税金折扣</td>
	<td  width="2%">设计费折扣</td>
	<td  width="2%">其它收费项目折扣</td>

	<td  width="2%">增减项折扣类型</td>
	<td  width="2%">部分项目独立打折</td>
	<td  width="3%">赠送净值</td>
	<td  width="2%">代金券百分比</td>
	<td  width="3%">代金券金额</td>
	<td  width="3%">审批时间</td>
	<td  width="16%">调整原因</td>
	<td  width="2%">审批人</td>
	<td  width="16%">审批说明</td>
	<td  width="2%">调整后毛利率</td>
	<td  width="2%">人辅毛利率</td>
	<td  width="2%">主材毛利率</td>
	<td  width="2%">录入人</td>
	<td  width="3%">录入时间</td>
