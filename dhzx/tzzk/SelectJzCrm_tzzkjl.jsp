...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tzzkjlJzList.jsp" name="selectform">
<div align="center">调整折扣（精装报价）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    ...
    <option value=""></option>
<%
	cf.selectToken(out,"1+未完成&2+直接修改折扣成功&3+需审批&4+审批通过已改折扣&5+审批未通过","");
%>
    </select>  </td>
