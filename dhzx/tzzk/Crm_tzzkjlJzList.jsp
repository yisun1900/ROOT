...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" FROM crm_tzzkjl,crm_zxkhxx,sq_dwxx,bdm_bjjbbm  ";
    ls_sql+=" where crm_tzzkjl.khbh=crm_zxkhxx.khbh and crm_tzzkjl.lrbm=sq_dwxx.dwbh";
    ls_sql+=" and crm_tzzkjl.clzt in('1','3')";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tzzkjlJzList.jsp","","","EditCrm_tzzkjlMain.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_tzzkjl.jsp?"};//按钮单击调用的网页，可以增加参数
