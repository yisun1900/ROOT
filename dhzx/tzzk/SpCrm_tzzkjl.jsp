...
try {
	...
	if (rs.next())
	{
		...
		rfmll=rs.getDouble("rfmll");
		zcmll=rs.getDouble("zcmll");
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="spsm" cols="71" rows="2"><%=spsm%></textarea></td>
	...
	<div align="center">
	  ...
	  <input name="button3" type="button" onClick="window.open('/dhzx/sjszxone/ylbj.jsp?khbh=<%=khbh%>')"  value="查看报价">
