...
<form method="post" action="Sq_bzxxCxList.jsp" name="selectform">
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td colspan="3">
				<INPUT type="radio" name="tdbz" value="N">正常
				<INPUT type="radio" name="tdbz" value="Y">停单
				<INPUT type="radio" name="tdbz" value="K">开除
				<INPUT type="radio" name="tdbz" value="L">离职			  </td>
            </tr>
            <tr bgcolor="#FFFFFF">
