...
<div align="center">
  ...
  <table width="170%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
	...
	<tr bgcolor="#CCCCCC" align="center"> 
      ...
      <td width="4%"><font color="#CC0000">*</font>班长名称</td>
	...
	for (int i=1;i<outStr.length ;i++ )
	{
		...
		{
			out.println("！！！班长["+bzmc+"]错误，[性别]只能为【男/女】，目前为["+lx+"]");
			return;
		}
		...
		if (!lx.equals("否") && !lx.equals("是"))
		{
			out.println("！！！班长["+bzmc+"]错误，[是否签劳动合同]只能为【是/否】，目前为["+lx+"]");
			return;
		}
