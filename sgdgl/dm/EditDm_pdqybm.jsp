...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditDm_pdqybm.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span><span class="STYLE2">派单区域编码</span></td> 
  <td width="32%"> 
    <input type="text" name="pdqybm" size="20" maxlength="4"  value="<%=pdqybm%>" readonly>  </td>
