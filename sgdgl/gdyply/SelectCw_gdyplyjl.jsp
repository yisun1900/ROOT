...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_gdyplyjlList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <INPUT name="cw_gdyplyjl_jsbz" type="radio" value="0" checked>
    未结算</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <INPUT name="cw_gdyplyjl_scbz" type="radio" value="N" checked>
    未删除</td>
