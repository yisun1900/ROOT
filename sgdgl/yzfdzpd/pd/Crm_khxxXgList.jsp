...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and crm_khxx.pdclzt in('5','6')";//1：申请派单；2：人工派单；5：电子派单；6：特权派单；7：拒单；8：换施工队；4：不许修改派单
	ls_sql+=" and pd_pdjl.hfjl='0'";
	ls_sql+=" and crm_khxx.pdbbh='1'";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_khxx.pdsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgList.jsp","SelectXgCrm_khxx.jsp","","");
...
<CENTER >
  <B><font size="3">删除派单信息（注意：已完结不能再修改）</font></B>
</CENTER>
<%
	pageObj.out=out;
