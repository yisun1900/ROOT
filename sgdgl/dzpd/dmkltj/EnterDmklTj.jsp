  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">店面客流统计</div>
      </td>
    
   
    <tr> 
      <td align="right" width="42%" height="39">咨询时间 从</td>
      <td width="58%" height="39"> 
        <input type="text" name="sjfw" size="20" maxlength="10" value="<%=cf.firstDayDate()%>">
      </td>
    </tr>
    <tr> 
