...
<%
	...
	ls_sql="SELECT a.sgdmc";
	ls_sql+=" ,(select count(*) from crm_khxx c where c.sgd=d.sgd and c.zt='2' and c.wgbz='N' ) zsl";
	ls_sql+=" ,(select sum(qye) from crm_khxx c where c.sgd=d.sgd and c.zt='2' and c.wgbz='N' ) zje";
	ls_sql+=" ,sgbz,khbh,cqmc,fwdz,qye,TO_CHAR(pmjj),sjs,zjxm,gcjdmc,sjkgrq,sjzkrq";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by zje,a.sgdmc,sgbz";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
