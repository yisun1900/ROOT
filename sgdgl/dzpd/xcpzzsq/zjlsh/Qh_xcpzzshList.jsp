...
<%
	...
	if(shqk.equals("N"))
	{
	wheresql+=" and (trim(qh_xcpzzsh.zjlyj) is  null)";//未审核
	
	}
	else
	{
	wheresql+=" and (trim(qh_xcpzzsh.zjlyj) is not null)";//已审核
	
	}
	ls_sql="SELECT qh_xcpzzsh.shbbh as shbbh,qh_xcpzzsh.sqsj as qh_xcpzzsh_sqsj,qh_xcpzzsh.tbr as qh_xcpzzsh_tbr,qh_xcpzzsh.scwjm,qh_xcpzzsh.zznr as qh_xcpzzsh_zznr,qh_xcpzzsh.sl as qh_xcpzzsh_sl,qh_xcpzzsh.gg as qh_xcpzzsh_gg,qh_xcpzzsh.xs as qh_xcpzzsh_xs,qh_xcpzzsh.wznr as qh_xcpzzsh_wznr,qh_xcpzzsh.ysyq as qh_xcpzzsh_ysyq,qh_xcpzzsh.qtyq as qh_xcpzzsh_qtyq,qh_xcpzzsh.wcsj as qh_xcpzzsh_wcsj,qh_xcpzzsh.bz as qh_xcpzzsh_bz,sq_dwxx.dwmc as sq_dwxx_dwmc,qh_xcpzzsh.zgbmjlyj as qh_xcpzzsh_zgbmjlyj  ";
	ls_sql+=" FROM qh_xcpzzsh,sq_dwxx  ";
    ls_sql+=" where qh_xcpzzsh.dwbh=sq_dwxx.dwbh(+) and sq_dwxx.ssdw='"+ssfgs+"' ";
    ls_sql+=wheresql;
	//out.print(ssfgs);
    pageObj.sql=ls_sql;
//进行对象初始化
if(shqk.equals("N"))//如果已审核，则调不出审核页面
{
