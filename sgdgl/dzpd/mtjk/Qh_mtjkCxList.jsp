...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT qh_mtjk.jkbbh as jkbbh,qh_bjkgsdm.bjkgsmc as qh_bjkgsdm_bjkgsmc,dm_xxlybm.xxlymc,qh_mtjk.bcsj as qh_mtjk_bcsj,qh_mtjk.gggs as qh_mtjk_gggs,qh_mtjk.yjjg as qh_mtjk_yjjg,sq_dwxx.dwmc as sq_dwxx_dwmc ,qh_mtjk.bz as qh_mtjk_bz ";
