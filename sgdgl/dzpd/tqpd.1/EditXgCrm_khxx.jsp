...
%> 
            ...
            <tr bgcolor="#FFCCCC"> 
              <td width="19%" align="right"><b>是否关系单</b></td>
...
%> 
            ...
            <tr> 
              ...
              <td width="31%" bgcolor="#FFFFCC"> 
                <input type="text" name="pdr" size="24" maxlength="20"  value="<%=yhdlm%>" readonly>
              </td>
              <td width="18%" bgcolor="#FFFFCC"> 
	...
	if (deflmc.equals("大单"))
	{
		sql="select sq_sgd.sgd,sgdmc||'（队号：'||sq_sgd.duihao||'）（排名：'||kp_sgdkpjg.bqpm||'）（可接单：'||(kjdds-yjdds)||'大'||(kjzds-yjzds)||'中'||(kjxds-yjxds)||'小）（'||sq_sgd.sgd||'）'";
		sql+=" from sq_sgd,kp_sgdkpjg";
		sql+=" where ssfgs='"+ssfgs+"' and cxbz='N'";
		sql+=" and sq_sgd.sgd=kp_sgdkpjg.sgd(+) and kp_sgdkpjg.kpjlh="+kpjlh;
		sql+="  order by kp_sgdkpjg.bqpm";
	}
	else if (deflmc.equals("中单"))
	{
		sql="select sq_sgd.sgd,sgdmc||'（队号：'||sq_sgd.duihao||'）（排名：'||kp_sgdkpjg.bqpm||'）（可接单：'||(kjdds-yjdds)||'大'||(kjzds-yjzds)||'中'||(kjxds-yjxds)||'小）（'||sq_sgd.sgd||'）'";
		sql+=" from sq_sgd,kp_sgdkpjg";
		sql+=" where ssfgs='"+ssfgs+"' and cxbz='N'";
...
%> 
                ...
                <input type="button"  value="打印开工证" onClick="window.open('/gcgl/kgzgl/EditCrm_khxx.jsp?khbh=<%=wherekhbh%>')" name="button2">
              </td>
            </tr>
          </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgEditCrm_khxx.jsp";
//	FormName.target="";
	FormName.submit();
	return true;
}
