...
%> 
            ...
            <tr> 
              ...
              <td colspan="3" bgcolor="#FFFFCC"> 
                <select name="sgd" style="FONT-SIZE:12PX;WIDTH:550PX" onChange="selectItem(sgd,sgbz,<%=str1%>)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select sgd,sgdmc||'（'||sgd||'）' from sq_sgd where ssfgs='"+ssfgs+"' and cxbz='N' order by sgdmc",sgd);
%> 
                </select>
              </td>
            </tr>
