...
try {
	...
	ls_sql="select khxm,hth,lxfs,qye,dwmc,kgrq,jgrq,zkl,yhyy,fwdz,zjxm,sjs,czbm,ysbm,sgd,qyrq,hxbm,jyjdrq,csrq,zybm,fj,fwmj";
...
<div align="center">
  <table width="100%"  border="0">
    <tr>
      <td width="15%">&nbsp;</td>
      <td width="15%" class="style2"><%=zgsmc%></td>
      <td width="40%"><div align="center" class="style1">派 工 单</div></td>
      <td width="15%">&nbsp;</td>
      <td width="15%"><span class="style4">编号：GC-7.5-01</span></td>
    </tr>
    <tr>
      <td colspan="5"><hr align="center" width="100%" size="1" noshade></td>
    </tr>
  </table>
  <table width="100%"  border="0" cellspacing="5">
    <tr>
      <td width="86%"><div align="justify" class="style2">序号： <%=sq_dwxx_dwmc%></div></td>
  ...
  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#000000" class="table" style="FONT-SIZE:14">
    ...
    <tr class="style4">
      ...
      <td width="25%"><div align="left"><%=crm_khxx_qye%> </div></td>
  ...
  <div align="center">
    <table width="100%"  border="0">
      <tr>
        ...
        <td width="40%"><div align="center" class="style1">派 工 单</div></td>
        <td width="15%">&nbsp;</td>
        <td width="15%" class="style4">编号：GC-7.5-01</td>
      </tr>
    </table>
    <table width="100%"  border="0" cellspacing="5">
      <tr>
...
%>
  ...
  <table width="100%"  border="0" cellpadding="5" cellspacing="0" bordercolor="#000000">
    <tr>
      <td width="10%" class="style4"><div align="center">班 &nbsp;&nbsp;&nbsp;长</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">电 &nbsp;&nbsp;&nbsp;话</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center"></div></td>
      <td width="26%">&nbsp;</td>
    </tr>
    <tr>
      <td width="10%" class="style4"><div align="center">油 &nbsp;&nbsp;&nbsp;工</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">木 &nbsp;&nbsp;&nbsp;工</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">水 &nbsp;&nbsp;&nbsp;电</div></td>
      <td width="26%">&nbsp;</td>
    </tr>
    <tr>
      <td width="10%" class="style4"><div align="center">瓦 &nbsp;&nbsp;&nbsp;工</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">展 &nbsp;&nbsp;&nbsp;架</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">工 &nbsp;&nbsp;&nbsp;服</div></td>
      <td width="26%">&nbsp;</td>
    </tr>
    <tr>
      <td width="10%" class="style4"><div align="center">窗 &nbsp;&nbsp;&nbsp;帖</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center">门 &nbsp;&nbsp;&nbsp;帖</div></td>
      <td width="22%">&nbsp;</td>
      <td width="10%" class="style4"><div align="center"></div></td>
      <td width="26%">&nbsp;</td>
    </tr>
