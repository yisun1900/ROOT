...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,khxm,fwdz,sjs,sq_dwxx.dwmc,DECODE(pd_pdjl.hfjl,'0','接受','3','拒单','5','换施工队') hfjl,DECODE(pd_pdjl.kppdbz,'1','非考评派单','2','考评派单') kppdbz,TO_CHAR(pd_pdjl.xuhao) xuhao";
	ls_sql+=" ,pd_pdjl.jrpde,pd_pdjl.kcpde,DECODE(pd_pdjl.kczbbl,'0','不扣指标','1','扣除单倍派单额','2','扣除2倍派单额','3','扣除3倍派单额') kczbbl";
	ls_sql+=" ,pd_pdjl.jjyy,pd_pdjl.hfr,pd_pdjl.hfsj,pd_pdjl.kpjlh";
...
//设置显示列
	String[] disColName={"khbh","hth","khxm","pdclzt","kgsjqd","sgdmc","sgbz","zjxm","jlbz","shzzb","sgdyxj","hfjl","pdsj","pdr","pdsm","kczbbl","jjyy","hfr","hfsj","kppdbz","jyjdrq","hdbz","fwdz","sjs","dwmc","xuhao"};
...
//设置列超级连接
	...
	coluParm.link="/pdgl/pd/DyPdCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
