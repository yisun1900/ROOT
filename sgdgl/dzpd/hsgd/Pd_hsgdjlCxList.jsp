...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,a.sgdmc newsgd,b.sgdmc oldsgd,pd_hsgdjl.newsgbz,pd_hsgdjl.oldsgbz,pd_hsgdjl.oldkzbbfb||'%' oldkzbbfb,pd_hsgdjl.newkzbbfb||'%' newkzbbfb,crm_khxx.zjxm";
	...
	ls_sql+=" and pd_hsgdjl.khbh=crm_khxx.khbh(+) ";
	ls_sql+=wheresql;
    ls_sql+=" order by pd_hsgdjl.xuhao desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Pd_hsgdjlCxList.jsp","SelectCxPd_hsgdjl.jsp","","");
	pageObj.setPageRow(15);//设置每页显示记录数

//设置显示列
	String[] disColName={"hth","khxm","pdclzt","oldsgd","oldsgbz","newsgd","newsgbz","oldkzbbfb","newkzbbfb","zjxm","jlbz","lrsj","lrr","hsgdyy","kgsjqd","jyjdrq","hdbz","fwdz","sjs","sqdm"};
