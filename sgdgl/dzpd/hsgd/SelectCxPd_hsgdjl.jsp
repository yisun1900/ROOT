...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">查询--换施工队记录</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Pd_hsgdjlCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">换施工队时间 从</td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">新施工队</td>
              <td width="31%">
                <select name="newsgd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
...
%> 
              ...
              <td width="17%" align="right">原施工队</td>
              <td width="33%">
...
{
	if(!(isDatetime(FormName.lrsj, "签约日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.lrsj2, "签约日期"))) {
		return false;
	}
