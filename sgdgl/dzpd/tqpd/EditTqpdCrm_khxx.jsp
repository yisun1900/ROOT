...
%></font></td>
            ...
            <tr>
              ...
              <td width="36%" bgcolor="#FFFFCC">
				...
				<OPTION VALUE=""></OPTION>
                  <%
	cf.selectToken(out,"1+回单奖励&2+公司奖励&3+设计师指定派单&4+客户指定派单&7+特殊情况&9+同小区派单",jlbz);
%> 
                </select>
              </td>
...
%></td>
            ...
            <tr> 
              ...
              <td colspan="3" bgcolor="#FFFFCC"> 
                <select name="sgd" style="FONT-SIZE:12PX;WIDTH:680PX" onChange="changeSgd(editform)" >
                  <option value=""></option>
                  <%=hxsgdstr%> 
                </select>
              </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	!radioChecked(FormName.shzzb)) {
		alert("请选择[是否占派单指标]！");
		FormName.shzzb[0].focus();
		return false;
	}

	if (FormName.jlbz.value=="3" || FormName.jlbz.value=="4" || FormName.jlbz.value=="9")
	{
		if(FormName.shzzb[1].checked) {
			alert("『设计师指定派单』、『客户指定派单』、『同小区派单』必须选择『占指标』！");
			FormName.shzzb[0].focus();
			return false;
		}
	}
