...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" where qh_qhfyzlb.fyzldm=qh_fyb.zl and qh_fyb.dwbh=sq_dwxx.dwbh and qh_fyb.xxlybm=dm_xxlybm.xxlybm  ";
    ls_sql+=wheresql;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Qh_fybCxList.jsp","SelectCxQh_fyb.jsp","ViewQh_fyb.jsp","");
