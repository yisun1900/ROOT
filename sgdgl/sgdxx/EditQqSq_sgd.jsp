...
try {
	...
	ls_sql="select grs,rzsj,lzsj,jjlxrdz,kjdsm,sfqldht,jcf,zbj,bzj,tdbz,tdkssj,tdzzsj,bzs,duihao,sgdjbbm,hjszd,sgd,sgdmc,sgdlx,dz,dh,cz,email,bz,dqbm,cxbz,ssfgs,jjlxr,lxrdh,sfzhm";
	ls_sql+=" from  sq_sgd";
          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr> 
              <td width="19%" align="right" bgcolor="#CCCCFF"> 
                <font color="#FF0000">*</font>工长编号              </td>
              <td width="31%" bgcolor="#CCCCFF"> 
                <input type="text" name="sgd" size="20" maxlength="5"  value="<%=sgd%>" >              </td>
              <td width="20%" align="right" bgcolor="#CCCCFF"> 
                <font color="#FF0000">*</font>工长名称              </td>
...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td align="right"><font color="#0000CC">保证金</font></td>
              <td><input name="bzj" type="text" id="bzj"  value="<%=bzj%>" size="20" maxlength="10" readonly></td>
            </tr>
            <tr bgcolor="#CCCCFF">
...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="tdkssj" size="20" maxlength="10"  value="<%=tdkssj%>" onDblClick="JSCalendar(this)">              </td>
              <td width="20%" align="right">停单终止时间</td>
              <td width="30%"> 
                <input type="text" name="tdzzsj" size="20" maxlength="10"  value="<%=tdzzsj%>" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#CCCCFF">
...
%></td>
            ...
            <tr> 
              <td colspan="4" align="center" > 
                  ...
                  <input type="hidden" name="kpjlh"  value="<%=kpjlh%>" >              </td>
            </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditQqSq_sgd.jsp";
	FormName.submit();
	return true;
}
