...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dwmc,sq_sgd.sgdmc,sq_grxxb.bzmc,sq_grxxb.lx,sq_grxxb.xm,sq_grxxb.dj,decode(sq_grxxb.sfqdlwpqht,'Y','是','N','否') sfqdlwpqht,sq_grxxb.yhk,sq_grxxb.xb,sq_grxxb.jg,sq_grxxb.csrq,sq_grxxb.gz,sq_grxxb.rzsj,sq_grxxb.lzsj,sq_grxxb.sgzbh,sq_grxxb.sfzh,sq_grxxb.zz,sq_grxxb.dh,sq_grxxb.jjlxr,sq_grxxb.jjlxrdh,sq_grxxb.jjlxrdz,sq_grxxb.pxsm,NVL2(zp,'<img src=\"/yblimg/grxx/'||zp||'\" width=\"100\">','')  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Sq_grxxbCxList.jsp","","","");
