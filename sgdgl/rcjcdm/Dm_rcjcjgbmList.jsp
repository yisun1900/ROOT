...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Dm_rcjcjgbmList.jsp","","","EditDm_rcjcjgbm.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Dm_rcjcjgbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
{
	String[] rcjcjgbm = request.getParameterValues("rcjcjgbm");
	String chooseitem =cf.GB2Uni(cf.arrayToInSQL(rcjcjgbm,"rcjcjgbm"));
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		String[] sql=new String[1];//要执行的SQL
		boolean needCommit=false;//不需要事务处理
		sql[0]="delete from dm_rcjcjgbm where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="12%">&nbsp;</td>
	<td  width="44%">日常检查结果编码</td>
	<td  width="44%">日常检查结果名称</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
