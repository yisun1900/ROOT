...
if (count>0)
{
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,sgdmc,fkze,kfzs,kp_xjgdjl.kcjdebl||'%',xjlxmc,xjjgmc,xjwtflmc,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,DECODE(kp_xjgdjl.cfspbz,'1','不需审批','2','未审批','3','审批通过','4','审批未通过')";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">法规质检处罚（记录号：<%=xjjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="批量录入" onClick="window.open('PlInsertKp_xjgdmx.jsp?xjjlh=<%=xjjlh%>')" name="pllr" disabled>
                <input type="button"  value="单项录入" onClick="window.open('yrk_lrxxmain.jsp?xjjlh=<%=xjjlh%>')" name="lr" disabled=true >
                <input type="button"  value="查看检查项目" onClick="window.open('Kp_xjgdmxList.jsp?xjjlh=<%=xjjlh%>')" name="cx" disabled=true>
