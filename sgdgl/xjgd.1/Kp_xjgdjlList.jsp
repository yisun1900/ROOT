...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,sgdmc,fkze,kfzs,jlje,kp_xjgdjl.kcjdebl||'%',crm_khxx.hth,crm_khxx.khxm,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,xjlxmc,xjjgmc,DECODE(kp_xjgdjl.cfspbz,'1','不需审批','2','未审批','3','审批通过','4','审批未通过'),kp_xjgdjl.bz,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.zjxm  ";
    ...
    ls_sql+=" and kp_xjgdjl.cfspbz in('1','2')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlList.jsp","SelectKp_xjgdjl.jsp","","EditKp_xjgdjl.jsp");
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[2]="delete from kp_xjgdjl where "+chooseitem;
...
<CENTER >
  <B><font size="3">施工队检查记录--维护</font></B>
</CENTER>
<%
	pageObj.out=out;
