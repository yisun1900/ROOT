...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队检查管理--处罚审批</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Kp_xjgdjlSpList.jsp" name="selectform">
...
%> 
              ...
              <td width="16%" align="right"> 检查结果</td>
              <td width="34%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td width="17%" align="right">审批标志</td>
              <td width="33%"> 
                <select name="cfspbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value="2">未审批</option>
                </select>
              </td>
              <td width="16%" align="right">罚款金额大于</td>
              <td width="34%"> 
                <input name="fkze" type="text" value="" size="20" maxlength="20" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
