...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,DECODE(kp_xjgdjl.cfspbz,'1','不需审批','2','未审批','3','审批通过','4','审批未通过'),sgdmc,fkze,kfzs,kp_xjgdjl.kcjdebl||'%',crm_khxx.hth,crm_khxx.khxm,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,xjlxmc,xjjgmc,kp_xjgdjl.bz,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.zjxm  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlSpList.jsp","SelectSpKp_xjgdjl.jsp","","SpKp_xjgdjl.jsp");
