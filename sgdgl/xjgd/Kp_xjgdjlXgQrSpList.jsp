...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and kp_xjgdjl.cfspbz in('5')";//1：无处罚；2：未审批；3：审批通过；4：审批未通过
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlQrSpList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQr.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">施工队处罚确认--修改</font></B>
</CENTER>
<%
	pageObj.out=out;
