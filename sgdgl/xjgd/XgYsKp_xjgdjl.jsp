...
try {
	...
	if(!"zgcljlh".equals(maxZgcljlh)){
		out.println("只能修改最近处理记录！"+maxZgcljlh);
		return;
	}
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队检查--问题验收（检查记录号：<%=xjjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">处理照片</td>
              <td ><img src="images/<%=clzp%>" alt="" width="140px" height="50px" onClick="javascript:document.getElementById('bigCl').style.display='block';"></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td><div align="right">处理人</div></td>
              <td><%=clr%></td>
              <td><div align="right">处理时间</div></td>
              <td><%=clsj%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">验收照片</td>
              <td ><img src="images/<%=yszp%>" alt="" width="140px" height="50px" onClick="javascript:document.getElementById('bigYs').style.display='block';"></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
			...
			<tr bgcolor="#FFFFFF"> 
			  ...
			  if("".equals(ysr)){
			  %>
                <input type="text" name="ysr" size="20" maxlength="20"  value="<%=yhmc%>" >
                <%
			  }else{
				%>
			  ...
			  if("".equals(yssj)){
			  %>
                <input type="text" name="yssj" size="20" maxlength="20"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)">
                <%
			  }else{
				%>
               <input type="text" name="yssj" size="20" maxlength="20"  value="<%=yssj%>" onDblClick="JSCalendar(this)"> 
                <%
			  }
				%>
              </td>
			...
			<tr bgcolor="#FFFFFF">
			  ...
			  <td ><%
	cf.radioToken(out, "ysjg","Y+合格&N+整改",ysjg);
%></td>
              <td align="right">验收照片</td>
			  <td ><input type="file" name="yszp"></td>
		    </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right">验收说明</td>
              <td colspan="3"> 
                <textarea name="yssm" cols="71" rows="3"><%=yssm%></textarea>
              </td>
            </tr>
