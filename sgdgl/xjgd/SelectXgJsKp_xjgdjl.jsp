...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">整改问题－接收维护</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Kp_xjgdjlXgJsList.jsp" name="selectform">
...
%>
              ...
              <td><input type="text" name="sgdmc" size="20"  value="<%=sgd%>" maxlength="20" <% if (!sgd.equals("")) out.println("readonly");%>  ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%>
	...
	{
		%>
		  <input type="text" name="fkbmjsr" size="20" maxlength="20" >
		<%
	}
	else{
		if (yhjs.equals("A0"))
		{
			...
			%>
			  <input type="text" name="fkbmjsr" size="20" maxlength="20" value="<%=yhmc%>" readonly>
			<%
		}
	}
%>
