...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT xjzpmc,'<A HREF=\"/sgdgl/xjgd/ViewImage.jsp?zhaopian=/yblimg/xjgd/'||kp_xjgdjlzp.zpml||'/'||xjzpmc||'\" target=\"_blank\"><img src=\"/yblimg/xjgd/'||kp_xjgdjlzp.zpml||'/'||xjzpmc||'\" width=\"100\"></A>', DECODE(kkzpbz,'0','不可看','1','可看'), DECODE(zpshbz,'Y','合格','B','不合格','N','未审核','C','不合格重拍'),kp_xjgdjlzp.shr,kp_xjgdjlzp.shsj,kp_xjgdjlzp.shsm,kp_xjgdjlzp.xjjlh,kp_xjgdjl.lrsj, DECODE(kp_xjgdjlzp.lx,'1','整体照片','2','检查项目照片','3','整改项目照片','4','整改处理照片','5','整改验收照片'),zpgjz,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.zjxm,sgdmc,zpsm,khly,khlysj,crm_khxx.khbh ";
	...
	ls_sql+=" and (kp_xjgdjlzp.zpshbz='Y' or  kp_xjgdjlzp.zpshbz='B')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by kp_xjgdjlzp.shsj desc,kp_xjgdjlzp.xjjlh,kp_xjgdjlzp.xjzpmc";
    pageObj.sql=ls_sql;
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlzpXgShList.jsp","","","");
