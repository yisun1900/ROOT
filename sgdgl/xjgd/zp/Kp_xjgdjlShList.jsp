...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,DECODE(kp_xjgdjl.cfspbz,'1','不需审批','2','未审批','3','审批通过','4','审批未通过','5','审批确认'),DECODE(kp_xjgdjl.wtclbz,'B','无整改','N','整改未接收','C','在处理','Y','已解决'),DECODE(kp_xjgdjl.kpbz,'N','未考评','Y','已考评'),DECODE(kp_xjgdjl.jsbz,'N','未结算','Y','已结算'),kp_xjgdjl.zpsl,kp_xjgdjl.shzpsl,kp_xjgdjl.khkkzpsl,kp_xjgdjl.bhgzpsl,fkze,kfzs,jlje,kp_xjgdjl.kcjdebl||'%',sgdmc,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_khxx.zjxm,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,xjlxmc,xjjgmc,kp_xjgdjl.bz,kp_xjgdjl.spr,kp_xjgdjl.spsj,kp_xjgdjl.spyj,kp_xjgdjl.qrr,kp_xjgdjl.qrsj,kp_xjgdjl.qrsm,kp_xjgdjl.lrr,to_char(kp_xjgdjl.lrsj,'yyyy-mm-dd HH24:Mi:SS') lrsj,dwmc  ";
    ...
    ls_sql+=" and kp_xjgdjl.zpsl>0";
    ls_sql+=" and (kp_xjgdjl.shzpsl is null OR kp_xjgdjl.shzpsl<kp_xjgdjl.zpsl) ";
    ls_sql+=wheresql;
    ls_sql+=" order by kp_xjgdjl.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlShList.jsp","","","EditKp_xjgdjlzpAll.jsp");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">检查类型</td>
	<td  width="2%">检查结果</td>
	<td  width="9%">检查情况说明</td>

	<td  width="2%">奖罚审批人</td>
	<td  width="3%">奖罚审批时间</td>
	<td  width="7%">奖罚审批意见</td>
	<td  width="2%">处罚确认人</td>
	<td  width="3%">处罚确认时间</td>
	<td  width="7%">处罚确认说明</td>
