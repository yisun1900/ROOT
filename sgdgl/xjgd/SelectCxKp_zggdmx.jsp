...
<form method="post" action="Kp_zggdmxCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">整改反馈部门</td>
              <td><select name="fkbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                <%
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where cxbz='N' order by ssfgs,dwbh","");
%>
              ...
              <td><input type="text" name="fkbmjsr" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">要求解决时间 从</td>
              <td><input type="text" name="yqjjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="yqjjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              ...
              <td align="right">处理状态</td>
              <td>
                <input type="radio" name="ystgbz" value="N">未结案
                <input type="radio" name="ystgbz" value="Y">整改已结案              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
