...
<form method="post" action="saveLoadPad.jsp" name="loadform" enctype="multipart/form-data">
    ...
    <table width="100%" border="0">
      ...
      <tr bgcolor="#999999"> 
        <td colspan="2" align="center"> 
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="button" onClick="window.open('viewPhoto.jsp?xjjlh=<%=xjjlh%>&lx=1')" value="查看上传文件" >
       </td>
      </tr>
    </table>
    <div id="list"></div>
