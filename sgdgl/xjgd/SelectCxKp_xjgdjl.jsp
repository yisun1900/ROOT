...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队检查记录--查询本部门数据</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="kp_xjgdjl_xjjlh" size="20" maxlength="10" >              </td>
              <td align="right">检查人</td>
              <td><input type="text" name="kp_xjgdjl_xjr" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">检查时间 从</td>
              <td><input type="text" name="kp_xjgdjl_xjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="kp_xjgdjl_xjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><select name="xjlxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%>
              ...
              <td><select name="xjjgbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="kp_xjgdjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="kp_xjgdjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%>
              ...
              <td><input type="text" name="kp_xjgdjl_lrr" size="20" maxlength="20" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right"><strong><font color="#0000FF">照片审核</font></strong></td>
              <td width="32%"><input type="radio" name="zpsh" value="Y" >合格
  <input type="radio" name="zpsh" value="N">不合格</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="jsjlh" size="20" maxlength="9" >              </td>
            </tr>
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Kp_xjgdjlCxList.jsp";
