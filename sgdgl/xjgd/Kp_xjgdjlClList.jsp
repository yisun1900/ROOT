...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and kp_zggdmx.clzt in ('2','3') ";//1:未接收；2：接收；3：在处理；4：已解决；5：验收通过；6：验收未通过
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_xjgdjlClList.jsp","","","ClKp_xjgdjl.jsp");
