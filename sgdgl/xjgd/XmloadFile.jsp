...
String zpgjz=cf.GB2Uni(cf.getParameter(request,"zpgjz"));
...
uploadUrl.append("/sgdgl/xjgd/SaveXmloadFile.jsp");
%>
...
SWFUpload.onload = function () 
{
	var settings = {
		...
		post_params: {
			...
			"lx" : "<%=lx%>",
			"zpml" : "<%=zpml%>",
			"zpgjz" : "<%=java.net.URLEncoder.encode(zpgjz,"UTF-8")%>",
...
<div id="content">
	<form id="form1" action="SaveZgloadFile.jsp" method="post" target="_blank" enctype="multipart/form-data">
