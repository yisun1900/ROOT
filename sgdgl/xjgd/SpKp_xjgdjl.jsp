...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队检查--处罚审批（检查记录号：<%=xjjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveSpKp_xjgdjl.jsp" name="editform" >
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><font color="#FF0000">*</font>审批结论</td>
              <td width="32%"> 
                <input type="radio" name="cfspbz" value="3">
                同意 
                <input type="radio" name="cfspbz" value="4">
              不同意 </td>
              <td width="18%">&nbsp;</td>
              <td width="32%">&nbsp;</td>
            </tr>
