...
if (yhjs.equals("A0") || yhjs.equals("A1") )
{
	...
	response.sendRedirect("InsertKp_pdkpjl.jsp?ssfgs="+ssfgs);
}
...
try {
	...
	if (yhjs.equals("G0"))
	{
		sql="select dwbh,dwmc from sq_dwxx where dwlx='F0' and dqbm='"+dqbm+"' order by dwbh";
...
{
	FormName.action="InsertKp_pdkpjl.jsp";
