...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_pdkpjlTzList.jsp","SelectTzKp_pdkpjl.jsp","","EditKp_pdkpmx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteKp_pdkpjl.jsp"};//按钮单击调用的网页，可以增加参数
