...
%></font></td>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFCC">
				<input type="button" onClick="changePdlx(editform,'1')"  value="选择同小区班长">
				<input type="button" onClick="changePdlx(editform,'2')"  value="选择同城区班长">
				<input type="button" onClick="changePdlx(editform,'3')"  value="正常派单"></td>
            </tr>
            <tr>
