...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 查看数据窗口信息
	  <input type="button"  value="继续" onClick="window.open('CopyEnterDwName.jsp?dw_name=<%=dw_name%>')">
	  </div>
    </td>
  </tr>
  <tr>
...
<form name="ref" method="post" action="CopyViewDW.jsp?dw_name=<%=dw_name%>&ref=0">
</form>
