...
else//第一次运行,需要查询
{
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by dw_name";
    pageObject.sql=ls_sql;
//进行对象初始化
	pageObject.initPage("Jdatawindow_noteCxList.jsp","SelectCxJdatawindow_note.jsp","ViewJdatawindow_note.jsp","");
...
<tr bgcolor="#CCCCCC"  align="center">
		...
		<td  width="26%" height="2">DataWindow说明</td>
