...
<table width="100%">
  <tr> 
    <td colspan="2"> 
      <div align="center"><b><font size="4">查看修改列</font></b></div>
    </td>
  </tr>
  <tr> 
...
%> 
            <tr align="center" bgcolor="#CCCCCC" > 
              <td colspan='11'> 
                ...
                <input type="button"  value="生成修改页面" onClick="makeEditPage(selectTableForm)" >
                <input type="button"  value="生成修改存盘页" onClick="makeEditSavePage(selectTableForm)" >
              </td>
            </tr>
          </table>
        </form>
...
<form name="ref" method="post" action="viewEditCol.jsp?dw_name=<%=dw_name%>&ref=0">
</form>
...
function makeEditPage(FormName)
{
	...
	FormName.action="makeEditPage.jsp";
	FormName.submit();
}
function makeEditSavePage(FormName)
{
	if(FormName.dw_name.value=="null") {
		alert("请选择数据窗口 ！");
		FormName.dw_name.focus();
	...
	FormName.action="makeEditSavePage.jsp";
	FormName.submit();
}
//-->
</script>
