...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cdbh,cdxh,cdxsmc,glurl,fcdbh, DECODE(sfmjcd,'Y','是','N','否'),cdsm  ";
	ls_sql+=" FROM sq_cd  ";
    ls_sql+=" where (1=1)";
    ls_sql+=wheresql;
...
//设置按钮参数
	...
	String[] buttonLink={"Sq_cdList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="12%">菜单编号</td>
	<td  width="12%">菜单序号</td>
	<td  width="12%">菜单显示名称</td>
	<td  width="12%">菜单关联URL</td>
	<td  width="12%">父菜单编号</td>
	<td  width="12%">是否末级菜单</td>
	<td  width="12%">菜单说明</td>
</tr>
<%
	pageObj.displayDate();
