...
<form method="post" action="Jdm_dgjsbmList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="dgjsbm" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">吊柜进深区间名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="dgjsmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
