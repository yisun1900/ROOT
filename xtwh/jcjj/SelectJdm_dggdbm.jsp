...
<form method="post" action="Jdm_dggdbmList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="dggdbm" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">吊柜高度区间名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="dggdmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
