...
<form method="post" action="Jdm_ppbmList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="jdm_ppbm_ppbm" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">品牌名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="jdm_ppbm_ppmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
  ...
  <td width="35%"> 
    <select name="jdm_ppbm_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
