...
<form method="post" action="SaveInsertJdm_tggdbm.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="tggdbm" value="" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">地柜高度区间名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="tggdmc" value="" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
