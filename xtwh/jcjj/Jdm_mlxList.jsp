...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT mlx,mlxmc,gdbxy||'mm≤门洞高度≤'||gdbdy||'mm',kdbxy||'mm≤门洞宽度≤'||kdbdy||'mm',tx  ";
	ls_sql+=" FROM jdm_mlx  ";
    ls_sql+=" where (1=1)";
    ls_sql+=wheresql;
    ls_sql+=" order by mlx";
...
//设置按钮参数
	...
	String[] buttonLink={"Jdm_mlxList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="8%">&nbsp;</td>
	<td  width="6%">门类型编码</td>
	<td  width="12%">门类型名称</td>
	<td  width="20%">门洞高度合理范围</td>
	<td  width="20%">门洞宽度合理范围</td>
	<td  width="34%">提醒</td>
</tr>
<%
	pageObj.displayDate();
