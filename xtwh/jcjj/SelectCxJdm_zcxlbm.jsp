...
<body bgcolor="#FFFFFF">
<form method="post" action="Jdm_zcxlbmCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">主材小类编码</td> 
  <td width="35%"> 
    <input type="text" name="zcxlbm" size="20" maxlength="4" >
  </td>
  <td align="right" width="15%">主材小类名称</td> 
  <td width="35%"> 
    <input type="text" name="zcxlmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
