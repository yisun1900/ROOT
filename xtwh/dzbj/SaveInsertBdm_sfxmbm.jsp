...
try {
	...
	ls_sql="insert into bdm_sfxmbm ( sfxmbm,sfxmmc,dysfxmmc,sflx,sfbxx,sfjrqye,dqbm,bz,gdje,jrsjbz   ,jrglfbz,sfkdz,zdzk,sfxmlx,sfcysgdjs,jldw,sfxsq,sfssjf,cbjbfb,sgcbjbfb   ,gcjcbjbfb,sffqsk,cbjjsfs,sfjrhtjz,sfjzsf) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,? ) ";
