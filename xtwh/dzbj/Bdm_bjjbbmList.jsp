...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT bjjbbm,bjjbmc,DECODE(lx,'1','个性化','2','套餐','3','整装'),yxj  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Bdm_bjjbbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="8%">&nbsp;</td>
	<td  width="14%">报价级别编码</td>
	<td  width="40%">报价级别名称</td>
	<td  width="24%">类型</td>
	<td  width="24%">级别排序</td>
</tr>
<%
