...
<form method="post" action="Dm_zxjwbmList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="zxjwbm" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">装修价位名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="zxjwmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
