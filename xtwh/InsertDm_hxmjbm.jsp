...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="hxmjbm" value="" size="20" maxlength="2" >
  </td>
  <td width="15%"> 
    <div align="right">户型面积名称</div>
  </td>
  <td width="35%"> 
    <input type="text" name="hxmjmc" value="" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="reset"  value="重输" name="reset">
				  &nbsp;&nbsp;&nbsp;&nbsp;
                <input name="button" type="button" onClick="f_gx(insertform)"  value="更新户型面积分类">
              </td>
            </tr>
          </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertDm_hxmjbm.jsp";
	FormName.submit();
	return true;
}
