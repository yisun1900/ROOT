...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dwflbm,dwflmc,dwtjflmc, DECODE(dwdl,'1','业绩部门','2','非业绩部门'),zzfw  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Dm_dwflbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="8%">&nbsp;</td>
	<td  width="12%">单位分类编码</td>
	<td  width="14%">单位分类名称</td>
	<td  width="11%">统计分类</td>
	<td  width="10%">单位大类</td>
	<td  width="45%">职责范围</td>
</tr>
