...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_fkfamxList.jsp","","","Editcw_fkfamx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Cw_fkfamxList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">是否含工程费</td>
	<td  width="6%">是否含记业绩其它费</td>
	<td  width="6%">是否含不记业绩其它费</td>
	<td  width="5%">是否含设计费</td>
	<td  width="6%">收款是否包含管理费</td>
