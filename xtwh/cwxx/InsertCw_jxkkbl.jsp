...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCw_jxkkbl.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
      <td align="right" width="17%">起点百分比（>=）</td> 
      <td width="33%"> 
...
<tr bgcolor="#FFFFFF">
      <td align="right" width="17%">处罚百分比</td> 
      <td width="33%"> 
