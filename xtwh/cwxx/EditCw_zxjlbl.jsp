...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCw_zxjlbl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
      ...
      <td width="32%"> 
        <input type="text" name="qd" size="10" maxlength="17"  value="<%=qd%>" >
        % </td>    <td align="right" width="18%">终点百分比（<）</td> 
      <td width="32%"> 
        <input type="text" name="zd" size="10" maxlength="17"  value="<%=zd%>" >
        % </td>
</tr>
<tr bgcolor="#FFFFFF">
      ...
      <td width="32%"> 
        ...
        % </td>    <td align="right" width="18%">分公司</td> 
      <td width="32%"> 
