...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_fgsfkfaCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">分公司编号</td> 
  <td width="35%"> 
    <select name="cw_fgsfkfa_fgsbh" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
%>
  ...
  <td width="35%"> 
    <select name="cw_fgsfkfa_fkfabm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
