...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Dm_sckhsbyybmList.jsp","","","EditDm_sckhsbyybm.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Dm_sckhsbyybmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from dm_sckhsbyybm where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="8%">&nbsp;</td>
	<td  width="24%">失败原因编码</td>
	<td  width="44%">失败原因名称</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
