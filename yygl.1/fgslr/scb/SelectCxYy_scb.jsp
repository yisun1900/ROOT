...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Yy_scbCxList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="29%"> 
    <input type="text" name="yy_scb_zqs" size="20" maxlength="8" >  </td>
  <td align="right" width="21%">市场部员工姓名</td> 
  <td width="29%"> 
...
{
	if(!(isNumber(FormName.yy_scb_zqs, "周期数"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbkh_byjh, "目标客户数量本月计划"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbkh_bylj, "目标客户数量本月累计"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbkh_szjh, "目标客户数量上周计划"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbkh_szwc, "目标客户数量上周完成"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbkh_bzyj, "目标客户数量本周预计"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbdj_byjh, "收取定金本月计划"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbdj_bylj, "收取定金本月累计"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbdj_szjh, "收取定金上周计划"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbdj_szwc, "收取定金上周完成"))) {
		return false;
	}
	if(!(isNumber(FormName.yy_scb_yy_scbdj_bzjh, "收取定金本周预计"))) {
		return false;
	}
	if(!(isDatetime(FormName.yy_scb_yy_scb_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.yy_scb_yy_scb_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
