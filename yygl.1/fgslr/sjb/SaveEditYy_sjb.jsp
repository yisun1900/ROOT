...
String whereyy_sjb_ygmc=null;
wherezqs=cf.GB2Uni(request.getParameter("wherezqs"));
whereyy_sjb_ygmc=cf.GB2Uni(request.getParameter("whereyy_sjb_ygmc"));
...
try {
	...
	ls_sql+=" where  (zqs="+wherezqs+") and  (yy_sjb_ygmc='"+whereyy_sjb_ygmc+"')  ";
