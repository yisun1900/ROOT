...
*/
   ...
   dzbj.NewDzbj dzbj=new dzbj.NewDzbj();//20100826
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td  width="53%" align="center" >工艺做法及材料说明</td>
  </tr>
</table>
...
<%
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,xmmc,jldwmc,bj_bjxmmx.zqdj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as je,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz,bj_bjxmmx.zcf,bj_bjxmmx.cldj,bj_bjxmmx.shf,bj_bjxmmx.qtf,bj_bjxmmx.ysf,bj_bjxmmx.rgdj,bj_bjxmmx.jxdj";
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td width="7%" align="center"> <%=cf.formatDouble(dj)%> </td>
				<td width="8%" align="center"> <%=cf.formatDouble(qye)%> </td>
				<td width="53%" align="left" ><%=gycl%></td>
			  </tr>
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		%> 
		  ...
		  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
			...
			<td >1</td>
			<td align="left"  >&nbsp; </td>
			<td colspan="1"><%=cf.formatDouble(sfje,"#########.##")%>元</td>	
			<td align="left"  ><%=bz%></td>
		  </tr>
    ...
    <td   colspan="2" >&nbsp;</td>
	<td align="left"  >&nbsp; </td>
	<td   colspan="1" ><%=cf.formatDouble(allsfje,"#########.##")%>元 </td>
	<td align="left"  >&nbsp; </td>
  </tr>
...
*/      
  ...
  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
	...
	<td >1</td>
	<td >&nbsp;</td>
	<td  colspan="1" > <%=cf.formatDouble(sfje2,"#########.##")%>元</td>
