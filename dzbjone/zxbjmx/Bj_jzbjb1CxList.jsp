...
<%
	...
	ls_sql+=" and bj_zdyxmb.xmbh  in(select xmbh from bj_bjxmmx where khbh='"+khbh+"')";
...
<%
	...
	ls_sql+=" and bj_zdyxmb.xmbh not in(select xmbh from bj_bjxmmx where khbh='"+khbh+"')";
	ls_sql+=" order by bj_zdyxmb.dqbm,bj_zdyxmb.xh,bj_zdyxmb.xmbh";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"SaveInsertBj_bjxmmx1.jsp?khbh="+khbh};//按钮单击调用的网页，可以增加参数
