...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF" align="center"> 
    ...
    <td  width="5%" ><span class="STYLE5">水电路</span></td>
...
<%
	...
	while (rs1.next())
	{
		...
		double zhje=0;
		String sdl=null;
		ls_sql="SELECT DECODE(bj_bjxmmxh.xmflbm,'01','水电路','') sdl ,bj_gclmx.sl*bj_bjxmmx.cbenj cbj,bj_gclmx.sl*bj_bjxmmx.sgcbj sgcbj,bj_gclmx.sl*bj_bjxmmx.sgdbj sgdbj,bj_bjxmmx.xh,xmflmc,bj_bjxmmx.xmbh,xmmc,jldwmc,bj_bjxmmx.zqdj,bj_bjxmmx.zk,bj_bjxmmx.dj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as zqje,bj_gclmx.sl*bj_bjxmmx.dj as zhje,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz";
