...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>" align="center"  >
		  ...
		  <td><%=gg%></td>
		  <td>
			<input type="text" name="sl" size="6" value="<%=sl%>" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" ><%=jldwbm%>
		  </td>
		  <td><%=zqdj%></td>
		  <td align="left">
			<input type="text" name="dj" size="6" value="<%=dj%>" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" >
