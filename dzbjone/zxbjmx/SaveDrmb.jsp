...
try {
	...
	while (rs1.next())
	{
		...
		//报价项目明细
		ls_sql="insert into bj_bjxmmx (xh,khbh,xmbh,xmmc,xmdlbm,xmxlbm,xmflbm,smbm,jldwbm,cldj,rgdj,jxdj,zcf,shf,ysf,qtf,zqdj,zk,dj,clcb,rgcb,jxcb,cbenj,sgdbj,sgcbj,sfyxdz,zdzk,gycl,bz,dqbm,bjjb,xmlx,jzbz,xmpx,sfxycl,sfzgzc,bjlx,glxmbh,sfbxx,lrr,lrsj,SFXYYJD,tcnxmbz ) ";
		ls_sql+=" select                   ?,?,xmbh,xmmc,xmdlbm,xmxlbm,xmflbm,smbm,jldwbm,clbj,rgbj,jxbj,zcf,shf,ysf,qtf,bj  ,10,bj,clcb,rgcb,jxcb,cbenj,sgdbj,sgcbj,sfyxdz,zdzk,gycl,bz,dqbm,bjjbbm,'1','1',?,'2','N','1',glxmbh,sfbxx,?,SYSDATE,SFXYYJD,'N'";//1：需要；2：不需要
