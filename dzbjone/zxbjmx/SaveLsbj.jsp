...
//	out.println(ls_sql);
	...
	ls_sql="insert into bj_mbsfxmmx (mbmc,khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfkdz,zdzk,sfbfb,dj,jldw,sl,zqsfje,dxzkl,sfje,bz,sfssjf,cbjbfb,sgcbjbfb,gcjcbjbfb,sffqsk,cbjjsfs,sfjrhtjz )";
	ls_sql+=" select '"+lsbjmc+"',khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfkdz,zdzk,sfbfb,dj,jldw,sl,zqsfje,dxzkl,sfje,bz,sfssjf,NVL(cbjbfb,0),NVL(sgcbjbfb,0),NVL(gcjcbjbfb,0),sffqsk,cbjjsfs,sfjrhtjz";
	...
	ls_sql="insert into      bj_mbkhzcxmxj (mbmc,khbh,jgwzbm,tccplbbm,tcsjflbm,sfbxx,sfyxsj,sfxzsl,bzsl,sfyqxtpp,sjsl,sjjshsl,khbjjbbm,bjjbbm)";
	ls_sql+=" select '"+lsbjmc+"',khbh,jgwzbm,tccplbbm,tcsjflbm,sfbxx,sfyxsj,sfxzsl,bzsl,sfyqxtpp,sjsl,sjjshsl,khbjjbbm,bjjbbm";
	...
	ls_sql="insert into      bj_mbkhzcxm (mbmc,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,sfxclxs,dj,jsj,sh,sfcscp,bz,sl,ptcpsm,bjjbbm)";
	ls_sql+=" select '"+lsbjmc+"',khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,sfxclxs,dj,jsj,sh,sfcscp,bz,sl,ptcpsm,bjjbbm";
