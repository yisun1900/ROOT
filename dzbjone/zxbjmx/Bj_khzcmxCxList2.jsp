...
<form method="POST" name="listform" action="" target="_blank">
  ...
  <table border="0" cellspacing="2" bgcolor="#999999" cellpadding="1" width="100%" style='FONT-SIZE: 12px'>
	...
	<tr bgcolor="#FFFFFF"    >
	  ...
	  <td align="center" bgcolor="#CCCCCC" ><input type="button" value='查  询' onClick="f_cx(listform)" ></td>
    </tr>
	<tr bgcolor="#FFFFFF"    >
	  ...
	  <td ><span class="STYLE1">数&nbsp;&nbsp;&nbsp;&nbsp;量</span>
        <input type="text" name="sl" size="15" value="" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" >
        <input type="hidden" name="ycf"  value="0" >
      <input type="hidden" name="qtfy" value="W" >
      <input type="hidden" name="qtfyje" value="0" ></td>
	  <td align="center" bgcolor="#CCCCCC" ><input type="button" value='存  盘' onClick="f_do(listform)"  ></td>
