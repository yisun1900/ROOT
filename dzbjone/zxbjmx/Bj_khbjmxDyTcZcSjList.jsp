...
<%
		...
		String sjsfycx=null;
	int i=0;
	ls_sql="SELECT bj_khzcxmxj.sjsfycx,jgwzbm,clxlmc,bj_khzcxmxj.tcsjflbm,tcsjflmc,bzsl,sjsl,sjjshsl,bjjbmc,bj_khzcxmxj.khbjjbbm,bj_khzcxmxj.bjjbbm,bj_khzcxmxj.sjsfsl,bj_khzcxmxj.sjcj,bj_khzcxmxj.sjsfje";
...
<%
	...
	double xjje=0;
	double xjsl=0;
	ls_sql="SELECT bj_khppsjcjb.jgwzbm,clxlmc,ppmc,bj_khppsjcjb.tcsjflbm,tcsjflmc,bjjbmc,bj_khppsjcjb.khbjjbbm,bj_khppsjcjb.bjjbbm,bj_khppsjcjb.sjsfsl,bj_khppsjcjb.sjcj,bj_khppsjcjb.sjsfje";
