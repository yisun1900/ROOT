...
<div align="center">主材减免（客户编号:<%=khbh%>、减免分类:<%=jmfl%>）</div>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="19%"><span class="STYLE1">*</span><span class="STYLE4">实际减免数量(数量前边不需加"-")</span></td>
</tr>
...
try {
	...
	ls_sql="select bj_khzcxmxj.jmjldw,bj_khzcxmxj.sjsl,bj_khzcxmxj.bjjbbm,bjjbmc,jgwzbm,bj_khzcxmxj.tccplbbm,jxc_clxlbm.clxlmc,bj_khzcxmxj.tcsjflbm,tcsjflmc,bj_khzcxmxj.sfxzsl,DECODE(bj_khzcxmxj.sfxzsl,'1','超量需加价','2','不可超量','3','无数量限制') sfxzslStr,bj_khzcxmxj.sfkjm,DECODE(bj_khzcxmxj.sfkjm,'1','不可减免','2','可减免') sfkjmStr,bj_khzcxmxj.yxjmzdsl,bj_khzcxmxj.jmdj,bj_khzcxmxj.sjjmsl,bj_khzcxmxj.sjjmje,bj_khzcxmxj.sjsl,bj_khzcxmxj.bzsl";
	ls_sql+=" FROM bj_khzcxmxj,jxc_clxlbm,bj_tcsjflbm,bdm_bjjbbm";
	ls_sql+=" where bj_khzcxmxj.khbh='"+khbh+"' and bj_khzcxmxj.jmfl='"+jmfl+"' and bj_khzcxmxj.sfkjm='2'";
	ls_sql+=" and bj_khzcxmxj.tcsjflbm=bj_tcsjflbm.tcsjflbm(+) ";
	ls_sql+=" and bj_khzcxmxj.tccplbbm=jxc_clxlbm.clxlbm(+) ";
