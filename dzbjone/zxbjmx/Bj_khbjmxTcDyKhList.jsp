...
//	String xmbh =null;
	String sfxzsl =null;
	double bzsl=0;
	ls_sql="SELECT bj_khgcxmxj.xmbh,bj_khgcxmxj.bzsl,bj_khgcxmxj.sfxzsl";
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	double zqdj=0;
	ls_sql="select bj_bjxmmx.xmbh,bj_bjxmmx.xmmc,bj_bjxmmx.xmmc,jldwmc,bj_bjxmmx.zqdj,bj_khgcxmxj.bzsl,bj_khgcxmxj.sjsl,bj_khgcxmxj.xjjsl";
