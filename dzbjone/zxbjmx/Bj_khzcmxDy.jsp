...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="9" height="35"><b><font size="5">大连王的装饰工程有限公司</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<%
	...
	while (rs1.next())
	{
		...
		double xjycffj=0;
		double xjqtfyjefj=0;
		ls_sql="SELECT xh,zcdlbm,zcxlbm,zcbm,zcmc,ppbm,xinghao,gg,zcysbm,jldwbm,zqdj,dpzk,zqdj,dpzk,dj,sl,ycf,DECODE(qtfy,'1','安装费','2','加工费','3','其它收费','W','无') qtfy,qtfyje";
		ls_sql+=" FROM bj_khzcmx";
		ls_sql+=" where khbh='"+khbh+"'";
		...
		while (rs.next())
		{
			...
			<tr bgcolor="<%=bgcolor%>" align="center"  >
			  ...
			  <td align="left"><%=zcmc%>、<%=xinghao%>、<%=gg%></td>
			</tr>
			<%
		}
		rs.close();
	...
	ls_sql+=" FROM bj_sfxmmx";
	ls_sql+=" where khbh='"+khbh+"'";
	ls_sql+=" and sfxmlx in('4')";//8：公司购主材税金
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	while (rs.next())
	{
	...
	<tr bgcolor="#FFFFFF" align="center" height="30" >
	  ...
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td colspan="2"><%=cf.round(zjje+zjycf+zjqtfyje,2)%></td>
	  <td>&nbsp;</td>
	</tr>
	<%
}
