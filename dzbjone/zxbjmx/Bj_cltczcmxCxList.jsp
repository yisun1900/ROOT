...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" where cpbm not in(select cpbm from bj_khcltcmx where khbh='"+khbh+"' and tcmc='"+tcmc+"' and jgwzbm='"+jgwzbm+"')";
    ls_sql+=wheresql;
...
//设置按钮参数
	...
	String[] buttonLink={"SaveInsertBj_khcltcmx.jsp?khbh="+khbh+"&tcmc="+tcmc+"&jgwzbm="+jgwzbm+"&lx="+lx};//按钮单击调用的网页，可以增加参数
