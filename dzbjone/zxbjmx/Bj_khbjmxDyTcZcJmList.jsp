...
<%
	...
	ls_sql="SELECT jgwzbm,clxlmc,DECODE(bj_khzcxmxj.sfxzsl,'1','超量需加价','2','不可超量','3','无数量限制') sfxzsl,jldw,jmjldw,bzsl,jmdj,sjjmsl,sjjmje";
	ls_sql+=" FROM bj_khzcxmxj,jxc_clxlbm ";
    ls_sql+=" where bj_khzcxmxj.tccplbbm=jxc_clxlbm.clxlbm";
    ls_sql+=" and bj_khzcxmxj.khbh='"+khbh+"' ";
    ls_sql+=" and bj_khzcxmxj.sjjmsl!=0";
