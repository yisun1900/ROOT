...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmx.xh xh,bj_bjxmmx.xmbh,xmmc,bj_bjxmmx.zqdj,jldwmc,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as je,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz";
