...
<form method="post" action="SaveBj_khcltcmx.jsp" name="editform" >
...
<%
	...
	ls_sql="SELECT jgwzbm,cpmc,cpsl,cpbm,xh,gg,ppmc,jldw,ydj,tcdj,sl";
	...
	while (rs.next())
	{
		...
		if (cpsl==1)
		{
			...
			ls_sql+=" where dqbm='"+dqbm+"' and hxbm='"+hxbm+"' and tcmc='"+tcmc+"' and jgwzbm='"+jgwzbm+"' and cpmc='"+cpmc+"'";
			ls_sql+=" order by xh";
