...
try {
	...
	while (rs.next())
	{
		...
		ls_sql="insert into bj_sfxmmx (khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfkdz,zdzk,sfbfb,dj,jldw,sl,zqsfje,dxzkl,sfje,bz,sfssjf,cbjbfb,sgcbjbfb,gcjcbjbfb,sffqsk,cbjjsfs)";
		ls_sql+=" select       '"+drkhbh+"',sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfkdz,zdzk,0,gdje,jldw,"+getsl+","+getsl+"*gdje,"+getdxzkl+","+getsl+"*gdje*"+getdxzkl+"/10,bz,sfssjf,cbjbfb,sgcbjbfb,gcjcbjbfb,sffqsk,cbjjsfs";
	...
	ls_sql="insert into      bj_khzcxm (khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,sfxclxs,dj,jsj,jjje,sh,sfcscp,xuhao,bz,sl,ptcpsm,bjjbbm,sfyx,sxh,tccldj,tcndj,ddcljjfs,jsfs,jsbl,xdsl)";
	ls_sql+=" select            '"+drkhbh+"',jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,sfxclxs,dj,jsj,jjje,sh,sfcscp,xuhao,bz,sl,ptcpsm,bjjbbm,sfyx,sxh,tccldj,tcndj,ddcljjfs,jsfs,jsbl,xdsl";
