	...
	while (rs.next())
	{
		...
		if (count>0)
		{
			...
			<tr bgcolor="<%=bgcolor%>" align="center"> 
				...
				<td><%=tcj%></td>
				<td>&nbsp;</td>
				<td><A HREF="Bj_khzctcmxList.jsp?khbh=<%=khbh%>&tcbm=<%=tcbm%>" target="lrbjframe">选择</A></td>
				<td><A HREF="DeleteZctcmc.jsp?khbh=<%=khbh%>&tcbm=<%=tcbm%>" target="lrbjframe">删除</A></td>
			</tr>
			<%
		}
		else{
			...
			<tr bgcolor="<%=bgcolor%>" align="center"> 
				...
				<td><A HREF="ViewBj_zctcmx.jsp?tcbm=<%=tcbm%>" target="lrbjframe"><%=tcmc%></A></td>
				<td><%=tcj%></td>
				<td><A HREF="SaveZctcmc.jsp?khbh=<%=khbh%>&tcbm=<%=tcbm%>&lx=<%=lx%>" >选择</A></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<%
