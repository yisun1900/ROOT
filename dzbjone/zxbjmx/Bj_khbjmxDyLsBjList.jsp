...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,xmmc,bj_bjxmmx.zqdj,jldwmc,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as je,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz";
...
%> 
  <tr bgcolor="#FFFFFF"> 
    <td align="right" colspan="9"><i><b><font size="3">直接费合计：<%=cf.formatDouble(allqye,"#########.##")%>元</font></b></i></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="9" align="center"><b><i><font size="3">综合取费</font></i></b></td>
  </tr>
  <%  
	double allsfje=0;
	int temp=0;
...
%> 
  <tr bgcolor="#FFFFFF"> 
    <td align="right" colspan="9"><i><b><font size="3">综合取费合计：<%=cf.formatDouble(allsfje,"#########.##")%>元</font></b></i></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td align="right" colspan="9"><i><b><font size="3">总 计：<%=cf.formatDouble(allzj,"#########.##")%>元</font></b></i></td>
  </tr>
</table>
