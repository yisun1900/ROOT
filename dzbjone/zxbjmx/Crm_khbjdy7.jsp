...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td  width="37%" align="center" >工艺做法及材料说明</td>
  </tr>
</table>
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td width="37%" align="left" ><%=gycl%></td>
			  </tr>
...
%> 
 ...
 <tr bgcolor="#FFFFFF" align="center"  height="25"> 
  ...
  <tr bgcolor="#FFFFFF" align="center"  height="25"> 
	...
	<td colspan="7">折前：<%=cf.formatDouble(allzcf+allfcf+allrgf+allshf+allysf+alljxf,"#########.##")%> &nbsp;&nbsp;&nbsp;&nbsp;折后：<%=cf.formatDouble(allqye,"#########.##")%>元</td>
	<td>&nbsp;</td>
  </tr>
  <%  
	double allsfje1=0;
