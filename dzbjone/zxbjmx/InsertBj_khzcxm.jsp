...
try {
	...
	ls_sql="select bjjbbm,sfxzsl,DECODE(sfxzsl,'1','超量需加价','2','不可超量','3','无数量限制') sfxzslStr,bzsl,sjjmsl,sjsl,tcsjflbm";
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>
    <%if (tccplbbm.equals("36")) out.println("玻璃型号");if (tccplbbm.equals("50")) out.println("坑距");%></td><td colspan="3"> 
