...
<div align="center">
  ...
  <table width="310%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#CCCCCC" align="center"> 
		...
		<td width="3%"><font color="#CC0000">客户报价</font></td>
	...
	for (int i=1;i<outStr.length ;i++ )
	{
		...
		sfyxdzStr=outStr[i][11].trim();
		zdzkStr=outStr[i][12].trim();

		gycl=outStr[i][13].trim();
		flmcgg=outStr[i][14].trim();
		bz=outStr[i][15].trim();
		glxmbh=outStr[i][16].trim();
		xh=outStr[i][17].trim();
		sfxyclstr=outStr[i][18].trim();
		sfxyyjdstr=outStr[i][19].trim();
