...
<%
	...
	String yhqx=cf.executeQuery("select count(*)  from v_sqxx where yhdlm='"+xtrzyhdlm+"' and cdbh='150121'");
	if (yhqx.equals("0"))
	{
...
<%
	...
	ls_sql="SELECT xmdlmc,xmxlmc,xmflmc,xmbh,bj_jzbjb.xmmc,DECODE(bj_jzbjb.sfbxx,'1','<font color=\"#FF0000\">必报项</font>','2','<font color=\"#CC00CC\">必列项</font>','3','可选项','9','<font color=\"#0000FF\">作废项</font>') sfbxx,smmc,jdm_jldwbm.jldwmc,bj_jzbjb.cbenj,bj_jzbjb.sgcbj,bj_jzbjb.bj,DECODE(bj_jzbjb.sfyxdz,'Y','允许','N','否') sfyxdz,bj_jzbjb.zdzk,gycl,flmcgg,bz,bj_jzbjb.glxmbh,bj_jzbjb.xh,DECODE(bj_jzbjb.sfxycl,'Y','需要','N','否') sfxycl,DECODE(bj_jzbjb.sfxyyjd,'Y','需要','N','否') sfxyyjd";
