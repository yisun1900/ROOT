...
try {
	...
	ls_sql="select xmflbm,sgcbj,xmmc,xmdlbm,xmxlbm,smbm,jldwbm,clbj,rgbj,bj,gycl,xh,flmcgg,bz,sfxycl,sfxyyjd ";
...
%>
            ...
            <tr>
              <td align="right" bgcolor="#FFFFFF"><font color="#CC0000">*</font>项目分类</td>
