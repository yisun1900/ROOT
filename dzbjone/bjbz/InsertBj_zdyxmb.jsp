...
String zdyxmyxq=cf.executeQuery("select TO_CHAR(ADD_MONTHS(SYSDATE,12),'YYYY-MM-DD') from sq_dwxx where dwbh='"+ssfgs+"'");
...
%></td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#CCCCFF"><input type="text" name="bj" size="20" maxlength="17" ></td>
           ...
           <tr align="center"> 
             <td colspan="4"> 
                ...
                <input type="hidden" name="clbj" value="0" >
                <input type="hidden" name="rgbj" value="0" >
                <input name="sgcbj" type="hidden"  value="0" >				</td>
            </tr>
        </table>
</form>    </td>
  </tr>
