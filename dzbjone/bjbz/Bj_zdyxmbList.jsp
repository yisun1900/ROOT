...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT bj_zdyxmb.dqbm,dqmc,xmdlmc,xmxlmc,xmflmc,bj_zdyxmb.zdyxmyxq,bj_zdyxmb.xmbh,bj_zdyxmb.bjjbbm,bjjbmc,bj_zdyxmb.xmmc,smmc,jdm_jldwbm.jldwmc,bj_zdyxmb.bj,lrr,lrsj,DECODE(bj_zdyxmb.shbz,'N','申请审核','S','受理申请','Y',' 审核通过','W','审核未通过','C','重新申请') shbz,gycl,flmcgg,bz,DECODE(bj_zdyxmb.sfxycl,'Y','需要','N','否') sfxycl,DECODE(bj_zdyxmb.sfxyyjd,'Y','需要','N','否') sfxyyjd";
...
//进行对象初始化
	pageObj.initPage("Bj_zdyxmbList.jsp","","","EditBj_zdyxmbMain.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数
//设置显示列
	String[] disColName={"shbz","dqmc","bjjbmc","xmbh","xmmc","jldwmc","bj","zdyxmyxq","gycl","flmcgg","xmdlmc","xmxlmc","xmflmc","smmc","lrr","lrsj","sfxycl","sfxyyjd"};
	pageObj.setDisColName(disColName);

//设置主键
	String[] keyName={"xmbh","lrr"};
	pageObj.setKey(keyName);

//设置按钮参数
	String[] buttonName={"删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"DeleteBj_zdyxmb.jsp"};//按钮单击调用的网页，可以增加参数
