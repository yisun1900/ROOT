...
String xmlrr=request.getParameter("xmlrr");
...
try {
	...
	ls_sql+=" and jxc_clbm.nbbm not in(select glfxclbm from bj_zdyglfxb where xmlrr='"+xmlrr+"' and xmbh='"+xmbh+"' and glfxclbm is not null)";;
