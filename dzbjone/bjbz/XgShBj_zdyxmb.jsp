...
try {
	...
	ls_sql+=" ,xmflbm,sgcbj,sgdbj,zcf,shf,ysf,qtf,cbenj ";
	...
	ls_sql="select yxmmc,ybj,ygycl,sfbxg,shyj ";
	...
	if (rs.next())
	{
		yxmmc=cf.fillNull(rs.getString("yxmmc"));
		ybj=rs.getDouble("ybj");
		ygycl=cf.fillNull(rs.getString("ygycl"));
		sfbxg=cf.fillNull(rs.getString("sfbxg"));
...
<form method="post" action="SaveXgShBj_zdyxmb.jsp" name="editform">
...
%></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>工程预算价</td>
              <td bgcolor="#FFFFFF"><input type="text" name="bj" value="<%=bj%>" size="20" maxlength="17" ></td>
              <td bgcolor="#FFFFFF" align="right"><font color="#FF0000">*</font>施工成本价</td>
              <td bgcolor="#FFFFFF"><input type="text" name="sgcbj" value="<%=sgcbj%>" size="20" maxlength="17" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"  ><font color="#FF0000">*</font>成本价</td>
              <td colspan="3"><input type="text" name="cbenj" value="<%=cbenj%>" size="20" maxlength="17" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#CCCCFF"><%
	cf.radioToken(out,"shbz","Y+审核通过&W+审核未通过",shbz);
%></td>
              <td align="right" bgcolor="#CCCCFF"><font color="#FF0000">*</font>是否修改</td>
              <td bgcolor="#CCCCFF"><%
	cf.radioToken(out,"sfbxg","Y+是&N+否",sfbxg);
%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr> 
              <td colspan="4" height="2"> 
                <div align="center"> 
                  ...
                  <input type="hidden" name="yxmmc"  value="<%=yxmmc%>" >
                  <input type="hidden" name="ybj"  value="<%=ybj%>" >
                  <input type="hidden" name="ygycl"  value="<%=ygycl%>" >
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	{
		if(FormName.xmmc.value!=FormName.yxmmc.value || parseFloat(FormName.bj.value)!=parseFloat(FormName.ybj.value) || FormName.gycl.value!=FormName.ygycl.value) 
		{
			alert("您选择了[未修改]，不能对项目信息进行了修改！");
			FormName.sfbxg[0].focus();
			return false;
		}
	}
