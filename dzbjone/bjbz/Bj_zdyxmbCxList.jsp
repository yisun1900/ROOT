...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(bj_zdyxmb.shbz,'N','申请','S','受理','Y',' 审核通过','W','未通过','C','重新申请') shbz,dwmc,DECODE(bj_zdyshjl.sfbxg,'Y','是','N','否') sfbxg,bj_zdyxmb.xmbh,bj_zdyxmb.xmmc,bjjbmc,bj_zdyxmb.zdyxmyxq,jdm_jldwbm.jldwmc,bj_zdyxmb.bj,yhmc,bj_zdyxmb.lrr,bj_zdyxmb.lrsj,dqmc,bj_zdyxmb.gycl,bj_zdyxmb.flmcgg,bj_zdyxmb.bz,xmdlmc,xmxlmc,xmflmc,smmc,bj_zdyxmb.ckxm,bj_zdyxmb.sqjl,bj_zdyshjl.slr,bj_zdyshjl.slsj,bj_zdyshjl.slsm,bj_zdyshjl.shr,bj_zdyshjl.shsj,bj_zdyshjl.shyj,DECODE(bj_zdyxmb.sfxycl,'Y','需要','N','否') sfxycl,DECODE(bj_zdyxmb.sfxyyjd,'Y','需要','N','否') sfxyyjd";
