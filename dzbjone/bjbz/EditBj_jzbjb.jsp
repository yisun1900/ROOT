...
try {
	...
	ls_sql="select gcjcbjxs,sgcbbjxs,khbjxs,xmflbm,sfyxdz,sgcbj,zdzk,zcf,shf,ysf,qtf,xmmc,xmdlbm,xmxlbm,smbm,jldwbm,clcb,rgcb,jxcb,cbenj,bj,clbj,rgbj,jxbj,sgdbj,gycl,xh,sfbxx,glxmbh,flmcgg,bz,sfxycl,sfxyyjd";
...
%></td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#E8E8FF"><input type="text" name="bj" value="<%=bj%>" size="20" maxlength="17" ></td>
              <td align="right" bgcolor="#E8E8FF"><font color="#FF0000">*</font>施工成本价</td>
              <td bgcolor="#E8E8FF"><input name="sgcbj" type="text" value="<%=sgcbj%>" size="20" maxlength="17"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><font color="#FF0000">*</font>成本价</td>
              <td colspan="3" bgcolor="#E8E8FF"><input type="text" name="cbenj" value="<%=cbenj%>" size="20" maxlength="17" ></td>
            </tr>
...
%>				</td>
              <td bgcolor="#E8E8FF" align="right"><font color="#FF0000">*</font>最低折扣</td>
              <td bgcolor="#E8E8FF"><input name="zdzk" type="text" value="<%=zdzk%>" size="10" maxlength="10" >
                (0到10之间)</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
