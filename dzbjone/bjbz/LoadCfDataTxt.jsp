...
String count=cf.executeQuery("select count(*) from bj_jzbjcfb where dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"' and bjbbh='"+bjbbh+"'");
%>

<body bgcolor="#FFFFFF">
<CENTER><B>导入拆分报价</B><BR><HR>
<form method="post" action="" name="loadform" enctype="multipart/form-data" >
    <table width="100%" border="0">
      ...
      <tr align="center">
        ...
        <td height="33" align="left"><input name="button" type="button" onClick="f_delete(loadform)"  value="删除拆分报价项目"></td>
      </tr>
      <tr align="center">
        <td height="33" align="right">报价版本号</td>
        <td height="33" align="left"><input type="text" name="bjbbh" value="<%=bjbbh%>" size="40" maxlength="50" readonly>
        </td>
      </tr>
      <tr align="center"> 
...
function f_delete(FormName)
{
	...
	FormName.action="deleteCfBjxm.jsp";
	FormName.submit();
	return true;
} 
...
function f_onclick(FormName)
{
	...
	FormName.target="";
	FormName.action="DisCfDataTxt.jsp";
	FormName.submit();
	return true;
} 
//-->
