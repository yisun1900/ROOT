...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><select name="bj_jzbjb1_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		out.println("<option value=\"\"></option>");
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <select name="bj_jzbjb1_xmdlbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="selectItem(bj_jzbjb1_xmdlbm,bj_jzbjb1_xmxlbm,<%=str1%>)" size="8" multiple>
                  <%
...
%> 
              ...
              <td width="19%" align="right"> 
                项目小类</td>
              <td width="31%"> 
                <select name="bj_jzbjb1_xmxlbm" style="FONT-SIZE:12PX;WIDTH:152PX" size="8" multiple>
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="bj_jzbjb1_xmbh" size="20" maxlength="16" ></td>
              <td width="19%" align="right">项目名称</td>
              <td width="31%"><input type="text" name="bj_jzbjb1_xmmc" size="20" maxlength="50" ></td>
            </tr>
            
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">饰面</td>
              <td width="31%"> 
                <select name="bj_jzbjb1_smbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%> 
              ...
              <td width="31%"> 
                <select name="bj_jzbjb1_jldwbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
{
	if(	javaTrim(FormName.bj_jzbjb1_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.bj_jzbjb1_dqbm.focus();
		return false;
	}
