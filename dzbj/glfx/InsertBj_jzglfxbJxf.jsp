...
<form method="post" action="" name="insertform" >
  <div align="center">修改家装工料分析表－增加机械费</div>
...
不打印 </td>
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right"><span class="STYLE2">*</span>机械费名称</td>
      <td>
		<input type="text" name="glfxclmc" value="" size="20" maxlength="100" >
      </td>
...
%>
    ...
    <tr align="center">
      <td colspan="4"><input type="button"  value="增加机械" onClick="f_lrjx(insertform)" >
...
function f_lrjx(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertBj_jzglfxbJxf.jsp";
	FormName.submit();
	return true;
}
