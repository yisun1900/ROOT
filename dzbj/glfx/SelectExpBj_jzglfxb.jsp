...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="xmmc" size="73" maxlength="50" >              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 

                  <p>
                    <input type="button" onClick="f_jc(selectform)"  value="检查工料分析" >
                    <input type="button" onClick="f_dc(selectform)"  value="导出工料分析" >
...
function f_jc(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Bj_jzglfxbJcList.jsp";
	FormName.submit();
	return true;
}
...
function f_dc(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Bj_jzglfxbExpList.jsp";
	FormName.submit();
	return true;
}
//-->
