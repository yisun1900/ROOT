...
<%
	...
	ls_sql="SELECT bj_jzglfxb.xmbh,xmmc,glflmc,DECODE(bj_jzglfxb.wlllbz,'Y','需要','N','否') wlllbz,TO_CHAR(glfxclbm),glfxclmc,jxc_clbm.ppmc,jxc_clbm.xh,jxc_clbm.gg,bj_jzglfxb.jldwbm,xhl,bj_jzglfxb.dj,DECODE(bj_jzglfxb.lx,'1','打印','2','不打印'),bj_jzglfxb.bz";
