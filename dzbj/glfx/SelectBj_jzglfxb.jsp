...
<body bgcolor="#FFFFFF">
<form method="post" action="Bj_jzglfxbList.jsp" name="selectform">
<div align="center">工料分析－调整材料</div>
...
%>
      ...
      <td align="right"><span class="STYLE1">*</span>材料编码</td>
      <td><input type="text" name="glfxclbm" size="20" maxlength="16" ></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"><input type="text" name="glfxclmc" size="73" maxlength="100" ></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="xssl" size="10" value="300">      </td>
