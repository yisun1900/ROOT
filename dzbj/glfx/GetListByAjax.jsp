...
try {
	...
	ls_sql+=" and jxc_clbm.nbbm not in(select glfxclbm from bj_jzglfxb where bjbbh='"+bjbbh+"' and dqbm='"+dqbm+"' and xmbh='"+xmbh+"' and bjjbbm='"+bjjbbm+"' and glfxclbm is not null)";;
