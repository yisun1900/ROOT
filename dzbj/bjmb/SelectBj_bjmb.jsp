...
<form method="post" action="Bj_bjmbList.jsp" name="selectform">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">用户登陆名</td>
      <td width="32%"> 
        <input type="text" name="bj_bjmb_yhdlm" size="20" maxlength="16" >      </td>
      <td align="right" width="18%">员工名称</td>
      <td width="32%"> 
        <input type="text" name="sq_yhxx_yhmc" size="20" maxlength="50" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">模板名称</td>
      <td width="32%"><input type="text" name="bj_bjmb_mbmc" size="20" maxlength="40" ></td>
      <td align="right" width="18%">模板类型</td>
      <td width="32%"><%
