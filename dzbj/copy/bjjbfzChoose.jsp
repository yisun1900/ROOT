...
String count=cf.executeQuery("select count(*) from bj_jzbjb where dqbm='"+newdqbm+"' and bjbbh='"+newbjbbh+"' and bjjbbm='"+newbjjbbm+"'");
%>
...
%>
      ...
      <tr align="center">
        <td height="34" align="right"><font color="#FF0000">*</font>被复制报价级别</td>
        <td height="34" align="left">
		<select name="oldbjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	cf.selectItem(out,"select bjjbbm,bjjbmc from bdm_bjjbbm where bjjbbm='"+oldbjjbbm+"'","");
%>
        </select></td>
      </tr>
       <tr align="center">
        <td height="33" align="right">复制级别项目已存在『<%=count%>』条：</td>
...
%>
      ...
      <tr align="center">
       ...
       <tr align="center">
        <td height="34" align="right"><font color="#FF0000">*</font>复制报价级别</td>
        <td height="34" align="left">
		<select name="newbjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	cf.selectItem(out,"select bjjbbm,bjjbmc from bdm_bjjbbm where bjjbbm='"+newbjjbbm+"'","");
%>
        </select></td>
      </tr>
      <tr align="center">
...
function f_delete(FormName)
{
	...
	if(	javaTrim(FormName.newbjjbbm)=="") {
		alert("请选择[复制报价级别]！");
		FormName.newbjjbbm.focus();
		return false;
	}
	...
	FormName.action="deleteJbBjxm.jsp";
	FormName.submit();
	return true;
} 
...
function f_onclick(FormName)
{
	...
	if(	javaTrim(FormName.oldbjjbbm)=="") {
		alert("请选择[被复制报价级别]！");
		FormName.oldbjjbbm.focus();
		return false;
	}
	...
	if (FormName.olddqbm.value==FormName.newdqbm.value && FormName.oldbjbbh.value==FormName.newbjbbh.value && FormName.oldbjjbbm.value==FormName.newbjjbbm.value)
	{
		alert("错误！不能自己复制自己");
		FormName.newbjbbh.focus();
		return false;
	...
	FormName.target="";
	FormName.action="SaveBjjbfz.jsp";
	FormName.submit();
	return true;
} 
//-->
