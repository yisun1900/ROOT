...
//设置显示列
	String[] disColName={"dqmc","bjjbmc","cpbm","cpmc","ppmc","xh","gg","jldw","xdjldw","xdb","sh","sfxclxs","dj","tccldj","sfkgdj","cldlmc","clxlmc","tcsjflmc","gysmc","sfyx","yxkssj","yxjzsj","sfcscp","sku","xuhao","lrr","lrsj","bz"};
