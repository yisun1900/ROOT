...
try {
	...
	ls_sql="select sfyx,yxkssj,yxjzsj,dqbm,bjjbbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,dj,tccldj,sfkgdj,jsj,sh,sfcscp,xuhao,lrr,lrsj,bz,sfxclxs ";
