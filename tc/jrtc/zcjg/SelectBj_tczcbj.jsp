...
<body bgcolor="#FFFFFF">
<form method="post" action="Bj_tczcbjList.jsp" name="selectform">
...
<tr align="center"> 
  <td colspan="4"> 
    ...
    <input type="button" onClick="f_yxbz(selectform)"  value="批量修改【有效标志】">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Bj_tczcbjList.jsp";
	FormName.submit();
	return true;
}
...
function f_xdb(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.bj_tczcbj_bjjbbm)=="") {
		alert("请输入[报价级别]！");
		FormName.bj_tczcbj_bjjbbm.focus();
		return false;
	}
	if(	javaTrim(FormName.bj_tczcjxc_clxlbm)=="") {
		alert("请选择[产品类别]！");
		FormName.bj_tczcjxc_clxlbm.focus();
		return false;
	}
...
function f_yxbz(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.bj_tczcbj_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.bj_tczcbj_dqbm.focus();
	...
	FormName.action="UpdateYxbz.jsp";
	FormName.submit();
	return true;
}
//-->
