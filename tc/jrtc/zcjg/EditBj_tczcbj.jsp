...
try {
	...
	ls_sql="select cllx,sfyx,yxkssj,yxjzsj,dqbm,bjjbbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,dj,tccldj,sfkgdj,jsj,sh,sfcscp,xuhao,lrr,lrsj,bz,sfxclxs ";
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font>套餐内单价</td> 
  <td width="32%"> 
    <input type="text" name="dj" size="20" maxlength="17"  value="<%=dj%>" >  </td>
  <td align="right" width="18%"><font color="#FF0000">*</font>套餐超量单价</td> 
  <td width="32%"><input type="text" name="tccldj" size="20" maxlength="17"  value="<%=tccldj%>" ></td>
</tr>
...
%></td>
  ...
  <td><%
	cf.radioToken(out, "cllx","1+旧材料&2+新材料",cllx);
%></td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.dj, "套餐内单价"))) {
		return false;
	}
	if(	javaTrim(FormName.tccldj)=="") {
		alert("请输入[套餐超量单价]！");
		FormName.tccldj.focus();
		return false;
	}
	if(!(isFloat(FormName.tccldj, "套餐超量单价"))) {
		return false;
	}
