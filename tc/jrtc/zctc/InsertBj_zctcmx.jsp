...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertBj_zctcmx.jsp" name="insertform"  >
<div align="center">录入－主材套餐明细</div>
<table width="101%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span><span class="STYLE2">主材套餐名称</span></td>
    <td><select name="tcbm" style="FONT-SIZE:12PX;WIDTH:152PX">
        <%
	cf.selectItem(out,"select tcbm,tcmc from bj_zctcmc where tcbm="+tcbm+" order by tcmc",tcbm);
%>
      </select>
    </td>
    <td align="right">&nbsp;</td>
