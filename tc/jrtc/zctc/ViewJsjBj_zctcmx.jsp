...
<%
	...
	String ls_sql=null;
	ls_sql="SELECT bj_zctcmx.sl,TO_CHAR(bj_zctcmx.tcdj),ROUND(bj_zctcmx.tcdj*bj_zctcmx.sl,2),bj_zctcmx.cpmc,bj_zctcmx.cpbm,bj_zctcmx.xh,bj_zctcmx.gg,bj_zctcmx.ppmc,bj_zctcmx.gysmc,bj_zctcmx.jldw,TO_CHAR(bj_zctcmx.ydj),TO_CHAR(bj_zctcmx.jsj),TO_CHAR(bj_zctcmx.sjzj),bj_zctcmx.bz,bj_zctcmx.lrr,bj_zctcmx.lrsj  ";
