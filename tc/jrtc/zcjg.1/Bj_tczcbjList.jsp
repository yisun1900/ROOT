...
//设置显示列
	String[] disColName={"bjjbmc","cpmc","ppmc","xh","jsj","sfyx","yxkssj","yxjzsj","gg","jldw","xdjldw","xdb","sh","sfxclxs","dj","tccldj","sfkgdj","cldlmc","clxlmc","tcsjflmc","gysmc","sfcscp","sku","xuhao","lrr","lrsj","dqmc","cpbm","bz"};
