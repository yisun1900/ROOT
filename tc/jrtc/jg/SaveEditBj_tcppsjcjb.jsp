...
try {
	...
	ls_sql="update bj_tcppsjcjb set ppmc=?,jldw=?,sjcj=?,yxkssj=?,yxjzsj=? ";
	ls_sql+=" where dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"' and bjjbbm1='"+bjjbbm1+"' and tcsjflbm='"+tcsjflbm+"' and ppmc='"+whereppmc+"'";
