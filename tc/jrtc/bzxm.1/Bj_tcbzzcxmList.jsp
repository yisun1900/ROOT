...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by bj_tcbzzcxm.dqbm,bj_tcbzzcxm.bjjbbm,bj_tcbzzcxm.hxbm,bj_tcbzzcxm.jgwzbm,bj_tcbzzcxm.tccplbbm";
    pageObj.sql=ls_sql;
//进行对象初始化
...
//设置显示列
	String[] disColName={"dqmc","bjjbmc","hxmc","jgwzbm","clxlmc","jldw","sfxzsl","bzsl","sfbxx","sfyxsj","tcsjflmc","sfyqxtpp","sfkjm","jmfl","jmjldw","yxjmzdsl","jmdj","sfkgh","khzdsl","ghzj","lrr","lrsj"};
	pageObj.setDisColName(disColName);


//设置主键
	String[] keyName={"dqbm","bjjbbm","hxbm","jgwzbm","tccplbbm"};
	pageObj.setKey(keyName);
//设置按钮参数
	String[] buttonName={"删除选中的信息","批量改升级分类","批量改[减免]","批量改[可更换]"};//按钮的显示名称
	String[] buttonLink={"Bj_tcbzzcxmList.jsp?","plsj.jsp","pljm.jsp","plgh.jsp"};//按钮单击调用的网页，可以增加参数
