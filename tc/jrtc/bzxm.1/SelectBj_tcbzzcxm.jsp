...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Bj_tcbzzcxmList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="34%"><select name="bj_tcbzzcxm_hxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="34%"><select name="bj_tcbzzcxm_tccplbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	  ...
	  <input type="radio" name="sfxzsl"  value="3">无数量限制 
  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="34%"><input type="text" name="bj_tcbzzcxm_lrr" size="20" maxlength="20" ></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.khzdsl2, "可换最大数量"))) {
		return false;
	}
