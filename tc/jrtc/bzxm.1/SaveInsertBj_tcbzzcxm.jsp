...
try {
	...
	ls_sql="insert into bj_tcbzzcxm (dqbm,bjjbbm,hxbm,jgwzbm,tccplbbm,tcsjflbm,sfbxx,sfyxsj,jldw,sfxzsl   ,bzsl,sfkjm,yxjmzdsl,jmdj,sfkgh,khzdsl,ghzj,sfyqxtpp,lrr,lrsj,jmfl,jmjldw)  ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?,?,? ) ";
