...
<body bgcolor="#FFFFFF">
<form method="post" action="Tc_csrjzckList.jsp" name="selectform">
<div align="center">套餐主材库－维护</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right">地区</td>
  <td><select name="tc_csrjzck_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
  ...
  <td><select name="tc_csrjzck_bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="tc_csrjzck_nbbm" size="20" maxlength="20" ></td>
</tr>
...
<tr align="center"> 
  <td colspan="4"> 
    ...
    <input type="button" onClick="f_plxgjsj(selectform)"  value="批量修改结算价">
    <input type="button" onClick="f_plxgkhj(selectform)"  value="批量修改客户销售单价">
    <input type="button" onClick="f_plxgsgdj(selectform)"  value="批量修改施工队单价">
    <input type="button" onClick="f_plxgsjj(selectform)"  value="批量修改升级收费价">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="";
	FormName.action="Tc_csrjzckList.jsp";
	FormName.submit();
	return true;
}

function f_plxgjsj(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.tc_csrjzck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.tc_csrjzck_dqbm.focus();
		return false;
	}
	if(	javaTrim(FormName.tc_csrjzck_bjjbbm)=="") {
		alert("请选择[报价级别]！");
		FormName.tc_csrjzck_bjjbbm.focus();
		return false;
	}
	...
	FormName.action="EnterPlxgjsj.jsp";
	FormName.submit();
	return true;
}


function f_plxgkhj(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.tc_csrjzck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.tc_csrjzck_dqbm.focus();
	...
	FormName.target="_blank";
	FormName.action="EnterPlxgkhj.jsp";
	FormName.submit();
	return true;
}
...
function f_plxgsgdj(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.tc_csrjzck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.tc_csrjzck_dqbm.focus();
	...
	FormName.target="_blank";
	FormName.action="EnterPlxgsgdj.jsp";
	FormName.submit();
	return true;
}

function f_plxgsjj(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.tc_csrjzck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.tc_csrjzck_dqbm.focus();
	...
	FormName.target="_blank";
	FormName.action="EnterPlxgsjj.jsp";
	FormName.submit();
	return true;
}
