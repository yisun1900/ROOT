...
String count=cf.executeQuery("select count(*) from tc_cxxm where dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"'");
%>


<body bgcolor="#FFFFFF">
<CENTER><B>导入套餐促销项目</B><BR><HR>
...
function f_delete(FormName)
{
	...
	FormName.action="deleteBjxmCx.jsp";
	FormName.submit();
	return true;
} 
