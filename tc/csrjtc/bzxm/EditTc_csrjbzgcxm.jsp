...
try {
	...
	ls_sql="select bjbbh,dqbm,bjjbbm,xmbh,bzsl,sfxzsl,lrr,lrsj ";
	ls_sql+=" from  tc_csrjbzgcxm";
	ls_sql+=" where  (bjbbh='"+wherebjbbh+"') and  (dqbm='"+wheredqbm+"') and  (bjjbbm='"+wherebjjbbm+"') and  (xmbh='"+wherexmbh+"')  ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjbzgcxm.jsp" name="editform">
