...
String count=cf.executeQuery("select count(*) from tc_csrjbzgcxm where dqbm='"+dqbm+"' and bjbbh='"+bjbbh+"'");
%>


<body bgcolor="#FFFFFF">
<CENTER><B>导入套餐标准工程项目</B><BR><HR>
<form method="post" action="" name="loadform" enctype="multipart/form-data" >
    <table width="100%" border="0">
      ...
      <tr align="center"> 
        <td width="48%" height="33" align="right">报价版本号</td>
...
function f_delete(FormName)
{
	...
	FormName.action="deleteBjxmGc.jsp";
	FormName.submit();
	return true;
} 
