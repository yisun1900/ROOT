...
try {
	...
	{
		ls_sql="insert into tc_csrjbzgcxm (dqbm,bjjbbm,hxbm,jgwzbm,tccplbbm,tcsjflbm,sfbxx,sfyxsj,jldw,sfxzsl   ,bzsl,sfkjm,jmfl,jmjldw,yxjmzdsl,jmdj,sfkgh,khzdsl,ghzj,sfyqxtpp,lrr,lrsj)  ";
		ls_sql+=" values('"+dqbm+"','"+bjjbbm[i]+"','"+hxbm[i]+"','"+cf.GB2Uni(jgwzbm[i])+"','"+tccplbbm[i]+"','"+tcsjflbm[i]+"','"+sfbxx[i]+"','"+sfyxsj[i]+"','"+cf.GB2Uni(jldw[i])+"','"+sfxzsl[i]+"'   ,'"+bzsl[i]+"','"+sfkjm[i]+"','"+cf.GB2Uni(jmfl[i])+"','"+cf.GB2Uni(jmjldw[i])+"','"+yxjmzdsl[i]+"','"+jmdj[i]+"','"+sfkgh[i]+"','"+khzdsl[i]+"','"+ghzj[i]+"','"+sfyqxtpp[i]+"','"+yhmc+"',SYSDATE)";
