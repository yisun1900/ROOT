...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,fjbzmj,dyygpm,pmzjmj,sfxzsl,tcnbz,sfbxx ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjygjmj.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="dyygpm" value="<%=dyygpm%>" size="20" maxlength="17" ></td>
</tr>
