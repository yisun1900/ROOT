...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Tc_csrjcgjmjList.jsp","","","EditTc_csrjcgjmj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Tc_csrjcgjmjList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from tc_csrjcgjmj where "+chooseitem;
...
<CENTER >
  <B><font size="3">套餐橱柜减免价－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
