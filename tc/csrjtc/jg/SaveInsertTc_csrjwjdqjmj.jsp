...
try {
	...
	ls_sql="insert into tc_csrjwjdqjmj ( dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,sfxzsl,bzsl,tcnbz,sfbxx ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
	...
	ps.setInt(12,bzsl);
	ps.setString(13,tcnbz);
	ps.setString(14,sfbxx);
