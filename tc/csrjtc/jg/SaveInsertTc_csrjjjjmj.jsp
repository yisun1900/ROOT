...
try {
	...
	ls_sql="insert into tc_csrjjjjmj ( dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,sfxzsl,bzsl,tcnbz,sfbxx,lrr,lrsj ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
	...
	ps.setDouble(8,jmdj);
	ps.setString(9,sfxzsl);
	ps.setInt(10,bzsl);
	ps.setString(11,tcnbz);
