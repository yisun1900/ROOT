...
try {
	...
	ls_sql="update tc_csrjcgjmj set dqbm=?,bjjbbm=?,tccplbbm=?,tccpdlbm=?,sfyqxtpp=?,jldw=?,sfkjm=?,jmdj=?,lrr=?,lrsj=?,bzsl=?,tcnbz=?,sfbxx=?,sfxzsl=? ";
	...
	ps.setString(12,tcnbz);
	ps.setString(13,sfbxx);
