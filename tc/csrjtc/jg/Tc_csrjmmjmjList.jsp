...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT tc_csrjmmjmj.dqbm,dm_dqbm.dqmc,tc_csrjmmjmj.bjjbbm,bdm_bjjbbm.bjjbmc,tc_csrjmmjmj.tccplbbm,jxc_clxlbm.clxlmc,jxc_cldlbm.cldlmc, DECODE(tc_csrjmmjmj.sfyqxtpp,'Y','是','N','否') sfyqxtpp,tc_csrjmmjmj.jldw, DECODE(tc_csrjmmjmj.sfkjm,'1','不可减免','2','可减免') sfkjm,tc_csrjmmjmj.jmdj,DECODE(tc_csrjmmjmj.sfxzsl,'1','不限制','2','不许超量','3','超量单独收费') sfxzsl,tc_csrjmmjmj.bzmj,tc_csrjmmjmj.bzsl,tc_csrjmmjmj.mtmzjmj,DECODE(tcnbz,'Y','套餐内','N','否') tcnbz,DECODE(sfbxx,'Y','必选项','N','否') sfbxx,tc_csrjmmjmj.lrr,tc_csrjmmjmj.lrsj  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Tc_csrjmmjmjList.jsp?"};//按钮单击调用的网页，可以增加参数
