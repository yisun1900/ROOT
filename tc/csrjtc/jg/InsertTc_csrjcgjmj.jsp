...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTc_csrjcgjmj.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	<INPUT type="radio" name="tcnbz" value="Y">套餐内
	<INPUT type="radio" name="tcnbz" value="N">否  </td>
  <td align="right"><font color="#FF0000">*</font>是否必选项</td>
  <td>
	<INPUT type="radio" name="sfbxx" value="Y">必选项
