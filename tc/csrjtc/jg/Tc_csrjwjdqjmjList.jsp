...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT tc_csrjwjdqjmj.dqbm,dm_dqbm.dqmc,tc_csrjwjdqjmj.bjjbbm,bdm_bjjbbm.bjjbmc,tc_csrjwjdqjmj.tccplbbm,jxc_clxlbm.clxlmc,jxc_cldlbm.cldlmc, DECODE(tc_csrjwjdqjmj.sfyqxtpp,'Y','是','N','否') sfyqxtpp,tc_csrjwjdqjmj.jldw, DECODE(tc_csrjwjdqjmj.sfkjm,'1','不可减免','2','可减免') sfkjm,tc_csrjwjdqjmj.jmdj,DECODE(tcnbz,'Y','套餐内','N','否') tcnbz,DECODE(sfbxx,'Y','必选项','N','否') sfbxx,tc_csrjwjdqjmj.lrr,tc_csrjwjdqjmj.lrsj  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Tc_csrjwjdqjmjList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">套餐五金电器减免价－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
