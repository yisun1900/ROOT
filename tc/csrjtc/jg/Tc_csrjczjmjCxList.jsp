...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dm_dqbm.dqmc,bdm_bjjbbm.bjjbmc,jxc_clxlbm.clxlmc,jxc_cldlbm.cldlmc, DECODE(tc_csrjczjmj.sfyqxtpp,'Y','是','N','否') sfyqxtpp,tc_csrjczjmj.jldw, DECODE(tc_csrjczjmj.sfkjm,'1','不可减免','2','可减免') sfkjm,tc_csrjczjmj.jmdj,DECODE(tcnbz,'Y','套餐内','N','否') tcnbz,DECODE(sfbxx,'Y','必选项','N','否') sfbxx,tc_csrjczjmj.lrr,tc_csrjczjmj.lrsj  ";
...
<CENTER >
  <B><font size="3">套餐磁砖减免价－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
