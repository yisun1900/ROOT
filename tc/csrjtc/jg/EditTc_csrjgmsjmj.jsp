...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,fjbzmj,dypm,pmzjmj,sfxzsl,tcnbz,sfbxx ";
	...
	if (rs.next())
	{
		...
		fjbzmj=rs.getDouble("fjbzmj");
		dypm=rs.getInt("dypm");
		pmzjmj=rs.getDouble("pmzjmj");
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjgmsjmj.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="fjbzmj" value="<%=fjbzmj%>" size="20" maxlength="17" ></td>
  <td align="right"><font color="#FF0000">*</font>对应平米</td>
  <td><input type="text" name="dypm" value="<%=dypm%>" size="20" maxlength="17" ></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>每平米增加面积</td>
  <td><input type="text" name="pmzjmj" value="<%=pmzjmj%>" size="20" maxlength="17" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.dypm)=="") {
		alert("请输入[对应平米]！");
		FormName.dypm.focus();
		return false;
	}
	if(!(isNumber(FormName.dypm, "对应平米"))) {
		return false;
	}
