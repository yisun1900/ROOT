...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,bzmj,bzsl,mtmzjmj,tcnbz,sfbxx,sfxzsl ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjmmjmj.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "sfxzsl","1+不限制&2+不许超量&3+超量单独收费",sfxzsl);
%></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>标准面积</td>
  <td><input type="text" name="bzmj" value="<%=bzmj%>" size="20" maxlength="17" ></td>
  <td align="right"><font color="#FF0000">*</font>标准数量</td>
  <td><input type="text" name="bzsl" value="<%=bzsl%>" size="20" maxlength="17" ></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>每樘门增加面积</td>
  <td><input type="text" name="mtmzjmj" value="<%=mtmzjmj%>" size="20" maxlength="17" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "tcnbz","Y+套餐内&N+否",tcnbz);
%></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.bzsl, "标准数量"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.mtmzjmj, "每樘门增加面积"))) {
		return false;
	}
