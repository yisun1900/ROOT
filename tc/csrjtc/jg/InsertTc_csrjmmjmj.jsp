...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTc_csrjmmjmj.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="bzmj" value="" size="20" maxlength="17" ></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="mtmzjmj" value="" size="20" maxlength="17" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
