...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTc_csrjwjdqjmj.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="radio" name="sfxzsl"  value="1">不限制
  <input type="radio" name="sfxzsl"  value="2">不许超量
  <input type="radio" name="sfxzsl"  value="3">超量单独收费</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="radio" name="tcnbz"  value="Y">套餐内
  <input type="radio" name="tcnbz"  value="N">套餐外</td>
  <td align="right"><font color="#FF0000">*</font>是否必选项</td>
  <td><input type="radio" name="sfbxx"  value="Y">必选项
  <input type="radio" name="sfbxx"  value="N">否</td>
</tr>
<tr bgcolor="#FFFFFF">
