...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,bzsl,tcnbz,sfbxx,sfxzsl ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjcgjmj.jsp" name="editform">
