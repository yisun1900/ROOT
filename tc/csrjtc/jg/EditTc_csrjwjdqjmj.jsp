...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,lrr,lrsj,sfxzsl,bzsl,tcnbz,sfbxx ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_csrjwjdqjmj.jsp" name="editform">
