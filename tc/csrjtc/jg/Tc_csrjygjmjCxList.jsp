...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dm_dqbm.dqmc,bdm_bjjbbm.bjjbmc,jxc_clxlbm.clxlmc,jxc_cldlbm.cldlmc, DECODE(tc_csrjygjmj.sfyqxtpp,'Y','是','N','否') sfyqxtpp,tc_csrjygjmj.jldw, DECODE(tc_csrjygjmj.sfkjm,'1','不可减免','2','可减免') sfkjm,tc_csrjygjmj.jmdj,tc_csrjygjmj.fjbzmj,tc_csrjygjmj.dyygpm,tc_csrjygjmj.pmzjmj,DECODE(tc_csrjygjmj.sfxzsl,'1','不限制','2','不许超量','3','超量单独收费') sfxzsl,tc_csrjygjmj.bzsl,DECODE(tc_csrjygjmj.tcnbz,'Y','套餐内','N','否') tcnbz,DECODE(tc_csrjygjmj.sfbxx,'Y','必选项','N','否') sfbxx,tc_csrjygjmj.lrr,tc_csrjygjmj.lrsj  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Tc_csrjygjmjCxList.jsp","","","");
