...
<body bgcolor="#FFFFFF">
<form method="post" action="Tc_csrjwjdqjmjCxList.jsp" name="selectform">
<div align="center">套餐五金电器减免价－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
    ...
    <INPUT type="radio" name="sfyqxtpp" value="N">否
  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	...
	<INPUT type="radio" name="sfkjm" value="2">可减免
  </td>
