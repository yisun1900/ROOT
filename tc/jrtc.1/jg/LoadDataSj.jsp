...
String count=cf.executeQuery("select count(*) from bj_tcsjcjb where dqbm='"+dqbm+"' and bjbbh='"+bjbbh+"'");
%>


<body bgcolor="#FFFFFF">
<CENTER><B>导入套餐升级差价表</B><BR><HR>
...
function f_delete(FormName)
{
	...
	FormName.action="deleteBjxmSj.jsp";
	FormName.submit();
	return true;
} 
