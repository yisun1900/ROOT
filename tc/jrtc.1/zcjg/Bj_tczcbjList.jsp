...
//设置显示列
	String[] disColName={"bjjbmc","cpmc","ppmc","xh","jsj","sfyx","yxkssj","yxjzsj","gg","jldw","xdjldw","xdb","sh","sfxclxs","dj","tccldj","sfkgdj","cldlmc","clxlmc","tcsjflmc","gysmc","sfcscp","sku","xuhao","lrr","lrsj","dqmc","cpbm","cllx","bz"};
...
//设置按钮参数
	String[] buttonName={"删除选中的信息","批量修改【有效标志】","批量修改【结算价】"};//按钮的显示名称
	String[] buttonLink={"Bj_tczcbjList.jsp?","PlUpdateYxbz.jsp","PlUpdateJsj.jsp"};//按钮单击调用的网页，可以增加参数
