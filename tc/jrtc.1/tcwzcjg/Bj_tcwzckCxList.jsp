...
//设置显示列
	String[] disColName={"dqmc","cpbm","cpmc","ppmc","xh","gg","jldw","xdjldw","xdb","sh","sfxclxs","dj","sfkgdj","sfycx","cxj","cxkssj","cxjssj","cxjsj","cxjsbl","cldlmc","clxlmc","gysmc","sfyx","yxkssj","yxjzsj","lrr","lrsj","bz"};
...
<CENTER >
  <B><font size="3">套餐外主材库－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
