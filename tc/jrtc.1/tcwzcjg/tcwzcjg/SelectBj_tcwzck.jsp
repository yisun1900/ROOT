...
<body bgcolor="#FFFFFF">
<form method="post" action="Bj_tcwzckList.jsp" name="selectform">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Bj_tcwzckList.jsp";
	FormName.submit();
	return true;
}
...
{
	if(	javaTrim(FormName.bj_tcwzck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.bj_tcwzck_dqbm.focus();
		return false;
	}
	if(	javaTrim(FormName.bj_tcwzck_clxlbm)=="") {
		alert("请选择[产品类别]！");
		FormName.bj_tcwzck_clxlbm.focus();
		return false;
	}
