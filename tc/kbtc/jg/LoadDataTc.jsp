...
String count=cf.executeQuery("select count(*) from tckb_tcjgb where dqbm='"+dqbm+"' and bjbbh='"+bjbbh+"'");
%>


<body bgcolor="#FFFFFF">
<CENTER><B>导入套餐总价</B><BR><HR>
<form method="post" action="" name="loadform" enctype="multipart/form-data" >
    <table width="100%" border="0">
      ...
      <tr align="center">
        <td height="33" align="right">已存在『<%=count%>』条：</td>
