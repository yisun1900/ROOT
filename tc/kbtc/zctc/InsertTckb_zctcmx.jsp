...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTckb_zctcmx.jsp" name="insertform"  >
<div align="center">录入－家具包明细</div>
<table width="101%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span><span class="STYLE2">家具包名称</span></td>
    <td><select name="tcbm" style="FONT-SIZE:12PX;WIDTH:152PX">
        <%
	cf.selectItem(out,"select tcbm,tcmc from tckb_zctcmc where tcbm="+tcbm+" order by tcmc",tcbm);
%>
      </select>    </td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%"><span class="STYLE1">*</span>包内单价</td> 
  <td width="32%"> 
