...
try {
	...
	ls_sql="select cpmc,xh,gg,ppmc,gysmc,jldw,ydj,tcdj,jsj,sl,lrr,lrsj,bz,kbwlbm,kbcpbm ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTckb_zctcmx.jsp" name="editform">
<div align="center">请修改信息（包编码:<%=tcbm%>）</div>
