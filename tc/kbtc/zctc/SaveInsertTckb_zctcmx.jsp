...
try {
	...
	ls_sql="insert into tckb_zctcmx ( cpbm,cpmc,tcbm,xh,gg,ppmc,gysmc,jldw,ydj,tcdj,jsj,sl,lrr,lrsj,bz,kbcpbm,kbwlbm ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,cpbm);
	ps.setString(2,cpmc);
	...
	ps.setDate(14,lrsj);
	ps.setString(15,bz);
	ps.setString(16,kbcpbm);
	ps.setString(17,kbwlbm);
