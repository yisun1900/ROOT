...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Tckb_bpgcxmList.jsp","","","EditTckb_bpgcxm.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Tckb_bpgcxmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from tckb_bpgcxm where "+chooseitem;
...
<CENTER >
  <B><font size="3">套餐标配工程项目－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
