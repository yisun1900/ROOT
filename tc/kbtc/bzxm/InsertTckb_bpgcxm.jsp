...
<div align="center">录入－套餐标配工程项目</div>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="xmbh" value="" size="20" maxlength="16" ></td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
%>
  ...
  <td align="right" width="18%"><font color="#FF0000">*</font>标配数量</td> 
...
%></td>
    ...
    <td><%
	cf.radioToken(out, "sfkth","Y+可替换&N+否","");
%></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="lrsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>  </td>
	...
	<P>
	<A HREF="套餐标配工程项目.xls"><B>点击右键另存为，下载Excel报价模板</B></A>	</td>
    </tr>
</table>
</form>
</body>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertTckb_bpgcxm.jsp";
	FormName.submit();
	return true;
}
...
function f_dc(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="ExpTckb_bpgcxm.jsp";
	FormName.submit();
	return true;
}
//-->
