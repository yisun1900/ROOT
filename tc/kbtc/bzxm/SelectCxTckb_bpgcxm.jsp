...
<body bgcolor="#FFFFFF">
<form method="post" action="Tckb_bpgcxmCxList.jsp" name="selectform">
<div align="center">套餐标配工程项目－查询</div>
...
{
	if(!(isDatetime(FormName.tckb_bpgcxm_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tckb_bpgcxm_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
