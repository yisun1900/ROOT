...
<body bgcolor="#FFFFFF">
<form method="post" action="Tckb_zckList.jsp" name="selectform">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Tckb_zckList.jsp";
	FormName.submit();
	return true;
}
...
{
	if(	javaTrim(FormName.tckb_zck_dqbm)=="") {
		alert("请选择[地区]！");
		FormName.tckb_zck_dqbm.focus();
		return false;
	}
	if(	javaTrim(FormName.tckb_zck_bjjbbm)=="") {
		alert("请输入[报价级别]！");
		FormName.tckb_zck_bjjbbm.focus();
		return false;
	}
