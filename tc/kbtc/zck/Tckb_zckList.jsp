...
//进行对象初始化
	pageObj.initPage("Tckb_zckList.jsp","","","EditTckb_zck.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数

//设置显示列
	String[] disColName={"dqmc","bjjbmc","cpbm","kbcpbm","kbwlbm","yxthsj","cpmc","ppmc","xh","gg","cptz","czlx","cpks","cplx","jldw","xdjldw","xdb","sh","sfxclxs","jsj","lsj","sjj","sfkgdj","cllx","cpdl","cpxl","gysmc","sfyx","yxkssj","yxjzsj","xuhao","lrr","lrsj","bz"};
...
//设置按钮参数
	...
	String[] buttonLink={"Tckb_zckList.jsp?","PlUpdateYxbz.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from tckb_zck where "+chooseitem;
