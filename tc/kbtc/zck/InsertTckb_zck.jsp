...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTckb_zck.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="kbwlbm" value="" size="20" maxlength="20" ></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="cpdl" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeDl(insertform)">
    <option value=""></option>
    <%
	cf.selectItem(out,"select cldlmc c1,cldlmc c2 from jxc_cldlbm where cldllb in('1','3') order by cldlmc","");
%>
  </select></td>
  <td align="right"><font color="#FF0000">*</font>产品小类</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="cpmc" value="" size="20" maxlength="100" ></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input name="cptz" type="text" value="" size="73" maxlength="100" ></td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right">材质类型</td>
  <td><input name="czlx" type="text"  value="" size="20" maxlength="50" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">产品款式</td>
  <td><input type="text" name="cpks" value="" size="20" maxlength="50" ></td>
  <td align="right">产品类型</td>
  <td><input name="cplx" type="text"  value="" size="20" maxlength="50" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>零售价</td>
  <td><input type="text" name="lsj" value="" size="20" maxlength="17" ></td>
  <td align="right"><font color="#FF0000">*</font>包内价</td>
  <td><input type="text" name="sjj" value="" size="20" maxlength="17" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="radio" name="yxthsj"  value="Y">
    ...
    否 </td>
  <td align="right"><font color="#FF0000">*</font>材料类型</td>
...
{
	strToItem(insertform.cpxl,ajaxRetStr);
}
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertTckb_zck.jsp";
	FormName.submit();
...
function f_dc(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="ExpTckb_zck.jsp";
	FormName.submit();
	return true;
}
//-->
