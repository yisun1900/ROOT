...
try {
	...
	ls_sql="insert into tc_zck ( cpbm,dqbm,bjjbbm,nbbm,cldl,clxl,cpmc,xh,gg,ppmc   ,gysmc,jldw,xdjldw,xdb,sh,sfxclxs,jsj,khxsdj,sjj1,sjj2     ,sjj3,sjj4,sjj5,sgddj,xuhao,lrr,lrsj,bz,lx,lbxmbm    ,cxxmbm,sfyx,yxkssj,yxjzsj ) ";
	ls_sql+=" values (           ?,?,?,?,?,?,?,?,?,?                               ,?,?,?,?,?,?,?,?,?,?                                       ,?,?,?,?,?,?,?,?,?,?                                 ,?,?,?,? ) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,cpbm);
	ps.setString(2,dqbm);
	...
	ps.setDouble(19,sjj1);
	ps.setDouble(20,sjj2);

	ps.setDouble(21,sjj3);
	ps.setDouble(22,sjj4);
	ps.setDouble(23,sjj5);
	ps.setDouble(24,sgddj);
	ps.setDouble(25,xuhao);
	ps.setString(26,lrr);
	ps.setDate(27,lrsj);
	ps.setString(28,bz);
	ps.setString(29,lx);
	ps.setString(30,lbxmbm);

	ps.setString(31,cxxmbm);
	ps.setString(32,sfyx);
	ps.setDate(33,yxkssj);
	ps.setDate(34,yxjzsj);
	ps.executeUpdate();
	ps.close();
