...
String lrr=null;
String lrsj=null;
String wherecxxmbm=cf.GB2Uni(request.getParameter("cxxmbm"));
...
try {
	...
	ls_sql="select cxxmbm,dqbm,bjjbbm,xmmc,ppmc,xh,jldw,dj,bz,lrr,lrsj ";
	ls_sql+=" from tc_cxxm";
...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_cxxm.jsp" name="editform" >
<div align="center">套餐促销项目－维护</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font>促销项目编码</td> 
  <td width="32%"><input type="text" name="cxxmbm" value="<%=cxxmbm%>" size="20" maxlength="6" ></td>
...
%>
  ...
  <td colspan="3"><select name="bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="dj" value="<%=dj%>" size="73" maxlength="17" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<input type="hidden" name="wherecxxmbm"  value="<%=wherecxxmbm%>" >
