...
String count=cf.executeQuery("select count(*) from tc_yhlbmx where dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"'");
%>


<body bgcolor="#FFFFFF">
<CENTER><B>导入套餐优惠项目</B><BR><HR>
...
function f_delete(FormName)
{
	...
	FormName.action="deleteBjxmYh.jsp";
	FormName.submit();
	return true;
} 
