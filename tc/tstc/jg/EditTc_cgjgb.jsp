...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,bzsl,bzmj,ccbfjj,sfkjm,jmdj,sjzj,lrr,lrsj ";
	ls_sql+=" from  tc_cgjgb";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_cgjgb.jsp" name="editform">
