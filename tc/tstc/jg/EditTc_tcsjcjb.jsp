...
try {
	...
	ls_sql="select dqbm,bjjbbm,bjjbbm1,tcsjflbm,jldw,sjcj,sjsfycx,cxkssj,cxjssj,cxsjcj ";
	ls_sql+=" from  tc_tcsjcjb";
	ls_sql+=" where  (dqbm='"+wheredqbm+"') and  (bjjbbm='"+wherebjjbbm+"') and  (bjjbbm1='"+wherebjjbbm1+"') and  (tcsjflbm='"+wheretcsjflbm+"')  ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_tcsjcjb.jsp" name="editform">
