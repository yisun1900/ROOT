...
//进行对象初始化
	pageObj.initPage("Tc_tcsjcjbList.jsp","","","EditTc_tcsjcjb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Tc_tcsjcjbList.jsp?","plxgcx.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from tc_tcsjcjb where "+chooseitem;
