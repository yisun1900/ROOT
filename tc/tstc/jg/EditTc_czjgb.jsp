...
try {
	...
	ls_sql="select dqbm,bjjbbm,tccplbbm,tccpdlbm,sfyqxtpp,jldw,sfkjm,jmdj,sjzj,lrr,lrsj,lx ";
	ls_sql+=" from  tc_czjgb";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditTc_czjgb.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><%
	cf.radioToken(out, "lx","1+套餐内&2+套餐外",lx);
%></td>
</tr>
<tr bgcolor="#FFFFFF">
