...
try {
	...
	for (int i=0;i<bjjbbm.length ;i++ )
	{
		...
		sql="insert into tc_tcsjcjb (dqbm,tcsjflbm,bjjbbm,bjjbbm1,jldw,sjcj,sjsfycx,cxkssj,cxjssj,cxsjcj) ";
		sql+=" values('"+dqbm+"','"+tcsjflbm[i]+"','"+bjjbbm[i]+"','"+bjjbbm1[i]+"','"+cf.GB2Uni(jldw[i])+"','"+sjcj[i]+"','"+sjsfycx[i]+"',TO_DATE('"+cxkssjstr[i]+"','YYYY-MM-DD')"+",TO_DATE('"+cxjssjstr[i]+"','YYYY-MM-DD'),'"+cxsjcjstr[i]+"')";
