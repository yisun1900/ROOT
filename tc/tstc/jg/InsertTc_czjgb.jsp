...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTc_czjgb.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="tccpdlbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
	cf.selectItem(out,"select cldlbm,cldlmc from jxc_cldlbm where cldlmc='瓷砖'","");
%>
  </select></td>
  ...
  <td><select name="tccplbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select clxlbm,clxlmc from jxc_clxlbm where cldlmc='瓷砖' order by clxlmc","");
%>
  </select></td>
</tr>
