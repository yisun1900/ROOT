...
<body bgcolor="#FFFFFF">
<form method="post" action="Tc_tcsjcjbCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
<!--  <td align="right" width="18%">报价版本号</td> 
  <td width="32%"> 
    <select name="tc_tcsjcjb_bjbbh" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
%>
  ...
  <td colspan="3"> 
    <select name="tc_tcsjcjb_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <select name="tc_tcsjcjb_bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
%>
  ...
  <td width="32%"> 
    <select name="tc_tcsjcjb_bjjbbm1" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
	cf.selectItem(out,"select bjjbbm,bjjbmc from bdm_bjjbbm where lx='2' order by bjjbbm","");
%>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="tcsjflbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select tcsjflbm,tcsjflmc from bdm_tcsjflbm order by tcsjflmc","");
%>
  </select></td>
  <td align="right" width="18%">计量单位</td> 
  <td width="32%"> 
    <select name="tc_tcsjcjb_jldw" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
