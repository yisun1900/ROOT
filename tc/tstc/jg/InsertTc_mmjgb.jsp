...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertTc_mmjgb.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="tccpdlbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
	cf.selectItem(out,"select cldlbm,cldlmc from jxc_cldlbm where cldlmc='门'","");
%>
  </select></td>
  ...
  <td><select name="tccplbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select clxlbm,clxlmc from jxc_clxlbm where cldlmc='门' order by clxlmc","");
%>
  </select></td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="bzmj" value="" size="20" maxlength="17" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">每个增加面积</td> 
  <td width="32%"> 
    <input type="text" name="mtmzjmj" value="" size="20" maxlength="17" >  </td>
  <td align="right" width="18%">超出部分加价</td> 
  <td width="32%"> 
    <input type="text" name="ccbfjj" value="" size="20" maxlength="17" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.mtmzjmj, "每个增加面积"))) {
		return false;
	}
