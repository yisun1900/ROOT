...
<body bgcolor="#FFFFFF">
<form method="post" action="Tc_bzgcxmCxList.jsp" name="selectform">
<div align="center">套餐标准工程项目－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">报价版本号</td> 
  <td colspan="3"> 
    <select name="tc_bzgcxm_bjbbh" style="FONT-SIZE:12PX;WIDTH:525PX">
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="tc_bzgcxm_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		out.println("<option value=\"\"></option>");
...
%>
  ...
  <td><select name="tc_bzgcxm_bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="tc_bzgcxm_xmbh" size="20" maxlength="16" ></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="tc_bzgcxm_lrr" size="20" maxlength="20" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入时间 从</td> 
  <td width="32%"><input type="text" name="tc_bzgcxm_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到 </td>
  <td width="32%"><input type="text" name="tc_bzgcxm_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
...
{
	if(!(isDatetime(FormName.tc_bzgcxm_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tc_bzgcxm_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
