...
<div align="center">录入－套餐主材项目 </div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="lrsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>  </td>
	...
	<P>
	<A HREF="CSH02-套餐主材项目.xls"><B>点击右键另存为，下载Excel报价模板</B></A>	</td>
    </tr>
</table>
</form>
</body>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertTc_tcbzzcxm.jsp";
	FormName.submit();
	return true;
}
...
function f_dc(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Exptc_tczcxm.jsp";
	FormName.submit();
	return true;
}
//-->
