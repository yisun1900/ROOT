...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Tc_tcbzzcxmCxList.jsp" name="selectform">
<div align="center">套餐标准主材项目－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<!--<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">报价版本号</td> 
  <td colspan="3"> 
    <select name="tc_tczcxm_bjbbh" style="FONT-SIZE:12PX;WIDTH:525PX">
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="tc_tczcxm_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		out.println("<option value=\"\"></option>");
...
%>
  ...
  <td><select name="tc_tczcxm_bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="tc_tczcxm_hxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
%>
  ...
  <td width="32%"><select name="tc_tczcxm_jgwzbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="tc_tczcxm_tccplbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="tc_tczcxm_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到 </td>
  <td><input type="text" name="tc_tczcxm_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="tc_tczcxm_lrr" size="20" maxlength="20" ></td>
...
{
	if(!(isDatetime(FormName.tc_tczcxm_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tc_tczcxm_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
