...
String[] dbhddzjj =request.getParameterValues("dbhddzjj");
...
try {
	...
	{
		sql="insert into tckd_tcjgb (dqbm,bjjbbm,hxbm,tcmc,fwmj,tcjg,pmzjdj,tlgbzjj,dbhddzjj) ";
		sql+=" values('"+dqbm+"','"+bjjbbm[i]+"','"+hxbm[i]+"','"+cf.GB2Uni(tcmc[i])+"','"+fwmj[i]+"','"+tcjg[i]+"','"+pmzjdj[i]+"','"+tlgbzjj[i]+"','"+dbhddzjj[i]+"')";
