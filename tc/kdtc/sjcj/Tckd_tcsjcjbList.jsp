...
//进行对象初始化
	pageObj.initPage("Tckd_tcsjcjbList.jsp","","","EditTckd_tcsjcjb.jsp");
...
//设置主键
	String[] keyName={"dqbm","bjjbbm","bjjbbm1","tccplbbm"};
	pageObj.setKey(keyName);

//设置按钮参数
	String[] buttonName={"删除选中的信息","批量修改促销"};//按钮的显示名称
	String[] buttonLink={"Tckd_tcsjcjbList.jsp?","plxgcx.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from tckd_tcsjcjb where "+chooseitem;
