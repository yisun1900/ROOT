...
try {
	...
	for (int i=0;i<bjjbbm.length ;i++ )
	{
		...
		sql="insert into tckd_tcsjcjb (dqbm,tccplbbm,bjjbbm,bjjbbm1,jldw,sjcj,sjsfycx,cxkssj,cxjssj,cxsjcj) ";
		sql+=" values('"+dqbm+"','"+tccplbbm[i]+"','"+bjjbbm[i]+"','"+bjjbbm1[i]+"','"+cf.GB2Uni(jldw[i])+"','"+sjcj[i]+"','"+sjsfycx[i]+"',TO_DATE('"+cxkssjstr[i]+"','YYYY-MM-DD')"+",TO_DATE('"+cxjssjstr[i]+"','YYYY-MM-DD'),'"+cxsjcjstr[i]+"')";
