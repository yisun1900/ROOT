...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT clxlbm,clxlmc,cldlmc,DECODE(sfxzsl,'1','不限制','2','不能超量','3','可超量需加价'),tcslxz,ccbfjj,DECODE(sfkjm,'1','不限制','2','限制'),yxjmzdsl ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="18%">材料小类名称</td>
	<td  width="18%">材料大类名称</td>
	<td  width="10%">是否限制数量</td>
	<td  width="10%">数量</td>
	<td  width="10%">超出部分加价</td>
	<td  width="10%">是否限制减免数量</td>
	<td  width="8%">允许减免最大数量</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
