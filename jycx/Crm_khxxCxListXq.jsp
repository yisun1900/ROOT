...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	crm_khxx_xqbm=request.getParameter("csmc");
	...
	ls_sql="SELECT dm_xqbm.xqmc,crm_khxx.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.hth,crm_khxx.sjs,b.dwmc sgd,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.qye,crm_khxx.jcjjqye,crm_khxx.jsje,gcjdmc  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_khxx.xqbm,khbh";
    pageObj.sql=ls_sql;
//进行对象初始化
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="9%" bgcolor="#FF0000" ><font color="#0000FF">小区</td>
	<td  width="5%">客户编号</td>
	<td  width="5%" >客户姓名 </td>
	<td  width="15%">房屋地址</td>
	<td  width="10%">联系方式</td>
