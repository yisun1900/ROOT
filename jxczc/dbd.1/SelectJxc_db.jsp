...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_dbList.jsp" name="selectform">
<div align="center">调拨单－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="jxc_db_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
