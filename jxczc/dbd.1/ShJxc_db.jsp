...
try {
	...
	ls_sql="select dbyy,dcgs,dcdq,drgs,lrr,lrsj,dwmc,jxc_db.bz ";
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "dbdzt","2+审核通过等待出库&7+审核未通过","");
%></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "jgzyk","Y+经过中央库&N+否","");
%></td>
  <td align="right">调经仓库</td>
  <td><select name="djck" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select jxc_ckmc.ckbh,ckmc from jxc_ckmc where cksslx='0'  order by ckmc","");
%>
  </select></td>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShJxc_db.jsp";
	FormName.submit();
	return true;
}
