...
try {
	...
	ls_sql=" select clbm,clmc,ppmc,xh,nbbm,scph,kcsl,jxc_kcb.ckbh,jxc_kcb.hjbh,hjmc,hwbh";
	ls_sql+=" from jxc_kcb,jxc_hjmc ";
	ls_sql+=" where jxc_kcb.hjbh=jxc_hjmc.hjbh(+) ";
	ls_sql+=" and lsh='"+lsh+"'";
...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertJxc_hjtzmx.jsp" name="insertform">
