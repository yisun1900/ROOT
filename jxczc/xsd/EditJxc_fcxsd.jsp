...
<div align="center">请修改销售单（销售批号：<%=xsph%>）</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>销售单类型</td> 
  <td width="32%"> 
    <select name="xsdlx" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
	cf.selectItem(out,"select xsdlx,xsdlxmc from dm_xsdlx order by xsdlx",xsdlx);
%>
    </select>  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="shfmc" size="73" maxlength="50"  value="<%=shfmc%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
