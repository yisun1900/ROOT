...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jxc_clsgd.sgdzt in('2','6')";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jxc_clsgdXgShList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"Jxc_clsgdXgShList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update jxc_clsgd set sgdzt='1',shr=null,shrq=null,shyj=null where sgdzt in('2','6') and "+chooseitem;
