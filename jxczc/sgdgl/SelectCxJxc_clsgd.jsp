...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_clsgdCxList.jsp" name="selectform">
<div align="center">申购单－查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">是否转为订单</td> 
  <td colspan="3">
	<input type="radio" name="jxc_clsgd_sfzcgd" value="N">未转 
	<input type="radio" name="jxc_clsgd_sfzcgd" value="Y">转为采购计划
	<input type="radio" name="jxc_clsgd_sfzcgd" value="M">转为供应商订单  </td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right">申购类别</td>
  <td><input type="radio" name="jxc_clsgd_sglb" value="0">
主材
  <input type="radio" name="jxc_clsgd_sglb" value="1">
辅材</td>
  <td align="right">申购单类型</td>
  <td><input type="radio" name="sgdlx" value="1">录入
  <input type="radio" name="sgdlx" value="2">主材订单</td>
</tr>
<tr bgcolor="#FFFFFF">
