...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (kcbj!=null)
	{
		if (kcbj.equals("1"))
		{
			wheresql+=" and jxc_cljgb.zcpzsl<jxc_cljgb.zdkcsl";
		}
		else if (kcbj.equals("2"))
		{
			wheresql+=" and jxc_cljgb.zcpzsl=jxc_cljgb.zdkcsl";
		}
		else if (kcbj.equals("3"))
		{
			wheresql+=" and ((jxc_cljgb.zcpzsl>jxc_cljgb.zdkcsl) OR jxc_cljgb.zdkcsl is null) ";
		}
	}
...
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_kcbCxList.jsp","","","");
