...
%>
  ...
  <td width="15%" align="right" bgcolor="#FFFFFF">来源单号</td>
  <td width="35%" bgcolor="#FFFFFF"><input type="text" name="lydh" size="20" maxlength="13" ></td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
