...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		ls_sql="SELECT jxc_kcb.lsh,DECODE(jxc_kcb.ztbz,'Y','在途','N','否'),jxc_kcb.clbm,jxc_kcb.nbbm,jxc_kcb.clmc,'<img src=\"/jxc/jxc_clbm/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">' zp,jxc_kcb.kcsl,TO_CHAR(jxc_kcb.rkj),TO_CHAR(jxc_kcb.yfrkj),TO_CHAR(jxc_kcb.jqpjcbj),TO_CHAR(jxc_kcb.yfjqpjcbj),jxc_kcb.kcje,jxc_kcb.yfkcje,TO_CHAR(jxc_cljgb.xsj),jxc_kcb.kcsl*jxc_cljgb.xsj,TO_CHAR(jxc_cljgb.lsj),dqmc,ckmc,hjmc,hwmc,DECODE(jxc_kcb.cllb,'0','主材','1','辅材'),jxc_kcb.cldlbm,jxc_kcb.clxlbm,jxc_kcb.scsmc,jxc_kcb.ppmc,jxc_kcb.gysmc,jxc_kcb.cllbbm,jxc_kcb.xh,jxc_kcb.gg,jxc_kcb.clysbm,jxc_kcb.jldwbm,jxc_kcb.pjts,jxc_kcb.cpjb,jxc_kcb.fgsx,jxc_kcb.cpsm,jxc_kcb.cd,jxc_kcb.cgzq,jxc_kcb.bz  ";
	}
	else
	{
		ls_sql="SELECT jxc_kcb.lsh,DECODE(jxc_kcb.ztbz,'Y','在途','N','否'),jxc_kcb.clbm,jxc_kcb.nbbm,jxc_kcb.clmc,'' zp,jxc_kcb.kcsl,TO_CHAR(jxc_kcb.rkj),TO_CHAR(jxc_kcb.yfrkj),TO_CHAR(jxc_kcb.jqpjcbj),TO_CHAR(jxc_kcb.yfjqpjcbj),jxc_kcb.kcje,jxc_kcb.yfkcje,TO_CHAR(jxc_cljgb.xsj),jxc_kcb.kcsl*jxc_cljgb.xsj,TO_CHAR(jxc_cljgb.lsj),dqmc,ckmc,hjmc,hwmc,DECODE(jxc_kcb.cllb,'0','主材','1','辅材'),jxc_kcb.cldlbm,jxc_kcb.clxlbm,jxc_kcb.scsmc,jxc_kcb.ppmc,jxc_kcb.gysmc,jxc_kcb.cllbbm,jxc_kcb.xh,jxc_kcb.gg,jxc_kcb.clysbm,jxc_kcb.jldwbm,jxc_kcb.pjts,jxc_kcb.cpjb,jxc_kcb.fgsx,jxc_kcb.cpsm,jxc_kcb.cd,jxc_kcb.cgzq,jxc_kcb.bz  ";
	}
...
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_kcbTqCxList.jsp","","","");
...
<CENTER >
  <B><font size="3">主材库存查询－特权</font></B>
</CENTER>
<%
	pageObj.out=out;
