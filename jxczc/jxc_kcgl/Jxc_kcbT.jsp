...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		ls_sql="SELECT dqmc,jxc_kcb.clbm clbm,jxc_kcb.clmc clmc,jxc_kcb.xh xh,jxc_kcb.gg gg,jxc_kcb.nbbm nbbm,jldwbm,SUM(jxc_kcb.kcsl),SUM(jxc_kcb.kcje),SUM(jxc_kcb.yfkcje),'<img src=\"/jxc/jxc_clbm/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">' zp ";
	}
	else
	{
		ls_sql="SELECT dqmc,jxc_kcb.clbm clbm,jxc_kcb.clmc clmc,jxc_kcb.xh xh,jxc_kcb.gg gg,jxc_kcb.nbbm nbbm,jldwbm,SUM(jxc_kcb.kcsl),SUM(jxc_kcb.kcje),SUM(jxc_kcb.yfkcje),'' zp ";
	}
	...
	if (sfxstp!=null && sfxstp!="")
	{
		ls_sql+=" group by dqmc,jxc_kcb.clbm,jxc_kcb.clmc,jxc_kcb.xh,jxc_kcb.gg,jxc_kcb.nbbm,'<img src=\"/jxc/jxc_clbm/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">',jldwbm";
	}
	else
	{
		ls_sql+=" group by dqmc,jxc_kcb.clbm,jxc_kcb.clmc,jxc_kcb.xh,jxc_kcb.gg,jxc_kcb.nbbm,'',jldwbm ";
	}
//	ls_sql+=ordersql;
