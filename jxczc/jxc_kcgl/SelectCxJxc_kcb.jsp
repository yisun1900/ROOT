...
<tr bgcolor="#99FFCC">
  <td align="right" class="STYLE1">所在地区</td>
  <td><select name="jxc_kcb_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changedqbm(selectform)">
    <%
...
%>
  ...
  <td align="right" class="STYLE1">库存报警</td>
  <td>
    <input type="radio" name="kcbj" value="1">报警
    <input type="radio" name="kcbj" value="2">
    即将报警
    <input type="radio" name="kcbj" value="3">未报警  </td>
</tr>
<tr bgcolor="#FFFFFF">
