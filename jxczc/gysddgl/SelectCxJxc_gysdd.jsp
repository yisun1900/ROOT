...
if (yhjs.equals("G0"))
{
	gysmc=cf.executeQuery("select gysmc from jxc_gysxx where gysbm='"+ygbh+"' order by gysmc");
	readMark="readonly";
}
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="jxc_gysdd_gysmc" size="20" maxlength="50" value="<%=gysmc%>" <%=readMark%>></td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	<INPUT name="jxc_gysdd_cllb" type="radio" value="0" checked>
	主材	</td>
</tr>
<tr bgcolor="#FFFFFF">
