...
<body bgcolor="#FFFFFF">
<form method="post" action="SavePlInsertJxc_gysdd.jsp" name="insertform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input name="cllb" type="radio"  value="0" checked>主材 </td>
</tr>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#0000CC">申购批号</font></td>
  <td colspan="3">
  <%
	for (int i=0;i<sgph.length ;i++ )
	{
		%>
		<A HREF="/jxczc/sgdgl/ViewJxc_clsgd.jsp?sgph=<%=sgph[i]%>" target="_blank"><%=sgph[i]+"、"%></A>
		<input type="hidden" name="sgph" value="<%=sgph[i]%>" >
		<%
	}
