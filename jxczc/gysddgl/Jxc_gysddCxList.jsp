...
//设置列超级连接
	...
	coluParm.link="/jxczc/gysddgl/ViewJxc_gysdd.jsp";//为列参数：coluParm.link设置超级链接
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="2%">&nbsp;</td>
	<td  width="3%">供应商订单批号</td>
	<td  width="3%">订单状态</td>
	<td  width="4%">直接入库申购单位</td>
	<td  width="3%">申购批号</td>
	<td  width="5%">申购公司</td>
	<td  width="5%">下单公司</td>
	<td  width="2%">地区</td>
