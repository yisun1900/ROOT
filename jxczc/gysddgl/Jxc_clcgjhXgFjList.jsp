...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jxc_clcgjh.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clcgjhXgFjList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"删除订单"};//按钮的显示名称
	String[] buttonLink={"DeleteFjJxc_clcgjh.jsp"};//按钮单击调用的网页，可以增加参数
...
//设置列超级连接
	...
	coluParm.link="/jxczc/cgjhgl/ViewJxc_clcgjh.jsp";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">删除【由采购计划】生成的供应商订单</font></B>
</CENTER>
<%
	pageObj.out=out;
