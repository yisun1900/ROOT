...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_gysddXdList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"批量下单"};//按钮的显示名称
	String[] buttonLink={"Jxc_gysddXdList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update jxc_gysdd set ddzt='1',xdr='"+yhmc+"',xdrq=SYSDATE where ddzt='0' and "+chooseitem;
