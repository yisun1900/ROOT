...
String cllb=request.getParameter("cllb");
%>
<html>
<head>
<title>录入数据</title>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">规格（双击可选择）</td> 
  ...
  <input type="hidden" name="dqbm" value="<%=dqbm%>" size="20" maxlength="50" readonly>
   <input type="hidden" name="cllb" value="<%=cllb%>" size="20" maxlength="50" readonly>
  ...
  <input type="hidden" name="cgjhph" value="<%=cgjhph%>" size="20" maxlength="50" readonly>
   <input type="hidden" name="cglb" value="<%=cglb%>" size="20" maxlength="50" readonly>
...
//			FormName.clbm.value=bmvalue;
		...
		//击【其它】键
			...
			//执行Ajax查询
			actionStr="GetGgListByAjax.jsp?dqbm="+FormName.dqbm.value+"&xh="+FormName.xh.value+"&cglb="+FormName.cglb.value+"&cllb="+FormName.cllb.value ;
