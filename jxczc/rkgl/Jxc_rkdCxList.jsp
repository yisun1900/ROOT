...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_rkd.rkph,DECODE(jxc_rkd.rkdzt,'0','未提交','1','等待审核','2','等待入库','3','已入库','4','已结算','6','等待总部审核'),DECODE(jxc_rkd.rklx,'C','采购入库','T','退货入库','R','调拨入库','S','申购入库','J','代金券退货入库','D','主材订单退货','F','发货单入库','Z','直接入库') rklx,jxc_ckmc.ckmc,jxc_rkd.rkr,jxc_rkd.rksj,jxc_rkd.rkzje,jxc_rkd.yf,jxc_rkd.qtfy,dm_dqbm.dqmc,jxc_rkd.gysmc,jxc_rkd.lydh,jxc_rkd.bz";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jxc_rkdCxList.jsp","","","/jxcdy/printzcrkd.jsp");
