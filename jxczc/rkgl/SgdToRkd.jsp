...
String gysddph=cf.GB2Uni(request.getParameter("lydh"));
...
<html>
<head>
<title>申购单－直接入库申购公司</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF">
<div align="center">申购单－直接入库申购公司
  <input type="button" value="申购单入库" onclick="window.close();window.open('SaveSgdToRkd.jsp?gysddph=<%=gysddph%>&rkph=<%=rkph%>');">
</div>
...
<%
	...
	ls_sql="SELECT dhxh,clbm,nbbm,clmc,xh,gg,jldwbm,TO_CHAR(cbj),dhsl,dhje,pssl,ppmc,clxlbm ";
	ls_sql+=" FROM jxc_gysddmx ";
    ls_sql+=" where gysddph='"+gysddph+"'";
