...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">型号（双击可选择）</td> 
...
//			FormName.clbm.value=bmvalue;
		...
		//击【其它】键
			...
			//执行Ajax查询
			actionStr="GetXhListByAjax.jsp?dqbm="+FormName.dqbm.value+"&xh="+FormName.xh.value+"&cglb="+FormName.cglb.value+"&cllb="+FormName.cllb.value ;
