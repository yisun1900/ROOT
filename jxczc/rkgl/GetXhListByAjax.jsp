...
try {
	conn=cf.getConnection();
		...
		ls_sql=" SELECT jxc_cljgb.clbm clbm,xh ";
		ls_sql+=" FROM jxc_cljgb,jxc_clbm ";
		ls_sql+=" where jxc_cljgb.clbm=jxc_clbm.clbm and dqbm='"+dqbm+"' and jxc_clbm.cllb='"+wherecllb+"' and xh like '"+wherexh+"%' and jxc_clbm.cglb='"+wherecglb+"' ";
		ls_sql+=" order by xh ";
//		out.println(ls_sql); 
