...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertJxc_db.jsp" name="insertform" >
<div align="center">调拨单－录入</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>调出公司</td> 
  <td width="32%"> 
    <select name="dcgs" style="FONT-SIZE:12PX;WIDTH:152PX">
<%
...
%>
  ...
  <td align="right" width="18%"><span class="STYLE1">*</span>调入公司</td> 
  <td width="32%"><select name="drgs" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
