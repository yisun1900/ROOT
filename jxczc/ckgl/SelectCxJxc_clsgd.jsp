...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<input name="jxc_clsgd_sfzcgd" type="radio" value="N" >未转
	<input name="jxc_clsgd_sfzcgd" type="radio" value="Y" >转为采购计划
	<input name="jxc_clsgd_sfzcgd" type="radio" value="M" >转为供应商订单	</td>
  </tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input name="jxc_clsgd_sglb" type="radio" value="1" checked>
辅材</td>
</tr>
<tr bgcolor="#FFFFFF">
