...
%>  </td>
  ...
  <select name="jxc_ckd_ckdzt" style="FONT-SIZE:12PX;WIDTH:152PX">
	<option value=""></option>
	<option value="0">录入未提交</option>
	<option value="1">等待报废审核</option>
	<option value="2">等待退货审核</option>
	<option value="3">等待调拨入库</option>
	<option value="4">已结算</option>
	<option value="5">退货审核通过</option>
	<option value="6">报废审核未通过</option>
	<option value="7">退货审核未通过</option>
