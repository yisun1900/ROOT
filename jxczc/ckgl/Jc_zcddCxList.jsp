...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,DECODE(jc_zcdd.sfck,'1','未出库','2','部分出库','3','已出库') sfck,crm_khxx.khxm,crm_khxx.fwdz,ppbm,jc_zcdd.htshsj,jc_zcdd.jhshsj,jc_zcdd.tzshsj,jc_zcdd.tzshr,jc_zcdd.tzry,crm_khxx.hth,crm_khxx.sgbz,jc_zcdd.clgw,jc_zcdd.xmzy,jc_zcdd.hkze,jc_zcdd.zjhze,jc_zcdd.shtzsm,jc_zcdd.gys,DECODE(jc_zcdd.ddshbz,'1','不需待电','2','待电未通知','3','待电已通知')";
	ls_sql+=" FROM crm_khxx,jc_zcdd,jdm_zcddzt ";
    ls_sql+=" where jc_zcdd.khbh=crm_khxx.khbh";
    ls_sql+=" and jc_zcdd.clzt=jdm_zcddzt.clzt(+)  ";
    ls_sql+=" and jc_zcdd.clzt in('09','11','13','15','17','18','20')";//11：合同已确认；13：工厂已接收；15：确定送货时间；17：已通知送货
	ls_sql+=" and jc_zcdd.ddlx='4'";//4：有库存订单
	ls_sql+="  and jc_zcdd.sfck in('1','2')";//1：未出库；2：部分出库；3：已出库
	if (yhjs.equals("G0"))
	{
