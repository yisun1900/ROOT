...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <select name="jxc_ckd_dqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <select name="jxc_ckd_fgsbh" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
%>  </td>
  ...
  <td width="32%"> 
    ...
    <option value=""></option>
<%
	cf.selectToken(out,"D+订单出库&B+报废出库&T+退货出库&S+申购出库&P+材料单出库&J+辅材代金券出库&X+销售出库&R+调拨出库","");
%>
    </select>  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="jxc_ckd_jhshsj" size="20" maxlength="10" ></td>
  <td align="right">到</td>
  <td><input type="text" name="jxc_ckd_jhshsj2" size="20" maxlength="10" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="jxc_ckd_cksj" size="20" maxlength="10" ></td>
  <td align="right">到</td>
  <td><input type="text" name="jxc_ckd_cksj2" size="20" maxlength="10" ></td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="jxc_ckd_lrsj" size="20" maxlength="10" ></td>
  <td align="right">到</td>
  <td><input type="text" name="jxc_ckd_lrsj2" size="20" maxlength="10" ></td>
</tr>
<tr bgcolor="#FFFFFF">
