...
try {
	...
	//1：未出库；2：部分出库；3：已出库
	if (!sfck.equals("1") && !sfck.equals("2") )
	{
		out.print("错误！主材订单["+lydh+"]出库状态不正确，应为【1：未出库；2：部分出库】！");
		return;
	}
	...
	response.sendRedirect("EditJxc_ckdDd.jsp?lx=1&ckph="+ckph);
}
catch (Exception e) {
