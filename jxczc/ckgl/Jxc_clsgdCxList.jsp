...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jxc_clsgd.sgdzt in('2','5')";
    ls_sql+=" and jxc_clsgd.sfrksgdw='N'";//是否直接入库申购公司
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jxc_clsgdCxList.jsp","","","InsertJxc_ckdSgd.jsp?cklx=S");
