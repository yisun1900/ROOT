...
try {
	...
	ls_sql+=" ,DECODE(sfth,'Y','送货','N','未送货') sfth,ddbh,thdbh,sgph,psph,dbph,czxh,xsph,rkph,cklx,jxc_ckd.khbh,jxc_ckd.lydh,DECODE(jxc_ckd.sfyfkc,'1','无负库存','2','负库存未入库','3','负库存入库') sfyfkc,DECODE(jxc_ckd.ckjxz,'1','取价格表','2','取入库时销售价','3','取材料单价格') ckjxz";
...
<%	
	...
	ls_sql="SELECT nbbm,clmc,xh,gg,ppmc,gysmc,DECODE(zljb,'1','<font color=green>正常品</font>','2','<font color=blue>残次品</font>','3','<font color=red>报废品</font>'),jldwbm,jxc_ckmx.cksl,TO_CHAR(jxc_ckmx.ckdj),jxc_ckmx.ckje,DECODE(jxc_ckmx.sfyfkc,'1','无','2','有负库存'),jxc_ckmx.fkcs,jxc_ckmc.ckmc,jxc_hjmc.hjmc,jxc_ckmx.scph,clbm";
