...
<%
	if (yhjs.equals("G0"))
	{
		...
		cf.selectItem(out,"select sq_dwxx.dwbh,sq_dwxx.dwmc from sq_gyssqfgs,sq_dwxx where sq_gyssqfgs.ssfgs=sq_dwxx.dwbh and sq_gyssqfgs.gysbm='"+ygbh+"' order by sq_dwxx.dwbh","");
        out.println("        </select>");
	}
	else
	{
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <select name="clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="15">确定送货时间</option>
                  <option value="17">已通知送货</option>
                </select>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="jhshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jhshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
