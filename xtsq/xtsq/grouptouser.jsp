...
<%
	String sql="";
	sql=" select yhdlm,yhdlm||yhmc||'（'||dwmc||'）'||'（'||zwmc||'）' from sq_yhxx,sq_dwxx,dm_zwbm where sq_yhxx.dwbh=sq_dwxx.dwbh(+) and sq_yhxx.zwbm=dm_zwbm.zwbm(+) and yhdlm not in(select yhdlm from sq_yhssz where yhzbh='000000') order by sq_yhxx.dwbh,yhmc";
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <select name="yhzbh" style="FONT-SIZE:12px;WIDTH:160px;" size="13" multiple  ondblclick="codeDBClick(insertform)">
                  <%
	cf.selectItem(out,"select sq_yhssz.yhzbh,yhzmc  from sq_yhssz,sq_yhz where sq_yhssz.yhzbh=sq_yhz.yhzbh and  sq_yhz.yhzbh!='000000' and jb='1' and yhdlm='"+yhdlm+"' order by yhzmc","");
%> 
                </select>
              </td>
              ...
              <td width="31%"> 
                <select name="yhzbh1" style="FONT-SIZE:12px;WIDTH:160px" size="13" multiple ondblclick="code1DBClick(insertform)">
                  <%
cf.selectItem(out,"select yhzbh,yhzmc from sq_yhz where jb='1' and  sq_yhz.yhzbh!='000000' and yhzbh not in(select yhzbh from sq_yhssz where yhdlm='"+yhdlm+"') order by yhzmc","");
%> 
                </select>
              </td>
            </tr>
