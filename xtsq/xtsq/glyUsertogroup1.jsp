...
<%
	...
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'警告！非法侵入[管理员授权]："+xtrzyhmc+"') ";
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td colspan="4"> 
                <select name="yhzbh" style="FONT-SIZE:12px;WIDTH:152px" onChange="selectgroup(insertform)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select yhzbh,yhzmc from sq_yhz where jb!='1' and yhzbh!='000000' order by yhzmc","");
%> 
                </select>
              </td>
            </tr>
...
function submit_onclick(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="saveglyUsertogroup.jsp";
	FormName.submit();
	return true;
}
//-->
