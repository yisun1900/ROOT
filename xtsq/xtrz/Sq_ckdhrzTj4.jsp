...
<%
	...
	ls_sql="SELECT a.dwmc,b.dwmc bm,zwmc,sq_ckdhrz.yhdlm,sq_yhxx.yhmc,sq_ckdhrz.ip ,count(*) cc";
    ...
    ls_sql+=wheresql;
	ls_sql+=" group by sq_ckdhrz.yhdlm,sq_yhxx.yhmc,a.dwmc,b.dwmc,zwmc,sq_ckdhrz.ip";
	ls_sql+=" order by sq_ckdhrz.yhdlm,cc desc,sq_ckdhrz.ip";
