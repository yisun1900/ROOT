...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 市场部客户查看日志</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
//					cf.selectItem(out,"select dwbh,dwmc from sq_dwxx  order by ssfgs,dwbh","");
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="text" name="scbkhbh" size="20" maxlength="20" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="清空日志" onClick="window.open('DeleteSq_scbkhckrz.jsp')">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_scbkhckrzList.jsp";
	FormName.submit();
	return true;
}
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_scbkhckrzTj.jsp";
	FormName.submit();
