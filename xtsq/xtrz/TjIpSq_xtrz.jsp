...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT a.dwmc,b.dwmc bm,zwmc,sq_xtrz.yhdlm,sq_yhxx.yhmc,sq_xtrz.ip ,count(*) cc,'<A HREF=\"ViewIpSq_xtrz.jsp?yhdlm='||sq_xtrz.yhdlm||'&ip='||sq_xtrz.ip||'\" target=\"_blank\">查看</A>' ";
	...
	ls_sql+=" group by sq_xtrz.yhdlm,sq_yhxx.yhmc,a.dwmc,b.dwmc,zwmc,sq_xtrz.ip";
	ls_sql+=" order by cc";
