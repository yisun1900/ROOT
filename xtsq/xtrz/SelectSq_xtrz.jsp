...
//					cf.selectItem(out,"select dwbh,dwmc from sq_dwxx  order by ssfgs,dwbh","");
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">登陆时间 从</td>
              <td width="33%"> 
...
%>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="登陆次数统计" onClick="f_do1(selectform)">
                <input type="button" onClick="f_do2(selectform)"  value="IP地址统计">
                <input type="button" onClick="f_do3(selectform)"  value="可疑登陆">
                <input type="button"  value="清空日志" onClick="window.open('DeleteXtrz.jsp')">
                <input name="button" type="button" onClick="window.open('DeleteCfXtrz.jsp')"  value="清出重复日志">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.dlsj2, "登陆时间"))) {
		return false;
	}
