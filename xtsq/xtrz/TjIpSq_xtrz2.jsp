...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT a.dwmc,b.dwmc bm,zwmc,sq_xtrz.yhdlm,sq_yhxx.yhmc,sq_xtrz.ip1||'.'||sq_xtrz.ip2 ,count(*) cc ";
	...
	ls_sql+=" group by sq_xtrz.yhdlm,sq_yhxx.yhmc,a.dwmc,b.dwmc,zwmc,sq_xtrz.ip1,sq_xtrz.ip2";
	ls_sql+=" order by cc";
