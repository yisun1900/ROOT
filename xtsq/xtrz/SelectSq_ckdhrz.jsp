...
//					cf.selectItem(out,"select dwbh,dwmc from sq_dwxx  order by ssfgs,dwbh","");
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td width="33%">
                <input type="text" name="fwdz" size="20" maxlength="50" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">查看时间 从</td>
              <td width="33%"> 
                <input type="text" name="cksj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="cksj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="姓名地址统计" onClick="f_do1(selectform)">
                <input name="button" type="button" onClick="f_do2(selectform)"  value="姓名统计">
                <input name="button2" type="button" onClick="f_do3(selectform)"  value="地址统计">
                <input name="button3" type="button" onClick="f_do4(selectform)"  value="姓名地址对照">
                <input type="button"  value="清空日志" onClick="window.open('Deletesq_ckdhrz.jsp')">
...
{
	if(!(isDatetime(FormName.cksj, "查看时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cksj2, "查看时间"))) {
		return false;
	}

	FormName.action="Sq_ckdhrzList.jsp";
	FormName.submit();
	return true;
}
...
function f_do2(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_ckdhrzTj2.jsp";
	FormName.submit();
...
function f_do3(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_ckdhrzTj3.jsp";
	FormName.submit();
...
function f_do4(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_ckdhrzTj4.jsp";
	FormName.submit();
