...
//					cf.selectItem(out,"select dwbh,dwmc from sq_dwxx  order by ssfgs,dwbh","");
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="清空日志" onClick="window.open('DeleteSq_ckxxrz.jsp')">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.dlsj, "查看时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.dlsj2, "查看时间"))) {
		return false;
	}
