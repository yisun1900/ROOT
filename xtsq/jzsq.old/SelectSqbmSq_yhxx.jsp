...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input name="button" type="button" onClick="f_do1(selectform)"  value="按店面批量授权">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_yhxxSqbmList.jsp";
	FormName.submit();
	return true;
}
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Sq_dwxxSqbmList.jsp";
	FormName.submit();
	return true;
}
