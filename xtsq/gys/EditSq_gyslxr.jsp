...
String wherelxrxm=request.getParameter("lxrxm");
...
try {
	...
	ls_sql="select lxrxm,zw,sj,bgdh,cz,sflz,bz ";
...
<form method="post" action="SaveEditSq_gyslxr.jsp" name="editform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"> 
                <select name="gysbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectItem(out,"select gysbm,gys from sq_gysbm where gysbm='"+gysbm+"'","");
%> 
                </select>
              </td>
