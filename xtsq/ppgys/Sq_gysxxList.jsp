...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  sq_gysxx.dqbm,sq_gysxx.gysbh,sq_gysxx.gysmc,sq_gysxx.cwdm,mrazhs,DECODE(sq_gysxx.gyslb,'1','木门','2','橱柜','3','家具','4','主材') gyslb,DECODE(sq_gysxx.sfyyh,'Y','是','N','否') sfyyh,sq_gysxx.yhkssj,sq_gysxx.yhjzsj,sq_gysxx.yhnr,zclb,sq_gysxx.ppmc,sq_gysxx.gys,sq_gysxx.ppbm,sq_gysxx.gysbm,dm_dqbm.dqmc, sq_gysxx.bz  ";
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSq_gysxx.jsp"};//按钮单击调用的网页，可以增加参数
