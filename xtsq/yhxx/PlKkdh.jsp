...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"><font color="#000099"><b>查看客户电话－－批量授权</b></font> 
      </div>
    </td>
  </tr>
	<tr> 
...
<form method="post" action="SavePlKkdh.jsp" name="insertform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF">
              <td width="50%" height="68" align="right"><font color="#CC0000">*</font>查看客户电话标志</td>
              <td width="50%">
				  <input type="radio" name="khdhbz" value="Y">可看
				  <BR>
				  <input type="radio" name="khdhbz" value="N">不可看 
			  </td>
            </tr>
