...
<body bgcolor="#FFFFFF">
<form method="post" action="getZhYhmm.jsp" name="insertform" >
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
	<tr bgcolor="#FFFFFF"> 
	  <td colspan="2" height="89" align="center"> 
		...
		<p><b><font color="#FF00CC">注意：本功能只限设计师</font></b></p>			  </td>
	</tr>

	<tr bgcolor="#FFFFFF">
	  <td width="48%" height="27" align="right" bgcolor="#CCFFFF"><font color="#FF0000">*</font>所属公司</td>
	  <td width="52%" bgcolor="#CCFFFF"><select name="ssfgs" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeFgs(insertform)">
        <%
