...
try {
	...
	ls_sql="select txfs,txjg,zdsjf,zgsjf,mrsjf,zdmll,sfkdybj,sfyxzhmm,kfgssq,mmsyzq,yxdlsbcs,bsxtsmmzq,kkglfx,khdhbz,yhdlm,yhmc,yhkl,yhjs,dwbh,xb,csrq,dh,email,zz,bz,zwbm,ckjgbz,zdyhbz,kdlxtbz,bjjb,sjsbh,ssfgs,kkbbz,sjxzbz,sbsj,xbsj,ipxzbz,ipdz,wkxzbz,wkdz,sqtszkcs ";
	ls_sql+=" from  sq_yhxx";
			...
			<tr> 
			  <td colspan="4" height="2"> 
				<div align="center"> 
				  ...
				  <input type="button" onClick="window.open('hxsq.jsp?ygbh=<%=whereygbh%>')"  value="设计师户型授权">
				</div>			  </td>
			</tr>
            <tr bgcolor="#CCCCFF"> 
...
%></td>
            ...
            <tr bgcolor="#CCCCFF">
              <td align="right">设计师最低设计费</td>
              <td><input type="text" name="zdsjf" size="20" maxlength="16"  value="<%=zdsjf%>" ></td>
              <td align="right">设计师最高设计费</td>
              <td><input type="text" name="zgsjf" size="20" maxlength="16"  value="<%=zgsjf%>" ></td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="18%" align="right">设计师默认设计费</td>
              <td width="32%"><input type="text" name="mrsjf" size="20" maxlength="16"  value="<%=mrsjf%>" ></td>
              <td colspan="2"><strong>每平米收设计费标准</strong></td>
            </tr>
...
%></td>
              <td rowspan="13" align="right" bgcolor="#CCFFFF"><font color="#FF0000">*</font>客户资料授权范围 </td>
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="wkdz" size="20" maxlength="200"  value="<%=wkdz%>" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="bsxtsmmzq" size="10" maxlength="16"  value="<%=bsxtsmmzq%>" >
天 <br>
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">提醒间隔</td>
              <td width="32%"><input type="text" name="txjg" size="10" maxlength="16"  value="<%=txjg%>" >
                秒</td>
            </tr>
            <tr> 
              <td colspan="4" height="2"> 
...
*/
	...
	if(	javaTrim(FormName.zdsjf)=="") {
		alert("请输入[最低设计费]！");
		FormName.zdsjf.focus();
		return false;
	}
	if(!(isFloat(FormName.zdsjf, "最低设计费"))) {
		return false;
	}
	if(	javaTrim(FormName.zgsjf)=="") {
		alert("请输入[最高设计费]！");
		FormName.zgsjf.focus();
		return false;
	}
	if(!(isFloat(FormName.zgsjf, "最高设计费"))) {
		return false;
	}
	if(	javaTrim(FormName.mrsjf)=="") {
		alert("请输入[默认设计费]！");
		FormName.mrsjf.focus();
		return false;
	}
	if(!(isFloat(FormName.mrsjf, "默认设计费"))) {
		return false;
	}
...
function f_sq(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/xtsq/xtsq/grouptouser.jsp";
	FormName.submit();
	return true;
}
//-->
