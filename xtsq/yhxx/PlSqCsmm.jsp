...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"><font color="#000099"><b>授权初始密码</b></font>      </div>    </td>
  </tr>
...
<form method="post" action="SavePlSqCsmm.jsp" name="insertform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF">
              <td width="50%" height="68" align="center"><strong><font color="#FF0000" size="6">把【密码】设为【111111】</font></strong></td>
            </tr>
