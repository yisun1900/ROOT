...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ckjgbz.equals("Y"))
	{
		ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm, DECODE(crm_khxx.xb,'M','男','W','女'),crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,ywy,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.qye,ysgcjdmc  ";
	}
	else{
		ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm, DECODE(crm_khxx.xb,'M','男','W','女'),crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,ywy,a.dwmc qydm,crm_khxx.qyrq,0,ysgcjdmc  ";
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","","Editkhxxpass.jsp");
