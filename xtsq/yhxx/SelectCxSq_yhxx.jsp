...
<form method="post" action="Sq_yhxxCxList.jsp" name="selectform">
      <div align="center">用户授权－查询</div>
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            
            <tr bgcolor="#FFFFCC"> 
              <td width="22%" align="right" bgcolor="#FFFFCC">所属公司</td>
              <td width="28%">
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="22%" align="right" bgcolor="#FFFFCC">所属部门小组</td>
              <td width="28%"> 
                <select name="sjsbh" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                </select>              </td>
              <td width="21%" align="right">工种</td>
              <td width="29%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="22%" align="right">用户角色</td>
              <td width="28%"> 
...
%>
              ...
              <td width="21%" align="right">是否可看工料分析</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">允许查看价格明细</td>
              <td width="28%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">时间限制标志</td>
              <td width="28%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">上班时间</td>
              <td width="28%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">IP地址限制标志</td>
              <td width="28%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">网卡地址限制标志</td>
              <td width="28%"> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="22%" align="right">查询结果排序</td>
              <td colspan="3"> 第一列 
