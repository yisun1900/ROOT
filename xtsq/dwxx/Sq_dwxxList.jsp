...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from sq_tsclbm where "+chooseitem;
		sql[1]="delete from bj_dzbjbz where "+chooseitem;
		sql[2]="delete from sq_xmzy where "+chooseitem;
		sql[3]="delete from sq_yjjzsj where "+chooseitem;
		sql[4]="delete from sq_dwxx where dwbh!='99999' and "+chooseitem;
