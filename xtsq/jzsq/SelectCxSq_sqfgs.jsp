...
<form method="post" action="Sq_sqfgsCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="22%" align="right">授权分公司</td>
              <td width="28%"> 
                <select name="sqfgs" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
