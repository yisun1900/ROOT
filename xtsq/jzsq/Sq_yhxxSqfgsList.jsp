...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Sq_yhxxSqfgsList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"PlFgsYgbhSq.jsp"};//按钮单击调用的网页，可以增加参数
...
//设置列超级连接
	...
	coluParm.link="InsertSq_sqfgs.jsp";//为列参数：coluParm.link设置超级链接
	...
	coluParm.link="DeleteSq_sqfgs.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">跨分公司授权(已离职的员工不能显示)</font></B>
</CENTER>
<%
	pageObj.out=out;
