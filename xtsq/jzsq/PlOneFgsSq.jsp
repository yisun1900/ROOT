...
<%
	...
	ls_sql+=" and sq_yhxx.yhjs in('A0','A1','F0','F1')";

	ls_sql+=" and (sq_yhxx.ssfgs='"+dwbh+"' OR sq_yhxx.ssfgs='99999')";
...
//设置按钮参数
	...
	String[] buttonLink={"SavePlOneFgsSq.jsp?dwbh="+dwbh};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">按分公司批量授权(转正、试用期、登陆名不为空员工才能显示)（不包括店面）</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
