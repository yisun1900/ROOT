...
String wherehflx=null;
String wherekhsksd=null;
wheressfgs=cf.GB2Uni(request.getParameter("wheressfgs"));
wherehflx=cf.GB2Uni(request.getParameter("wherehflx"));
wherekhsksd=cf.GB2Uni(request.getParameter("wherekhsksd"));
Connection conn  = null;
PreparedStatement ps=null;
String ls_sql=null;
try {
	conn=cf.getConnection();
	ls_sql="update hf_hfblsz set ssfgs=?,hflx=?,khsksd=?,khsjzd=?,hfbl=? ";
