...
<body bgcolor="#FFFFFF">
<form method="post" action="Sq_txxxbList.jsp" name="selectform">
<div align="center">修改提醒</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	<INPUT type="radio" name="sq_txxxb_txzt" value="1" checked>未提醒
    <INPUT type="radio" name="sq_txxxb_txzt" value="2">提醒
    <INPUT type="radio" name="sq_txxxb_txzt" value="3">处理  
  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
