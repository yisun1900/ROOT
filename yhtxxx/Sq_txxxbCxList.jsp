...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Sq_txxxbCxList.jsp","","","");
//	pageObj.setPageRow(10);//设置每页显示记录数
/*
//设置显示列
	String[] disColName={"xh","sq_txxxb_yhdlm","sq_txxxb_ygbh","sq_txxxb_yhmc","sq_txxxb_txfs","sq_txxxb_txlx","sq_txxxb_txgjz","sq_txxxb_txnr","sq_txxxb_kstxsj","sq_txxxb_txzt","sq_txxxb_txsj","sq_txxxb_lrr","sq_txxxb_lrsj","sq_dwxx_dwmc"};
