...
try {
	...
	ls_sql="select jc_zcdd.ddqrr,jc_zcdd.khbh,jc_zcdd.jzsjs,crm_khxx.fgsbh,crm_khxx.dwbh,jhshsj,jc_zcdd.tdsj,jc_zcdd.clzt,jc_zcdd.ppbm,jc_zcdd.bz,crm_khxx.fgsbh,jc_zcdd.xmzy,crm_khxx.khxm,cxhdbm,tzshsj,HTH,sjs,crm_khxx.sgd,sgbz,jc_zcdd.htshsj,crm_khxx.hth,jc_zcdd.zczkl,jc_zcdd.wdzje,jc_zcdd.hkze,sgdmc,sq_sgd.dh,fwdz,lxfs";
	...
	ls_sql=" select dh ";
	ls_sql+=" from sq_yhxx";
	ls_sql+=" where ssfgs='"+ssfgs+"' and yhmc ='"+jzsjs+"' and zwbm='04'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
	if (rs.next())
	{
		jzsjsdh=cf.fillNull(rs.getString("dh"));
	}
	rs.close();
	ps.close();
...
//
	ls_sql=" select dh ";
	ls_sql+=" from sq_yhxx";
	ls_sql+=" where ssfgs='"+ssfgs+"' and yhmc ='"+ddqrr+"' and zwbm='05'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
	if (rs.next())
	{
		ddqrrdh=cf.fillNull(rs.getString("dh"));
	}
	rs.close();
	ps.close();
...
<table width="100%" border="0" style='FONT-SIZE: 14px'>
  <tr> 
    <td colspan="3" align="center" >  <strong>松下亿达订货/验收单（<b>订单编号：<%=ddbh%></b>）</strong></td>
  </tr>
    <tr> 
    <td height="20"> 
      品牌名称：<b><%=ppbm%></b>    </td>
    <td width="34%"  height="20"> 
      订货日期：<b><%=cf.today()%></b>    </td>
    <td width="34%"  height="20"> 
      送货日期：<b><%=jhshsj%></b>    </td>
  </tr>
    <tr> 
...
<%
	...
	if (clzt.equals("99"))
	{
		ls_sql ="SELECT zcpzwzbm,zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,jc_zcddmx.zcysbm,jldwbm,-1*jc_zcddmx.sl,-1*jc_zcddmx.zjhsl,jc_zcddmx.bz  ";
	}
	else{
...
%> 
  ...
  <tr  >
    <td height="42" colspan="9" align="center">
	  <p>&nbsp;</p>
	  <p align="justify">厂家签字：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> &nbsp;&nbsp;&nbsp;工程担当：<u><%=ddqrr%></u> &nbsp;&nbsp;</p></td>
  </tr>
</table>
...
如存在质量问题，顾客意见：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
    ...
    <BR>
    <BR>
工长签字：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <u>&nbsp;&nbsp;&nbsp;&nbsp; </u>年<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>月<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>日 </div></td>
  </tr>
</table>
