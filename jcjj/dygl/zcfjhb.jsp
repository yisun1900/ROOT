...
<%
	...
	while (rs1.next())
	{
		...
		ls_sql ="SELECT zcmc,zclbbm,jc_zcddmx.xinghao,jc_zcddmx.gg,zcpzwzbm,jc_zcddmx.zcysbm,DECODE(xzjg,'1','销售价','2','<font color=\"#FF0000\">促销价</font>') xzjg,jc_zcddmx.dj,jldwbm,jc_zcddmx.sl,jc_zcddmx.je,nvl(ycf,0)+NVL(qtfyje,0) qtsf,cxhdbl||'%' cxhdbl ,cxhdje,jc_zcddmx.bz  ";
		ls_sql+=" FROM jc_zcddmx";
		...
		<td >&nbsp;</td>
		<td colspan="2"><span class="STYLE2"><strong><%=cf.round(je+qtsf,2)%></strong></span></td>
		<td >&nbsp;</td>
		</tr>
		<%
	}
