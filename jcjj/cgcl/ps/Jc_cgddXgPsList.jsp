...
<%
	...
	ls_sql="SELECT jc_cgdd.ddbh as ddbh,gysmc,DECODE(jc_cgdd.sfpsjs,'1','是','2','否') sfpsjs,jc_cgdd.khbh as khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,clgw,jc_cgdd.ztjjgw,jc_cgdd.xmzy,jc_cgdd.dj as jc_cgdd_dj,jc_cgdd.cgsjs as jc_cgdd_cgsjs,clztmc,DECODE(jc_cgdd.khlx,'2','家装客户','4','非家装') as jc_cgdd_khlx,jc_cgdd.pslrsj,jc_cgdd.pslrr,jc_cgdd.gcjsr,jc_cgdd.gcjssj,jc_cgdd.jhazrq,jc_cgdd.kjxsj,jc_cgdd.htze,jc_cgdd.gtbfje,jc_cgdd.tmbfje,jc_cgdd.wjhtze,jc_cgdd.dqhtze,a.dwmc as sq_dwxx_dwmc  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","XgPsJc_cgdd.jsp");
	pageObj.setPageRow(1000);//设置每页显示记录数
//	pageObj.setEditStr("入库");//设置每页显示记录数
//设置显示列
	String[] disColName={"ddbh","clztmc","khxm","gysmc","sfpsjs","jc_cgdd_cgsjs","pslrr","pslrsj","gcjsr","gcjssj","jhazrq","kjxsj","htze","gtbfje","tmbfje","wjhtze","dqhtze","jc_cgdd_khlx","fwdz","hth","clgw","ztjjgw","xmzy","sq_dwxx_dwmc"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeletePsJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单处理--修改配送</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
