...
<form method="post" action="Jc_cgddAzList.jsp" name="selectform">
<div align="center">橱柜订单处理--橱柜安装</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><select name="jc_cgdd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX" >
                  <option value=""></option>
                  <option value="27">确定安装时间</option>
                  <option value="29">已通知安装</option>
	  </select></td>
	</tr>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><input name="jc_cgdd_aztzr" type="text" size="20" maxlength="20" ></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
%>
	...
	<tr bgcolor="#FFFFCC"> 
	  <td width="19%" align="right">协商安装时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_kazsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_kazsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>

	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right">发安装通知时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_aztzsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_aztzsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_kazsj, "协商安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_kazsj2, "协商安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_aztzsj, "发安装通知时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_aztzsj2, "发安装通知时间"))) {
		return false;
	}
