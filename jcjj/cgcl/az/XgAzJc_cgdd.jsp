...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td colspan="4" align="center" height="51"> 
                ...
                <input type="button"  value="录入安装记录" onClick="f_lraz(insertform)" name="lraz" >
                <input type="button"  value="查看安装记录" onClick="f_ckaz(insertform)" name="ckaz" >
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgAzJc_cgdd.jsp";
	FormName.submit();
	return true;
}
...
function f_lraz(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="InsertJc_cgazjl.jsp";
	FormName.submit();
	return true;
}
...
function f_ckaz(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_cgazjlList.jsp";
	FormName.submit();
	return true;
}
