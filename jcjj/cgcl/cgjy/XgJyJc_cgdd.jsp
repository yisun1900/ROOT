      ...
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%"> 
                <input type="text" name="jyr" size="20" maxlength="20"  value="<%=jyr%>" readonly>
              </td>
              <td width="21%" align="right">检验时间</td>
              <td width="29%"> 
                <input type="text" name="jysj" size="20" maxlength="20"  value="<%=jysj%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgJyJc_cgdd.jsp";
	FormName.submit();
	return true;
}
//-->
