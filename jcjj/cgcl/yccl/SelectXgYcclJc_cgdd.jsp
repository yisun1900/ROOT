...
<form method="post" action="Jc_cgddXgYcclList.jsp" name="selectform">
<div align="center">橱柜订单处理--修改延迟处理</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><select name="jc_cgdd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX" >
                  <option value="33">安装完成</option>
	  </select></td>
	</tr>
	

	<tr bgcolor="#FFFFFF"> 
	  <td align="right" width="19%">延迟处理状态</td>
	  <td width="31%"> 
...
%>
	...
	<tr bgcolor="#FFFFCC"> 
	  <td width="19%" align="right">开始安装时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_ksazsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_ksazsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>

	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right">安装完成时间 从</td>
	  <td width="31%"> 
	...
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right" bgcolor="#FFFFFF">延迟核实时间 从</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_ychssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
	  <input type="text" name="jc_cgdd_ychssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_ychssj, "延迟核实时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_ychssj2, "延迟核实时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_ksazsj, "开始安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_ksazsj2, "开始安装时间"))) {
		return false;
	}
