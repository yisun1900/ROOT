...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_cgdd.ddbh,clztmc,jc_cgdd.qhtsj,jc_cgdd.qhtr,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,jc_cgdd.cgzkl,jc_cgdd.htze,jc_cgdd.gtbfje,jc_cgdd.tmbfje,jc_cgdd.wjhtze,jc_cgdd.dqhtze,jc_cgdd.dzyy,clgw,jc_cgdd.ztjjgw,jc_cgdd.xmzy,jc_cgdd.cgsjs,jc_cgdd.jhazrq,sdks,xtbc,cghs,tmpp,tmhs,blcz,jiaolian,jc_cgdd.khbh  ";
	ls_sql+=" FROM jc_cgdd,jdm_cgddzt,crm_khxx";
    ls_sql+=" where jc_cgdd.khbh=crm_khxx.khbh(+) and jc_cgdd.clzt=jdm_cgddzt.clzt(+)";
    ls_sql+=" and jc_cgdd.clzt not in('00','01','03','05','07','09','11','35','98','99')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddQxddList.jsp","","","QxddJc_cgdd.jsp");
