...
<form method="post" action="Jc_cgddQxddList.jsp" name="selectform">
<div align="center">橱柜订单--退单
        <BR><b><font color="#FF0000">注意：适用于【签合同】的订单，未签合同的要做【取消预订单】</font></b>
...
%> 
	...
	<tr bgcolor="#FFFFFF"> 
	  ...
	  <td width="31%"> 
		...
		<input name="sfpsjs" type="radio" value="2">否
	  </td>
	...
	<tr bgcolor="#FFFFCC"> 
	  ...
	  <td width="31%"> 
		<input type="text" name="jc_cgdd_htqrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="19%" align="right">到</td>
	  <td width="31%"> 
		<input type="text" name="jc_cgdd_htqrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgdd_htqrsj, "交款确认时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgdd_htqrsj2, "交款确认时间"))) {
		return false;
	}
