...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_cgdd.ddbh,clztmc,jc_cgdd.jhazrq,jc_cgdd.gcjssj,jc_cgdd.gcjsr,jc_cgdd.pdgcmc,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,jc_cgdd.htze,clgw,jc_cgdd.ztjjgw,jc_cgdd.xmzy,jc_cgdd.cgsjs,sdks,jc_cgdd.khbh  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgddRkList.jsp","","","RkJc_cgdd.jsp");
...
//设置按钮参数
	String[] buttonName={"批量入库"};//按钮的显示名称
	String[] buttonLink={"SavePlRkJc_cgdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">橱柜订单处理--入库</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
