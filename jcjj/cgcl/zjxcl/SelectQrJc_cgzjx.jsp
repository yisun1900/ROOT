...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_cgzjxQrList.jsp" name="selectform">
<div align="center">增减项处理---工厂确认</div>
...
%>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><input type="text" name="jc_cgzjx_azwcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
      <td align="right">到</td>
      <td><input type="text" name="jc_cgzjx_azwcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_cgzjx_azwcsj, "安装完成时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_cgzjx_azwcsj2, "安装完成时间"))) {
		return false;
	}
