...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (yhjs.equals("G0"))
	{
		...
		{
			ls_sql+=" and (jc_cgzjx.jjsjs='"+yhmc+"' OR jc_cgzjx.lrr='"+yhmc+"')";
		}
		if (zwbm.equals("10"))//10:项目专员
		{
	...
	ls_sql+=wheresql;
    ls_sql+=" order by jc_cgzjx.qrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_cgzjxXgQrList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQrJc_cgzjx.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">增减项处理---修改确认</font></B>
</CENTER>
<%
	pageObj.out=out;
