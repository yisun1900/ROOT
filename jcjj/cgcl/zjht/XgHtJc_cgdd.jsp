    ...
    <td width="100%" > 
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>柜体合同金额</td>
              <td width="29%"> 
                <input type="text" name="gtbfje" size="20" maxlength="20"  value="<%=gtbfje%>" onChange="f_wdzje(insertform)" >
              </td>
              <td width="22%" align="right"><font color="#FF0033">*</font>台面合同金额</td>
              <td width="28%"> 
                <input type="text" name="tmbfje" size="20" maxlength="20"  value="<%=tmbfje%>"  onChange="f_wdzje(insertform)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>电器合同总额</td>
              <td width="29%"> 
                <input type="text" name="dqhtze" size="20" maxlength="20"  value="<%=dqhtze%>" onChange="f_wdzje(insertform)" >
              </td>
              <td width="22%" align="right"><font color="#FF0033">*</font>五金合同总额</td>
              <td width="28%"> 
                <input type="text" name="wjhtze" size="20" maxlength="20"  value="<%=wjhtze%>" onChange="f_wdzje(insertform)" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"> 
                <input type="text" name="htze" size="20" maxlength="20"  value="<%=htze%>" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"> 
                <input type="text" name="kjxsj" size="20" maxlength="10"  value="<%=kjxsj%>" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"> 
                <input type="text" name="qhtsj" size="20" maxlength="10"  value="<%=qhtsj%>" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_wdzje(FormName)//参数FormName:Form的名称
{
	...
	je=parseInt(je*100.0+0.5)/100.0;
