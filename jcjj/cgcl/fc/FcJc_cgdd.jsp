...
try {
	...
	ls_sql="select jhfcsj,sfcsj,fcbz";
	ls_sql+=" from  jc_cgdd";
      ...
      <div align="center">
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="26%" align="right">水电路与原图纸是否相同</td>
              <td width="27%"> 
                <input type="radio" name="sdlsfxt" value="Y">
                相同 
                <input type="radio" name="sdlsfxt" value="N">
                不相同 </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFFFFF">实复测时间</td>
              <td width="26%"><input type="text" name="sfcsj" size="20" maxlength="20"  value="<%=cf.today()%>" ondblclick="JSCalendar(this)"></td>
              <td width="26%" align="right">复测录入人</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jhfcsj, "实复测时间"))) {
		return false;
	}
...
*/
	FormName.action="SaveFcJc_cgdd.jsp";
	FormName.submit();
