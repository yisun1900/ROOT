...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">橱柜订单处理--修改计划复测时间</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_cgddJhFcList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFCC"> 
              <td width="18%"> 
                <div align="right">所属公司</div>
              </td>
              <td width="32%"> <%
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
				  ...
				  <option value="02">已派设计师</option>
				  <option value="03">已初测</option>
                </select>
              </td>
              <td width="18%"> 
