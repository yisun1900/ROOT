...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.paidsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgPdList.jsp","","","XgPdJc_mmydd.jsp");
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"DeletePdJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改派单</font></B>
</CENTER>
<%
	pageObj.out=out;
