...
try {
	...
	for (int i=0;i<yddbh.length ;i++ )
	{
		...
		ls_sql="update jc_mmydd set clzt='01',pdgc=null,pdgcmc=null,ppmc=null,gys=null,paidr=null,paidsj=null";
		ls_sql+=" where  yddbh='"+yddbh[i]+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();
	
		ls_sql="update jc_mmzjx set pdgc=null,pdgcmc=null,ppmc=null,gys=null";
		ls_sql+=" where  yddbh='"+yddbh[i]+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();
