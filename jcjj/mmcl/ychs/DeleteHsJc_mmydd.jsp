...
try {
	...
	for (int i=0;i<yddbh.length ;i++ )
	{
		...
		ls_sql="update jc_mmydd set ychssj=null,ychsr=null,ychsqk=null,zsycyybm=null,ycclzt='1',sfxwyj=null,wyj=0,jjfa=null";
		ls_sql+=" where  yddbh='"+yddbh[i]+"' and clzt='15' ";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();
