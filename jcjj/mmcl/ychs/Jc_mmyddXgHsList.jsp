...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ycclzt=request.getParameter("ycclzt");
	if (ycclzt!=null)
	{
		ycclzt=cf.GB2Uni(ycclzt);
		if (!(ycclzt.equals("")))	wheresql+=" and  (jc_mmydd.ycclzt='"+ycclzt+"')";
	}
	...
	jc_mmydd_azkssj=request.getParameter("jc_mmydd_azkssj");
	if (jc_mmydd_azkssj!=null)
	{
		jc_mmydd_azkssj=jc_mmydd_azkssj.trim();
		if (!(jc_mmydd_azkssj.equals("")))	wheresql+="  and (jc_mmydd.azkssj>=TO_DATE('"+jc_mmydd_azkssj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_azkssj=request.getParameter("jc_mmydd_azkssj2");
	if (jc_mmydd_azkssj!=null)
	{
		jc_mmydd_azkssj=jc_mmydd_azkssj.trim();
		if (!(jc_mmydd_azkssj.equals("")))	wheresql+="  and (jc_mmydd.azkssj<=TO_DATE('"+jc_mmydd_azkssj+"','YYYY-MM-DD'))";
	...
	jc_mmydd_azjssj=request.getParameter("jc_mmydd_azjssj");
	if (jc_mmydd_azjssj!=null)
	{
		jc_mmydd_azjssj=jc_mmydd_azjssj.trim();
		if (!(jc_mmydd_azjssj.equals("")))	wheresql+="  and (jc_mmydd.azjssj>=TO_DATE('"+jc_mmydd_azjssj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_azjssj=request.getParameter("jc_mmydd_azjssj2");
	if (jc_mmydd_azjssj!=null)
	{
		jc_mmydd_azjssj=jc_mmydd_azjssj.trim();
		if (!(jc_mmydd_azjssj.equals("")))	wheresql+="  and (jc_mmydd.azjssj<=TO_DATE('"+jc_mmydd_azjssj+"','YYYY-MM-DD'))";
	...
	jc_mmydd_ychssj=request.getParameter("jc_mmydd_ychssj");
	if (jc_mmydd_ychssj!=null)
	{
		jc_mmydd_ychssj=jc_mmydd_ychssj.trim();
		if (!(jc_mmydd_ychssj.equals("")))	wheresql+="  and (jc_mmydd.ychssj>=TO_DATE('"+jc_mmydd_ychssj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_ychssj=request.getParameter("jc_mmydd_ychssj2");
	if (jc_mmydd_ychssj!=null)
	{
		jc_mmydd_ychssj=jc_mmydd_ychssj.trim();
		if (!(jc_mmydd_ychssj.equals("")))	wheresql+="  and (jc_mmydd.ychssj<=TO_DATE('"+jc_mmydd_ychssj+"','YYYY-MM-DD'))";
	...
	ls_sql="SELECT yddbh,DECODE(jc_mmydd.ycclzt,'1','延迟未核实','2','延迟原因属实','3','延迟原因不属实','4','延迟已处理') ycclzt,a.mmycyymc mmycyybm,b.mmycyymc zsycyybm,jc_mmydd.pdgcmc,paidr,ychssj,kazsj,aztzsj,azkssj,azjssj,jhazsj,mmcljs,sshsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.pdgc,jc_mmydd.ppmc,jc_mmydd.gys,jc_mmydd.bz  ";
	ls_sql+=" FROM crm_khxx,jc_mmydd,jdm_mmyddzt,jdm_mmycyybm a,jdm_mmycyybm b";
    ls_sql+=" where jc_mmydd.khbh=crm_khxx.khbh(+) ";
    ls_sql+=" and jc_mmydd.mmycyybm=a.mmycyybm(+) and jc_mmydd.zsycyybm=b.mmycyybm(+)";
	if (yhjs.equals("G0"))
	{
    ...
    ls_sql+=wheresql;
    ls_sql+=" and ycclzt in('2','3')";
	ls_sql+=" and jc_mmydd.clzt=jdm_mmyddzt.clzt(+)";
    ls_sql+=" order by "+pxzd;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgHsList.jsp","","","XgHsJc_mmydd.jsp");
//设置显示列
	String[] disColName={"yddbh","khxm","clztmc","ycclzt","mmycyybm","zsycyybm","ychssj","azkssj","azjssj","aztzsj","kazsj","jhazsj","pdgcmc","fwdz","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","pdgc","ppmc","gys","bz"};
...
//设置按钮参数
	String[] buttonName={"删除延迟处理信息"};//按钮的显示名称
	String[] buttonLink={"DeleteHsJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改延迟处理</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">客户姓名</td>
	<td  width="3%">处理状态</td>
	<td  width="5%">延迟处理状态</td>
	<td  width="6%">延迟原因</td>
	<td  width="6%">真实延迟原因</td>
	<td  width="3%">延迟核实时间</td>
	<td  width="3%">安装开始时间</td>
	<td  width="3%">安装完成时间</td>
	<td  width="3%">发安装通知时间</td>
	<td  width="3%">协商安装时间</td>
	<td  width="3%">合同安装时间</td>
	<td  width="5%">派单工厂</td>
	<td  width="8%">房屋地址</td>
	<td  width="3%">测量技师</td>
	<td  width="3%">五金情况</td>
