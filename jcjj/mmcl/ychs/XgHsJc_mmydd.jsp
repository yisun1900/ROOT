...
<div align="center">木门预订单---核实延迟原因 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#CCCCFF"> 
      <td width="18%" align="right">计划安装时间</td>
      <td width="32%"><%=jc_mmydd_jhazsj%></td>
      <td width="18%" align="right">安装开始时间</td>
      <td width="32%"><%=jc_mmydd_azkssj%></td>
    </tr>
    <tr bgcolor="#CCCCFF"> 
...
%> </td>
    ...
    <tr bgcolor="#CCCCFF"> 
      <td width="18%" align="right">延迟说明</td>
      <td colspan="3"><%=jc_mmydd_ycsm%></td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="18%">延迟核实时间</td>
      <td width="32%"> 
      <input type="text" name="ychssj" size="20" maxlength="10" value="<%=jc_mmydd_ychssj%>" readonly>      </td>
      <td width="18%" bgcolor="#E8E8FF" align="right">延迟核实人</td>
      <td width="32%"> 
      <input type="text" name="ychsr" size="20" maxlength="10" value="<%=jc_mmydd_ychsr%>" readonly>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="18%">延迟原因是否属实</td>
      <td width="32%"> 
...
%> 
      ...
      <td width="32%"> 
        <select name="zsycyybm" style="FONT-SIZE:12PX;WIDTH:152PX" >
          <option value=""></option>
          <%
	cf.selectItem(out,"select mmycyybm,mmycyymc from jdm_mmycyybm order by mmycyybm",jc_mmydd_zsycyybm);
%> 
      </select>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="18%">延迟核实情况</td>
      <td colspan="3"> 
        <textarea name="ychsqk" cols="71" rows="5"><%=jc_mmydd_ychsqk%></textarea>      </td>
    </tr>
    <tr bgcolor="#E8E8FF">
...
%>
    ...
    <tr bgcolor="#E8E8FF">
      ...
      <td colspan="3"><textarea name="jjfa" cols="71" rows="3"><%=jjfa%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right"> 
      客户姓名    </td>
    <td width="32%"> <%=crm_khxx_khxm%>（<%=lxfs%>） </td>
...
%> </td>
  ...
  <tr bgcolor="#FFFFCC"> 
    <td width="18%" align="right">派单人</td>
    <td width="32%"><%=paidr%></td>
  ...
  <tr bgcolor="#FFFFCC"> 
    <td width="18%" align="right" bgcolor="#FFFFCC"> 
      计划初测时间    </td>
    <td width="32%"><%=jc_mmydd_jhccsj%> </td>
    <td width="18%" align="right"> 
      实初测时间    </td>
    <td width="32%"><%=jc_mmydd_sccsj%> </td>
  </tr>
  <tr bgcolor="#FFFFCC"> 
    <td width="18%" align="right" bgcolor="#FFFFCC">初测说明</td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right">合同备注</td>
...
%> </td>
  ...
  <tr bgcolor="#99CCFF"> 
    <td width="18%" align="right"> 
      送五金时间    </td>
    <td width="32%" bgcolor="#99CCFF"> <%=jc_mmydd_swjsj%> </td>
    <td width="18%" align="right"> 
      五金接收人    </td>
    <td width="32%"> <%=jc_mmydd_wjjsr%> </td>
  </tr>
  <tr bgcolor="#99CCFF"> 
    <td width="18%" align="right">五金接收情况</td>
  ...
  <tr bgcolor="#99CCFF"> 
    ...
    <td width="18%" align="right"> 
      安装结束时间    </td>
    <td width="32%"> <%=jc_mmydd_azjssj%> </td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right"> 
      延迟原因    </td>
...
%> </td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right">真实延迟原因</td>
    <td width="32%"><%
...
%></td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right">延迟核实情况</td>
    <td colspan="3"><%=jc_mmydd_ychsqk%></td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="18%" align="right"> 
      延迟核实人    </td>
    <td width="32%"> <%=jc_mmydd_ychsr%> </td>
    <td width="18%" align="right"> 
      延迟核实时间    </td>
    <td width="32%"> <%=jc_mmydd_ychssj%> </td>
  </tr>
</table>
</body>
</html>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgHsJc_mmydd.jsp";
	FormName.submit();
	return true;
}
