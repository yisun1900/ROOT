...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---木门入库</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">工厂接收录入时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_gcjslrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_gcjslrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_gcjslrsj, "工厂接收录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_gcjslrsj2, "工厂接收录入时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddRkList.jsp";
