...
<body bgcolor="#FFFFFF">
<div align="center">木门预订单---修改入库（预订单编号：<%=jc_mmydd_yddbh%>）</div>
...
<form method="post" action="" name="selectform">
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="28%"> 
        <input type="text" name="srksj" size="20" maxlength="10"  value="<%=jc_mmydd_srksj%>" onDblClick="JSCalendar(this)">
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <textarea name="rksm" rows="3" cols="71"><%=jc_mmydd_rksm%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
*/
	...
	FormName.action="SaveXgRkJc_mmydd.jsp";
	FormName.submit();
	return true;
}
