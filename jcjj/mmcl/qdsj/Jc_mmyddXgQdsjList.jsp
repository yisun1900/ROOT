...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.kazsj,jc_mmydd.pdgcmc,mmcljs,jc_mmydd.htje,jc_mmydd.mmhtje,jc_mmydd.wjhtje,jc_mmydd.blhtje,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.lrsj,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.kazsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgQdsjList.jsp","","","XgQdsjJc_mmydd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除确认时间"};//按钮的显示名称
	String[] buttonLink={"DeleteQdsjJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单--确定安装时间</font></B>
</CENTER>
<%
	pageObj.out=out;
