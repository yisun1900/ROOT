...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---安装提醒</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"><input type="text" name="crm_khxx_khxm2" size="14" maxlength="20" >
              （模糊查询）</td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"><input type="text" name="crm_khxx_fwdz2" size="14" maxlength="50" >
              （模糊查询）</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
              <input type="text" name="jc_mmydd_srksj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
              <input type="text" name="jc_mmydd_srksj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">合同安装时间 从</td>
              <td width="31%"> 
                <input type="text" name="jhazsj" size="20" maxlength="10" value="<%=cf.today()%>" onDblClick="JSCalendar(this)">
              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
                <input type="text" name="jhazsj2" size="20" maxlength="10" value="<%=cf.addDay(3)%>" onDblClick="JSCalendar(this)">
              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_srksj, "入库时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_srksj2, "入库时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jhazsj, "合同安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jhazsj2, "合同安装时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddAztxList.jsp";
