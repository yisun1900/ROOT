...
<body bgcolor="#FFFFFF">
<div align="center">木门预订单---安装提醒 （预订单编号：<%=jc_mmydd_yddbh%>）</div>
  
<form method="post" action="" name="selectform">
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td width="22%" align="right">安装提醒</td>
      <td colspan="3"> 
        <textarea name="aztxbz" cols="71" rows="3"><%=aztxbz%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
{
	if(	javaTrim(FormName.aztxbz)=="") {
		alert("请输入[安装提醒]！");
		FormName.aztxbz.focus();
		return false;
	}

	FormName.action="SaveAztxJc_mmydd.jsp";
	FormName.submit();
	return true;
}
