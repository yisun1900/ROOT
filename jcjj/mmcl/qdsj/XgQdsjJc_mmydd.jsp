...
try {
	...
	ls_sql=" select bz from jc_mmazsjjl";
...
<BR><div align="center">木门预订单---修改安装时间 （预订单编号：<%=jc_mmydd_yddbh%>）</div>
<form method="post" action="" name="selectform">
 <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="21%">协商安装时间</td>
      <td width="29%"> 
        <input type="text" name="kazsj" size="20" maxlength="20"  value="<%=kazsj%>" onDblClick="JSCalendar(this)">
      </td>
      <td width="20%" bgcolor="#E8E8FF" align="right">合同安装时间</td>
      <td width="30%"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      <td width="21%" align="right">安装时间备注</td>
      <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgQdsjJc_mmydd.jsp";
	FormName.submit();
	return true;
}
