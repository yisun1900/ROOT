...
<body bgcolor="#FFFFFF">
<div align="center">木门预订单---确定安装时间 （预订单编号：<%=jc_mmydd_yddbh%>）</div>
  
<form method="post" action="" name="selectform">
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%" bgcolor="#E8E8FF">协商安装时间</td>
      <td width="28%"> 
        <input type="text" name="kazsj" size="20" maxlength="20"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)">
      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">合同安装时间</td>
      <td width="27%"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      <td width="22%" align="right">安装时间备注</td>
      <td colspan="3"> 
        <textarea name="bz" cols="71" rows="3"><%=azsjbz%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveQdsjJc_mmydd.jsp";
	FormName.submit();
	return true;
}
