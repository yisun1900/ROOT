...
<form method="post" action="SaveZhshJc_mmydd.jsp" name="selectform">
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#E8E8FF"> 
    <td align="right" width="22%">综合经营审核时间</td>
    <td width="28%"> 
        <input type="text" name="zhshsj" size="20" maxlength="10" value="<%=cf.today()%>" readonly>
    </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">综合经营部审核人</td>
    <td width="27%"> 
        <input type="text" name="zhshr" size="20" maxlength="20" value="<%=yhdlm%>" readonly>
    </td>
  </tr>
  <tr bgcolor="#E8E8FF"> 
