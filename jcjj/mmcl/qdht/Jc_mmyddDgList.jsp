...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT clztmc,jc_mmydd.pdgc,mmcljs,sccsj,jc_mmydd.jhccsj,yddbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,sq_dwxx.dwmc,jc_mmydd.bz,jc_mmydd.khbh  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddDgList.jsp","","","DgJc_mmydd.jsp");
...
<CENTER >
  <B><font size="3">木门预订单---签订合同</font></B>
</CENTER>
<%
	pageObj.out=out;
