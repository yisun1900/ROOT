...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgDgList.jsp","","","XgDgJc_mmydd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除木门合同"};//按钮的显示名称
	String[] buttonLink={"DeleteDgJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改合同</font></B>
</CENTER>
<%
	pageObj.out=out;
