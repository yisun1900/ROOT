...
//	ls_sql+=" and jc_mmydd.ycclzt in('2','3')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddWjdjList.jsp","","","WjdjJc_mmydd.jsp");
//设置显示列
	String[] disColName={"yddbh","khxm","fwdz","clztmc","ycclzt","mmycyybm","zsycyybm","ychssj","azkssj","azjssj","aztzsj","kazsj","jhazsj","pdgcmc","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","pdgc","ppmc","gys","bz"};
...
//设置按钮参数
	String[] buttonName={"批量完结登记"};//按钮的显示名称
	String[] buttonLink={"PlWjdjJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
