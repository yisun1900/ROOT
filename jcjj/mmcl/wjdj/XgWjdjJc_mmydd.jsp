...
%> </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="33%"> 
        <input type="text" name="wjsj" size="20" maxlength="10" value="<%=wjsj%>" onDblClick="JSCalendar(this)">
      </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgWjdjJc_mmydd.jsp";
	FormName.submit();
	return true;
}
