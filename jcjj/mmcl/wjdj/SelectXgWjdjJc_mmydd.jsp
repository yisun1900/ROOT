...
<form method="post" action="" name="selectform">
      <div align="center">木门预订单---删除完结登记</div>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">安装开始时间 从</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_azkssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_azkssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">安装结束时间 从</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_azjssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_azjssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">延迟核实时间 从</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_ychssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_ychssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">完结时间 从</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_wjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_wjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
           ...
           <tr bgcolor="#CCFFFF"> 
              ...
              <td width="31%"> 
                <select name="pxzd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  ...
                  <option value="jc_mmydd.ychssj desc">延迟核实时间</option>
                  <option value="jc_mmydd.azjssj desc">安装结束时间</option>
                  <option value="jc_mmydd.azkssj desc">安装开始时间</option>
                  <option value="jc_mmydd.aztzsj desc">发安装通知时间</option>
                  <option value="jc_mmydd.kazsj desc">协商安装时间</option>
...
{
	if(!(isDatetime(FormName.jc_mmydd_azkssj, "安装开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_azkssj2, "安装开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_azjssj, "安装结束时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_azjssj2, "安装结束时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_ychssj, "延迟核实时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_ychssj2, "延迟核实时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_wjsj, "完结时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_wjsj2, "完结时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddXgWjdjList.jsp";
