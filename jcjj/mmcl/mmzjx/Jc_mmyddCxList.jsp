...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.htrq,jc_mmydd.htqdr,jc_mmydd.pdgc,mmcljs,jc_mmydd.htje,jc_mmydd.wdzje,TO_CHAR(jc_mmydd.mmzkl) mmzkl,jc_mmydd.dzyy,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.lrsj,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=" and jc_mmydd.clzt in('23','05','30','31','32','06','07','09','11','15')";//未签合同或已退单、完结的不能增减项
	if (yhjs.equals("G0"))
	{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddCxList.jsp","","","InsertJc_mmzjx.jsp");


//设置主键
	String[] keyName={"yddbh"};
	pageObj.setKey(keyName);
	pageObj.setEditStr("增减项");
	pageObj.setEditBolt("");
...
<CENTER >
  <B><font size="3">木门增减项（<font color="#0000CC"><strong>提醒：完结和未经过【收款确认】的订单不能做增减项</strong></font>）</font></B>
</CENTER>
<%
	pageObj.out=out;
