...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jc_mmzjx_lrsj=request.getParameter("jc_mmzjx_lrsj");
	if (jc_mmzjx_lrsj!=null)
	{
		jc_mmzjx_lrsj=jc_mmzjx_lrsj.trim();
		if (!(jc_mmzjx_lrsj.equals("")))	wheresql+="  and (jc_mmzjx.lrsj>=TO_DATE('"+jc_mmzjx_lrsj+"','YYYY/MM/DD'))";
	}
	jc_mmzjx_lrsj=request.getParameter("jc_mmzjx_lrsj2");
	if (jc_mmzjx_lrsj!=null)
	{
		jc_mmzjx_lrsj=jc_mmzjx_lrsj.trim();
		if (!(jc_mmzjx_lrsj.equals("")))	wheresql+="  and (jc_mmzjx.lrsj<=TO_DATE('"+jc_mmzjx_lrsj+"','YYYY/MM/DD'))";
	...
	jc_mmzjx_jhazsj=request.getParameter("jc_mmzjx_jhazsj");
	if (jc_mmzjx_jhazsj!=null)
	{
		jc_mmzjx_jhazsj=jc_mmzjx_jhazsj.trim();
		if (!(jc_mmzjx_jhazsj.equals("")))	wheresql+="  and (jc_mmzjx.jhazsj>=TO_DATE('"+jc_mmzjx_jhazsj+"','YYYY/MM/DD'))";
	}
	jc_mmzjx_jhazsj=request.getParameter("jc_mmzjx_jhazsj2");
	if (jc_mmzjx_jhazsj!=null)
	{
		jc_mmzjx_jhazsj=jc_mmzjx_jhazsj.trim();
		if (!(jc_mmzjx_jhazsj.equals("")))	wheresql+="  and (jc_mmzjx.jhazsj<=TO_DATE('"+jc_mmzjx_jhazsj+"','YYYY/MM/DD'))";
	...
	jc_mmzjx_azwcsj=request.getParameter("jc_mmzjx_azwcsj");
	if (jc_mmzjx_azwcsj!=null)
	{
		jc_mmzjx_azwcsj=jc_mmzjx_azwcsj.trim();
		if (!(jc_mmzjx_azwcsj.equals("")))	wheresql+="  and (jc_mmzjx.azwcsj>=TO_DATE('"+jc_mmzjx_azwcsj+"','YYYY/MM/DD'))";
	}
	jc_mmzjx_azwcsj=request.getParameter("jc_mmzjx_azwcsj2");
	if (jc_mmzjx_azwcsj!=null)
	{
		jc_mmzjx_azwcsj=jc_mmzjx_azwcsj.trim();
		if (!(jc_mmzjx_azwcsj.equals("")))	wheresql+="  and (jc_mmzjx.azwcsj<=TO_DATE('"+jc_mmzjx_azwcsj+"','YYYY/MM/DD'))";
	...
	jc_mmzjx_lrr=request.getParameter("jc_mmzjx_lrr");
	if (jc_mmzjx_lrr!=null)
	{
		jc_mmzjx_lrr=cf.GB2Uni(jc_mmzjx_lrr);
		if (!(jc_mmzjx_lrr.equals("")))	wheresql+=" and  (jc_mmzjx.lrr='"+jc_mmzjx_lrr+"')";
	}

	jc_mmzjx_dwbh=request.getParameter("jc_mmzjx_dwbh");
	if (jc_mmzjx_dwbh!=null)
	{
		jc_mmzjx_dwbh=cf.GB2Uni(jc_mmzjx_dwbh);
		if (!(jc_mmzjx_dwbh.equals("")))	wheresql+=" and  (jc_mmzjx.dwbh='"+jc_mmzjx_dwbh+"')";
	}
	...
	ls_sql="SELECT jc_mmzjx.zjxxh,DECODE(jc_mmzjx.clzt,'00','录入未完成','01','录入完成','05','增减项确认','02','工厂已接收','03','已入库','04','安装完成','99','退单'),jc_mmzjx.yddbh,pdgcmc,crm_khxx.khxm,crm_khxx.fwdz,jc_mmzjx.zjxfssj,jc_mmzjx.zjxqrsj,mmzjxyymc,jc_mmzjx.zqzjxze,jc_mmzjx.zjxze,TO_CHAR(jc_mmzjx.mmzkl) mmzkl,jc_mmzjx.dzyy,jc_mmzjx.xmzy,jc_mmzjx.clgw,jc_mmzjx.ztjjgw,jc_mmzjx.qrsj,jc_mmzjx.azwcsj,jc_mmzjx.lrsj,jc_mmzjx.lrr,sq_dwxx.dwmc lrbm, pdgc, ppmc, gys,jc_mmzjx.khbh,crm_khxx.hth,crm_khxx.sjs,crm_khxx.zjxm,sgdmc ";
...
//	out.println(ls_sql);
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmzjxCxList.jsp","","","/jcjj/dygl/dymmzjx.jsp");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">增减项确认时间</td>
	<td  width="4%">增减项原因</td>
	<td  width="4%">增减项总额-折前</td>
	<td  width="4%">增减项总额-折后</td>
	<td  width="2%">折扣率</td>
	<td  width="11%">打折原因</td>
	<td  width="2%">项目专员</td>
	<td  width="2%">驻店家居顾问</td>
	<td  width="2%">展厅家居顾问</td>
	<td  width="3%">工厂接收时间</td>
