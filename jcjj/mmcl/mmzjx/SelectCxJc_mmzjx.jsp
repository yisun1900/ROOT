...
<form method="post" action="Jc_mmzjxCxList.jsp" name="selectform">
<div align="center">查询增减项</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><select name="jc_mmzjx_clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
		<option value=""></option>
		<%
cf.selectToken(out,"00+录入未完成&01+录入已完成&05+增减项确认&02+工厂已接收&03+已入库&04+安装完成&99+取消订单","");
%>
	  </select></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td><input type="text" name="jc_mmzjx_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	  <td align="right"> 到 </td>
	  <td><input type="text" name="jc_mmzjx_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	</tr>
	
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right">计划安装时间 从</td>
	  <td width="31%"> 
		<input type="text" name="jc_mmzjx_jhazsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="18%" align="right">到</td>
	  <td width="32%"> 
	  <input type="text" name="jc_mmzjx_jhazsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	</tr>
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right"> 
		安装完成时间 从              </td>
	  <td width="31%"> 
		<input type="text" name="jc_mmzjx_azwcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
	  <td width="18%" align="right">到</td>
	  <td width="32%"><input type="text" name="jc_mmzjx_azwcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
	</tr>
	<tr bgcolor="#FFFFFF"> 
	  <td width="19%" align="right"> 
		录入人              </td>
	  <td width="31%"> 
		<input type="text" name="jc_mmzjx_lrr" size="20" maxlength="20" >              </td>
	  <td width="18%" align="right"> 
		录入部门&nbsp;              </td>
	  <td width="32%"> 
		<select name="jc_mmzjx_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" onclick="getThis('lrbm')">
		  <option value=""></option>
	  </select>              </td>
	</tr>
	<tr bgcolor="#CCFFFF"> 
	  ...
	  <td colspan="3" bgcolor="#CCFFFF"> 第一列 
		<select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:125PX">
		  <option value="jc_mmzjx.zjxfssj desc">增减项发生时间</option>
		  <option value="jc_mmzjx.zjxqrsj desc">增减项确认时间</option>
		  <option value="jc_mmzjx.lrsj desc">录入时间</option>
		  <option value="jc_mmzjx.qrsj desc">工厂接收时间</option>
		  ...
		  <option value="jc_mmzjx.xmzy">项目专员</option>
		  <option value="jc_mmzjx.clgw">驻店家居顾问</option>
		  <option value="jc_mmzjx.ztjjgw">展厅家居顾问</option>
		  <option value="jc_mmzjx.clzt">订单状态</option>
		  <option value="jc_mmzjx.pdgcmc">派单工厂</option>
		</select>
		第二列 
...
{
	if(!(isDatetime(FormName.jc_mmzjx_jhazsj, "计划安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmzjx_jhazsj2, "计划安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmzjx_azwcsj, "安装完成时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmzjx_azwcsj2, "安装完成时间"))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.jc_mmzjx_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmzjx_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
