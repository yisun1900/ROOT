...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 木门增项明细（增减项序号：<%=zjxxh%>）（注意：<font color="#FF6699">红色部分</font>会影响到价格）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveInsertJc_mmdgdmx.jsp" name="insertform" >
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3" bgcolor="#FFCCFF"> 
                <select name="mmxh" style="FONT-SIZE:12PX;WIDTH:452PX" onChange="getMmxh(insertform)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmxh,trim(mmxh)||'('||mxmc||','||myt||')' from jc_mmxhb,jdm_mxbm,jdm_mytbm where jc_mmxhb.mxbm=jdm_mxbm.mxbm and jc_mmxhb.mytbm=jdm_mytbm.mytbm and jc_mmxhb.dqbm='"+dqbm+"' and jc_mmxhb.mmxh in(select mmxh from jc_mmbjb where dqbm='"+dqbm+"') order by mmxh","");
%> 
                </select>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right" bgcolor="#FFCCFF"> 
                材质              </td>
              <td colspan="3" bgcolor="#FFCCFF"> 
...
%> 
              ...
              <td width="19%" align="right">（门,哑口,窗套）门芯线</td>
              <td width="31%">
...
%> 
              ...
              <td width="19%" align="right">玻璃型号</td>
              <td width="31%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%" bgcolor="#FFCCFF"> 
                ...
                （mm） </td>
              <td width="19%" align="right" bgcolor="#FFFFFF">地材厚</td>
              <td width="31%"> 
            ...
            <tr> 
              ...
              <td width="29%" bgcolor="#FFFFFF"> 
                ...
                无顶窗</td>
              <td width="19%" bgcolor="#FFFFFF" align="right">门套/哑口材质</td>
              <td width="31%" bgcolor="#FFFFFF"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="19%" align="right"> 
                <font color="#0000CC">单价（元）</font>              </td>
              <td width="31%"> 
