...
try {
	...
	ls_sql="select yddbh,mtxbm,mxxbm,dsk,mmdglxbm,mlx,mmxh,zjhsl,ysbm,czbm,azwzbm,kqfxbm,dbh,qh,mdk,mdg,ctbs,tjx,bzdj,dj,blxhbm,bz,dczlbm,sfsmjcc,sfydc ";
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3" bgcolor="#FFCCFF"> 
                <select name="mmxh" style="FONT-SIZE:12PX;WIDTH:452PX" onChange="getMmxh(insertform)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmxh,trim(mmxh)||'('||mxmc||','||myt||')' from jc_mmxhb,jdm_mxbm,jdm_mytbm where jc_mmxhb.mxbm=jdm_mxbm.mxbm and jc_mmxhb.mytbm=jdm_mytbm.mytbm and jc_mmxhb.dqbm='"+dqbm+"' and (jc_mmxhb.mmxh in(select mmxh from jc_mmbjb where dqbm='"+dqbm+"') OR jc_mmxhb.mmxh='"+mmxh+"') order by mmxh",mmxh);
%> 
                </select>
              </td>
            </tr>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="29%"> 
                <select name="dczlbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="getJg(dczlbm,dbh)">
                  <option value=""></option>
                  <%
...
%> 
              ...
              <td width="32%"> 
                <input type="text" name="tjx" value="<%=tjx%>" size="20" maxlength="8"  onChange="getDj(insertform)">
                延米/平米 </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="21%"> 
              ...
              <td width="29%"> 
                <input type="text" name="zjhsl" value="<%=zjhsl%>" size="20" maxlength="8" >
              </td>
              <td width="18%"> 
                <div align="right"><font color="#0000CC">单价（元）</font></div>
              </td>
              <td width="32%"> 
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="重新计算价格" onClick="getDj(insertform)" name="button">
              </td>
            </tr>
          </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.zjhsl, "订购数量"))) {
		return false;
	}
