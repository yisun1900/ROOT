...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,jc_mmydd.pdgcmc,paidr,azkssj,kazsj,aztzsj,azjssj,jhazsj,mmcljs,sshsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.lxfs,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.gys,jc_mmydd.bz  ";
    ...
    ls_sql+=" and jc_mmydd.clzt in('11','15')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgAzList.jsp","","","XgAzJc_mmydd.jsp");

//	pageObj.setEditStr("修改");
//设置显示列
	String[] disColName={"yddbh","khxm","clztmc","azkssj","azjssj","aztzsj","kazsj","jhazsj","pdgcmc","lxfs","fwdz","mmcljs","wjqk","xmzy","clgw","ztjjgw","hth","gys","bz"};
...
//设置按钮参数
	String[] buttonName={"删除安装信息"};//按钮的显示名称
	String[] buttonLink={"DeleteAzJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单--修改安装信息</font></B>
</CENTER>
<%
	pageObj.out=out;
