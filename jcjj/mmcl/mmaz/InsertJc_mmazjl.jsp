...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 请录入木门安装记录（预订单编号：<%=yddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveInsertJc_mmazjl.jsp" name="insertform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"> 
                <input type="text" name="smrq" value="<%=cf.today()%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
              <td width="15%"> 
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="hidden" name="yddbh" value="<%=yddbh%>" size="20" maxlength="9" >
              </td>
            </tr>
          </table>
</form>
