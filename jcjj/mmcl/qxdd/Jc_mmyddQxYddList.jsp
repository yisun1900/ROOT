...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yddbh,jc_mmydd.pdgcmc,paidr,paidsj,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.htje, DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,clztmc,jc_mmydd.lrsj,jc_mmydd.gys,jc_mmydd.ppmc,sq_dwxx.dwmc,jc_mmydd.bz  ";
    ...
    ls_sql+=" and jc_mmydd.clzt in('01','02','03')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddQxYddList.jsp","","","QxYddJc_mmydd.jsp");
//设置显示列
	String[] disColName={"clztmc","pdgcmc","paidr","paidsj","yddbh","khxm","hth","fwdz","wjqk","sqdj","xmzy","clgw","ztjjgw","gys","ppmc","lrsj","dwmc","bz"};
...
<CENTER >
  <B><font size="3">木门预订单---取消预订单</font></B> <font color="#0000FF"><b>(注意：<b><font color="#FF0000">不包括已签合同订单，已签合同的要做【退单】</font></b>)</b></font> 
</CENTER>
<%
	pageObj.out=out;
