...
String jc_mmydd_kazsj=null;
String jc_mmydd_aztzr=null;
...
try {
	...
	if (rs.next())
	{
		...
		jc_mmydd_kazsj=cf.fillNull(rs.getDate("jc_mmydd_kazsj"));
		jc_mmydd_aztzr=cf.fillNull(rs.getString("jc_mmydd_aztzr"));
		jc_mmydd_aztzsj=cf.fillNull(rs.getDate("jc_mmydd_aztzsj"));
...
<div align="center">木门预订单---修改安装通知</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><font color="#0000FF">计划安装时间</font></td>
      <td width="28%"> 
        <input type="text" name="jhazsj" size="20" maxlength="10"  value="<%=jc_mmydd_jhazsj%>" readonly>      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right"><font color="#0000FF">协商安装时间</font></td>
      <td width="27%"> 
        <input type="text" name="kazsj" size="20" maxlength="10" value="<%=jc_mmydd_kazsj%>" readonly>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><font color="#0000FF">发安装通知人</font></td>
      <td width="28%"> 
        <input type="text" name="aztzr" size="20" maxlength="10" value="<%=yhmc%>" readonly>      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">发安装通知时间</td>
      <td width="27%"> 
        <input type="text" name="aztzsj" size="20" maxlength="10" value="<%=jc_mmydd_aztzsj%>" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#E8E8FF">
      <td align="right">安装时间备注</td>
      <td colspan="3"><textarea name="azsjbz" cols="71" rows="3"><%=azsjbz%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
%> </td>
  ...
  <tr bgcolor="#99CCFF"> 
    <td width="19%" align="right"> 
      计划安装时间    </td>
    <td width="31%"> <%=jc_mmydd_jhazsj%> </td>
    <td width="17%" align="right"> 
      协商安装时间    </td>
    <td width="33%"> <%=jc_mmydd_kazsj%> </td>
  </tr>
</table>
</body>
</html>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgAztzJc_mmydd.jsp";
	FormName.submit();
	return true;
}
