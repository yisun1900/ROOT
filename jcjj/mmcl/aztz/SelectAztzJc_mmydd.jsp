...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---发安装通知</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
              <input type="text" name="jc_mmydd_kazsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
              <input type="text" name="jc_mmydd_kazsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            ...
            <tr bgcolor="#CCFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="myxssl" size="20" maxlength="13" value="300">
              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_kazsj, "计划安装时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_kazsj2, "计划安装时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddAztzList.jsp";
