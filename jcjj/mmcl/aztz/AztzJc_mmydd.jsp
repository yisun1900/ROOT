...
<div align="center">木门预订单---发安装通知</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><font color="#0000FF">合同安装时间</font></td>
      <td width="28%"> 
      ...
      <td width="27%"> 
        <input type="text" name="kazsj" size="20" maxlength="10" value="<%=kazsj%>" readonly>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><font color="#0000FF">发通知人</font></td>
      <td width="28%"> 
        <input type="text" name="aztzr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">发通知时间</td>
      <td width="27%"> 
        <input type="text" name="aztzsj" size="20" maxlength="10"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#E8E8FF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveAztzJc_mmydd.jsp";
	FormName.submit();
	return true;
}
