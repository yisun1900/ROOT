...
<body bgcolor="#FFFFFF">
<div align="center">木门订单---接收客户自购五金件（单号：<%=yddbh%>） </div>
  
<form method="post" action="" name="selectform" >
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">接收五金时间</td>
      <td width="28%"> 
        <input type="text" name="swjsj" size="20" maxlength="20" value="<%=cf.today()%>" onDblClick="JSCalendar(this)">
      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">五金接收人</td>
      <td width="27%"> 
        <input type="text" name="wjjsr" size="20" maxlength="20" value="<%=yhmc%>" readonly>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">五金接收情况</td>
      <td colspan="3"> 
        <textarea name="wjjsqk" rows="3" cols="71"></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.swjsj, "送五金时间"))) {
		return false;
	}
