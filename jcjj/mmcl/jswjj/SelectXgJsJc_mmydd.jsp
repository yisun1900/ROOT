...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---修改接收情况</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><select name="jc_mmydd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="04">签订合同</option>
                  <option value="23">收款确认</option>
                  <option value="05">工厂接收</option>
                  <option value="06">已入库</option>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">五金接收时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_swjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_swjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_swjsj, "五金接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_swjsj2, "五金接收时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddXgJsList.jsp";
