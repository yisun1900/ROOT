...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---接收自购五金件</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">收款确认时间 从</td>
              <td width="30%"> 
...
{
	if(!(isDatetime(FormName.jc_mmydd_skqrsj, "收款确认时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_skqrsj2, "收款确认时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddJsList.jsp";
