...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---修改复测通知</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><select name="jc_mmydd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectItem(out,"select jgclzt,clztmc from jdm_mmclzt,jdm_mmyddzt where jdm_mmclzt.jgclzt=jdm_mmyddzt.clzt and cdmc='通知复测' order by jgclzt","");
%> 
                </select>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">通知复测时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_tzfcsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_tzfcsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">发复测通知时间 从</td>
              <td width="30%"> 
                <input type="text" name="jc_mmydd_ffctzsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"> 
                <input type="text" name="jc_mmydd_ffctzsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
{
	if(!(isDatetime(FormName.jc_mmydd_tzfcsj, "通知复测时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_tzfcsj2, "通知复测时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_ffctzsj, "发复测通知时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_ffctzsj2, "发复测通知时间"))) {
		return false;
	}

	FormName.action="Jc_mmyddXgFctzList.jsp";
