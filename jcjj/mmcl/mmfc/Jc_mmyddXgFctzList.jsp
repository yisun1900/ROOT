...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jc_mmydd_tzfcsj=request.getParameter("jc_mmydd_tzfcsj");
	if (jc_mmydd_tzfcsj!=null)
	{
		jc_mmydd_tzfcsj=jc_mmydd_tzfcsj.trim();
		if (!(jc_mmydd_tzfcsj.equals("")))	wheresql+="  and (jc_mmydd.tzfcsj>=TO_DATE('"+jc_mmydd_tzfcsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_tzfcsj=request.getParameter("jc_mmydd_tzfcsj2");
	if (jc_mmydd_tzfcsj!=null)
	{
		jc_mmydd_tzfcsj=jc_mmydd_tzfcsj.trim();
		if (!(jc_mmydd_tzfcsj.equals("")))	wheresql+="  and (jc_mmydd.tzfcsj<=TO_DATE('"+jc_mmydd_tzfcsj+"','YYYY-MM-DD'))";
	...
	String jc_mmydd_ffctzsj=null;
	jc_mmydd_ffctzsj=request.getParameter("jc_mmydd_ffctzsj");
	if (jc_mmydd_ffctzsj!=null)
	{
		jc_mmydd_ffctzsj=jc_mmydd_ffctzsj.trim();
		if (!(jc_mmydd_ffctzsj.equals("")))	wheresql+="  and (jc_mmydd.ffctzsj>=TO_DATE('"+jc_mmydd_ffctzsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_ffctzsj=request.getParameter("jc_mmydd_ffctzsj2");
	if (jc_mmydd_ffctzsj!=null)
	{
		jc_mmydd_ffctzsj=jc_mmydd_ffctzsj.trim();
		if (!(jc_mmydd_ffctzsj.equals("")))	wheresql+="  and (jc_mmydd.ffctzsj<=TO_DATE('"+jc_mmydd_ffctzsj+"','YYYY-MM-DD'))";
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.ffctzsj,jc_mmydd.tzfcsj,jc_mmydd.ffctzr,jc_mmydd.pdgcmc,mmcljs,jc_mmydd.htje,jc_mmydd.mmhtje,jc_mmydd.wjhtje,jc_mmydd.blhtje,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.ffctzsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgFctzList.jsp","","","XgFctzJc_mmydd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除复测通知"};//按钮的显示名称
	String[] buttonLink={"DeleteFctzJc_mmydd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门预订单---修改复测通知</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">家装合同号</td>
	<td  width="4%">处理状态</td>
	<td  width="5%">发复测通知时间</td>
	<td  width="5%">通知复测时间</td>
	<td  width="4%">发复测通知人</td>
	<td  width="7%">派单工厂</td>
	<td  width="4%">测量技师</td>
	<td  width="6%">合同金额</td>
	<td  width="6%">木门合同金额</td>
	<td  width="6%">五金合同金额</td>
	<td  width="5%">玻璃合同金额</td>
	<td  width="4%">服务费</td>
	<td  width="4%">五金情况</td>
	<td  width="3%">项目专员</td>
