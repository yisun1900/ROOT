...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_mmydd_gcjslrsj=null;

	jc_mmydd_gcjslrsj=request.getParameter("jc_mmydd_gcjslrsj");
	if (jc_mmydd_gcjslrsj!=null)
	{
		jc_mmydd_gcjslrsj=jc_mmydd_gcjslrsj.trim();
		if (!(jc_mmydd_gcjslrsj.equals("")))	wheresql+="  and (jc_mmydd.gcjslrsj>=TO_DATE('"+jc_mmydd_gcjslrsj+"','YYYY-MM-DD'))";
	}
	jc_mmydd_gcjslrsj=request.getParameter("jc_mmydd_gcjslrsj2");
	if (jc_mmydd_gcjslrsj!=null)
	{
		jc_mmydd_gcjslrsj=jc_mmydd_gcjslrsj.trim();
		if (!(jc_mmydd_gcjslrsj.equals("")))	wheresql+="  and (jc_mmydd.gcjslrsj<=TO_DATE('"+jc_mmydd_gcjslrsj+"','YYYY-MM-DD'))";
	...
	ls_sql="SELECT yddbh,crm_khxx.khxm,crm_khxx.hth,clztmc,jc_mmydd.gcjslrsj,jc_mmydd.gcjslrr,jc_mmydd.pdgcmc,mmcljs,jc_mmydd.htje,jc_mmydd.mmhtje,jc_mmydd.wjhtje,jc_mmydd.blhtje,jc_mmydd.fwf, DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.lrsj,jc_mmydd.bz,jc_mmydd.khbh  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mmydd.gcjslrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddXgJsList.jsp","","","/jcjj/dygl/dymmht.jsp");
...
//设置按钮参数
	String[] buttonName={"删除接收信息"};//按钮的显示名称
...
<CENTER >
  <B><font size="3">木门预订单---修改工厂接收</font></B>
</CENTER>
<%
	pageObj.out=out;
