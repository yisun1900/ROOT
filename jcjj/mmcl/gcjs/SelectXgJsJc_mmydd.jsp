...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单---修改工厂接收</div></td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right">工厂接收时间 从</td>
              <td width="30%"> 
...
{
	if(!(isDatetime(FormName.jc_mmydd_gcjslrsj, "工厂接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmydd_gcjslrsj2, "工厂接收时间"))) {
		return false;
	}
