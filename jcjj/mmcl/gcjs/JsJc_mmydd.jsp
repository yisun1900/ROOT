...
<body bgcolor="#FFFFFF">
<div align="center">木门预订单---工厂接收（预订单编号：<%=jc_mmydd_yddbh%>）
  
</div>
<form method="post" action="" name="selectform">
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#CCCCFF">
      <td align="right"> 木门合同金额 </td>
      <td><%=jc_mmydd_mmhtje%> </td>
      <td align="right"> 五金合同金额 </td>
      <td><%=jc_mmydd_wjhtje%> </td>
    </tr>
    <tr bgcolor="#CCCCFF">
      <td align="right"> 玻璃合同金额 </td>
      <td><%=jc_mmydd_blhtje%> </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">工厂接收录入时间</td>
      <td width="28%"> 
        <input type="text" name="gcjslrsj" size="20" maxlength="10"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)">      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">工厂接收录入人</td>
      <td width="27%"> 
        <input type="text" name="gcjslrr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td height="39" colspan="4" align="center"> 
        <div align="center"> 
          <input type="button"  value="接收" onClick="f_do(selectform)">
           <input type="button"  value="接收并打印合同" onClick="f_do1(selectform)" >
...
{
	if(	javaTrim(FormName.gcjslrsj)=="") {
		alert("请输入[工厂接收录入时间]！");
		FormName.gcjslrsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.gcjslrsj, "工厂接收录入时间"))) {
		return false;
	}
	if(	javaTrim(FormName.gcjslrr)=="") {
		alert("请输入[工厂接收录入人]！");
		FormName.gcjslrr.focus();
		return false;
	}


	FormName.action="SaveJsJc_mmydd.jsp";
	FormName.submit();
	return true;
}
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="GcjsDyJc_mmydd.jsp";
	FormName.submit();
	return true;
}
