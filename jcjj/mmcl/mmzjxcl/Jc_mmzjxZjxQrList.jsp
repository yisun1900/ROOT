...
//	out.println(ls_sql);
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmzjxZjxQrList.jsp","","","ZjxQrJc_mmzjx.jsp");
...
//设置按钮参数
	String[] buttonName={"批量确认"};//按钮的显示名称
	String[] buttonLink={"PlZjxQrJc_mmzjx.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门增减项处理－增减项确认</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">增减项确认时间</td>
	<td  width="5%">增减项原因</td>
	<td  width="5%">增减项总额-折前</td>
