...
<form method="post" action="Jc_mmzjxXgQrList.jsp" name="selectform">
<div align="center">木门增减项处理－修改工厂接收</div>
...
%>
	...
	<tr bgcolor="#FFFFFF">
	  <td align="right"> 工厂接收时间 从 </td>
	  <td><input type="text" name="jc_mmzjx_qrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	  <td align="right"> 到 </td>
	  <td><input type="text" name="jc_mmzjx_qrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">	  </td>
	</tr>
	<tr align="center"> 
	  <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jc_mmzjx_qrsj, "工厂接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_mmzjx_qrsj2, "工厂接收时间"))) {
		return false;
	}
	FormName.submit();
	return true;
