...
<div align="center">木门增减项处理-增项入库 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="28%"> 
        <input type="text" name="srksj" size="20" maxlength="10"  value="<%=jc_mmzjx_srksj%>" readonly>
      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right">入库人</td>
      <td width="27%"> 
        <input type="text" name="rkr" size="20" maxlength="20"  value="<%=jc_mmzjx_rkr%>" readonly>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%">入库说明</td>
      <td colspan="3"> 
        <textarea name="rksm" rows="3" cols="71"><%=jc_mmzjx_rksm%></textarea>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgRkJc_mmzjx.jsp";
	FormName.submit();
	return true;
