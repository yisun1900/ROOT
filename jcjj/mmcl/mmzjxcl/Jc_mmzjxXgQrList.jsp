...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_mmzjx_qrsj=null;
	jc_mmzjx_qrsj=request.getParameter("jc_mmzjx_qrsj");
	if (jc_mmzjx_qrsj!=null)
	{
		jc_mmzjx_qrsj=jc_mmzjx_qrsj.trim();
		if (!(jc_mmzjx_qrsj.equals("")))	wheresql+="  and (jc_mmzjx.qrsj>=TO_DATE('"+jc_mmzjx_qrsj+"','YYYY/MM/DD'))";
	}
	jc_mmzjx_qrsj=request.getParameter("jc_mmzjx_qrsj2");
	if (jc_mmzjx_qrsj!=null)
	{
		jc_mmzjx_qrsj=jc_mmzjx_qrsj.trim();
		if (!(jc_mmzjx_qrsj.equals("")))	wheresql+="  and (jc_mmzjx.qrsj<=TO_DATE('"+jc_mmzjx_qrsj+"','YYYY/MM/DD'))";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by jc_mmzjx.qrsj desc";

//	out.println(ls_sql);

    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmzjxXgQrList.jsp","","","XgQrJc_mmzjx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQrJc_mmzjx.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门增减项处理－修改工厂接收</font></B>
</CENTER>
<%
	pageObj.out=out;
