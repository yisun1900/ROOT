...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_mmzjx.zjxxh,DECODE(jc_mmzjx.clzt,'00','录入未完成','01','录入完成','05','增减项确认','02','工厂已接收','03','已入库','04','安装完成','99','退单'),jc_mmzjx.yddbh,pdgcmc,crm_khxx.khxm,crm_khxx.fwdz,jc_mmzjx.zjxqrsj,jc_mmzjx.zjxqrr,jc_mmzjx.zjxfssj,mmzjxyymc,jc_mmzjx.zqzjxze,jc_mmzjx.zjxze,TO_CHAR(jc_mmzjx.mmzkl) mmzkl,jc_mmzjx.dzyy,jc_mmzjx.xmzy,jc_mmzjx.clgw,jc_mmzjx.ztjjgw,jc_mmzjx.khbh,crm_khxx.hth,crm_khxx.sjs,crm_khxx.zjxm,sgdmc ";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by jc_mmzjx.zjxqrsj desc";

//	out.println(ls_sql);

    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmzjxXgZjxQrList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteZjxQrJc_mmzjx.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门增减项处理－修改增减项确认</font></B>
</CENTER>
<%
	pageObj.out=out;
