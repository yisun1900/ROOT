...
<body bgcolor="#FFFFFF">
<div align="center">木门预订单---修改木门初测单 </div>
  
<form method="post" action="" name="selectform" target="_blank">
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><span class="STYLE1">*</span>木门测量技师</td>
      <td width="28%"> 
        <select name="mmcljs" style="FONT-SIZE:12PX;WIDTH:152PX" >
          <option value=""></option>
          <%
	cf.selectItem(out,"select sq_gyslxr.lxrxm,sq_gyslxr.lxrxm||':'||sq_gyslxr.sj  from sq_gyslxr,sq_gysbm,jxc_gyssqfgs where sq_gyslxr.gysbm=sq_gysbm.gysbm and sq_gysbm.gysbm=jxc_gyssqfgs.gysbm and jxc_gyssqfgs.ssfgs='"+ssfgs+"' and sq_gysbm.gys='"+gys+"' and sq_gyslxr.zw='木门测量师'",jc_mmydd_mmcljs);
%> 
        </select>
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="27%"> 
        <input type="text" name="sccsj" size="20" maxlength="20" value="<%=jc_mmydd_sccsj%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="22%"><span class="STYLE1">*</span><span class="STYLE2">初测录入人</span></td>
      <td width="28%"> 
        <input type="text" name="cclrr" value="<%=cclrr%>" size="20" maxlength="20" readonly>
      </td>
      <td width="23%" bgcolor="#E8E8FF" align="right"><span class="STYLE1">*</span><span class="STYLE2">初测录入时间</span></td>
      <td width="27%"> 
        <input type="text" name="cclrsj" value="<%=cclrsj%>" size="20" maxlength="10" readonly>
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      <td colspan="4" height="39"> 
        <div align="center"> 
          ...
          <input type="button"  value="录入初测单明细" onClick="f_do1(selectform)" name="lr" >
          <input type="button"  value="查看初测单明细" onClick="f_do2(selectform)" name="ck" >
          <input type="button"  value="打印初测单" onClick="window.open('/jcjj/dygl/dymmccd.jsp?yddbh=<%=yddbh%>')">
...
%>    </td>
  ...
  <tr bgcolor="#99CCFF">
    <td bgcolor="#99CCFF" align="right">备注</td>
...
*/
	FormName.action="SaveXgCcJc_mmydd.jsp";
	FormName.submit();
	return true;
}
