...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT TO_CHAR(lrxh) lrxh,DECODE(lx,'1','合同项','2','增项','3','减项') lx,jc_blddmx.yddbh as yddbh,jc_blddmx.blxhbm as blxhbm,jc_blbj.blxh as jc_blbj_blxh,TO_CHAR(jc_blddmx.dj) as jc_blddmx_dj,jc_blddmx.sl as jc_blddmx_sl,jc_blddmx.dj*jc_blddmx.sl je,jc_blddmx.bz as jc_blddmx_bz  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Jc_blddmxZxList.jsp?yddbh="+yddbh};//按钮单击调用的网页，可以增加参数
