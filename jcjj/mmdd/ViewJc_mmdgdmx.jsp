...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">折后单价</td>
	<td  width="3%">合同数量</td>
	<td  width="4%">合同金额-折前</td>
	<td  width="4%">合同金额-折后</td>
	<td  width="3%">增减后数量</td>
	<td  width="4%">增减后总额-折前</td>
	<td  width="4%">增减后总额-折后</td>
	<td  width="7%">备注</td>
	<td  width="5%">照片</td>
	<td  width="2%">自动计价</td>
</tr>
...
//设置显示列
	String[] disColName={"lx","mmdglxmc","mlxmc","mmxh","mmczmc","czmc","azwzmc","kqfxmc","mtxmc","mxxmc","dczlmc","dbh","md","tjx","blxh","ctbs","sfsmjcc","sfydc","bzdj","dj","sl","zqzj","zj","zjhsl","zqzjhze","zjhze","bz","zp","sfzdjj"};
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">折后单价</td>
	<td  width="4%">合同数量</td>
	<td  width="6%">合同金额-折前</td>
	<td  width="6%">合同金额-折后</td>
	<td  width="4%">增减后数量</td>
	<td  width="6%">增减后总额-折前</td>
	<td  width="6%">增减后总额-折后</td>
	<td  width="13%">备注</td>
</tr>
<%

	ls_sql="SELECT '',DECODE(lx,'1','合同项','2','增项') lx,wjmc,jdm_wjjbm.wjjmc,jc_wjjddmx.xinghao ,mmsbsmc,TO_CHAR(jc_wjjddmx.bzdj),TO_CHAR(jc_wjjddmx.dj),jc_wjjddmx.sl,jc_wjjddmx.bzdj*jc_wjjddmx.sl zqje,jc_wjjddmx.dj*jc_wjjddmx.sl je,jc_wjjddmx.zjhsl,jc_wjjddmx.bzdj*jc_wjjddmx.zjhsl zqzjhze,jc_wjjddmx.dj*jc_wjjddmx.zjhsl zjhze,jc_wjjddmx.bz as jc_wjjddmx_bz  ";
...
<%
	...
	ls_sql="SELECT '',DECODE(lx,'1','合同项','2','增项') lx,blxh,TO_CHAR(jc_blddmx.bzdj),TO_CHAR(jc_blddmx.dj),jc_blddmx.sl,jc_blddmx.bzdj*jc_blddmx.sl zqje,jc_blddmx.dj*jc_blddmx.sl je,jc_blddmx.zjhsl,jc_blddmx.bzdj*jc_blddmx.zjhsl zqzjhze,jc_blddmx.dj*jc_blddmx.zjhsl zjhze,jc_blddmx.bz  ";
