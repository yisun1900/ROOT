...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">木门预订单（订单编号：<%=jc_mmydd_yddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%>（<%=dzdh%>） </td>
          ...
          <tr bgcolor="#CCFFCC"> 
            <td width="22%" align="right">参加促销活动</td>
            <td width="28%"> <%=cxhdbm%> </td>
            <td width="21%" align="right">订金</td>
            <td width="29%"><%=fkje%></td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%"> 
...
%> </td>
          ...
          <tr bgcolor="#99CCFF"> 
            <td width="22%"> 
              <div align="right">完结录入人</div>
            </td>
            <td width="28%"> <%=wjlrr%> </td>
            <td width="21%"> 
              <div align="right">完结时间</div>
            </td>
            <td width="29%"> <%=wjsj%> </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td colspan="4"> 
              <div align="center"> 
                <input type="button" value="木门预订单" onClick="window.open('/jcjj/mmdd/ViewJc_mmydmx.jsp?yddbh=<%=yddbh%>')">
              </div>
            </td>
          </tr>
          <tr bgcolor="#99CCFF">
            <td width="22%" align="right">订单所属分公司</td>
            <td width="28%">
<%
...
%> </td>
            <td width="21%" align="right">订单所属设计师</td>
            <td width="29%"><%=jzsjs%></td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" bgcolor="#99CCFF" align="right">项目专员</td>
            <td width="28%"><%=xmzy%></td>
            <td width="21%" align="right">木门订金</td>
          ...
          <tr bgcolor="#99CCFF"> 
            ...
            <td width="29%"><%
	cf.selectToken(out,"2+家装客户&4+非家装客户",khlx,true);
%> </td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" bgcolor="#99CCFF" align="right">备注</td>
          ...
          <tr bgcolor="#FFFFCC"> 
            <td width="22%"> 
              <div align="right">派单工厂</div>
            </td>
            <td width="28%"> <%=jc_mmydd_pdgc%> </td>
            <td width="21%"> 
              <div align="right">派单工厂名称</div>
            </td>
          ...
          <tr bgcolor="#FFFFCC"> 
            <td width="22%" align="right">木门测量技师</td>
          ...
          <tr bgcolor="#FFFFCC"> 
            ...
            <td width="21%"> 
              <div align="right">实初测时间</div>
            </td>
            <td width="29%"><%=jc_mmydd_sccsj%> </td>
          </tr>
          <tr bgcolor="#FFFFCC"> 
            <td width="22%" align="right" bgcolor="#FFFFCC">初测说明</td>
            <td colspan="3"><%=jc_mmydd_ccsm%></td>
          </tr>
          <tr bgcolor="#FFFFCC"> 
            <td width="22%" bgcolor="#FFFFCC" align="right">初测录入人</td>
            <td width="28%"><%=cclrr%></td>
            <td width="21%" align="right">初测录入时间</td>
            <td width="29%"><%=cclrsj%></td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">计划初测时间修改人</td>
            <td width="28%"><%=jhccxgr%></td>
            <td width="21%" align="right">修改时间</td>
            <td width="29%"><%=jhccxgsj%></td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">修改原因</td>
            <td colspan="3"><%=jhccxgyy%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td colspan="4"> 
              <div align="center"> 
                <input type="button" value="合同明细" onClick="window.open('/jcjj/mmdd/ViewJc_mmdgdmx.jsp?yddbh=<%=yddbh%>')">
                <input type="button" value="增减项" onClick="window.open('/jcjj/mmdd/ViewJc_mmzjx.jsp?yddbh=<%=yddbh%>')" >
              </div>
            </td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">木门合同金额</td>
            <td width="28%"> <%=jc_mmydd_mmhtje%> </td>
            <td width="21%" align="right">增减后木门金额</td>
          ...
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">玻璃合同金额</td>
            <td width="28%"> <%=jc_mmydd_blhtje%> </td>
            <td width="21%" align="right">增减后玻璃金额</td>
          ...
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" bgcolor="#CCCCFF" align="right">合同金额</td>
            <td width="28%"><%=jc_mmydd_htje%></td>
            <td width="21%" align="right">增减后总额</td>
            <td width="29%"><%=zjhze%></td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right" bgcolor="#CCCCFF">签合同日期</td>
            <td width="28%"> <%=jc_mmydd_htrq%> </td>
            <td width="21%" align="right">合同签定人</td>
            <td width="29%"> <%=jc_mmydd_htqdr%> </td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right" bgcolor="#CCCCFF">合同备注</td>
...
%> </td>
          ...
          <tr bgcolor="#99CCFF"> 
            <td width="22%"> 
              <div align="right">送五金时间</div>
            </td>
            <td width="28%" bgcolor="#99CCFF"> <%=jc_mmydd_swjsj%> </td>
            <td width="21%"> 
              <div align="right">五金接收人</div>
            </td>
            <td width="29%"> <%=jc_mmydd_wjjsr%> </td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" align="right">五金接收情况</td>
            <td colspan="3"><%=jc_mmydd_wjjsqk%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td colspan="4"> 
              <div align="center"> 
                <input type="button"  value="安装时间记录" onClick="window.open('/jcjj/mmdd/ViewJc_mmazsjjl.jsp?yddbh=<%=yddbh%>')" name="button2">
                <input type="button" value="安装记录"  onClick="window.open('/jcjj/mmdd/ViewJc_mmazjl.jsp?yddbh=<%=yddbh%>')" name="button">
                <input type="button" value="安装反馈单"  onClick="window.open('/jcjj/mmdd/ViewJc_mmazfkd.jsp?yddbh=<%=yddbh%>')">
              </div>
            </td>
          </tr>
          <tr bgcolor="#FFFFCC"> 
          ...
          <tr bgcolor="#FFFFCC"> 
            <td width="22%" align="right"> 实入库时间</td>
            <td width="28%"><%=jc_mmydd_srksj%> </td>
            <td width="21%" align="right"> 入库人</td>
            <td width="29%"><%=jc_mmydd_rkr%> </td>
          </tr>
          <tr bgcolor="#FFFFCC"> 
            <td width="22%" align="right">入库说明</td>
            <td colspan="3"><%=jc_mmydd_rksm%></td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" align="right"> 合同安装时间</td>
            <td width="28%"> <%=jc_mmydd_jhazsj%> </td>
            <td width="21%" align="right"> 协商安装时间</td>
...
%> </td>
          ...
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right" height="20">延迟说明</td>
            <td colspan="3" height="20"><%=jc_mmydd_ycsm%></td>
          </tr>
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">真实延迟原因</td>
            <td width="28%"><%
...
%></td>
          ...
          <tr bgcolor="#CCCCFF"> 
            <td width="22%" align="right">延迟核实情况</td>
...
%> </td>
          ...
          <tr bgcolor="#99CCFF"> 
            <td width="22%" align="right">退单时间</td>
            <td width="28%"><%=tdsj%></td>
            <td width="21%" align="right">退单录入人</td>
            <td width="29%"><%=tdlrr%></td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" align="right">扣测量费</td>
            <td width="28%"><%=kclf%></td>
            <td width="21%" align="right">退单原因</td>
            <td width="29%"> <%
	cf.selectItem(out,"select jctdyybm,jctdyymc from jdm_jctdyybm where jctdyybm='"+jctdyybm+"'",jctdyybm,false);
%> </td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%" align="right">退单说明</td>
            <td colspan="3"><%=tdsm%></td>
          </tr>
          <tr bgcolor="#99CCFF"> 
            <td width="22%"> 
              <div align="right">是否与工厂结算</div>
            </td>
            <td width="28%"> <%
