...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  yddbh,clztmc,jc_mmydd.xmzy,jc_mmydd.clgw,jc_mmydd.ztjjgw,jc_mmydd.pdgc,jc_mmydd.mmzkl,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,c.dwmc,ysgcjdmc,cxhdbm,jc_mmydd.sccsj,jc_mmydd.htrq,jc_mmydd.jhazsj,kazsj,aztzsj,jc_mmydd.azkssj,jc_mmydd.azjssj,jc_mmydd.tdsj,jc_mmydd.wdzje,jc_mmydd.htje,jc_mmydd.zqzjhze,jc_mmydd.zjhze,jc_mmydd.dzyy,DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,jc_mmydd.lrsj,jc_mmydd.khbh ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_mmyddTqList.jsp","","","TqEditJc_mmydd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteTqJc_mmyd.jsp","plxgGys.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">木门订单－维护特权</font></B>
</CENTER>
<%
	pageObj.out=out;
