...
%>	
  <tr>
    <td> 
      <div align="center"><b>木门投诉统计</b> <b>(<%=sjfw%>--<%=sjfw2%>)</b></div>
	...
	ls_sql+=" and sq_gysxx.gyslb='1'";//1：木门；2：橱柜；3：家具；4：主材
	ls_sql+=" and crm_tsjl.slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=" and crm_tsjl.slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
...
%> 
	  ...
	  <br>
  <div align="center"><b>木门投诉原因统计</b> <b>(<%=sjfw%>--<%=sjfw2%>)</b></div>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
...
%> 
  ...
  <div align="center"><b>GZ木门原因统计</b> <b>(<%=sjfw%>--<%=sjfw2%>)</b></div>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
	...
	ls_sql+=" where crm_tsjl.tsjlh=crm_tspp.tsjlh and crm_tspp.tspp=sq_gysxx.gysbh and crm_tsjl.lx='1'";
	ls_sql+=" and sq_gysxx.gyslb='1'";//1：木门；2：橱柜；3：家具；4：主材
	ls_sql+=" and sq_gysxx.gysbh='G00212'";//
	ls_sql+=" and crm_tsjl.slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=" and crm_tsjl.slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	ls_sql+=" and crm_tsjl.khbh=crm_khxx.khbh";
	ls_sql+=dwbhsql;
...
%> 
	  ...
	  <br>
	   ...
	   <div align="center"><b>YT木门原因统计</b> <b>(<%=sjfw%>--<%=sjfw2%>)</b></div>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
	...
	ls_sql+=" where crm_tsjl.tsjlh=crm_tspp.tsjlh and crm_tspp.tspp=sq_gysxx.gysbh and crm_tsjl.lx='1'";
	ls_sql+=" and sq_gysxx.gyslb='1'";//1：木门；2：橱柜；3：家具；4：主材
	ls_sql+=" and sq_gysxx.gysbh='G0021'";//
	ls_sql+=" and crm_tsjl.slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=" and crm_tsjl.slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	ls_sql+=" and crm_tsjl.khbh=crm_khxx.khbh";
	ls_sql+=dwbhsql;
