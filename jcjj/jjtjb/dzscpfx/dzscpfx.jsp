...
%>
    ...
    <input type="button"  value="橱柜店面对比" onClick="f_do(selectform)">
        <input type="button"  value="定制式产品统计" onClick="f_do1(selectform)" name="button">
		 <input type="button"  value="主材统计" onClick="f_do2(selectform)" name="button">
		 <input type="button"  value="加权平均占有比例" onClick="f_do3(selectform)" name="button">
