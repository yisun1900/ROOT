...
%>
    ...
    <input type="button"  value="完工订购集成产品种类统计" onClick="f_do(selectform)">
	    <input type="button"  value="完工申请单未订集成的比例" onClick="f_do1(selectform)">
