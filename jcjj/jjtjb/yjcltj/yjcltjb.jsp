...
<br>
    <div align="center"><b>外主材各类产品实收款所占比例</b><br> <b>(<%=sjfw%>--<%=sjfw2%>)</b></div>
...
<%
	...
	rs1.close();
	//按外主材各类产品进行分类统计
	ls_sql="select zcdlmc,(sum(hkze+zjhze)) from jc_zcdd,jdm_zcdlbm,crm_khxx where jc_zcdd.khbh=crm_khxx.khbh and jc_zcdd.zcdlbm=jdm_zcdlbm.zcdlbm and jc_zcdd.lrsj<=TO_DATE('"+sjfw2+"','YYYY-MM-DD') and jc_zcdd.lrsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=wheresql;
