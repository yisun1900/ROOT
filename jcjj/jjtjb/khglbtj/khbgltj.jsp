...
%>
    ...
    <input type="button"  value="项目管理部完结客户统计" onClick="f_do(selectform)">
	<input type="button"  value="参加促销活动类别统计" onClick="f_do1(selectform)">
