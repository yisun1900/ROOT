...
try {
	...
	{
		ls_sql="select khxm,crm_khxx.xmzy,fwdz,lxfs,hth,khjl,sjs,qye,kgrq,jgrq,fgsbh,crm_khxx.dwbh,dwmc,cxhdbm,zjxm,sgd,sgbz,qyrq,crm_khxx.jjwjbz";
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right"><font color="#FF0000">*</font><font color="#0000FF">折前合同总额</font></td>
              <td width="31%"><input type="text" name="wdzje" value="0" size="20" maxlength="20" readonly></td>
              <td width="18%" align="right"><font color="#FF0000">*</font><font color="#0000FF">折后合同额</font></td>
              <td width="32%"><input type="text" name="hkze" value="0" size="20" maxlength="20" readonly></td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right"><font color="#FF0000">*</font><font color="#0000FF">计入促销活动金额</font></td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFCC">
              <td align="right"><font color="#FF0000">*</font>减免金额</td>
              <td><input type="text" name="jmje" value="0" size="20" maxlength="20" ></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"><select name="zcdlbm" style="FONT-SIZE:12PX;WIDTH:152PX"  onchange="changeDl(insertform)">
                <option value=""></option>
                <%
	cf.selectItem(out,"select cldlmc c1,cldlmc c2 from jxc_cldlbm where cldllb in('1','3')  order by cldlbm","");
%>
              </select></td>
              <td width="18%" align="right"><font color="#FF0000">*</font>主材小类</td>
              <td width="32%"><select name="zcxlbm" style="FONT-SIZE:12PX;WIDTH:152PX" >
              </select></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"><font color="#FF0000">*</font>品牌</td>
...
%> 
              ...
              <td width="18%" align="right"><font color="#FF0000">*</font>展厅家居顾问</td>
              <td width="32%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="radio" name="ddshbz" value="1">
                不需等待通知 
                <input type="radio" name="ddshbz" value="2">
                需等待通知 </td>
...
function getPp(FormName)
{
	...
	var sql="select distinct jxc_ppxx.ppmc c1,jxc_ppxx.ppmc||NVL2(yhkssj,'（优惠期'||TO_CHAR(yhkssj,'YYYY-MM-DD')||'至'||TO_CHAR(yhjzsj,'YYYY-MM-DD')||'）','') c2 from jxc_ppxx,jxc_ppgysdzb where jxc_ppxx.ppbm=jxc_ppgysdzb.ppbm and jxc_ppgysdzb.ssfgs='"+FormName.fgsbh.value+"' and jxc_ppxx.cldl='"+FormName.zcdlbm.value+"' order by jxc_ppxx.ppmc";
