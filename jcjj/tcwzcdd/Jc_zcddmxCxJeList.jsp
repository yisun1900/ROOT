...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcddmx.xh,DECODE(jc_zcddmx.sftjcp,'Y','推荐','N','否'),jc_zcddmx.khbh,crm_khxx.hth,crm_khxx.khxm,bjjbmc,jc_zcddmx.jzsjs,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcddmx.ddbh,clztmc,jc_zcdd.wjsj,DECODE(jc_zcddmx.lx,'1','合同项','2','增项'),DECODE(jc_zcddmx.sxbz,'1','非手写','2','手写'),jc_zcddmx.zcbm,jc_zcddmx.zcmc,jc_zcddmx.zcdlbm,jc_zcddmx.zcxlbm,jc_zcddmx.dwbh,jc_zcddmx.gys,jc_zcddmx.ppmc,jc_zcddmx.zclbbm,jc_zcddmx.xinghao,jc_zcddmx.gg,jc_zcddmx.zcysbm,jc_zcddmx.zcpzwzbm,jc_zcddmx.jldwbm, DECODE(jc_zcddmx.sfbhpj,'Y','包含','N','不包含'),jc_zcddmx.pjts,TO_CHAR(jc_zcddmx.lsj),TO_CHAR(jc_zcddmx.yhj),TO_CHAR(jc_zcddmx.bzcbj),jc_zcddmx.bzcxhdbl||'%', DECODE(jc_zcddmx.sfycx,'N','没促销','Y','有促销'),jc_zcddmx.cxkssj,jc_zcddmx.cxjzsj,TO_CHAR(jc_zcddmx.cxj),TO_CHAR(jc_zcddmx.cxcbj),jc_zcddmx.lscxhdbl||'%', DECODE(jc_zcddmx.xzjg,'0','手写','1','销售限价','2','促销价','3','市场标价'),TO_CHAR(jc_zcddmx.dj),jc_zcddmx.jsbl||'%',TO_CHAR(jc_zcddmx.cbj), DECODE(jc_zcddmx.cxhdbz,'Y','参加','N','不参加'),jc_zcddmx.cxhdbl||'%',jc_zcddmx.sl,jc_zcddmx.je,jc_zcddmx.ycf, DECODE(jc_zcddmx.qtfy,'1','安装费','2','加工费','3','其它收费'),jc_zcddmx.qtfyje,NVL(jc_zcddmx.je,0)+NVL(jc_zcddmx.ycf,0)+NVL(jc_zcddmx.qtfyje,0) htfy,ROUND(jc_zcddmx.cbj*jc_zcddmx.sl,2) htcj,DECODE(jc_zcddmx.je,0,'',ROUND(100-ROUND(jc_zcddmx.cbj*jc_zcddmx.sl,2)*100/jc_zcddmx.je,2)||'%'),jc_zcddmx.cxhdje,jc_zcddmx.zjhsl,jc_zcddmx.zjhje,jc_zcddmx.zjhycf,jc_zcddmx.zjhqtfy,NVL(jc_zcddmx.zjhje,0)+NVL(jc_zcddmx.zjhycf,0)+NVL(jc_zcddmx.zjhqtfy,0) zfy,ROUND(jc_zcddmx.cbj*jc_zcddmx.zjhsl,2) zcb,DECODE(jc_zcddmx.zjhje,0,'',ROUND(100-ROUND(jc_zcddmx.cbj*jc_zcddmx.zjhsl,2)*100/jc_zcddmx.zjhje,2)||'%'),jc_zcddmx.zjhcxhdje, jc_zcddmx.lrr,jc_zcddmx.lrsj, jc_zcddmx.sxhtyy,a.dwmc fgsbh,b.dwmc qddm,jc_zcddmx.bz  ";
	ls_sql+=" FROM crm_khxx,bdm_bjjbbm,jc_zcdd,jdm_zcddzt,jc_zcddmx,sq_dwxx a,sq_dwxx b  ";
