...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审核手写合同－录入结算价（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%></td>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td>
			  <input type="hidden" name="jsbl" size="10" maxlength="9"  value="<%=jsbl%>">
			  <input type="text" name="cbj" size="17" maxlength="9"  value="<%=cbj%>"   onChange="f_jsjg(editform)">元
...
function f_jsjg(FormName)//参数FormName:Form的名称
{
	...
	if (<%=dj%>!=0)
	{
		FormName.cbj.value*100/<%=dj%>;
		jsbl=round(jsbl,2);
	}
	
     
	FormName.jsbl.value=jsbl;
