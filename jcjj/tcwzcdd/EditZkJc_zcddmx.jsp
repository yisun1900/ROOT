...
<form method="post" action="SaveEditJc_zcddmx.jsp" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"><input type="text" name="gg" size="46" maxlength="60"  value="<%=gg%>"  ></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
元 </td>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="36%"> 
                <input type="text" name="sl" size="17" maxlength="8"  value="<%=sl%>" onChange="f_jsjg(editform)" onKeyUp="keyGo(ycf)">
                <%
