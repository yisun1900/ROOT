...
%> 
  ...
  <tr bgcolor="#CCFFCC">
    ...
    <td><%=zctclx%></td>
    <td align="right"><font color="#0000FF">退补货序号</font></td>
    <td><%=zjxxh%></td>
  </tr>
  <tr bgcolor="#CCFFCC">
