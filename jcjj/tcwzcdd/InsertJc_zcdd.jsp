...
%> 
    ...
    <td width="29%">&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="radio" name="ddshbz" value="1" checked>
                不需等待通知 
                </td>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="录入手写项目" onClick="f_xzwc(insertform)" name="xzwc" disabled>
                  ...
                  <input type="button"  value="套餐" onClick="f_tc(insertform)" name="tc" disabled>
                  <input type="button"  value="顶配" onClick="f_dp(insertform)" name="dp" disabled></td>
            </tr>
        </table>
</form>
...
function getPp(FormName)
{
	...
	var sql="select jxc_ppxx.ppmc c1,jxc_ppxx.ppmc||NVL2(yhkssj,'（优惠期'||TO_CHAR(yhkssj,'YYYY-MM-DD')||'至'||TO_CHAR(yhjzsj,'YYYY-MM-DD')||'）','') c2 from jxc_ppxx,jxc_ppsqfgs where jxc_ppxx.ppbm=jxc_ppsqfgs.ppbm and jxc_ppsqfgs.ssfgs='"+FormName.fgsbh.value+"' and jxc_ppxx.cldl='"+FormName.zcdlbm.value+"' order by jxc_ppxx.ppmc";
...
function changePp(FormName)
{
	...
	sql+=" from  jxc_ppxx,jxc_ppsqfgs";
	sql+=" where jxc_ppxx.ppbm=jxc_ppsqfgs.ppbm ";
	sql+=" and jxc_ppsqfgs.ssfgs='<%=ssfgs%>' and jxc_ppxx.ppmc='"+FormName.ppbm.value+"'";
...
//	}
	...
	FormName.tc.disabled=false;
	FormName.dp.disabled=false;
	return true;
