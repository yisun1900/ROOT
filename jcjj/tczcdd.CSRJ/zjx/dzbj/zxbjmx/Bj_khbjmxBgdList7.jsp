...
//原有、未删除房间信息＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋
	...
	//	out.println(ls_sql);
		...
		//输出被删掉项目明细
		ls_sql="SELECT bj_bjxmmxq.xh xh,bj_bjxmmxq.xmbh,xmmc,jldwmc,bj_bjxmmxq.zqdj,bj_bjxmmxq.dj,bj_gclmxq.sl,bj_gclmxq.sl*bj_bjxmmxq.dj as je,bj_gclmxq.sl*bj_bjxmmxq.zqdj as zqje";
...
//删除房间信息＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋
	...
	while (rs1.next())
	{
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmxq.xh xh,bj_bjxmmxq.xmbh,xmmc,jldwmc,bj_bjxmmxq.zqdj,bj_bjxmmxq.dj,bj_gclmxq.sl";
		ls_sql+=" ,bj_bjxmmxq.cldj,bj_bjxmmxq.rgdj,bj_bjxmmxq.jxdj,bj_bjxmmxq.zcf,bj_bjxmmxq.shf,bj_bjxmmxq.ysf,bj_bjxmmxq.qtf";
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="5"> 
      <div align="center"><b><font size="3">综合取费</font></b></div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"  > 
    <td><B><font size="3">变更单总计：</font><%=cf.formatDouble(allZhZjJe+allqtje,"#########.##")%></B></td>
  </tr>
</table>
