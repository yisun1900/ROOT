...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2"><span lang=EN-US><img src="/images/tubiao.jpg" v:shapes="_x0000_i1025"></span></td>
    <td align="center">&nbsp;</td>
    <td align="right">http://www.longfa.com</td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="4" height="35"><b><font size="5">产品销售明细单</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td >客户姓名：<%=khxm%></td>
    <td colspan="2" >设 计 师：<%=sjs%></td>
    <td >联系方式：<%=lxfs%></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td >工程地点：<%=fwdz%></td>
