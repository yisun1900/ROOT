...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(crm_khxx.fjtcbz,'Y','分解','N','未分解','M','非套餐'),hth,khxm,fwdz,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,ysgcjdmc,kgrq,jgrq,khbh ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxXgCxList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"删除分解"};//按钮的显示名称
	String[] buttonLink={"scfjbz.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">分解套餐订单－删除</font></B>
</CENTER>
<%
	pageObj.out=out;
