...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_zjxdj.lx='4' and crm_zjxdj.shbz='N'";//N：未审核；Y：审核通过；S：审核未通过；M：不需审核
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zjxdjShList.jsp","","","EditShCrm_zjxdj.jsp");
