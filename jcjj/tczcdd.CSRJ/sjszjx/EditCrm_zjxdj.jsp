...
try {
	...
	{
		out.println("错误！只能修改最新的调换产品记录:"+kh_zjxxh);
		return;
	}
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000CC">工程调换产品-折前</font></td>
              <td width="31%"><%=kh_zjxje%></td>
              <td align="right" width="21%"><font color="#0000CC">工程调换产品-折后</font></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td align="right" width="21%" height="2"><font color="#0000CC">调换产品税金</font></td>
...
%>
                  ...
                  <td width="21%" rowspan="4" align="right"><font color="#FF0000">*</font>调换产品原因</td>
...
%>
                ...
                <tr bgcolor="#FFFFFF">
                  <td align="right"><font color="#FF0000">*</font>调换产品发生时间</td>
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="完成调换产品" onClick="f_wc(insertform)" name="wc" >
                ...
                <P> 
                  ...
                  <input type="button"  value="查看变更信息" onClick="f_bgmx(insertform)"  >
              </td>
            </tr>
        </table>
</form>
