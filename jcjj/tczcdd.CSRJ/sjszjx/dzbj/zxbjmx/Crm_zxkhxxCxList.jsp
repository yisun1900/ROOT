...
<%
	...
	ls_sql="SELECT crm_zxkhxx.khxm,cqmc,crm_zxkhxx.xqbm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过'),dzbjze,bjjbmc,DECODE(crm_zxkhxx.jzbz,'1','家装','2','公装'),sq_dwxx.dwmc as zxdm,sjs,lrsj,crm_zxkhxx.khbh as khbh";
