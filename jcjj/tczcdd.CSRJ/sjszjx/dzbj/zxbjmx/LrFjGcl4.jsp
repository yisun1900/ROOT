...
try {
	...
	ls_sql="select xmmc,xmdlbm,xmxlbm,smbm,jldwbm,zqdj,gycl,DECODE(bjlx,'1','标准项目','2','自定义项目') bjlx,bjjbmc bjjb,DECODE(bj_bjxmmxh.sfbxx,'1','必报项','2','必列项','3','可选项','9','作废项') sfbxx,zdyxmyxq";
...
<table width="100%">
  <tr>
    <td width="100%"> 
		<div align="center"><B><font color="#FF0000">增减工程量，减项为负数</font></B></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
				...
				if (i1%3==1)
				{
					%> 
					  ...
					  <tr bgcolor="#FFFFFF"> 
						...
						<input type="hidden" name="CN<%=jgwzbm%>" value="<%=jgwzmc%>"><BR>原数量:<%=zjqslStr%>
						<input name="CL<%=jgwzbm%>" type="hidden" value="<%=zjqslStr%>">
						</td>
					  <%
				}
				else{
