          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <BR><BR> 
                  <input type="button"  value="备份全部报价到临时库" onClick="f_back(selectform)">
                ...
                <BR><BR> 
                  ...
                  <input type="button"  value="删除[品牌供应商]报价" onClick="f_del(selectform)">
                <BR><BR> 
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><font color="#0000CC"><b>品牌供应商</b></font></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" bgcolor="#FFFFFF" align="right">品牌供应商</td>
