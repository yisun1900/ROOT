...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,DECODE(jc_zcdd.sxhtsfysh,'M','非手写合同','Y','已审核','N','未审核'),jc_zcdd.sxhtshr,jc_zcdd.sxhtshsj,zcxlbm,jc_zcdd.ppbm,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcdd.jjsjs, DECODE(jc_zcdd.jkxz,'1','未付款','2','全款','3','材料商收余款','4','预付款减出','5','退货款减出'), DECODE(jc_zcdd.jkdd,'1','材料商现场收余款','2','店面收款','3','公司财务收款'), DECODE(jc_zcdd.ddshbz,'1','不需待电','2','待电未通知','3','待电已通知'),jc_zcdd.hkze,DECODE(jc_zcdd.xclbz,'1','非定制产品','2','定制式产品'),jc_zcdd.lrsj,a.dwmc lrdw,jc_zcdd.bz,jc_zcdd.gys";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgShJsblList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteWcSxhtsh.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">审核手写项目结算比例－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
