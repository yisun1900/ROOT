...
<%
	...
	ls_sql ="SELECT jc_zcddmx.xh xh,zclbbm,DECODE(jsfs,'1','结算价','2','结算比例') jsfs,TO_CHAR(jc_zcddmx.jsbl)||'%' jsbl,TO_CHAR(jc_zcddmx.cbj) cbj,jc_zcddmx.cbj*jc_zcddmx.sl jsje,jc_zcddmx.zcbm zcbm,zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,zcpzwzbm,jc_zcddmx.zcysbm,DECODE(xzjg,'0','手写','1','销售限价','2','<font color=\"#FF0000\">促销价</font>') xzjg,TO_CHAR(jc_zcddmx.dj) dj,jldwbm,jc_zcddmx.sl,jc_zcddmx.je,ycf,qtfyje,DECODE(jc_zcddmx.sfbhpj,'Y','<font color=\"#FF0000\">包含</font>','N','不含') sfbhpj,jc_zcddmx.pjts*jc_zcddmx.sl pjzs, DECODE(jc_zcddmx.cxhdbz,'Y','<font color=\"#FF0000\">参加</font>','N','不参加') cxhdbz,cxhdbl||'%' cxhdbl,cxhdje,DECODE(jc_zcddmx.sxbz,'1','非手写','2','手写') sxbz, jc_zcddmx.sxhtyy,jc_zcddmx.bz  ";
...
//设置显示列
	String[] disColName={"zcbm","sxbz","sxhtyy","dj","jsfs","jsbl","cbj","sl","jsje","zcmc","xinghao","gg","zcpzwzbm","zcysbm","xzjg","zclbbm","jldwbm","je","ycf","qtfyje","cxhdbz","cxhdbl","cxhdje","bz"};
