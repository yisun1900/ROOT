...
try {
	...
	ls_sql+=" ,zctclx,zctcmc,zctcje,zjxxh,qtycf,htyjjrje,zjxyjjrje";
	ls_sql+=" ,sskje,shsskje,yjjzsj,tdjryjsj";
	ls_sql+=" ,zcpclf,tjpclf,tcjrbl,tjptcjrbl";
	ls_sql+=" from  jc_zcdd";
...
<div align="center">主材订单（订单编号：<%=ddbh%>） 
  <input type="button" value="订单付款信息" onClick="window.open('Cw_khfkjlCxList.jsp?ddbh=<%=ddbh%>')"   >
</div>
...
%> 
  ...
  <tr bgcolor="#CCFFCC">
    ...
    <td><%=zctclx%></td>
    <td align="right"><font color="#0000FF">分解订单的退补货序号</font></td>
    <td><%=zjxxh%>
    <input name="button5" type="button" onClick="window.open('/gcgl/zjx/ViewCrm_zjxdj.jsp?zjxxh=<%=zjxxh%>')" value="查看"  ></td>
  </tr>
  <tr bgcolor="#CCFFCC">
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFCC">
    <td align="right"><strong><font color="#FF0000">实收款金额</font></strong></td>
    <td><%=sskje%></td>
    <td align="right"><font color="#FF0000"><strong>财务审核实收款金额</strong></font></td>
    <td><%=shsskje%></td>
  </tr>
  <tr bgcolor="#FFFFCC">
    <td align="right"><strong><font color="#FF0000">记入业绩时间</font></strong></td>
    <td><%=yjjzsj%></td>
    <td align="right"><font color="#FF0000"><strong>退单记入业绩时间</strong></font></td>
    <td><%=tdjryjsj%></td>
  </tr>
  <tr bgcolor="#FFFFCC"> 
    <td width="20%" align="right"><b><font color="#0000FF">订单折扣</font></b></td>
    <td width="30%"><%=zczkl%> </td>
    <td width="290" align="right"><strong><font color="#0000FF">赠送金额总计</font></strong></td>
...
%> </td>
  ...
  <tr bgcolor="#CCFFCC"> 
    ...
    <td width="290" align="right"> 
      实送货时间    </td>
    <td width="29%" bgcolor="#CCFFCC"> <%=jc_zcdd_sshsj%> <input type="button" value="送货记录" onClick="window.open('ViewJc_zcshd.jsp?ddbh=<%=ddbh%>')" name="button4"></td>
  </tr>
  <tr bgcolor="#CCFFCC"> 
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="90px">最低销售限价</td>
	<td  width="110px">单位</td>
	<td  width="80px" bgcolor="#CC99FF">计入活动比率</td>
	<td  width="80px" bgcolor="#CC99FF">业绩记入比例</td>
	<td  width="110px">出库数量</td>
	<td  width="130px">出库金额</td>
	...
	<td  width="130px">合同业绩记入金额</td>

	<td  width="130px" bgcolor="#CC99FF">增减后数量</td>
	<td  width="130px" bgcolor="#CC99FF">送货数量</td>
	...
	<td  width="130px" bgcolor="#CC99FF">增减后业绩记入金额</td>

	<td  width="130px">赠送单价</td>
	<td  width="130px">赠送金额</td>
	<td  width="130px">市场标价</td>
	<td  width="130px">销售限价</td>
	<td  width="120px">标准计入活动比例</td>
	<td  width="120px">标准业绩记入比例</td>
	...
	<td  width="90px">主材套餐标志</td>
	<td  width="90px">累计订货数量</td>
...
<%
	...
	ls_sql ="SELECT DECODE(jc_zcddmx.lx,'1','合同','2','增项') lx,DECODE(jc_zcddmx.sxbz,'1','否','2','手写') sxbz,DECODE(jc_zcddmx.sfzp,'Y','赠品','N','否') sfzp,jc_zcddmx.zcbm,zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,TO_CHAR(jc_zcddmx.zxqdl),zcpzwzbm,jc_zcddmx.zcysbm";
	ls_sql+=" ,TO_CHAR(jc_zcddmx.zqdj) zqdj,TO_CHAR(jc_zcddmx.dpzk) dpzk,TO_CHAR(jc_zcddmx.dj) dj,TO_CHAR(jc_zcddmx.zdxsj) zdxsj,jldwbm,cxhdbl||'%' cxhdbl,yjjrbl||'%' yjjrbl,jc_zcddmx.cksl,jc_zcddmx.ckje,jc_zcddmx.sl";
	ls_sql+=" ,jc_zcddmx.zqje,jc_zcddmx.je,ycf,DECODE(qtfy,'1','安装费','2','加工费','3','其它收费'),qtfyje,zqje+ycf+qtfyje zqhtxj,je+ycf+qtfyje zhhtxj,cxhdje,htyjjrje";
	ls_sql+=" ,zjhsl,shsl,zqzjhje,zjhje,zjhycf,zjhqtfy,zqzjhje+zjhycf+zjhqtfy zqzjhxj,zjhje+zjhycf+zjhqtfy zhzjhxj,zjhcxhdje,zjhyjjrje";

	ls_sql+=" ,TO_CHAR(jc_zcddmx.zsdj),jc_zcddmx.zsdj*jc_zcddmx.zjhsl";
	
	ls_sql+=" ,TO_CHAR(jc_zcddmx.lsj),TO_CHAR(jc_zcddmx.yhj),bzcxhdbl||'%',bzyjjrbl||'%',DECODE(sfycx,'N','无','Y','<font color=\"#FF0000\">有</font>'),cxkssj,cxjzsj,cxj,lscxhdbl||'%',cxyjjrbl||'%'";
	...
	ls_sql+=" ,jc_zcddmx.sxhtyy,DECODE(jc_zcddmx.zctcbz,'Y','是','N','否'),jc_zcddmx.ljdhsl,jc_zcddmx.bz";
