...
//设置按钮参数
	...
	String[] buttonLink={"/jcjj/dygl/zcfjhb.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="80px">套餐名称</td>
	<td  width="55px">是否计入家装合同</td>
	<td  width="60px">是否已结算</td>
	...
	<td  width="90px" bgcolor="#99FFFF"><strong>套餐订单远程费</strong></td>
	<td  width="90px" bgcolor="#99FFFF"><strong>合同其它费</strong></td>
	<td  width="90px" bgcolor="#99FFFF"><strong>合同计入活动金额</strong></td>
	<td  width="90px" bgcolor="#99FFFF"><strong>合同业绩记入金额</strong></td>
	...
	<td  width="90px"><strong>增减项业绩记入金额</strong></td>
	...
	<td  width="90px" bgcolor="#FFFFCC"><strong>业绩记入总额</strong></td>
