...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcddmx.xh,jc_zcddmx.khbh,crm_khxx.khxm,bjjbmc,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcddmx.ddbh,DECODE(jc_zcddmx.lx,'1','合同项','2','增项'),DECODE(jc_zcddmx.sxbz,'1','非手写','2','手写'),jc_zcddmx.zcbm,jc_zcddmx.zcmc,jc_zcddmx.zcdlbm,jc_zcddmx.zcxlbm,jc_zcddmx.dwbh,jc_zcddmx.gys,jc_zcddmx.ppmc,jc_zcddmx.zclbbm,jc_zcddmx.xinghao,jc_zcddmx.gg,jc_zcddmx.zcysbm,jc_zcddmx.zcpzwzbm,jc_zcddmx.jldwbm, DECODE(jc_zcddmx.sfbhpj,'Y','包含','N','不包含'),jc_zcddmx.pjts,TO_CHAR(jc_zcddmx.lsj),TO_CHAR(jc_zcddmx.yhj),jc_zcddmx.bzcxhdbl||'%', DECODE(jc_zcddmx.sfycx,'N','没促销','Y','有促销'),jc_zcddmx.cxkssj,jc_zcddmx.cxjzsj,TO_CHAR(jc_zcddmx.cxj),jc_zcddmx.lscxhdbl||'%', DECODE(jc_zcddmx.xzjg,'0','手写项目','1','销售限价','2','促销价','3','市场标价'),TO_CHAR(jc_zcddmx.dj), DECODE(jc_zcddmx.cxhdbz,'Y','参加','N','不参加'),jc_zcddmx.cxhdbl||'%',jc_zcddmx.sl,jc_zcddmx.je,jc_zcddmx.ycf, DECODE(jc_zcddmx.qtfy,'1','安装费','2','加工费','3','其它收费'),jc_zcddmx.qtfyje,NVL(jc_zcddmx.je,0)+NVL(jc_zcddmx.ycf,0)+NVL(jc_zcddmx.qtfyje,0) htfy,jc_zcddmx.cxhdje,jc_zcddmx.zjhsl,jc_zcddmx.zjhje,jc_zcddmx.zjhycf,jc_zcddmx.zjhqtfy,NVL(jc_zcddmx.zjhje,0)+NVL(jc_zcddmx.zjhycf,0)+NVL(jc_zcddmx.zjhqtfy,0) zfy,jc_zcddmx.zjhcxhdje, jc_zcddmx.lrr,jc_zcddmx.lrsj, jc_zcddmx.sxhtyy,a.dwmc fgsbh,b.dwmc qddm,jc_zcddmx.jzsjs,jc_zcddmx.bz  ";
	ls_sql+=" FROM crm_khxx,bdm_bjjbbm,jc_zcdd,jc_zcddmx,sq_dwxx a,sq_dwxx b  ";
    ...
    ls_sql+=" and jc_zcddmx.fgsbh=a.dwbh(+) and jc_zcddmx.qddm=b.dwbh(+) ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jc_zcddmxCxList.jsp","","","");
...
<CENTER >
  <B><font size="3">查询－订单明细</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(curPage);
	pageObj.printPageLink(710);
%>
...
<tr bgcolor="#CCCCCC"  align="center">
  ...
  <td width="50px" rowspan="2">驻店家居顾问</td>
  <td width="50px" rowspan="2">展厅家居顾问</td>
  ...
  <td width="150px" rowspan="2">品牌</td>
  <td width="340px" rowspan="2">类别系列</td>
  ...
  <td width="50px" rowspan="2">是否包含配件</td>
  <td width="50px" rowspan="2">单套配件数</td>
  <td colspan="8"><B>产品报价表信息</B></td>
  <td colspan="4"><B>实销单价</B></td>
  <td colspan="7"><B>合同情况</B></td>
  <td colspan="6"><B>合同情况＋增减项</B></td>
  <td width="50px" rowspan="2">录入人</td>
  <td width="70px" rowspan="2">录入时间</td>
  <td width="150px" rowspan="2">手写合同原因</td>
  <td width="100px" rowspan="2">分公司</td>
  <td width="110px" rowspan="2">签单店面</td>
  <td width="50px" rowspan="2">家装设计师</td>
  <td width="340px" rowspan="2">备注</td>
</tr>
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="60px">市场标价</td>
	<td  width="60px">销售限价</td>
	<td  width="50px">标准计入活动比例</td>
	<td  width="50px">是否有促销</td>
	<td  width="70px">销开始时间</td>

	<td  width="70px">促销结束时间</td>
	<td  width="70px">促销价</td>
	<td  width="50px">促销期计入比例</td>
