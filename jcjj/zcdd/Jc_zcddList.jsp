...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and (jc_zcdd.ddlx!='5' OR (jc_zcdd.ddlx='5' and jc_zcdd.sfkgsl='Y')) ";//是否可改数量  Y：可以；N：否
	ls_sql+=" and (jc_zcdd.ddlx!='6' OR (jc_zcdd.ddlx='6' and jc_zcdd.zctclx='2')) ";//6：家具套餐分解订单
	ls_sql+=" and jc_zcdd.ddlx not in('8','9','C','D','E')";//6：家具套餐分解订单
...
//设置主键
	...
	pageObj.setEditBolt("");
//设置按钮参数
	String[] buttonName={"删除完成标志","删除合同"};//按钮的显示名称
