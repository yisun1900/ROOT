...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input name="sxhtsfysh" type="radio" value="N" checked>
              未审核
              <input type="radio" name="sxhtsfysh" value="Y">已审核</td>
            </tr>
            <tr bgcolor="#E8E8FF">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	{
		FormName.action="Jc_zcddShsxhtList.jsp";
	}
	else{
		FormName.action="Jc_zcddXgShsxhtList.jsp";
	}
	FormName.submit();
	return true;
}
