...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">工程扣款审核（调换产品序号：<%=zjxxh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="" name="editform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"><%=fwdz%></td>
              <td width="17%" align="right"><font color="#0000CC">质检</font></td>
              <td width="33%"><%=zjxm%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"><%=qye%></td>
              <td align="right" width="17%"><font color="#0000CC">累计调换产品总额</font></td>
              <td width="33%"><%=zjxje%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%"><font color="#0000CC">调换产品发生阶段</font></td>
              <td width="35%"> 
...
%> 
              ...
              <td align="right" width="17%"><font color="#0000CC">调换产品发生时间</font></td>
              <td width="33%"> 
                <input type="text" name="fssj" value="<%=fssj%>" size="20" maxlength="10" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%"><font color="#0000CC">调换产品发生总额</font></td>
              <td width="35%"> 
              ...
              <td rowspan="6" width="17%"> 
                <div align="right"><font color="#0000CC">调换产品原因</font></div>
                <div align="right"></div>
              </td>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right"><font color="#0000CC">调换产品完成标志</font></td>
              <td width="35%"><%
	cf.radioToken(out, "zjxwcbz","1+未完成&2+已完成",zjxwcbz,true);
%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right">工程扣款(可修改)</td>
              <td width="35%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
                <div align="right"><font color="#0000CC">调换产品说明</font></div>
              </td>
              <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShCrm_zjxdj.jsp";
	FormName.submit();
	return true;
}
