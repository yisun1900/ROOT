...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditSxhtBj_khzcxm.jsp" name="insertform">
...
<div align="center"><B>[<%=jgwzbm%>]中[<%=clxlmc%>]套餐外收费主材</B></div>
...
<%
    ...
    ls_sql+=" and bj_khzcxmh.zclx in('5')";//5：套餐外收费
...
<tr bgcolor="#FFFFFF">
  ...
  <select name="cpbm" style="FONT-SIZE:12PX;WIDTH:512PX" >
    <%
	String sql="select cpbm,cpmc||'（'||xh||'）（'||gg||'）'||'（'||jldw||'）' from bj_tczcbj where cpbm='"+cpbm+"'";
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="sl" value="<%=slStr%>" size="10" maxlength="17" ></td>
