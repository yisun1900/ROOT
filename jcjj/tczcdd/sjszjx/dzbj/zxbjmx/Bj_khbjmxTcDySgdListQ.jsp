...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	while (rs1.next())
	{
		...
		ls_sql+=" where bj_bjxmmxq.zjxxh='"+zjxxh+"' and bj_gclmxq.jgwzbm='"+jgwzmc+"'";
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmxq.xh xh,bj_bjxmmxq.xmbh,xmmc,bj_bjxmmxq.zqdj,jldwmc,bj_gclmxq.sl,bj_gclmxq.sl*bj_bjxmmxq.zqdj as je,gycl,bj_bjxmmxq.flmcgg,bj_bjxmmxq.bz";
