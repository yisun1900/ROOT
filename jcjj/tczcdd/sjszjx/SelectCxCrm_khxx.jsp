...
<form method="post" action="Crm_khxxCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="clgw" value="<%=clgw%>" size="20" maxlength="20" <% if (!clgw.equals("")) out.println("readonly");%>>
              </td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="调换产品登记" onClick="f_do(selectform)">
