...
try {
	...
	ps.setString(33,"4");//1：有明细；2：无明细；3：套餐退补货；4：套餐调换产品
...
*/
		...
		//增减前客户主材清单
		ls_sql="insert into bj_khzcxmq (zjxxh,sxh,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw            ,xdjldw,xdb,sfxclxs,sfyx,yxkssj,yxjzsj,tcndj,tccldj,sfkgdj,dj,jsfs,jsj,jsbl,sh,sfcscp,bz,zclx,ddcljjfs,sl,xdsl,ptcpsm,bjjbbm,fjddbh,ywdhslbz,newzjxxh) ";
		ls_sql+=" select          '"+zjxxh+"',sxh,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,NVL(JLDW,'JLDW'),xdjldw,xdb,sfxclxs,sfyx,yxkssj,yxjzsj,tcndj,tccldj,sfkgdj,dj,jsfs,jsj,jsbl,sh,sfcscp,bz,zclx,ddcljjfs,sl,xdsl,ptcpsm,bjjbbm,fjddbh,ywdhslbz,newzjxxh";
...
*/
		...
		//增减前客户主材清单
		ls_sql="insert into bj_khzcxmh (zjxxh,sxh,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw            ,xdjldw,xdb,sfxclxs,sfyx,yxkssj,yxjzsj,tcndj,tccldj,sfkgdj,dj,jsfs,jsj,jsbl,sh,sfcscp,bz,zclx,ddcljjfs,sl,xdsl,ptcpsm,bjjbbm,fjddbh,lx ,ywdhslbz,newzjxxh) ";
		ls_sql+=" select          '"+zjxxh+"',sxh,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,NVL(JLDW,'JLDW'),xdjldw,xdb,sfxclxs,sfyx,yxkssj,yxjzsj,tcndj,tccldj,sfkgdj,dj,jsfs,jsj,jsbl,sh,sfcscp,bz,zclx,ddcljjfs,sl,xdsl,ptcpsm,bjjbbm,fjddbh,'1',ywdhslbz,newzjxxh";//1：原项目；2：增项；3：减项
		ls_sql+=" from bj_khzcxmh ";
		ls_sql+=" where zjxxh='"+oldzjxxh+"' ";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
