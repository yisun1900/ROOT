...
try {
	...
	if (!shbz.equals("N"))//N：未审核；Y：审核通过；S：审核未通过；M：不需审核
	{
		out.println("错误！不需审核");
		return;
	}
...
<body>
<div align="center">调换产品审核（调换产品序号：<%=zjxxh%>）</div> 
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
    <td align="right" width="15%">调换产品代金券</td>
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="18%" align="right"> 
      调换产品发生时间    </td>
    <td width="32%"><%=crm_zjxdj_fssj%></td>
  </tr>
  
  <tr bgcolor="#FFFFFF"> 
    <td align="right" width="18%">调换产品原因</td>
    <td colspan="3"><%=zjxyymc%></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td align="right" width="18%">调换产品说明</td>
    <td colspan="3"><%=zjxyysm%></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
%></td>
    <td width="18%" align="right"><b>类型</b></td>
    <td width="32%"><font color="#0000CC"><b>
    <%
  ...
  <tr bgcolor="#FFFFFF" align="center"> 
    <td colspan="4">  
	  ...
	  <input type="button" onClick="window.open('dzbj/zxbjmx/Jc_zcddCxList.jsp?zjxxh=<%=zjxxh%>&khbh=<%=khbh%>')" value="分解订单">
	        <input type="button" onClick="window.open('/gcgl/zjx/ViewCrm_zjxtckhqye.jsp?zjxxh=<%=zjxxh%>')" value="套餐价格"></td>
...
<form method="post" action="" name="insertform" >
        <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td width="32%">
<%
	cf.radioToken(out,"shbz","Y+审核通过&S+审核未通过",shbz);
%>
					</td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td align="right"><font color="#FF0000">*</font><font color="#0000FF">审核人</font></td>
                    <td><input type="text" name="shr" value="<%=yhmc%>" size="20" maxlength="17" readonly></td>
                    <td width="18%" align="right"><font color="#FF0000">*</font><font color="#0000FF">审核时间</font></td>
                    <td width="32%"><input type="text" name="shsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
                  </tr>
            
            
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">调换产品说明              </td>
              <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditShCrm_zjxdj.jsp";
	FormName.submit();
	return true;
}
