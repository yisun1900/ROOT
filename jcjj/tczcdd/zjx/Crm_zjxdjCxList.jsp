...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  crm_khxx.khxm,crm_khxx.fwdz,sgdmc,sjs ,crm_zjxdj.zjxxh,DECODE(crm_zjxdj.lx,'1','增减项','2','无明细增减项','3','退补货','4','调换产品'),DECODE(crm_zjxdj.sfwc,'N','未完成','Y','已完成'),DECODE(crm_zjxdj.shbz,'N','未审核','Y','审核','M','不需审核'),crm_zjxdj.zqtczjje,crm_zjxdj.tczjje,zjxfsjdmc,fssj,crm_zjxdj.lrr,hth,crm_zjxdj.zjxyysm ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="7%">发生阶段</td>
	<td  width="6%">调换产品发生时间</td>
	<td  width="4%">录入人</td>
	<td  width="5%">合同号</td>
	<td  width="25%">调换产品原因</td>
</tr>
<%
