...
try {
	...
	ls_sql="select khbh,cpbm,tccpdlbm,tccplbbm,bjjbbm,ppmc,ptcpsm,sl,jgwzbm,jldw,dj,sfkgdj,lx,fjddbh";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditBj_khzcxmTcwDljj.jsp" name="insertform">
<div align="center"><B>选择的所有顶配独立收费型号</B></div>
...
<%
    ...
    ls_sql+=" and bj_khzcxmh.ddcljjfs='2'";//0：套餐内材料；1：顶配升级；2：顶配独立收费；3：套餐选配
...
<BR>
<div align="center">修改－顶配独立计价主材</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1"><strong>计量单位</strong></span></td>
  <td><span class="STYLE1"><strong><%=jldw%></strong></span></td>
