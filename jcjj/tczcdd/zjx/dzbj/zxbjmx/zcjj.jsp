...
<tr bgcolor="#FFFFFF">
  <td width="45%" height="43" align="right"><font color="#FF0000">*</font>降级后级别</td>
  <td width="55%"><select name="bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select bjjbbm,bjjbmc from bdm_bjjbbm where lx='2' and yxj<'"+yxj+"' order by bjjbbm",bjjbbm);
%>
  </select></td>
</tr>
