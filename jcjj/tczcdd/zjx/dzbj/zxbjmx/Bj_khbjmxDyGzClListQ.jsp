...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="8" align="center" class="STYLE2" ><B>全装修套餐工长主材购物清单（<%=bjjb%>）</B></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td  width="68%" align="center">备注</td>
  </tr>
...
<%
	...
	ls_sql+=" where bj_khzcxmq.zjxxh='"+zjxxh+"' and bj_khzcxmq.sfcscp='Y'";
