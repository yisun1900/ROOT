...
<%
	...
	int tcxpsl=0;
	ls_sql="SELECT bj_khzcxmh.sxh,bjjbmc,bj_khzcxmh.xdsl,bj_khzcxmh.cpbm,bj_khzcxmh.cpmc,bj_khzcxmh.ppmc,bj_khzcxmh.xh,bj_khzcxmh.zclx";
	...
	if (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  ...
		  <td rowspan="<%=rowspan%>">&nbsp;</td>
		  <td rowspan="<%=rowspan%>">&nbsp;</td>
		  <td rowspan="<%=rowspan%>" colspan="2">套餐选配主材</td>
		  <td><%=lxmc%></td>
		  ...
		  {
			  %>
			  <td><A HREF="EditBj_khzcxmTcwXp.jsp?zjxxh=<%=zjxxh%>&sxh=<%=sxh%>" target="_blank">退补</A></td>
			  <%
		  }
		  else
		  {
		  ...
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><a href="InsertBj_khzcxmTcwXp.jsp?zjxxh=<%=zjxxh%>" target="_blank">更换</a></td>
	...
	ls_sql+=" and bj_khzcxmh.zjxxh='"+zjxxh+"'";
	ls_sql+=" and bj_khzcxmh.zclx in('4')";//主材类型 1：套餐内；2：套餐外；3：顶配套餐内；4：顶配套餐外
	ls_sql+=" and bj_khzcxmh.ddcljjfs in('2')";//0：非大店材料；1：套外升级（补差价）；2：套外升级（独立计价）；3：套餐选配
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
	...
	if (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  ...
		  <td rowspan="<%=rowspan%>">&nbsp;</td>
		  <td rowspan="<%=rowspan%>">&nbsp;</td>
		  <td rowspan="<%=rowspan%>" colspan="2">顶配单独收费</td>
		  <td><%=lxmc%></td>
		  <%
		  if (lx.equals("1"))//1：原项目；2：增项；3：减项；4：更换项
		  {
			  %>
			  <td><A HREF="EditBj_khzcxmTcwDljj.jsp?zjxxh=<%=zjxxh%>&sxh=<%=sxh%>" target="_blank">退补</A></td>
			  <%
		  }
		  else
		  {
		  ...
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><a href="InsertBj_khzcxmTcwDljj.jsp?zjxxh=<%=zjxxh%>" target="_blank">更换</a></td>
					...
					while (rs3.next())
					{
						...
						if (row==1)//房间内第一行
						{
							...
							<%
									...
									if (zclx.equals("1") || zclx.equals("2"))
									{
										%>
										  ...
										  {
											  %>
											  <td><A HREF="EditBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>" target="_blank">退补</A></td>
											  <%
										  }
										  else
										  {
										...
										%>
										  ...
										  {
											  %>
											  <td><A HREF="EditBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>" target="_blank">退补</A></td>
											  <%
										  }
										  else
										  {
							...
							%>
							  ...
							  <td rowspan="<%=xlcpsl%>">套餐内更换</td>
								<%
								if (sfkgh.equals("2"))//1：不可换；2：可换
								{
									%>
								  <td rowspan="<%=xlcpsl%>">更换</td>
									<%
								}
								else{
									%>
