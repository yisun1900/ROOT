...
<form method="post" action="Crm_khxxCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="clgw" value="<%=clgw%>" size="20" maxlength="20" <% if (!clgw.equals("")) out.println("readonly");%>>              </td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="sjs" value="<%=sjs%>" size="20" maxlength="20" <% if (!sjs.equals("")) out.println("readonly");%>>              </td>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="退补货登记" onClick="f_do(selectform)">
