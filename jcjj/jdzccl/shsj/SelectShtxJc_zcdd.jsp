...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－送货提醒</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddShtxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              <td align="right">合同确认时间 从</td>
              <td > 
                <input type="text" name="ddqrsj" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td > 
                <input type="text" name="ddqrsj2" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td align="right">合同确认时间超过</td>
              <td > 
                <input type="text" name="shsj" size="10" maxlength="20" value="28">
                天 </td>
              <td align="right">&nbsp;</td>
              <td >&nbsp;</td>
            </tr>
...
{
	if(!(isDatetime(FormName.ddqrsj, "合同确认时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.ddqrsj2, "合同确认时间"))) {
		return false;
	}
	if(!(isNumber(FormName.shsj, "合同确认时间超过"))) {
		return false;
	}
	FormName.submit();
	return true;
