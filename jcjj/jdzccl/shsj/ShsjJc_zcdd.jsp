...
<div align="center">确定送货时间（订单编号：<%=fbillno%>） 
</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td > 
        <input type="text" name="jhshsj" size="20" maxlength="10" value="<%=cf.today()%>" onDblClick="JSCalendar(this)">      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <textarea name="shtzsm" rows="3" cols="69"></textarea>      </td>
    </tr>
    <tr> 
