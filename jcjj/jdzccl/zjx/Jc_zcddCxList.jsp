...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zcdd.qhtsj desc,jc_zcdd.ddbh";

	
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddCxList.jsp","SelectCxJc_zcdd.jsp","InsertJc_zczjx.jsp","");
...
<CENTER >
  <B><font size="3">主材增减项</font></B>（<font color="#0000CC"><strong>提醒：完结和未经过【收款确认】的订单不能做增减项</strong></font>）
</CENTER>
<%
	pageObj.out=out;
