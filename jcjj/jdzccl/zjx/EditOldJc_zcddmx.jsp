...
try {
	...
	ls_sql="select zcbm,zcmc,zclbbm,xinghao,gg,dj,sl,je,ycf,zcpzwzbm,zcysbm,cxhdbz,jldwbm,qtfy,xzjg,sfbhpj,pjts,lsj,yhj,cbj";
	...
	ls_sql="select zjsl,zjje,zjycf,zjqtfy,zjcxhdje,zjcbje,lx,bz ";
	...
	if (rs.next())
	{
		...
		zjycf=cf.fillNull(rs.getString("zjycf"));
		zjqtfy=cf.fillNull(rs.getString("zjqtfy"));
...
%></td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">选择价格</td>
              <td width="31%"> <%
					cf.radioToken(out, "xzjg","0+手写项目&1+销售限价&2+促销价",xzjg,true);
				%> </td>
              <td width="20%" align="right">实销单价</td>
              <td width="30%"><%=dj%>元 </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="19%"> 
...
%> <font color="#0000CC">（增项为正，减项为负）</font> </td>
              <td width="20%" align="right"><font color="#FF0000">*</font>增减远程费</td>
              <td width="30%"> 
...
%> </td>
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="19%" align="right"><font color="#FF0000">*</font><font color="#0000CC">增减材料费</font></td>
              <td width="31%"> <font color="#0000CC"> 
                <input type="text" name="zjje" size="17" maxlength="9"  value="<%=zjje%>" readonly>
                元 </font></td>
              <td width="20%" align="right"><font color="#FF0000">*</font>增减计入活动金额</td>
...
{
	var je=<%=dj%>*FormName.zjsl.value;
	je=round(je,2);
	FormName.zjje.value=je;
