...
<%
	...
	ls_sql ="SELECT jc_zcddmx.xh xh,DECODE(jc_zcddmx.lx,'1','合同项','2','增项') lx,DECODE(jc_zcddmx.sxbz,'1','非手写','2','手写') sxbz,jc_zcddmx.sxhtyy,zclbbm,jc_zcddmx.zcbm zcbm,zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,zcpzwzbm,jc_zcddmx.zcysbm,DECODE(xzjg,'0','手写','1','销售价','2','<font color=\"#FF0000\">促销价</font>') xzjg,TO_CHAR(jc_zcddmx.dj) dj,jldwbm,jc_zcddmx.zjhsl,jc_zcddmx.zjhje,zjhycf,zjhqtfy,zjhcxhdje,jc_zcddmx.sl,jc_zcddmx.je,ycf,qtfyje,DECODE(jc_zcddmx.sfbhpj,'Y','包含','N','不含') sfbhpj,jc_zcddmx.pjts*jc_zcddmx.zjhsl pjzs, DECODE(jc_zcddmx.cxhdbz,'Y','参加','N','不参加') cxhdbz,cxhdbl||'%' cxhdbl,cxhdje,jc_zcddmx.bz  ";
...
//设置显示列
	String[] disColName={"zcbm","lx","zcmc","zclbbm","xinghao","gg","jldwbm","xzjg","dj","cxhdbz","cxhdbl","zjhsl","zjhje","zjhycf","zjhqtfy","zjhcxhdje","sl","je","ycf","qtfyje","cxhdje","pjzs","zcpzwzbm","zcysbm","sxbz","sxhtyy","bz"};
