...
//设置显示列
	String[] disColName={"lx","sxbz","dj","zjsl","zcmc","xinghao","gg","zclbbm","xzjg","jldwbm","cxhdbl","zjje","zjycf","zjqtfy","zjcxhdje","zjhsl","zjhje","zjhycf","zjhqtfy","zjhcxhdje","zcpzwzbm","zcysbm","sxhtyy","zcbm","dwbh","bz"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJc_zcddmxAjax.jsp?zjxbh="+zjxbh+"&ddbh="+ddbh};//按钮单击调用的网页，可以增加参数
