...
<form method="post" action="Jc_zcjgbCxList.jsp" name="selectform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="myxssl" size="7" maxlength="13" value="50">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td rowspan="8" align="center" bgcolor="#CCCCFF"> 
                <p>被选型号</p>
                <p> 
              ...
              <td rowspan="8" align="center" valign="middle" bgcolor="#CCCCFF"> 
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="jc_zcjgb_zclbbm" size="20" maxlength="100" >
              </td>
