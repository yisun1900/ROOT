...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－删除送货通知
    </div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddXgShtzList.jsp" name="selectform">
...
%>
 ...
 %>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td width="31%"><input type="text" name="tzshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"><input type="text" name="tzshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr> 
