...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－订单确认 </div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddQrList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">客户编号</td>
              <td width="31%"><input type="text" name="khbh" size="20" maxlength="20"></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <select name="clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
					<option value=""></option>
                  <option value="09">录入合同</option>
                </select>              </td>
            </tr>
            
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"><font color="#0000CC"><b>品牌</b></font></td>
              <td width="31%"><input name="ppbm" type="text" id="ppbm" size="20" maxlength="50" ></td>
