...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－修改接收
    </div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddXgGcjsList.jsp" name="selectform">
...
%>
 ...
 %>
            ...
            <tr bgcolor="#E8E8FF">
              <td width="19%" align="right">接收时间 从</td>
              <td width="31%"><input type="text" name="gysjslrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td width="19%" align="right">到</td>
              <td width="31%"><input type="text" name="gysjslrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr> 
...
{
	if(!(isDatetime(FormName.gysjslrsj, "接收时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.gysjslrsj2, "接收时间"))) {
		return false;
	}
