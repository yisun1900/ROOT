...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－修改计划测量时间</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddJhclList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="jc_zcdd_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
