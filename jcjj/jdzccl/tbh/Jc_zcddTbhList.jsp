...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,zcxlbm,ppbm,crm_khxx.khxm,crm_khxx.lxfs||','||crm_khxx.qtdh,crm_khxx.sgbz||'('||sq_bzxx.dh||')' sgbz,jc_zcdd.jhtbhsj,jc_zcdd.tztbhsj,jc_zcdd.tbhtzry,jc_zcdd.tbhqk,jc_zcdd.sshsj,crm_khxx.hth,crm_khxx.fwdz,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcdd.hkze,jc_zcdd.zjhze,jc_zcdd.bz,jc_zcdd.ppmc,jc_zcdd.gys";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zcdd.jhtbhsj";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddTbhList.jsp","","","TbhJc_zcdd.jsp");
	pageObj.setEditStr("退补货");//设置每页显示记录数
/*
//设置显示列
...
<CENTER >
  <B><font size="3">主材订单处理－－退补货</font></B>
</CENTER>
<%
	pageObj.out=out;
