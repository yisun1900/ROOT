...
<body bgcolor="#FFFFFF">
<div align="center">退补货（订单编号：<%=ddbh%>） </div>
...
<form method="post" action="" name="editform">
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="stbhr" value="<%=yhmc%>" size="20" maxlength="20" >
      </td>
      <td width="18%"> 
        <div align="right">实退补货时间</div>
      </td>
      <td width="32%"> 
        <input type="text" name="stbhsj" value="<%=cf.today()%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveTbhJc_zcdd.jsp";
	FormName.submit();
	return true;
}
