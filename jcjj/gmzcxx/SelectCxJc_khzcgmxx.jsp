...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_khzcgmxxCxList.jsp" name="selectform">
<div align="center">主材购买信息－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%"><input type="radio" name="jc_khzcgmxx_clzt" value="N">
    未审核
      <input type="radio" name="jc_khzcgmxx_clzt" value="Y">
      审核 </td>
</tr>
<tr bgcolor="#FFFFFF">
