...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_khzcgmxxShList.jsp" name="selectform">
<div align="center">主材购买信息－审核</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%"><input name="jc_khzcgmxx_clzt" type="radio" value="N" checked>
    未审核</td>
</tr>
<tr bgcolor="#FFFFFF">
