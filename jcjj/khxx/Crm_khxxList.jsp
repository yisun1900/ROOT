...
String jjgw=cf.executeQuery("select yhmc from sq_yhxx where yhdlm='"+yhdlm+"' and zwbm='08'");
if (jjgw==null)
{
	jjgw="";
}
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,xmzy,fwdz,lxfs,lrsj,lrr,a.dwmc dm";
	ls_sql+=" FROM crm_khxx,sq_dwxx a ";
    ls_sql+=" where (crm_khxx.dwbh=a.dwbh(+))";
 	if (!jjgw.equals(""))
	{
		ls_sql+=" and (crm_khxx.lrr='"+jjgw+"')";
	}
   ls_sql+=wheresql;
