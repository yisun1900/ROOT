...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,xmzy,DECODE(zt,'2','家装','3','<font color=\"#FF00FF\">已退单</font>','4','非家装','5','设计'),ysgcjdmc,khlxmc,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,ywy,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_khlxbm";
	...
	ls_sql+=" and crm_khxx.gcjdbm!='5' and crm_khxx.zt!='3'";
	ls_sql+=wheresql;
	ls_sql+=" order by lrsj desc";

    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxScYddList.jsp","SelectScYddCrm_khxx.jsp","ViewYdd.jsp","");
//	pageObj.setPageRow(10);//设置每页显示记录数
	pageObj.setViewStr("查看");//设置每页显示记录数
...
<CENTER >
  <B><font size="3">删除未签合同预订单</font></B>
</CENTER>
<%
	pageObj.out=out;
