  ...
  <tr align="center">
    <td colspan="3">
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 12px'>
		...
		ls_sql+=" where crm_zjxdj.lrsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
		ls_sql+=" and crm_zjxdj.lrsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
		ls_sql+=" and crm_zjxdj.fylxbm='01'";
		if (fgs!=null)
		{
			if (!(fgs.equals("")))	ls_sql+=" and  (crm_zjxdj.dwbh in(select dwbh from sq_dwxx where dwlx='F2' and ssdw='"+fgs+"'))";
		}
		if (dwbh!=null)
		{
			if (!(dwbh.equals("")))	ls_sql+=" and  crm_zjxdj.dwbh='"+dwbh+"'";
		}

		String tdje=cf.executeQuery(ls_sql);

		
		ls_sql="SELECT zjxyymc,count(*),sum(zjje),'<img src=\"/images/ColuGif.gif\" width='||sum(zjje)*130/"+tdje+"||' height=14>&nbsp;'||ROUND(sum(zjje)*100/"+tdje+",2)||'%'";
		ls_sql+=" FROM crm_zjxdj,dm_zjxyybm ";
		ls_sql+=" where crm_zjxdj.zjxyybm=dm_zjxyybm.zjxyybm ";
