...
%> 
	...
	{
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx='F2' order by cxbz,dwbh","");
	}
	else if (yhjs.equals("F0") || yhjs.equals("F1"))
	{
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx='F2' and ssdw='"+ssfgs+"' order by cxbz,dwbh","");
	}
...
%> 
    ...
    <tr>
      <td align="right" width="42%" height="39">设计室</td>
      <td width="58%" height="39">
...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="37">统计时间</td>
      <td width="58%" height="37"> 
        <input type="radio" name="tjsjlx" value="qyrq" checked>
        签约时间 
        <input type="radio" name="tjsjlx" value="lrsj">
        录入时间 </td>
    </tr>
    <tr> 
      <td align="right" width="42%" height="37">录入截止时间</td>
      <td width="58%" height="37"> 
        <input type="text" name="jzsj" maxlength="20" size="10" value="12">
        时 </td>
    </tr>
    <tr> 
