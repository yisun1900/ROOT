...
try {
	...
	for (int i=0;i<sjs.length ;i++ )
	{
		...
		ls_sql="SELECT hth,khxm,fwdz,DECODE(crm_khxx.jzbz,'1','家装','2','公装') jzbz,crm_khxx.cxhdbm,wdzgce,zkl,qye,zjxje,NVL(zjxje,0)+qye zjhze,sjf,a.dwmc qydm,TO_CHAR(lrsj,'YYYY-MM-DD HH24:MI') lrsj,TO_CHAR(qyrq,'YYYY-MM-DD') qyrq,DECODE(TO_CHAR(lrsj,'MM')-TO_CHAR(qyrq,'MM'),0,'是','<font color=\"#FF0000\">跨月</font>') dylr,sgdmc sgd,zjxm";
