...
%> 
    ...
    <tr align="center"> 
      <td height="41" colspan="4"> 
        <input type="button"  value="城区大小单统计" onClick="f_do(selectform)">
        <input type="button"  value="环线大小单统计" onClick="f_do(selectform)">
        <input type="button"  value="热点地区大小单统计" onClick="f_do(selectform)">
