...
<form method="post" action="yqyyfx.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right" bgcolor="#E8E8FF">所属热点地区</td>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right" bgcolor="#E8E8FF">所属城区</td>
              <td width="31%" bgcolor="#E8E8FF"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">总延期天数 从</td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">面积分类</td>
              <td width="31%" bgcolor="#FFFFFF"> 
                <select name="hxmjbm" style="FONT-SIZE:12PX;WIDTH:152PX" onKeyUp="keyGo(fj)" size="8" multiple>
                  <option value=""></option>
                  <%
...
%> 
              ...
              <td width="33%"> 
                <select name="zxjwbm" style="FONT-SIZE:12PX;WIDTH:152PX" onKeyUp="keyGo(fj)" size="8" multiple>
                  <option value=""></option>
                  <%
