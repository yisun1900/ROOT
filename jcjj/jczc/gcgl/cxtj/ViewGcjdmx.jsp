...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 12px'>
    <tr align="center"> 
        <td> 
          <select name="px" style="FONT-SIZE:12PX;WIDTH:152PX" onchange="f_ck(selectform)">
			  ...
			  <option value="crm_khxx.jgrq">合同竣工日期</option>
			  <option value="crm_khxx.sjjgrq">实竣工日期</option>
			  <option value="yqts">延期天数</option>
          </select>
    ...
    <tr align="center" valign="top"> 
      <td height="540">
	  <iframe width="100%" height="100%" src="GcjdmxList.jsp?fgs=<%=fgs%>&dwbh=<%=dwbh%>&tjrq=<%=tjrq%>&tjrq2=<%=tjrq2%>" name="childFrame" marginwidth="0" marginheight="0" scrolling="YES" FrameBorder="0"> 
	  </iframe>
	  </td>
    </tr>
  </table>
...
{               
	...
	FormName.action="GcjdmxList.jsp";
	FormName.submit();	
}                                                                                                                
//-->
</SCRIPT>
