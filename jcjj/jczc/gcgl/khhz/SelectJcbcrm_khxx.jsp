...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="客户汇总" onClick="f_do(selectform)">
				<input type="button"  value="监理满意度" onClick="f_do1(selectform)">
				<input type="button"  value="设计师满意度" onClick="f_do2(selectform)">
				<input type="button"  value="施工队满意度" onClick="f_do3(selectform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_khxxhxfz.jsp";
	FormName.submit();
	return true;
}
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_khxxhxts.jsp";
	FormName.submit();
	return true;
}
