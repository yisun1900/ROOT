...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="jjwjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="jjwjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td><div align="right">家居完结人</div></td>
              <td><input type="text" name="jjwjr" size="20" maxlength="20" >              </td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr align="center"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_khxxXgWjdjList.jsp";
	FormName.submit();
	return true;
}
