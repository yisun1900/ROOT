...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT distinct crm_zxkhxx.khbh,crm_zxkhxx.dzbjze,crm_zxkhxx.zjzbjsj,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_zxkhxx.khjl,crm_zxkhxx.ywy,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,crm_zxkhxx.lrsj,dwmc as zxdm";
	ls_sql+=" FROM crm_zxkhxx,sq_dwxx,bj_khzcmx";
    ls_sql+=" where crm_zxkhxx.zxdm=sq_dwxx.dwbh(+)";
    ls_sql+=" and crm_zxkhxx.khbh=bj_khzcmx.khbh";
    ls_sql+=" and zxzt in('3')";
    ls_sql+=" and (crm_zxkhxx.fjtcbz is null or crm_zxkhxx.fjtcbz!='Y')";
...
//	out.println(ls_sql);
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxShList.jsp","","","AllBj_khzcmxJsj.jsp");
