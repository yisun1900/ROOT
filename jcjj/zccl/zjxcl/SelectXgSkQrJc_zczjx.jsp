...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">增减项－删除确认<font color="#FF0000"><strong>（客户未付款不能确认）</strong></font></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zczjxXgSkQrList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF">确认时间 从</td>
              <td><input type="text" name="qrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right" bgcolor="#FFFFFF">到</td>
              <td><input type="text" name="qrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.qrsj2, "确认时间"))) {
		return false;
	}
