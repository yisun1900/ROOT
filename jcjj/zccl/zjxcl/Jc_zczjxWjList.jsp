...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,jc_zczjx.ddbh,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,jc_zczjx.lrsj,crm_khxx.hth,crm_khxx.khbh,jc_zczjx.ppmc,jc_zczjx.gys,jc_zczjx.bz";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zczjxWjList.jsp","","","WjJc_zczjx.jsp");
//	pageObj.setPageRow(1000);//设置每页显示记录数
	pageObj.setEditStr("完结");
/*
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"PlWjJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
