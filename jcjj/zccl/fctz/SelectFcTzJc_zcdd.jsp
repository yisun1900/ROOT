...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－通知复尺</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddFcTzList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right">实测量时间 从</td>
              <td><input type="text" name="jc_zcdd_sclsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_sclsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
...
{
	if(!(isDatetime(FormName.jc_zcdd_sclsj, "实测量时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jc_zcdd_sclsj2, "实测量时间"))) {
		return false;
	}
