...
try {
	...
	ls_sql+=" ,tzclsj,cltzr,sclsj,sclr,jhfcsj,tzfcsj,tzfclrr";
	ls_sql+=" from  jc_zcdd";
...
<body bgcolor="#FFFFFF">
<div align="center">修改通知复尺（订单编号：<%=ddbh%>） 
...
<form method="post" action="" name="editform" >
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"><span class="STYLE2">*</span>计划复尺时间</td>
      <td width="32%"><input type="text" name="jhfcsj" value="<%=jhfcsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
      <td width="18%" align="right">&nbsp;</td>
      <td width="32%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"><span class="STYLE2">*</span><span class="STYLE1">发复尺通知时间</span></td>
      <td width="32%"><input type="text" name="tzfcsj" value="<%=tzfcsj%>" size="20" maxlength="10" readonly></td>
      <td width="18%" align="right"><span class="STYLE2">*</span><span class="STYLE1">通知复尺录入人</span> </td>
      <td width="32%"><input type="text" name="tzfclrr" value="<%=yhmc%>" size="20" maxlength="20" readonly></td>
    </tr>
    <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jhfcsj, "计划复尺时间"))) {
		return false;
	}
	if(	javaTrim(FormName.tzfclrr)=="") {
		alert("请选择[通知复尺录入人]！");
		FormName.tzfclrr.focus();
		return false;
	}
	...
	if(!(isDatetime(FormName.tzfcsj, "发复尺通知时间"))) {
		return false;
	}

	FormName.action="SaveXgFcTzJc_zcdd.jsp";
	FormName.submit();
	return true;
}
