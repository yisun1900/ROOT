...
<form method="post" action="" name="editform" >
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"><span class="STYLE1">计划复尺时间</span></td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><%=tzfcsj%></td>
      <td align="right"><span class="STYLE1">通知复尺录入人</span></td>
      <td><%=tzfclrr%></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"><span class="STYLE2">*</span><span class="STYLE1">复尺时间</span></td>
      <td width="32%"><input type="text" name="fcsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
      <td width="18%" align="right"><span class="STYLE2">*<span class="STYLE1">复尺录入人</span></span></td>
      <td width="32%"><input type="text" name="fclrr" value="<%=yhmc%>" size="20" maxlength="20" readonly></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">复尺说明</td>
      <td colspan="3"><textarea name="fcsm" cols="71" rows="3"></textarea></td>
    </tr>
    <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.fclrr)=="") {
		alert("请选择[复尺录入人]！");
		FormName.fclrr.focus();
		return false;
	}
	if(	javaTrim(FormName.fcsj)=="") {
		alert("请选择[复尺时间]！");
		FormName.fcsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.fcsj, "复尺时间"))) {
		return false;
	}

	FormName.action="SaveFcJc_zcdd.jsp";
	FormName.submit();
	return true;
}
