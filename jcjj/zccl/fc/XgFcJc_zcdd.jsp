...
<body bgcolor="#FFFFFF">
<div align="center">修改复尺（订单编号：<%=ddbh%>） 
...
<form method="post" action="" name="editform" >
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"><input type="text" name="fcsj" value="<%=fcsj%>" size="20" maxlength="10" readonly></td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td colspan="3"><textarea name="fcsm" cols="71" rows="3"><%=fcsm%></textarea></td>
    </tr>
    <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgFcJc_zcdd.jsp";
	FormName.submit();
	return true;
}
