...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,DECODE(jc_zcdd.ddlx,'1','代销品','3','补录合同','4','有库存订单','5','标准套餐','6','家具健康套餐','7','温暖静音套餐','8','窗帘套餐','9','代购主材','A','顶配升级','B','顶配独立收费','C','选配主材','D','套餐外主材','E','散客'),crm_khxx.khxm,crm_khxx.fwdz,ppbm,jc_zcdd.htshsj,jc_zcdd.jhshsj,jc_zcdd.tzshsj,jc_zcdd.tzshr,jc_zcdd.tzry,crm_khxx.lxfs||','||crm_khxx.qtdh,crm_khxx.hth,crm_khxx.sgbz,sq_bzxx.dh,jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcdd.shtzsm,jc_zcdd.gys,DECODE(jc_zcdd.ddshbz,'1','不需待电','2','待电未通知','3','待电已通知')";
    ...
    ls_sql+=" and (  (jc_zcdd.ddlx!='4' and jc_zcdd.ddshbz!='1' and jc_zcdd.clzt in('17','20'))";//等待送货通知标志  1：不需待电；2：待电未通知；3：待电已通知
    ls_sql+=" OR     (jc_zcdd.ddlx!='4' and jc_zcdd.ddshbz='1' and jc_zcdd.clzt in('13','15','17','20'))   ";
    ls_sql+=" OR     (jc_zcdd.ddlx='4' and jc_zcdd.clzt in('18','20'))  )";
	if (yhjs.equals("G0"))
	{
