...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="19%" align="right">实送货人 
              </td>
              <td width="31%"><input type="text" name="sshr" size="20" maxlength="20" > </td>
            </tr>
            <tr bgcolor="#E8E8FF">
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="打印送货时间" onClick="f_dy(selectform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="";
	FormName.action="Jc_zcddXgShList.jsp";
	FormName.submit();
	return true;
}
...
function f_dy(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_zcddDyList.jsp";
