...
<form method="post" action="" name="editform">
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="sshr" value="<%=yhmc%>" size="20" maxlength="20" >
      </td>
      <td width="18%"> 
        <div align="right">实送货时间</div>
      </td>
      <td width="32%"> 
        <input type="text" name="sshsj" value="<%=cf.today()%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%"> 
      ...
      <td colspan="3"> 
        <textarea name="shqk" rows="3" cols="72"></textarea>
      </td>
    </tr>
    <tr> 
