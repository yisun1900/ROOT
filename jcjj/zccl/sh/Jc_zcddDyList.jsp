...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String sshr=null;
	sshr=request.getParameter("sshr");
	if (sshr!=null)
	{
		sshr=cf.GB2Uni(sshr);
		if (!(sshr.equals("")))	wheresql+=" and  (jc_zcdd.sshr='"+sshr+"')";
	}


	ls_sql="SELECT jc_zcdd.ddbh,crm_khxx.khxm,crm_khxx.fwdz,ppbm,jc_zcdd.jhshsj,jc_zcdd.sshsj,crm_khxx.lxfs,crm_khxx.hth,crm_khxx.sgbz,sq_bzxx.dh,jc_zcdd.clgw";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddDyList.jsp","","","");
