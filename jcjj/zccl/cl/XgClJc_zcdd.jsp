...
try {
	...
	ls_sql="select cltzsm,sclsj,ztjjgw,htcxhdje,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,zjhze,ddqrr,ddqrsj,cltzr,tzclsj ";
	ls_sql+=" from  jc_zcdd";
...
<body bgcolor="#FFFFFF">
<div align="center">修改测量（订单编号：<%=ddbh%>） 
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="19%" align="right"> 
        实测量时间      </td>
      <td width="31%"> 
        <input type="text" name="sclsj" value="<%=sclsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgClJc_zcdd.jsp";
	FormName.submit();
	return true;
}
