...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－测量</div></td>
  </tr>
  <tr>
    <td width="100%" > 

<form method="post" action="Jc_zcddClList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right">计划测量时间 从</td>
              <td><input type="text" name="jc_zcdd_jhclsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_jhclsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right">发测量通知时间 从</td>
              <td><input type="text" name="jc_zcdd_tzclsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="jc_zcdd_tzclsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr> 
