...
<body bgcolor="#FFFFFF">
<div align="center">送货（订单编号：<%=ddbh%>） </div>
    ...
    <tr> 
      <td colspan="4" height="2">
        <div align="center"> 
          ...
          <input type="button"  value="送货明细" onClick="f_shmx(editform)" >
          <input type="button"  value="送货完成" onClick="f_do(editform)" >
          <input type="reset"  value="重输" name="reset">
		  <input type="button"  value="保存并打印合同" onClick="f_do1(editform)" >
        </div>      </td>
    </tr>
  </table>
</form>
