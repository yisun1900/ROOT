...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddTbhtzList.jsp","","","TbhtzJc_zcdd.jsp");
...
<CENTER >
  <B><font size="3">主材订单处理－－通知退补货</font></B>
</CENTER>
<%
	pageObj.out=out;
