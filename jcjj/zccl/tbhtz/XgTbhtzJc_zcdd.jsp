...
try {
	...
	ls_sql="select shqk,sshsj,sshr,tbhtzry,jhtbhsj,tbhqk,tztbhsj,tztbhr,shtzsm,jhshsj,tzry,ztjjgw,htcxhdje,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,zjhze,ddqrr,ddqrsj,cltzr,tzclsj,sclr,sclsj,tzshr,tzshsj ";
	ls_sql+=" from  jc_zcdd";
...
<div align="center">修改退补货通知（订单编号：<%=ddbh%>） </div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="tbhtzry" value="<%=tbhtzry%>" size="20" maxlength="20" >
      </td>
      <td width="18%"> 
        <div align="right">约定退补货时间</div>
      </td>
      <td width="32%"> 
        <input type="text" name="jhtbhsj" value="<%=jhtbhsj%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgTbhtzJc_zcdd.jsp";
	FormName.submit();
	return true;
}
