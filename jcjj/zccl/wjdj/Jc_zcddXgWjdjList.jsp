...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jc_zcdd.ddlx not in('E','9','C')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_zcdd.wjsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgWjdjList.jsp","","","XgWjdjJc_zcdd.jsp");
//	pageObj.setEditStr("完结");//设置每页显示记录数
/*
//设置显示列
...
//设置按钮参数
	String[] buttonName={"删除完结信息"};//按钮的显示名称
	String[] buttonLink={"DeleteWjdjJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">主材订单处理－－修改完结登记（结算后不能再修改）</font></B>
</CENTER>
<%
	pageObj.out=out;
