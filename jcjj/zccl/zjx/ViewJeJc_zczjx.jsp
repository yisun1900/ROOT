...
%> </td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right" bgcolor="#FFFFCC"><span class="STYLE1">增减项折扣</span></td>
    <td bgcolor="#FFFFCC"><%=zjxzkl%></td>
    <td align="right" bgcolor="#FFFFCC"><span class="STYLE1">赠送金额</span></td>
    <td bgcolor="#FFFFCC"><%=zsje%></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right" bgcolor="#FFFFCC"><span class="STYLE5">记入业绩时间</span></td>
    <td bgcolor="#FFFFCC"><%=yjjzsj%></td>
    <td align="right" bgcolor="#FFFFCC"><span class="STYLE5">实收款金额</span></td>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">手写标志</td>
	<td  width="2%">是否赠品</td>
	<td  width="4%" bgcolor="#CCCCCC">系列</td>
	<td  width="4%">主材名称</td>
	<td  width="4%">型号</td>
	<td  width="4%">规格</td>
	<td  width="2%">选择价格</td>
	...
	<td  width="2%" bgcolor="#CC99FF">赠送单价</td>
	<td  width="3%" bgcolor="#CC99FF">赠送金额</td>
	<td  width="2%" bgcolor="#CC99FF">增减数量</td>
	<td  width="3%" bgcolor="#CC99FF">折前增减材料费</td>
	<td  width="3%" bgcolor="#CC99FF">折后增减材料费</td>
	<td  width="3%" bgcolor="#CC99FF">增减远程费</td>
	<td  width="3%" bgcolor="#CC99FF">增减其它费</td>
	<td  width="3%" bgcolor="#CC99FF">折前增减合计</td>
	<td  width="3%" bgcolor="#CC99FF">折后增减合计</td>
	<td  width="3%" bgcolor="#CC99FF">增减计入活动金额</td>
	<td  width="3%" bgcolor="#CC99FF">增减业绩记入金额</td>
	<td  width="3%" bgcolor="#CC99FF">增减成本金额</td>
	<td  width="3%">铺装位置</td>
	<td  width="3%">颜色</td>
...
<%
	...
	ls_sql ="SELECT DECODE(jc_zczjxmx.lx,'1','原项目','2','新增') lx,jc_zcddmx.zcbm,DECODE(jc_zczjxmx.sxbz,'1','否','2','手写') sxbz,DECODE(jc_zcddmx.sfzp,'Y','赠品','N','否') sfzp,zclbbm,zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,DECODE(xzjg,'0','手写','1','销售价','2','<font color=\"#FF0000\">促销价</font>') xzjg,TO_CHAR(jc_zcddmx.zqdj) zqdj,TO_CHAR(jc_zcddmx.dpzk) dpzk,TO_CHAR(jc_zcddmx.dj) dj,DECODE(jc_zcddmx.jsfs,'1','结算价','2','结算比例'),jc_zcddmx.jsbl||'%',TO_CHAR(jc_zcddmx.cbj) cbj,jc_zcddmx.jldwbm,cxhdbl||'%' cxhdbl,yjjrbl||'%' yjjrbl,TO_CHAR(jc_zcddmx.zsdj),round(jc_zcddmx.zsdj*jc_zczjxmx.zjsl,2),jc_zczjxmx.zjsl,jc_zczjxmx.zqzjje,jc_zczjxmx.zjje ,jc_zczjxmx.zjycf,jc_zczjxmx.zjqtfy,(jc_zczjxmx.zqzjje+jc_zczjxmx.zjycf+jc_zczjxmx.zjqtfy) zqxj,(jc_zczjxmx.zjje+jc_zczjxmx.zjycf+jc_zczjxmx.zjqtfy) zhxj,jc_zczjxmx.zjcxhdje,jc_zczjxmx.zjyjjrje,jc_zczjxmx.zjcbje,zcpzwzbm,jc_zcddmx.zcysbm,jc_zcddmx.sxhtyy,jc_zcddmx.dwbh,jc_zczjxmx.bz ";
