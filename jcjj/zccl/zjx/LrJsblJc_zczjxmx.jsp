...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">审核手写项目结算比例－录入结算比例（增减项编号：<%=zjxbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveLrJsblJc_zczjxmx.jsp" name="editform">
...
%></td>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="jsbl" size="10" maxlength="9"  value="<%=jsbl%>" onChange="f_jsjg(editform)">
                ％</td>
...
{
	var cbj=<%=dj%>*FormName.jsbl.value/100;
	cbj=round(cbj,2);
