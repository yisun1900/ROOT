...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入已完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),crm_khxx.khxm,crm_khxx.fwdz,jc_zczjx.ppbm,TO_CHAR(jc_zczjxmx.xh),DECODE(jc_zczjxmx.lx,'1','已有项','2','新增'),jc_zcddmx.zcmc,jc_zcddmx.xinghao,jc_zcddmx.gg,jc_zcddmx.zcysbm,jc_zcddmx.zclbbm,TO_CHAR(jc_zcddmx.dpzk),TO_CHAR(jc_zcddmx.dj),jc_zcddmx.jldwbm,jc_zczjxmx.zjsl,jc_zczjxmx.zqzjje,jc_zczjxmx.zjje,jc_zczjxmx.zjcxhdje,jc_zczjxmx.zjycf,jc_zczjxmx.zjqtfy,jc_zczjxmx.zjcbje,jc_zczjx.ddbh,jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,zczjxyymc,jc_zczjx.lrsj,crm_khxx.hth,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,jc_zczjx,jc_zczjxmx,jdm_zczjxyybm,jc_zcddmx";
    ls_sql+=" where jc_zczjx.khbh=crm_khxx.khbh and jc_zczjx.zczjxyybm=jdm_zczjxyybm.zczjxyybm(+)";
    ls_sql+=" and jc_zczjx.zjxbh=jc_zczjxmx.zjxbh and jc_zczjxmx.xh=jc_zcddmx.xh";
	if (yhjs.equals("G0"))
	{
		ls_sql+=" and crm_khxx.fgsbh in(select ssfgs from jxc_ppgysdzb where gysbm='"+ygbh+"' )";
		ls_sql+=" and jc_zczjx.clzt in('02','03','04')";
	}
	else{
	...
	ls_sql+=wheresql;
    ls_sql+=" order by jc_zczjxmx.zjxbh,jc_zcddmx.xinghao";
    pageObj.sql=ls_sql;
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jc_zczjxmxCxJeList.jsp","","","");
...
<CENTER >
  <B><font size="3">查询－增减项明细（金额）</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">计量单位</td>
	<td  width="2%">增减数量</td>
	<td  width="3%">折前增减材料费</td>
	<td  width="3%">折后增减材料费</td>
	<td  width="3%">增减计入活动金额</td>
	<td  width="3%">增减远程费</td>
	<td  width="3%">增减其它费用</td>
	<td  width="3%"><B>增减成本金额</B></td>
	<td  width="3%">订单编号</td>
