...
<form method="post" action="Jc_zczjxCxJeList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><strong>*增减项发生时间 从</strong></td>
              <td><input type="text" name="zjxfssj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right" bgcolor="#FFFFFF">到</td>
              <td><input type="text" name="zjxfssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td align="right" bgcolor="#FFFFFF"><strong><font color="#FF0000">是否已结算</font></strong></td>
              <td><input type="radio" name="sfjs" value="Y">
                已结算
                  <input type="radio" name="sfjs" value="N">
              未结算 </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><select name="jc_zczjx_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" onclick="getThis('lrbm')">
                  <option value=""></option>
                </select>              </td>
            </tr>
            <tr> 
...
function changeFgs(FormName) 
{
	...
	FormName.jc_zczjx_dwbh.length=1;
...
function getAjax(ajaxRetStr) 
{
	...
	{
		strToSelect(selectform.jc_zczjx_dwbh,ajaxRetStr);
	}
