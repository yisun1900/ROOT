...
%> 
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td><input type="text" name="gysjslrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="gysjslrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr> 
