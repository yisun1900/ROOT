...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddXgQxList.jsp","","","XgQxdd.jsp");
//	pageObj.setEditStr("删除退单");//设置每页显示记录数
/*
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteQxdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">主材订单处理－－修改退单</font></B>
</CENTER>
<%
	pageObj.out=out;
