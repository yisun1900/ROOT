...
try {
	...
	ls_sql="select sxhtsfysh,wdzje,hkze,zczkl,dzyy,htcxhdje,zjxcxhdje,zqzjhze,zjhze   ,ztjjgw,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz ";
	ls_sql+=" from  jc_zcdd";
	...
	if ( zcfk < (hkze+zjhze-11))
	{
		...
		out.println("<BR>订单金额＝￥"+(hkze+zjhze)+"，应补交货款＝￥"+(hkze+zjhze-zcfk));
	}
}
catch (Exception e) {
