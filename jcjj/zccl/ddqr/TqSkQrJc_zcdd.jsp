...
try {
	...
	ls_sql="select clzt,zjxxh,sxhtsfysh,wdzje,hkze,zczkl,dzyy,htcxhdje,zjxcxhdje,zqzjhze,zjhze   ,ztjjgw,zcdlbm,ppbm,ddbh,khbh,clgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz ";
	ls_sql+=" from  jc_zcdd";
...
//	ls_sql+=" and (  skdd='1' OR (skdd='2' and dsksjbz='Y')  )";
	...
	{
		out.println("<B><font color=\"#FF0000\">提醒！付款不足！</B></font>");
	...
	//	ls_sql+=" and (  skdd='1' OR (skdd='2' and dsksjbz='Y')  )";
		...
		if ( zcfk < (gethkze-11))
		{
			out.println("提醒！付款不足或财务未审核，请在[收集成款]中收取[主材变更款]");
			out.println("<BR>实付款＝￥"+zcfk);
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="21%" align="right"> 
        <div align="right"><b>折前－增减后总额</b></div>      </td>
      <td width="29%"><%=cf.formatDouble(wdzje+zqzjhze)%> </td>
      <td width="21%" align="right"> 
        <div align="right"><b>折后－增减后总额</b></div>      </td>
    ...
    <tr> 
      <td colspan="4" height="2">
        <div align="center"> 
          ...
          <input name="button2" type="button" onClick="f_do1(editform)"  value="确认并打印主材款凭证" >
        </div>      </td>
    </tr>
  </table>
</form>
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/jcjj/zccl/ddqr/DYSkQrJc_zcdd.jsp";
	FormName.submit();
	return true;
}
