...
try {
	...
	ls_sql="select qtycf,ycf,zjxycf,sxhtsfysh,sfjs,zjxcbze,cbze,zqclf,zhclf,zqzjxclf,zhzjxclf,dzyy,lrsj,sfyyh,yhkssj,yhjzsj,yhnr,zczkl,jjsjs,htcxhdje,wdzje,zcdlbm,zcxlbm,ppbm,khbh,clgw,ztjjgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,jhtzshsj ";
	ls_sql+=" from  jc_zcdd";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">修改远程费（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%>              </td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><strong><font color="#0000FF">合同远程费</font></strong></td>
              <td><%=ycf%><strong><font color="#990000">(含：套餐分解远程费)</font></strong></td>
              <td align="right"><strong><font color="#0000FF">增减项远程费</font></strong></td>
              <td><%=zjxycf%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#FF0000">*</font>套餐分解远程费</td>
              <td><input name="qtycf" type="text" value="<%=qtycf%>" size="20" maxlength="16" ></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.qtycf, "套餐分解远程费"))) {
		return false;
	}

	FormName.action="SaveXgYcfJc_zcdd.jsp";
	FormName.submit();
	return true;
}
