...
try {
	...
	ls_sql="select gys,jssj,jsr,cbzj,ycfzj,qtfzj,fk,kzbjbl,kzbjje,qtkk,kcfy,jsje,jssm,cwzq,fk,kzbjbl,kzbjje,qtkk ";
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font><font color="#0000CC">远程费</font></td> 
  <td width="32%"> 
    <input type="text" name="ycfzj" size="20" maxlength="17"  value="<%=ycfzj%>" readonly>  </td>
  <td align="right" width="18%"><font color="#FF0000">*</font><font color="#0000CC">其它费</font></td> 
  <td width="32%"> 
    <input type="text" name="qtfzj" size="20" maxlength="17"  value="<%=qtfzj%>" readonly>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>罚款</td>
  <td><input type="text" name="fk" value="<%=fk%>" size="20" maxlength="20" onChange="f_jsjg(editform)"/></td>
  <td align="right"><font color="#FF0000">*</font>其它扣款</td>
  <td><input name="qtkk" type="text" onChange="f_jsjg(editform)" value="<%=qtkk%>" size="20" maxlength="20"/></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>扣质保金比例</td>
  <td><input type="text" name="kzbjbl" value="<%=kzbjbl%>" size="10" maxlength="20" onChange="f_jsjg(editform)"/>
    %</td>
  <td align="right"><font color="#FF0000">*</font>扣质保金金额</td>
  <td><input type="text" name="kzbjje" value="<%=kzbjje%>" size="20" maxlength="20" onChange="f_jsjg(editform)"/></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font><font color="#0000CC">扣除费用总额 </font></td> 
  <td width="32%"> 
    <input type="text" name="kcfy" size="20" maxlength="17"  value="<%=kcfy%>" onChange="f_jsjg(editform)" readonly>  </td>
...
<input type="hidden" name="jsjlh"  value="<%=jsjlh%>" >
	...
	<div align="center">
	  ...
	  <input type="hidden" name="cwzq" value="<%=cwzq%>" size="20" maxlength="20" />
	</div>      </td>
    </tr>
  </table>
</form>
...
{
	var kzbjje=<%=cf.round(cbzj+ycfzj+qtfzj,2)%>/100*FormName.kzbjbl.value;
	kzbjje=round(kzbjje,2);
	FormName.kzbjje.value=kzbjje;

	var kcfy=FormName.fk.value*1.0+FormName.qtkk.value*1.0+FormName.kzbjje.value*1.0;
	kcfy=round(kcfy,2);
	FormName.kcfy.value=kcfy;
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.ycfzj)=="") {
		alert("请输入[远程费]！");
		FormName.ycfzj.focus();
		return false;
	}
	if(!(isFloat(FormName.ycfzj, "远程费"))) {
		return false;
	}
	if(	javaTrim(FormName.qtfzj)=="") {
		alert("请输入[其它费]！");
		FormName.qtfzj.focus();
		return false;
	}
	if(!(isFloat(FormName.qtfzj, "其它费"))) {
		return false;
	}
