...
%>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><input type="text" name="fk" value="0" size="20" maxlength="20" onchange="f_jsjg(editform)"/></td>
      <td align="right"><font color="#FF0000">*</font>其它扣款</td>
      <td><input name="qtkk" type="text" onchange="f_jsjg(editform)" value="0" size="20" maxlength="20"/></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right"><font color="#FF0000">*</font>扣质保金比例</td>
      <td><input type="text" name="kzbjbl" value="0" size="10" maxlength="20" onchange="f_jsjg(editform)"/>
      %</td>
      <td align="right"><font color="#FF0000">*</font>扣质保金金额</td>
      <td><input type="text" name="kzbjje" value="0" size="20" maxlength="20" onchange="f_jsjg(editform)"/></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right"><font color="#FF0000">*</font><font color="#0000CC">扣除费用总额 </font></td>
      <td><input type="text" name="kcfy" value="0" size="20" maxlength="20" onChange="f_jsjg(editform)" readonly /></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.kzbjje)=="") {
		alert("请选择[扣质保金金额]！");
		FormName.kzbjje.focus();
		return false;
	}
	if(!(isFloat(FormName.kzbjje, "扣质保金金额"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.kcfy, "扣除费用总额 "))) {
		return false;
	}
