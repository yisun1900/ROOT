...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_gysjsCxFkList.jsp" name="selectform">
<div align="center">结算单付款－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right"><strong><font color="#0000FF">付款状态</font></strong></td>
  <td>
    <input type="radio" name="shbz" value="S">
    部分付款
    <input type="radio" name="shbz" value="F">
    付款完成   </td>
</tr>
<tr bgcolor="#FFFFFF">
