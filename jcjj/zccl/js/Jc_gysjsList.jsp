...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jsjlh,DECODE(shbz,'N','未审核','Y','审核','F','付款完成','S','部分付款'),gys,ppbm,jssj,jsr,jsje,cbzj,ycfzj,qtfzj,kcfy,fk,kzbjbl||'%',kzbjje,qtkk,jssm,shr,shsj,fkr,fksj,fksm,dwmc ";
