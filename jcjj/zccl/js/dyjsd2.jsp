...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	ls_sql+=" from jc_gysjsmx,jc_zcdd,crm_khxx,sq_dwxx,bdm_bjjbbm,dm_hxbm";
	...
	ls_sql+=" from jc_gysjsmx,jc_zczjx,crm_khxx,sq_dwxx,bdm_bjjbbm,dm_hxbm";
	...
	while (rs1.next())
	{
		...
		ls_sql=" SELECT dwbh,ddbh,qhtsj,sshsj,khxm,fwdz,zcmc,gg,xinghao,jldwbm,sl,cbj,je,ycf,qtfy,cxhdbl,cxhdje,bz";
		ls_sql+=" FROM ( ";
	...
	%> 
		  <tr bgcolor="#E8E8FF"  align="center"  >
            <td colspan="8"><font size="3"><b>套餐总计：<%=cf.formatDouble(zjje+zjycf+zjqtfy)%></b></font></td>
		    <td colspan="3">&nbsp;</td>
