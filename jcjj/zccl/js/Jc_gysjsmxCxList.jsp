...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_gysjs.jsjlh,jc_gysjs.jssj,jc_gysjs.ppbm,crm_khxx.khbh,crm_khxx.khxm,jc_gysjsmx.ddbh,jc_zcdd.cbze,ROUND(NVL(jc_zcdd.ycf,2)+NVL(jc_zcdd.qtf,2),2),jc_zcdd.clgw,jc_zcdd.ztjjgw,jc_zcdd.xmzy,crm_khxx.hth,crm_khxx.fwdz,DECODE(jc_gysjs.shbz,'N','未审核','Y','审核') shbz,jc_gysjs.gys,jc_gysjs.cwzq,jc_gysjs.jsr,TO_CHAR(jc_gysjs.cbzj) cbzj,TO_CHAR(jc_gysjs.jsje) jsje,TO_CHAR(jc_gysjs.kcfy) kcfy";
    ...
    ls_sql+=" and jc_gysjs.lx='1'";//1：订单；2：代购主材
	...
	ls_sql+=" SELECT jc_gysjs.jsjlh,jc_gysjs.jssj,jc_gysjs.ppbm,crm_khxx.khbh,crm_khxx.khxm,jc_gysjsmx.ddbh,jc_zczjx.zjxcbze,ROUND(NVL(jc_zczjx.zjxycf,2)+NVL(jc_zczjx.zjxqtf,2),2),jc_zczjx.clgw,jc_zczjx.ztjjgw,jc_zczjx.xmzy,crm_khxx.hth,crm_khxx.fwdz,DECODE(jc_gysjs.shbz,'N','未审核','Y','审核') shbz,jc_gysjs.gys,jc_gysjs.cwzq,jc_gysjs.jsr,TO_CHAR(jc_gysjs.cbzj) cbzj,TO_CHAR(jc_gysjs.jsje) jsje,TO_CHAR(jc_gysjs.kcfy) kcfy";
