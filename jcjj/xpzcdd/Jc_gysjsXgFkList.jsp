...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jsjlh,DECODE(shbz,'N','未审核','Y','审核','F','结算付款'),gys,ppbm,jssj,jsr,kcfy,jsje,cbzj,ycfzj,qtfzj,jssm,shr,shsj,fkr,fksj,fksm,dwmc,jc_gysjs.cwzq  ";
	ls_sql+=" FROM jc_gysjs,sq_dwxx  ";
    ls_sql+=" where  jc_gysjs.ssfgs=sq_dwxx.dwbh and jc_gysjs.lx='3'";//1：订单；2：代购主材；3：选配主材
