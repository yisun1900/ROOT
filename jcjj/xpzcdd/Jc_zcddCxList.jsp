...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (yhjs.equals("G0"))
	{
		ls_sql="SELECT  jc_zcdd.ddbh,clztmc,jc_zcdd.ppbm,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.khjl,crm_khxx.zjxm,crm_khxx.hth,jc_zcdd.clgw,crm_khxx.yjjzsj,crm_khxx.khjssj,jc_zcdd.ddqrsj,jc_zcdd.xshth,jc_zcdd.qhtsj,jc_zcdd.wdzje,jc_zcdd.zcpclf,jc_zcdd.tjpclf,jc_zcdd.qtf,jc_zcdd.ycf,jc_zcdd.khfdbl||'%',jc_zcdd.tjpkhfdbl||'%',ROUND(jc_zcdd.zcpclf*jc_zcdd.khfdbl/100+jc_zcdd.tjpclf*jc_zcdd.tjpkhfdbl/100,2) khyh,jc_zcdd.htshsj,jc_zcdd.gys,zcdlbm,jc_zcdd.lrsj,a.dwmc lrdw,jc_zcdd.khbh,jc_zcdd.bz,DECODE(jc_zcdd.clzt,'07','未审核','09','未审核','98','退单','99','退单','审核'),crm_khxx.qyrq,b.dwmc dm";
...
<body bgcolor="#ffffff" text="#000000" style='FONT-SIZE: 12px'>
<CENTER >
  <B><font size="3">选配主材主材－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">合同号</td>
	<td  width="2%">家居顾问</td>
	<td  width="3%">家装记入业绩时间</td>
	<td  width="3%">客户竣工结算时间</td>
	<td  width="3%">订单确认时间</td>
	<td  width="3%">销售合同号</td>
	<td  width="3%">购买日期</td>
	...
	<td  width="3%">安装费</td>
	<td  width="3%">远程费</td>
	<td  width="2%">正常品客户返点比例</td>
	<td  width="2%">特价品客户返点比例</td>
	<td  width="3%">客户优惠金额</td>
