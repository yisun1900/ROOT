...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddPlWhTcblList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"设置提成记入比例"};//按钮的显示名称
	String[] buttonLink={"PlEditWhTcblJc_zcdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">批量维护提成记入比例</font></B>
</CENTER>
<%
	pageObj.out=out;
