...
try {
	...
	ls_sql="select khbh,zcdlbm,zcxlbm,ppbm,xshth,zcpclf,tjpclf,qtf,ycf,wdzje,djqmc,djqje,sjbh,clzt,xmzy,clgw";
	ls_sql+=" from  jc_zcdd";
...
<table width="100%" style='FONT-SIZE: 14px'>
  <tr>
    <td width="100%"> 
      <div align="center">整单退货（订单编号：<%=ddbh%>）
    </div></td>
  </tr>
  <tr>
    <td width="100%" > 
...
if (dds>0)
{
	...
	<%
		...
		ls_sql+=" and jc_zcdd.ddlx='9'";//9:集成家居主材
...
%>
            ...
            <tr bgcolor="#FFFFCC">
              <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><span class="STYLE2">退货正常品-材料费</span></td>
              <td>
			  <input name="zcpclf" type="text"  onChange="f_jsjg(insertform)" value="<%=-1*zcpclf%>" size="20" maxlength="20" readonly>
			  订货:<%=zcpclf%></td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right"><font color="#FF0000">*</font><span class="STYLE2">退货特价品-材料费</span></td>
              <td>
			  <input name="tjpclf" type="text" onChange="f_jsjg(insertform)" value="<%=-1*tjpclf%>" size="20" maxlength="20" readonly>
			  订货:<%=tjpclf%>			  </td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right"><font color="#FF0000">*</font><span class="STYLE2">退货安装辅料加工费</span></td>
              <td><input name="qtf" type="text"  onChange="f_jsjg(insertform)" value="<%=-1*qtf%>" size="20" maxlength="20" readonly>
			  订货:<%=qtf%>			  </td>
              <td align="right"><font color="#FF0000">*</font><span class="STYLE2">退货远程费</span></td>
              <td><input name="ycf" type="text" onChange="f_jsjg(insertform)" value="<%=-1*ycf%>" size="20" maxlength="20" readonly>
			  订货:<%=ycf%></td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">合同总额</font></td>
              <td colspan="3"><input type="text" name="wdzje" value="<%=-1*wdzje%>" size="20" maxlength="20"  readonly>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td colspan="3">&nbsp;①、<strong>绿色电子礼券卡</strong>，已付金额：
			    <input type="text" name="zcdjj" size="8" value="<%=zcdjj%>" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"  >
			  ，<span class="STYLE2">本次转款金额</span>              
              <input name="djjzkje" type="text" onChange="f_jsjg(insertform)" value="<%=-1*zcdjj%>" size="10" maxlength="20"  readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td colspan="3">&nbsp;②、<strong>增值储值卡</strong>，已付金额：
                <input type="text" name="zzczk" size="8" value="<%=zzczk%>" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"  >
，<span class="STYLE2">本次转款金额</span>
<input name="zzczkzkje" type="text" onChange="f_jsjg(insertform)" value="<%=-1*zzczk%>" size="10" maxlength="20" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td height="32" colspan="3">&nbsp;③、<strong>主材预付款</strong>，已付金额：
			   <input type="text" name="zcyfk" size="8" value="<%=zcyfk%>" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"  >
			  ，<span class="STYLE2">本次转款金额</span>
              <input name="yfkzkje" type="text" onChange="f_jsjg(insertform)" value="<%=-1*zcyfk%>" size="10" maxlength="20"  readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid">
              <span class="STYLE1">请优先使用</span></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td colspan="3">&nbsp;④、<strong>纸质材料券</strong>
                <select name="djqmc" style="FONT-SIZE:12PX;WIDTH:162PX" >
                  <option value="<%=djqmc%>"><%=djqmc%></option>
                </select>
                ，已使用金额：
                <input type="text" name="sydjqje" size="8" value="<%=djqje%>" readonly style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"  >
              ，<span class="STYLE2">本次使用金额</span>
              <input name="djqje" type="text" onChange="f_jsjg(insertform)" value="<%=-1*djqje%>" size="10" readonly maxlength="20" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid">
			  <BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;凭证号
              <input name="sjbh"  value="<%=sjbh%>" type="text" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" size="20" maxlength="20"></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (parseFloat(FormName.djjzkje.value) >0 )
	{
		alert("错误！[绿色电子礼券卡转款金额]应小于0");
		FormName.djjzkje.select();
		return false;
	}

	if (parseFloat(FormName.zcdjj.value)+parseFloat(FormName.djjzkje.value)<0 )
	{
		alert("绿色电子礼券卡错误！[转款金额]不能大于[已付金额]！");
		FormName.djjzkje.select();
		return false;
	}
	...
	if (parseFloat(FormName.zzczkzkje.value) >0 )
	{
		alert("错误！[增值储值卡转款金额]应小于0");
		FormName.zzczkzkje.select();
		return false;
	}
	if (parseFloat(FormName.zzczk.value)+parseFloat(FormName.zzczkzkje.value)<0)
	{
		alert("增值储值卡转款金额错误！[转款金额]不能大于[已付金额]！");
		FormName.zzczkzkje.select();
		return false;
	}
	...
	if (parseFloat(FormName.yfkzkje.value) >0 )
	{
		alert("错误！[主材预付款转款金额]应小于0");
		FormName.yfkzkje.select();
		return false;
	}

	if (parseFloat(FormName.zcyfk.value)+parseFloat(FormName.yfkzkje.value)<0)
	{
		alert("主材预付款错误！[转款金额]不能大于[已付金额]！");
		FormName.yfkzkje.select();
		return false;
	}

	if (parseFloat(FormName.zcyfk.value)+parseFloat(FormName.yfkzkje.value)>0 && parseFloat(FormName.djjzkje.value)!=0)
	{
		alert("错误！请优先使用【主材预付款】");
		FormName.yfkzkje.select();
		return false;
	}
	...
	if(!(isFloat(FormName.djqje, "纸质材料券转款金额"))) {
		return false;
	}
	if (parseFloat(FormName.djqje.value) >0 )
	{
		alert("错误！[纸质材料券转款金额]应小于0");
		FormName.djqje.select();
		return false;
	}
	else if (parseFloat(FormName.djqje.value)< 0 )
	{
	...
	if (parseFloat(FormName.sydjqje.value)+parseFloat(FormName.djqje.value)<0)
	{
		alert("纸质材料券转款金额错误！[转款金额]不能大于[已付金额]！");
		FormName.djqje.select();
		return false;
	}
	...
	FormName.action="SaveInsertJc_zcddTd.jsp";
	FormName.submit();
