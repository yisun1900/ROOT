...
<CENTER >
  <B><font size="3">品牌选配主材主材统计</font></B>
</CENTER>
...
try {
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF"  align="center" height="23">
			<td><A HREF="ViewPpJc_zcdd.jsp?wheresql=<%=java.net.URLEncoder.encode(wheresql,"UTF-8")%>&ppbm=<%=getppbm%>" target="_blank"><%=getppbm%></A></td>
			<td><%=wdzje%></td>
			<td><%=hkze%></td>
			<td><%=cbze%></td>
			<td><%=tcze%></td>
