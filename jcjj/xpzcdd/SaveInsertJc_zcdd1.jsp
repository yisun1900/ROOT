...
try {
	...
	//6：散客
	ls_sql="insert into crm_zxkhxx ( khbh,khxm,xb,fwdz,lxfs,lrr,lrsj   ,zxdjbm,ssfgs   ,zxzt,lfbz,ctbz,shbz,sfzdzbj,sjsjsbz,sfjczjz,lfdjbz,hddjbz,sjfbz,cxgtbz,csgtbz,qsjhtbz,ysshbz,bjdysq,xcjdbz ,khlxbm,hdbz,sfxhf,clgw) ";
	...
	ls_sql+=" ,xshth,sftjp,zcpclf,fdbl,khfdbl,tcjrbl,tjpclf,tjpfdbl,tjpkhfdbl,tjptcjrbl,htyjjrje,zjxyjjrje,sskje )";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?    ,?,?,?,?,?,?,?,?,?,?";
	ls_sql+=" ,?,?,?,?,SYSDATE,?,?,?    ";
	...
	ps.setString(43,"");
	ps.setDouble(44,zcpclf);
	ps.setDouble(45,xpjsbl);
	ps.setDouble(46,xpkhfdbl);
	ps.setDouble(47,xptcjrbl);
	ps.setDouble(48,tjpclf);
	ps.setDouble(49,tjpfdbl);
	ps.setDouble(50,tjpkhfdbl);
	ps.setDouble(51,tjptcjrbl);
	ps.setDouble(52,htyjjrje);
