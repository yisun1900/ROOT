...
try {
	...
	ls_sql="select zdxsj,zxqdl,zcpzsl,dhsl,zcpzsl-dhsl xhsl,xsfs,DECODE(xsfs,'1','代销品','2','现货销售','3','库存无货可销售') xsfsmc,bz";
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="36%"><%=lsj%></td>
              <td width="18%" align="right"><font color="#0000CC">销售价</font></td>
              <td width="28%"><%=yhj%>(最低销售限价:<%=zdxsj%>)</td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%></td>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="36%"> 
                <input type="text" name="cxhdbl" size="17" maxlength="9"  value="<%=cxhdbl%>" readonly onChange="f_jsjg(editform)" >
                % </td>
            ...
            <tr> 
              <td colspan="4" height="2"> 
				...
				<input type="hidden" name="zdxsj"  value="<%=zdxsj%>" >
