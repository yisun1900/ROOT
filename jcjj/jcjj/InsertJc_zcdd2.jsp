...
if (dds>0)
{
	...
	<%
		...
		ls_sql="SELECT jc_zcdd.ddbh,'<A HREF=\"InsertJc_zcddTd2.jsp?ddbh='||jc_zcdd.ddbh||'\" >退单</A>','<A HREF=\"InsertJc_zcddTh2.jsp?ddbh='||jc_zcdd.ddbh||'\" >退货</A>',clztmc,ppbm,jc_zcdd.clgw,jc_zcdd.xshth,jc_zcdd.zcpclf,jc_zcdd.tjpclf,jc_zcdd.qtf,jc_zcdd.ycf,jc_zcdd.wdzje,jc_zcdd.lrsj";
...
%>
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#CCFFCC">
              ...
              <td colspan="3"><%=cf.round(zcyfk+zcdjj-(htze-zcfk),2)%><strong>（主材预付款＋绿色电子礼券卡＋主材已付款－订货总额），如果新订货超过此金额需要客户补款</strong></td>
            </tr>
            <tr bgcolor="#CCFFCC"> 
              <td width="19%" align="right"><b>主材预付款</b></td>
              <td width="31%"><%=zcyfk%></td>
              <td width="18%" align="right"><strong>绿色电子礼券卡</strong></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertJc_zcdd2.jsp";
	FormName.submit();
