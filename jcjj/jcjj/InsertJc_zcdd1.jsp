...
<form method="post" action="" name="insertform"  >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>分公司</td>
              <td bgcolor="#FFFFFF"><select name="fgsbh" style="FONT-SIZE:12PX;WIDTH:152PX" onchange="changeFgs(insertform)">
                <%
		...
		%>
              ...
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>所属部门 </td>
              <td bgcolor="#FFFFFF"><select name="dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
                <%
...
%>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button" name="save"  value="存盘" onClick="f_do(insertform)">              </td>
            </tr>
        </table>
</form>
