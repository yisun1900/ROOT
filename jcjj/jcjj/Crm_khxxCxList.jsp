...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hth,khxm,fwdz,bjjbmc,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,crm_khxx.clgw,ysgcjdmc,khbh ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","InsertJc_zcdd.jsp?zt=2","");
