...
try {
	...
	if (!jc_zcdd_sfjs.equals("N") && !jc_zcdd_sfjs.equals("C"))//N：未结算；C：已选择结算；Y：已结算；M：结算已审核；F：结算付款；P：不需结算
	{
...
<div align="center">订单编号：<%=ddbh%></div>
<form method="post" action="" name="editform" >
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    <td width="20%" align="right"><span class="STYLE1">*</span>退单原因</td>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span><span class="STYLE2">退单办理人</span></td>
    <td><input type="text" name="tdblr" value="<%=yhmc%>" size="20" maxlength="20" readonly>    </td>
    <td align="right"><span class="STYLE1">*</span><span class="STYLE2">退单时间</span></td>
    <td><input type="text" name="tdsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly>    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span>退单说明</td>
  ...
  <tr>
    <td colspan="4" align="center">
        ...
        <input type="button" onClick="window.open('/jcjj/zcdd/Cw_khfkjlCxList.jsp?ddbh=<%=ddbh%>')" value="订单付款信息"   >    </td>
  </tr>
  </table>
  </form>
...
<tr bgcolor="#FFFFFF"> 
  ...
  <tr bgcolor="#CCCCFF"> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF">家装签约日期</td>
  ...
  <tr> 
    ...
    <td width="20%" bgcolor="#FFFFFF" align="right">家装设计师</td>
...
%> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF"><strong>订单类型</strong></td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF">子品牌</td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF">供应商</td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF">签合同时间</td>
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="20%" align="right" bgcolor="#FFFFFF">特价品客户返点比例</td>
  ...
  <tr bgcolor="#FFFFCC">
    <td align="right" bgcolor="#FFFFFF">成本金额</td>
...
%>    </td>
    <td align="right" bgcolor="#FFFFFF">结算金额</td>
