...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">集成家居主材－查询</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddCxList.jsp" name="selectform" target="_blank">
...
%> 
			...
			<tr bgcolor="#FFFFFF">
				...
				<td><input type="text" name="crm_khxx_qyrq" size="20" maxlenght="10" onDblClick="JSCalendar(this)"></td>
				<td align="right">到</td>
...
%> 
	        ...
	        <tr bgcolor="#FFFFFF">
	          ...
	          <td><input name="dsksjbz" type="radio" value="N" >
未审核
