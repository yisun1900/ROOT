...
%>
            ...
            <tr bgcolor="#FFFFFF">
              <td rowspan="4" align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>付款方式
              <BR><BR><input  type="button" onClick="window.open('/khxx/ViewCwxx.jsp?khbh=<%=khbh%>')" value="付款信息"></td>
...
%>
              ...
              凭证号<input name="sjbh" type="text" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" size="20" maxlength="20"></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
