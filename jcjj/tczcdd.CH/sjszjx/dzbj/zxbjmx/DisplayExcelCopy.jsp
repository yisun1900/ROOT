    ...
    <tr>
      <td width="68%" height="57"><table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="1">
          <tr align="center" bgcolor="#FFFFFF">
            ...
            <td width="47%"><strong>项目名称</strong></td>
            <td width="14%"><strong>计量单位</strong></td>
            <td width="12%"><strong>工程量</strong></td>
          </tr>
<%
	...
	{
		out.println("<BR>错误！列数量不足，应该是5列，实际列："+colStr.length);
		return;
	}
	...
	for (int i=1;i<lineStr.length ;i++ )
	{
		...
		if (colStr==null || colStr.length!=5)
		{
			out.println("<BR>第["+(i+1)+"]行错误！列数量不足，应该是5列，本行数据被放弃，实际列："+colStr.length);
			continue;
		}
