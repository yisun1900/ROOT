...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_zjxdj.lx='4' and crm_zjxdj.shbz in('Y','S')";//N：未审核；Y：审核通过；S：审核未通过；M：不需审核
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zjxdjXgShList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteShCrm_zjxdj.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">调换产品－修改审核</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">扣其它款</td>
	<td  width="3%">发生阶段</td>
	<td  width="3%">调换产品发生时间</td>
	<td  width="3%">合同号</td>
	<td  width="10%">调换产品原因</td>
</tr>
<%
