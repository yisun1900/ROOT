...
<body>
<div align="center">调换产品登记（调换产品序号：<%=crm_zjxdj_zjxxh%>）</div> 
  ...
  <tr bgcolor="#FFFFFF" align="center"> 
    <td colspan="4">  
	  ...
	  <input type="button" onClick="window.open('dzbj/zxbjmx/Jc_zcddCxList.jsp?zjxxh=<%=zjxxh%>&khbh=<%=khbh%>')" value="分解订单">
			...
			<input type="button"  value="家具套餐合同" onClick="window.open('dzbj/zxbjmx/Bj_zctcmcDyListH.jsp?khbh=<%=khbh%>&zjxxh=<%=zjxxh%>')"  /></td>
