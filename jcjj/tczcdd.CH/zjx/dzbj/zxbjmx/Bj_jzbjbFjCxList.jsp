...
<%
	...
	{
		ls_sql="SELECT bj_jzbjb1.xmbh,bj_jzbjb1.xmmc,jdm_jldwbm.jldwmc,bj_jzbjb1.bj,smmc";
		...
		ls_sql="SELECT bj_jzbjb.xmbh,bj_jzbjb.xmmc,jdm_jldwbm.jldwmc,bj_jzbjb.bj,smmc";
...
<%
	...
	if (bjtyMark.compareTo("0")>0)//已停用，从表[bj_jzbjb1]取数据而非表[bj_jzbjb]
	{
		ls_sql="SELECT dqbm,bj_jzbjb1.xmbh as xmbh,bj_jzbjb1.xmmc,smmc,jdm_jldwbm.jldwmc,bj_jzbjb1.bj";
...
//设置显示列
	String[] disColName={"xmbh","xmmc","jldwmc","bj","smmc"};
