...
<form method="post" action="SaveLrFjGcl3.jsp" name="editform" >
  <div align="center"><B><font color="#FF0000">增减工程量，减项为负数（位置：<%=jgwzbm%>）</font></B>         
<table border="1" cellspacing="0" cellpadding="1" width="100%" style='FONT-SIZE: 12px'>
	<tr bgcolor="#CCCCCC"  align="center"> 
		<td width="3%">序号</td>
		<td width="10%">增减工程量</td>
		<td width="7%">原工程量</td>
		<td width="12%">项目编号</td>
		<td width="35%">项目名称</td>
		<td width="8%">计量单位</td>
		<td width="8%">单价</td>
		<td width="8%">是否必选项</td>
		<td width="13%">项目有效期</td>
	</tr>
<%
	int row=0;
	String bgcolor=null;
	ls_sql="select xh,dqbm,xmbh,xmmc,xmdlbm,xmxlbm,smbm,jldwmc,zqdj,DECODE(bjlx,'1','标准项目','2','自定义项目') bjlx,bjjbmc bjjb,DECODE(bj_bjxmmxh.sfbxx,'1','必报项','2','必列项','3','可选项','9','作废项') sfbxx,zdyxmyxq";
	...
	while (rs.next())
	{
		...
		%>
			<td><%=zjqslStr%>
				<input type="hidden" name="ysl" size="8" value="<%=zjqslStr%>" >
			</td>
