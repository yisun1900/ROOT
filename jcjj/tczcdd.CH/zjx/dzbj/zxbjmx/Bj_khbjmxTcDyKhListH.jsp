...
//	String xmbh =null;
	String sfxzsl =null;
	double bzsl=0;
	ls_sql="SELECT bj_khgcxmxjh.xmbh,bj_khgcxmxjh.bzsl,bj_khgcxmxjh.sfxzsl";
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	while (rs1.next())
	{
		...
		String tcnxmbz=null;
		double zqdj=0;
		ls_sql="SELECT bj_bjxmmxh.tcnxmbz,bj_bjxmmxh.xh xh,bj_bjxmmxh.xmbh,xmmc,bj_bjxmmxh.zqdj,jldwmc,bj_gclmxh.sl,bj_gclmxh.sl*bj_bjxmmxh.zqdj as je,gycl,bj_bjxmmxh.flmcgg,bj_bjxmmxh.bz";
	...
	double zqdj=0;
	ls_sql="select bj_bjxmmxh.xmbh,bj_bjxmmxh.xmmc,bj_bjxmmxh.xmmc,jldwmc,bj_bjxmmxh.zqdj,bj_khgcxmxjh.bzsl,bj_khgcxmxjh.sjsl,bj_khgcxmxjh.xjjsl";
	ls_sql+=" from  bj_khgcxmxjh,bj_bjxmmxh,jdm_jldwbm";
	ls_sql+=" where bj_khgcxmxjh.zjxxh=bj_bjxmmxh.zjxxh and bj_khgcxmxjh.xmbh=bj_bjxmmxh.xmbh ";
	ls_sql+=" and bj_bjxmmxh.jldwbm=jdm_jldwbm.jldwbm ";
	ls_sql+=" and bj_khgcxmxjh.xjjsl>0 and bj_khgcxmxjh.tcnxmbz='Y'";
	ls_sql+=" and bj_khgcxmxjh.zjxxh='"+zjxxh+"' and bj_khgcxmxjh.sfxzsl='1'";//1：可增项；2：不可增项；3：不控制
