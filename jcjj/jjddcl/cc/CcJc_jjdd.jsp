...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">家具初测（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
*/
	FormName.action="SaveCcJc_jjdd.jsp";
	FormName.submit();
...
function f_lrmm(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_jjccdmxMain.jsp";
	FormName.submit();
	return true;
}
...
function f_ckmm(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_jjccdmxList.jsp";
	FormName.submit();
	return true;
}
function f_lrwj(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="InsertJc_jjwjccdmx.jsp";
	FormName.submit();
	return true;
}
...
function f_ckwj(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_jjwjccdmxList.jsp";
	FormName.submit();
	return true;
}
function f_lrbl(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="InsertJc_jjdqccdmx.jsp";
	FormName.submit();
	return true;
}
...
function f_ckbl(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jc_jjdqccdmxList.jsp";
	FormName.submit();
	return true;
}
//-->
