...
<form method="post" action="Jc_jjddXgQdsjList.jsp" name="selectform">
      <div align="center">家具订单处理--修改安装时间</div>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                协商安装时间录入人              </td>
              <td width="31%"> 
                <input type="text" name="jc_jjdd_kazsjlrr" size="20" maxlength="20" >              </td>
              <td width="19%" align="right"> 
                录入部门              </td>
              <td width="31%"> 
