...
try {
	...
	ls_sql="select khbh,jjsjs,pdgc,xcmgc,jc_jjdd.pgcr,jc_jjdd.pgcsj,jc_jjdd.pgcsm,fgsbh,khbh,htze,wdzje,fkfs,jjzkl,dzyy";
	ls_sql+=" from  jc_jjdd";
	...
	ls_sql+=" where khbh='"+khbh+"' and ddbh='"+ddbh+"' and scbz='N' and fklxbm='24'";//24:家具款
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">家具订单处理--派工厂（订单编号：<%=ddbh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right" bgcolor="#FFFFFF">家具工厂</td>
              <td width="33%"> 
