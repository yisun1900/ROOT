...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.pgcsj,jc_jjdd.pgcr,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.pgcsm,TO_CHAR(jc_jjdd.jjzkl) jjzkl,jc_jjdd.dzyy,jc_jjdd.htze,jc_jjdd.wdzje,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.khbh,crm_khxx.sjs,cxhdbm ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.pgcsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgPgcList.jsp","","","XgPdJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeletePdJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--派工厂</font></B>
</CENTER>
<%
	pageObj.out=out;
