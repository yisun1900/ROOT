...
<div align="center">家具订单处理--修改延迟处理（订单编号：<%=ddbh%>）</div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#CCCCFF" width="19%"><span class="STYLE1">协商安装时间</span></td>
      <td bgcolor="#CCCCFF" width="31%"><%=kazsj%></td>
      <td align="right" bgcolor="#CCCCFF" width="18%"><span class="STYLE1">合同安装时间</span></td>
      <td bgcolor="#CCCCFF" width="32%"><%=jhazrq%></td>
    </tr>
    <tr bgcolor="#E8E8FF">
      <td align="right" bgcolor="#CCCCFF" width="19%"><span class="STYLE1">发安装通知人</span></td>
      <td bgcolor="#CCCCFF" width="31%"><%=aztzr%></td>
      <td align="right" bgcolor="#CCCCFF" width="18%"><span class="STYLE1">发安装通知时间</span></td>
      <td bgcolor="#CCCCFF" width="32%"><%=aztzsj%></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#CCCCFF" width="19%">安装开始时间</td>
      <td bgcolor="#CCCCFF" width="31%"><%=ksazsj%></td>
      <td align="right" bgcolor="#CCCCFF" width="18%">安装完成时间</td>
      <td bgcolor="#CCCCFF" width="32%"><%=sazrq%></td>
    </tr>
    <tr bgcolor="#CCCCFF">
      <td align="right" bgcolor="#CCCCFF" width="19%"> 延迟原因</td>
      <td bgcolor="#CCCCFF" width="31%"><%
	cf.selectItem(out,"select mmycyybm,mmycyymc from jdm_mmycyybm order by mmycyybm",ycyybm,true);
%> </td>
      <td align="right" bgcolor="#CCCCFF" width="18%"> 延迟处理状态</td>
      <td bgcolor="#CCCCFF" width="32%"><%
	cf.radioToken(out, "1+延迟未核实&2+延迟原因属实&3+延迟原因不属实",ycclzt,true);
%> </td>
    </tr>
    <tr bgcolor="#CCCCFF">
      <td align="right" bgcolor="#CCCCFF" width="19%">安装说明</td>
...
%> 
    ...
    <tr bgcolor="#E8E8FF">
      <td align="right" width="19%">否支付违约金</td>
      <td width="31%"> <%
	cf.radioToken(out,"sfxwyj","Y+需要&N+不需要",sfxwyj);
%> </td>
      <td bgcolor="#E8E8FF" align="right" width="18%">违约金</td>
      <td width="32%">
<input type="text" name="wyj" size="20" maxlength="10" value="<%=wyj%>" ></td>
    </tr>
    <tr bgcolor="#E8E8FF">
      <td align="right" width="19%">解决方案</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgHsJc_jjdd.jsp";
	FormName.submit();
	return true;
}
