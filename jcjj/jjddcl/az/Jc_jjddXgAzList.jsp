...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String jc_jjdd_ksazsj=null;
	jc_jjdd_ksazsj=request.getParameter("jc_jjdd_ksazsj");
	if (jc_jjdd_ksazsj!=null)
	{
		jc_jjdd_ksazsj=jc_jjdd_ksazsj.trim();
		if (!(jc_jjdd_ksazsj.equals("")))	wheresql+="  and (jc_jjdd.ksazsj>=TO_DATE('"+jc_jjdd_ksazsj+"','YYYY/MM/DD'))";
	}
	jc_jjdd_ksazsj=request.getParameter("jc_jjdd_ksazsj2");
	if (jc_jjdd_ksazsj!=null)
	{
		jc_jjdd_ksazsj=jc_jjdd_ksazsj.trim();
		if (!(jc_jjdd_ksazsj.equals("")))	wheresql+="  and (jc_jjdd.ksazsj<=TO_DATE('"+jc_jjdd_ksazsj+"','YYYY/MM/DD'))";
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,crm_khxx.khxm,crm_khxx.fwdz,jc_jjdd.pdgcmc,jc_jjdd.xcmgcmc,jc_jjdd.kazsj,jc_jjdd.jhazrq,jc_jjdd.ksazsj,jc_jjdd.sazrq,mmycyymc,clgw,jc_jjdd.ztjjgw,jc_jjdd.xmzy,jc_jjdd.jjsjs,jc_jjdd.khbh  ";
	ls_sql+=" FROM jc_jjdd,jdm_jjddzt,crm_khxx,jdm_mmycyybm";
    ls_sql+=" where jc_jjdd.khbh=crm_khxx.khbh(+) and jc_jjdd.clzt=jdm_jjddzt.clzt(+)";
    ls_sql+=" and jc_jjdd.ycyybm=jdm_mmycyybm.mmycyybm(+)";
	ls_sql+=" and jc_jjdd.clzt in('31','33') ";
	ls_sql+=" and jc_jjdd.ycclzt in('0','1')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.clzt,jc_jjdd.ksazsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgAzList.jsp","","","XgAzJc_jjdd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteAzJc_jjdd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">家具订单处理--修改安装</font></B>
</CENTER>
<%
	pageObj.out=out;
