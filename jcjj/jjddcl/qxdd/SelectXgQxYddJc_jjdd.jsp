...
<form method="post" action="Jc_jjddXgQxYddList.jsp" name="selectform">
      <div align="center">家具订单处理--修改取消预订单
	  </div>
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="31%"> 
                <input type="text" name="jhazrq" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
                <input type="text" name="jhazrq2" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">协商安装时间 从</td>
              <td><input name="kazsj" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
              <td align="right">到</td>
              <td><input name="kazsj2" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">              </td>
            </tr>
            
            <tr bgcolor="#FFFFCC"> 
              <td width="19%" align="right">取消预订单时间 从</td>
              <td width="31%"> 
                <input type="text" name="tdsj" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
                <input type="text" name="tdsj2" size="20" maxlength="10"  value=""  onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.tdsj, "取消预订单时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tdsj2, "取消预订单时间"))) {
		return false;
	}
