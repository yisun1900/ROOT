...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_jjdd.ddbh,clztmc,jc_jjdd.pdsj,crm_khxx.khxm khxm,crm_khxx.fwdz,jc_jjdd.jjsjs,jc_jjdd.xmzy,jc_jjdd.clgw,jc_jjdd.ztjjgw,jc_jjdd.lrsj,jc_jjdd.lrr,sq_dwxx.dwmc,jc_jjdd.khbh,crm_khxx.hth,ysgcjdmc,crm_khxx.sjs,cxhdbm ";
    ...
    ls_sql+=" and jc_jjdd.clzt not in('00','01','33','35','98','99')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by jc_jjdd.pdsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_jjddXgPdList.jsp","","","XgPdJc_cgdd.jsp");
...
<CENTER >
  <B><font size="3">家具订单处理--修改设计师</font></B>
</CENTER>
<%
	pageObj.out=out;
