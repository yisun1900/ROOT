...
try {
	...
	ls_sql="select cpjjbh,cpjjfg,cpjjmc,xh,gg,cpjjxl,cpjjcz,bzdj,sl,zqzj,zj,cpsm,bz,cpjjhs,cpbz ";
	ls_sql+=" from  jc_cpjjddmx";
	ls_sql+=" where  (ddbh='"+whereddbh+"') and  (cpjjbh='"+wherecpjjbh+"')  ";
	...
	ls_sql+=" where jc_jjdd.fgsbh=sq_dwxx.dwbh and jc_jjdd.ddbh='"+whereddbh+"'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
	if (rs.next())
	{
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditJc_cpjjddmx.jsp" name="insertform" target="_blank">
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#FF0000">*</font>型号</td>
      <td width="35%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#FF0000">*</font>材质</td>
      <td width="35%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#0000CC">名称</font></td>
      <td width="35%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#0000CC">风格</font></td>
      <td width="35%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#FF0000">*</font>数量</td>
      <td width="35%"> 
        <input type="text" name="sl" size="20" maxlength="8"  value="<%=sl%>" onchange="f_jszj(insertform)">
      </td>
      <td align="right" width="20%"><font color="#FF0000">*</font><font color="#0000CC">总价</font></td>
      <td width="31%"> 
        <input type="text" name="zj" size="20" maxlength="17"  value="<%=zqzj%>" readonly>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#0000CC">产品说明</font></td>
      <td colspan="3"> 
        <textarea name="cpsm" cols="74" rows="6"><%=cpsm%></textarea>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%"><font color="#0000CC">产品备注</font></td>
      <td colspan="3"> 
        <textarea name="cpbz" cols="74" rows="1"><%=cpbz%></textarea>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="14%">订单备注</td>
      <td colspan="3"> 
