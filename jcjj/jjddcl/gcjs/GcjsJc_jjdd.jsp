...
<table width="100%">
  <tr>
    <td width="100%"> 
        <div align="center">工厂接收（订单编号：<%=ddbh%>） </div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
          ...
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td colspan="4" align="right" height="51"> 
                <div align="center"> 
                  <input type="button"  value="接收" onClick="f_do(insertform)">
                  <input type="reset" name="Reset" value="重输">
				  <input type="button"  value="接收并打印合同" onClick="f_do1(insertform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveGcjsJc_jjdd.jsp";
	FormName.submit();
	return true;
}
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="GcjsDyJc_jjdd.jsp";
	FormName.submit();
	return true;
}
//-->
