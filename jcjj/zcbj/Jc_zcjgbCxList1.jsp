...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dwbh,jc_zcjgb.zcmc,jc_zcjgb.xh,zclbbm,jc_zcjgb.gg,jc_zcjgb.zcbm,zcysbm,jldwbm,jc_zcjgb.lsj,jc_zcjgb.yhj,cxhdbl||'%',DECODE(sfycx,'N','无','Y','<font color=\"#FF0000\">有促销</font>'),cxkssj,cxjzsj,cxj,lscxhdbl||'%',DECODE(jc_zcjgb.sfbhpj,'Y','<font color=\"#FF0000\">含</font>','N','不含'),jc_zcjgb.pjts,DECODE(sfyh,'Y','有货','N','<font color=\"#FF0000\">无货</font>'),jc_zcjgb.cpjb,jc_zcjgb.fgsx,jc_zcjgb.cpsm,jc_zcjgb.cd,jc_zcjgb.zp,jc_zcjgb.lrr,jc_zcjgb.lrsj,jc_zcjgb.bz,ppmc,gys,zcxlbm,zcdlbm";
