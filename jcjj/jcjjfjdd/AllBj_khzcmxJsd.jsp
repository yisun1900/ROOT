...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2" align="center" class="STYLE2" ><B>客户主材明细
      <input type="button" value="导入" onclick="window.open('LoadData.jsp?khbh=<%=khbh%>')">
      <input type="button" value="导出" onclick="window.open('expZc.jsp?khbh=<%=khbh%>')">
    </B></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td   >客户姓名：<%=khxm%></td>
