...
String bgcolor="";
	...
	ls_sql="SELECT zcpzwzbm,xh,zcdlbm,zcxlbm,zcbm,zcmc,ppbm,xinghao,gg,zcysbm,jldwbm,zqdj,dpzk,zqdj,dpzk,dj,cbj,sl,ycf,DECODE(qtfy,'1','安装费','2','加工费','3','其它收费','W','无') qtfy,qtfyje";
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveAllBj_khzcmxJsjEdit.jsp";
	FormName.submit();
	return true;
}
