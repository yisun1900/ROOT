...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(crm_khxx.fjtcbz,'Y','分解','N','未分解','M','非套餐'),hth,khxm,fwdz,bjjbmc,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,ysgcjdmc,kgrq,khbh,clgw ";
    ...
    ls_sql+=" and crm_khxx.fjtcbz='N'";//Y：是；N：否；M：非套餐
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","InsertJc_zcdd.jsp","");
...
<CENTER >
  <B><font size="3">生成套餐主材订单</font>
  <P>
  <font color="#FF0000">（注意：如果查不到客户，请做如下检查，1、是否退单；2、是否套餐客户；3、是否已分解；4、是否完工）</font></B>
</CENTER>
<%
	pageObj.out=out;
