...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(jc_zcjgb.sftjcp,'Y','是','N','否'),jc_zcjgb.zcbm,jc_zcjgb.zcmc,zclbbm,jc_zcjgb.xh,jc_zcjgb.gg,zcysbm,jldwbm,jc_zcjgb.lsj,jc_zcjgb.yhj,cxhdbl||'%',DECODE(sfyh,'Y','有货','N','<font color=\"#FF0000\">无货</font>'),DECODE(sfycx,'N','无','Y','<font color=\"#FF0000\">有促销</font>'),cxj,lscxhdbl||'%',cxkssj,cxjzsj,DECODE(jc_zcjgb.sfbhpj,'Y','<font color=\"#FF0000\">包含</font>','N','否'),jc_zcjgb.pjts,jc_zcjgb.bz,jc_zcjgb.ppmc,jc_zcjgb.gys";
