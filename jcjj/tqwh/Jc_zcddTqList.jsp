...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcddTqList.jsp","","","TqEditJc_zcdd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除选中的信息","批量修改供应商","批量修改材料员","批量修改订单类型"};//按钮的显示名称
	String[] buttonLink={"DeleteTqJc_zcdd.jsp","plxgGys.jsp","plxgClgw.jsp","plxgDdlx.jsp"};//按钮单击调用的网页，可以增加参数
