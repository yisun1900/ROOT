...
try {
	...
	ls_sql="select sfjs,tjpclf,zcpclf,xshth,jmje,dzyy,lrsj,sfyyh,yhkssj,yhjzsj,yhnr,zczkl,jjsjs,htcxhdje,wdzje,zqclf,ycf,qtf,zcdlbm,zcxlbm,ppbm,khbh,clgw,ztjjgw,jkxz,jkdd,ddshbz,kjxsj,xclbz,htshsj,xmzy,qhtsj,jhclsj,bz,hkze,jhtzshsj,clgw";
	ls_sql+=" from  jc_zcdd";
...
<body bgcolor="#FFFFFF">
	...
	<%
		...
		ls_sql="SELECT jc_zcdd.ddbh,clztmc,ppbm,jc_zcdd.clgw,jc_zcdd.xshth,jc_zcdd.zqclf,jc_zcdd.qtf,jc_zcdd.ycf,jc_zcdd.wdzje,jc_zcdd.lrsj,jc_zcdd.lrr";
