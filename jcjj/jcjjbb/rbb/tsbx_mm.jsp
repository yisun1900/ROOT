...
<table width="100%" border="0">
 ...
 <tr align="right">
    <td><div align="left">木业类问题</div></td>
  </tr>
...
<%
    ...
    ls_sql+=" where crm_tsjl.tslxbm=dm_tslxbm.tslxbm and crm_tsjl.tslxbm='33' and b.dwbh=crm_tsjl.dwbh and crm_tsjl.tsyybm=dm_tsyybm.tsyybm and slbm='FBJ13' and crm_tsclqk.tsjlh=crm_tsjl.tsjlh and crm_tspp.tsjlh=crm_tsjl.tsjlh and  a.dwbh=crm_tspp.tspp";
	ls_sql+=wheresql;
    ls_sql+=" order by lx";
    pageObj.sql=ls_sql;
//进行对象初始化
