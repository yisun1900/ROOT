...
<%
	...
	ls_sql="SELECT yddbh,jc_mmydd.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.jgrq,DECODE(jc_mmydd.wjqk,'1','客户自购','2','公司购买') wjqk,jc_mmydd.sqdj,jc_mmydd.clgw,jc_mmydd.xmzy,b.dwmc pdgc,DECODE(jc_mmydd.wjsgsbz,'Y','已送公司','N','未送公司') wjsgsbz,jc_mmydd.htrq,htje,DECODE(jc_mmydd.clzt,'00','录入未完成','01','预订单完成','02','已派单','03','已完成初测','04','签订合同','05','已入库','06','安装完成','99','取消订单') clzt,a.dwmc lrbm ";
	ls_sql+=" from  jc_mmydd,crm_khxx,sq_dwxx a,sq_dwxx b";
	ls_sql+=" where jc_mmydd.dwbh=a.dwbh and jc_mmydd.pdgc=b.dwbh(+)";
	ls_sql+=" and jc_mmydd.khbh=crm_khxx.khbh and jgrq-SYSDATE<10";
	ls_sql+=" and clzt<'05'";
	ls_sql+=wheresql;
...
//设置显示列
	String[] disColName={"yddbh","khxm","hth","jgrq","wjqk","sqdj","clgw","xmzy","pdgc","htrq","htje","wjsgsbz","clzt","lrbm"};
...
<CENTER >
  <B><font size="3">木门入库延期（项目专员：<%=xmzymc%>）</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
