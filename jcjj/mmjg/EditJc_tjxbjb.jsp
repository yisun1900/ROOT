...
try {
	...
	ls_sql="select mmdglxbm,ysbm,dj,dqbm ";
	ls_sql+=" from  jc_tjxbjb";
...
<form method="post" action="SaveEditJc_tjxbjb.jsp" name="editform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <select name="mmdglxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmdglxbm,mmdglxmc from jc_mmdglx where jjfs in('41','42') order by mmdglxbm",mmdglxbm);
%> 
                </select>
              </td>
              <td width="17%"> 
