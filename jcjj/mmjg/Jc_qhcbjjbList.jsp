...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_qhcbjjbList.jsp","SelectJc_qhcbjjb.jsp","","EditJc_qhcbjjb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Jc_qhcbjjbList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from jc_qhcbjjb where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="12%">&nbsp;</td>
	<td  width="27%">木门订购类型</td>
	<td  width="27%">墙厚价格区间</td>
	<td  width="17%">每米加价率</td>
</tr>
<%
	pageObj.printDate();
	pageObj.printFoot();
