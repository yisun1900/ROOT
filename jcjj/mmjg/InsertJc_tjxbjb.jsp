...
<form method="post" action="SaveInsertJc_tjxbjb.jsp" name="insertform" target="_blank">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="34%"> 
                <select name="mmdglxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmdglxbm,mmdglxmc from jc_mmdglx where jjfs in('41','42') order by mmdglxbm","");
%> 
                </select>
              </td>
              <td width="16%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#FF0000">*</font>材质</td>
              <td colspan="3"> 
