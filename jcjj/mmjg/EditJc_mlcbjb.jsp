...
try {
	...
	ls_sql="select mmdglxbm,ysbm,qhjgqjbm,ctdj,csdj,dqbm ";
	ls_sql+=" from  jc_mlcbjb";
	...
	if (rs.next())
	{
		...
		ctdj=cf.fillNull(rs.getString("ctdj"));
		csdj=cf.fillNull(rs.getString("csdj"));
...
<form method="post" action="SaveEditJc_mlcbjb.jsp" name="editform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="mmdglxbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="selectItem(mmdglxbm,qhjgqjbm,<%=str%>)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmdglxbm,mmdglxmc from jc_mmdglx where jjfs in('21','22') order by mmdglxbm",mmdglxbm);
%> 
                </select>
              </td>
              <td width="18%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
                <div align="right"><font color="#FF0000">*</font>材质</div>
              </td>
              <td colspan="3"> 
                <select name="ysbm" style="FONT-SIZE:12PX;WIDTH:513PX">
                  <option value=""></option>
                  <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
                <div align="right"><font color="#FF0000">*</font>窗套每米单价</div>
              </td>
              <td width="32%"> 
                <input type="text" name="ctdj" size="20" maxlength="17"  value="<%=ctdj%>" >
              </td>
              <td width="18%"> 
                <div align="right"><font color="#FF0000">*</font>窗扇每平米单价</div>
              </td>
              <td width="32%"> 
                <input type="text" name="csdj" size="20" maxlength="17"  value="<%=csdj%>" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.ctdj)=="") {
		alert("请输入[窗套每米单价]！");
		FormName.ctdj.focus();
		return false;
	}
	if(!(isFloat(FormName.ctdj, "窗套每米单价"))) {
		return false;
	}
	if(	javaTrim(FormName.csdj)=="") {
		alert("请输入[窗扇每平米单价]！");
		FormName.csdj.focus();
		return false;
	}
	if(!(isFloat(FormName.csdj, "窗扇每平米单价"))) {
		return false;
	}
