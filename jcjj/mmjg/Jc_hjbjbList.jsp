...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_hjbjb.dqbm,jc_hjbjb.mmdglxbm as mmdglxbm,jc_mmdglx.mmdglxmc as jc_mmdglx_mmdglxmc,jc_hjbjb.kdjgqjbm as kdjgqjbm,jdm_kdjgqj.kdjgqj as jdm_kdjgqj_kdjgqj,jc_hjbjb.ysbm as ysbm,mmczmc,jc_hjbjb.dj as jc_hjbjb_dj,jc_hjbjb.lrr,jc_hjbjb.lrsj,dwmc,dqmc  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_hjbjbList.jsp","SelectJc_hjbjb.jsp","","EditJc_hjbjb.jsp");
...
//设置主键
	String[] keyName={"mmdglxbm","dqbm","kdjgqjbm","ysbm"};
	pageObj.setKey(keyName);
//设置按钮参数
	String[] buttonName={"删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"Jc_hjbjbList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from jc_hjbjb where "+chooseitem;
