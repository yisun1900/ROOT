...
<form method="post" action="SaveEditJc_wpclk.jsp" name="editform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="mmdglxbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="selectItem(mmdglxbm,qhjgqjbm,<%=str%>)">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmdglxbm,mmdglxmc from jc_mmdglx where jjfs in('31') order by mmdglxbm",mmdglxbm);
%> 
                </select>
              </td>
              <td width="16%"> 
