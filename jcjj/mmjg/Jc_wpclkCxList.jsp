...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jc_mtbjb.mmdglxbm as mmdglxbm,jc_mmdglx.mmdglxmc as jc_mmdglx_mmdglxmc,jc_mtbjb.ysbm as ysbm,mmczmc,jc_mtbjb.qhjgqjbm as qhjgqjbm,jdm_qhjgqj.qhjgqj as jdm_qhjgqj_qhjgqj,jc_mtbjb.mmdj as jc_mtbjb_mmdj,yksmjjl,jc_mtbjb.lrr,jc_mtbjb.lrsj,dwmc,dqmc  ";
    ...
    ls_sql+=" and jc_mmdglx.jjfs in('31') ";
    ls_sql+=wheresql;
    ls_sql+=" order by jc_mtbjb.dqbm,jc_mtbjb.mmdglxbm,jc_mtbjb.ysbm,jc_mtbjb.qhjgqjbm";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_wpclkCxList.jsp","SelectCxJc_wpclk.jsp","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="12%">木门订购类型</td>
	<td  width="17%">材质</td>
	<td  width="15%">墙厚价格区间</td>
	<td  width="9%">每米单价</td>
	<td  width="9%">松木集成材加价率</td>
	<td  width="7%">录入人</td>
	<td  width="10%">录入时间</td>
	<td  width="13%">录入部门</td>
	<td  width="7%">所属地区</td>
