...
<form method="post" action="SaveInsertJc_mlcbjb.jsp" name="insertform" target="_blank">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="text" name="ctdj" value="" size="20" maxlength="17" >
              </td>
              <td width="16%"> 
                <div align="right"><font color="#FF0000">*</font>窗扇每平米单价</div>
              </td>
              <td width="34%"> 
                <input type="text" name="csdj" value="" size="20" maxlength="17" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%"> 
