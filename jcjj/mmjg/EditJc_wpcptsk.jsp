...
<form method="post" action="SaveEditJc_wpcptsk.jsp" name="editform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <select name="mmdglxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select mmdglxbm,mmdglxmc from jc_mmdglx where jjfs in('32') order by mmdglxbm",mmdglxbm);
%> 
                </select>
              </td>
              <td width="17%"> 
