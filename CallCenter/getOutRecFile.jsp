...
<body bgcolor="#FFFFFF">
<form method="post" action="RecOutFileCxList.jsp" name="selectform">
<div align="center">查找去电录音文件</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="call_qdjl_lrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">所属分公司</td> 
  <td width="32%">
  <select name="call_qdjl_ssfgs" style="FONT-SIZE:12PX;WIDTH:152PX">
        <%
			if (kfgssq.equals("2"))//0：不授权；1：授权单个分公司；2：授权多个分公司；3：授权单个店面；4：授权某一分公司多个店面；5：授权多个分公司多个店面
			{
				out.println("<option value=\"\"></option>");
