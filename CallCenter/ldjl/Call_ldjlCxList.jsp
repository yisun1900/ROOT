...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT call_ldjl.xh,call_ldjl.ldsj,call_ldjl.ldhm,dm_ldlxbm.ldlxmc,DECODE(call_ldjl.khlx,'1','咨询','2','签单','3','未知'),DECODE(call_ldjl.jtzt,'1','未接通','2','接通'),crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.zjxm,sgdmc,call_ldjl.khbh,call_ldjl.bjhm,call_ldjl.lywjml,call_ldjl.lywj,call_ldjl.lrr,call_ldjl.lrsj,a.dwmc lrbm,b.dwmc ssfgs  ";
