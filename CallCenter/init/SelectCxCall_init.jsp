...
<body bgcolor="#FFFFFF">
<form method="post" action="Call_initCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">本机号码</td> 
  <td width="35%"> 
    <input type="text" name="call_init_bjhm" size="20" maxlength="30" >
  </td>
  <td align="right" width="15%">Mac地址</td> 
  <td width="35%"> 
    <input type="text" name="call_init_mac" size="20" maxlength="30" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">用户编码</td> 
  <td width="35%"> 
    <input type="text" name="call_init_yhbm" size="20" maxlength="30" >
  </td>
  <td align="right" width="15%">所属分公司</td> 
  <td width="35%"><select name="call_init_ssfgs" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">录音文件目录</td> 
  <td width="35%"> 
