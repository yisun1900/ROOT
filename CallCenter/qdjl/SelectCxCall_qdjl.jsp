...
<body bgcolor="#FFFFFF">
<form method="post" action="Call_qdjlCxList.jsp" name="selectform">
<div align="center">去电记录－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <td width="32%"> 
    <input type="text" name="call_qdjl_xh" size="20" maxlength="16" >  </td>
  <td align="right" width="18%">去电类型</td> 
  <td width="32%"><select name="call_qdjl_ldlxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  <td align="right">去电时间 从</td>
  <td><input type="text" name="call_qdjl_ldsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="call_qdjl_ldsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">去电号码</td> 
  <td width="32%"> 
    <input type="text" name="call_qdjl_ldhm" size="20" maxlength="30" >  </td>
  <td align="right" width="18%">本机号码</td> 
  <td width="32%"><input type="text" name="call_qdjl_bjhm" size="20" maxlength="30" ></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录音文件目录</td> 
  <td width="32%"> 
    <input type="text" name="call_qdjl_lywjml" size="20" maxlength="100" >  </td>
  <td align="right" width="18%">录音文件</td> 
  <td width="32%"> 
    <input type="text" name="call_qdjl_lywj" size="20" maxlength="100" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入人</td>
  <td><input type="text" name="call_qdjl_lrr" size="20" maxlength="20" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
    <input type="radio" name="khlx" value="1">咨询
    <input type="radio" name="khlx" value="2">签单
    <input type="radio" name="khlx" value="3">未知
  </td>
  <td align="right" width="18%">接通状态</td> 
  <td width="32%"><input type="radio" name="jtzt" value="1">
    未接通
      <input type="radio" name="jtzt" value="2">
      接通</td>
</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.call_qdjl_xh, "序号"))) {
		return false;
	}
	if(!(isDatetime(FormName.call_qdjl_ldsj, "去电时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.call_qdjl_ldsj2, "去电时间"))) {
		return false;
	}
