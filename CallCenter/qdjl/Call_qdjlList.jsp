...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT call_qdjl.xh,call_qdjl.ldsj,call_qdjl.ldhm,dm_ldlxbm.ldlxmc,call_qdjl.lywj,call_qdjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.zjxm,sgdmc,call_qdjl.bjhm,call_qdjl.lywjml,call_qdjl.lrr,call_qdjl.lrsj,a.dwmc lrbm,b.dwmc ssfgs  ";
...
//进行对象初始化
	pageObj.initPage("Call_qdjlList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"Call_qdjlList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from call_qdjl where "+chooseitem;
