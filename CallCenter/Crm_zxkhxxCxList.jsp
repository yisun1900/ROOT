...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过') as zxzt,crm_zxkhxx.fwdz,dwmc zxdm,sjs,lrsj,'<A href=# onclick=\"window.opener.outnum.value='''||crm_khlxfs.dhhm||''';window.close();\">获取</A>'  tly,DECODE(crm_khlxfs.lx,'1','手机','2','座机','3','小灵通'),crm_khlxfs.dhhm  ";
	ls_sql+=" FROM crm_zxkhxx,sq_dwxx,crm_khlxfs";
    ls_sql+=" where crm_zxkhxx.khbh=crm_khlxfs.khbh ";
    ls_sql+=" and crm_zxkhxx.zxdm=sq_dwxx.dwbh and zxzt in('1','2','5')";
...
//设置显示合并列
	...
	spanColHash.put("zxzt","1");//列参数对象加入Hash表
