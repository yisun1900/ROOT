...
//		alert("来电:"+khxm.value+"－"+innum.value);
		...
		filename.value="<%=cf.replace(lywjml,"\\","\\\\")%>\\"+"in-"+xh.value+"-"+khbh.value+"-"+khxxArr[2]+".wav";
		playfile.value="<%=cf.replace(lywjml,"\\","\\\\")%>\\"+"in-"+xh.value+"-"+khbh.value+"-"+khxxArr[2]+".wav";
	}
	else if (czlx=="2")
	{
		//去除前面的换行符
		...
		filename.value="<%=cf.replace(lywjml,"\\","\\\\")%>\\"+"out-"+xh.value+"-"+khbh.value+"-"+khxxArr[2]+".wav";
		playfile.value="<%=cf.replace(lywjml,"\\","\\\\")%>\\"+"out-"+xh.value+"-"+khbh.value+"-"+khxxArr[2]+".wav";
