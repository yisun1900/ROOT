...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT yzf_hjzx.xh, DECODE(yzf_hjzx.clzt,'1','未处理','2','处理','9','不需处理'),yzf_hjzx.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.zjxm,sjjgrq,a.dwmc dm,yzf_hjzx.fywt,yzf_hjzx.hfjg,yzf_hjzx.clfs,yzf_hjzx.hfbm,yzf_hjzx.hfsj,yzf_hjzx.zxy,yzf_hjzx.zxz,yzf_hjzx.xgbmclqk,yzf_hjzx.clr,yzf_hjzx.clsj,yzf_hjzx.zdy,yzf_hjzx.lrr,yzf_hjzx.lrsj,b.dwmc lrbm  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Yzf_hjzxCxList.jsp","","","");
