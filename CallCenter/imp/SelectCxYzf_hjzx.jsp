...
<body bgcolor="#FFFFFF">
<form method="post" action="Yzf_hjzxCxList.jsp" name="selectform">
<div align="center">查询回访结果</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">自动编号</td> 
  <td width="32%"> 
    <input type="text" name="xh" size="20" maxlength="8" >  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">回访结果</td> 
  <td width="32%"> 
    <input type="text" name="hfjg" size="20" maxlength="18" >  </td>
  <td align="right" width="18%">处理方式</td> 
  <td width="32%"> 
    <input type="text" name="clfs" size="20" maxlength="18" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">回访部门</td> 
  <td width="32%"> 
    <input type="text" name="hfbm" size="20" maxlength="18" >  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">座席员</td>
  <td><input type="text" name="zxy" size="20" maxlength="18" >  </td>
  <td align="right">座席组</td>
  <td><input type="text" name="zxz" size="20" maxlength="18" >  </td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">自定义</td> 
  <td width="32%"> 
    <input type="text" name="zdy" size="20" maxlength="18" >  </td>
  <td align="right" width="18%">处理状态</td> 
  <td width="32%"> 
    <INPUT type="radio" name="clzt" value="1">未处理
    <INPUT type="radio" name="clzt" value="2">处理
    <INPUT type="radio" name="clzt" value="9">不需处理
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">处理人</td> 
  <td width="32%"><input type="text" name="clr" size="20" maxlength="20" ></td></tr>
<tr bgcolor="#FFFFFF">
  <td align="right">回访时间 从</td>
