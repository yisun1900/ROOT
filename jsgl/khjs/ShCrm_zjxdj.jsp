...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">工程扣款审核（增减项序号：<%=zjxxh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%"><font color="#0000CC">未打折工程额</font></td>
...
function f_dybj(FormName)//参数FormName:Form的名称
{
	...
	if ("<%=jzbz%>"=="1")
	{
		FormName.action="/jsgl/khjs/dzbj/zxbjmx/Bj_khbjmxJsList.jsp?dqbm=<%=dqbm%>";
	}
	else{
		FormName.action="/jsgl/khjs/dzbj/zxbjmx/Bj_khbjmxJsList.jsp?dqbm=<%=dqbm%>";
	}
