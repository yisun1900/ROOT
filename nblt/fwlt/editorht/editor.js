		...
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 621px;'>\
				...
				<div style='height: 200px; background-image: url(images/editor/guage.gif); padding-left: 39px; width: 582px!important ; width: 621px;' id='EDiaryEditorContent'>\
					<iframe id='editor_body_area' name='editor_body_area' style='width: 502px; height: 200px; border-width: 0px; overflow-x: atuo; display: nones;' frameborder='0'></iframe>\
					<textarea id='editor_body_textarea' name='editor_body' style='width: 500px; height: 202px; border-width: 0px; padding-top:8px; display: none;'></textarea>\
