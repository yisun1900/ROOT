...
<table style="word-break:break-all;word-wrap:break-word" width="98%" id="table2" border=0 cellpadding=0 cellspacing=1 bgcolor="#BBE9FF">
	...
	<td width="550px"><span style="FONT-SIZE:14">[优铂利论坛系统]</span></td>
...
<table style="word-break:break-all;word-wrap:break-word" width="98%" id="table2" border=0 cellpadding=0 cellspacing=1 bgcolor="#BBE9FF">
  <tr>
	...
	<DIV width="30px"><span style="FONT-SIZE:12" width="30px">&nbsp;&nbsp;&nbsp;小提示：您可以复制上面的内容到下面的编辑框，进行编辑。</b></span></div>
	</td>
    <td bgcolor="#FFFFFF"><div id="div3">
	<table style="word-break:break-all;word-wrap:break-word" width="95%">
	<tr>
	<td align="left"><span style="FONT-SIZE:12">回复于：<%=hfsj%></span></td>
	<td align="right"><span style="FONT-SIZE:12" ><%=wherelch%>楼</span></td>
	</tr>
	</table>
	</DIV></td>
  </tr>
...
<table style="word-break:break-all;word-wrap:break-word" width="98%" id="table2" border=0 cellpadding=0 cellspacing=1 bgcolor="#BBE9FF">
  <tr>
	...
	<div id="div0">
		<span style="FONT-SIZE:14"><b>编辑帖子</b></span>
</DIV>
</td>
  </tr>
  <tr>
