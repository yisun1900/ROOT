	...
	initView: function (sParentID) {
		...
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 621px;'>\
				<div id='EDiaryEditorToolBar' style='position: relative; width: 761px; height: 69px; background-image: url(images/editor/toolbar_bg.gif);'>\
				...
				<div style='width: 761px; height: 25px; background-image: url(images/editor/title_bg.gif);'>\
				</div>\
				<div style='height: 200px; background-image: url(images/editor/guage.gif); padding-left: 39px; width: 782px!important ; width: 761px;' id='EDiaryEditorContent'>\
					<iframe id='editor_body_area' name='editor_body_area' style='width: 722px; height: 400px; border-width: 0px; overflow-x: atuo; display: nones;' frameborder='0'></iframe>\
					<textarea id='editor_body_textarea' name='editor_body' style='width: 500px; height: 302px; border-width: 0px; padding-top:8px; display: none;'></textarea>\
					<input type='hidden' name='char_count' value='-1' id='EDiaryEditorStrLen'>\
				</div>\
				<div style='width: 761px; height: 59px; background-image: url(images/editor/editor_foot.gif)'>\
