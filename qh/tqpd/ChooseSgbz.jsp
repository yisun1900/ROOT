...
<html>
<head>
<title>查询班组在施工程</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>

<body bgcolor="#FFFFFF">
<form method="post" action="Crm_khxxBzList.jsp" name="insertform">
  <table width="100%" border="0">
    <tr> 
      <td colspan="2" height="75"> 
        <div align="center">查询班组在施工程</div>
      </td>
    </tr>
    <tr> 
...
%> 
    ...
    <tr> 
      <td width="43%" align="right" height="40">施工班组</td>
      <td width="57%" height="40">
		<input name="sgbz" type="text" value="" maxlength="20" size="20">
      </td>
    </tr>
    <tr> 
