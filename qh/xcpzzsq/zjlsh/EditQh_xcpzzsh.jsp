...
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
    <div align="right">审核单位代码</div>
  </td>
  <td width="35%"> 
<%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx order by dwbh",qh_xcpzzsh_shdwbh,true);
%>
  </td>
  <td width="15%"> 
...
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
    <div align="right">总经理经理意见</div>
  </td>
  <td width="85%" colspan="3"> 
    <font color="#FF0000"> 
    <textarea name="zjlyj" cols="72" rows="3"></textarea>
    </font>
  </td>
</tr>
...
if(	javaTrim(FormName.zjlyj)=="") {
		alert("请输入[总经理审核意见]！");
		FormName.zjlyj.focus();
		return false;
	}		
