...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT qh_mtjk.jkbbh,qh_bjkgsdm.bjkgsmc,dm_xxlybm.xxlymc,to_char(qh_mtjk.bcsj,'YYYY-MM-DD')||'('||decode(to_char(qh_mtjk.bcsj,'D'),'1','周日','2','周一','3','周二','4','周三','5','周四','6','周五','7','周六','星期八')||')',qh_mtjk.gggs,qh_mtjk.yjjg,sq_dwxx.dwmc,qh_mtjk.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Qh_mtjkList.jsp","SelectQh_mtjk.jsp","","EditQh_mtjk.jsp");
