...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh khbh,crm_khxx.khxm,crm_khxx.fwdz,qye,TO_CHAR(pmjj) pmjj,qyrq,kgrq,DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单') hdbz,crm_khxx.sjs,a.dwmc sqdm,crm_khxx.sgd,sgdmc,crm_khxx.sgbz,DECODE(pdclzt,'1','申请派单','2','派单','3','拒绝派单','4','接受派单','5','保持原派','6','同意改派') pdclzt,DECODE(pd_pdjl.sfhs,'Y','核实','N','未核实') sfhs";
...
//进行对象初始化
	pageObj.initPage("Pd_pdjlSpList.jsp","SelectSpPd_pdjl.jsp","","SpPd_pdjl.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数
//设置显示列
	String[] disColName={"khbh","pdclzt","sfhs","sgdmc","sgbz","khxm","fwdz","qye","pmjj","hdbz","sjs","sqdm","qyrq","kgrq"};
