...
%></font></td>
            ...
            <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right">选择施工队</td>
              <td colspan="3" bgcolor="#FFFFCC"> 

				<INPUT type="radio" name="xzsgdjb" value="1" onClick="getSgd(editform)">
				一级队
				<INPUT type="radio" name="xzsgdjb" value="2" onClick="getSgd(editform)">
				二级队
				<INPUT type="radio" name="xzsgdjb" value="3" onClick="getSgd(editform)">
				三级队
                <input type="radio" name="xzsgdjb" value="DJ" onClick="getSgd(editform)">
                优选低级队 
                <input type="radio" name="xzsgdjb" value="GJ" onClick="getSgd(editform)">
                优选高级队
                <input type="radio" name="xzsgdjb" value="" checked onClick="getSgd(editform)">
                不受限制</td>
            </tr>
            <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right">小区名称</td>
              <td colspan="3" bgcolor="#FFFFCC"> 
                <input type="text" name="yxxq" size="24" maxlength="100"  value="" >
                （<font color="#FF0033"><b>若本小区有在施工地，则优先选择该施工队</b></font>） </td>
            </tr>
            <tr> 
              ...
              <td width="31%" bgcolor="#FFFFCC"> 
                <select name="jlbz" style="FONT-SIZE:12PX;WIDTH:180PX" onChange="getSgd(editform)">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"0+正常派单&5+大单抵小单&6+小单抵大单&1+回单奖励&2+公司奖励&3+设计师指定派单&4+客户指定派单",jlbz);
%> 
                </select>
              </td>
            ...
            <tr> 
              ...
              <td colspan="3" bgcolor="#FFFFCC"> 
                <select name="sgd" style="FONT-SIZE:12PX;WIDTH:630PX" onChange="selectItem(sgd,sgbz,<%=str1%>)" >
                  <option value=""></option>
                  <%
%> 
                </select>
            ...
            <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right">施工班长</td>
              <td width="31%" bgcolor="#FFFFCC"> 
...
function getSgd(FormName)
{
	...
	var str="SgdCx.jsp?khbh=<%=wherekhbh%>&cqbm=<%=cqbm%>&deflbm=<%=deflbm%>&sgd=<%=sgd%>&ssfgs=<%=ssfgs%>&kpjlh=<%=kpjlh%>&jlbz="+FormName.jlbz.value+"&yxxq="+FormName.yxxq.value+"&xzsgdjb="+getRadio(FormName.xzsgdjb);
