...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,qye,DECODE(pdclzt,'1','申请派单','2','派单','3','拒绝派单','4','接受','5','保持原派','6','同意改派')";
	ls_sql+=" ,sgdmc sgd,sgbz,DECODE(jlbz,'0','正常派单','1','回单奖励','2','公司奖励','3','设计师指定派单','4','客户指定派单','5','大单抵小单','6','小单抵大单'),pdsm,pdsj,pdr,DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单','4','老客户回单','5','员工回单','6','班长回单','7','售楼处','8','材料商','9','其他'),fwdz";
	ls_sql+=" ,sjs,zjxm,a.dwmc sqdm";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd  ";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)  and zt='2' and (pdsj is not null and pdclzt!='1' or pdclzt='1')";
	ls_sql+=wheresql;
...
//设置列超级连接
	...
	coluParm.link="DyPdCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
