...
<%
	...
	ls_sql="SELECT distinct crm_khxx.khbh khbh,crm_khxx.hth,DECODE(pdclzt,'1','申请派单','2','派单','4','接受派单') pdclzt,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>') kgsjqd,khxm,cqmc,fwdz,crm_khxx.qye,khlxmc";
...
//进行对象初始化
	pageObj.initPage("","","","EditCrm_khxxMain.jsp");
	pageObj.setPageRow(10000);//设置每页显示记录数

//设置显示列
	String[] disColName1={"hth","pdclzt","kgsjqd","khxm","cqmc","fwdz","qye","khlxmc","hdbz","jyjdrq","sjs","sqdm","qyrq","kgrq","sgd"};
