...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,DECODE(pdclzt,'1','申请派单','2','派单','4','不许修改派单') pdclzt,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>') kgsjqd";
	ls_sql+=" ,sgdmc sgd,sgbz,zjxm,DECODE(jlbz,'0','正常派单','1','回单奖励','2','公司奖励','3','设计师指定派单','4','客户指定派单','5','大单抵小单','6','小单抵大单') jlbz,pdsm,pdsj,pdr,jyjdrq,DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单','4','老客户回单','5','员工回单','6','班长回单','7','售楼处','8','材料商','9','其他') hdbz,khxm,fwdz";
	ls_sql+=" ,sjs,a.dwmc sqdm";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd ";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)  and zt='2' and pdsj is not null and gcjdbm!='5' ";
	ls_sql+=wheresql;
    ls_sql+=" order by pdsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgList.jsp","SelectXgCrm_khxx.jsp","","EditCrm_khxxMain.jsp");
//	pageObj.setPageRow(100);//设置每页显示记录数
//设置显示列
	String[] disColName={"hth","khxm","pdclzt","kgsjqd","sgd","sgbz","zjxm","jlbz","pdsm","pdsj","pdr","jyjdrq","hdbz","fwdz","sjs","sqdm"};
