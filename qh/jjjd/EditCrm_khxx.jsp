...
%> 
            ...
            <tr> 
              ...
              <td colspan="3" bgcolor="#FFFFCC"> 
                <select name="sgd" style="FONT-SIZE:12PX;WIDTH:540PX" onChange="selectItem(sgd,sgbz,<%=str1%>)" >
                  <option value=""></option>
                  <%
%> 
                </select>
...
function getSgd(FormName)
{
	...
	var str="SgdCx.jsp?cqbm=<%=cqbm%>&deflbm=<%=deflbm%>&sgd=<%=sgd%>&ssfgs=<%=ssfgs%>&kpjlh=<%=kpjlh%>&jlbz="+FormName.jlbz.value+"&yxxq="+FormName.yxxq.value;
