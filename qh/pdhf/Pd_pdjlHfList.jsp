...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,sgdmc,sgbz,khxm,fwdz,qye,qyrq,kgrq,DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单') hdbz,sjs,zjxm,a.dwmc sqdm,sgd,DECODE(pdclzt,'1','申请派单','2','派单','3','拒绝派单','4','接受派单','5','保持原派') pdclzt";
