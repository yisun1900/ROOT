...
<title>江苏红蚂蚁装饰（集团）企业ERP管理系统</title>
  ...
  <%String cxhdbm = cf.fillNull(request.getParameter("cxhdbm"));  %>
...
finally 
{
  ...
  xcjlh--><%=xcjlh%>   khbh--><%=khbh%>   cxhdbm--><%=cxhdbm%>

  	<form  name="loginform" method="post" action="/jcjj/xcl/Bj_khcxzckList.jsp">
