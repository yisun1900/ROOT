...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditGsjJxc_cljgb.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>分公司价</td>
  <td>
  <input type="text" name="dfgsjg" size="20"   value="<%=dfgsjg%>" >
  </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.dfgsjg, "分公司价"))) {
		return false;
	}
