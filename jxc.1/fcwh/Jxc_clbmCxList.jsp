...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT clxlbm,clbm,nbbm,clmc,xh,gg,jldwbm,bzjldwbm,bzgg,djzl,cgzq,bzq,bztxq,cldlbm,scsmc,ppmc,DECODE(cglb,'J','集团采购','D','地方采购'),lrr,lrsj,dwmc,jxc_clbm.bz ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clbmCxList.jsp","","","");
