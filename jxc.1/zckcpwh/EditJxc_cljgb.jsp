            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="cldlbm" style="FONT-SIZE:12PX;WIDTH:152PX" >
                  <%
	cf.selectItem(out,"select cldlmc c1,cldlmc c2 from jxc_cldlbm where cldllb in('1','3') order by cldlmc",cldlbm);
%> 
                </select>              </td>
              <td width="17%" align="right"><font color="#FF0000">*</font><font color="#0000CC">主材小类</font></td>
              <td width="33%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditJxc_cljgb.jsp";
	FormName.submit();
	return true;
}
