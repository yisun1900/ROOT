...
try {
	...
	String[] title={"子品牌","材料大类","材料小类","类别系列","主材编码","主材名称","型号","规格","颜色","计量单位","市场标价","销售价","最低销售限价","业绩记入价","结算方式","结算价","结算比例","计入活动比例","是否有促销","促销开始时间","促销结束时间","促销价","促销结算价","促销结算比例","促销期计入活动比例","包含配件","配件套数","是否有货","产品级别","风格属性","产品说明","产地","是否推荐产品","销售方式 ","照片名称","备注"};
