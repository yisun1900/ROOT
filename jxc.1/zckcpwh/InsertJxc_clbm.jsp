...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="clmc" value="" size="73" maxlength="50" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">类别/系列</td>
              <td colspan="3"> 
                <input type="text" name="cllbbm" value="" size="73" maxlength="100" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%> 
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="xsj" value="" size="20" maxlength="9" >
              </td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
