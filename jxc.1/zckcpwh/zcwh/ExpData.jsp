...
try {
/*
	ls_sql="SELECT ppmc,gysmc,ppmc,cldlbm,clxlbm,cllbbm,clbm,jxc_cljgb.clmc,jxc_cljgb.xh,jxc_cljgb.gg,clysbm,jldwbm,jxc_cljgb.lsj,jxc_cljgb.xsj,jxc_cljgb.cbj,jxc_cljgb.jsbl,jxc_cljgb.cxhdbl,DECODE(sfycx,'N','否','Y','是'),jxc_cljgb.cxkssj,jxc_cljgb.cxjzsj,jxc_cljgb.cxj,jxc_cljgb.cxcbj,jxc_cljgb.lscxhdbl,DECODE(jxc_cljgb.sfbhpj,'Y','是','N','否'),jxc_cljgb.pjts,DECODE(sfyh,'Y','是','N','否'),jxc_cljgb.cpjb,jxc_cljgb.fgsx,jxc_cljgb.cpsm,jxc_cljgb.cd,jxc_cljgb.zp,jxc_cljgb.bz";
	ls_sql+=" FROM jxc_cljgb";
    ls_sql+=" where (1=1)";
    ls_sql+=wheresql;
    ls_sql+=" order by  cldlbm,clxlbm,ppmc,jxc_cljgb.xh";

	String rootPath=getServletContext().getRealPath("");
	String fileName=rootPath+"\\jcjj\\zcbj\\expdata\\主材报价";
	String sheetName="one";

	String[] title={"子品牌","供应商","品牌","主材大类","主材小类","类别系列","主材编码","主材名称","型号","规格","颜色","计量单位","市场标价","销售价","结算价","结算比例","计入活动比例","是否有促销","促销开始时间","促销结束时间","促销价","促销结算价","促销期计入活动比例","包含配件","配件套数","是否有货","产品级别","风格属性","产品说明","产地","照片名称","备注"};
*/	
	
	ls_sql="SELECT jxc_clbm.ppmc,jxc_clbm.cllbbm,jxc_clbm.clbm,jxc_clbm.nbbm,jxc_clbm.clmc,jxc_clbm.xh,jxc_clbm.gg,jxc_clbm.clysbm,jxc_clbm.jldwbm,jxc_clbm.bzjldwbm,jxc_clbm.bzgg,jxc_cljgb.lsj,jxc_cljgb.xsj,jxc_cljgb.cbj,jxc_cljgb.jsbl,jxc_cljgb.cxhdbl,DECODE(jxc_cljgb.sfycx,'N','否','Y','是'),jxc_cljgb.cxkssj,jxc_cljgb.cxjzsj,jxc_cljgb.cxj,jxc_cljgb.cxcbj,jxc_cljgb.lscxhdbl,DECODE(jxc_clbm.sfbhpj,'Y','是','N','否'),jxc_clbm.pjts,DECODE(jxc_cljgb.sfyh,'Y','是','N','否'),jxc_clbm.cpjb,jxc_clbm.fgsx,jxc_clbm.cpsm,jxc_clbm.cd,DECODE(jxc_cljgb.sftjcp,'Y','是','N','否'),jxc_clbm.zp,jxc_clbm.bz";
	...
	String[] title={"子品牌","类别系列","主材编码","内部编码","主材名称","型号","规格","颜色","计量单位","包装计量单位","包装规格","市场标价","销售价","结算价","结算比例","计入活动比例","是否有促销","促销开始时间","促销结束时间","促销价","促销结算价","促销期计入活动比例","包含配件","配件套数","是否有货","产品级别","风格属性","产品说明","产地","是否推荐产品","照片名称","备注"};
