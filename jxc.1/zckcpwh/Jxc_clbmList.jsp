...
//		if (!(lrbm.equals("")))	wheresql+=" and  (jxc_clbm.lrbm='"+lrbm+"')";
	...
	ls_sql="SELECT jxc_clbm.clbm,jxc_clbm.clmc,jxc_clbm.xh,jxc_clbm.gg,jxc_clbm.ppmc,DECODE(jxc_cljgb.xsfs,'1','代销品','2','现货','3','期货销售','4','虚拟出入库') xsfs,DECODE(jxc_cljgb.sftjcp,'Y','是','N','否'),DECODE(jxc_cljgb.sfyh,'Y','有货','N','<font color=\"#FF0000\">无货</font>'),DECODE(jxc_cljgb.sfycx,'N','无','Y','<font color=\"#FF0000\">有促销</font>'),jxc_cljgb.cxkssj,jxc_cljgb.cxjzsj,jxc_clbm.cllbbm,jxc_clbm.clysbm,jxc_clbm.jldwbm,jxc_cljgb.lsj,jxc_cljgb.xsj,jxc_cljgb.zdxsj,jxc_cljgb.yjjrj,DECODE(jxc_cljgb.jsfs,'1','结算价','2','结算比例'),jxc_cljgb.cbj,jxc_cljgb.jsbl||'%',jxc_cljgb.cxhdbl||'%',jxc_cljgb.cxj,jxc_cljgb.cxcbj,jxc_cljgb.cxjsbl||'%',jxc_cljgb.lscxhdbl||'%',DECODE(jxc_clbm.sfbhpj,'Y','<font color=\"#FF0000\">含</font>','N','不含'),jxc_clbm.pjts,jxc_clbm.cpjb,jxc_clbm.fgsx,jxc_clbm.cpsm,jxc_clbm.cd,jxc_clbm.zp,jxc_clbm.cldlbm,jxc_clbm.clxlbm,jxc_clbm.scsmc,jxc_cljgb.gysmc,jxc_clbm.lrr,jxc_clbm.lrsj,jxc_clbm.bz";
...
//设置按钮参数
	String[] buttonName={"促销开始","促销结束","有货","无货","删除选中的信息","调销售方式"};//按钮的显示名称
