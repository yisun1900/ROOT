...
%> 
            ...
            <tr bgcolor="#CCCCFF">
              ...
              <td><input name="yjjrbl" type="text" id="yjjrbl" value="<%=yjjrbl%>" size="20" maxlength="9" ></td>
            </tr>
            <tr bgcolor="#CCCCFF">
...
%></td>
            ...
            <tr bgcolor="#E8E8FF"> 
              ...
              <td><input name="cxyjjrbl" type="text" value="<%=cxyjjrbl%>" size="10" maxlength="9" >
              % <font color="#0000CC">（百分比）</font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td colspan="3"><%
	cf.radioToken(out, "xsfs","1+代销品&4+虚拟出入库",xsfs);
%>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
