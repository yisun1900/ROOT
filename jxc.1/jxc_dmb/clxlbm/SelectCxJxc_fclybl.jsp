...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_fclyblCxList.jsp" name="selectform">
<div align="center">辅材领用比例－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="jxc_fclybl_clxlbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select clxlbm,clxlmc from jxc_clxlbm,jxc_cldlbm where jxc_clxlbm.cldlmc=jxc_cldlbm.cldlmc and jxc_cldlbm.cldllb in('2','3') order by jxc_clxlbm.cldlmc,clxlmc","");
%>
  </select></td>
  <td align="right" width="18%">材料小类</td> 
