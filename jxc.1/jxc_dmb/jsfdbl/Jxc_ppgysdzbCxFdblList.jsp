...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  jxc_ppgysdzb.ppbm,jxc_ppgysdzb.ppmc,jxc_ppgysdzb.gysbm,jxc_ppgysdzb.gysmc,jxc_ppgysdzb.azfjsbl||'%' azfjsbl,jxc_ppgysdzb.ycfjsbl||'%' ycfjsbl,fdbl||'%' fdbl,cxfdbl||'%' cxfdbl,khfdbl||'%' khfdbl,khcxfdbl||'%' khcxfdbl,tcjrbl||'%' tcjrbl,tccxjrbl||'%' tccxjrbl,xpjsbl||'%' xpjsbl,xpcxjsbl||'%' xpcxjsbl,xpkhfdbl||'%' xpkhfdbl,xpkhcxfdbl||'%' xpkhcxfdbl,xptcjrbl||'%' xptcjrbl,xptccxjrbl||'%' xptccxjrbl,jxc_ppgysdzb.ssfgs,dwmc ";
...
//进行对象初始化
 ...
 //设置显示列
	String[] disColName={"ppbm","ppmc","gysbm","gysmc","azfjsbl","ycfjsbl","fdbl","cxfdbl","khfdbl","khcxfdbl","tcjrbl","tccxjrbl","xpjsbl","xpcxjsbl","xpkhfdbl","xpkhcxfdbl","xptcjrbl","xptccxjrbl","dwmc"};
