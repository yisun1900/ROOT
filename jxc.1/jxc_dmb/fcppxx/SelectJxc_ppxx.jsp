...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_ppxxList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="cldl" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeCldlbm(selectform)">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="scsmc" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select scsmc c1,scsmc c2 from jxc_scsxx where scslb in('2','3')  order by scsmc","");
%>
  </select></td>
</tr>
<tr align="center"> 
