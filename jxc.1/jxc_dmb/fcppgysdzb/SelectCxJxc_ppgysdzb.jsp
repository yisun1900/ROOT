...
<tr bgcolor="#FFFFFF">
  ...
  <select name="gysbm" style="FONT-SIZE:12PX;WIDTH:522PX">
    <option value=""></option>
<%
	cf.selectItem(out,"select jxc_gysxx.gysbm,'('||dqmc||')'||jxc_gysxx.gysmc||DECODE(jxc_gysxx.sfhz,'Y','（合作）','N','（不合作）') from jxc_gysxx,dm_dqbm where jxc_gysxx.dqbm=dm_dqbm.dqbm and jxc_gysxx.cllx='2' order by jxc_gysxx.dqbm,sfhz desc,gysmc","");
%>
  </select></td>
  </tr>
<tr bgcolor="#FFFFFF">
