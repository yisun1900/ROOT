...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_hjmcCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
<td align="right" width="15%">所属地区</td> 
  <td width="35%"><select name="dqbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changedqbm(selectform)">
	<option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">货架编号</td> 
  <td width="35%"><input type="text" name="hjbh" size="20" maxlength="6" ></td>
  <td align="right" width="15%">货架名称 </td>
  <td width="35%"><input type="text" name="hjmc" size="20" maxlength="50" >  </td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
