...
%>    </td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><strong><%=pszje%></strong></td>
    <td align="right"><strong>成本总额</strong></td>
    <td><strong><%=cbze%></strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<%
	...
	ls_sql="SELECT jxc_clpsmx.psxh,jxc_clpsmx.clbm,jxc_clpsmx.nbbm,jxc_clpsmx.clmc,jxc_clpsmx.xh,jxc_clpsmx.gg,jxc_clpsmx.jldwbm,TO_CHAR(jxc_clpsmx.cbj),TO_CHAR(jxc_clpsmx.dj),jxc_clpsmx.sqpssl,jxc_clpsmx.pssl,ROUND(jxc_clpsmx.cbj*jxc_clpsmx.pssl,2),jxc_clpsmx.psje,jxc_clpsmx.cksl";
