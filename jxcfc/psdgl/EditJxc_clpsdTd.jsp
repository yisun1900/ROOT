...
<div align="center">退料单－维护（材料单号：<%=psph%>）
</div>
...
%>      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> <%
	cf.radioToken(out, "fclb","4+退单",fclb);
%> </td>
    ...
    <tr align="center"> 
      <td colspan="4"> 
        <p>
          ...
          <input type="button"  value="配送单录入" onClick="f_pllr(insertform)" name="pllr">
          ...
          <input type="button"  value="整单打印" onClick="f_print(insertform)" name="print" >
          <input type="button"  value="供应商打印" onClick="f_gysprint(insertform)" name="gysprint" >
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditJxc_clpsdTd.jsp";
	FormName.submit();
