...
try {
	...
	ls_sql="insert into jxc_clpsd ( psph,psdzt,khbh,yf,qtsf,fkje,psfs,jhshsj,lrr,lrrq,ssbm,bz,ssfgs,pszsl,pszje,cbze,dybz,fclb,ycksl,yckje) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,0,0,0,'N',?,0,0 ) ";
