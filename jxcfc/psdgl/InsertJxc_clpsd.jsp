...
try { 
	...
	ls_sql="select sfke,khbh,khxm,fwdz,lxfs,dwbh,sjs,sgd,zjxm,hth,kgrq,jgrq,sgbz,NVL(guanlif,0)+NVL(suijin,0)+qye qye,fgsbh";
	...
	double[] fkxx=cwgl.getFkje(khbh,"1");
	double yfkje=fkxx[2]+sfke;//一期款金额

	if ((sfke+100)<yfkje)
	{
		out.println("错误！未交齐首期款不能开材料单，首期款："+yfkje+"，实收款："+sfke);
		return;
	}
...
%> </td>
	...
	<tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="radio" name="fclb" value="1">
       开工
        <input type="radio" name="fclb" value="2">
       补料 
        <input type="radio" name="fclb" value="3">
      中期 </td>
    ...
    <tr align="center"> 
      <td colspan="4"> 
        <p>
          ...
          <input type="button"  value="工料分析转入" onClick="f_glfx(insertform)" name="glfx" disabled>
