...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and (jxc_clpsd.psdzt in ('0','1','6') OR (jxc_clpsd.psdzt='2' and shjl is null))";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clpsdTdList.jsp","","","EditJxc_clpsdTd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除材料单","删除提交"};//按钮的显示名称
	String[] buttonLink={"DeleteJxc_clpsdTd.jsp","sctjTd.jsp"};//按钮单击调用的网页，可以增加参数
