...
try { 
	...
	ls_sql="select khbh,psfs,jhshsj,fkje,yf,qtsf,ssbm,lrr,lrrq,bz,psdzt,shjl,shr,shsj,shsm";
...
<div align="center"><strong>材料单－修改审核</strong>（材料单号：<%=psph%>）</div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td colspan="3"><%
	cf.radioToken(out, "shjl","Y+同意&N+作废（不能打印不能出库）&M+驳回重新修改（不能打印不能出库）",shjl);
%>      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="";
	FormName.action="SaveXgShJxc_clpsd.jsp";
	FormName.submit();
