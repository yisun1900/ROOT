...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_clpsd.khbh,crm_khxx.hth,crm_khxx.khxm,sq_sgd.sgdmc,crm_khxx.fwdz,jxc_clpsmx.psph,TO_CHAR(jxc_clpsmx.psxh),jxc_clpsmx.nbbm,jxc_clpsmx.clmc,jxc_clpsmx.sqpssl,jxc_clpsmx.pssl,jxc_clpsmx.psje,jxc_clpsmx.cksl,jxc_clpsmx.xh,jxc_clpsmx.gg,jxc_clpsmx.clbm,jxc_clpsmx.cldlbm,jxc_clpsmx.clxlbm,jxc_clpsmx.jldwbm,TO_CHAR(jxc_clpsmx.dj),jxc_clpsmx.ppmc,jxc_clpsmx.gysmc, DECODE(jxc_clpsd.psdzt,'0','等待提交','1','等待审核','6','已审核','2','等待出库','3','已出库','5','部分出库'),jxc_clpsd.lrrq,jxc_clpsd.jhshsj,jxc_clpsd.shsj, DECODE(jxc_clpsd.shjl,'Y','同意','N','作废','M','驳回重新修改'),jxc_clpsd.dysj,dwmc ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clpsmxCxList.jsp","","","");
