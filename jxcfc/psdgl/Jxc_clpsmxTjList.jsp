...
try {
	...
	ls_sql=" select sum(jxc_clpsmx.sqpssl),sum(jxc_clpsmx.pssl),sum(jxc_clpsmx.psje),sum(jxc_clpsmx.cksl),sum(jxc_clpsmx.pssl)";
...
<%
	...
	if (groupsl==0)
	{
		...
		selectgroupsql=" select "+selectgroupsql.substring(1)+",sum(jxc_clpsmx.sqpssl),sum(jxc_clpsmx.pssl),sum(jxc_clpsmx.psje),sum(jxc_clpsmx.cksl),sum(jxc_clpsmx.pssl-jxc_clpsmx.cksl)";
	}
%>

<center>材料单明细统计</center>
