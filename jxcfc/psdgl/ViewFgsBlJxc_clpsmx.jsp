...
%>
<center><b>材料使用比例分析（<%=fgsmc%>）
<BR>完工登记时间：（<%=tjsj%>－－<%=tjsj2%>）
</b></center><br>
<table width="<%=(820+xlsl*400+480)%>" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2" align="center">
	<tr bgcolor="CCCCCC" align="center"> 
		...
		<td width="80" rowspan="2"><B>完工时间</b></td>
	...
	while (rs2.next())
	{
		...
		if (xjpsje==0)
		{
			%>
				...
				<td ><%=alllyxxje%></td>
				<td ><%=alllysxje%></td>
				<td><font color="#FF0000">未领任何材料</font></td>
			<%
		}
		else{
			%>
				...
				<td ><%=alllyxxje%></td>
				<td ><%=alllysxje%></td>
				<td ><A HREF="ViewKhAlljxc_clpsmx.jsp?khbh=<%=khbh%>" target="_blank"><%=xjpsje%></A></td>
			<%
		}
