...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_clpsd.psph,DECODE(jxc_clpsd.psdzt,'0','等待提交','1','等待审核','2','等待出库','3','已出库','5','部分出库','6','驳回重新修改','7','作废') psdzt,DECODE(jxc_clpsd.shjl,'Y','同意','N','作废','M','驳回重新修改'),jxc_clpsd.shsj,DECODE(jxc_clpsd.psfs,'1','配送','2','自提','9','其它') psfs,jxc_clpsd.jhshsj,jxc_clpsd.khbh,crm_khxx.hth,crm_khxx.khxm,sq_sgd.sgdmc,crm_khxx.fwdz,jxc_clpsd.pszsl,jxc_clpsd.pszje,jxc_clpsd.yf,jxc_clpsd.qtsf,jxc_clpsd.fkje,jxc_clpsd.lrr,jxc_clpsd.lrrq,a.dwmc ssfgs,b.dwmc ssbm,jxc_clpsd.bz  ";
    ...
    ls_sql+=" and jxc_clpsd.psdzt in('2','6','7')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clpsdXgShList.jsp","","","XgShJxc_clpsd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteShJxc_clpsd.jsp"};//按钮单击调用的网页，可以增加参数
