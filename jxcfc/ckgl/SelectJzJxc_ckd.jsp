...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_ckdJzList.jsp" name="selectform">
<div align="center">出库单结帐</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <INPUT name="jxc_ckd_sfjz" type="radio" value="N" checked>未结账	</td>
  <td align="right" width="18%">出库人</td> 
  <td width="32%"><input type="text" name="jxc_ckd_ckr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
