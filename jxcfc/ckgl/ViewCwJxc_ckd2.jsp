...
<%	
	...
	ls_sql="SELECT nbbm,clmc,xh,gg,ppmc,jldwbm,jxc_ckmx.cksl,TO_CHAR(jxc_ckmx.ckdj),jxc_ckmx.ckje,TO_CHAR(jxc_ckmx.cbdj),jxc_ckmx.cbje,DECODE(jxc_ckmx.sfyfkc,'1','无','2','有负库存'),jxc_ckmx.fkcs,jxc_ckmc.ckmc,jxc_hjmc.hjmc,clbm,gysmc,DECODE(zljb,'1','<font color=green>正常品</font>','2','<font color=blue>残次品</font>','3','<font color=red>报废品</font>')";
