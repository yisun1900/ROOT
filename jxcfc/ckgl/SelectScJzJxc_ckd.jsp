...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_ckdScJzList.jsp" name="selectform">
<div align="center">出库单结帐－删除</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <INPUT name="jxc_ckd_sfjz" type="radio" value="Y" checked>结账	</td>
  <td align="right" width="18%">结账</td> 
  <td width="32%"><input name="jzr" type="text" id="jzr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">结账时间 从</td>
  <td><input name="jzsj" type="text" id="jzsj" onDblClick="JSCalendar(this)" size="20" maxlength="10"></td>
  <td align="right">到</td>
  <td><input name="jzsj2" type="text" id="jzsj2" onDblClick="JSCalendar(this)" size="20" maxlength="10"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#FFFFCC" ><font color="#FF0000">*</font>每页显示数量 </td>
  <td colspan="3" bgcolor="#FFFFCC" ><input type="text" name="myxssl" size="7" maxlength="13" value="200">  </td></tr>
