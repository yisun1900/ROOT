...
<div align="center">人工调整库存－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFCC">
    <td align="right">修改人分公司</td>
    <td bgcolor="#FFFFCC">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">流水号</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">原库存数量</td> 
  <td width="32%"><input type="text" name="ykcsl" size="20" maxlength="17" ></td>
  <td align="right" width="18%">调整后库存数量</td> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.xgsj2, "修改时间"))) {
		return false;
	}
	if(!(isFloat(FormName.ykcsl, "原库存数量"))) {
		return false;
	}
	if(!(isFloat(FormName.xkcsl, "调整后库存数量"))) {
		return false;
	}
	FormName.submit();
	return true;
