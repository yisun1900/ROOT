...
finally 
{
	...
	if (jxc_kcb_dqbm!=null)
	{
		...
		else
		{
			...
			{wheresql=" and jxc_kcb.dqbm='"+dqbm+"'";}
		}
	}
	...
	{
	ls_sql="SELECT jxc_kcb.lsh,jxc_kcb.clbm,jxc_kcb.clmc,'<img src=\"/jxc/jxc_clbm/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">' zp,jxc_kcb.kcsl,jxc_kcb.scrq,jxc_kcb.scph,jxc_kcb.bztxq,round(to_number(sysdate-jxc_kcb.scrq)-0.5,0),dqmc,ckmc,hjmc,hwmc,DECODE(jxc_kcb.cllb,'0','主材','1','辅材'),jxc_kcb.cldlbm,jxc_kcb.clxlbm,jxc_kcb.scsmc,jxc_kcb.ppmc,jxc_kcb.gysmc,jxc_kcb.cllbbm,jxc_kcb.xh,jxc_kcb.nbbm,jxc_kcb.gg,jxc_kcb.clysbm,jxc_kcb.jldwbm,jxc_kcb.pjts,jxc_kcb.cpjb,jxc_kcb.fgsx,jxc_kcb.cpsm,jxc_kcb.cd,jxc_kcb.cgzq,jxc_kcb.bz  ";
	}
	else
	{
		ls_sql="SELECT jxc_kcb.lsh,jxc_kcb.clbm,jxc_kcb.clmc,'' zp,jxc_kcb.kcsl,jxc_kcb.scrq,jxc_kcb.scph,jxc_kcb.bztxq,round(to_number(sysdate-jxc_kcb.scrq)-0.5,0),dqmc,ckmc,hjmc,hwmc,DECODE(jxc_kcb.cllb,'0','主材','1','辅材'),jxc_kcb.cldlbm,jxc_kcb.clxlbm,jxc_kcb.scsmc,jxc_kcb.ppmc,jxc_kcb.gysmc,jxc_kcb.cllbbm,jxc_kcb.xh,jxc_kcb.nbbm,jxc_kcb.gg,jxc_kcb.clysbm,jxc_kcb.jldwbm,jxc_kcb.pjts,jxc_kcb.cpjb,jxc_kcb.fgsx,jxc_kcb.cpsm,jxc_kcb.cd,jxc_kcb.cgzq,jxc_kcb.bz  ";
	}
	ls_sql+=" FROM jxc_kcb,dm_dqbm,jxc_ckmc,jxc_hjmc,jxc_hwmc  ";
    ...
    ls_sql+=" and to_number(sysdate-scrq)<bztxq ";
	ls_sql+=wheresql;
	ls_sql+=ordersql;
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">生产批号</td>
	<td  width="2%">保质期</td>
	<td  width="2%"><font color=red>过期剩余天数</font></td>
	<td  width="3%">所在地区</td>
	<td  width="5%">所在仓库</td>
	<td  width="5%">所在货架</td>
	<td  width="5%">所在货位</td>
