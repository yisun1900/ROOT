...
try {
	...
	ls_sql="select jxc_cljgb.clbm lyph,dqmc dqbm,jxc_kcb.gysmc gysmc,lsj,xsj,cxhdbl,myqjf,DECODE(sfycx,'N','无','Y','有') sfycx,cxkssj,cxjzsj,cxj,lscxhdbl,cxmyqjf,DECODE(xsfs,'1','代销品','2','现货销售','3','期货销售') xsfs,zcpzsl,dhsl,ycgsl,clmc,xh,gg,'<img src=\"/jxc/jxc_lyph/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">' zp,scsmc,ppmc,cldlbm,clxlbm,ccpzsl,bfpzsl ";
