...
try {
	...
	ls_sql="select jxc_cljgb.clbm clbm,dqmc dqbm,jxc_kcb.gysmc gysmc,lsj,xsj,cxhdbl,myqjf,DECODE(sfycx,'N','无','Y','有') sfycx,cxkssj,cxjzsj,cxj,lscxhdbl,cxmyqjf,DECODE(xsfs,'1','代销品','2','现货销售','3','期货销售') xsfs,zcpzsl,dhsl,ycgsl,jxc_clbm.clmc clmc,jxc_clbm.xh xh,jxc_clbm.gg gg,'<img src=\"/jxc/jxc_clbm/clzp/'||jxc_kcb.zp||'\" width=\"100px\" height=\"100px\">' zp,jxc_clbm.scsmc scsmc,jxc_clbm.ppmc ppmc,jxc_clbm.cldlbm cldlbm,jxc_clbm.clxlbm clxlbm,ccpzsl,bfpzsl ";
