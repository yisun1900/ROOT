...
<tr align="center" bgcolor="#D6D3CE"> 
  <td colspan="4"> 
   <input type="button"  value="库存统计" onClick="f_do(selectform,5)">&nbsp;&nbsp;&nbsp;
    <!-- <input type="button"  value="财务流水统计" onClick="f_do(selectform,2)">&nbsp;&nbsp;&nbsp; -->
...
<tr align="center" bgcolor="#D6D3CE"> 
  ...
  <!--  <input type="button"  value="品牌统计" onClick="f_do(selectform,11)">&nbsp;&nbsp;&nbsp; -->
    ...
    <input type="button"  value="大类小类统计" onClick="f_do(selectform,8)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#FFFFCC">在途货物</td>
  <td bgcolor="#FFFFCC">
    <input type="radio" name="ztbz" value="Y">在途
    <input type="radio" name="ztbz" value="N">否  </td>
  <td rowspan="7" align="right" bgcolor="#FFFFCC">
  ...
  <td rowspan="7" bgcolor="#FFFFCC">
    <select name="clbmlist" size="12" multiple style="FONT-SIZE:12px;WIDTH:152px">
    </select></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#99FFCC">内部编码</td>
  <td bgcolor="#99FFCC"><input name="nbbm" type="text" id="nbbm"  onkeyup="singleAdd(selectform)" size="20" maxlength="20"></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="15%">统计月份</td> 
  <td width="35%">
  年<select name="jxc_kcb_nian" style="FONT-SIZE:12PX;WIDTH:62PX">
    <option value=""></option>
	<%
	cf.selectItem(out,"select to_number(to_char(sysdate,'YYYY'))+rownum-10,to_number(to_char(sysdate,'YYYY'))+rownum-10 nian from sq_dwxx where rownum<21","");
%>
  </select>
  &nbsp;&nbsp;月<select name="jxc_kcb_yue" style="FONT-SIZE:12PX;WIDTH:40PX">
    <option value=""></option>
	<%
	cf.selectItem(out,"select lpad(trim(rownum),2,0),lpad(trim(rownum),2,0) as from sq_dwxx where rownum<13","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input name="rkph" type="text" id="rkph" size="20" maxlength="11" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr align="center"> 
...
<!--    <input type="button"  value="品牌统计" onClick="f_do(selectform,11)">&nbsp;&nbsp;&nbsp;
 -->    <input type="button"  value="子品牌统计" onClick="f_do(selectform,7)">&nbsp;&nbsp;&nbsp;
    ...
    <input type="button"  value="在途货物查询" onClick="f_do(selectform,9)">&nbsp;&nbsp;&nbsp;</tr>
</table>
</form>
</body>
</html>
...
function f_do(FormName,cxlx)//参数FormName:Form的名称
{
	...
	else if (cxlx=="2")
	{
		...
		if(	javaTrim(FormName.jxc_kcb_nian)=="") {
		alert("请选择[年]！");
		FormName.jxc_kcb_nian.focus();
		return false;
	}
	if(	javaTrim(FormName.jxc_kcb_yue)=="") {
		alert("请选择[月]！");
		FormName.jxc_kcb_yue.focus();
		return false;
	}
	FormName.action="Jxc_kcbcwtj.jsp";
	FormName.submit();
	return true;
	}
	else if (cxlx=="3")
