...
finally 
{
	...
	ls_sql="SELECT jxc_kcb.lsh,jxc_kcb.clbm,jxc_kcb.clmc,jxc_kcb.kcsl,TO_CHAR(jxc_kcb.rkj),TO_CHAR(jxc_kcb.jqpjcbj),jxc_kcb.kcje,jxc_cljgb.dgzjg,jxc_kcb.kcsl*jxc_cljgb.dgzjg,jxc_kcb.rkph,jxc_kcb.scph,jxc_kcb.scrq,TO_CHAR(jxc_kcb.bzq),TO_CHAR(jxc_kcb.bztxq),dqmc,ckmc,hjmc,hwmc,DECODE(jxc_kcb.cllb,'0','主材','1','辅材'),jxc_kcb.cldlbm,jxc_kcb.clxlbm,jxc_kcb.scsmc,jxc_kcb.ppmc,jxc_kcb.gysmc,jxc_kcb.cllbbm,jxc_kcb.xh,jxc_kcb.nbbm,jxc_kcb.gg,jxc_kcb.jldwbm,jxc_kcb.cgzq,jxc_kcb.bz  ";
...
<CENTER >
  <B><font size="3">辅材库存查询－特权</font></B>
</CENTER>
<%
	pageObj.out=out;
