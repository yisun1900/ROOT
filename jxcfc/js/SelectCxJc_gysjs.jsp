...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_gysjsCxList.jsp" name="selectform">
<div align="center">结算单－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
    <input type="radio" name="shbz" value="N">未审核
    <input type="radio" name="shbz" value="Y">审核
    <input type="radio" name="shbz" value="F">付款  </td>
</tr>
<tr bgcolor="#FFFFFF">
