...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="jc_fcgysjsmxCxList.jsp" name="selectform" target="_blank">
<div align="center">结算明细－查询</div>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><select name="zcdlbm" style="FONT-SIZE:12PX;WIDTH:152PX" onclick="getThisOne('zcdlbm');" onChange="zcxlbmMark=0;zcxlbm.length=1;gysMark=0;gys.length=1;ppbmMark=0;ppbm.length=1;ppmcMark=0;ppmc.length=1;">
        <option value=""></option>
      </select>    </td>
    <td align="right">主材小类</td>
    <td><select name="zcxlbm" style="FONT-SIZE:12PX;WIDTH:152PX" onclick="getThisOne('zcxlbm');" onChange="gysMark=0;gys.length=1;ppbmMark=0;ppbm.length=1;ppmcMark=0;ppmc.length=1;">
        <option value=""></option>
      </select>    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="ppmc2" size="20" maxlength="50" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%"><strong><font color="#0000FF">审核标志</font></strong></td> 
  <td width="32%"><select name="shbz" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <option value="N">未审核</option>
    <option value="Y">审核</option>
  </select></td>
</tr>
