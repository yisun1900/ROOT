...
try {
	...
	while (rs.next())
	{
		...
		out.print("<a href=\"/jxcfc/gysddgl/ViewJxc_gysdd.jsp?gysddph="+gysddph+"\" target=\"_blank\">"+gysddph+"</a>&nbsp;&nbsp;&nbsp;");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="12%">规格</td>
	<td  width="6%">计量单位</td>
	<td  width="8%">计划采购单价</td>
	<td  width="8%">计划采购数量</td>
	<td  width="8%">计划采购金额</td>
	<td  width="8%">实际采购数量</td>

</tr>
<%
	ybl.common.PageObject pageObj=new ybl.common.PageObject();

	ls_sql="SELECT jhxh,nbbm,clmc,xh,gg,jldwbm,jhcgdj,jhcgsl,jhcgje,sjcgsl";
