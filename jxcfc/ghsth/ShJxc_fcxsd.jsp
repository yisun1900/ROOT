...
<div align="center">供货商退货单－审核（销售批号：<%=xsph%>）</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE2">供货商退货单类型</span></td> 
  <td width="32%"> 
<%
	cf.selectItem(out,"select xsdlx,xsdlxmc from dm_xsdlx where xsdlx='6' order by xsdlx",xsdlx,true);
%>    </td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE2">供货商</span></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "shjl","Y+同意&N+不同意","");
%></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="shr" size="20" maxlength="20"  value="<%=yhmc%>" >  </td>
  <td align="right"><span class="STYLE1">*</span><span class="STYLE2">审核时间</span></td>
  <td><input type="text" name="shsj" size="20" maxlength="10"  value="<%=cf.today()%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">审核说明</td>
  <td colspan="3"><textarea name="shsm" cols="72" rows="3"></textarea>  </td>
  </tr>
    <tr> 
      <td colspan="4" >
	<div align="center">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShJxc_fcxsd.jsp";
	FormName.submit();
	return true;
}
