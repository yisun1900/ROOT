...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jxc_fcxsd.xsdzt in('2','9')";
    ls_sql+=" and jxc_fcxsd.cllx='1'";//0：主材；1：辅材
    ls_sql+=wheresql;
    ls_sql+=" order by jxc_fcxsd.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_fcxsdXgShList.jsp","","","XgShJxc_fcxsd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteShJxc_fcxsd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">供货商退货单－审核维护</font></B>
</CENTER>
<%
	pageObj.out=out;
