...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_fcxsdShList.jsp","","","ShJxc_fcxsd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"PlTyJxc_fcxsd.jsp","PlBtyJxc_fcxsd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">供货商退货单－审核</font></B>
</CENTER>
<%
	pageObj.out=out;
