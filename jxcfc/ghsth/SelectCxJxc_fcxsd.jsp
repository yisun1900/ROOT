...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_fcxsdCxList.jsp" name="selectform">
<div align="center">供货商退货单－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">销售批号</td> 
  <td width="32%"> 
    <input type="text" name="jxc_fcxsd_xsph" size="20" maxlength="11" >  </td>
  <td align="right" width="18%">供货商退货单状态</td> 
  <td width="32%">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">供货商退货单类型</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">供货商</td> 
  <td width="32%"> 
