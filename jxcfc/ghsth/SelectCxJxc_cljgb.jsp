...
String shfmc=cf.GB2Uni(request.getParameter("shfmc"));
%>

<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_cljgbCxList.jsp" name="insertform">
<div align="center">辅材供货商退货单－选择材料（供货商退货单号：<%=xsph%>）</div>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td colspan="3"><input type="text" name="gysmc" size="73" maxlength="50"  value="<%=shfmc%>" readonly></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    ...
    <td colspan="3">
		...
		<input type="radio" name="xsfs" value="4">允许负库存	</td>
    </tr>
  <tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="scsmc" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changePp(insertform)">
    <option value=""></option>
    <%
	cf.selectItem(out,"select scsmc mc,scsmc from jxc_scsxx where scslb in('2','3') order by scsmc","");
%>
  </select></td>
