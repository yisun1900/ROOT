...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_fcxsd.xsph, DECODE(jxc_fcxsd.xsdzt,'0','未提交','1','等待审核','2','等待出库','3','已出库','4','部分出库','9','取消'),dqmc,a.dwmc ssfgs,c.dwmc shbm,xsdlxmc,jxc_fcxsd.xszsl,jxc_fcxsd.xszje,jxc_fcxsd.cbzje, DECODE(jxc_fcxsd.sklx,'1','现金','2','转账','3','支票','9','其它'), DECODE(jxc_fcxsd.sfqk,'1','全款','2','部分款','3','未付款'),jxc_fcxsd.shfmc,jxc_fcxsd.shrlxfs,jxc_fcxsd.shfdz,jxc_fcxsd.xsy,jxc_fcxsd.xsrq,jxc_fcxsd.lrr,jxc_fcxsd.lrsj,b.dwmc lrbm,jxc_fcxsd.bz  ";
	ls_sql+=" FROM jxc_fcxsd,sq_dwxx a,sq_dwxx b,sq_dwxx c,dm_dqbm,dm_xsdlx  ";
    ...
    ls_sql+=" and jxc_fcxsd.shbm=c.dwbh(+)";
    ls_sql+=" and jxc_fcxsd.xsdzt in('0','1')";
    ls_sql+=" and jxc_fcxsd.cllx='1'";//0：主材；1：辅材
    ls_sql+=wheresql;
    ls_sql+=" order by jxc_fcxsd.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_fcxsdList.jsp","","","EditJxc_fcxsd.jsp");
...
//设置按钮参数
	String[] buttonName={"删除选中的信息","删除提交"};//按钮的显示名称
	String[] buttonLink={"DeleteJxc_fcxsd.jsp","sctjxsd.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">供货商退货单－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="3%">&nbsp;</td>
	<td  width="4%">销售批号</td>
	<td  width="3%">供货商退货单状态</td>
	<td  width="3%">地区</td>
	<td  width="4%">所属分公司</td>
	<td  width="4%">收货部门</td>
	<td  width="3%">供货商退货单类型</td>
	<td  width="4%">销售总数量</td>
	<td  width="4%">销售总金额</td>
	<td  width="4%">成本总金额</td>
	<td  width="3%">收款类型</td>
