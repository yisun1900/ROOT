...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_rkmx.rkph,DECODE(jxc_rkd.rkdzt,'0','未提交','1','等待审核','2','等待入库','3','已入库','4','已结算','6','等待总部审核'),DECODE(jxc_rkd.rklx,'C','采购入库','T','退货入库','R','调拨入库','S','申购入库','J','代金券退货入库','D','主材订单退货','P','直接入库') rklx,jxc_ckmc.ckmc,jxc_rkd.rksj,jxc_rkd.gysmc,jxc_rkmx.clbm,jxc_clbm.clmc,jxc_clbm.ppmc,jxc_clbm.xh,jxc_clbm.gg,jxc_clbm.nbbm,jxc_rkmx.rksl,jxc_rkmx.rkj,jxc_rkmx.rkje,jxc_rkmx.zcpsl,jxc_rkmx.ccpsl,jxc_rkmx.thpsl,jxc_rkmx.wldssl,jxc_rkmx.bfpsl,jxc_rkmx.scrq,jxc_rkmx.scph,jxc_rkmx.ccpzkl,hjmc,hwmc,jxc_rkd.rkr,jxc_rkd.lydh,TO_CHAR(jxc_rkmx.rkxh),dm_dqbm.dqmc  ";
...
//设置列超级连接
	...
	coluParm.link="/jxcfc/jxc_rkgl/ViewJxc_rkd.jsp";//为列参数：coluParm.link设置超级链接
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">正常品数量</td>
	<td  width="3%">残次品数量</td>
	<td  width="3%">厂家缺失数量</td>
	<td  width="3%">物流丢失数量</td>
	<td  width="3%">报废品数量</td>
	<td  width="3%">生产日期</td>
	<td  width="4%">生产批号</td>
