...
try {
	...
	ls_sql="select nbbm,clmc,xh,gg,DECODE(xsfs,'1','代销品','2','现货销售','3','期货销售','4','允许负库存') xsfsmc,xsfs,jldwbm,cbj,dgzjg,zxqdl,cldlbm,clxlbm,ppmc,jxc_cljgb.gysmc,zcpzsl,ccpzsl,bfpzsl,dhsl,ycgsl ";
...
<BR>
    ...
    <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="18%" align="right"><span class="STYLE3">对工长价格</span></td>
        <td width="32%" bgcolor="#FFFFFF" ><%=dgzjg%></td>
      </tr>
      <tr bgcolor="#FFFFFF">
