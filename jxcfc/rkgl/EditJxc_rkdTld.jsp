...
try {
	...
	ls_sql=" select dqbm,ckbh,rksj,gysmc,rkcllx,rklx,lydh,rkr,rkrssbm,rkrssfgs,bz";
	ls_sql+=" from jxc_rkd ";
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="bz" cols="72" rows="3" ><%=bz%></textarea></td>
    ...
    <tr align="center"> 
      ...
      <p>
        <input type="button"  value="来源单转入" onClick="f_to(insertform)"  >
...
function f_ck(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="AllEditRkmxCkd.jsp";
	FormName.submit();
	return true;
}
...
function f_print(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="/jxcdy/printfcrkd.jsp";
	FormName.submit();
	return true;
}
