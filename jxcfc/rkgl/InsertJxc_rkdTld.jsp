...
String rklx="T";//T：退货入库

String lydh="";
String dqbm="";

lydh=cf.GB2Uni(request.getParameter("psph"));
dqbm=cf.executeQuery("select sq_dwxx.dqbm from jxc_clpsd,sq_dwxx where jxc_clpsd.ssfgs=sq_dwxx.dwbh and  jxc_clpsd.psph='"+lydh+"'");
...
<div align="center">退料单－入库</div>
<div align="center">

<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span>地区1</td>
    <td width="32%">
...
<%
	String sql="";
	sql="select dwmc c1,dwmc c2 from jxc_clpsd,sq_dwxx where jxc_clpsd.ssfgs=sq_dwxx.dwbh and jxc_clpsd.psph='"+lydh+"'";
...
*/	
	...
	FormName.action="SaveInsertJxc_rkdTld.jsp";
	FormName.submit();
	return true;
}
