...
try {
	...
	if (rs.next())
	{
		...
		out.print("错误！供应商订单批号["+gysddph+"]不存在！");
		return;
	}
	rs.close();
	ps.close();
	...
	ls_sql+=" select              ?,?+rownum,jxc_gysddmx.clbm,clmc,xh,gg,nbbm,jldwbm,ppmc,jxc_gysddmx.gysmc,cldlbm,clxlbm,jxc_gysddmx.dhsl,jxc_cljgb.dfgsjg,jxc_gysddmx.dhsl*jxc_cljgb.dfgsjg,jxc_gysddmx.dhsl,?   ,?   ,?   ,?   ,0,0,0,0,10,0,0,0 ";
