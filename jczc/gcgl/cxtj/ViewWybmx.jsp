...
<center>
  隐蔽工程验收延期列表（计划隐蔽工程验收时间：<%=tjrq%>----<%=tjrq2%>） 
</center>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="9%">签约日期</td>
	<td  width="9%">签约店面</td>
	<td  width="9%">计划隐蔽工程验收</td>
	<td  width="9%">实际隐蔽工程验收</td>
	<td  width="7%">目前进度</td>
</tr>
<%
	//未办理中期手续数
	ls_sql="SELECT '',khbh,khxm, fwdz,sjs,sgdmc sgd,zjxm,qyrq,a.dwmc sbdm,jhybgcrq,sybgcrq,gcjdmc   ";
