...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 12px'>
    ...
    <tr align="center" valign="top"> 
      <td height="540">
	  <iframe width="100%" height="100%" src="WwgmxList.jsp?fgs=<%=fgs%>&dwbh=<%=dwbh%>&tjrq=<%=tjrq%>&tjrq2=<%=tjrq2%>" name="childFrame" marginwidth="0" marginheight="0" scrolling="YES" FrameBorder="0"> 
	  </iframe>
	  </td>
    </tr>
  </table>
