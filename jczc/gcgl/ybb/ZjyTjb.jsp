...
//=============================质检员服务==================================================
	...
	ls_sql+=" where crm_hfjl.zjyfw=dm_hfjgbm.hfjgbm ";//设计师设计方案
	...
	ls_sql+=" and crm_hfjl.jglxbm not in('6','7')";
	ls_sql+=" and crm_hfjl.khbh=crm_khxx.khbh ";
	ls_sql+=" and crm_hfjl.zjyfw=dm_hfjgbm.hfjgbm ";
    ls_sql+=wheresql;
...
//=============================质检员到位==================================================
	...
	ls_sql="SELECT count(crm_khxx.khbh)";
	ls_sql+=" FROM crm_hfjl,dm_hfjgbm,crm_khxx ";
	ls_sql+=" where crm_hfjl.zjydw=dm_hfjgbm.hfjgbm ";//
	ls_sql+=" and crm_hfjl.hfsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD') ";
	ls_sql+=" and crm_hfjl.hfsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	ls_sql+=" and crm_hfjl.jglxbm not in('6','7')";
	ls_sql+=" and crm_hfjl.khbh=crm_khxx.khbh ";
	...
	ls_sql+=" and crm_hfjl.jglxbm not in('6','7')";
	ls_sql+=" and crm_hfjl.khbh=crm_khxx.khbh ";
	ls_sql+=" and crm_hfjl.zjydw=dm_hfjgbm.hfjgbm ";
    ls_sql+=wheresql;
	ls_sql+=" group by dm_hfjgbm.hfjgbm,hfjgmc ";
...
//=============================质检员尽责==================================================
	...
	ls_sql="SELECT count(crm_khxx.khbh)";
	ls_sql+=" FROM crm_hfjl,dm_hfjgbm,crm_khxx ";
	ls_sql+=" where crm_hfjl.zjyjz=dm_hfjgbm.hfjgbm ";//
	ls_sql+=" and crm_hfjl.hfsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD') ";
	ls_sql+=" and crm_hfjl.hfsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	ls_sql+=" and crm_hfjl.jglxbm not in('6','7')";
	ls_sql+=" and crm_hfjl.khbh=crm_khxx.khbh ";
	...
	ls_sql+=" and crm_hfjl.jglxbm not in('6','7')";
	ls_sql+=" and crm_hfjl.khbh=crm_khxx.khbh ";
	ls_sql+=" and crm_hfjl.zjyjz=dm_hfjgbm.hfjgbm ";
    ls_sql+=wheresql;
	ls_sql+=" group by dm_hfjgbm.hfjgbm,hfjgmc ";
	...
	<P><div align="center">质检员总满意度统计表</div>
