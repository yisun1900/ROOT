...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="4"> 
        <input type="button"  value="冻结" onClick="f_do(selectform)">
		<input type="button"  value="解除冻结" onClick="f_do1(selectform)">
