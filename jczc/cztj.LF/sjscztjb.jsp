...
try {
	...
	ls_sql+=" select '"+yhdlm+"'||rownum,'"+yhdlm+"',fgsbh,dwbh,sjs,cxhdbm,cxhdbmxq,cxhdbmzh,lx ";
	//sz1:签约数
	//sz2:签约额－折前
	//sz3:签约额－折后
	//sz4:合同管理费
	...
	ls_sql+=" select crm_khxx.fgsbh,crm_khxx.dwbh,crm_khxx.sjs,crm_khxx.cxhdbm,crm_khxx.cxhdbmxq,crm_khxx.cxhdbmzh,'0' lx";
	...
	ls_sql+=" group by crm_khxx.fgsbh,crm_khxx.dwbh,crm_khxx.sjs,crm_khxx.cxhdbm,crm_khxx.cxhdbmxq,crm_khxx.cxhdbmzh,crm_khxx.ywy";
...
<%
	...
	ls_sql+=" SELECT yhmc sjs,sq_yhxx.dwbh,dwmc ";
	...
	while (rs.next())
	{
		...
		ls_sql+=" where cw_khfkjl.dwbh='"+dmbh+"' and cw_khfkjl.sjs='"+getsjs+"' and cw_khfkjl.fklxbm='53' and cw_khfkjl.scbz='N' ";//53:设计装修费
		...
		<tr align="center" bgcolor="<%=bgcolor%>">
			...
			<td ><A HREF="ViewSjscz.jsp?tjsjlx=<%=tjsjlx%>&jzsj=<%=jzsj%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=dmbh%>" target="_blank"><%=getsjs%></A></td>
			<td ><%=dm%></td>
...
<tr align="center">
	...
	<td  align="right"><%=cf.formatDouble((long)allsjsyj)%></td>
