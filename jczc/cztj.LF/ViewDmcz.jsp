...
<%
	...
	if (!getjzbz.equals("0"))
	{
		wheresql+=" and  crm_khxx.jzbz='"+getjzbz+"'";
	}
...
try {
	...
	if(lx.equals("1"))//店面
	{
		ls_sql="SELECT crm_khxx.khbh,crm_khxx.fgsbh,crm_khxx.cxhdbm,crm_khxx.cxhdbmxq,crm_khxx.cxhdbmzh,crm_khxx.sjs,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,sgdmc,zjxm,DECODE(crm_khxx.jzbz,'1','家装','2','工装') jzbz";
		ls_sql+=" ,wdzgce,zkl,qye,guanlif,suijinbfb,suijin ";
		ls_sql+=" ,zhzjxje,zjxguanlif,zjxsuijin,kglf ";
		ls_sql+=" ,crm_khxx.sjf,sfke,DECODE(crm_khxx.sffj,'Y','返卷','N','否') sffj,crm_khxx.fjje,crm_khxx.gsfje";
