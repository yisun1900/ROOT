...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="派单金额统计" onClick="f_pdje(selectform)">
...
<!--
function f_pdje(FormName)//参数FormName:Form的名称
{
...
function f_kppd(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.sjfw)=="") {
		alert("请输入[时间范围 ]！");
		FormName.sjfw.focus();
