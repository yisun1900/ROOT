...
<%
	...
	String yhqx=cf.executeQuery("select count(*)  from v_sqxx where yhdlm='"+xtrzyhdlm+"' and cdbh='090408'");
	if (yhqx.equals("0"))
	{
		String xtrzip=request.getRemoteHost();
		String xtrzyhmc=(String)session.getAttribute("yhmc");

		String sql="insert into sq_xtrz ( xh,ip,yhdlm,dlsj,bz ) ";
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_xtrz),'"+xtrzip+"','"+xtrzyhdlm+"',SYSDATE,'警告！非法侵入[业务员产值统计]："+xtrzyhmc+"') ";
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">全部业务员产值统计</div>
      </td>
    </tr>
    <tr> 
 ...
 %> </td>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="产值统计" onClick="f_do(selectform)" name="jzcz">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="allywycztjb.jsp";
	FormName.submit();
