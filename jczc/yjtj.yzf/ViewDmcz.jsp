...
<tr bgcolor="#CCCCCC"  align="center">
  ...
  <td width="3%" rowspan="2" bgcolor="#99FFFF">应退金额</td>
  <td width="3%" rowspan="2" bgcolor="#99FFFF">实退金额</td>
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="2%">合同</td>
	<td  width="2%">增减项</td>
	<td  width="5%" bgcolor="#99FFFF">折前业绩</td>
	<td  width="5%" bgcolor="#99FFFF">折后业绩</td>
...
<%
	ls_sql="SELECT '',cw_qmjzmx.sjs,cw_qmjzmx.hth,cw_qmjzmx.khxm,DECODE(cw_qmjzmx.jzbz,'1','家装','2','工装'),DECODE(cw_qmjzmx.zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),crm_tddj.ytje,crm_tddj.stje,cw_qmjzmx.tdsj,cw_qmjzmx.qyrq ";
	ls_sql+=" ,TO_CHAR(cw_qmjzmx.zkl),TO_CHAR(cw_qmjzmx.zjxzkl) ";
	...
	ls_sql+=" ,cw_qmjzmx.wdzgce,cw_qmjzmx.qye,NVL(cw_qmjzmx.cdzwjmje,0),NVL(cw_qmjzmx.zqguanlif,0),NVL(cw_qmjzmx.guanlif,0),NVL(cw_qmjzmx.glfjmje,0),NVL(cw_qmjzmx.suijin,0),NVL(cw_qmjzmx.sjjmje,0) ";
	...
	ls_sql+=" ,cw_qmjzmx.sjf,cw_qmjzmx.cwsfke,DECODE((cw_qmjzmx.qye+NVL(cw_qmjzmx.guanlif,0)+NVL(cw_qmjzmx.suijin,0)),0,'',ROUND(cw_qmjzmx.cwsfke*100/(cw_qmjzmx.qye+NVL(cw_qmjzmx.guanlif,0)+NVL(cw_qmjzmx.suijin,0)),1)||'%' ),sgdmc sgd,cw_qmjzmx.zjxm,cw_qmjzmx.ywy ";
	...
	ls_sql+=wheresql;
	ls_sql+=" order by cw_qmjzmx.sjs,cw_qmjzmx.qyrq";
...
<%
	...
	ls_sql+=" ,TO_CHAR(zkl),TO_CHAR(zjxzkl) ";
	ls_sql+=" ,wdzgce+NVL(zqguanlif,0)+NVL(suijin,0),qye+NVL(guanlif,0)+NVL(suijin,0)";
	ls_sql+=" ,wdzgce,qye,NVL(cdzwjmje,0),NVL(zqguanlif,0),NVL(guanlif,0),NVL(glfjmje,0),NVL(suijin,0),NVL(sjjmje,0) ";
	...
	ls_sql+=" ,sjf,cwsfke,DECODE((qye+NVL(guanlif,0)+NVL(suijin,0)),0,'',ROUND(cwsfke*100/(qye+NVL(guanlif,0)+NVL(suijin,0)),1)||'%' ),sgdmc sgd,zjxm,ywy,cxhdbm ";
