...
<table border="1" width="240%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#CCCCCC"  align="center"> 
    ...
    <td rowspan="2" width="3%">设计师</td>
    <td rowspan="2" width="3%">合同号</td>
    <td rowspan="2" width="3%">姓名</td>
    <td rowspan="2" width="5%" >促销活动</td>
    <td rowspan="2" width="4%" >工程增减后总额 </td>
    <td rowspan="2" width="5%" >签约店面</td>
    <td rowspan="2" width="4%" >签约日期</td>
    <td rowspan="2" width="4%" >首次付家装款时间</td>
    <td rowspan="2" width="4%" >财务首次收家装款时间</td>
    <td colspan="9" ><font color="#0000CC"><b>定制品</b></font></td>
    <td colspan="5" ><font color="#CC0000"><b>主材</b></font></td>
    <td rowspan="2" width="4%" ><b>总计</b></td>
  </tr>
  <tr bgcolor="#CCCCCC"  align="center"> 
    <td  width="4%"><font color="#0000CC"><b>橱柜订单日期</b></font></td>
    <td  width="4%"><font color="#0000CC"><b>橱柜初测</b></font></td>
    <td  width="4%"><font color="#0000CC"><b>橱柜复测</b></font></td>
    <td  width="3%"><font color="#0000CC"><b>橱柜签约额</b></font></td>
    <td  width="4%"><font color="#009900"><b>木门订单日</b></font></td>
    <td  width="3%"><font color="#009900"><b>木门签约额</b></font></td>
    <td  width="4%"><font color="#0000CC"><b>家具订单日</b></font></td>
    <td  width="3%"><font color="#0000CC"><b>家具签约额</b></font></td>
    <td  width="4%"><font color="#0000CC"><b><font color="#009900">定制品小计</font></b></font></td>
    <td  width="3%"><font color="#CC0000"><b>地板</b></font></td>
    <td  width="3%"><font color="#CC0000"><b>洁具</b></font></td>
    <td  width="3%"><font color="#CC0000"><b>瓷砖</b></font></td>
    <td  width="3%"><font color="#CC0000"><b>其它</b></font></td>
    <td  width="4%"><font color="#CC0000"><b><font color="#009900">主材小计</font></b></font></td>
  </tr>
  <%
String lssjs=null;
String lsdwbh=null;
...
try {
	...
	for (int i=0;i<sjs.length ;i++ )
	{
		...
		ls_sql+=" SELECT cw_qmjzmx.khbh,cw_qmjzmx.qyrq";
		ls_sql+=" FROM cw_qmjzmx";
		ls_sql+=" where cw_qmjzmx.sjs='"+lssjs+"' and cw_qmjzmx.dwbh='"+lsdwbh+"'";
		...
		if (!(fgs.equals("")))	ls_sql+=" and  (cw_qmjzmx.fgsbh='"+fgs+"')";
		if (!(dwbh.equals("")))	ls_sql+=" and  cw_qmjzmx.dwbh='"+dwbh+"'";
		if (!lrjzbz.equals("0"))
		{
			ls_sql+=" and  cw_qmjzmx.jzbz='"+lrjzbz+"'";
		}
		...
		ls_sql+=" SELECT cw_qmjzmx.khbh,cw_qmjzmx.qyrq";
		ls_sql+=" FROM cw_qmjzmx,jc_mmydd";
		ls_sql+=" where jc_mmydd.khbh=cw_qmjzmx.khbh ";
		...
		ls_sql+=" SELECT cw_qmjzmx.khbh,cw_qmjzmx.qyrq";
		ls_sql+=" FROM cw_qmjzmx,jc_cgdd";
		ls_sql+=" where jc_cgdd.khbh=cw_qmjzmx.khbh ";
		ls_sql+=" and cw_qmjzmx.sjs='"+lssjs+"' and cw_qmjzmx.dwbh='"+lsdwbh+"'";
		if (!(fgs.equals("")))	ls_sql+=" and  (cw_qmjzmx.fgsbh='"+fgs+"')";
		if (!(dwbh.equals("")))	ls_sql+=" and  cw_qmjzmx.dwbh='"+dwbh+"'";
		if (kfgssq.equals("1") || kfgssq.equals("2"))//0：不授权；1：授权单个分公司；2：授权多个分公司；3：授权单个店面；4：授权某一分公司多个店面；5：授权多个分公司多个店面
		...
		ls_sql+=" SELECT cw_qmjzmx.khbh,cw_qmjzmx.qyrq";
		ls_sql+=" FROM cw_qmjzmx,jc_jjdd";
		ls_sql+=" where jc_jjdd.khbh=cw_qmjzmx.khbh ";
		ls_sql+=" and cw_qmjzmx.sjs='"+lssjs+"' and cw_qmjzmx.dwbh='"+lsdwbh+"'";
		if (!(fgs.equals("")))	ls_sql+=" and  (cw_qmjzmx.fgsbh='"+fgs+"')";
		if (!(dwbh.equals("")))	ls_sql+=" and  cw_qmjzmx.dwbh='"+dwbh+"'";
		if (kfgssq.equals("1") || kfgssq.equals("2"))//0：不授权；1：授权单个分公司；2：授权多个分公司；3：授权单个店面；4：授权某一分公司多个店面；5：授权多个分公司多个店面
		...
		ls_sql+=" SELECT cw_qmjzmx.khbh,cw_qmjzmx.qyrq";
		ls_sql+=" FROM cw_qmjzmx,jc_zcdd";
		ls_sql+=" where jc_zcdd.khbh=cw_qmjzmx.khbh ";
		ls_sql+=" and cw_qmjzmx.sjs='"+lssjs+"' and cw_qmjzmx.dwbh='"+lsdwbh+"'";
		if (!(fgs.equals("")))	ls_sql+=" and  (cw_qmjzmx.fgsbh='"+fgs+"')";
		if (!(dwbh.equals("")))	ls_sql+=" and  cw_qmjzmx.dwbh='"+dwbh+"'";
		if (kfgssq.equals("1") || kfgssq.equals("2"))//0：不授权；1：授权单个分公司；2：授权多个分公司；3：授权单个店面；4：授权某一分公司多个店面；5：授权多个分公司多个店面
		...
		while (rs.next())
		{
			...
			ls_sql="SELECT hth,khxm,cw_qmjzmx.cxhdbm,NVL(zjxje,0)+qye zjhze,a.dwmc qydm,qyrq,jzkscsj,cwjzkscsj";
			ls_sql+=" FROM cw_qmjzmx,sq_dwxx a";
			ls_sql+=" where cw_qmjzmx.dwbh=a.dwbh(+)";
			ls_sql+=" and cw_qmjzmx.khbh='"+khbh+"'";
