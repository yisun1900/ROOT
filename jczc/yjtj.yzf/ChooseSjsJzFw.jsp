  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">设计师结转业绩统计</div>
      </td>
    </tr>
    <tr> 
      <td align="right" width="37%" height="42">大区</td>
      <td height="42" colspan="3" width="63%"> 
...
%> 
    ...
    <tr> 
      <td align="right" width="37%" height="42">分公司</td>
      <td height="42" colspan="3" width="63%">
    ...
    <tr> 
      <td align="right" width="37%" height="44">签约店面</td>
      <td height="44" colspan="3" width="63%"> 
    ...
    <tr> 
      <td align="right" width="37%" height="39">设计师</td>
 ...
 %> </td>
    ...
    <tr> 
      <td align="right" width="37%" height="43"> 统计时间</td>
      <td height="43" colspan="3" width="63%"> 从 
    ...
    <tr> 
      <td align="right" width="37%" height="46"><font color="#FF0000">*</font>业绩范围</td>
      <td height="46" colspan="3" width="63%"> 
    ...
    <tr> 
      <td align="right" width="37%" height="46">显示风格</td>
      <td height="46" colspan="3" width="63%"> 
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="sjsjzyjtjb.jsp";
	FormName.target="";
	FormName.submit();
