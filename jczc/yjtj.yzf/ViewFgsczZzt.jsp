...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"自营分公司产值占比","","签约额",2000,400,request,session);
%>
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"加盟商产值占比","","签约额",1000,400,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"全部(自营加盟商)产值占比","","签约额",2000,400,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
