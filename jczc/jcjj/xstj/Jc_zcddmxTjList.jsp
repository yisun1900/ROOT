...
<table class="LockHeadTable" ROWHEADNUM=1 COLHEADNUM=3 ROWHEADSTYLE="background:#CC6600; color:white;" COLHEADSTYLE="background:#CCCCCC; color:black;" FOCUSSTYLE="background-image: url(/images/bg.normal.gif);" width="100%" border="1" cellpadding="3" cellspacing="0" align="center" style="FONT-SIZE:12">
...
%>
	...
	<td  width="10%" >合同金额</td>
	<td  width="8%" >增减后数量</td>
	<td  width="10%" >增减后金额</td>
	<td  width="10%" >计入促销活动金额</td>
	<td  width="20%" >合同金额所占比率</td>
</tr>
<%
