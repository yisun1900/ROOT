...
try {
	...
	if (rs.next())
	{
		khcz=rs.getDouble("khcz");
		mbcz=rs.getDouble("mbcz");
	}
	rs.close();
	ps.close();
  ...
  <B>店面月运营统计</B><BR>
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
      ...
      <tr> 
        ...
        <td colspan="5"> 
          <textarea name="byczsm" cols="73" rows="3"></textarea>
        </td>
      </tr>
      <tr> 
        <td align="right" width="17%"><font color="#FF0033">*</font>店面经理次月产值说明</td>
        <td colspan="5"> 
          <textarea name="cyczsm" cols="73" rows="3"></textarea>
        </td>
      </tr>
      <tr> 
        <td align="right" width="17%"><font color="#FF0033">*</font>分总意见</td>
        <td colspan="5"> 
          <textarea name="fzyj" cols="73" rows="3"></textarea>
        </td>
      </tr>
