...
<tr bgcolor="#CCCCCC"  align="center" class="STYLE_TR">
  ...
  <td  width="8%" class="STYLE2">未打折金额(工程+税金+管理费)</td>
  <td  width="8%" class="STYLE2">签单总额(工程+税金+管理费)</td>
  <td  width="7%" class="STYLE2">退单额</td>
  <td  width="8%" class="STYLE2">业绩(签单－退单)</td>
  ...
  <td  width="5%" class="STYLE2">折扣率</td>
</tr>
<%
	int allqys=0;
	double allwdzgce=0;
...
<tr bgcolor="#CCCCCC"  align="center" class="STYLE_TR">
  ...
  <td  width="12%" class="STYLE1">分公司</td>
  <td  width="5%" class="STYLE2">签约数</td>
  <td  width="9%" class="STYLE2">未打折金额(工程+税金+管理费)</td>
  <td  width="9%" class="STYLE2">签单总额(工程+税金+管理费)</td>
  <td  width="8%" class="STYLE2">退单额</td>
  <td  width="9%" class="STYLE2">业绩(签单－退单)</td>
  <td  width="5%" class="STYLE2">签约数比例</td>
  <td  width="5%" class="STYLE2">签约额比例</td>
  <td  width="8%" class="STYLE2">增减项</td>
...
<tr bgcolor="#CCCCCC"  align="center" class="STYLE_TR">
  <td  width="4%" class="STYLE1">排名</td>
  <td  width="12%" class="STYLE1">大区</td>
  <td  width="5%" class="STYLE2">签约数</td>
  <td  width="9%" class="STYLE2">未打折金额(工程+税金+管理费)</td>
  <td  width="9%" class="STYLE2">签单总额(工程+税金+管理费)</td>
  <td  width="8%" class="STYLE2">退单额</td>
