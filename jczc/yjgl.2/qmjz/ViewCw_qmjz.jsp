...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" where cw_qmjzmx.jzrq=TO_DATE('"+jzrq+"','YYYY-MM-DD') and cw_qmjzmx.fgsbh=a.dwbh(+) and cw_qmjzmx.dwbh=b.dwbh(+) and cw_qmjzmx.sgd=sq_sgd.sgd(+)";
...
/*
//设置显示列
	String[] disColName={"jzrq","khbh","zt","khxm","hth","sjs","wdzgce","qye","suijin","suijinbfb","sjf","glf","guanlif","hbqye","zjxje","zhzjxje","zjxsuijin","kglf","kqtk","zkl","cxhdbm","qyrq","tdsj","sgd","zjxm","sfke","jzkfkcs","jzkscsj","jzkfksj","cwsfke","cwjzkfkcs","cwjzkscsj","cwjzkfksj","ywy","fgsbh","dwbh"};
