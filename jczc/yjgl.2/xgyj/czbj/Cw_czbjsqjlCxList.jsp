...
%>
   ...
   <tr bgcolor="#CCCCCC"  align="center"> 
    ...
    <td rowspan="2" width="2%">客户编号</td>
    <td rowspan="2" width="3%">合同号</td>
    <td rowspan="2" width="3%">客户姓名</td>
    <td rowspan="2" width="7%">房屋地址</td>
    ...
    <td colspan="9" bgcolor="#CCCC99">更新前</td>
    <td colspan="9" bgcolor="#CCCCFF">更新后</td>
    <td rowspan="2" width="9%">备注</td>
  </tr>
  <tr bgcolor="#CCCCCC"  align="center"> 
    <td  width="3%" bgcolor="#CCCC99">工程原报价</td>
    ...
    <td  width="2%" bgcolor="#CCCC99">服务费</td>
    <td  width="3%" bgcolor="#CCCC99">折前管理费</td>
    <td  width="3%" bgcolor="#CCCC99">折后管理费</td>
    <td  width="3%" bgcolor="#CCCCFF">工程原报价</td>
    ...
    <td  width="2%" bgcolor="#CCCCFF">服务费</td>
    <td  width="3%" bgcolor="#CCCCFF">折前管理费</td>
    <td  width="3%" bgcolor="#CCCCFF">折后管理费</td>
  </tr>
<%
	pageObj.printDate();
	pageObj.printFoot();
