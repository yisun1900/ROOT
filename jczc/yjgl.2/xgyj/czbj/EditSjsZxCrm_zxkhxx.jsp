              ...
              <td colspan="4" > 
                <div align="center"> 
                  <p> 
                    ...
                    <input type="button"  value="导Excel" onClick="f_excel(editform)" <%=bjdysq%>>
				  </p>
                  <p> 
                    <input type="button"  value="选报价项目" onClick="f_xzxm(editform)">
                    <input type="button"  value="整体调项目顺序" onClick="f_xmpx(editform)">
                    <input type="button"  value="按房间调项目顺序" onClick="f_fjxmpx(editform)" >
