...
if (!xghqdjzsjStr.equals(""))
{
	...
	if (!lday.equals(xghqdjzsjStr))
	{
		out.println("<BR>错误！[修改后签单结转时间]非当月最后一天『"+lday+"』");
		return;
	}
...
if (!xghtdjzsjStr.equals(""))
{
	...
	String lday=cf.lastDay(nian,yue);
	if (!lday.equals(xghtdjzsjStr))
	{
		out.println("<BR>错误！[修改后退单结转时间]非当月最后一天『"+lday+"』");
		return;
	}
...
/*
	...
	{
		out.println("错误！[签单结转时间]已改变，不能修改，可能您已经存盘了");
		return;
	}
...
*/
	...
	if (xghqdjzsj!=null)
	{
		...
		ls_sql+=" select ?,khbh,'2',khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh";
		ls_sql+=" FROM crm_khxx";
		ls_sql+=" where khbh='"+khbh+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.setDate(1,xghqdjzsj);
	...
	{
		ls_sql="insert into cw_qmjzmx (jzrq,khbh,zt,khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh)";
		ls_sql+=" select ?,khbh,'3',khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh";
		ls_sql+=" FROM crm_khxx";
		ls_sql+=" where khbh='"+khbh+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.setDate(1,xghtdjzsj);
