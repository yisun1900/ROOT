...
<CENTER >
  <B><font size="3">客户合并（<font color="#FF0000"><b>把两个客户资料合并在一起，删除一个，保留一个</b></font>）</font></B>
</CENTER>
...
%>
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 13px'>
    <tr height="25" align="center" bgcolor="#E8E8FF"> 
      <td colspan="3"><b><font color="#990099" size="4">保留客户（客户编号：<%=khbh%>）</font></b></td>
    </tr>
...
<P>
  <table border="1" width="100%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 13px'>
    <tr height="25" align="center" bgcolor="#CCCCCC"> 
      <td colspan="3"><b><font color="#0000CC" size="4">删除客户（客户编号：<%=khbh2%>）</font></b></td>
    </tr>
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="1" style='FONT-SIZE: 13px'>
    <tr height="25" align="center" bgcolor="#CCCCCC"> 
      <td colspan="3" height="38"> 
        ...
        <input type="button" value="开始合并客户" onClick="f_do(insertform)">
