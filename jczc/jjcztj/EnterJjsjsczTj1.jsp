...
try {
	...
	ps.setString(3,xtrzyhmc+"：家居设计师业绩统计");
	ps.executeUpdate();
	ps.close();
}
catch (Exception e) {
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">家居设计师业绩统计</div>
      </td>
    </tr>
    <tr> 
...
%> </td>
    ...
    <tr> 
      <td align="right" width="42%" height="39">家居设计师</td>
      <td width="58%" height="39"> <%
 ...
 %> </td>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="家居产值统计" onClick="f_do(selectform)" name="jjcz">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="JjsjsCztjb.jsp";
	FormName.submit();
