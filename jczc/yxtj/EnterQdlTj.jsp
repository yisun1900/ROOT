...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">登记部门</td>
      <td width="58%" height="39"> 
...
%> 
    ...
    <tr>
      <td align="right" width="42%" height="39">时间间隔</td>
      <td width="58%" height="39">
        <input type="text" name="sjjg" size="17" maxlength="10" value="30">
        天 </td>
    </tr>
    <tr> 
      <td align="right" width="42%" height="39">统计时间 从</td>
      <td width="58%" height="39"> 
        <input type="text" name="sjfw" size="20" maxlength="10" value="2006-03-01">
      </td>
    </tr>
    <tr> 
      <td align="right" width="42%" height="40">到</td>
      <td width="58%" height="40"> 
        <input type="text" name="sjfw2" size="20" maxlength="10"  value="2006-11-30">
      </td>
    </tr>
    <tr> 
...
{
	if(	javaTrim(FormName.sjjg)=="") {
		alert("请输入[时间间隔 ]！");
		FormName.sjjg.focus();
		return false;
	}
	if(!(isNumber(FormName.sjjg, "时间间隔 "))) {
		return false;
	}
