...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF"  align="center">
			...
			<td><%=sjkgrq%></td>
			<td><%=dwmc%></td>
			<td><A HREF="ViewCrm_hfjl.jsp?khbh=<%=khbh%>&hfsj=<%=hfsj%>&hfsj2=<%=hfsj2%>" target="_blank"><%=sl%></A></td>
		</tr>
		<%
	}
	rs.close();
...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF"  align="center">
			...
			<td><%=lrsj%></td>
			<td><%=zxztmc%></td>
			<td><A HREF="ViewCrm_zxhfjl.jsp?khbh=<%=khbh%>&hfsj=<%=hfsj%>&hfsj2=<%=hfsj2%>" target="_blank"><%=sl%></A></td>
		</tr>
		<%
	}
	rs.close();
