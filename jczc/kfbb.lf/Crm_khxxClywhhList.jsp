...
%>
	...
	<CENTER >
	  <B><font size="3">已签单－超两个月未回访客户</font></B>
	</CENTER>
...
<%
	...
	ls_sql+=" and ((TRUNC(SYSDATE)-crm_khxx.zxhfsj>=60) OR (crm_khxx.zxhfsj is null and TRUNC(SYSDATE)-crm_khxx.qyrq>=60))";
	ls_sql+=wheresql;
...
%>
	...
	<CENTER >
	  <B><font size="3">咨询客户－超两个月未回访</font></B>
	</CENTER>
...
<%
	...
	ls_sql+=" and ((TRUNC(SYSDATE)-crm_zxkhxx.zxhfsj>=60) OR (crm_zxkhxx.zxhfsj is null and TRUNC(SYSDATE)-crm_zxkhxx.lrsj>=60))";
	ls_sql+=wheresql1;
