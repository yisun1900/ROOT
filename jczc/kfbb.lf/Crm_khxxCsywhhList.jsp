...
%>
	...
	<CENTER >
	  <B><font size="3">已签单－超三个月未回访客户</font></B>
	</CENTER>
...
<%
	...
	ls_sql+=" and ((TRUNC(SYSDATE)-crm_khxx.zxhfsj>=90) OR (crm_khxx.zxhfsj is null and TRUNC(SYSDATE)-crm_khxx.qyrq>=90))";
	ls_sql+=wheresql;
...
%>
	...
	<CENTER >
	  <B><font size="3">咨询客户－超三个月未回访</font></B>
	</CENTER>
...
<%
	...
	ls_sql+=" and ((TRUNC(SYSDATE)-crm_zxkhxx.zxhfsj>=90) OR (crm_zxkhxx.zxhfsj is null and TRUNC(SYSDATE)-crm_zxkhxx.lrsj>=90))";
	ls_sql+=wheresql1;
