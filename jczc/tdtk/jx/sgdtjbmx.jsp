...
<%	
	int[] mark={3,1,1,1,1,2,4};//设置显示风格参数
	//0:空;1：合并列，无小计；2：数值列，需小计、总计；3：合并列，有小计；4：不合并列；5：列名在小计中显示

	ls_sql="SELECT sgdmc,khxm,sjs,dwmc,fssj,crm_zjxdj.zjje,zjxyysm";
	ls_sql+=" FROM crm_zjxdj,crm_khxx,sq_dwxx,sq_sgd ";
    ls_sql+=" where crm_zjxdj.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd and crm_zjxdj.lrdw=sq_dwxx.dwbh(+)";
