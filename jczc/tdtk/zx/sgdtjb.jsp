...
//	out.println(ls_sql);
	...
	ls_sql+=" FROM (";
	ls_sql+=" SELECT b.dwmc fgs,sgdmc dm,count(*) sl,sum(zjje) je,'<A HREF=\"ViewSgdtd.jsp?sjfw="+sjfw+"&sjfw2="+sjfw2+"&dwbh='||crm_khxx.sgd||'\" target=\"_blank\"><img src=\"/images/ColuGif.gif\" width='||sum(zjje)*200/"+all+"||' height=14></A>' as tx";
	ls_sql+=" FROM crm_zjxdj,crm_khxx,sq_sgd,sq_dwxx b";
	ls_sql+=" where crm_zjxdj.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd and crm_khxx.fgsbh=b.dwbh";
	ls_sql+=" and crm_zjxdj.fssj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=" and crm_zjxdj.fssj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	ls_sql+=" and crm_zjxdj.zjje>0";
	if (fgs!=null)
	...
	ls_sql+=" group by b.dwmc,crm_khxx.sgd,sgdmc";
