  ...
  <tr align="center">
    <td colspan="3">
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 12px'>
		...
		ls_sql+=" FROM crm_zjxdj,crm_zjxyydj,crm_khxx,dm_zjxyybm ";
		ls_sql+=" where crm_zjxdj.zjxxh=crm_zjxyydj.zjxxh and crm_zjxdj.khbh=crm_khxx.khbh and crm_zjxyydj.zjxyybm=dm_zjxyybm.zjxyybm ";
