...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">增项时间 从</td>
      <td width="58%" height="39"> 
    ...
    <tr align="center"> 
      <td height="96" colspan="2"> 
        <p>
          <input type="button"  value="施工队增项统计" onClick="f_do(selectform,'sgdtd')">
          <input type="button"  value="施工队增项明细" onClick="f_do(selectform,'sgdtdmx')">
        </p>
        <p>
          <input type="button"  value="增项原因分析" onClick="f_do(selectform,'tdyy')">
        </p>
        </td>
    </tr>
  </table>
