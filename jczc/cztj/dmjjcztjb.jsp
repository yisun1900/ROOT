...
*/
			...
			ls_sql+=" where crm_zxkhxx.zxzt in ('3') and crm_zxkhxx.zxdm='"+dmbh+"'";
		    ...
		    ls_sql+=" and crm_zxkhxx.zxzt in ('0','1','5') and zxdm='"+dmbh+"'";
			ls_sql+=" and crm_zxkhxx.jlfdjsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
			ls_sql+=" and crm_zxkhxx.jlfdjsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
			ps1= conn.prepareStatement(ls_sql);
			rs1 =ps1.executeQuery();
			...
			ls_sql=" SELECT count(*)";
			ls_sql+=" FROM crm_zxkhxx";
			ls_sql+=" where crm_zxkhxx.hddjbz='Y' and crm_zxkhxx.zxdm='"+dmbh+"'";
		    ls_sql+="  and crm_zxkhxx.zxzt in ('0','1','5') ";
			ls_sql+=" and crm_zxkhxx.jhddjsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
			ls_sql+=" and crm_zxkhxx.jhddjsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
			ps1= conn.prepareStatement(ls_sql);
		...
		ls_sql+=" where qddm='"+dmbh+"'";
			...
			%> 
			  <tr align="center" > 
				...
				<td  align="right"><A HREF="ViewSdjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=sdjs%></A></td>
				<td  align="right"><A HREF="ViewBqsdjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=bqsdjs%></A></td>
				<td  align="right"><A HREF="ViewLjsdjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljsdjs%></A></td>
				<td  align="right"><A HREF="ViewScxhddjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=scxhddjs%></A></td>
				<td  align="right"><A HREF="ViewBqscxhddjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=bqscxhddjs%></A></td>
				<td  align="right"><A HREF="ViewLjscxhddjs.jsp?dwbh=<%=dmbh%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljscxhddjs%></A></td>
