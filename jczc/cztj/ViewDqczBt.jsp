...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.pie3D(ls_sql,"自营大区产值占比",950,580,1,request,session);
%>
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.pie3D(ls_sql,"加盟大区产值占比",950,580,1,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.pie3D(ls_sql,"全部(自营加盟商)大区产值占比",950,580,1,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
