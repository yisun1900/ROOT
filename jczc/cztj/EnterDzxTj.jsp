...
%> 
    ...
    <tr align="center"> 
      <td height="41" colspan="4"> 
		<input type="button"  value="统计1" onClick="f_do5(selectform,5)">
		<input type="button"  value="统计2" onClick="f_do5(selectform,6)">
...
function f_do5(FormName,flag)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.sjfw)=="") {
		alert("请输入[时间范围]！");
		FormName.sjfw.focus();
	...
	if (FormName.qye.value!="" || FormName.qye2.value!="")
	{
		...
		if(flag==5)
		FormName.action="dzxtjb5.jsp";
		if(flag==6)
		FormName.action="dzxtjb6.jsp";
	}
