...
<%
	...
	ls_sql="SELECT '',crm_zxkhxx.lfdj,TO_CHAR(crm_zxkhxx.jlfdjsj,'YYYY-MM-DD') jlfdjsj,crm_zxkhxx.khbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,DECODE(crm_zxkhxx.jzbz,'1','家装','2','公装') jzbz,crm_zxkhxx.cxhdbm,b.dwmc ssfgs,a.dwmc qydm,TO_CHAR(crm_zxkhxx.lrsj,'YYYY-MM-DD HH24:MI') lrsj";
	ls_sql+=" FROM crm_zxkhxx,sq_dwxx a,sq_dwxx b";
	ls_sql+=" where crm_zxkhxx.lfdjbz='Y' and crm_zxkhxx.zxdm='"+dwbh+"'";
...
<CENTER >
  <B><font size="3">本期收量房订金数（未签单）（<%=sjfw%>－－<%=sjfw2%>）</B>
</CENTER>
