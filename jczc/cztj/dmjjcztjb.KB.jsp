...
<table border="1" width="2432" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
  <tr bgcolor="#CCCCCC"  align="center">
    ...
    <td colspan="4">家装</td>
    <td colspan="9"><strong>旧产品体系</strong></td>
    <td colspan="9"><strong>新产品体系</strong></td>
  </tr>
  <tr bgcolor="#CCCCCC"  align="center">
    <td  width="80">松下亿达</td> 
    <td  width="100">松下亿达</td>
    <td  width="100">松下亿达</td>
    <td  width="100">合计</td>
    <td  width="100">橱柜</td>
    <td  width="100">内门</td>
    ...
    <td  width="100">家具</td>
    <td  width="70">沙发/床</td>
    <td  width="70">窗帘/布艺</td>
    <td  width="70">地板/楼梯</td>
    <td  width="70">壁纸/壁布</td>
    <td  width="70">合计</td>

    <td  width="100">散热器、地采暖、中央空调</td>
    <td  width="100">大理石、磁砖</td>
    <td  width="100">智能系统、家庭影院、开关插座</td>
    <td  width="100">钢结构</td>
    <td  width="100">园林景观</td>
	
	
	<td  width="100">顶线、石膏线、地漏</td>
    <td  width="100">灯具饰品</td>
    <td  width="70">壁炉、门窗等产品</td>
    <td  width="70">合计</td>
  </tr>
  <%
