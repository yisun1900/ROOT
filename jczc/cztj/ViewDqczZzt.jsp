...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"自营大区产值对比","","签约额",950,300,request,session);
%>
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"加盟大区产值对比","","签约额",950,300,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
...
//	out.println(ls_sql);
	...
	jpgFileName =yblc.bar(ls_sql,"全部(自营加盟商)大区产值对比","","签约额",950,300,request,session);
%>
	<img src="<%=jpgFileName%>" border=0 >
