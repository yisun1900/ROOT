...
*/
			...
			ls_sql+=" where crm_khxx.zt in ('2','5') and crm_khxx.dwbh='"+dmbh+"'";
			...
			ls_sql+=" where crm_zxkhxx.lfdjbz not in ('N','T') ";
			...
			ls_sql=" SELECT count(*)";
			ls_sql+=" FROM crm_zxkhxx";
			ls_sql+=" where crm_zxkhxx.lfdjbz not in ('T','N') and crm_zxkhxx.zxdm='"+dmbh+"'";
			...
			ls_sql=" SELECT count(*)";
			ls_sql+=" FROM crm_zxkhxx";
			ls_sql+=" where crm_zxkhxx.hddjbz not in ('T','N') and crm_zxkhxx.zxdm='"+dmbh+"'";
		    ls_sql+="  and crm_zxkhxx.zxzt in ('0','1','5') ";
			ls_sql+=" and crm_zxkhxx.jhddjsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
			ls_sql+=" and crm_zxkhxx.jhddjsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
			ps1= conn.prepareStatement(ls_sql);
			...
			ls_sql+=" where crm_zxkhxx.hddjbz not in ('T','N') and crm_zxkhxx.zxdm='"+dmbh+"'";
		       ls_sql+="  and crm_zxkhxx.zxzt in ('0','1','5') and crm_khxx.dwbh='"+dmbh+"'";
			ps1= conn.prepareStatement(ls_sql);
			rs1 =ps1.executeQuery();
			if (rs1.next())
			{	
		...
		ls_sql+=" where qddm='"+dmbh+"'";
			...
			%> 
			  <tr align="center" > 
				...
				<td  align="right"><%=bqsdjs%></td>
				<td  align="right"><%=ljsdjs%></td>
				<td  align="right"><%=scxhddjs%></td>
				<td  align="right"><%=bqscxhddjs%></td>
				<td  align="right"><%=ljscxhddjs%></td>
