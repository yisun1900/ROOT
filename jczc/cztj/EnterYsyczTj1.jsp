...
String zwbm=(String)session.getAttribute("zwbm");//08:家居顾问;10:项目专员;12:家居设计师;18:木门测量师;20:预算员
...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">预算员</td>
      <td width="58%" height="39"> <%
	if (zwbm.equals("20"))//20:预算员
	{
		%> 
        <input type="text" name="ysy" maxlength="20" size="20" value="<%=yhmc%>" readonly>
        <%
	}
	else{
		%> 
        <input type="text" name="ysy" maxlength="20" size="20">
        <%
	}
 %> </td>
    </tr>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="签单统计" onClick="f_do(selectform)" name="jzcz">
