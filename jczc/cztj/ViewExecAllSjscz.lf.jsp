...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">设计费</td>
	<td  width="3%">实收款</td>
	<td  width="3%">设计师考核业绩</td>
	<td  width="3%">设计师提成业绩</td>
...
try {
	...
	for (int i=0;i<sjs.length ;i++ )
	{
		...
		ls_sql="SELECT fgsbh,cxhdbm,cxhdbmxq,cxhdbmzh,sjs,hth,khxm,fwdz,sgdmc,zjxm,DECODE(crm_khxx.jzbz,'1','家装','2','工装') jzbz";
		...
		while (rs.next())
		{
			...
			if (!cxhdmc.equals(""))
			{
				...
				ls_sql=" select yjxs";
				ls_sql+=" from jc_cxhdyjxs";
				ls_sql+=" where jc_cxhdyjxs.fgsbh='"+fgsbh+"' and jc_cxhdyjxs.cxhdmc='"+cxhdmc+"' and jc_cxhdyjxs.yjxsbm='05'";
				ps1= conn.prepareStatement(ls_sql);
				rs1 =ps1.executeQuery();
				if (rs1.next())
				{
			...
			if (!cxhdbmxq.equals(""))
			{
				...
				ls_sql=" select yjxs";
				ls_sql+=" from jc_cxhdyjxs";
				ls_sql+=" where jc_cxhdyjxs.fgsbh='"+fgsbh+"' and jc_cxhdyjxs.cxhdmc='"+cxhdbmxq+"' and jc_cxhdyjxs.yjxsbm='05'";
				ps1= conn.prepareStatement(ls_sql);
				rs1 =ps1.executeQuery();
				if (rs1.next())
				{
			...
			if (!cxhdbmzh.equals(""))
			{
				...
				ls_sql=" select yjxs";
				ls_sql+=" from jc_cxhdyjxs";
				ls_sql+=" where jc_cxhdyjxs.fgsbh='"+fgsbh+"' and jc_cxhdyjxs.cxhdmc='"+cxhdbmzh+"' and jc_cxhdyjxs.yjxsbm='05'";
				ps1= conn.prepareStatement(ls_sql);
				rs1 =ps1.executeQuery();
				if (rs1.next())
				{
			...
			{
				sjskhyj=ze-ze*(10-yjxs11)/10-ze*(10-yjxs21)/10-ze*(10-yjxs31)/10;
				sjstcyj=ze-ze*(10-yjxs12)/10-ze*(10-yjxs22)/10-ze*(10-yjxs32)/10;
			}
			else{
				sjskhyj=qye-gsfje;
				sjstcyj=qye-gsfje;
		...
		<tr bgcolor="#FFFFFF"  align="center">
			...
			<td><%=cf.formatDouble(xjsjstcyj)%></td>
...
<tr bgcolor="#FFFFFF"  align="center">
	...
	<td><%=cf.formatDouble(allsjstcyj)%></td>
