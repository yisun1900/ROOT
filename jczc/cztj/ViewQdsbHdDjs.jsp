...
<%
	...
	ls_sql="SELECT crm_zxkhxx.khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过'),crm_zxkhxx.khxm,crm_zxkhxx.fwdz,crm_zxkhxx.sjs,crm_zxkhxx.ywy,dwmc,TO_CHAR(crm_zxkhxx.lrsj,'YYYY-MM-DD HH24:MI'),crm_zxkhxx.jhddjsj,crm_zxkhxx.hddj";
