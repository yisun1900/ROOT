...
%> </td>
    ...
    <tr align="center"> 
      <td height="71" colspan="4"> 
        ...
        <input type="button"  value="房屋面积统计1" onClick="f_do(selectform,'1')" >
        <input type="button"  value="房屋面积统计2" onClick="f_do(selectform,'2')" >
