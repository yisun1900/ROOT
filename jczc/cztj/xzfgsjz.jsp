...
{
	%>
    <input type="button"  value="分公司产值-表格" onClick="f_fgs(selectform,'bg')">
    </p>
  <p>
    <input type="button"  value="分公司产值-饼图" onClick="f_fgs(selectform,'bt')">
  </p>
  <p>
    <input type="button"  value="分公司产值-柱状图" onClick="f_fgs(selectform,'zzt')">
    <%
...
<!--
function f_fgs(FormName,lx)//参数FormName:Form的名称
{
	if (lx=="bg")
	{
