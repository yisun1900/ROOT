...
<DIV onselectstart="return false" style="BORDER-RIGHT: #808080 2px solid; BORDER-TOP: #808080 2px solid; DISPLAY: inline; OVERFLOW: auto; BORDER-LEFT: #808080 2px solid; WIDTH: 100%; CURSOR: default; BORDER-BOTTOM: #808080 2px solid; HEIGHT: 100%"> 
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		ls_sql+=" where crm_khxx.fgsbh=sq_dwxx.dwbh(+) and crm_khxx.khbh=cw_khfkjl.khbh and crm_khxx.zt in('2','5')";
