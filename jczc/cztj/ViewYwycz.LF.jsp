...
<%
	...
	ls_sql="SELECT '',ywy,hth,khxm,fwdz,DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.cxhdbm,wdzgce,TO_CHAR(zkl),qye,zjxje,NVL(zjxje,0)+qye,sjf,sfke,ROUND(crm_khxx.wdzgce*jc_cxhd.yjzkl/10,2),ROUND(crm_khxx.wdzgce*jc_cxhd.dmzkl/10,2),ROUND(crm_khxx.wdzgce*jc_cxhd.zlzkl/10,2),ROUND(crm_khxx.wdzgce*jc_cxhd.sjszkl/10,2),ROUND(crm_khxx.wdzgce*jc_cxhd.ywyzkl/10,2),DECODE(crm_khxx.sffj,'Y','返卷','N','否'),crm_khxx.fjje,crm_khxx.gsfje,DECODE(crm_khxx.sfyrz,'Y','认证','N','否'),b.dwmc rzsc,a.dwmc qydm,TO_CHAR(lrsj,'YYYY-MM-DD HH24:MI') lrsj,TO_CHAR(qyrq,'YYYY-MM-DD'),DECODE(TO_CHAR(lrsj,'MM')-TO_CHAR(qyrq,'MM'),0,'是','<font color=\"#FF0000\">跨月</font>'),sgdmc sgd,zjxm";
	...
	ls_sql+=" SELECT '',ywy,hth,khxm,fwdz,DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.cxhdbm,wdzgce,TO_CHAR(zkl),qye,zjxje,NVL(zjxje,0)+qye,sjf,sfke,qye-NVL(gsfje,0),qye-NVL(gsfje,0),qye-NVL(gsfje,0),qye-NVL(gsfje,0),qye-NVL(gsfje,0) ywyqye,DECODE(crm_khxx.sffj,'Y','返卷','N','否'),crm_khxx.fjje,crm_khxx.gsfje,DECODE(crm_khxx.sfyrz,'Y','认证','N','否'),b.dwmc rzsc,a.dwmc qydm,TO_CHAR(lrsj,'YYYY-MM-DD HH24:MI') lrsj,TO_CHAR(qyrq,'YYYY-MM-DD'),DECODE(TO_CHAR(lrsj,'MM')-TO_CHAR(qyrq,'MM'),0,'是','<font color=\"#FF0000\">跨月</font>'),sgdmc sgd,zjxm";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_dwxx b,sq_sgd,jc_cxhd";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.rzsc=b.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) ";
    ls_sql+=" and crm_khxx.ywy='"+ywy+"' and crm_khxx.fgsbh='"+fgsbh+"'";
	ls_sql+=" and crm_khxx.zt in('2','5')";
