...
%> 
    ...
    <tr>
      <td align="right" width="42%" height="39">回单类型</td>
      <td width="58%" height="39">
        <select name="hdbz" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="cf_hdbz(insertform)" onKeyUp="keyGo(bz)">
          <%
	cf.selectToken(out,"2+设计师回单&3+施工队回单&4+老客户回单&5+员工回单&6+班长回单&7+售楼处&8+材料商&9+其他","3");
%> 
        </select>
	  </td>
    </tr>
    <tr> 
      <td align="right" width="42%" height="39">回单时间 从</td>
      <td width="58%" height="39"> 
