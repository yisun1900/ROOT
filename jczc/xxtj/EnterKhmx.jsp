  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">客户咨询资料完整性分析</div>      </td>
    </tr>
    <tr>
...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="有效性统计" onClick="f_do(selectform,'yxxfx')">
		<input type="button"  value="完整性明细分析" onClick="f_do(selectform,'wzxfx')">      </td>
    </tr>
  </table>
</form>
</body>
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (lx=='yxxfx')
	{
		FormName.action="YxxTj.jsp";
	}
	else if (lx=='wzxfx')
	{
		FormName.action="WzxTj.jsp";
	}
