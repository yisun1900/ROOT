...
<%
if (cf.check((String)session.getAttribute("yhdlm"),request.getRemoteHost(),"090509")==0) 
{
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (skfw!=null)
	{
		...
		if (skfw.equals("1"))
		{
			wheresql+=" and  (cw_khfkjl.fklxbm in('51','52','53'))";
		}
		else if (skfw.equals("2"))
		{
			wheresql+=" and  (cw_khfkjl.fklxbm not in('51','52','53'))";
		}
	}
	...
	ls_sql="SELECT crm_zxkhxx.khbh,crm_zxkhxx.khxm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过'),sum(cw_khfkjl.fkje),crm_zxkhxx.fwdz,b.dwmc as zxdm,crm_zxkhxx.sjs,khjl,ywy,dzbjze,bjjbmc,lfdj,jlfdjsj,cxhdbm,hddj,jhddjsj,sjf,jsjfsj,lfsj,ctsj,cxgtsj,csgtsj,DECODE(crm_zxkhxx.jzbz,'1','家装','2','公装'),crm_zxkhxx.lrsj,fwlxmc";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zxkhxxJdmxList.jsp","","","");
	if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
	{
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">报价级别</td>
	<td  width="4%">量房订金</td>
	<td  width="4%">交量房订金时间</td>
	<td  width="7%">参加促销活动</td>
	<td  width="4%">活动订金</td>
	<td  width="4%">交活动订金时间</td>
	<td  width="4%">实收设计费</td>
