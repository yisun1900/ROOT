...
<%
	...
	ls_sql+=" where crm_tsjl.tsjlh=crm_tsbm.tsjlh and crm_tsbm.tsxlbm=dm_tsxlbm.tsxlbm and crm_tsjl.lx='1'";//1：投诉；2：报修
	ls_sql+=" and crm_tsbm.tslxbm=dm_tslxbm.tslxbm and crm_tsbm.tslxbm!='23'";
  ...
  <tr>
    <td> 
      <CENTER >
        <B>（<%=tslxmc%>：<%=tsxlmc%>）投诉率统计(<%=sjfw%>--<%=sjfw2%>)</B> 
      </CENTER>
