...
<%
	...
	String dwstr=cf.getItemData("select dwbh,dwmc,ssdw from sq_dwxx where dwlx in('A1','F1','F2') order by ssdw,dwbh");
%>
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">各部门投诉报修汇总表</div>
      </td>
    </tr>
    <tr> 
...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        ...
        <input type="button"  value="明细" onClick="f_hz(selectform,'mx')">
      </td>
    </tr>
  </table>
</form>
