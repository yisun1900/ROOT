...
<%
	...
	ls_sql+=" where crm_tsjl.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd(+) and crm_tsjl.lx='2'";
	ls_sql+=" and slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw+"','YYYY-MM-DD')+7";
	...
	ls_sql+=" FROM crm_tsjl,crm_khxx,sq_sgd";
	ls_sql+=" where crm_tsjl.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd(+) and crm_tsjl.lx='2'";
	ls_sql+=" and slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')+8";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw+"','YYYY-MM-DD')+14";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	if (fgs!=null)
	{
		if (!(fgs.equals("")))	ls_sql+=" and  (crm_khxx.dwbh in(select dwbh from sq_dwxx where dwlx='F2' and ssdw='"+fgs+"'))";
	...
	ls_sql+=" FROM crm_tsjl,crm_khxx,sq_sgd";
	ls_sql+=" where crm_tsjl.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd(+) and crm_tsjl.lx='2'";
	ls_sql+=" and slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')+15";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw+"','YYYY-MM-DD')+21";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	if (fgs!=null)
	{
		if (!(fgs.equals("")))	ls_sql+=" and  (crm_khxx.dwbh in(select dwbh from sq_dwxx where dwlx='F2' and ssdw='"+fgs+"'))";
	...
	ls_sql+=" FROM crm_tsjl,crm_khxx,sq_sgd";
	ls_sql+=" where crm_tsjl.khbh=crm_khxx.khbh and crm_khxx.sgd=sq_sgd.sgd(+) and crm_tsjl.lx='2'";
	ls_sql+=" and slsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')+22";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw+"','YYYY-MM-DD')+31";
	ls_sql+=" and slsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
	if (fgs!=null)
	{
		if (!(fgs.equals("")))	ls_sql+=" and  (crm_khxx.dwbh in(select dwbh from sq_dwxx where dwlx='F2' and ssdw='"+fgs+"'))";
