...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">可参观截止时间 从</td>
      <td width="58%" height="39"> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="样板间列表" onClick="f_do(selectform)" name="button">
        <input type="button"  value="样板间统计" onClick="f_do1(selectform)">
