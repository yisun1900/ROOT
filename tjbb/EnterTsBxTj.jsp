...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="投诉报修明细" onClick="f_do(selectform)" name="button">
        <input type="button"  value="投诉统计" onClick="f_do1(selectform)">
        <input type="button"  value="报修统计" onClick="f_do2(selectform)" name="button2">
