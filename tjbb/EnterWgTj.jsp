...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">完工时间 从</td>
      <td width="58%" height="39"> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="完工明细" onClick="f_do(selectform)">
        <input type="button"  value="增减项金额统计" onClick="f_do1(selectform)" name="button">
