...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hy_hyxxbZfList.jsp","SelectZfHy_hyxxb.jsp","","ZfHy_hyxxb.jsp");
...
//设置按钮参数
	String[] buttonName={"会员作废","取消作废"};//按钮的显示名称
	String[] buttonLink={"Hy_hyxxbZfList.jsp?sfzf=Y","Hy_hyxxbZfList.jsp?sfzf=N"};//按钮单击调用的网页，可以增加参数
