...
<form method="post" action="SaveSjjHy_hyxxb.jsp" name="editform">
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right"><font color="#0000CC">入会日期</font></td>
              <td width="35%"> 
                <input type="text" name="rhrq" size="20" maxlength="10"  value="<%=rhrq%>" >
              </td>
              <td width="15%" bgcolor="#FFFFFF" align="right"><font color="#0000CC">有效日期</font></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="15%"> 
                <div align="right"><font color="#0000CC">是否作废</font></div>
              </td>
              <td width="35%"><font color="#0000CC"> 
