...
String hykh=null;
	...
	ls_sql="SELECT khbh,hy_hyxxb.hykh,ywxh,cpbm,DECODE(cplb,'B','素金','A','镶嵌'),bkbh,plmc,bqj,sxj  ";
	ls_sql+=" FROM cp_cpxx1,hy_hyxxb,xt_plbm ";
	ls_sql+=" where cp_cpxx1.khbh=hy_hyxxb.hybh and khlx='1' and wlzt='05'";
...
<CENTER >
  <B><font size="2"><%=dwmc%>VIP销售</font></B>
  <BR>（<%=xsrq%>--<%=xsrq2%>）
</CENTER>
<%
	pageObject.out=out;
...
<%
	ls_sql="SELECT pmmc,count(*),'','','','','',sum(cp_cpxx1.bqj),sum(cp_cpxx1.sxj)";
	ls_sql+=" FROM cp_cpxx1,sq_dwxx,hy_hyxxb,xt_pmbm ";
	ls_sql+=" where cp_cpxx1.szdw=sq_dwxx.dwbh and cp_cpxx1.khbh=hy_hyxxb.hybh and khlx='1' and wlzt='05'";
	ls_sql+=" and cp_cpxx1.pmbm=xt_pmbm.pmbm ";
    ls_sql+=wheresql;
	ls_sql+=" group by cp_cpxx1.pmbm,pmmc";
	ls_sql+=" order by cp_cpxx1.pmbm";

    pageObject.sql=ls_sql;
//进行对象初始化
	pageObject.initPage("","","","");
	pageObject.setPageRow(50000);
...
<table width="100%" border="0" style='FONT-SIZE: 12px'>
  <tr height='30'>
    <td width="33%" height="30"><strong>制表：</strong></td>
    <td width="33%" height="30"><b>交货：</b></td>
    <td width="33%" height="30"><strong>收货：</strong></td>
  </tr>
  <tr height='30'>
    <td width="33%" height="30"><b>财务：</b></td>
    <td width="33%" height="30"><b>验收：</b></td>
    <td width="33%" height="30"><b>审批：</b></td>
  </tr>
</table>
</body>
</html>