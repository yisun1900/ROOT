...
<%
	...
	ls_sql="select cpdlmc,xt_plbm.plmc,count(*),sum(lsj),sum(bqj),sum(sxj)";
	ls_sql+="  from cp_cpxx1,xt_plbm,v_bk,xt_cpdlbm ";
	ls_sql+=wheresql;
...
//	out.println(ls_sql);
	...
	ls_sql+="  from cp_cpxx1,xt_plbm,v_bk  ";
	ls_sql+=wheresql;
	ls_sql+=" and cp_cpxx1.plbm=xt_plbm.plbm(+) and cp_cpxx1.bkbh=v_bk.bkbh(+)";
	ls_sql+="  and v_bk.bkflbm='501' ";
