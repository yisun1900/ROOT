...
try {
	...
	if (rs.next())
	{
		mddqbm=cf.fillNull(rs.getString("dqbm"));
	}
	rs.close();
	ps.close();
}
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertJxc_ckdSgd.jsp" name="insertform" >
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*<span class="STYLE2">出库</span></span><span class="STYLE2">分公司</span></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="bz" cols="71" rows="3"></textarea></td>
	...
	<input type="button" onClick="window.open('/jxcfc/sgdgl/ViewJxc_clsgd.jsp?sgph=<%=sgph%>')"  value="查看来源单信息"></td>
    </tr>
</table>
</form>
</body>
