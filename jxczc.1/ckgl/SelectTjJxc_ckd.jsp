...
<tr> 
     <td colspan="2" align="right" > 
		...
		<input type="button" onClick="f_do(selectform,'fgsblfx')"  value="分公司[使用比例]分析" ></td>
     <td colspan="2">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.cksj, "统计时间"))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.cksj2, "统计时间"))) {
		return false;
	}
	...
	else if (lx=="fgsblfx")
	{
		...
		FormName.action="Jxc_ckmxFgsBlFxList.jsp";
	}
	else if (lx=="khtj")
	{
	...
	else if (lx=="khblfx")
	{
		...
		FormName.action="Jxc_ckmxKhBlFxList.jsp";
	}
