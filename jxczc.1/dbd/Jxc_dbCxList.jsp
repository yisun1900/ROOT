...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	jxc_db_lrbm=request.getParameter("jxc_db_lrbm");
	if (jxc_db_lrbm!=null)
	{
		jxc_db_lrbm=cf.GB2Uni(jxc_db_lrbm);
		if (!(jxc_db_lrbm.equals("")))	wheresql+=" and  (jxc_db.lrbm='"+jxc_db_lrbm+"')";
	}
	ls_sql="SELECT jxc_db.dbph,DECODE(jxc_db.dbdzt,'0','未提交','1','提交等待审核','2','审核通过等待出库','3','已出库等待入库','7','审核未通过','9','入库完成'), DECODE(jxc_db.dbcllx,'0','主材','1','辅材'), DECODE(jxc_db.dbyy,'0','集团调货','1','退货调拨'),c.dqmc dcdq,a.dwmc dcgs,d.dqmc drdq,b.dwmc drgs,jxc_db.dbzsl, DECODE(jxc_db.jgzyk,'N','不经过','Y','经过'),ckmc,jxc_db.shr,jxc_db.shrq,jxc_db.shyj,jxc_db.lrr,jxc_db.lrsj,e.dwmc lrbm,jxc_db.nian,jxc_db.bz  ";
    ...
    ls_sql+=" and jxc_db.dbcllx='0'";//0：主材；1：辅材
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_dbCxList.jsp","","/jxcdy/dydbd.jsp","");
//	pageObj.setPageRow(10);//设置每页显示记录数
/*
//设置显示列
	String[] disColName={"dbph","jxc_db_dbcllx","jxc_db_dbyy","jxc_db_dcdq","jxc_db_dcgs","sq_dwxx_dwmc","jxc_db_drdq","jxc_db_drgs","jxc_db_jgzyk","jxc_db_djck","jxc_db_shr","jxc_db_shrq","jxc_db_shyj","jxc_db_dbdzt","jxc_db_lrr","jxc_db_lrsj","jxc_db_lrbm","jxc_db_nian","jxc_db_bz"};
