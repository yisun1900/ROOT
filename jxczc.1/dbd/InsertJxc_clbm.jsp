...
try {
	...
	ls_sql="select nbbm,clmc,xh,gg,DECODE(xsfs,'1','代销品','2','现货调拨','3','期货调拨','4','允许负库存') xsfsmc,xsfs,jldwbm,xsj,zxqdl,cldlbm,clxlbm,ppmc,jxc_cljgb.gysmc,zcpzsl,ccpzsl,bfpzsl,dhsl,ycgsl ";
...
<BR>
    ...
    <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td align="right" bgcolor="#FFFFFF"><span class="STYLE3">销售价</span></td>
        <td bgcolor="#FFFFFF"><%=xsj%></td>
      </tr>
