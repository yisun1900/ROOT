...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_db.dbph,DECODE(jxc_db.dbdzt,'0','未提交','1','提交等待审核','2','审核通过等待出库','3','已出库等待入库','7','审核未通过','9','入库完成'), DECODE(jxc_db.dbcllx,'0','主材','1','辅材'), DECODE(jxc_db.dbyy,'0','集团调货','1','退货调拨'),c.dqmc dcdq,a.dwmc dcgs,d.dqmc drdq,b.dwmc drgs,jxc_db.dbzsl, DECODE(jxc_db.jgzyk,'N','不经过','Y','经过'),jxc_db.djck,jxc_db.shr,jxc_db.shrq,jxc_db.shyj,jxc_db.lrr,jxc_db.lrsj,e.dwmc lrbm,jxc_db.nian,jxc_db.bz  ";
	ls_sql+=" FROM jxc_db,sq_dwxx a,sq_dwxx b,dm_dqbm c,dm_dqbm d,sq_dwxx e ";
    ...
    ls_sql+=" and jxc_db.dbdzt in('0','1') ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_dbList.jsp","","","EditJxc_db.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJxc_db.jsp","sctjdbd.jsp"};//按钮单击调用的网页，可以增加参数
