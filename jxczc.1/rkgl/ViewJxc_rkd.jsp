...
//	out.println(ls_sql);
	...
	if (rs.next())
	{
		...
		rkzje=cf.fillNull(rs.getString("rkzje"));
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">入库金额</td>
	<td  width="4%">正常品数量</td>
	<td  width="4%">正常品负库存入库数</td>
	<td  width="4%">残次品数量</td>
	<td  width="4%">残次品负库存入库数</td>
	<td  width="4%">报废品数量</td>
	<td  width="4%">报废品负库存入库数</td>
	<td  width="4%">厂家缺失数量</td>
	<td  width="4%">物流丢失数量</td>
	<td  width="5%">生产日期</td>
	<td  width="6%">生产批号</td>
	<td  width="6%">入库货架</td>
	<td  width="6%">入库货位</td>
...
<%
	...
	ls_sql="SELECT jxc_rkmx.rkxh,jxc_rkmx.clbm,nbbm,clmc,xh,gg,TO_CHAR(jxc_rkmx.rkj),jxc_rkmx.rksl,jxc_rkmx.rkje,jxc_rkmx.zcpsl,jxc_rkmx.zcpfkcsl,jxc_rkmx.ccpsl,jxc_rkmx.ccpfkcsl,jxc_rkmx.bfpsl,jxc_rkmx.bfpfkcsl,jxc_rkmx.thpsl,jxc_rkmx.wldssl,to_char(scrq,'YYYY-MM-DD'),scph,hjmc,hwmc ";
