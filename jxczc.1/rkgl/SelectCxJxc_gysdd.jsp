...
<body bgcolor="#FFFFFF">
<form method="post" action="Jxc_gysddCxList.jsp" name="selectform">
<div align="center">供应商订单－入库</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	...
	<INPUT type="radio" name="jxc_gysdd_cglb" value="D">地方采购  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	...
	<INPUT type="radio" name="jxc_gysdd_psfs" value="3">其他  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	...
	<INPUT type="radio" name="jxc_gysdd_fhsfwc" value="M">部分发货  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    ...
    <INPUT type="radio" name="jxc_gysdd_sfjs" value="N">未结算  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	...
	<INPUT type="radio" name="jxc_gysdd_sfrksgdw" value="N">否  </td>
