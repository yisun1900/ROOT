...
%>
  ...
  <td width="32%"><input name="cllx" type="radio"  value="0" checked>主材
 </td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="shfmc" value="" size="73" maxlength="50" ></td>
</tr>
<tr bgcolor="#FFFFFF">
