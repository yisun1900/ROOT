...
<body  onselectstart="return false;" onmousemove="moveye()"  onclick="dj()" onmousedown="mstate='down'" onmouseup="mstate='up'">



    <form method="post" action="SaveEditCmp_khpjb.jsp" name="insertform" >
		...
		if (rs1.next())
		{
			...
			<tr  align="center" height="37" > 
			  ...
			  <td width="12%" align="center" class="STYLE3">
				...
				{
					%>
					<INPUT type="radio" name="pjxmbm<%=xmsl%>" style="display:none" value="1" id="xg<%=xmsl%>1" checked>
					
					<img src="1.jpg"  id="img<%=xmsl%>0" border='2' onclick="pjxmbm<%=xmsl%>[0].checked=true;document.getElementById('img<%=xmsl%>0').border='2';document.getElementById('img<%=xmsl%>1').border='0';document.getElementById('img<%=xmsl%>2').border='0'">
					<%
				}
				else{
					%>
			  ...
			  <td width="12%" align="center" class="STYLE3">
				...
				{
					%>
					<INPUT type="radio" name="pjxmbm<%=xmsl%>" style="display:none" value="2" id="xg<%=xmsl%>2" checked>
						
					<img src="2.jpg" id="img<%=xmsl%>1" border='2' onclick="pjxmbm<%=xmsl%>[1].checked=true;document.getElementById('img<%=xmsl%>1').border='2';document.getElementById('img<%=xmsl%>0').border='0';document.getElementById('img<%=xmsl%>2').border='0'">
					<%
				}
				else{
					%>
			  ...
			  <td width="12%" align="center" class="STYLE3">
				...
				{
					%>
					<INPUT type="radio" name="pjxmbm<%=xmsl%>" style="display:none" value="3" id="xg<%=xmsl%>3" checked>
						
					<img src="3.jpg" id="img<%=xmsl%>2" border='2' onclick="pjxmbm<%=xmsl%>[2].checked=true;document.getElementById('img<%=xmsl%>2').border='2';document.getElementById('img<%=xmsl%>0').border='0';document.getElementById('img<%=xmsl%>1').border='0'">
					<%
				}
				else{
					%>
