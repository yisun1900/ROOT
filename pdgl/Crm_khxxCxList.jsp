...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,gcjdmc,khxm,fwdz,NVL(fkcsmc,'未付款'),kgrq,sgdmc,sjs,zjxm,kgzsj,sq_dwxx.dwmc,jgrq ";
	ls_sql+=" FROM crm_khxx,sq_dwxx,sq_sgd,dm_gcjdbm,cw_fkcs ";
    ...
    ls_sql+=" and crm_khxx.zt='2' and crm_khxx.gcjdbm='1'";
    ls_sql+=" and crm_khxx.sgd is not null";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","viewFbht.jsp","");
