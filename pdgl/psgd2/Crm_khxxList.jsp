...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh khbh,crm_khxx.hth,DECODE(pdclzt,'1','申请派单','2','人工派单','5','电子派单','6','特权派单','7','拒单','8','换施工队','4','不许修改派单') pdclzt,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>') kgsjqd,khxm,cqmc,fwdz,crm_khxx.qye,khlxmc,dwmc";
	ls_sql+=" ,DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单','4','老客户回单','5','员工回单') hdbz,jyjdrq,crm_khxx.sjs,crm_khxx.qyrq,crm_khxx.kgrq";
	ls_sql+=" FROM crm_khxx,sq_dwxx,dm_cqbm,dm_khlxbm  ";
	ls_sql+=" where crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.cqbm=dm_cqbm.cqbm(+)  and zt='2' ";
    ls_sql+=" and crm_khxx.khlxbm=dm_khlxbm.khlxbm(+) and pdclzt in('1','7')   and gcjdbm!='5'";
    ls_sql+=" and crm_khxx.htshbz='Y'";//N：未审核；P：可开工；Y：审核完成
...
//设置显示列
	String[] disColName1={"hth","pdclzt","kgsjqd","khxm","cqmc","fwdz","khlxmc","hdbz","jyjdrq","sjs","dwmc","qyrq","kgrq"};
