...
%>              </td>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFCC"><select name="mgfrz" style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.selectItem(out,"select xm,xm||'（'||dh||'）' from sq_grdjb where sgd='"+sgd+"' and bzmc ='"+sgbz+"' and gz='木工' order by xm",mgfrz);
%>
              </select></td>
              ...
              <td bgcolor="#FFFFCC"><select name="nwgfrz" style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.selectItem(out,"select xm,xm||'（'||dh||'）' from sq_grdjb where sgd='"+sgd+"' and bzmc ='"+sgbz+"' and gz='瓦工' order by xm",nwgfrz);
%>
              </select></td>
            </tr>
            <tr>
              ...
              <td bgcolor="#FFFFCC"><select name="sdgfrz" style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.selectItem(out,"select xm,xm||'（'||dh||'）' from sq_grdjb where sgd='"+sgd+"' and bzmc ='"+sgbz+"' and gz='水电工' order by xm",sdgfrz);
%>
              </select></td>
              ...
              <td bgcolor="#FFFFCC"><select name="yqgfrz" style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.selectItem(out,"select xm,xm||'（'||dh||'）' from sq_grdjb where sgd='"+sgd+"' and bzmc ='"+sgbz+"' and gz='油漆工' order by xm",yqgfrz);
%>
              </select></td>
            </tr>
            <tr align="center"> 
