...
%>              </td>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFCC"><select name="mgfrz" size="8" multiple style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.mutilSelectItem(out,"select grxm c1,grxm c2 from crm_grxx where  khbh='"+khbh+"' and grgz='木工' ","select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='木工'");
	cf.selectItem(out,"select sq_grxxb.xm,sq_grxxb.xm||'（'||sgdmc||'）' from sq_grxxb,sq_sgd where sq_grxxb.sgd=sq_sgd.sgd(+) and sq_grxxb.gz='木工' and sq_grxxb.xm not in(select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='木工') order by sq_sgd.sgdmc,sq_grxxb.xm ","");
%>
              </select></td>
              <td bgcolor="#FFFFCC" align="right">泥瓦工</td>
              <td bgcolor="#FFFFCC"><select name="nwgfrz" size="8" style="FONT-SIZE:12PX;WIDTH:180PX" multiple>
                <option value=""></option>
                <%
	cf.mutilSelectItem(out,"select grxm c1,grxm c2 from crm_grxx where  khbh='"+khbh+"' and grgz='泥瓦工' ","select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='泥瓦工'");
	cf.selectItem(out,"select sq_grxxb.xm,sq_grxxb.xm||'（'||sgdmc||'）' from sq_grxxb,sq_sgd where sq_grxxb.sgd=sq_sgd.sgd(+) and sq_grxxb.gz='瓦工' and sq_grxxb.xm not in(select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='泥瓦工') order by sq_sgd.sgdmc,sq_grxxb.xm ","");
%>
              </select></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFCC" align="right">水电工</td>
              <td bgcolor="#FFFFCC"><select name="sdgfrz" size="8" multiple style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.mutilSelectItem(out,"select grxm c1,grxm c2 from crm_grxx where  khbh='"+khbh+"' and grgz='水电工' ","select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='水电工'");
	cf.selectItem(out,"select sq_grxxb.xm,sq_grxxb.xm||'（'||sgdmc||'）' from sq_grxxb,sq_sgd where sq_grxxb.sgd=sq_sgd.sgd(+) and sq_grxxb.gz='水电工' and sq_grxxb.xm not in(select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='水电工') order by sq_sgd.sgdmc,sq_grxxb.xm ","");
%>
              </select></td>
              <td bgcolor="#FFFFCC" align="right">油漆工</td>
              <td bgcolor="#FFFFCC"><select name="yqgfrz" size="8" style="FONT-SIZE:12PX;WIDTH:180PX" multiple>
                <option value=""></option>
                <%
	cf.mutilSelectItem(out,"select grxm c1,grxm c2 from crm_grxx where  khbh='"+khbh+"' and grgz='油漆工' ","select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='油漆工'");
	cf.selectItem(out,"select sq_grxxb.xm,sq_grxxb.xm||'（'||sgdmc||'）' from sq_grxxb,sq_sgd where sq_grxxb.sgd=sq_sgd.sgd(+) and sq_grxxb.gz='油漆工' and sq_grxxb.xm not in(select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='油漆工') order by sq_sgd.sgdmc,sq_grxxb.xm ","");
%>
              </select></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFCC" align="right">杂工</td>
              <td bgcolor="#FFFFCC"><select name="zgfrz" size="8" multiple style="FONT-SIZE:12PX;WIDTH:180PX">
                <option value=""></option>
                <%
	cf.mutilSelectItem(out,"select grxm c1,grxm c2 from crm_grxx where  khbh='"+khbh+"' and grgz='杂工' ","select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='杂工'");
	cf.selectItem(out,"select sq_grxxb.xm,sq_grxxb.xm||'（'||sgdmc||'）' from sq_grxxb,sq_sgd where sq_grxxb.sgd=sq_sgd.sgd(+) and sq_grxxb.gz='杂工' and sq_grxxb.xm not in(select grxm from crm_grxx where  khbh='"+khbh+"' and grgz='杂工') order by sq_sgd.sgdmc,sq_grxxb.xm ","");
%>
              </select></td>
