...
//工程担当电话
	...
	flf=cf.round(sgcbj-sgcbj*0.5,0);	
...
%></u></td>
   ...
   <tr  bgcolor="#FFFFFF">
     <td height="35"  >&nbsp;&nbsp;&nbsp;&nbsp;预付款：按照合同总价的<u>25％</u>支付辅材预付款；</td>
   </tr>
   <tr  bgcolor="#FFFFFF">
     <td height="35"  >&nbsp;&nbsp;&nbsp;&nbsp;进度款：当工程量进行到<u>80％</u>时，支付首次人工费（即合同暂定总价的<u>25%</u>），同时扣除人工费总额的<u>2.3%</u>作为管理费；</td>
   </tr>
   <tr  bgcolor="#FFFFFF">
