...
%>
            ...
            <tr>
              <td align="right" bgcolor="#FFFFFF"><font color="#000099">管家</font></td>
...
%></font></td>
            ...
            <tr bgcolor="#FFCCCC"> 
			  ...
			  <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right">管家</td>
              <td width="31%" bgcolor="#FFFFCC"> 
                <select name="gj" style="FONT-SIZE:12PX;WIDTH:180PX">
                 <option value=""></option>
                  <%
	cf.selectItem(out,"select yhmc,yhmc||'（'||dh||'）' from sq_yhxx,sq_dwxx where sq_yhxx.dwbh=sq_dwxx.dwbh and sq_dwxx.ssfgs='"+ssfgs+"' and zwbm='06' and sfzszg in('Y','N') order by yhmc",gj);
%> 
                </select>              </td>
