...
%> 
            ...
            <tr bgcolor="#FFFFCC">
              <td width="21%" align="right">监理姓名</td>
              <td width="29%">
...
%> 
              ...
              <td width="19%" align="right">监理姓名</td>
              <td width="31%">
                <input type="text" name="zjxm2" size="20" maxlength="20" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right"> 
...
%> 
            ...
            <tr> 
              <td width="16%" bgcolor="#FFFFCC" align="right">派单奖励</td>
              ...
              <td width="15%" bgcolor="#FFFFCC" align="right">是否监理</td>
              <td width="35%" bgcolor="#FFFFCC"> 
                <input type="radio" name="sfszj" value="Y" checked>
                已设监理 </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_khxxHzjList.jsp";
