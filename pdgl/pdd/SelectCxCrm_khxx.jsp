...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFCC">
              <td align="right" bgcolor="#FFFFCC">派调度时间 从</td>
              <td><input type="text" name="pddsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="pddsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#CCFFFF">
              ...
              <td colspan="3" bgcolor="#CCFFFF"> 第一列
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:130PX">
                    <option value="crm_khxx.pddsj desc">派调度时间</option>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.pddsj, "派调度时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.pddsj2, "派调度时间"))) {
		return false;
	}
