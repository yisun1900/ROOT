...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String pddsj=null;
	pddsj=request.getParameter("pddsj");
	if (pddsj!=null)
	{
		pddsj=pddsj.trim();
		if (!(pddsj.equals("")))	wheresql+="  and (crm_khxx.pddsj>=TO_DATE('"+pddsj+"','YYYY/MM/DD'))";
	}
	pddsj=request.getParameter("pddsj2");
	if (pddsj!=null)
	{
		pddsj=pddsj.trim();
		if (!(pddsj.equals("")))	wheresql+="  and (crm_khxx.pddsj<=TO_DATE('"+pddsj+"','YYYY/MM/DD'))";
	...
	ls_sql="SELECT crm_khxx.khbh khbh,crm_khxx.hth,sgdmc,gj,pddsj,dd,DECODE(pdclzt,'1','申请派单','2','人工派单','5','电子派单','6','特权派单','7','拒单','8','换施工队','4','不许修改派单') pdclzt,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>') kgsjqd,khxm,fwdz,crm_khxx.qye,khlxmc,dwmc";
    ...
    ls_sql+=" and crm_khxx.dd is not null ";
...
//设置显示列
	String[] disColName1={"hth","khxm","fwdz","sjs","sgdmc","dd","pddsj","gj","pdclzt","kgsjqd","jyjdrq","khlxmc","hdlxmc","dwmc","kgrq"};
...
//设置主键
	...
	String[] buttonLink={"delete.jsp"};//按钮单击调用的网页，可以增加参数
