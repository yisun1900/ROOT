...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(pdclzt,'1','申请派单','2','人工派单','5','电子派单','6','特权派单','7','拒单','8','换施工队','4','不许修改派单') pdclzt";
    ...
    ls_sql+=" where crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+)  and zt='2' ";
    ls_sql+=" and crm_khxx.hdbz=dm_hdlxbm.hdlxbm(+) and crm_khxx.sgd=sq_sgd.sgd ";
    ls_sql+=" and crm_khxx.khlxbm=dm_khlxbm.khlxbm(+)  and crm_khxx.gcjdbm not in('4','5')";
    ls_sql+=" and crm_khxx.sgbz is null ";
