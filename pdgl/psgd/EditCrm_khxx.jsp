...
%> 
            ...
            <tr> 
              ...
              <td width="18%" bgcolor="#FFFFFF" align="right"><font color="#FF00FF">监理姓名</font></td>
...
%> 
            ...
            <tr bgcolor="#FFCCCC"> 
              ...
              <td width="18%" align="right"><font color="#000000"><b>签约额</b></font></td>
              <td width="32%" bgcolor="#FFCCCC"><font color="#000000"><b><%=cf.formatDouble(qye+guanlif+suijin)%></b></font></td>
            </tr>
            <tr bgcolor="#FFCCCC"> 
...
%></font></td>
            ...
            <tr> 
              <td width="19%" align="right" bgcolor="#FFFFCC"> 
                <font color="#FF0000">*</font>派单类型              </td>
              <td width="31%" bgcolor="#FFFFCC"> 
                <select name="jlbz" style="FONT-SIZE:12PX;WIDTH:152PX" >
				 <option value=""></option>
                 <%
	cf.selectToken(out,"0+正常派单&1+回单奖励&2+公司奖励&3+设计师指定派单&4+客户指定派单&7+特殊情况&9+同小区派单",jlbz);
%> 
                </select>
              </td>
            ...
            <tr> 
              <td width="19%" align="right" bgcolor="#FFFFCC"> 
                <font color="#FF0000">*</font><font color="#0000CC">派单人</font> </td>
              <td width="31%" bgcolor="#FFFFCC"> 
                <input type="text" name="pdr" size="24" maxlength="20"  value="<%=yhmc%>" readonly>
              </td>
              <td width="18%" align="right" bgcolor="#FFFFCC"> 
                <font color="#FF0000">*</font><font color="#0000CC">派单时间</font> </td>
              <td width="32%" bgcolor="#FFFFCC"> 
                <input type="text" name="pdsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>
              </td>
            </tr>
            <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right"><font color="#FF0000">*</font>派施工队</td>
...
%> 
              ...
              <td width="18%" bgcolor="#FFFFCC" align="right">监理</td>
              <td width="32%" bgcolor="#FFFFCC"> 
...
%> 
                ...
                <input type="button"  value="打印派工单" onClick="window.open('DyPdCrm_khxx.jsp?khbh=<%=wherekhbh%>')">
              </td>
            </tr>
          </table>
</form>
