...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%	
	...
	ls_sql+=" and sq_sgd.ssfgs='"+ssfgs+"' and gcjdbm='1' and crm_khxx.zt='2'";
	...
	ls_sql+=" FROM sq_sgd,crm_khxx";
	ls_sql+=" where crm_khxx.sgd=sq_sgd.sgd and sq_sgd.cxbz='N'";
	ls_sql+=" and sq_sgd.ssfgs='"+ssfgs+"' and gcjdbm not in('1','4','5') and crm_khxx.zt='2'";
	ls_sql+=" group by crm_khxx.sgd,sgdmc,bzs,zbj";
	...
	ls_sql+=" FROM sq_sgd,crm_khxx";
	ls_sql+=" where crm_khxx.sgd=sq_sgd.sgd and sq_sgd.cxbz='N'";
	ls_sql+=" and sq_sgd.ssfgs='"+ssfgs+"' and gcjdbm in('4','5') and crm_khxx.zt='2'";
