...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_khxx.pdsj is not null ";
	ls_sql+=" and crm_khxx.khbh=pd_pdjl.khbh";
	ls_sql+=" and pd_pdjl.hfr is null";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Pd_pdjlHfList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"SaveEditPd_pdjl.jsp"};//按钮单击调用的网页，可以增加参数
