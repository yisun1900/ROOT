...
<%@ page import="org.apache.poi.poifs.filesystem.POIFSFileSystem,org.apache.poi.hssf.record.*,org.apache.poi.hssf.model.*,org.apache.poi.hssf.usermodel.*,org.apache.poi.hssf.util.*" %>
...
<BR>（注意：数据从第2行开始，[档案号]第2列，[提成]第3列）</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#CCCCCC" align="center"> 
      ...
      <td width="8%" bgcolor="#FFCCFF">姓名</td>
      <td width="14%">部门</td>
      <td width="8%">客户名</td>
      <td width="9%">家装签约额</td>
      <td width="8%">家装实收</td>
