            ...
            <tr> 
              <td colspan="4" height="2"> 
                <div align="center"> 
                  ...
                  <input name="pr" type="button" value="打印收据" onClick="window.open('/cwgl/qyecx/PrintJcSj.jsp?fkxh=<%=fkxh%>&khbh=<%=khbh%>')" >
                  <input name="pr2" type="button" value="选择打印" onClick="window.open('/cwgl/qyecx/PrintChooseJcSj.jsp?fkxh=<%=fkxh%>')" >
                </div>              </td>
            </tr>
          </table>
</form>
