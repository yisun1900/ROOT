...
%> 
            ...
            <tr> 
              <td height="2" colspan="4" align="center"> 
                  ...
                  <input name="pr" type="button" value="打印收据" onClick="window.open('/cwgl/qyecx/PrintJzSj.jsp?fkxh=<%=fkxh%>&khbh=<%=khbh%>')" >
              <input name="pr2" type="button" value="选择打印" onClick="window.open('/cwgl/qyecx/PrintChooseJzSj.jsp?fkxh=<%=fkxh%>')" >              </td>
            </tr>
        </table>
