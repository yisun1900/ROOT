...
try {
	...
	ls_sql="select spyj,clzt,htsjf,sssjf,wdzgce,qye,zqljzjx,zhljzjx,zqhj,zhhj,jsze,yjzxk,dj,yjwk,yhje,fqbl,fqje,djfxje,dyq,yhze,shfqje,yjzck,zcddjezq,zcddyh,dgzcjezq,dgzcyh,zcjsje,pck,khbjk,lrr,lrsj,lrbm,bz ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgShCw_jrkhjs.jsp" name="insertform" >
<div align="center">个性化客户结算－修改审核(<font color="#0000FF">客户编号:<%=khbh%></font>)</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="spyj" cols="71" rows="3"><%=spyj%></textarea>  </td>
</tr>
    <tr align="center"> 
      <td colspan="4"> 
