...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and cw_gdjsjl.jsfs='1'";//：计提管理费；2：定额结算
    ls_sql+=wheresql;
...
//设置列超级连接
	...
	coluParm.link="/cwgl/hdsgdjs/ViewCw_gdjsjl.jsp";//为列参数：coluParm.link设置超级链接
