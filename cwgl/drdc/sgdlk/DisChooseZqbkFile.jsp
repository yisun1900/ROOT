...
%> 
<form method="post" action="SaveChooseZqbkFile.jsp" name="editform" target="_blank">
<div align="center">中期拨款－导入（科目代码：<%=kmdm%>）
<BR>（注意：数据从第6行开始，[档案号]第2列，[二期拨款]第3列）</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#CCCCCC" align="center"> 
      ...
      <td width="8%" bgcolor="#FFCCFF">二期工程拨款</td>
      <td width="7%">客户</td>
	  <td width="7%">设计师</td>
      <td width="7%">施工队长</td>
      <td width="8%">签约额</td>
