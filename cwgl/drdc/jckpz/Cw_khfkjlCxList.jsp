...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,a.fklxmc fklxbm,fkxh,DECODE(cw_khfkjl.czlx,'1','录入','2','导出凭证','3','凭证导入'),DECODE(cw_khfkjl.zrkdcpz,'0','否','1','是'),DECODE(cw_khfkjl.zckdcpz,'0','否','1','是'),fkcsmc,NVL2(cw_khfkjl.yfkbl,cw_khfkjl.yfkbl||'%',''),cw_khfkjl.yfkje,cw_khfkjl.fkje,cw_khfkjl.gysbh,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y',' 审核通过','M','审核未通过'),cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,cw_khfkjl.zcgysbh,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,DECODE(scbz,'N','未删除','Y','删除'),sjr,sjsj,cw_khfkjl.bz  ";
	...
	ls_sql+=" SELECT '&nbsp;',crm_zxkhxx.khxm,a.fklxmc fklxbm,cw_khfkjl.fkxh,DECODE(cw_khfkjl.czlx,'1','录入','2','导出凭证','3','凭证导入'),DECODE(cw_khfkjl.zrkdcpz,'0','否','1','是'),DECODE(cw_khfkjl.zckdcpz,'0','否','1','是'),fkcsmc,NVL2(cw_khfkjl.yfkbl,cw_khfkjl.yfkbl||'%',''),cw_khfkjl.yfkje,cw_khfkjl.fkje,cw_khfkjl.gysbh,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y',' 审核通过','M','审核未通过'),cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,cw_khfkjl.zcgysbh,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,DECODE(scbz,'N','未删除','Y','删除'),sjr,sjsj,cw_khfkjl.bz  ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">收款序号</td>
	<td  width="3%">操作类型</td>
	<td  width="2%">转入导出凭证</td>
	<td  width="2%">转出导出凭证</td>
	<td  width="2%">收款期数</td>
	<td  width="2%">应收款率</td>
	<td  width="3%">家装应收款</td>
	<td  width="3%">家装实收款</td>
