...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Dm_khjscsbList.jsp","","","EditDm_khjscsb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Dm_khjscsbList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from dm_khjscsb where "+chooseitem;
...
<CENTER >
  <B><font size="3">客户结算参数表－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">其它收费项目1</td>
	<td  width="5%">其它收费项目2</td>
	<td  width="5%">其它收费项目3</td>
	<td  width="3%">是否有其它项1</td>
	<td  width="6%">其它项1名称</td>
