...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql=" SELECT hth,khxm,fwdz,DECODE(jjwjbz,'N','未完结','Y','完结'),jjwjr,jjwjsj,qyrq,sjjgrq,sq_dwxx.dwmc,sgdmc,sjs,zjxm,khbh ";
...
//进行对象初始化
	...
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertCw_jcfkd.jsp");
