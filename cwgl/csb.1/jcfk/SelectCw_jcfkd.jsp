...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_jcfkdList.jsp" name="selectform">
<div align="center">修改集成返款单</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="cw_jcfkd_lrr" size="20" maxlength="20" ></td>
  <td align="right">办理人</td>
  <td><input type="text" name="cw_jcfkd_blr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">办理时间 从</td>
  <td><input type="text" name="cw_jcfkd_blsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="cw_jcfkd_blsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从</td>
  <td><input type="text" name="cw_jcfkd_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="cw_jcfkd_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"><select name="cw_jcfkd_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <%
...
{
	if(!(isDatetime(FormName.cw_jcfkd_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_jcfkd_lrsj2, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_jcfkd_blsj, "办理时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_jcfkd_blsj2, "办理时间"))) {
		return false;
	}
	FormName.submit();
	return true;
