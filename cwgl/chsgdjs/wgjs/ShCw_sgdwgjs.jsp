...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveShCw_chsgdjs.jsp" name="insertform">
...
<%
	...
	ls_sql="SELECT cw_chbgfjl.jsjlh,gdjsjdmc,cw_chbgfjl.jsrq,cw_chbgfjl.htje,cw_chbgfjl.zjxje, DECODE(cw_chbgfjl.jsjs,'1','工程费','2','工程费＋其它费','3','实收款总额','4','一期款','5','二期款','6','三期款','7','工程基础报价','8','工程基础报价＋其它费基础报价','9','工程施工成本价','A','工程施工成本价＋其它费施工成本','B','工程成本价','C','工程成本价＋其它费成本'),cw_chbgfjl.jsjsze,cw_chbgfjl.jsbl||'%',cw_chbgfjl.jsje,cw_chbgfjl.clf,cw_chbgfjl.gdyp,cw_chbgfjl.sjbk,cw_chbgfjl.lrr,cw_chbgfjl.bz  ";
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="fkje" value="<%=fkje%>" size="20" maxlength="17" >
    </td>
    <td align="right"><font color="#FF0000">*</font>奖励金额</td>
    <td><input type="text" name="jlje" value="<%=jlje%>" size="20" maxlength="17" >
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right"><font color="#FF0000">*</font>其它金额</td>
    <td><input type="text" name="qtje" value="<%=qtje%>" size="20" maxlength="17" >
    </td>
