...
try {
	...
	ls_sql+=" ,wdzgce,qye,zqljzjx,zhljzjx,sfke";
...
/*
	...
	{
		out.println("<BR>！！！提醒，客户欠款，签约额:"+qye+"、增减项:"+zhljzjx+"、实际发生额:"+cf.round(qye+zhljzjx,2)+"、实付款:"+sfke+"、欠款:"+cf.round(qye+zhljzjx-sfke,2));
	}
...
<%
	...
	ls_sql="SELECT cw_chbgfjl.jsjlh,gdjsjdmc,cw_chbgfjl.jsrq,TO_CHAR(cw_chbgfjl.htje),TO_CHAR(cw_chbgfjl.zjxje), DECODE(cw_chbgfjl.jsjs,'1','工程费','2','工程费＋其它费','3','实收款总额','4','一期款','5','二期款','6','三期款','7','工程基础报价','8','工程基础报价＋其它费基础报价','9','工程施工成本价','A','工程施工成本价＋其它费施工成本','B','工程成本价','C','工程成本价＋其它费成本'),TO_CHAR(cw_chbgfjl.jsjsze),cw_chbgfjl.jsbl||'%',TO_CHAR(cw_chbgfjl.jsje),TO_CHAR(cw_chbgfjl.clf),TO_CHAR(cw_chbgfjl.gdyp),cw_chbgfjl.sjbk,cw_chbgfjl.lrr,cw_chbgfjl.bz  ";
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
	...
	<input type="button"  value="允许结算" onClick="f_do(insertform)"></td>
    </tr>
</table>
</form>
</body>
