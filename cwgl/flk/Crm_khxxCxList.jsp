...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_cflkjl.jlh,cw_cflkjl.khbh,khxm,fwdz,wdzgce,DECODE(crm_khxx.kgzbz,'Y','充卡','N','未充卡'),cw_cflkjl.clfbfb||'%',cw_cflkjl.clf+cw_cflkjl.fwmjcz+cw_cflkjl.zccz,cw_cflkjl.czkh,cw_cflkjl.clf,cw_cflkjl.cfje,cw_cflkjl.fwmjcz,cw_cflkjl.zccz,dwmc,sjs,cw_cflkjl.lrr,cw_cflkjl.lrsj,cw_cflkjl.bz";
