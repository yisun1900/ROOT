...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_gdsgjsdCxList.jsp" name="selectform">
...
{
	if(	javaTrim(FormName.cw_gdsgjsd_lrsj)=="") {
		alert("请输入[录入时间]！");
		FormName.cw_gdsgjsd_lrsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.cw_gdsgjsd_lrsj, "录入时间"))) {
		return false;
	}
	if(	javaTrim(FormName.cw_gdsgjsd_lrsj2)=="") {
		alert("请输入[录入时间]！");
		FormName.cw_gdsgjsd_lrsj2.focus();
		return false;
	}
