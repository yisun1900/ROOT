...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_gcjddjjl.djjlh,crm_khxx.hth,crm_khxx.khxm,dm_gcjdbm.ysgcjdmc,crm_gcjddjjl.djsj,crm_gcjddjjl.lrr,crm_gcjddjjl.lrsj,crm_khxx.fwdz,sgdmc,crm_khxx.zjxm,crm_khxx.sjs,crm_khxx.qyrq,crm_gcjddjjl.khbh ,sq_dwxx.dwmc,crm_gcjddjjl.bz ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_gcjddjjlCxList.jsp","SelectCxCrm_gcjddjjl.jsp","","");
