...
<form method="post" action="Crm_gcjddjjlList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">实际完结时间 从</td>
              <td width="33%"> 
