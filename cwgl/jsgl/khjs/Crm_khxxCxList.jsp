...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,ysgcjdmc,kgrq,jgrq,sjjgrq,sjwjrq,sgdmc sgd,sjs,zjxm,sq_dwxx.dwmc,hth ";
    ...
    ls_sql+=" and (crm_khxx.khjsbz='N' OR crm_khxx.khjsbz is null)";
