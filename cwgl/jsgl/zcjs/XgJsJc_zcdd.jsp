...
<div align="center">修改厂商结算（订单编号：<%=ddbh%>）</div> 
...
%>
    ...
    <tr bgcolor="#CCCCFF">
      ...
      <td bgcolor="#FFFFFF"><input type="text" name="jssj" value="<%=jssj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right"><font color="#FF0000">*</font>结算金额</td>
      <td><input type="text" name="jsje" value="<%=jsje%>" size="20" maxlength="20" ></td>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgJsJc_zcdd.jsp";
	FormName.submit();
	return true;
}
