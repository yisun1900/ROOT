...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材订单处理－－修改厂商结算</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Jc_zcddXgJsList.jsp" name="selectform">
...
//			window.open(actionStr);
	...
	else if (lx=="gys")
	{
		if (gysMark==0)
		{
			...
			{
				sql="select jxc_gysxx.gysmc from jxc_ppxx,jxc_ppsqfgs,jxc_ppgysdzb,jxc_gysxx where jxc_ppxx.ppbm=jxc_ppsqfgs.ppbm and jxc_ppxx.ppbm=jxc_ppgysdzb.ppbm and jxc_ppgysdzb.gysbm=jxc_gysxx.gysbm and jxc_ppsqfgs.ssfgs='"+selectform.fgs.value+"' and jxc_ppxx.clxl='"+selectform.zcxlbm.value+"' order by jxc_gysxx.gysmc";
			}
			else if (selectform.zcdlbm.value!="")
			{
				sql="select jxc_gysxx.gysmc from jxc_ppxx,jxc_ppsqfgs,jxc_ppgysdzb,jxc_gysxx where jxc_ppxx.ppbm=jxc_ppsqfgs.ppbm and jxc_ppxx.ppbm=jxc_ppgysdzb.ppbm and jxc_ppgysdzb.gysbm=jxc_gysxx.gysbm and jxc_ppsqfgs.ssfgs='"+selectform.fgs.value+"' and jxc_ppxx.clxl in(select clxlmc from jxc_clxlbm where cldlmc='"+selectform.zcdlbm.value+"') order by jxc_gysxx.gysmc";
			}
			else
			{
				sql="select jxc_gysxx.gysmc from jxc_gysxx,jxc_gyssqfgs where jxc_gysxx.gysbm=jxc_gyssqfgs.gysbm and jxc_gyssqfgs.ssfgs='"+selectform.fgs.value+"' order by jxc_gysxx.gysmc";
			}
