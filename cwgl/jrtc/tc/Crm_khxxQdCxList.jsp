...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(crm_khxx.sjsjsbz,'0','未提成','1','签单提成','2','结算提成'),crm_khxx.yjjzsj,crm_khxx.htshsj,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,bjjbmc,crm_khxx.sjs,crm_khxx.zjxm,sgdmc,qye,sfke,dwmc,crm_khxx.khbh,gcjdmc  ";
...
//设置按钮参数
	...
	String[] buttonLink={"InsertCw_jrtcmxQd.jsp?khzq="+khzq};//按钮单击调用的网页，可以增加参数
