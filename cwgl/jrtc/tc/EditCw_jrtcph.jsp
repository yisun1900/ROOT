...
<table border="1" width="850%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>

<tr bgcolor="#CCCCCC"  align="center">
	<td  width="70px" rowspan="3" >序号</td>
	<td  width="90px" rowspan="3" >修改</td>
	<td  width="90px" rowspan="3" >删除</td>
	<td  width="140px" rowspan="3">类型</td>
	...
	<td  width="140px" rowspan="3">套餐客户</td>
...
try {
	...
	ls_sql =" select cw_jrtcmx.khbh,cw_jrtcmx.hdbz,DECODE(cw_jrtcmx.tckh,'1','个性','2','套餐') tckh,cw_jrtcmx.dianz,cw_jrtcmx.weny,cw_jrtcmx.khjl,cw_jrtcmx.sjs,cw_jrtcmx.cly,cw_jrtcmx.zjxm,cw_jrtcmx.xqzg,cw_jrtcmx.xqzz,cw_jrtcmx.xqzy,cw_jrtcmx.wlyxzg,cw_jrtcmx.yxzy,cw_jrtcmx.wzch,cw_jrtcmx.wysj,cw_jrtcmx.wzcxy,cw_jrtcmx.dhzy,cw_jrtcmx.wztgy,cw_jrtcmx.siji ";
	...
	while (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
			<td ><%=row%></td>
			<td ><A HREF="EditCw_jrtcmx.jsp?khbh=<%=khbh%>&khzq=<%=khzq%>&ssfgs=<%=fgsbh%>" target="_blank">修改</A></td>
			<td ><A HREF="DeleteCw_jrtcmx.jsp?khbh=<%=khbh%>&khzq=<%=khzq%>&ssfgs=<%=fgsbh%>" target="_blank">删除</A></td>
			<td ><%=lx%>
