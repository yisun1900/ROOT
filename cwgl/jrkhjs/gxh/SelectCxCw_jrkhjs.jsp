...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_jrkhjsCxList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
    <INPUT type="radio" name="cw_jrkhjs_clzt" value="1">未审批
    <INPUT type="radio" name="cw_jrkhjs_clzt" value="2">审批同意
    <INPUT type="radio" name="cw_jrkhjs_clzt" value="3">审批不同意  </td>
  <td align="right" width="18%">类型</td> 
  <td width="32%">
	<INPUT type="radio" name="cw_jrkhjs_lx" value="1">个性化
    <INPUT type="radio" name="cw_jrkhjs_lx" value="2">套餐  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.cw_jrkhjs_lrsj, "结算时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_jrkhjs_lrsj2, "结算时间"))) {
		return false;
	}
	FormName.submit();
	return true;
