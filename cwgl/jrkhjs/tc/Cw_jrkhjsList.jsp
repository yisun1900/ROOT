...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and (cw_jrkhjs.clzt='1' OR cw_jrkhjs.clzt='3')";
    ls_sql+=wheresql;
    ls_sql+=" order by cw_jrkhjs.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_jrkhjsList.jsp","","","EditCw_jrkhjs.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCw_jrkhjs.jsp?"};//按钮单击调用的网页，可以增加参数
