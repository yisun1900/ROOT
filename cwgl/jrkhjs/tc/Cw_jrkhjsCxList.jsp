...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	cw_jrkhjs_spsj=request.getParameter("cw_jrkhjs_spsj2");
	if (cw_jrkhjs_spsj!=null)
	{
		cw_jrkhjs_spsj=cw_jrkhjs_spsj.trim();
		if (!(cw_jrkhjs_spsj.equals("")))	wheresql+="  and (cw_jrkhjs.spsj<=TO_DATE('"+cw_jrkhjs_spsj+"','YYYY-MM-DD'))";
	...
	cw_jrkhjs_lrsj=request.getParameter("cw_jrkhjs_lrsj2");
	if (cw_jrkhjs_lrsj!=null)
	{
		cw_jrkhjs_lrsj=cw_jrkhjs_lrsj.trim();
		if (!(cw_jrkhjs_lrsj.equals("")))	wheresql+="  and (cw_jrkhjs.lrsj<=TO_DATE('"+cw_jrkhjs_lrsj+" 23:59:59','YYYY-MM-DD hh24:mi:ss'))";
	}
	...
	ls_sql="SELECT DECODE(cw_jrkhjs.lx,'1','个性化','2','套餐') lx, DECODE(cw_jrkhjs.clzt,'1','未审批','2','审批同意','3','审批不同意'),cw_jrkhjs.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.yjjzsj,cw_jrkhjs.htsjf,cw_jrkhjs.sssjf,cw_jrkhjs.wdzgce,cw_jrkhjs.qye,cw_jrkhjs.zqljzjx,cw_jrkhjs.zhljzjx,cw_jrkhjs.zqhj,cw_jrkhjs.zhhj,cw_jrkhjs.jsze,cw_jrkhjs.yjzxk,cw_jrkhjs.dj,cw_jrkhjs.yjwk,cw_jrkhjs.yhje,cw_jrkhjs.fqbl,cw_jrkhjs.fqje,cw_jrkhjs.djfxje,cw_jrkhjs.dyq,cw_jrkhjs.yhze,cw_jrkhjs.shfqje,cw_jrkhjs.yjzck,cw_jrkhjs.zcddjezq,cw_jrkhjs.zcddyh,cw_jrkhjs.dgzcjezq,cw_jrkhjs.dgzcyh,cw_jrkhjs.zcjsje,cw_jrkhjs.pck,cw_jrkhjs.khbjk,cw_jrkhjs.spr,cw_jrkhjs.spsj,cw_jrkhjs.spyj,cw_jrkhjs.lrr,cw_jrkhjs.lrsj,dwmc,cw_jrkhjs.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_jrkhjsCxList.jsp","","","");
...
//设置列超级连接
	...
	coluParm.link="/cwgl/jrkhjs/ViewCw_jrkhjs.jsp";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">结算－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(curPage);
	pageObj.printPageLink(570);
%>
