...
<%
	...
	ls_sql+=" and (cw_khfkjl.fklxbm in('11')";//23:主材
	ls_sql+=" OR ";
    ...
    ls_sql+=" order by fklxbm,skdd,dsksjbz desc,jc_zcdd.ddlx,cw_khfkjl.ddbh,fkxh";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
...
<CENTER >
  <B><font size="3">查询结果<font color="#FF0000">（注意：财务必须审核，此列表含未审核记录）</font></font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
