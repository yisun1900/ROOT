...
<%
	...
	ls_sql="SELECT jc_zcdd.ddbh,clztmc,DECODE(jc_zcdd.ddlx,'1','代销品','3','补录合同','4','有库存订单','5','标准套餐','6','家具健康套餐','7','温暖静音套餐','8','窗帘套餐','9','代购主材','A','顶配升级','B','顶配独立收费','C','选配主材'),DECODE(jc_zcdd.sfjrht,'Y','计入','N','不计入') sfjrht,ppbm,jc_zcdd.wdzje,jc_zcdd.hkze,jc_zcdd.zqzjhze,jc_zcdd.zjhze ,jc_zcdd.wdzje+jc_zcdd.zqzjhze,jc_zcdd.hkze+jc_zcdd.zjhze,jc_zcdd.qhtsj,jc_zcdd.clgw,jc_zcdd.jssj,jc_zcdd.bz";
	...
	ls_sql+=" and jc_zcdd.ddlx in('1','3','4')";//是否计入合同  Y：计入；N：不计入
