...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Dm_sgdjscsbList.jsp","","","EditDm_sgdjscsb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Dm_sgdjscsbList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from dm_sgdjscsb where "+chooseitem;
		sql[1]="delete from dm_yqgcjd where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">是否加主材奖励</td>
	<td  width="3%">是否扣罚款金额</td>
	<td  width="3%">是否加奖励金额</td>
	<td  width="2%">是否加其它金额</td>
