...
try {
	...
	ls_sql="insert into cw_jrsgdjs ( jsjlh,khbh,sgd,sgbz,jsrq,ysglk,zjsge,cfje,jsglk,rgfbfb   ,yfrgf,bcrgf,flkbfb,ycflk,kjflk,bcflk,gsfl,psfl,kzbjbl,kzbj   ,fk,bx,rybx,pck,kqtk,kqtksm,bcfkhj,lrr,lrsj,lrbm,bz   ,lx,clzt ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?   ,?,?,?,?,?,?,?,?,?,?   ,?,?,'1' ) ";
	ps= conn.prepareStatement(ls_sql);
