...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_jrsgdjs.jsjlh,gdjsjdmc, DECODE(cw_jrsgdjs.clzt,'1','结算','2','审批同意','3','审批不同意'),crm_khxx.khxm,crm_khxx.fwdz,sgdmc,cw_jrsgdjs.bcfkhj,cw_jrsgdjs.jsrq,cw_jrsgdjs.sgbz,crm_khxx.hth,cw_jrsgdjs.khbh,TO_CHAR(cw_jrsgdjs.ysglk),TO_CHAR(cw_jrsgdjs.zjsge),TO_CHAR(cw_jrsgdjs.cfje),TO_CHAR(cw_jrsgdjs.jsglk),cw_jrsgdjs.rgfbfb||'%',TO_CHAR(cw_jrsgdjs.yfrgf),cw_jrsgdjs.bcrgf,cw_jrsgdjs.flkbfb||'%',TO_CHAR(cw_jrsgdjs.ycflk),TO_CHAR(cw_jrsgdjs.kjflk),cw_jrsgdjs.bcflk,cw_jrsgdjs.gsfl,cw_jrsgdjs.psfl,cw_jrsgdjs.kzbjbl||'%',cw_jrsgdjs.kzbj,cw_jrsgdjs.fk,cw_jrsgdjs.bx,cw_jrsgdjs.rybx,cw_jrsgdjs.pck,cw_jrsgdjs.kqtk,cw_jrsgdjs.kqtksm,cw_jrsgdjs.spr,cw_jrsgdjs.spsj,cw_jrsgdjs.spyj,cw_jrsgdjs.lrr,cw_jrsgdjs.lrsj,dwmc,cw_jrsgdjs.bz  ";
	ls_sql+=" FROM crm_khxx,cw_jrsgdjs,dm_gdjsjd,sq_sgd,sq_dwxx  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_jrsgdjsCxList.jsp","","","");
