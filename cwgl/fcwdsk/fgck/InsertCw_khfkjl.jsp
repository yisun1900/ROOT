...
try {
	...
	ls_sql="select crm_khxx.bz,crm_khxx.jzwkqs,DECODE(zt,'2','家装客户','3','退单客户','4','非家装客户','5','设计客户') ztmc,zjxssk,guanlif,zjxguanlif,suijin,suijinbfb,zjxsuijin,cxhdbm,cxhdbmxq,cxhdbmzh,sffj,fjje,gsfje,sfyrz,rzsc,sfyyh,yhyy,fkcsmc,kqtk,kglf,gckkspbz,gcjdmc,DECODE(zjxwcbz,'1','未发生增减项','2','发生增减项','3','已完成增减项') zjxwcbz,gckk,zkl,sjfkzc,fgsbh,sjsbh,khxm,fwdz,lxfs,xb,sjs,hth,qyrq,dwbh,sgd,zjxm,wdzgce,qye,sjf,glf,sfke,zjxje,zhzjxje,sgbz,jgrq";
	ls_sql+=" ,wjrqyexmsm,zqljzjx,zhljzjx";
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input name="pr" type="button" value="打印收据" onClick="window.open('/cwgl/dy/PrintJzSj.jsp?fkxh=<%=fkxh%>&khbh=<%=khbh%>')" disabled>
                <input name="pr2" type="button" value="选择打印" onClick="window.open('/cwgl/dy/PrintChooseJzSj.jsp?fkxh=<%=fkxh%>')" disabled>              </td>
            </tr>
        </table>
