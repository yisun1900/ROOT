...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_khxx.jzkfkcs=cw_fkcs.fkcs(+) and crm_khxx.zt in('2','3') ";
...
//进行对象初始化
	...
	pageObj.initPage("Crm_khxxCxList.jsp","","","/cwgl/fcwdsk/fgck/InsertCw_khfkjlMain.jsp");
	pageObj.setPageRow(25);//设置每页显示记录数
	pageObj.setEditStr("收款");
	pageObj.setEditBolt("");
/*
//设置显示列
