...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (zt.equals("1"))
	{
		ls_sql="SELECT fkxh,crm_khxx.khxm,a.fklxmc fklxbm,cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,zcgysbh,cw_khfkjl.fkje,crm_khxx.hth,crm_khxx.fwdz,crm_khxx.khbh,DECODE(crm_khxx.zt,'2','家装客户','3','退单客户','4','非家装客户','5','设计客户') khlx,cw_khfkjl.skr,cw_khfkjl.sksj,cw_khfkjl.sjr,cw_khfkjl.sjsj,dwmc,cw_khfkjl.bz  ";
		...
		ls_sql=" SELECT cw_khfkjl.fkxh,crm_zxkhxx.khxm,a.fklxmc fklxbm,cw_khfkjl.sjbh,zffsmc,b.fklxmc zckx,zcgysbh,cw_khfkjl.fkje,hth,crm_zxkhxx.fwdz,crm_zxkhxx.khbh,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过') khlx,cw_khfkjl.skr,cw_khfkjl.sksj,cw_khfkjl.sjr,cw_khfkjl.sjsj,dwmc,cw_khfkjl.bz  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khfkjlList.jsp","SelectCw_khfkjl.jsp","","/cwgl/fcwdsk/qtsk/EditCw_khfkjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"/cwgl/fcwdsk/qtsk/DeleteCw_khfkjl.jsp"};//按钮单击调用的网页，可以增加参数
