...
<%
    ...
    ls_sql+=" where (crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)) and (gdjsjd='0' or gdjsjd is null) and gcjdbm in('4','5')";
    //ls_sql+="and zjxwcbz='2'";           //2006-12-25  只有增减项的才能结算
	ls_sql+=wheresql;
