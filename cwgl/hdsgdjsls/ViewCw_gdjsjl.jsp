...
{
	%> 
          <input name="button" type="button" onClick="window.open('/dzbj/zxbjmx/Bj_khbjmxDyList.jsp?khbh=<%=khbh%>')" value="完工结算单">
          <%
}
else{
	%> 
          <input name="button" type="button" onClick="window.open('/gcgl/zjx/dzbj/zxbjmx/Bj_khbjmxJsList.jsp?khbh=<%=khbh%>&zjxxh=<%=zjxxh%>')" value="完工结算单">
          <%
}
...
%> 
          ...
          <input type="button" onClick="window.open('/cwgl/sgdjs/ViewJkjlList.jsp?gdjsjlh=<%=gdjsjlh%>')" value="借款记录">
          <input type="button" onClick="window.open('/cwgl/sgdjs/ViewWxjlList.jsp?gdjsjlh=<%=gdjsjlh%>')" value="维修记录">
          <input type="button" onClick="window.open('/cwgl/sgdjs/ViewFkjlList.jsp?gdjsjlh=<%=gdjsjlh%>')" value="罚款记录">
          <input type="button" onClick="window.open('/cwgl/sgdjs/ViewKqtkList.jsp?gdjsjlh=<%=gdjsjlh%>')" value="扣其它款">
...
%></td>
      ...
      <tr> 
        ...
        <td width="28%" bgcolor="#FFFFCC"><%=qye%></td>
        <td width="24%" bgcolor="#FFFFCC"> 
          <div align="right">工程原报价</div>
        </td>
        <td width="26%" bgcolor="#FFFFCC"> <%=cw_gdjsjl_wdzgce%> </td>
      </tr>
      <tr> 
        <td width="22%" bgcolor="#FFFFCC" align="right">折后累计增减项</td>
        <td width="28%" bgcolor="#FFFFCC"><%=zhzjxje%></td>
        <td width="24%" bgcolor="#FFFFCC" align="right">折前累计增减项</td>
        <td width="26%" bgcolor="#FFFFCC"><%=cw_gdjsjl_zjxje%></td>
      </tr>
      <tr> 
        <td width="22%" bgcolor="#FFFFCC"> 
          <div align="right">工程实际发生额</div>
        </td>
        <td width="28%" bgcolor="#FFFFCC"><%=(qye+zhzjxje)%>（<font color="#0000FF">签约额</font>＋<font color="#0000FF">折后增减项</font>）</td>
        <td width="24%" bgcolor="#FFFFCC"> 
      ...
      <tr> 
        <td align="right" bgcolor="#CCCCFF">结算方式</td>
        <td bgcolor="#CCCCFF"><%
	cf.selectToken(out,"1+计提管理费&2+定额结算",jsfs,true);
		%></td>
...
%></td>
      ...
      <tr> 
        ...
        <td align="right" bgcolor="#CCCCFF">需补材料款</td>
        <td bgcolor="#CCCCFF"><%=xbclk%></td>
      </tr>
      <tr> 
        <td colspan="4" align="center">工程扣款</td>
      </tr>
      <tr> 
      ...
      <tr> 
        <td colspan="4" align="center">罚款</td>
      </tr>
      <tr> 
        <td align="right" bgcolor="#CCCCFF">施工队罚款</td>
        <td bgcolor="#CCCCFF"><%=sgdfk%></td>
        <td align="right" bgcolor="#CCCCFF">设计师罚款</td>
        <td bgcolor="#CCCCFF"><%=sjsfk%></td>
      </tr>
      <tr> 
        <td colspan="4" align="center">财务</td>
      </tr>
      <tr> 
        <td align="right" bgcolor="#CCCCFF">物流材料费</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_clf%></td>
        <td align="right" bgcolor="#CCCCFF">自购材料费</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_zgclf%></td>
      </tr>
      <tr> 
        <td align="right" bgcolor="#CCCCFF">税金</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_sj%></td>
        <td align="right" bgcolor="#CCCCFF">扣水电费</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_ksdf%></td>
      </tr>
      <tr bgcolor="#FFFFFF"> 
        <td align="right"><b><font color="#0000CC">工队结算款总额</font></b></td>
        <td colspan="3"><%=cw_gdjsjl_gdjskze%></td>
      </tr>
      <tr bgcolor="#FFFFFF"> 
        <td colspan="4"> 计提管理费：<font color="#3333FF">结算款</font>＝提点基数－管理费－税金－材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 
          <BR>
          定 额结 算：<font color="#3333FF">结算款</font>＝&nbsp;&nbsp;&nbsp;&nbsp;定额结算金额－税金－材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 
          －需补材料款</td>
      </tr>
      <tr> 
      ...
      <tr bgcolor="#FFFFCC"> 
        <td align="right">维修金百分比</td>
        <td><%=wxjbfb%>%</td>
        <td align="right">维修金</td>
        <td><%=cw_gdjsjl_wxj%></td>
      </tr>
      <tr> 
      ...
      <tr> 
        <td align="right" bgcolor="#FFFFCC" height="19">罚款金额</td>
        <td bgcolor="#FFFFCC" height="19"><%=cw_gdjsjl_fakuan%></td>
        <td align="right" bgcolor="#FFFFCC" height="19">扣其它款</td>
        <td bgcolor="#FFFFCC" height="19"><%=cw_gdjsjl_kqtk%></td>
      </tr>
      <tr> 
        <td width="22%" bgcolor="#FFFFCC"> 
          <div align="right"><font color="#0000CC"><b>税前工资</b></font></div>
        </td>
        <td width="28%" bgcolor="#FFFFCC"><%=cw_gdjsjl_sqgz%> </td>
        <td width="24%" bgcolor="#FFFFCC"> 
          <div align="right"></div>
        </td>
        <td width="26%" bgcolor="#FFFFCC">&nbsp;</td>
      ...
      <tr bgcolor="#FFFFCC"> 
        <td align="right">&nbsp;</td>
        <td colspan="3">税前工资 = 工队结算款总额－维修金-扣维修费－借款－罚款金额－其它扣款</td>
      </tr>
      <tr> 
...
%></td>
      ...
      <tr> 
        <td align="right" bgcolor="#CCCCFF">财务结算人</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_cwjsr%></td>
        <td align="right" bgcolor="#CCCCFF">财务结算时间</td>
        <td bgcolor="#CCCCFF"><%=cw_gdjsjl_cwjssj%></td>
      </tr>
      <tr> 
        <td align="right" bgcolor="#CCCCFF">财务结算说明</td>
        <td colspan="3" bgcolor="#CCCCFF"><%=cw_gdjsjl_cwjssm%></td>
      </tr>
      <tr> 
