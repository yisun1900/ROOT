...
try {
	...
	ls_sql="SELECT khbh,dejsje,xbclk";
...
<table border="1" width="120%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	//输出项目明细
	ls_sql="SELECT xmbh,xh,xmmc,jldwmc,sl,dwbjdj,dwbjje,cbdj,cbje,mll,mle,jsblxs,nbjsdj,nbjsje,gsmll,gsmlr,clfbfb,bjlx,DECODE(bjlx,'1','标准','2','自定义','3','特殊项目') bjlxmc";
