...
try {
	...
	ls_sql="select ssfgs,ygbh,bianhao,yhmc,xzzwbm,zwbm,dwbh,lx,txbz,jbgz,gwgz,glgz,jtbt,dhbt,cb,buzhu,dixin,dxsf,khgz,jxfz,jxgz,khyj,bqyjze,sqyj,cqts,sjts,bjts,kgts,sjkk,bjkk,cjkk,kgkk,qqkk,jbf,kbx,jf,kzbj,qtkk,yfgz,ksk,sfgz,lrr,lrsj,bz,khzq,jxgzjs,yjkhkk,cjts,jbts ";
...
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="khzq" size="20" maxlength="6"  value="<%=khzq%>" >    </td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">分公司</td>
    <td><input type="text" name="ssfgs" size="20" maxlength="5"  value="<%=ssfgs%>" >    </td>
    <td align="right">员工序号</td>
    <td><input type="text" name="ygbh" size="20" maxlength="8"  value="<%=ygbh%>" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">员工编号</td>
    <td><input type="text" name="bianhao" size="20" maxlength="20"  value="<%=bianhao%>" >    </td>
    <td align="right">员工姓名</td>
    <td><input type="text" name="yhmc" size="20" maxlength="50"  value="<%=yhmc%>" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">行政职务</td>
    <td><input type="text" name="xzzwbm" size="20" maxlength="30"  value="<%=xzzwbm%>" >    </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">底薪</td> 
  <td width="32%"><input type="text" name="dixin" size="20" maxlength="17"  value="<%=dixin%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">考核业绩</td> 
  <td width="32%"> 
    <input type="text" name="khyj" size="20" maxlength="17"  value="<%=khyj%>" >  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">本期业绩总额</td>
  <td><input type="text" name="bqyjze" size="20" maxlength="17"  value="<%=bqyjze%>" ></td>
  <td align="right">连续3期业绩</td>
  <td><input type="text" name="sqyj" size="20" maxlength="17"  value="<%=sqyj%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">业绩考核扣款</td>
  <td><input type="text" name="yjkhkk" size="20" maxlength="17"  value="<%=yjkhkk%>" ></td>
  <td align="right">考核工资</td>
  <td><input type="text" name="khgz" size="20" maxlength="17"  value="<%=khgz%>" ></td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">产假天数</td> 
  <td width="32%"><input type="text" name="cjts" size="20" maxlength="9"  value="<%=cjts%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">事假扣款</td> 
  <td width="32%"> 
    <input type="text" name="sjkk" size="20" maxlength="17"  value="<%=sjkk%>" >  </td>
  <td align="right" width="18%">病假扣款</td> 
  <td width="32%"> 
    <input type="text" name="bjkk" size="20" maxlength="17"  value="<%=bjkk%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">产假扣款</td> 
  <td width="32%"> 
    <input type="text" name="cjkk" size="20" maxlength="17"  value="<%=cjkk%>" >  </td>
  <td align="right" width="18%">旷工扣款</td> 
  <td width="32%"> 
    <input type="text" name="kgkk" size="20" maxlength="17"  value="<%=kgkk%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">缺勤扣款</td> 
  <td width="32%"> 
    <input type="text" name="qqkk" size="20" maxlength="17"  value="<%=qqkk%>" >  </td>
  <td align="right" width="18%">加班费</td> 
  <td width="32%"> 
    <input type="text" name="jbf" size="20" maxlength="17"  value="<%=jbf%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">扣保险</td> 
  <td width="32%"> 
    <input type="text" name="kbx" size="20" maxlength="17"  value="<%=kbx%>" >  </td>
  <td align="right" width="18%">奖罚</td> 
  <td width="32%"><input type="text" name="jf" size="20" maxlength="17"  value="<%=jf%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="yfgz" size="20" maxlength="17"  value="<%=yfgz%>" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
