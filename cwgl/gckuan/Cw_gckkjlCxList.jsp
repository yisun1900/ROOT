...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_gckkjl.kkjlh,DECODE(cw_gckkjl.spbz,'2','未审批','3','审批通过','4','审批未通过'), DECODE(cw_gckkjl.jsbz,'N','未结算','Y','已结算'), DECODE(cw_gckkjl.sjsjsbz,'N','未结算','Y','已结算'), DECODE(cw_gckkjl.zjjsbz,'N','未结算','Y','已结算'),crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_khxx.qyrq,sgdmc,crm_khxx.zjxm,b.dwmc qydm,cw_gckkjl.gckk,cw_gckkjl.sjsfy,cw_gckkjl.sgdfy,cw_gckkjl.zjfy,cw_gckkjl.gsfy,cw_gckkjl.qtfy,cw_gckkjl.spgckk,cw_gckkjl.spsjsfy,cw_gckkjl.spsgdfy,cw_gckkjl.spzjfy,cw_gckkjl.spgsfy,cw_gckkjl.spqtfy,cw_gckkjl.lrr,cw_gckkjl.lrsj,a.dwmc lrbm,cw_gckkjl.spyj,cw_gckkjl.spr,cw_gckkjl.spsj,cw_gckkjl.jsjlh,cw_gckkjl.sjsjsjlh,cw_gckkjl.zjjsjlh,cw_gckkjl.bz,cw_gckkjl.khbh  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_gckkjlCxList.jsp","SelectCxCw_gckkjl.jsp","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="2%">扣款记录号</td>
	<td  width="2%">审批标志</td>
	<td  width="2%">施工队结算标志</td>
	<td  width="2%">设计师结算标志</td>
	<td  width="2%">质检结算标志</td>
	<td  width="2%">客户姓名</td>
	<td  width="7%">房屋地址</td>
	<td  width="2%">合同号</td>
	<td  width="2%">设计师</td>
	...
	<td  width="2%">审批人</td>
	<td  width="3%">审批时间</td>
	<td  width="2%">施工队结算记录号</td>
	<td  width="2%">设计师结算记录号</td>
	<td  width="2%">质检结算记录号</td>
	<td  width="7%">备注</td>
	<td  width="2%">客户编号</td>
</tr>
<%
