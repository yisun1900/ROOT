...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_gckkjlXgSpList.jsp" name="selectform">
<div align="center">审批工程扣款--修改</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%">
<INPUT name="cw_gckkjl_jsbz" type="radio" value="N" checked>
未结算</td>
  <td align="right" width="20%">设计师结算标志</td>
  <td width="30%"><input name="cw_gckkjl_sjsjsbz" type="radio" value="N" checked>
未结算</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%">
<INPUT name="cw_gckkjl_zjjsbz" type="radio" value="N" checked>
未结算</td>
  <td align="right" width="20%">&nbsp;</td>
  <td width="30%">&nbsp;</td>
</tr>
