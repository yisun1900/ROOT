...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	cw_sgdwgjsty_khbh=request.getParameter("cw_sgdwgjsty_khbh");
	if (cw_sgdwgjsty_khbh!=null)
	{
		cw_sgdwgjsty_khbh=cf.GB2Uni(cw_sgdwgjsty_khbh);
		if (!(cw_sgdwgjsty_khbh.equals("")))	wheresql+=" and  (cw_sgdwgjsty.khbh='"+cw_sgdwgjsty_khbh+"')";
	}
    ...
    ls_sql+=" and cw_sgdwgjsty.clzt='2'";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sgdwgjstyList.jsp","","","XgShCw_sgdwgjsty.jsp");
