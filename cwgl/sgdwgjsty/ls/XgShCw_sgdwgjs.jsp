...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgShCw_sgdwgjsty.jsp" name="insertform">
...
<%
    ...
    ls_sql+=" where cw_sgdbgfty.lx=dm_gdjsjd.gdjsjd(+) ";
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="qtf" value="<%=qtf%>" size="20" maxlength="17" >    </td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td colspan="3"><input type="text" name="qtfsm" value="<%=qtfsm%>" size="72" maxlength="100" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><font color="#FF0000">*</font>客户欠款</td>
    <td><input type="text" name="khqk" value="<%=khqk%>" size="20" maxlength="17" readonly></td>
    <td align="right"><font color="#FF0000">*</font>延期费</td>
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input type="text" name="clyf" value="0" size="20" maxlength="17" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
