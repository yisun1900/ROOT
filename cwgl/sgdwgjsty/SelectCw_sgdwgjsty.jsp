...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdwgjstyList.jsp" name="selectform">
...
%>
  ...
  <td width="32%"><input type="text" name="sgbz" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="jsrq" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="jsrq2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">处理状态</td> 
  <td colspan="3"> 
<%
	cf.radioToken(out, "spzt","1+结算&2+审批同意&3+审批不同意","");
%>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">审批时间 从</td> 
  <td width="32%"><input type="text" name="spsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="spsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入人</td>
  <td><input type="text" name="lrr" size="20" maxlength="20" ></td>
  <td align="right">审批人</td>
  <td><input type="text" name="spr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jsrq2, "结算日期"))) {
		return false;
	}
