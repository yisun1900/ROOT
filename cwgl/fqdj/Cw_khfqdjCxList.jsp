...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khxm,fwdz,sgdmc,a.dwmc dm,crm_khxx.wdzgce,crm_khxx.qye-cw_khfqdj.fqje,fqmc,fqbh,fqje,yxrq,cw_khfqdj.jlh,cw_khfqdj.khbh,cw_khfqdj.lrr,cw_khfqdj.lrsj,b.dwmc lrbm, DECODE(sybz,'1','未用','2','已使用'),syjlh, DECODE(scbz,'N','未删除','Y','已删除'),scr,scsj,cw_khfqdj.bz  ";
...
<CENTER >
  <B><font size="3">客户返券登记－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
