...
<form method="post" action="Cw_gdjkjlCxList.jsp" name="selectform">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <select name="cw_gdjkjl_gdjsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"0+未结算&1+已结算","");
%> 
                </select>
              </td>
              <td width="18%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right">数据类型</td>
              <td width="32%"> 
                <input type="radio" name="czlx" value="1" >
                录入
