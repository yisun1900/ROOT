...
<form method="post" action="Cw_khfkjlCxWshList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right">材料顾问              </td>
              <td width="32%"><input type="text" name="clgw" size="20" maxlength="20" value="<%=clgw%>" <% if (!clgw.equals("")) out.println("readonly");%>></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
