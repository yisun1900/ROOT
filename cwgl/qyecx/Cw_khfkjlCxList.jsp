...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String gysbh2=null;
	gysbh2=request.getParameter("gysbh2");
	if (gysbh2!=null)
	{
		gysbh2=cf.GB2Uni(gysbh2);
		if (!(gysbh2.equals("")))	wheresql+=" and  (cw_khfkjl.gysbh like '%"+gysbh2+"%')";
	}
	...
	if (!(crm_khxx_hth.equals("")))
	{
		ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,cw_khfkjl.fkkhxm,cw_khfkjl.fkfwdz,DECODE(zt,'2','家装客户','3','退单客户','4','非家装客户','5','设计客户') zt,a.fklxmc fklxbm,cw_khfkjl.fkxh,fkcsmc,cw_khfkjl.gysbh,cw_khfkjl.ddbh,cw_khfkjl.zjxbh,cw_khfkjl.fkje,zffsmc,b.fklxmc zckx,cw_khfkjl.zcgysbh,cw_khfkjl.zcddbh,cw_khfkjl.zczjxbh,NVL2(cw_khfkjl.yfkbl,cw_khfkjl.yfkbl||'%',''),cw_khfkjl.yfkje,DECODE(skdd,'1','不需审核','2','需审核'),DECODE(dsksjbz,'N','未审核','Y',' 审核通过','M','审核未通过'),cw_khfkjl.sjbh,cw_khfkjl.skr,cw_khfkjl.sksj,a.dwmc,cw_khfkjl.sjr,cw_khfkjl.sjsj,DECODE(scbz,'N','未删除','Y','删除'),scr,scsj,DECODE(cw_khfkjl.gljlbz,'N','非关联','Y','关联'),cw_khfkjl.glxh,cw_khfkjl.shyj,cw_khfkjl.bz  ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khfkjlCxList.jsp","SelectCxCw_khfkjl.jsp","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">付款房屋地址</td>
	<td  width="2%">客户类型</td>
	<td  width="3%">收款类型</td>
	<td  width="2%">收款序号</td>
	<td  width="2%">收款期数</td>
	<td  width="3%">收款品牌</td>
	<td  width="2%">收款订单编号</td>
	<td  width="2%">收款增减项编号</td>
	<td  width="3%">实收款金额</td>
	<td  width="2%">支付方式</td>
	<td  width="3%">转帐款项</td>
	<td  width="3%">转帐品牌</td>
	<td  width="2%">转帐订单编号</td>
	<td  width="2%">转帐增减项编号</td>
	<td  width="2%">应收款率</td>
	<td  width="4%">应收款金额</td>
	<td  width="2%">是否需审核</td>
	<td  width="2%">审核标志</td>
