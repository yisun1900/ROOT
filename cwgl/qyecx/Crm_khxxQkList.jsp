...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">验收项目</td>
	<td  width="4%">验收时间</td>
	<td  width="3%">应收款百分比</td>
	<td  width="3%">实收款百分比</td>
	<td  width="4%">工程原报价</td>
	<td  width="5%">家装签约额</td>
	<td  width="4%">增减项</td>
	<td  width="4%">工程实收款</td>
	<td  width="4%">收款期数</td>
	<td  width="4%">最近收款时间</td>
...
<%
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,ysgcjdmc,dm_gcysxm.gcysxmmc,crm_khxx.szqsj,dm_gcysxm.ljskbfb||'%',ROUND(NVL(crm_khxx.cwsfke,0)*100/crm_khxx.qye,2)||'%',crm_khxx.wdzgce,crm_khxx.qye,NVL(crm_khxx.zjxje,0),NVL(crm_khxx.cwsfke,0),NVL2(cwjzkfkcs,cwjzkfkcs||'期','无收款'),jzkfksj,sjkgrq,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.khbh";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_gcysxm";
	...
	ls_sql+=" and ROUND(NVL(crm_khxx.cwsfke,0)*100/crm_khxx.qye,2)<dm_gcysxm.ljskbfb ";
	ls_sql+=" and  crm_khxx.qye!=0";
    ls_sql+=wheresql;
