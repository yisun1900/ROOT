...
<form method="post" action="Crm_khxxQkList.jsp" name="selectform">
...
%> 
              ...
              <td width="17%"> 
                <div align="right">停工标志</div>              </td>
              <td width="33%"><select name="tgbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                <option value=""></option>
