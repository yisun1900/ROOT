...
<form method="post" action="Cw_khfkjlCxZcList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="17%" align="right"><strong>是否撤店</strong></td>
              <td width="33%">
                <input type="radio" name="sfcd" value="Y">撤店
                <input type="radio" name="sfcd" value="N">否              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td> 
                <select name="fklxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectItem(out,"select fklxbm,fklxmc from cw_fklxbm where fklxbm='23'","");
%> 
                </select>              </td>
            </tr>
