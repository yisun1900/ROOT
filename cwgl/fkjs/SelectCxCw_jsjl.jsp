...
<form method="post" action="Cw_jsjlCxList.jsp" name="selectform">
...
%> 
	...
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
        out.println("        <select name=\"fgs\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" onChange=\"selectItem(fgs,jsdw,"+dwstr+");\">");
		out.println("<option value=\"\"></option>");
