...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_zbjxgjlCxList.jsp" name="selectform">
<div align="center">查询质保金修改记录</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><label>
    <input type="radio" name="scbz" value="Y">删除
    <input name="scbz" type="radio" value="N" checked>
    未删除
  </label></td>
  <td align="right">类型</td>
  <td><input type="radio" name="lx" value="1">手工录入
    <input type="radio" name="lx" value="2">完工结算
    <input type="radio" name="lx" value="3">工地维修</td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
