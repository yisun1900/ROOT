...
try {
	...
	if (jzbz.equals("1"))
	{
		glf=(tdjsje-sj)*glftd/100;//家装管理费＝（提点基数－税金）×管理费提点
	}
	else{
		glf=tdjsje*glftd/100;//公装管理费＝提点基数×管理费提点
	}
	...
	ls_sql+=" where kp_xjgdjl.khbh=crm_khxx.khbh and crm_khxx.sgd='"+sgd+"' and kp_xjgdjl.jsbz='N' and kp_xjgdjl.cfspbz='3' ";//2：未审批；3：审批通过；4：审批未通过
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
	if (rs.next())
	{
		fakuan=rs.getDouble(1);//罚款金额
	}
	rs.close();
	ps.close();
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000FF">折扣率</font></td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000FF">客户结算金额</font></td>
              <td width="31%"> 
                <input type="text" name="khjskze" value="<%=khjskze%>" size="20" maxlength="17" onChange="f_jsglf(editform)" readonly>
              </td>
              <td align="right" width="18%"><font color="#0000FF">实际成本</font></td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000FF">提点基数</font></div>
              </td>
              <td width="31%"> 
...
%> 
              ...
              <td width="18%"> 
                <div align="right"><font color="#0000FF">提点基数金额</font></div>
              </td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000FF">设计师承担费用</font></div>
              </td>
              <td width="31%"> 
                <input type="text" name="sjsfy" size="20" maxlength="17"  value="<%=sjsfy%>" readonly>
              </td>
              <td width="18%"> 
                <div align="right"><font color="#0000FF">施工队承担费用</font></div>
              </td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000FF">质检承担费用</font></div>
              </td>
              <td width="31%"> 
                <input type="text" name="zjfy" size="20" maxlength="17"  value="<%=zjfy%>" readonly>
              </td>
              <td width="18%"> 
                <div align="right"><font color="#0000FF">公司承担费用</font></div>
              </td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000FF">其它方承担费用</font></div>
              </td>
              <td width="31%"> 
                <input type="text" name="qtfy" size="20" maxlength="17"  value="<%=qtfy%>" readonly>
              </td>
              <td width="18%"> 
                <div align="right"><font color="#0000FF">工程扣款</font></div>
              </td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#E8E8FF" width="19%"><font color="#0000FF">备注</font></td>
              <td colspan="3" bgcolor="#E8E8FF"><%=bz%></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#FFFFCC" width="19%"><font color="#0000FF">管理费提点</font></td>
              <td bgcolor="#FFFFCC" width="31%"> 
                <input type="text" name="glftd" size="10" maxlength="17"  value="<%=glftd%>" onChange="f_jsk(insertform)" readonly>
                % </td>
              <td align="right" bgcolor="#FFFFCC" width="18%"><font color="#0000FF">管理费</font></td>
              <td bgcolor="#FFFFCC" width="32%"> 
                <input type="text" name="glf" size="20" maxlength="17"  value="<%=glf%>" onChange="f_jsk(insertform)" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#FFFFCC" width="19%"><font color="#0000FF">维修金百分比</font></td>
              <td bgcolor="#FFFFCC" width="31%"> 
                <input name="wxjbfb" type="text" onChange="f_wxj(editform)"  value="<%=wxjbfb%>" size="10" maxlength="17" readonly>
                % </td>
              <td align="right" bgcolor="#FFFFCC" width="18%"><font color="#0000FF">维修金</font></td>
              <td bgcolor="#FFFFCC" width="32%"> 
                <input type="text" name="wxj" size="20" maxlength="17"  value="<%=wxj%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#FFFFCC" width="19%"><font color="#0000FF">审批结论</font></td>
              <td bgcolor="#FFFFCC" width="31%"> <%
	cf.radioToken(out, "spjl","3+同意&4+不同意",spjl,true);
%> </td>
              <td bgcolor="#FFFFCC" width="18%" align="right"><font color="#0000FF">补款</font></td>
              <td bgcolor="#FFFFCC" width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td bgcolor="#FFFFCC" width="19%"> 
                <div align="right"><font color="#0000FF">审批人</font></div>
              </td>
              <td bgcolor="#FFFFCC" width="31%"> <%=spr%> </td>
              <td bgcolor="#FFFFCC" width="18%"> 
                <div align="right"><font color="#0000FF">审批时间</font></div>
              </td>
              <td bgcolor="#FFFFCC" width="32%"> <%=spsj%> </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" bgcolor="#FFFFCC" width="19%"><font color="#0000FF">审批意见</font></td>
              <td colspan="3" bgcolor="#FFFFCC"> <%=spyj%> </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" width="19%"><font color="#0000FF">定额结算金额</font></td>
              <td width="31%">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000FF">扣维修费</font></td>
              <td width="31%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"> 扣其它款</td>
              <td width="31%"> 
                <input type="text" name="kqtk" value="<%=kqtk%>" size="20" maxlength="17" >
              </td>
              <td align="right" width="18%">扣水电费</td>
              <td width="32%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">财务结算说明</td>
              <td colspan="3"> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <p> 
                  ...
                  <input type="button" value="查看结算信息" onClick="f_ck(insertform)" name="ck" disabled>
                  <input type="reset"  value="重输" name="reset">
                  <input name="button2" type="button" onClick="window.open('/khxx/ViewCwxx.jsp?khbh=<%=khbh%>')" value="客户收款信息">
                  <input type="hidden" name="khbh" value="<%=khbh%>" >
                  <input type="hidden" name="gdjsjlh" value="<%=gdjsjlh%>" >
                </p>
                <p>
                  <input name="button4" type="button" onClick="window.open('dejs.jsp?khbh=<%=khbh%>&gdjsjlh=<%=gdjsjlh%>')" value="定额结算">
                  <input type="button" onClick="window.open('/cwgl/sgdjs/JkjlList.jsp?khbh=<%=khbh%>')" value="借款记录">
                  <input type="button" onClick="window.open('/cwgl/sgdjs/WjsWxjlList.jsp?sgd=<%=sgd%>')" value="未结算维修记录">
                  <input type="button" onClick="window.open('/cwgl/sgdjs/WjsFkjlList.jsp?sgd=<%=sgd%>')" value="未结算罚款记录">
                  <input type="button" onClick="window.open('/cwgl/sgdjs/WjsKqtkList.jsp?sgd=<%=sgd%>')" value="未结算扣其它款">
                </p>
              </td>
            </tr>
          </table>
