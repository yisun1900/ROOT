...
try {
	...
	ls_sql="update cw_gckkjl set gckk=?,sjsfy=?,sgdfy=?,zjfy=?,gsfy=?,qtfy=?,spgckk=?,spsjsfy=?,spsgdfy=?,spzjfy=?,spgsfy=?,spqtfy=?,lrr=?,lrsj=?,lrbm=?,bz=? ";
	ls_sql+=" where  (kkjlh='"+wherekkjlh+"' and jsbz='Y' and cw_gckkjl.spbz='2')  ";
