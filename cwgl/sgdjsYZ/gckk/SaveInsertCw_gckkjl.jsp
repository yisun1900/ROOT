...
try {
	...
	ls_sql="insert into cw_gckkjl ( kkjlh,khbh,gckk,sjsfy,sgdfy,zjfy,gsfy,qtfy,spgckk,spsjsfy,spsgdfy,spzjfy,spgsfy,spqtfy,lrr,lrsj,lrbm,spbz,jsbz,jsjlh,sjsjsbz,zjjsbz,bz ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'2','Y',?,'N','N',? ) ";
