...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.spsjsfy, "设计师承担费用"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.spsgdfy, "施工队承担费用"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.spzjfy, "质检承担费用"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.spgsfy, "公司承担费用"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.spqtfy, "其它方承担费用"))) {
		return false;
	}
