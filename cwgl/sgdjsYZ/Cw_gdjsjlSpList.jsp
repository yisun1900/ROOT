...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_gdjsjl.gdjsjlh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.hth,crm_khxx.zjxm ,sgdmc, DECODE(cw_gdjsjl.jzbz,'1','家装','2','公装'),cw_gdjsjl.wdzgce,cw_gdjsjl.qye,cw_gdjsjl.zkl,cw_gdjsjl.zjxje,cw_gdjsjl.khjskze,cw_gdjsjl.khsskze,cw_gdjsjl.sjcb, DECODE(cw_gdjsjl.tdjs,'1','客户结算金额','2','实收款','3','签约额','4','实际成本'),cw_gdjsjl.tdjsje,cw_gdjsjl.wxj,cw_gdjsjl.clf,cw_gdjsjl.zgclf,cw_gdjsjl.jkje,cw_gdjsjl.fakuan,cw_gdjsjl.kwxf,cw_gdjsjl.gckk,cw_gdjsjl.kqtk,cw_gdjsjl.bk,cw_gdjsjl.gdjskze,cw_gdjsjl.jsr,cw_gdjsjl.jssj,dwmc, DECODE(cw_gdjsjl.jsjd,'1','结算部结算','2','结算审批','3','财务结算'), DECODE(cw_gdjsjl.fkbz,'1','未收款','2','已付款'),cw_gdjsjl.khbh,cw_gdjsjl.bz";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_gdjsjlSpList.jsp","SelectSpCw_gdjsjl.jsp","","SpCw_gdjsjl.jsp");
...
<CENTER >
  <B><font size="3">施工队结算--结算审批</font></B>
</CENTER>
<%
	pageObj.out=out;
