...
try {
	...
	for (int i=0;i<xmbh.length ;i++ )
	{
		...
		ls_sql+=" where cw_dejsmx.khbh='"+khbh+"' and cw_dejsmx.xmbh='"+xmbh[i]+"'";
		...
		ls_sql="update cw_dejsmx set jsblxs="+jsblxs+",nbjsdj="+nbjsdj+",nbjsje="+nbjsje+",gsmll="+gsmll+",gsmlr="+gsmlr;
		ls_sql+=" where cw_dejsmx.khbh='"+khbh+"' and cw_dejsmx.xmbh='"+xmbh[i]+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();
