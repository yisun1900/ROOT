...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工队结算--财务结算</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Cw_gdjsjlCwList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"><%
	cf.radioToken(out, "cw_gdjsjl_spjl","3+通过","3");
%></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td width="15%"> 
