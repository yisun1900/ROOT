...
try {
	...
	ls_sql="select jsfs,sgdfk,sjsfk,xbclk,jsr,jssj,dejsje,wxjbfb,wxj,spr,spsj,spjl,spyj,khbh,sgd,khjskze,khsskze,sjcb,tdjs,glftd,ksdf,bk,bz,tdjsje,gckk,sjsfy,sgdfy,zjfy,gsfy,qtfy ";
...
//定 额结 算：结算款＝   定额结算金额－税金－材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 －需补材料款 
	...
	gdjskze=    dejsje-sj-clf-zgclf-sgdfy-ksdf+bk-sgdfk-xbclk;
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="text" name="sj" value="<%=sj%>" size="20" maxlength="17" onChange="f_gdjskze(insertform)">
              </td>
              <td align="right" width="21%">扣水电费</td>
              <td width="29%"> 
                <input name="ksdf" type="text" id="ksdf" value="0" size="20" maxlength="17" onchange="f_gdjskze(insertform)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td colspan="4"> <font color="#0000FF">工队结算款总额</font>＝定额结算金额－税金－物流材料费－自购材料费－工程扣款－扣水电费＋补款－施工队罚款 
                －需补材料款 </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="30%"> 
                <input type="text" name="kwxf" value="" size="20" maxlength="17" onchange="f_sqgz(insertform)">
              </td>
              <td align="right" width="21%">借款金额</td>
              <td width="29%"> 
                <input type="text" name="jkje" value="" size="20" maxlength="17" onchange="f_sqgz(insertform)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="20%">罚款金额</td>
              <td width="30%"> 
                <input type="text" name="fakuan" value="" size="20" maxlength="17" onchange="f_sqgz(insertform)">
              </td>
              <td align="right" width="21%">其它扣款</td>
              <td width="29%"> 
                <input type="text" name="kqtk" value="" size="20" maxlength="17" onchange="f_sqgz(insertform)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="20%" align="right"><b><font color="#FF0000">*</font><font color="#0000FF">税前工资</font></b></td>
              <td width="30%"> 
                <input type="text" name="sqgz" value="" size="20" maxlength="9" readonly>
              </td>
              <td width="21%">&nbsp;</td>
              <td width="29%">&nbsp;</td>
            </tr>
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <p> 
                  ...
                  <input type="button" value="查看结算信息" onClick="window.open('/cwgl/hdsgdjs/ViewCw_gdjsjl.jsp?gdjsjlh=<%=gdjsjlh%>')" name="ck" disabled>
                ...
                <p> 
                  ...
                  <input type="button" onClick="window.open('/cwgl/hdsgdjs/JsWxjlList.jsp?sgd=<%=sgd%>&gdjsjlh=<%=gdjsjlh%>')" value="维修费">
                  <input type="button" onClick="window.open('/cwgl/hdsgdjs/JsJkjlList.jsp?sgd=<%=sgd%>&gdjsjlh=<%=gdjsjlh%>')" value="借款记录" name="button">
                  <input type="button" onClick="window.open('/cwgl/hdsgdjs/JsFkjlList.jsp?sgd=<%=sgd%>&gdjsjlh=<%=gdjsjlh%>')" value="罚款">
                  <input type="button" onClick="window.open('/cwgl/hdsgdjs/JsKqtkList.jsp?sgd=<%=sgd%>&gdjsjlh=<%=gdjsjlh%>')" value="其它扣款">
                </p>
              </td>
            </tr>
          </table>
