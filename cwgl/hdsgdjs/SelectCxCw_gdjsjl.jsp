...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="cw_gdjsjl_jsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <%
	cf.selectToken(out,"0+未结算&1+结算部结算&2+结算审批&3+财务结算","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
...
%>
  ...
  <td bgcolor="#FFFFCC"><div align="right">签约店面</div></td>
...
<tr align="center"> 
  <td colspan="4"> 
    <input type="button"  value="查询" onClick="f_do(selectform,'cx')">
        <input type="button"  value="结算统计表－定额" onClick="f_do(selectform,'de')" name="button">
        <input type="button"  value="结算统计表－提点" onClick="f_do(selectform,'td')" name="button3">
