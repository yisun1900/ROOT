...
try {
	...
	ls_sql="insert into cw_gckkjl ( kkjlh,khbh,gckk,sjsfy,sgdfy,zjfy,gsfy,qtfy,spgckk,spsjsfy,spsgdfy,spzjfy,spgsfy,spqtfy,lrr,lrsj,lrbm,spbz,spr,spsj,jsbz,jsjlh,sjsjsbz,zjjsbz,bz ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'3',?,TRUNC(SYSDATE),'Y',?,'N','N',? ) ";
	...
	ps.setString(18,yhmc);
	ps.setString(19,gdjsjlh);
	ps.setString(20,bz);
