...
<%
	...
	ls_sql="SELECT bj_bjxmmxh.xmbh,bj_bjxmmxh.xmmc,bj_bjxmmxh.dj,bj_bjxmmxh.bjlx,bj_bjxmmxh.xmpx ";
	ls_sql+=" FROM bj_bjxmmxh";
    ls_sql+=" where bj_bjxmmxh.khbh='"+khbh+"' and bj_bjxmmxh.zjxxh='"+zjxxh+"' and bj_bjxmmxh.xmbh='"+xmbh+"'";
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		ls_sql+=" and bj_khglfxbh.glflbm='1' and bj_khglfxbh.wlllbz='N'";
		ps2= conn.prepareStatement(ls_sql);
		rs2 =ps2.executeQuery();
		if (rs2.next())
		{
		...
		ls_sql+=" FROM bdm_cljldwbm,bj_khglfxbh  ";
		ls_sql+=" where bj_khglfxbh.jldwbm=bdm_cljldwbm.cljldwbm(+) ";
		ls_sql+=" and khbh='"+khbh+"' and zjxxh='"+zjxxh+"' and xmbh='"+xmbh+"'";
		ls_sql+=" and bj_khglfxbh.glflbm='1' and bj_khglfxbh.wlllbz='N'";
