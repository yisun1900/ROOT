...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_khxx.gdjsjd='9'";//8:完工结算
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgFpList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJsFp.jsp"};//按钮单击调用的网页，可以增加参数
...
//设置列超级连接
	...
	coluParm.link="ViewCw_sgdwgjsjlkb.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">施工队完工结算－交发票－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">结算应付金额</td>
	
	<td  width="2%">材料评审处罚</td>
	<td  width="2%">库房领料金额</td>
	<td  width="2%">已付工程款</td>
	<td  width="2%">已扣工程处罚</td>
	<td  width="2%">其它扣款</td>
	<td  width="2%">现场营销费用</td>
	<td  width="2%">材料运费</td>
	<td  width="2%">工程实付金额</td>
	<td  width="2%">录入人</td>
	<td  width="2%">录入时间</td>
	<td  width="2%">录入部门</td>
	<td  width="32%">备注</td>
