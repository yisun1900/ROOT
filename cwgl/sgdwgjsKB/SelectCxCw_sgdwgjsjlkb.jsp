...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdwgjsjlkbCxList.jsp" name="selectform">
<div align="center">施工队完工结算－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <td width="32%"> 
    <input type="text" name="cw_sgdwgjsjlKB_jsjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">结算进度</td> 
  <td width="32%">
  <select name="gdjsjd" style="FONT-SIZE:12PX;WIDTH:152PX" >
	 <option value=""></option>
   <%
	cf.selectItem(out,"select gdjsjd,gdjsjdmc from dm_gdjsjd where gdjsjd in('7','8','9') order by gdjsjd","");
	%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">结算日期 从 </td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdwgjsjlKB_jsrq" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="cw_sgdwgjsjlKB_jsrq2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">结算比例 从</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdwgjsjlKB_jsbl" size="10" maxlength="9" >
    %</td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="cw_sgdwgjsjlKB_jsbl2" size="10" maxlength="9" >
  %</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从</td>
  <td><input type="text" name="cw_sgdwgjsjlKB_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="cw_sgdwgjsjlKB_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdwgjsjlKB_lrr" size="20" maxlength="20" >  </td>
...
{
	if(!(isDatetime(FormName.cw_sgdwgjsjlKB_jsrq, "结算日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdwgjsjlKB_jsrq2, "结算日期"))) {
		return false;
	}

	if(!(isFloat(FormName.cw_sgdwgjsjlKB_jsbl, "结算比例"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdwgjsjlKB_jsbl2, "结算比例"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdwgjsjlKB_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdwgjsjlKB_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
