...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT fkxh,crm_khxx.khxm,a.fklxmc fklxbm,gysbh,ddbh,zjxbh,cw_khfkjl.sjbh,cw_khfkjl.fkje,zffsmc,b.fklxmc zckx,zcgysbh,zcddbh,zczjxbh,crm_khxx.fwdz,crm_khxx.hth,cw_khfkjl.skr,cw_khfkjl.sksj,cw_khfkjl.sjr,cw_khfkjl.sjsj,dwmc,cw_khfkjl.bz  ";
