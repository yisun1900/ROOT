...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sjsjsjl.jsjlh,b.dwmc dwbh,c.dwmc sjsbh,cw_sjsjsjl.sjfw2,cw_sjsjsjl.dyqdze,cw_sjsjsjl.dyqds,cw_sjsjsjl.sjstcbl||'%',cw_sjsjsjl.sjsjsbl||'%',cw_sjsjsjl.dyjss,cw_sjsjsjl.jzssk,cw_sjsjsjl.wgjsje,cw_sjsjsjl.kqtk,cw_sjsjsjl.qdsyjsje,cw_sjsjsjl.sjf,cw_sjsjsjl.sjfksbl||'%',cw_sjsjsjl.sjftcbl||'%',cw_sjsjsjl.dyjsze,cw_sjsjsjl.lrr,cw_sjsjsjl.lrsj,a.dwmc lrbm, DECODE(cw_sjsjsjl.spbz,'2','未审批','3','审批通过','4','审批未通过'),cw_sjsjsjl.spyj,cw_sjsjsjl.spr,cw_sjsjsjl.spsj,cw_sjsjsjl.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sjsjsjlSpList.jsp","SelectSpCw_sjsjsjl.jsp","","SpCw_sjsjsjl.jsp");
