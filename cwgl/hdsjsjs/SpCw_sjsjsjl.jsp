...
<body bgcolor="#FFFFFF">
<div align="center"><strong>设计师结算---审批</strong> </div>
<form method="post" action="SaveSpCw_sjsjsjl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
<%
	cf.selectToken(out,"2+未审批&3+审批通过&4+审批未通过",cw_sjsjsjl_spbz,true);
%>  </td>
</tr>
<tr bgcolor="#FFFFFF">
