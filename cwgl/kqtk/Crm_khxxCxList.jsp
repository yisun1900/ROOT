...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khxm,fwdz,hth,dwmc,sgdmc sgd,sjs,zjxm,ysgcjdmc,sjkgrq,sjjgrq,khbh ";
...
//	ls_sql+=" and crm_khxx.gcjdbm not in('5')";
    ls_sql+=" and crm_khxx.sgd is not null";//0：未结算；1：完工结算；2：中期结算
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertCw_kqtkjl.jsp");
