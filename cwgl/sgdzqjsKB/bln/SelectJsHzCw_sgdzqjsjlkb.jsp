...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdzqjsjlkbJsHzList.jsp" name="selectform">
...
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <select name="gdjsjd" style="FONT-SIZE:12PX;WIDTH:152PX" >
        <option value=""></option>
   <%
		cf.selectItem(out,"select gdjsjd,gdjsjdmc from dm_gdjsjd where gdjsjd in('1','2','3') order by gdjsjd","");
	%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.cw_sgdzqjsjlkb_jsrq2, "结算日期"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.cw_sgdzqjsjlkb_jsbl2, "结算比例"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdzqjsjlkb_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdzqjsjlkb_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
