...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sgdzqjsjlkb.jsjlh,gdjsjdmc,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,sgdmc,cw_sgdzqjsjlkb.jsrq,cw_sgdzqjsjlkb.jsje,cw_sgdzqjsjlkb.jsbl||'%',cw_sgdzqjsjlkb.jskjs,crm_khxx.sjs,cw_sgdzqjsjlkb.sgbz,cw_sgdzqjsjlkb.khbh,cw_sgdzqjsjlkb.lrr,cw_sgdzqjsjlkb.lrsj,dwmc,cw_sgdzqjsjlkb.bz  ";
	ls_sql+=" FROM crm_khxx,cw_sgdzqjsjlkb,sq_sgd,sq_dwxx,dm_gdjsjd  ";
...
<CENTER >
  <B><font size="3">钛马赫三次结算－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
