...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sgdzqjsjlkb.jsjlh,cw_sgdzqjsjlkb.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,cw_sgdzqjsjlkb.sgbz,cw_sgdzqjsjlkb.jsrq,cw_sgdzqjsjlkb.jskjs,cw_sgdzqjsjlkb.jsbl||'%',cw_sgdzqjsjlkb.jsje,cw_sgdzqjsjlkb.lrr,cw_sgdzqjsjlkb.lrsj,dwmc,cw_sgdzqjsjlkb.bz  ";
    ...
    ls_sql+=" and cw_sgdzqjsjlkb.lx='B'";//B:钛马赫二次结算
    ls_sql+=" and crm_khxx.gdjsjd='B'";//B:钛马赫二次结算
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sgdzqjsjlkbList.jsp","","","EditCw_sgdzqjsjlkb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteZqCw_gdjsjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">钛马赫二次结算－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
