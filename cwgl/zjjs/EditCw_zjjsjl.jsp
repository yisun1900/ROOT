...
try {
	...
	ls_sql="SELECT cw_zjjsmx.khbh,hth,khxm,fwdz,sgdmc,sjs,qyrq,qye,sfke,ysgcjdmc,DECODE(crm_khxx.zjjsbz,'0','未结算','1','已结算') zjjsbz";
...
//	ls_sql+=" and cw_zjjsmx.tclx='2'";//1：签单提成；2：完工提成；3：设计客户；4：退单
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	while (rs.next())
	{
		...
		<tr bgcolor="<%=bgcolor%>"  align="center">
			<td><A HREF="Editcw_zjjsmx.jsp?jsjlh=<%=jsjlh%>&khbh=<%=khbh%>" target="_blank">扣款</A></td>
