...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_khjstyCxList.jsp" name="selectform">
<div align="center">结算－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right">记入业绩时间 从</td>
    <td><input name="yjjzsj" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10">    </td>
    <td align="right">到</td>
    <td><input name="yjjzsj2" type="text" onDblClick="JSCalendar(this)" size="20" maxlength="10"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">结算人</td>
    <td><input type="text" name="cw_khjsty_lrr" size="20" maxlength="20" ></td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">结算时间 从</td>
    <td><input type="text" name="cw_khjsty_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">    </td>
    <td align="right">到</td>
    <td><input type="text" name="cw_khjsty_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  <td align="right" width="18%">审批人</td> 
  <td width="32%"><input type="text" name="cw_khjsty_spr" size="20" maxlength="20" ></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="cw_khjsty_spsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="cw_khjsty_spsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">处理状态</td> 
  <td width="32%">
    <INPUT type="radio" name="cw_khjsty_clzt" value="1">未审批
    <INPUT type="radio" name="cw_khjsty_clzt" value="2">审批同意
    <INPUT type="radio" name="cw_khjsty_clzt" value="3">审批不同意  </td>
  <td align="right" width="18%">类型</td> 
  <td width="32%">
	<INPUT type="radio" name="cw_khjsty_lx" value="1">个性化
    <INPUT type="radio" name="cw_khjsty_lx" value="2">套餐  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.cw_khjsty_spsj, "审批时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_khjsty_spsj2, "审批时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_khjsty_lrsj, "结算时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_khjsty_lrsj2, "结算时间"))) {
		return false;
	}
	FormName.submit();
	return true;
