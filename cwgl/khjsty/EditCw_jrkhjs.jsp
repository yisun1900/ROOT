...
try {
	...
	ls_sql="select shsgfq,shzcfq,fxjzck,clzt,htsjf,sssjf,wdzgce,qye,zqljzjx,zhljzjx,zqhj,zhhj,jsze,yjzxk,dj,yjwk,yhje,fqbl,fqje,djfxje,dyq,yhze,shfqje,yjzck,zcddjezq,zcddyh,dgzcjezq,dgzcyh,zcjsje,pck,khbjk,lrr,lrsj,lrbm,bz,zctcze ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCw_khjsty.jsp" name="insertform" >
<div align="center">客户结算－修改(<font color="#0000FF">客户编号:<%=khbh%></font>)</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>返券金额</td>
  <td><input type="text" name="fqje" value="<%=fqje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
  <td colspan="2">&nbsp;</td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>折扣优惠</td>
  <td><font color="#FF0000">
    <input type="text" name="yhje" value="<%=yhje%>" size="20" maxlength="17" onChange="calValue(insertform)">
  </font></td>
  <td colspan="2"><%=zklmc%></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>订金折现优惠</td>
  <td><font color="#FF0000">
    <input type="text" name="djfxje" value="<%=djfxje%>" size="20" maxlength="17" onChange="calValue(insertform)">
  </font></td>
  <td colspan="2">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="2">收回施工返券
    <input type="text" name="shsgfq" size="8" value="<%=shsgfq%>" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid">
，收回主材返券
<input type="text" name="shzcfq" size="8" value="<%=shzcfq%>" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#0000FF">优惠合计金额</font></td>
  <td><input type="text" name="yhze" value="<%=yhze%>" size="20" maxlength="17" readonly>  </td>
  <td colspan="2">优惠金额＝折扣优惠-收回减项返券金额</td>
</tr>
<tr bgcolor="#FFFFCC">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="bz" cols="71" rows="3"></textarea>  </td>
    ...
    <tr align="center"> 
	  ...
	  <input name="button6" type="button" onClick="window.open('/cwgl/jrkhjs/ViewGxhCw_khjsty.jsp?khbh=<%=khbh%>')"  value="打印">
...
{  
	//优惠金额
	var yhze=FormName.yhje.value*1.0-FormName.shfqje.value*1.0;
	yhze=round(yhze,0);
