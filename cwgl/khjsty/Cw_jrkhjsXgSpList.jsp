...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and cw_khjsty.clzt in('2','3')";
    ls_sql+=wheresql;
    ls_sql+=" order by cw_khjsty.spsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khjstyXgSpList.jsp","","","XgShCw_khjsty.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSpCw_khjsty.jsp?"};//按钮单击调用的网页，可以增加参数
