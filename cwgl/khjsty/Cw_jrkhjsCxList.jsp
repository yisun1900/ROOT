...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(cw_khjsty.lx,'1','个性化','2','套餐') lx, DECODE(cw_khjsty.clzt,'1','未审批','2','审批同意','3','审批不同意'),cw_khjsty.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.yjjzsj,cw_khjsty.htsjf,cw_khjsty.sssjf,cw_khjsty.wdzgce,cw_khjsty.qye,cw_khjsty.zqljzjx,cw_khjsty.zhljzjx,cw_khjsty.zqhj,cw_khjsty.zhhj,cw_khjsty.jsze,cw_khjsty.yjzxk,cw_khjsty.dj,cw_khjsty.yjwk,cw_khjsty.yhje,cw_khjsty.fqbl,cw_khjsty.fqje,cw_khjsty.djfxje,cw_khjsty.dyq,cw_khjsty.yhze,cw_khjsty.shfqje,cw_khjsty.yjzck,cw_khjsty.zcddjezq,cw_khjsty.zcddyh,cw_khjsty.dgzcjezq,cw_khjsty.dgzcyh,cw_khjsty.zcjsje,cw_khjsty.pck,cw_khjsty.khbjk,cw_khjsty.spr,cw_khjsty.spsj,cw_khjsty.spyj,cw_khjsty.lrr,cw_khjsty.lrsj,dwmc,cw_khjsty.bz  ";
...
//设置列超级连接
	...
	coluParm.link="/cwgl/jrkhjs/ViewCw_khjsty.jsp";//为列参数：coluParm.link设置超级链接
