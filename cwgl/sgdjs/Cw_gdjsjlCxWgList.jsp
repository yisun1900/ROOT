...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String fgs=null;
	String cw_gdjsjl_xbclf=null;


	String sfybgf=null;
	sfybgf=request.getParameter("sfybgf");
	if (sfybgf!=null)
	{
		if (sfybgf.equals("1"))
		{
			wheresql+=" and  (cw_gdjsjl.sbgf=0)";
		}
		else if (sfybgf.equals("2"))
		{
			wheresql+=" and  (cw_gdjsjl.sbgf!=0 and cw_gdjsjl.sbgf<cw_gdjsjl.sqgz)";
		}
		else if (sfybgf.equals("3"))
		{
			wheresql+=" and  (cw_gdjsjl.sbgf>=cw_gdjsjl.sqgz)";
		}
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_gdjsjlCxWgList.jsp","SelectCxWgCw_gdjsjl.jsp","","");
