...
<form method="post" action="Cw_gdjsjlWgList.jsp" name="selectform">
...
%> 
              ...
              <td width="35%"> 
                <input type="text" name="cw_gdjsjl_zkl" size="20" maxlength="9" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="15%">结算时间 从</td>
              <td width="35%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"> 
                <select name="cw_gdjsjl_jsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"1+结算部结算&2+结算审批","");
%> 
                </select>
              </td>
              <td width="15%"> 
                <div align="right">付款标志</div>
              </td>
              <td width="35%">
                <select name="cw_gdjsjl_fkbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"1+未收款&2+已付款","");
%> 
                </select>
              </td>
            </tr>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right">结算类型</td>
              <td width="35%"> 
