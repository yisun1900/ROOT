...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_ygzbjtzjlList.jsp","","","EditRs_ygzbjtzjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRs_ygzbjtzjl.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">设计师质保金－维护</font></B>
</CENTER>
<%
	pageObj.out=out;
