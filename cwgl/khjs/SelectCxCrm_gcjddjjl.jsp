...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="34%"> 
                <input type="text" name="crm_gcjddjjl_khbh" size="20" maxlength="20" >
              </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#0000CC"><b>客户姓名</b></font></td>
              <td width="34%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#0000CC"><b>房屋地址</b></font></td>
              <td colspan="3"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right">质检姓名</td>
              <td width="34%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%"> 
                <div align="right">登记记录号</div>
              </td>
              <td width="34%"> 
                <input type="text" name="crm_gcjddjjl_djjlh" size="20" maxlength="9" >
              </td>
              <td width="18%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right">实际完结时间 从</td>
              <td width="34%"> 
                <input type="text" name="crm_gcjddjjl_djsj" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
              <td width="18%" align="right">到</td>
              <td width="32%"> 
                <input type="text" name="crm_gcjddjjl_djsj2" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%"> 
              ...
              <td width="34%"> 
                <input type="text" name="crm_gcjddjjl_lrsj" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
              <td width="18%"> 
                <div align="right">到</div>
              </td>
              <td width="32%"> 
                <input type="text" name="crm_gcjddjjl_lrsj2" size="20" maxlength="10" ondblclick="JSCalendar(this)">
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%"> 
              ...
              <td width="34%"> 
                <input type="text" name="crm_gcjddjjl_lrr" size="20" maxlength="20" >
              </td>
              <td width="18%"> 
                <div align="right">录入单位</div>
              </td>
              <td width="32%"> 
                <select name="crm_gcjddjjl_lrdw" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
{
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj, "实际完结时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj2, "实际完结时间"))) {
		return false;
	}
