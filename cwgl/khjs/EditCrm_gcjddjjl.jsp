...
try {
	...
	ls_sql="select khjsbz,khjssj,gcjdbm,bxkssj,bxjzsj,kbxbz,bybxsm,zt,jjwjbz,crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm,khjsje";
	...
	if (rs.next())
	{
		...
		khjssj=cf.fillNull(rs.getDate("khjssj"));
...
<form method="post" action="SaveEditCrm_gcjddjjl.jsp" name="insertform"  >
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"><input type="text" name="khjsje" value="<%=khjsje%>" size="20" maxlength="10" ></td>
              <td align="right"><span class="STYLE1">*</span>客户结算时间</td>
              <td><input type="text" name="khjssj" value="<%=khjssj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
