...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertXgYjCw_jzsjxgjl.jsp" name="insertform"  >
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%"><font color="#000099">原－签单记入业绩时间</font></td>
      <td width="32%"> 
        <input type="text" name="yqdjzsj" value="<%=yjjzsj%>" size="20" maxlength="10" readonly>      </td>
      <td align="right" width="22%"><b><font color="#CC0000">修改后－签单记入业绩时间</font></b></td>
      <td width="28%"> 
        <input type="text" name="xghqdjzsj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%"><font color="#000099">合同原报价</font></td>
      <td width="32%"> 
        <input type="text" name="wdzgce" value="<%=wdzgce%>" size="20" maxlength="17" readonly>      </td>
      <td align="right" width="22%">&nbsp;</td>
      <td width="28%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%"><font color="#000099">合同签约额</font></td>
      <td width="32%"> 
        <input type="text" name="qye" value="<%=qye%>" size="20" maxlength="17" readonly>      </td>
      <td align="right" width="22%">&nbsp;</td>
      <td width="28%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <textarea name="xgsm" rows="3" cols="76"></textarea>      </td>
    </tr>
    <tr align="center"> 
      <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (javaTrim(FormName.xghqdjzsj)=="")
	{
		if (!confirm("提醒！『签单结转时间』为空，确实要继续吗?") )	
		{
			return;
		}
	}
