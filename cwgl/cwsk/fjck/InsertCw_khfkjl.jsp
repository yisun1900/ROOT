...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input name="pr" type="button" value="打印收据" onClick="window.open('/cwgl/dy/PrintJcSj.jsp?fkxh=<%=fkxh%>&khbh=<%=khbh%>')" disabled>
                <input name="pr2" type="button" value="选择打印" onClick="window.open('/cwgl/dy/PrintChooseJcSj.jsp?fkxh=<%=fkxh%>')" disabled>              </td>
            </tr>
        </table>
</form>
