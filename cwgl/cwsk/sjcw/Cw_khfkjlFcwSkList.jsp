...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (!(crm_khxx_hth.equals("")))
	{
		ls_sql=" SELECT cw_khfkjl.fkxh,cw_khfkjl.sjbh,crm_khxx.khxm,crm_khxx.fwdz,a.fklxmc fklxbm,cw_khfkjl.fkje,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y','审核通过','M','审核未通过'),zffsmc,b.fklxmc zckx,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,crm_khxx.khbh,cw_khfkjl.bz";
		...
		ls_sql+=" and sq_dwxx.dwflbm!='06'";//06：财务部
		...
		ls_sql=" SELECT cw_khfkjl.fkxh,cw_khfkjl.sjbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,a.fklxmc fklxbm,cw_khfkjl.fkje,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y','审核通过','M','审核未通过'),zffsmc,b.fklxmc zckx,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,crm_zxkhxx.khbh,cw_khfkjl.bz";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khfkjlFcwSkList.jsp","SelectFcwSkCw_khfkjl.jsp","","EditCw_khfkjl.jsp");
...
<CENTER >
  <B><font size="3">审核－非财务部收款</font></B>
</CENTER>
<%
	pageObj.out=out;
