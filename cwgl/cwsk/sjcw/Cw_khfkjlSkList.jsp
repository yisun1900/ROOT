...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (!(crm_khxx_hth.equals("")))
	{
		ls_sql=" SELECT cw_khfkjl.fkxh,cw_khfkjl.sjbh,crm_khxx.khxm,crm_khxx.fwdz,a.fklxmc fklxbm,cw_khfkjl.fkje,cw_khfkjl.gysbh,cw_khfkjl.ddbh,cw_khfkjl.zjxbh,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y','审核通过','M','审核未通过'),zffsmc,b.fklxmc zckx,cw_khfkjl.zcgysbh,cw_khfkjl.zcddbh,cw_khfkjl.zczjxbh,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,crm_khxx.khbh,cw_khfkjl.bz";
		...
		ls_sql+=wheresql;
		ls_sql+=" order by sjbh";
	}
	else{
		ls_sql=" SELECT cw_khfkjl.fkxh,cw_khfkjl.sjbh,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,a.fklxmc fklxbm,cw_khfkjl.fkje,cw_khfkjl.gysbh,cw_khfkjl.ddbh,cw_khfkjl.zjxbh,DECODE(skdd,'1','不需','2','需审核'),DECODE(dsksjbz,'N','未审核','Y','审核通过','M','审核未通过'),zffsmc,b.fklxmc zckx,cw_khfkjl.zcgysbh,cw_khfkjl.zcddbh,cw_khfkjl.zczjxbh,cw_khfkjl.skr,cw_khfkjl.sksj,dwmc,crm_zxkhxx.khbh,cw_khfkjl.bz";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_khfkjlSkList.jsp","","","EditCw_khfkjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"SavePlCw_khfkjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">收款金额</td>
	<td  width="5%">收款品牌</td>
	<td  width="4%">收款订单编号</td>
	<td  width="4%">收款增减项编号</td>
	<td  width="3%">是否需审核</td>
	<td  width="4%">审核标志</td>
	<td  width="4%">支付方式</td>
	<td  width="5%">转帐款项</td>
