...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sgdbgfty.jsjlh,cw_sgdbgfty.khbh,crm_khxx.khxm,sq_sgd.sgdmc,cw_sgdbgfty.sgbz,gdjsjdmc,cw_sgdbgfty.jsrq,cw_sgdbgfty.htje,cw_sgdbgfty.zjxje, DECODE(cw_sgdbgfty.jsjs,'1','工程费','2','工程费＋其它费','3','实收款总额','4','一期款','5','二期款','6','三期款','7','工程基础报价','8','工程基础报价＋其它费基础报价','9','最新工程施工成本价','A','最新工程施工成本价＋其它费施工成本','D','合同工程施工成本价','E','合同工程施工成本价＋其它费施工成本','B','工程成本价','C','工程成本价＋其它费成本'),cw_sgdbgfty.jsjsze,cw_sgdbgfty.jsbl||'%',cw_sgdbgfty.jsje,cw_sgdbgfty.clf,cw_sgdbgfty.gdyp,cw_sgdbgfty.sjbk,cw_sgdbgfty.lrr,cw_sgdbgfty.lrsj,dwmc,cw_sgdbgfty.bz  ";
    ...
    ls_sql+=" and crm_khxx.gdjsjd in(select gdjsjd from dm_gdjsjd where ztlx='3' and nextzt!='X')";//0:未结算
    ls_sql+=" and cw_sgdbgfty.spzt='1'";//1：未审批；2：审批同意；3：审批不同意
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sgdbgftyShList.jsp","","","ShCw_sgdbgfty.jsp");
