...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (cw_sgdbgfty_lx!=null)
	{
		...
		if (!(cw_sgdbgfty_lx.equals("")))	wheresql+=" and  (cw_sgdbgfty.lx='"+cw_sgdbgfty_lx+"')";
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sgdbgftyList.jsp","","","EditCw_sgdbgfty.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCw_sgdbgfty.jsp?"};//按钮单击调用的网页，可以增加参数
