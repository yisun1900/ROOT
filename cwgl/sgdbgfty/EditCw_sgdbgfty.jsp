...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCw_sgdbgfty.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><input type="text" name="sjbk" size="20" maxlength="17"  value="<%=sjbk%>" readonly>
    <span class="STYLE5"><%=sjbkStr%></span></td>
  </tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"> 
	...
	<input type="hidden" name="wherejsjlh"  value="<%=wherejsjlh%>" >
	  ...
	  <input type="button" onClick="window.open('/cwgl/sgdzqjs/dybkd.jsp?jsjlh=<%=jsjlh%>')"  value="打印拨款单">
	  <input type="button" onClick="window.open('SaveZjxbz.jsp?khbh=<%=khbh%>');this.disabled=true;"  value="不许录入增减项" <%if (zjxwcbz.equals("3")) out.print("disabled");%>>
