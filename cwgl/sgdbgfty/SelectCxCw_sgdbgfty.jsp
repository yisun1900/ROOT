...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdbgftyCxList.jsp" name="selectform">
<div align="center">拨工费－查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">拨工费记录号</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_jsjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">现场负责人</td> 
  <td width="32%"><input type="text" name="cw_sgdbgfty_sgbz" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">施工队</td> 
  <td width="32%"> 
    <select name="cw_sgdbgfty_sgd" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><select name="cw_sgdbgfty_lx" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
%>
  ...
  <td><select name="cw_sgdbgfty_jsjs" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="cw_sgdbgfty_jsrq" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到 </td>
  <td><input type="text" name="cw_sgdbgfty_jsrq2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">结算比例</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_jsbl" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">结算金额</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_jsje" size="20" maxlength="17" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">材料费</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_clf" size="20" maxlength="17" >  </td>
  <td align="right" width="18%">工地用品</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_gdyp" size="20" maxlength="17" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">实际拨款</td> 
  <td width="32%"> 
    <input type="text" name="cw_sgdbgfty_sjbk" size="20" maxlength="17" >  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入时间 从</td> 
  <td width="32%"><input type="text" name="cw_sgdbgfty_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="cw_sgdbgfty_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入人</td>
  <td><input type="text" name="cw_sgdbgfty_lrr" size="20" maxlength="20" ></td>
  <td align="right">录入部门</td>
  <td><select name="cw_sgdbgfty_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
{
	if(!(isDatetime(FormName.cw_sgdbgfty_jsrq, "结算日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdbgfty_jsrq2, "结算日期"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdbgfty_jsbl, "结算比例"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdbgfty_jsje, "结算金额"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdbgfty_clf, "材料费"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdbgfty_gdyp, "工地用品"))) {
		return false;
	}
	if(!(isFloat(FormName.cw_sgdbgfty_sjbk, "实际拨款"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdbgfty_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdbgfty_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
