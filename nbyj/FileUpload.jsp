...
a.files {
	...
	background:url(fu_btn.gif) left top no-repeat;
...
<form id="uploadForm" action="file.jsp">
  <table border="0" cellspacing="1" class="fu_list">
    <tbody>
      <tr>
	  <DIV ><b>主 题&nbsp;: </b><input type="txt" value="" name="yjzt"  size="69" ></DIV>
        <td align="right" width="15%" style="line-height:35px;">添加文件：</td>
        <td><a href="javascript:void(0);" class="files" id="idFile"></a> <img id="idProcess" style="display:none;" src="loading.gif" /></td>
      </tr>
      <tr>
        <td colspan="2"><table border="0" cellspacing="0">
            <thead>
              <tr>
                <td>文件路径（温馨提示：最多可同时上传 <b id="idLimit"></b> 个文件，只允许上传 <b id="idExt"></b> 文件）</td>
                <td width="100"></td>
              </tr>
            </thead>
            <tbody id="idFileList">
