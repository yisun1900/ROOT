...
<body bgcolor="#FFFFFF">
<form method="post" action="Nbyj_fjxList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
	...
	<input type="hidden" name="yjygbh" value="<%=yjygbh%>" ></td>
  <td align="right" width="15%">收件人</td> 
  <td width="35%">
  <select name="sjr" style="FONT-SIZE:12PX;WIDTH:152PX">
  <option value=""></option>
 <%
