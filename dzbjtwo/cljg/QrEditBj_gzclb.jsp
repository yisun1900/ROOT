...
<form method="post" action="" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"><font color="#0000CC">地区</font></td>
              <td width="31%"> 
...
%> 
              ...
              <td width="18%" align="right"><font color="#0000CC">材料类别</font></td>
              <td width="32%"> 
	...
	cf.selectItem(out,"select cldlbm,cldlmc from bdm_cldlbm where cldlbm='"+cldlbm+"'",cldlbm);
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000CC">物流材料编码</font></div>
              </td>
              <td width="31%"> 
                <input type="text" name="wlbm" size="20" maxlength="16"  value="<%=wlbm%>" readonly>
              </td>
              <td width="18%"> 
                <div align="right"><font color="#0000CC">物流计量单位</font></div>
              </td>
              <td width="32%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000CC">单价</font></td>
              <td width="31%"> 
                <input type="text" name="dj" size="20" maxlength="50"  value="<%=dj%>" readonly>
              </td>
              <td width="18%" align="right">&nbsp;</td>
              <td width="32%">&nbsp; </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000CC">材料名称</font></td>
              <td colspan="3"> 
                <input type="text" name="glmc" size="71" maxlength="100"  value="<%=glmc%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="19%"> 
                <div align="right"><font color="#0000CC">型号规格</font></div>
              </td>
              <td colspan="3"> 
                <input type="text" name="xhgg" size="71" maxlength="100"  value="<%=xhgg%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="19%"><font color="#0000CC">品牌</font></td>
              <td colspan="3"> 
                <input type="text" name="pp" size="71" maxlength="100"  value="<%=pp%>" readonly>
              </td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveQrEditBj_wljgb.jsp";
	FormName.submit();
	return true;
}
//-->
