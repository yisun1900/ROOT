...
<body bgcolor="#FFFFFF">
<form method="post" action="Bj_wlbjmbList.jsp" name="selectform">
  <div align="center">请输入查询条件</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td width="16%" height="2" align="right">地区</td>
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="16%" height="2" align="right">材料名称</td>
      <td colspan="3" height="2"> 
        <input type="text" name="glmc" size="73" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="16%" height="2" align="right">物流材料编码</td>
      <td width="34%" height="2"> 
