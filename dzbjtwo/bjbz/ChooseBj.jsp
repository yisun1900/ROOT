...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                    <BR>
                  <input type="button" onClick="LoadDzbj(insertform)"  value="导入电子报价-Excel">
                  <input type="button" onClick="LoadDzbjTxt(insertform)"  value="导入电子报价-Txt" >
                    <BR>
                    <BR> 
				    <A HREF="CSH05-电子报价2.xls"><B>下载【电子报价Excel】模板</B></A>
					&nbsp;&nbsp;&nbsp;&nbsp;
				    <A HREF="CSH05-电子报价.txt"><B>下载【电子报价Txt】模板</B></A>
                </td>
            </tr>
        </table>
</form>
...
function LoadDzbj(FormName)//参数FormName:Form的名称
{
...
function LoadDzbjTxt(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.bjbbh)=="") {
		alert("请选择[报价版本号]！");
		FormName.bjbbh.focus();
	...
	FormName.action="LoadDataTxt.jsp";
	FormName.submit();
	return true;
}
