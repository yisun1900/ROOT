...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"><input type="text" name="bj_zdyxmb_xmbh" size="20" maxlength="13" ></td>
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
			  ...
			  <select name="shbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                <option value=""></option>
                <option value="N">申请审核</option>
                <option value="S">受理申请</option>
                <option value="C">重新申请</option>
              </select></td>
