...
String count=cf.executeQuery("select count(*) from bj_jzbjb where dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"' and bjbbh='"+bjbbh+"'");
%>
...
<form method="post" action="" name="loadform" enctype="multipart/form-data" >
    <table width="100%" border="0">
      <tr align="center"> 
        <td colspan="2" height="52"><b>请选择上载Txt文件</b></td>
      </tr>
      <tr align="center">
...
function f_onclick(FormName)
{
	...
	FormName.target="";
	FormName.action="DisDataTxt.jsp";
	FormName.submit();
	return true;
} 
//-->
