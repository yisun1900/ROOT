...
//设置显示列
	String[] disColName={"shbz","dqmc","bjjbmc","xmbh","xmmc","jldwmc","bj","clbj","rgbj","zdyxmyxq","gycl","flmcgg","xmdlmc","xmxlmc","xmflmc","smmc","lrr","lrsj","sfxycl","sfxyyjd"};
