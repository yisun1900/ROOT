...
//设置按钮参数
	String[] buttonName={"审核"};//按钮的显示名称
	String[] buttonLink={"Bj_jzbjbShList.jsp?bjbbh="+bjbbh+"&dqbm="+bj_jzbjb_dqbm+"&bjjbbm="+bjjbbm};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update bj_jzbjb set shbz='Y',shsj=SYSDATE,shr='"+yhmc+"' where bjbbh='"+bjbbh+"' and dqbm='"+dqbm+"' and bjjbbm='"+bjjbbm+"' and ("+chooseitem+")";
