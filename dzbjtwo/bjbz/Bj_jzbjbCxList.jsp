...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT bj_jzbjb.bjbbh,bj_jzbjb.xmbh,bj_jzbjb.xmmc,jdm_jldwbm.jldwmc,DECODE(bj_jzbjb.sfbxx,'1','<font color=\"#FF0000\">必报项</font>','2','<font color=\"#CC00CC\">必列项</font>','3','可选项','9','<font color=\"#0000FF\">作废项</font>') sfbxx,bjjbmc,bj_jzbjb.bj,bj_jzbjb.clbj,bj_jzbjb.rgbj,DECODE(bj_jzbjb.sfyxdz,'Y','允许','N','否') sfyxdz,bj_jzbjb.zdzk,DECODE(bj_jzbjb.sfxycl,'Y','需要','N','否') sfxycl,DECODE(bj_jzbjb.sfxyyjd,'Y','需要','N','否') sfxyyjd,glxmbh,xmxlmc,xmdlmc,xmflmc,smmc,gycl,flmcgg,bz,lrr,lrsj,bj_jzbjb.xh,dqmc";
