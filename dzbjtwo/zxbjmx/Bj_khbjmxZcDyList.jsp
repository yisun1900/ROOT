...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
	...
	<td  width="9%" align="center" rowspan="2">项目分类</td>
	<td  width="5%" align="center" rowspan="2">数量</td>
    <td  width="3%" align="center" rowspan="2">单位</td>
    <td  width="10%" align="center" colspan="4">单价</td>
    <td  width="8%" align="center" rowspan="2">金额（元）</td>
	<td  width="8%" align="center" rowspan="2">成本（元）</td>
	<td  width="8%" align="center" rowspan="2">毛利率（%）</td>
    <td  width="49%" align="center" rowspan="2">备注</td>
  </tr>
  <tr bgcolor="#FFFFFF">
  <td  width="5%" align="center" >材料</td>
  <td  width="5%" align="center" >材料成本</td>
  <td  width="5%" align="center">人工费</td>
  <td  width="5%" align="center">人工成本</td>
  </tr>
</table>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style="FONT-SIZE: 12px;">
  ...
  <%
	...
	while (rs1.next())
	{
		...
		ls_sql="SELECT sum(bj_gclmx.sl) sl,sum(bj_gclmx.sl*bj_bjxmmx.zqdj) as je,sum(bj_gclmx.sl*bj_bjxmmx.cbenj) as cbje";
	...
	//	out.println(ls_sql);
		...
		{
		allmlv=(allqye-allcbje)/allqye*100;
		}
	...
	<tr bgcolor="#CCCCCC" <% //if("客厅".equals(jgwzmc)) out.print("style=\"page-break-after:always;\" ");%>> 
		...
		//输出项目明细
		ls_sql="SELECT  bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,bj_bjxmmx.xmmc,jldwmc,bj_bjxmmx.cldj,bj_bjxmmx.rgdj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as je,substr(bj_bjxmmx.gycl,1,80) a,bj_bjxmmx.bz,bdm_xmflbm.xmflmc,bj_bjxmmx.clcb,bj_bjxmmx.rgcb,bj_gclmx.sl*bj_bjxmmx.cbenj as cbje,case when bj_gclmx.sl*bj_bjxmmx.zqdj=0 then 100 else (bj_gclmx.sl*bj_bjxmmx.zqdj-bj_gclmx.sl*bj_bjxmmx.cbenj)/(bj_gclmx.sl*bj_bjxmmx.zqdj)*100 end mlv";
		ls_sql+=" FROM bj_bjxmmx,jdm_jldwbm,bj_gclmx,bdm_xmdlbm,bdm_xmflbm  ";
		ls_sql+=" where bj_bjxmmx.jldwbm=jdm_jldwbm.jldwbm and bdm_xmflbm.xmflbm=bj_bjxmmx.xmflbm";
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF" height="30px"  <% //if(row%8==0) out.print("style=\"page-break-after:always;\" ");%>> 
				...
				<td width="9%" align="center"><%=xmflmc%></td>
				...
				<td width="5%" align="center"><%=cf.formatDouble(clcb,"#########.##")%></td>
				<td width="5%" align="center"><%=cf.formatDouble(rgdj,"#########.##")%></td>
				<td width="5%" align="center"><%=cf.formatDouble(rgcb,"#########.##")%></td>
				<td width="8%" align="center"><%=cf.formatDouble(qye,"#########.##")%></td>
				<td width="8%" align="center"><%=cf.formatDouble(cbje,"#########.##")%></td>
				<td width="8%" align="center"><%=cf.formatDouble(mlv,"#########.##")%></td>
	...
	<tr bgcolor="#CCCCCC" <% //if("客厅".equals(jgwzmc)) out.print("style=\"page-break-after:always;\" ");%>> 
		...
		<td colspan="7" align="center"><b><font size="2">
				小计</font></b></div></td>
...
%> 
  ...
  <td align="center">1</td>
    <td align="left" colspan="9"><b><font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工程直接费：</font></b></td>
	<td align="center"><%=cf.formatDouble(allqye,"#########.##")%>&nbsp;&nbsp;</td>
	<td ><%=cf.formatDouble(allcbje,"#########.##")%> </td>
	<td><%=cf.formatDouble(allmlv,"#########.##")%></td>
	<td></td>
  </tr>
  <%  
	double allsfje=0;
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		%> 
		  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
			<td ><%=temp%></td>
			<td colspan="9" align="left"><b><font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=sfxmmc%>：</font></b></td>
...
%> 
<tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="10"><b><font size="3">(1)<%=k%>：</font></b></td>
	<td align="right"><b><font size="3"><%=cf.formatDouble(allzj,"#########.##")%></font></b></td>
	<td colspan="3"> </td>
</tr>
<tr bgcolor="#FFFFFF"> 
   <td colspan="14" ><%=dzbjbz%></td>
</tr>
</table>
...
<tr bgcolor="#FFFFFF"> 
	...
	<td width="22%" height="42">全国免费服务电话：<%=dwdz%></td>
