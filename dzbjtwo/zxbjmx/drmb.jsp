      ...
      <td height="5" colspan="2" align="center"> 
	   同小区客户名单
		...
		<%
			...
			ls_sql="SELECT crm_zxkhxx.khbh as khbh,crm_zxkhxx.khxm,cqmc,crm_zxkhxx.xqbm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','设计师提交飞单','3','已签约','4','飞单','5','飞单审核未通过'),dzbjze,bjjbmc,DECODE(crm_zxkhxx.jzbz,'1','家装','2','公装'),sq_dwxx.dwmc as zxdm,sjs,lrsj";
