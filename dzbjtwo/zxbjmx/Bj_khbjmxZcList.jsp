...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style="FONT-SIZE: 12px;">
  ...
  <%
	...
	<tr bgcolor="#CCCCCC" <% //if("客厅".equals(jgwzmc)) out.print("style=\"page-break-after:always;\" ");%>> 
		...
		//输出项目明细
		ls_sql="SELECT  bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,bj_bjxmmx.xmmc,jldwmc,bj_bjxmmx.cldj,bj_bjxmmx.rgdj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as je,substr(bj_bjxmmx.gycl,1,80) a,bj_bjxmmx.bz";
...
%> 
  ...
  <td align="center">1</td>
    <td align="left" colspan="6"><b><font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主材费：</font></b></td>
