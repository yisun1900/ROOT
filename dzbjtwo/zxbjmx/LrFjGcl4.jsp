...
try {
	...
	ls_sql="select xmmc,xmdlbm,xmxlbm,smbm,jldwbm,zqdj,gycl,DECODE(bjlx,'1','标准项目','2','自定义项目') bjlx,bjjbmc bjjb,DECODE(bj_bjxmmx.sfbxx,'1','必报项','2','必列项','3','可选项','9','作废项') sfbxx,zdyxmyxq";
...
%></td>
			...
			while (rs.next())
			{
				...
				ls_sql+=" where khbh='"+khbh+"' and xmbh='"+xmbh+"' and dqbm='"+dqbm+"' and jgwzbm='"+jgwzmc+"'";
