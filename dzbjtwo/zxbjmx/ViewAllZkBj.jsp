...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF" align="center"> 
    ...
    <td  width="17%" ><strong>项目名称</strong></td>
    <td  width="8%" ><strong>项目分类</strong></td>
    <td  width="6%" ><strong>单位</strong></td>
    <td  width="6%" ><strong>数量</strong></td>
	<td  width="7%" ><strong>折前单价</strong></td>
    <td  width="8%" ><strong>折前金额</strong></td>
	<td  width="5%" ><strong>折扣</strong></td>
	<td  width="7%" ><strong>折后单价</strong></td>
    <td  width="8%" ><strong>折后金额</strong></td>
	<td  width="8%" ><strong>施工成本价</strong></td>
	<td  width="8%" ><strong>工程基础报价</strong></td>
  </tr>
...
<%
	...
	while (rs1.next())
	{
		...
		double zqje=0;
		double zhje=0;
		ls_sql="SELECT bj_gclmx.sl*bj_bjxmmx.cbenj cbj,bj_gclmx.sl*bj_bjxmmx.sgcbj sgcbj,bj_gclmx.sl*bj_bjxmmx.sgdbj sgdbj,bj_bjxmmx.xh,xmflmc,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,xmmc,jldwmc,bj_bjxmmx.zqdj,bj_bjxmmx.zk,bj_bjxmmx.dj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as zqje,bj_gclmx.sl*bj_bjxmmx.dj as zhje,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz";
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF" align="center"  >
    <td width="4%"><strong>序号</strong></td> 
	<td width="25%"><strong>收费项目名称</strong></td>
	<td width="6%"><strong>是否记入业绩</strong></td>
	<td width="8%"><strong>单价</strong></td>
	<td width="6%"><strong>数量</strong></td>
	<td width="9%"><strong>折前收费金额</strong></td>
	<td width="6%"><strong>折扣率</strong></td>
	<td width="9%"><strong>折后收费金额</strong></td>
	<td  width="9%" ><strong>施工成本价</strong></td>
	<td  width="9%" ><strong>工程基础报价</strong></td>
  </tr>
  <%  
	double allsfje=0;
	 row=0;
...
%> 
  <tr bgcolor="#FFFFFF" align="center"  height="31">
	<td colspan="3"><span class="STYLE2"><strong>小 计</strong></span></td> 
	<td >&nbsp;</td>
	<td >&nbsp;</td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="left" colspan="11"><strong>总 计&nbsp;&nbsp;&nbsp;&nbsp;折前：<%=cf.formatDouble(allzqje,"#########.##")%>&nbsp;&nbsp;&nbsp;&nbsp;折后：<%=cf.formatDouble(allzhje,"#########.##")%></strong></td>
  </tr>
</table>
