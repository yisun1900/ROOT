...
<%
	...
	//输出项目明细
		...
		ls_sql="SELECT bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glfxclmc,bj_khglfxb.glfxclbm,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj,sum(bj_khglfxb.xhl*bj_gclmx.sl) xhl,sum(bj_khglfxb.xhl*bj_gclmx.sl*bj_khglfxb.dj) clf ";
		...
		ls_sql+=" group by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glfxclmc,bj_khglfxb.glfxclbm,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
		ls_sql+=" order by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glfxclmc,bj_khglfxb.glfxclbm,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
//		out.println(ls_sql);
		ps= conn.prepareStatement(ls_sql);
		rs =ps.executeQuery();
		while (rs.next())
