...
<%
String wherepsph=request.getParameter("psph");
String gysmc=cf.GB2Uni(cf.getParameter(request,"gysmc"));
%>

<body bgcolor="#ffffff" text="#000000" style='FONT-SIZE: 12px'>
<CENTER >
  <B><font size="3">材料领用预算单(单号:<%=wherepsph%>)</font></B> 
</CENTER>
<%
String ls_sql=null;
...
try {
	...
	ls_sql="SELECT jxc_clpsd.psdzt,hth,zjxm,khxm,lxfs,fwdz,sgdmc,sq_sgd.dh,DECODE(psfs,'1','配送','2','自提','9','其他') psfs,jhshsj,pszje,yf,qtsf,kgrq,jgrq  ";
	ls_sql+=" FROM jxc_clpsd,crm_khxx,sq_sgd ";
	ls_sql+=" where crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.khbh=jxc_clpsd.khbh(+) and jxc_clpsd.psph='"+wherepsph+"' ";
...
<%
	...
	ls_sql+=" where jxc_clpsmx.clbm=jxc_clbm.clbm and jxc_clpsmx.psph='"+wherepsph+"' and jxc_clpsmx.gysmc='"+gysmc+"' ";
