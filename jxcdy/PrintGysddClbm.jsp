...
try {
	...
	ls_sql="select sfrksgdw,sgph,jxc_gysdd.ssfgs,gysddph,to_char(yqdhsj,'YYYY') nian,to_char(yqdhsj,'MM') yue,to_char(yqdhsj,'DD') ri,gysmc,dqmc dqbm,DECODE(cglb,'J','集团采购','D','地方采购') cglb,xdr,to_char(xdrq,'YYYY-MM-DD') xdrq,to_char(yqdhsj,'YYYY-MM-DD') yqdhsj,dwmc fgsbh,DECODE(psfs,'1','配送','2','自取','3','其他') psfs,jxc_gysdd.bz bz ";
	...
	if (sfrksgdw.equals("Y"))//是否直接入库申购公司：Y：是；N：否  
	{
		ls_sql="select ssfgs";
...
<body bgcolor="#FFFFFF">
<div align="center"><font size="+2"><b><U>&nbsp;<%=fgsbh%>&nbsp;</U>材料订单</font></b></div>
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center" width="6%"><b>订货数量</b></td>
