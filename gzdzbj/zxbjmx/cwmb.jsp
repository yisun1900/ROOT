  ...
  <table width="100%" border="0" style="FONT-SIZE:16">
    ...
    <tr> 
      ...
      <td width="68%" height="57"> 
        ...
        <input type="button"  value="保存模板" onClick="f_bcmb(editform)" name="button">
      </td>
    </tr>
  </table>
  <HR>
    ...
    <tr> 
      ...
      <td width="68%" height="60"> 
        <select name="mbmc" style="FONT-SIZE:12PX;WIDTH:224PX">
          <option value=""></option>
          <%
	cf.selectItem(out,"select distinct mbmc||'+'||yhdlm c1,mbmc||DECODE(bj_gzmbfjxx.mblx,'1','（公用模板）','2','（私人模板）') c2  from bj_gzmbfjxx where yhdlm='"+yhdlm+"' and mblx='2' order by c1","");
%> 
        </select>
        <input type="button"  value="删除模板" onClick="f_scmb(editform)" name="button2">
        <input type="button"  value="查看模板" onClick="f_ckmb(editform)" name="button22">
      </td>
    </tr>
  </table>
  <HR>
