...
try {
	...
	ls_sql+=" FROM bj_mbbjxmmx,bj_mbgclmx,bdm_xmdlbm";
    ls_sql+=" where bj_mbbjxmmx.khbh='"+khbh+"'";
    ls_sql+=" and bj_mbbjxmmx.mbmc='"+mbmc+"'";
    ls_sql+=" and bj_mbgclmx.mbmc='"+mbmc+"' ";
	ls_sql+=" and bj_mbbjxmmx.xmdlbm=bdm_xmdlbm.xmdlbm and bdm_xmdlbm.sftsxm in('1','2')";
...
<%
	...
	while (rs1.next())
	{
		...
		ls_sql+=" FROM bj_mbbjxmmx,jdm_jldwbm,bj_mbgclmx,bdm_xmdlbm  ";
		...
		ls_sql+=" and bj_mbbjxmmx.mbmc='"+mbmc+"'";
		ls_sql+=" and bj_mbgclmx.mbmc='"+mbmc+"'";
		ls_sql+=" order by bj_mbbjxmmx.xmpx";
	//	out.println(ls_sql);
		ps= conn.prepareStatement(ls_sql);
		rs =ps.executeQuery();
		while (rs.next())
