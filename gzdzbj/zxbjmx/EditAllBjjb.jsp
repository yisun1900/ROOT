...
%> </td>
		...
		if (dybjjb==null)
		{
			cf.radioToken(out,"bjjb","A+"+dzbjzjmc,"A");
		}
		else if (dybjjb.equals("A"))
		{
			cf.radioToken(out,"bjjb","A+"+dzbjzjmc+"","A");
		}
		else if (dybjjb.equals("B"))
		{
			cf.radioToken(out,"bjjb","A+"+dzbjzjmc+"&B+"+dzbjzgjmc+"",bjjb);
		}
		else if (dybjjb.equals("C"))
		{
			cf.radioToken(out,"bjjb","C+"+dzbjgjmc+"","C");
		}
		else if (dybjjb.equals("D"))
		{
			cf.radioToken(out,"bjjb","A+"+dzbjzjmc+"&B+"+dzbjzgjmc+"&C+"+dzbjgjmc+"",bjjb);
		}
		else if (dybjjb.equals("E"))
		{
			cf.radioToken(out,"bjjb","B+"+dzbjzgjmc+"&C+"+dzbjgjmc+"",bjjb);
		}
		else
		{
			cf.radioToken(out,"bjjb","A+"+dzbjzjmc,bjjb);
		}
%> </td>
