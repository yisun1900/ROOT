...
<input type="hidden" name="khbh" value="<%=khbh%>" >
	  ...
	  <table border="1" cellspacing="0" cellpadding="1" width="100%" height="200" style='FONT-SIZE: 12px'>
        ...
        <%
	ls_sql="SELECT xh,xmbh,dqbm,xmmc,DECODE(sfxycl,'1','需要','2','不需要') sfxycl,jldwmc,dj,bjjbmc,DECODE(bjlx,'1','标准项目','2','自定义') bjlx";
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
        ...
        <tr bgcolor="<%=bgcolor%>" align="center">
          ...
          <td ><%=row%></td>
          <td align="center" ><a href="#" onclick=window.open('LrFjGcl1.jsp?khbh=<%=khbh%>&dqbm=<%=dqbm%>&xmbh=<%=xmbh.trim()%>') >录入</a></td>
