...
String clylzd = request.getParameter("jjf");
String[] wybh = request.getParameterValues("wybh");
String clylgs = request.getParameter("jjf1");
...
try {
	...
	if (clylzd.equals("ajjf"))
	{
		out.println("机械费:"+dzbjzjmc+"<BR>");
	}
	else if (clylzd.equals("bjjf"))
	{
		out.println("机械费:"+dzbjzgjmc+"<BR>");
	}
	else if (clylzd.equals("cjjf"))
	{
		out.println("机械费:"+dzbjgjmc+"<BR>");
	}
