...
String clylzd = request.getParameter("glfbl");
String[] wybh = request.getParameterValues("wybh");
String clylgs = request.getParameter("glfbl1");
...
try {
	...
	if (clylzd.equals("glfbl"))
	{
		out.println("管理费百分比:"+dzbjzjmc+"<BR>");
	}
	else if (clylzd.equals("bglfbl"))
	{
		out.println("管理费百分比:"+dzbjzgjmc+"<BR>");
	}
	else if (clylzd.equals("cglfbl"))
	{
		out.println("管理费百分比:"+dzbjgjmc+"<BR>");
	}
