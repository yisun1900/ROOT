...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Bj_jzbjbShList.jsp","SelectCxBj_jzbjb.jsp","","");
...
//设置按钮参数
	String[] buttonName={"审核通过"};//按钮的显示名称
	String[] buttonLink={"ShBj_jzbjb.jsp?"};//按钮单击调用的网页，可以增加参数
...
//设置显示合并列
	...
	//pageObj.alignStr[26]="align='left'";
	//pageObj.alignStr[27]="align='left'";
}
