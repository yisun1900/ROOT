...
String clylzd = request.getParameter("lrbl");
String[] wybh = request.getParameterValues("wybh");
String clylgs = request.getParameter("lrbl1");
...
try {
	...
	if (clylzd.equals("alrbl"))
	{
		out.println("利润百分比:"+dzbjzjmc+"<BR>");
	}
	else if (clylzd.equals("blrbl"))
	{
		out.println("利润百分比:"+dzbjzgjmc+"<BR>");
	}
	else if (clylzd.equals("clrbl"))
	{
		out.println("利润百分比:"+dzbjgjmc+"<BR>");
	}
