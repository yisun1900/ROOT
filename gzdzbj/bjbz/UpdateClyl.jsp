...
String clylzd = request.getParameter("clylzd");
String[] wybh = request.getParameterValues("wybh");
String clylgs = request.getParameter("clylgs");
...
try {
	...
	if (clylzd.equals("azcf"))
	{
		out.println("主材费:"+dzbjzjmc+"<BR>");
	}
	else if (clylzd.equals("bzcf"))
	{
		out.println("主材费:"+dzbjzgjmc+"<BR>");
	}
	else if (clylzd.equals("czcf"))
	{
		out.println("主材费:"+dzbjgjmc+"<BR>");
	}
