...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="bj_jzbjb_xmmc" size="73" maxlength="50" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><%=dzbjzjmc%>工艺材料简介</td>
              <td colspan="3"> 
                <input type="text" name="gycl" size="73" maxlength="50" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><%=dzbjzgjmc%>工艺材料简介</td>
              <td colspan="3"> 
                <input type="text" name="bgycl" size="73" maxlength="50" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><%=dzbjgjmc%>工艺材料简介</td>
              <td colspan="3"> 
                <input type="text" name="cgycl" size="73" maxlength="50" >
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
