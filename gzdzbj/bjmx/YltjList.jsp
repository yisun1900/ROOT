...
<%
	...
	//输出项目明细
		...
		ls_sql="SELECT bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xhgg,bj_khglfxb.jldwbm,bdm_cljldwbm.cljldwmc,bj_khglfxb.dj,sum(bj_khglfxb.xhl*bj_gclmx.sl) xhl,sum(bj_khglfxb.xhl*bj_gclmx.sl*bj_khglfxb.dj) clf ";
		ls_sql+=" FROM bdm_cljldwbm,bdm_glflbm,bj_khglfxb,bj_gclmx,crm_khxx  ";
		ls_sql+=" where bj_khglfxb.glflbm=bdm_glflbm.glflbm(+) and bj_khglfxb.jldwbm=bdm_cljldwbm.cljldwbm(+)";
		ls_sql+=" and bj_gclmx.khbh=crm_khxx.khbh and crm_khxx.jzbz='2'";
		ls_sql+=wheresql;
		ls_sql+=" and bj_khglfxb.glflbm='1'";
		ls_sql+=" and bj_gclmx.khbh=bj_khglfxb.khbh and bj_gclmx.wybh=bj_khglfxb.wybh ";
		ls_sql+=" group by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xhgg,bj_khglfxb.jldwbm,bdm_cljldwbm.cljldwmc,bj_khglfxb.dj";
		ls_sql+=" order by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xhgg,bj_khglfxb.jldwbm,bdm_cljldwbm.cljldwmc,bj_khglfxb.dj";
//		out.println(ls_sql);
		...
		while (rs1.next())
		{
			...
			cljldwmc=cf.fillHtml(rs1.getString("cljldwmc"));
			...
			ls_sql+=" where bj_gclmx.khbh=bj_khglfxb.khbh and bj_gclmx.wybh=bj_khglfxb.wybh ";
...
//		out.println(ls_sql);
	...
	xjsl=0;
	xjclf=0;
	ls_sql="SELECT bj_bjxmmx.xh,bj_bjxmmx.wybh,trim(bj_bjxmmx.xmbh)||DECODE(bj_bjxmmx.bjlx,'1','','2','增') xmbh,bj_bjxmmx.xmmc,jldwmc,bj_bjxmmx.dj,sum(bj_gclmx.sl) sl,sum(bj_gclmx.sl*bj_bjxmmx.dj) as je";
	ls_sql+=" FROM bj_bjxmmx,jdm_jldwbm,bj_gclmx,crm_khxx  ";
	ls_sql+=" where bj_bjxmmx.jldwbm=jdm_jldwbm.jldwbm ";
    ls_sql+=" and bj_gclmx.khbh=crm_khxx.khbh and crm_khxx.jzbz='2'";
    ls_sql+=wheresql;
	ls_sql+=" and bj_bjxmmx.khbh=bj_gclmx.khbh and bj_bjxmmx.wybh=bj_gclmx.wybh";
	ls_sql+=" and bj_bjxmmx.wybh not in(select wybh from bj_khglfxb,crm_khxx where bj_khglfxb.khbh=crm_khxx.khbh "+wheresql+") ";
	ls_sql+=" group by bj_bjxmmx.xh,bj_bjxmmx.wybh,bj_bjxmmx.xmbh,bj_bjxmmx.bjlx,bj_bjxmmx.xmmc,jldwmc,bj_bjxmmx.dj";
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		wybh=cf.fillNull(rs.getString("wybh"));
