...
<%
	...
	ls_sql="SELECT xmdlmc,xmxlmc,xmbh,xmmc,TO_CHAR(dj),sum(sl),sum(bj_gclmx.sl*bj_bjxmmx.dj) ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" group by bj_bjxmmx.xmdlbm,xmdlmc,bj_bjxmmx.xmxlbm,xmxlmc,xmbh,xmmc,dj";
    ls_sql+=" order by sum(bj_gclmx.sl*bj_bjxmmx.dj) desc,bj_bjxmmx.xmdlbm,bj_bjxmmx.xmxlbm,xmbh";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
