...
//		out.println(ls_sql);
		...
		if (rowsl>0)
		{
			ls_sql="SELECT bdm_glflbm.glflmc,bj_khglfxb.glbxh,bj_khglfxb.glmc,bdm_cljldwbm.cljldwmc,bj_khglfxb.xhl,bj_khglfxb.dj,bj_khglfxb.pp,bj_khglfxb.xhgg ";
			ls_sql+=" FROM bdm_cljldwbm,bdm_glflbm,bj_khglfxb  ";
			ls_sql+=" where bj_khglfxb.glflbm=bdm_glflbm.glflbm(+) and bj_khglfxb.jldwbm=bdm_cljldwbm.cljldwbm(+)";
			ls_sql+=" and bj_khglfxb.wybh='"+wybh+"' ";
			ls_sql+=" order by bj_khglfxb.glflbm,bj_khglfxb.glbxh";
	//		out.println(ls_sql);
			...
			if (rs1.next())
			{
				...
				glmc=cf.fillHtml(rs1.getString("glmc"));
				cljldwmc=cf.fillHtml(rs1.getString("cljldwmc"));

				xhgg=cf.fillHtml(rs1.getString("xhgg"));
				pp=cf.fillHtml(rs1.getString("pp"));
