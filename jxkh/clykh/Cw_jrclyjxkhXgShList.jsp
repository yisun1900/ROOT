...
//设置按钮参数
	...
	String[] buttonLink={"Cw_jrclyjxkhXgShList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update cw_jrclyjxkh set clzt='1' where "+chooseitem;
...
<CENTER >
  <B><font size="3">材料员考核－维护审核</font></B>
</CENTER>
<%
	pageObj.out=out;
