...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_jrclyjxkh.khzq,cw_jrclyjxkh.khqssj,cw_jrclyjxkh.khjzsj,a.dwmc fgsbh,cw_jrclyjxkh.dwbh,b.dwmc,cw_jrclyjxkh.yhmc,DECODE(cw_jrclyjxkh.clzt,'1','未审核','2','审核') clzt,cw_jrclyjxkh.khfs,tsl,tslfs,ddjdfs,xtsyfs,tsclfs,rcglfs,lckhfs,cw_jrclyjxkh.lrr,cw_jrclyjxkh.lrsj,cw_jrclyjxkh.bz  ";
