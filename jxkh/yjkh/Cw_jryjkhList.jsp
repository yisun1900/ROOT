...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_jryjkh.khzq,cw_jryjkh.khqssj,cw_jryjkh.khjzsj,a.dwmc fgs,b.dwmc,cw_jryjkh.ygbh,cw_jryjkh.bianhao,cw_jryjkh.yhmc,zwmc,cw_jryjkh.byrw,cw_jryjkh.lrr,cw_jryjkh.lrsj,cw_jryjkh.bz  ";
