...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_jryjkh.khzq,cw_jryjkh.khqssj,cw_jryjkh.khjzsj,a.dwmc fgs,b.dwmc,cw_jryjkh.ygbh,cw_jryjkh.bianhao,cw_jryjkh.yhmc,zwmc,cw_jryjkh.byrw,cw_jryjkh.byqds,cw_jryjkh.byyj,cw_jryjkh.dzkhbl||'%',cw_jryjkh.khr,cw_jryjkh.khsj,cw_jryjkh.lrr,cw_jryjkh.lrsj,cw_jryjkh.bz  ";
    ...
    ls_sql+=" and cw_jryjkh.sfkh='Y'";//N：未考核；Y：考核
    ls_sql+=wheresql;
    ls_sql+=" order by cw_jryjkh.khzq,cw_jryjkh.fgsbh,cw_jryjkh.dwbh,cw_jryjkh.zw,cw_jryjkh.yhmc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_jryjkhXgKhList.jsp","","","EditKhCw_jryjkh.jsp");
...
//设置按钮参数
	String[] buttonName={"删除考核信息"};//按钮的显示名称
	String[] buttonLink={"Cw_jryjkhXgKhList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update cw_jryjkh set sfkh='N',byqds=0,byyj=0,dzkhbl=0,khr='',khsj=null where "+chooseitem;
