...
<%
	...
	{
		String ls=new String(b,0,len);
		if (ls.indexOf("window.close")!=-1)
		{
			ls=cf.replace(ls,"window.close","AAAA.close");
		} 
		if (ls.indexOf("window.location")!=-1)
		{
			ls=cf.replace(ls,"window.location","AAAA.location");
		} 
		out.print(ls);
	}
}
