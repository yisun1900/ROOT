...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/"+"xz/ggbgl/tp/";
String jdbasePath="/xz/ggbgl/tp/";
%>
...
//String src = basePath;
   ...
   %>
<script type="text/javascript">
//alert("<%= jdbasePath+saObjectFile[i]%>");
