...
try {
	...
	ls_sql="select sqxh,xm,zw,sqlrr,dh,bgdh,yx,bz,dwbh,sqrq ,yqjfrq,yqsl,sfywc,cz,ygbh,mpbb";
...
<form method="post" action="SaveWcXz_mpyzsq.jsp" name="editform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%"> 
                <div align="right"><font color="#0000FF">办公电话</font></div>
              </td>
              <td width="32%">
                <input type="text" name="bgdh" value="<%=bgdh%>" size="20" maxlength="50" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td width="17%" align="right"><font color="#0000FF">传真</font></td>
              <td width="33%">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="text" name="wcsl" size="20" maxlength="10"  value="<%=yqsl%>" >
              </td>
...
%> 
              ...
              <td width="32%"> 
                <input type="text" name="dj" value=""  size="20" maxlength="10" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%"> 
