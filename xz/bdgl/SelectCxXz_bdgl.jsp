...
<form method="post" action="Xz_bdglCxList.jsp" name="selectform">
	...
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
        ...
        out.println("        <select name=\"fbfgs\" style=\"FONT-SIZE:12PX;WIDTH:152PX\"  onChange=\"selectItem(fbfgs,xz_bdgl_fbbm,"+dwstr1+");\">");
		out.println("<option value=\"\"></option>");
