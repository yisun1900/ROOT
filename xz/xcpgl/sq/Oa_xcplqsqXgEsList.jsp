...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Oa_xcplqsqXgEsList.jsp","SelectXgEsOa_xcplqsq.jsp","","XgEsOa_xcplqsq.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Oa_xcplqsqXgEsList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update oa_xcplqsq set lqzt='3',ejspr=null,ejspsj=null,ejspjl=null,ejspsm=null where lqzt='4' and ("+chooseitem+")";
...
<CENTER >
  <B><font size="3">印刷品领取申请---修改二级审批</font></B>
</CENTER>
<%
	pageObj.out=out;
