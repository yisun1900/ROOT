...
<body bgcolor="#FFFFFF">
<form method="post" action="Oa_xcplqsqLqList.jsp" name="selectform">
<div align="center">印刷品领取申请---领取</div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">二级审批人</td>
      <td width="32%"> 
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">二级审批时间 从</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">三级审批人</td>
      <td width="32%"> 
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">三级审批时间 从</td>
      <td width="32%"> 
