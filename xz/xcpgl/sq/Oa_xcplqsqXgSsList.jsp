...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by oa_xcplqsq.sjspsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Oa_xcplqsqXgSsList.jsp","SelectXgSsOa_xcplqsq.jsp","","XgSsOa_xcplqsq.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Oa_xcplqsqXgSsList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update oa_xcplqsq set lqzt='4',sjspr=null,sjspsj=null,sjspjl=null,sjspsm=null where lqzt='5' and ("+chooseitem+")";
...
<CENTER >
  <B><font size="3">印刷品领取申请---修改三级审批</font></B>
</CENTER>
<%
	pageObj.out=out;
