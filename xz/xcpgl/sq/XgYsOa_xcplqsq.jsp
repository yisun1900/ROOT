...
<form method="post" action="" name="editform" >
  <div align="center">印刷品领取申请---修改一级审批</div>
...
%> </td>
      <td align="right" width="16%"><font color="#0000CC">申领分公司</font></td>
      <td width="34%"> <%
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> <%=slr%> </td>
      <td align="right" width="16%"><font color="#0000CC">计划领取日期</font></td>
      <td width="34%"> <%=jhlqrq%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">录入人</font></td>
      <td width="33%"> <%=lrr%> </td>
      <td align="right" width="16%"><font color="#0000CC">录入日期</font></td>
      <td width="34%"> <%=lrrq%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">二级审批人</font></td>
      <td width="33%"> <%=ejspr%> </td>
      <td align="right" width="16%"><font color="#0000CC">二级审批时间</font></td>
      <td width="34%"> <%=ejspsj%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">二级审批结论</font></td>
      <td width="33%"><%
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">二级审批说明</font></td>
      <td colspan="3"> <%=ejspsm%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">三级审批人</font></td>
      <td width="33%"> <%=sjspr%> </td>
      <td align="right" width="16%"><font color="#0000CC">三级审批时间</font></td>
      <td width="34%"> <%=sjspsj%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="16%"><font color="#CC0033">*</font>审批时间</td>
      <td width="34%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"><%
	cf.radioToken(out, "yjspjl","1+同意&2+返回上级&3+撤销",yjspjl);
%></td>
      <td align="right" width="16%">&nbsp;</td>
      <td width="34%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <textarea name="yjspsm" cols="71" rows="3"><%=yjspsm%></textarea>
      </td>
    </tr>
    <tr> 
      <td colspan="4" > 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgYsOa_xcplqsq.jsp"
	FormName.submit();
	return true;
}
