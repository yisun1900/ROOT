  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> <%
        ...
        out.println("        </select>");
%> </td>
      <td align="right" width="18%">当前保管部门</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="xz_gdzcb_gsbh" size="20" maxlength="7" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="xz_gdzcb_bmbh" size="20" maxlength="7" >
      </td>
      <td align="right" width="18%">固定资产分类</td>
      <td width="32%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%" align="right">配置(内存)</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%" align="right">配置(主板)</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%" align="right">配置(显示器)</td>
      <td width="32%"> 
...
%> </td>
      <td align="right" width="18%">保管人</td>
      <td width="32%"> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td align="right" width="18%">到</td>
      <td width="32%">
        <input type="text" name="xz_gdzcb_lrsj2" value="" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
