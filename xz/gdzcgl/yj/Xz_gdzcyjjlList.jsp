...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Xz_gdzcyjjlList.jsp","SelectXz_gdzcyjjl.jsp","","EditXz_gdzcyjjl.jsp");
...
//设置主键
	String[] keyName={"gsbh","yjsj"};
	pageObj.setKey(keyName);
//设置按钮参数
	String[] buttonName={"删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"DeleteXz_gdzcyjjl.jsp?"};//按钮单击调用的网页，可以增加参数
