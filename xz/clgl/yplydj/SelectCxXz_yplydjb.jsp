...
%> 
    ...
    <tr bgcolor="#FFFFCC"> 
      <td align="right" width="19%">查询结果排序</td>
      <td colspan="3">第一列 
        <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
          <option value="xz_yplydjb.ssfgs">所属分公司</option>
          <option value="xz_yplydjb.qcph">汽车牌号</option>
          <option value="xz_yplydjb.xh">序号</option>
          <option value="xz_yplydjb.lyrq">加油日期</option>
          <option value="xz_yplydjb.lyr">加油人</option>
          <option value="xz_yplydjb.ybh">油标号</option>
          <option value="xz_yplydjb.lysl">加油数量</option>
        </select>
        第二列 
        <select name="jgpx2" style="FONT-SIZE:12PX;WIDTH:100PX">
          <option value=""></option>
          <option value="xz_yplydjb.ssfgs">所属分公司</option>
          <option value="xz_yplydjb.qcph" selected>汽车牌号</option>
          <option value="xz_yplydjb.xh">序号</option>
          <option value="xz_yplydjb.lyrq">加油日期</option>
          <option value="xz_yplydjb.lyr">加油人</option>
          <option value="xz_yplydjb.ybh">油标号</option>
        ...
        <select name="jgpx3" style="FONT-SIZE:12PX;WIDTH:100PX">
          ...
          <option value="xz_yplydjb.ssfgs">所属分公司</option>
          <option value="xz_yplydjb.qcph">汽车牌号</option>
          <option value="xz_yplydjb.xh" selected>序号</option>
          <option value="xz_yplydjb.lyrq">加油日期</option>
          <option value="xz_yplydjb.lyr">加油人</option>
          <option value="xz_yplydjb.ybh">油标号</option>
          <option value="xz_yplydjb.lysl">加油数量</option>
