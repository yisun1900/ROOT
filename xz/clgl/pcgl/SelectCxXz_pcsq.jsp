    ...
    <tr bgcolor="#FFFFCC"> 
      ...
      <td colspan="3">第一列 
        <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
          <option value="xz_pcsq.pzsj desc">派车时间</option>
          <option value="xz_pcsq.sqxh">申请序号</option>
          <option value="xz_pcsq.dwbh">申请部门</option>
          <option value="xz_pcsq.qcph">汽车牌号</option>
          <option value="xz_pcsq.lrsj desc">录入时间</option>
          <option value="xz_pcsq.sqrq desc">申请日期</option>
          <option value="xz_pcsq.clzt">派车状态</option>
          <option value="xz_pcsq.ycsj desc">用车时间</option>
          <option value="xz_pcsq.fhsj desc">返回时间</option>
          <option value="xz_pcsq.sjxm">司机姓名</option>
        </select>
        第二列 
