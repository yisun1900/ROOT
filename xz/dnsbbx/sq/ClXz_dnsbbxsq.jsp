...
String wxbm=(String)session.getAttribute("dwbh");
...
try {
	...
	ls_sql="select clzt,fgsbh,dwbh,gdzcmc,bgr,gsbh,bmbh,gdzcflmc,xh,pp,pz1,pz2,pz3,pz4,pz5,pz6 ,dnsbflmc,dnsbgzmc,sqr,bxrq,jhlqrq,DECODE(sfyzysj,'N','无','Y','有') as sfyzysj,gzxxsm,lrr ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveClXz_dnsbbxsq.jsp" name="editform">
<div align="center">处理－电脑及设备报修申请（报修序号：<%=wherebxxh%>）</div>
...
%>
    ...
    <td><input type="text" name="wxr" size="20" maxlength="20"  value="<%=yhmc%>" readonly></td>
  </tr>
  
<tr bgcolor="#FFFFFF">
  <td align="right" width="20%"><span class="STYLE4">*</span>诊断结果</td> 
  <td colspan="3"> 
    <textarea name="jdjg" cols="73" rows="3"></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE4">*</span>处理情况</td>
  <td colspan="3"><textarea name="clqk" cols="73" rows="3"></textarea></td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE4">*</span>处理状态</td>
  <td><%
	cf.radioToken(out, "clzt","3+维修中&4+采购中&5+送修中&6+完成","");
%>  </td>
  <td align="right"><span class="STYLE1"><span class="STYLE4">*</span>维修录入时间</span></td>
  <td><input type="text" name="wxlrsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="20%">维修完成时间</td> 
  <td width="30%"><input type="text" name="wcsj" size="20" maxlength="10"  value="" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="20%">维修费用</td> 
  <td width="30%"> 
    <input type="text" name="wxfy" size="20" maxlength="17"  value="0" >  </td>
</tr>
