...
<form method="post" action="Xz_xzzlkhbTjList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="xz_xzzlkhb_khsj" size="20" value=<%=cf.firstDay()%> maxlength="10" >
  </td>
  <td width="15%"> 
...
{ 
    ...
    out.print("\n <OPTION  value=\""+kb+"\">"+kb+"</OPTION>");	
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx='F1' and dqbm='"+dqbm+"'","");
 }
 else
 {
