...
try {
	...
	ls_sql="select gwbh,gwmc,gwnr,gwfj,fbsj,fbr,fbbm,lrsj,bz,lrr,fbfw,fbfgs ";
	ls_sql+=" from  xz_gwgl";
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="35%"> 
                <input type="text" name="gwbh" size="20" maxlength="20"  value="<%=gwbh%>" >
              </td>
              <td width="15%"> 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="gwmc" size="73" maxlength="100"  value="<%=gwmc%>" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <textarea name="gwnr" cols="71" rows="15"><%=gwnr%></textarea>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
...
%>
	...
	FormName.action="SaveEditXz_gwgl.jsp";
	FormName.submit();
	return true;
}
