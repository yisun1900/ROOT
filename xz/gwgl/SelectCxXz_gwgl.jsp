...
<form method="post" action="Xz_gwglCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">发布分公司</td>
              <td width="32%"><%
	...
	%></td>
              <td width="16%" align="right">发布部门</td>
              <td width="34%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="18%">公文名称</td>
              <td width="32%"> 
                <input type="text" name="xz_gwgl_gwmc" size="20" maxlength="100" >
              </td>
              <td align="right" width="16%">发布范围</td>
              <td width="34%"> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                <select name="jgpx1" style="FONT-SIZE:12PX;WIDTH:100PX">
                  <option value="xz_gwgl.fbsj desc">发布时间</option>
                  <option value="xz_gwgl.gwmc">公文名称</option>
                  <option value="xz_gwgl.gwbh">公文编号</option>
                  <option value="xz_gwgl.fbr">发布人</option>
                  <option value="xz_gwgl.fbbm">发布部门</option>
                  <option value="xz_gwgl.fbfgs">发布分公司</option>
                  <option value="xz_gwgl.fbfw">发布范围</option>
                  <option value="xz_gwgl.lrr">录入人</option>
                  <option value="xz_gwgl.lrsj">录入时间</option>
                </select>
                第二列 
...
{
	if(!(isDatetime(FormName.xz_gwgl_fbsj, "发布时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.xz_gwgl_fbsj2, "发布时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.xz_gwgl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.xz_gwgl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
