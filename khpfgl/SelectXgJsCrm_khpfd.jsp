...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_khpfdXgJsList.jsp" name="selectform">
<div align="center">赔付单－财务接收－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><%
	cf.radioToken(out, "crm_khpfd_pfzt","1+等待审核&2+已审核&3+财务接收&4+赔付完成","");
%></td>
  </tr>
<tr bgcolor="#FFFFFF">
