...
//	out.println(chooseitem);
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update oa_lqsq set lqzt='N',slqsl=0,blr=null,lqsj=null where "+chooseitem;
