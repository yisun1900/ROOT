...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by oa_lqsq.lqsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Oa_lqsqXgLqList.jsp","SelectXgLqOa_lqsq.jsp","XgLqOa_lqsq.jsp","");
...
//设置按钮参数
	String[] buttonName={"删除领取信息"};//按钮的显示名称
	String[] buttonLink={"Oa_lqsqXgLqList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update oa_lqsq set lqzt='N',slqsl=0,blr=null,lqsj=null where lqlx='1' and "+chooseitem;
		sql[1]="delete from oa_lqsq where lqlx='2' and "+chooseitem;
