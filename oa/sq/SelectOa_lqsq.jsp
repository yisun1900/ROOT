...
<form method="post" action="Oa_lqsqList.jsp" name="selectform">
...
%> 
              ...
              <td width="33%"> 
                <select name="oa_lqsq_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" >
<%
	if (yhjs.equals("A0"))
	{
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">录入日期 从</td>
              <td width="33%"> 
            ...
            <tr bgcolor="#FFFFFF">
              <td width="17%" align="right">计划领取日期 从</td>
              <td width="33%"> 
