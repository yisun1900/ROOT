...
<%	
		...
		while(rs1.next())
		{
			...
			{
%>
				<tr><td>&nbsp;&nbsp;&nbsp;<%=count%>).<% out.print("\n<input name=\"wtbh"+row+"\" type=checkbox value=\""+wtkxda+"\" check=\"^0{1,}$\" warning=\"您有至少有一个题目没有选,请仔细查看!谢谢!\">");%> <%=wtkxda%><input type="hidden" NAME="sfyxsm<%=row%>" value="<%=sfyxsm%>" ></td></tr>
<%
			}else
			{
			
%>
				<tr><td>&nbsp;&nbsp;&nbsp;<%=count%>).<% out.print("\n<input name=\"wtbh"+row+"\" type=radio value=\""+wtkxda+"\" check=\"^0$\" warning=\"您有至少有一个题目没有选,请仔细查看!谢谢!\">");%><%=wtkxda%><input type="hidden" NAME="sfyxsm<%=row%>" value="<%=sfyxsm%>" ></td></tr>
...
%>
  <tr bgcolor="#FFFFFF">
	...
	<table width="60%" height="25" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td align="center">
							  <img src="../images/queren.gif" width="39" height="25" onClick="CheckForm(listform)">
                              <img src="../images/REG.gif" width="39" height="25" onClick="listform.reset()">&nbsp;<img src="../images/new.gif" width="39" height="25" onclick="window.open('ckjg.jsp',target='_self')"></td>
                            </tr>
                          </table>
	</td>
	</tr>
