...
try {
	...
	ls_sql="select wtbh,dcqs,wtmc,sfkdx,wtsfgq,wtfl,xwtsm,lrr,to_char(lrsj,'YYYY-MM-DD') lrsj";
...
%>
	...
	<tr bgcolor="#FFFFFF"> 
      ...
      <td width="28%"><input type="text" name="lrsj" size="15"  value="<%=lrsj%>" readonly>
       </td>
    </tr>
	 <tr bgcolor="#FFFFFF">
	...
	%>
	    <tr bgcolor="#FFFFFF"> 
      <td align="right">可选答案<%=(i+l)%> 
        <%//=(1+j)%>
      </td>
      <td colspan="3"><input type="text" name="kxdax" value="" size="80" maxlength="300" > 
       </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right">结果说明</td>
      <td colspan="3"><input type="text" name="jgsmx" value="" size="80" maxlength="300" > 
        </td>
    </tr>
	<%
	}
	%>
	<input type="hidden" name="jgsmx" value="" size="80" maxlength="300" > 
	<input type="hidden" name="kxdax" value="" size="80" maxlength="300" > 
	<tr bgcolor="#FFFFFF"> 
