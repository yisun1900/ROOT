...
%>
<div align="center"><br><b>在施工工地－在施遗留<%=fgsmc%>）
<BR>
[<%=sjfw%>]之前开工工地，到[<%=sjfw2%>]时未完工，且实际工期<合法工期
</b></div>
...
String ys4=null;
	...
	int row=0;
	ls_sql="select khbh,hth,khxm,lxfs,fwdz,sjs,zjxm,sgdmc sgd,qyrq,pdsj,kgrq,sjkgrq,sybgcrq,szqsj,jgrq,crm_khxx.gcjdbm,ysgcjdmc,pdclzt,sjjgrq,hzts,cwsfke";
	ls_sql+=" from  crm_khxx,sq_sgd,dm_gcjdbm";
	ls_sql+=" where crm_khxx.sgd=sq_sgd.sgd(+) and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm ";
	ls_sql+=" and crm_khxx.fgsbh='"+fgsbh+"' and zt='2' and crm_khxx.gcjdbm in('2','3','6')";
