...
%>
<div align="center"><br> <b>退单工地情况说明 （<%=sjfw%>----<%=sjfw2%>）</b></div>
...
try {
	...
	ls_sql+=" and crm_tddj.lrsj<=TO_DATE('"+sjfw2+"','YYYY-MM-DD')";
	ls_sql+=wheresql;
	//out.print(ls_sql);
...
<div align="center"><br> <b>跑单情况说明 （<%=sjfw%>----<%=sjfw2%>）</b></div>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"   style='FONT-SIZE: 12px'>
 ...
 <%
	...
	ls_sql+=" and crm_zxkhxx.lrsj<=TO_DATE('"+sjfw2+"','YYYY-MM-DD')";
	ls_sql+=wheresql;
	//out.print(ls_sql);
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery(ls_sql);
