...
try {
	...
	String hfnr=null;
	String hfr=null;
	ls_sql="select crm_hfjl.hfjlh,hth,khxm,sjs,qyrq,hfsj,DECODE(sjshfnr,null,'',sjshfnr,'[设]：'||sjshfnr)||DECODE(zjyhfnr,null,'',zjyhfnr,'<BR>[质]：'||zjyhfnr)||DECODE(sgdhfnr,null,'',sgdhfnr,'<BR>[队]：'||sgdhfnr)||DECODE(jchfnr,null,'',jchfnr,'<BR>[集成]：'||jchfnr) as hfnr,hfr";
	ls_sql+=" from crm_hfjl,crm_khxx";
	ls_sql+=" where crm_hfjl.khbh=crm_khxx.khbh and hfsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD') ";
