...
//out.println(wheresql);
	...
	ls_sql="SELECT '',crm_zxkhxx.sjs,crm_zxkhxx.hth,crm_zxkhxx.khxm,crm_zxkhxx.fwdz fwwww,DECODE(crm_khxx.jzbz,'1','家装','2','工装'),DECODE(crm_khxx.zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),crm_khxx.tdsj,crm_zxkhxx.jsjfsj,crm_khxx.qyrq,crm_khxx.qyrq-crm_zxkhxx.jsjfsj ";
	...
	ls_sql+=" ,crm_khxx.sjf,cwsfke,DECODE((qye+NVL(guanlif,0)+NVL(suijin,0)),0,'',ROUND(cwsfke*100/(qye+NVL(guanlif,0)+NVL(suijin,0)),1)||'%' ),sgdmc sgd,crm_khxx.zjxm ,crm_khxx.cxhdbm ";
...
<tr bgcolor="#CCCCCC"  align="center">
  ...
  <td width="3%" rowspan="2">交设计费时间</td>
  <td width="3%" rowspan="2">签约日期</td>
  <td width="2%" rowspan="2">签单周期</td>
  <td width="3%" rowspan="2">电子报价总额</td>
  <td colspan="2">折扣</td>
  ...
  <td width="3%" rowspan="2" bgcolor="#FFFF99">增减后总额 </td>
  <td width="3%" rowspan="2">设计费</td>
  <td width="3%" rowspan="2">财务家装实收款额</td>
  <td width="2%" rowspan="2" bgcolor="#FFFF99">实收款比例</td>
  <td width="2%" rowspan="2">施工队</td>
  <td width="2%" rowspan="2">质检员</td>
  <td width="5%" rowspan="2">促销活动</td>
  </tr>
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="2%">合同</td>
	<td  width="2%">增减项</td>
	...
	<td  width="3%" bgcolor="#FFFF99">工程签约额</td>
