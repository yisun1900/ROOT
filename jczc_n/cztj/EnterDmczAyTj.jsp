...
<%
	...
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"',SYSDATE,'警告！非法侵入[店面产值按月统计]："+xtrzyhmc+"') ";
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">店面产值按月统计</div>
      </td>
    </tr>
	<tr>
      <td align="right" width="42%" height="39">大区</td>
