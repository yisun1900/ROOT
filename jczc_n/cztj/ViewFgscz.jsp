...
//out.println(wheresql);
	ls_sql="SELECT '',crm_zxkhxx.sjs,crm_zxkhxx.hth,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(crm_khxx.jzbz,'1','家装','2','工装'),DECODE(crm_khxx.zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),crm_khxx.tdsj,crm_zxkhxx.jsjfsj,crm_khxx.qyrq,crm_khxx.qyrq-crm_zxkhxx.jsjfsj";
...
<CENTER >
  <B><font size="3">店面签约明细（<%=dwmc%>）（注意：包含退单）
...
<tr bgcolor="#CCCCCC"  align="center">
  ...
  <td width="4%" rowspan="2" bgcolor="#FFFF99">增减后总额 </td>
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="2%">合同</td>
	<td  width="2%">增减项</td>
	<td  width="3%" bgcolor="#99FFFF">折前业绩</td>
