...
<table border="1" width="4500" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
  <tr bgcolor="#CCCCCC"  align="center">
    <td  width="120" rowspan="2">分公司</td>
    <td  width="40" rowspan="2">序号</td>
    <td  width="160" rowspan="2">店面</td>
    <td  width="80" rowspan="2">本期收量房订金数</td>
    <td  width="80" rowspan="2">累计订金数（未签单）</td>
    <td  width="80" rowspan="2">订金签单数</td>
    <td  width="100" rowspan="2">家装签约额</td>
    <td  width="100" rowspan="2">家装签约数</td>
    <td  width="100" rowspan="2"><font color="#000099"><b>家居签约数</b></font></td>
    <td  width="70" rowspan="2"><font color="#000099"><b>家居数/家装数</b></font></td>
    <td  width="70" rowspan="2"><font color="#000099"><b>占总家居签约数比例</b></font></td>
    <td  width="100" rowspan="2"><font color="#000099"><b>家居签约额</b></font></td>
    <td  width="70" rowspan="2"><font color="#000099"><b>家居额/家装额</b></font></td>
    <td  width="70" rowspan="2"><font color="#000099"><b>占总家居签约额比例</b></font></td>
    <td colspan="25"><strong>定制产品类</strong></td>
    <td colspan="13"><strong>成品类</strong></td>
  </tr>
  <tr bgcolor="#CCCCCC"  align="center"> 
...
//			out.println(ls_sql);
		...
		ls_sql+=" where qddm='"+dmbh+"'";
			...
			%> 
			  <tr align="center" > 
				...
				<td  align="right"><%=sdjs%></td>
				<td  align="right"><%=ljsdjs%></td>
				<td  align="right"><%=djqds%></td>
		...
		%> 
		  <tr align="center" > 
			...
			<td >&nbsp;</td>
			<td   align="right"><font color="#000099"><b><%=cf.formatDouble(xjmmqye+xjcgqye+xjjjqye)%></b></font></td>
			<!-- 以下是主材内容: --> 
