...
//入职时间
			...
			ls_sql+=" FROM sq_yhxx ";
			ls_sql+=" where sq_yhxx.yhmc='"+getsjs+"' and sq_yhxx.dwbh='"+dmbh+"' and sfzszg in('Y','N')";
...
//派单数
			...
			<tr align="center" bgcolor="<%=bgcolor%>">
				...
				<td ><%=cf.formatDouble((int)zjxje)%></td>
...
<tr align="center">
	...
	<td ><%=cf.formatDouble((long)allzjxje)%></td>
