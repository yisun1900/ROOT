...
try {
	...
	ls_sql="select MONTHS_BETWEEN(  NVL(max(jzrq),ADD_MONTHS(TO_DATE('"+jzrq+"','YYYY-MM-DD'),-1)),TO_DATE('"+jzrq+"','YYYY-MM-DD')),max(jzrq) ";
	ls_sql+="  from cw_qmjz";  
	...
	ls_sql="insert into cw_qmjz ( jzrq,jzr,sqjzrq) ";
	ls_sql+=" values ( TO_DATE('"+jzrq+"','YYYY-MM-DD'),?,?) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,yhmc);
	ps.setDate(2,sqjzrq);
	ps.executeUpdate();
	...
	while (rs1.next())
	{
		...
		ls_sql+=" select TO_DATE('"+jzrq+"','YYYY-MM-DD'),khbh,zt,khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh";
		ls_sql+=" FROM crm_khxx";
		ls_sql+=" where zt in('2','5')";//2：家装客户；3：退单客户；4：集成客户；5：设计客户
		...
		ls_sql="insert into cw_qmjzmx (jzrq,khbh,zt,khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh)";
		ls_sql+=" select TO_DATE('"+jzrq+"','YYYY-MM-DD'),khbh,'2',khxm,hth,sjs,wdzgce,qye,suijin,suijinbfb,sjf,glf,guanlif,hbqye,zjxje,zhzjxje,zjxsuijin,kglf,kqtk,zkl,cxhdbm,qyrq,tdsj,sgd,zjxm,fwmj,jzbz,sfke,jzkfkcs,jzkscsj,jzkfksj,cwsfke,cwjzkfkcs,cwjzkscsj,cwjzkfksj,ywy,fgsbh,dwbh";
		ls_sql+=" FROM crm_khxx";
