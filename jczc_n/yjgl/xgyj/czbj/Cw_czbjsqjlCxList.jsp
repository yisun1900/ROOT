...
%>
   ...
   <tr bgcolor="#CCCCCC"  align="center"> 
    <td rowspan="2" width="2%">完成标志</td>
    <td rowspan="2" width="2%">需业绩结转</td>
    <td rowspan="2" width="3%">业绩结转时间</td>
    <td rowspan="2" width="3%">客户编号</td>
    <td rowspan="2" width="3%">合同号</td>
    <td rowspan="2" width="3%">客户姓名</td>
    <td rowspan="2" width="8%">房屋地址</td>
    <td rowspan="2" width="3%">设计师</td>
    <td rowspan="2" width="3%">签约日期</td>
    <td rowspan="2" width="5%">签约店面</td>
    <td rowspan="2" width="3%">授权时间</td>
    <td rowspan="2" width="2%">授权人</td>
    <td rowspan="2" width="3%">完成时间</td>
    <td rowspan="2" width="2%">完成人</td>
    <td colspan="8" bgcolor="#CCCC99">更新前</td>
    <td colspan="8" bgcolor="#CCCCFF">更新后</td>
    <td rowspan="2" width="11%">备注</td>
  </tr>
  <tr bgcolor="#CCCCCC"  align="center"> 
    <td  width="3%" bgcolor="#CCCC99">合同原报价</td>
    <td  width="2%" bgcolor="#CCCC99">折扣率</td>
    <td  width="3%" bgcolor="#CCCC99">签约额</td>
    <td  width="3%" bgcolor="#CCCC99">税金</td>
    <td  width="2%" bgcolor="#CCCC99">税金百分比</td>
    <td  width="3%" bgcolor="#CCCC99">设计费</td>
    <td  width="3%" bgcolor="#CCCC99">服务费</td>
    <td  width="3%" bgcolor="#CCCC99">管理费</td>
    <td  width="3%" bgcolor="#CCCCFF">合同原报价</td>
    <td  width="2%" bgcolor="#CCCCFF">折扣率</td>
    <td  width="3%" bgcolor="#CCCCFF">签约额</td>
    <td  width="3%" bgcolor="#CCCCFF">税金</td>
    <td  width="2%" bgcolor="#CCCCFF">税金百分比</td>
    <td  width="3%" bgcolor="#CCCCFF">设计费</td>
    <td  width="3%" bgcolor="#CCCCFF">服务费</td>
    <td  width="3%" bgcolor="#CCCCFF">管理费</td>
  </tr>
<%
	pageObj.printDate();
	pageObj.printFoot();
