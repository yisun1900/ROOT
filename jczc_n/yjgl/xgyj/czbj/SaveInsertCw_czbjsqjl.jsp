...
try {
	...
	ls_sql="insert into cw_czbjsqjl (khbh,sqsj,khxm,fgsbh,sqr,wcbz  ,gxqwdzgce,gxqzkl,gxqqye,gxqsuijin,gxqsuijinbfb,gxqsjf,gxqglf,gxqguanlif   ,gxhwdzgce,gxhzkl,gxhqye,gxhsuijin,gxhsuijinbfb,gxhsjf,gxhglf,gxhguanlif  ,bz,sfxyjjz)";
	ls_sql+=" select khbh,?,khxm,fgsbh,?,'1'  ,NVL(wdzgce,0),zkl,NVL(qye,0),NVL(suijin,0),suijinbfb,NVL(sjf,0),NVL(glf,0),NVL(guanlif,0)   ,NVL(wdzgce,0),zkl,NVL(qye,0),NVL(suijin,0),suijinbfb,NVL(sjf,0),NVL(glf,0),NVL(guanlif,0)  ,?,'Y'";
	ls_sql+=" from crm_khxx ";
	ls_sql+=" where khbh='"+khbh+"'";
	ps= conn.prepareStatement(ls_sql);
	ps.setDate(1,sqsj);
