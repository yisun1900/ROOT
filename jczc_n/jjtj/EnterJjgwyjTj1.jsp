...
%> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">家居顾问</td>
      <td width="58%" height="39"> <%
 ...
 %> </td>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="家居顾问业绩统计" onClick="f_do(selectform)" name="jzcz">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.cxrq, "时间范围 "))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.cxrq2, "时间范围 "))) {
		return false;
	}
