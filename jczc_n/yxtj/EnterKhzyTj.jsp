...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="客户资源统计" onClick="f_do(selectform,'zy')">
        <input type="button"  value="房屋面积统计" onClick="f_do(selectform,'mj')" name="button">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (lx=='zy')
	{
		FormName.action="KhzyTj.jsp";
	}
	else if (lx=='mj')
	{
		FormName.action="fwmjtjb.jsp";
	}
	FormName.submit();
	return true;
}
