    ...
    <td>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px' class="STYLE_TAB">
        <tr bgcolor="#CCCCCC"  align="center" class="STYLE_TR"> 
          <td  width="6%" class="STYLE2">名次</td>
          <td  width="12%" class="STYLE2">回单人</td>
          <td  width="9%" class="STYLE2">回单总数</td>
          <td  width="10%" class="STYLE2">回单总金额</td>
          <td  width="8%" class="STYLE2">折扣率</td>
          <td  width="9%" class="STYLE2">平均单额</td>
          <td  width="8%" class="STYLE2">设计费</td>
          <td  width="34%" class="STYLE2">回单总金额</td>
        </tr>
<%
int maxsl=0;
int maxsl1=0;
