...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,khxm,fwdz,DECODE(zt,'2','家装','3','退单','4','集成','5','设计'),yjjzsj,tdyjjzsj,a.dwmc sbdm,sjs,sgdmc sgd,zjxm,kgrq,jgrq ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","InsertCw_jzyjxgjl.jsp","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="20%">房屋地址</td>
	<td  width="5%">类型</td>
	<td  width="7%">签单业绩结转时间</td>
	<td  width="7%">退单业绩结转时间</td>
	<td  width="11%">签约店面</td>
	<td  width="5%">设计师</td>
	<td  width="5%">施工队</td>
	<td  width="5%">质检员</td>
