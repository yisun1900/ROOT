...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jxc_clbmShList.jsp?dqbm="+dqbm,"","","");
...
//设置按钮参数
	...
	String[] buttonLink={"Jxc_clbmShList.jsp?dqbm="+dqbm};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update jxc_cljgb set shbz='Y',shsj=SYSDATE,shr='"+yhmc+"' where  dqbm='"+dqbm+"' and "+chooseitem;
