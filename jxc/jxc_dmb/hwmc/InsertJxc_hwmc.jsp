...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertJxc_hwmc.jsp" name="insertform" target="_blank">
...
%>
  ...
  <td width="35%"><select name="ckbh" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeckbh(insertform)">
    <option value=""></option>
    <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"><input type="text" name="hwmc" value="" size="20" maxlength="50" ></td>
</tr>
    <tr align="center"> 
      <td colspan="4"> 
