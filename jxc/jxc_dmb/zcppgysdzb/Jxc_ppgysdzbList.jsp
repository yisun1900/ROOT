...
//设置显示列
	String[] disColName={"ppbm","ppmc","gysbm","gysmc","dwmc","yhdlm","yhmc","kdlxtbz","lxdlsbcs","mmsyzq","yxdlsbcs","sfsd","tcycf","sfxcl","sfkgtcsl","sfyyh","yhkssj","yhjzsj","yhnr"};
