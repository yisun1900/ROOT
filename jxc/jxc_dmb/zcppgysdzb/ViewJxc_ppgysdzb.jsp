...
try {
	...
	ls_sql="select ppbm,ppmc,gysbm,gysmc,dqmc dqbm ";
	ls_sql+=" from  jxc_ppgysdzb,dm_dqbm";
	ls_sql+=" where jxc_ppgysdzb.dqbm=dm_dqbm.dqbm and  (ppbm="+whereppbm+") and  (gysbm="+wheregysbm+")  ";
