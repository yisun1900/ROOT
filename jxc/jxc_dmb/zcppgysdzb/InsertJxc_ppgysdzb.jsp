...
<tr bgcolor="#CCCCFF">
  ...
  <td><%
	cf.radioToken(out, "sfxcl","Y+需要&N+否","N");
%></td>
  <td align="right">是否可改套餐数量</td>
  <td><%
	cf.radioToken(out, "sfkgtcsl","Y+可以&N+否","N");
%></td>
</tr>
<tr bgcolor="#CCCCFF">
  <td align="right"><font color="#FF0000">*</font>是否有优惠</td>
  <td><input name="sfyyh" type="radio" value="N" checked>
    否
...
<tr bgcolor="#CCCCFF">
  ...
  <td><input type="text" name="yhkssj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)">
  </td>
  <td align="right">优惠截至时间</td>
  <td><input type="text" name="yhjzsj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)">
  </td>
</tr>
<tr bgcolor="#CCCCFF">
  <td align="right">优惠内容</td>
  <td colspan="3"><textarea name="yhnr" cols="72" rows="3"></textarea>
  </td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="yhdlm" value="" size="20" maxlength="16" >  </td>
