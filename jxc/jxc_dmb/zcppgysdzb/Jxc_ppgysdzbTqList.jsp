...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT distinct jxc_ppgysdzb.ppbm,jxc_ppgysdzb.ppmc,jxc_ppgysdzb.gysbm,jxc_ppgysdzb.gysmc,jxc_ppgysdzb.ssfgs,dwmc ";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_ppgysdzbTqList.jsp","","","EditJxc_ppgysdzb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Jxc_ppgysdzbTqList.jsp?"};//按钮单击调用的网页，可以增加参数
