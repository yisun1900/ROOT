...
String wherehtbh=null;
wherehtbh=cf.GB2Uni(request.getParameter("wherehtbh"));
Connection conn  = null;
PreparedStatement ps=null;
String ls_sql=null;
try {
	conn=cf.getConnection();
	ls_sql="update jxc_gyshtxx set htbh=?,dqbm=?,gysmc=?,gysdz=?,gysfzr=?,gysdh=?,gyscz=?,kssj=?,jssj=?,bz=? ";
