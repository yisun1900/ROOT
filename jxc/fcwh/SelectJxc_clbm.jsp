...
<tr align="center"> 
  <td colspan="4"> 
    ...
    <input type="button" onClick="f_exp(insertform)"  value="导出辅材编码">
    <input type="reset"  value="重输">
    <input type="button" onClick="f_del(insertform)"  value="删除价格表和库存中所有未用材料"></td>
</tr>
</table>
</form>
</body>
...
function f_exp(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Jxc_clbmExpList.jsp";
	FormName.submit();
	return true;
}
...
function f_del(FormName)//参数FormName:Form的名称
{
	...
	FormName.target="_blank";
	FormName.action="QrDeleteWyJxc_clbm.jsp";
	FormName.submit();
	return true;
}
//-->
