...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT jxc_tzcljgjl.clbm,DECODE(jxc_tzcljgjl.xgzt,'N','未改','Y','已修改'),TO_CHAR(jxc_tzcljgjl.sxsj,'YYYY-MM-DD'),jxc_clbm.nbbm,jxc_clbm.clmc,jxc_clbm.gg,jxc_clbm.jldwbm,jxc_tzcljgjl.cbj,jxc_tzcljgjl.dfgsjg,jxc_tzcljgjl.dgzjg, jxc_tzcljgjl.xgsj,dm_dqbm.dqmc,TO_CHAR(jxc_tzcljgjl.lrsj,'YYYY-MM-DD'),jxc_tzcljgjl.lrr,dwmc  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_tzcljgjlCxList.jsp","","","");
...
<CENTER >
  <B><font size="3">预先调整价格－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
