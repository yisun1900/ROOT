...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT dqmc,DECODE(jxc_cljgb.xsfs,'1','代销品','2','现货','3','期货销售','4','虚拟出入库') xsfs,DECODE(jxc_cljgb.sfyh,'Y','有货','N','无货') sfyh,DECODE(jxc_cljgb.sfcy,'Y','常用','N','否') sfcy,jxc_clbm.clbm,clxlbm,nbbm,clmc,xh,gg,jldwbm,TO_CHAR(jxc_cljgb.cbj),TO_CHAR(jxc_cljgb.jqpjcbj),TO_CHAR(jxc_cljgb.dfgsjg),TO_CHAR(jxc_cljgb.dgzjg),jxc_cljgb.zcpzsl,jxc_cljgb.dgzjg*jxc_cljgb.zcpzsl zcpje,jxc_cljgb.ccpzsl,jxc_cljgb.bfpzsl,jxc_cljgb.dhsl,jxc_cljgb.ycgsl,jxc_cljgb.gysmc,bzjldwbm,bzgg,djzl,cgzq,bzq,bztxq,cldlbm,ppmc,DECODE(cglb,'J','集团','D','地方'),jxc_clbm.bz ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_cljgbCbjList.jsp?dqbm="+dqbm,"","","EditCbjJxc_cljgb.jsp?dqbm="+dqbm);
