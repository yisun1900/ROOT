...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_cljgbJtJgList.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"批量调价"};//按钮的显示名称
	String[] buttonLink={"EnterPlJg.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">集团调价格－－－把各公司的价格统一调整</font></B>
</CENTER>
<%
	pageObj.out=out;
