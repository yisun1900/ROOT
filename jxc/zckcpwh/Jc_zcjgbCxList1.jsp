...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT ppmc,jc_zcjgb.clmc,jc_zcjgb.xh,cllbbm,jc_zcjgb.gg,jc_zcjgb.clbm,clysbm,jldwbm,jc_zcjgb.lsj,jc_zcjgb.xsj,cxhdbl||'%',DECODE(sfycx,'N','无','Y','<font color=\"#FF0000\">有促销</font>'),cxkssj,cxjzsj,cxj,lscxhdbl||'%',DECODE(jc_zcjgb.sfbhpj,'Y','<font color=\"#FF0000\">含</font>','N','不含'),jc_zcjgb.pjts,DECODE(sfyh,'Y','有货','N','<font color=\"#FF0000\">无货</font>'),jc_zcjgb.cpjb,jc_zcjgb.fgsx,jc_zcjgb.cpsm,jc_zcjgb.cd,jc_zcjgb.zp,jc_zcjgb.lrr,jc_zcjgb.lrsj,jc_zcjgb.bz,ppmc,gysmc,clxlbm,cldlbm";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jc_zcjgbCxList.jsp","SelectCxJc_zcjgb.jsp","","");
