...
try {
	...
	ls_sql="SELECT jxc_clbm.ppmc,jxc_clbm.cldlbm,jxc_clbm.clxlbm,jxc_clbm.cllbbm,jxc_clbm.clbm,jxc_clbm.nbbm,jxc_clbm.clmc,jxc_clbm.xh,jxc_clbm.gg,jxc_clbm.clysbm,jxc_clbm.jldwbm,jxc_clbm.bzjldwbm,jxc_clbm.bzgg,jxc_clbm.cgzq,jxc_clbm.djzl,jxc_clbm.bzq,jxc_clbm.bztxq,jxc_clbm.clcd,jxc_clbm.clkd,jxc_clbm.clgd,jxc_cljgb.lsj,jxc_cljgb.xsj,jxc_cljgb.zdxsj,jxc_cljgb.yjjrbl,DECODE(jxc_cljgb.jsfs,'1','结算价','2','结算比例') jsfs,jxc_cljgb.cbj,jxc_cljgb.jsbl,jxc_cljgb.cxhdbl,DECODE(jxc_cljgb.sfycx,'N','否','Y','是'),jxc_cljgb.cxkssj,jxc_cljgb.cxjzsj,jxc_cljgb.cxj,jxc_cljgb.cxcbj,jxc_cljgb.cxjsbl,jxc_cljgb.lscxhdbl,jxc_cljgb.cxyjjrbl,DECODE(jxc_clbm.sfbhpj,'Y','是','N','否'),jxc_clbm.pjts,DECODE(jxc_cljgb.sfyh,'Y','是','N','否'),jxc_clbm.cpjb,jxc_clbm.fgsx,jxc_clbm.cpsm,jxc_clbm.cd,DECODE(jxc_cljgb.sftjcp,'Y','是','N','否'),DECODE(jxc_cljgb.xsfs,'1','代销品','2','现货销售','3','期货销售','4','虚拟出入库'),jxc_clbm.zp,jxc_clbm.bz,jxc_cljgb.zdkcsl,jxc_cljgb.zdkcje,DECODE(jxc_clbm.cglb,'J','集团采购','D','地方采购') cglb";
	...
	String[] title={"子品牌","材料大类","材料小类","类别系列","主材编码","内部编码","主材名称","型号","规格","颜色","计量单位","包装计量单位","包装规格","单件重量（KG）","长度(cm)","宽度(cm)","高度(cm)","采购周期（天）","保质期（天）","保质提醒期（天）","市场标价","销售价","最低销售限价","业绩记入比例","结算方式","结算价","结算比例","计入活动比例","是否有促销","促销开始时间","促销结束时间","促销价","促销结算价","促销结算比例","促销期计入活动比例","促销期业绩记入比例","包含配件","配件套数","是否有货","产品级别","风格属性","产品说明","产地","是否推荐产品","销售方式 ","照片名称","备注","最低库存数量","最低库存金额","采购类别"};
