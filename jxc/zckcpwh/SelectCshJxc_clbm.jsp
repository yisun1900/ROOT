...
<tr align="center"> 
  <td colspan="4"> 
    <input type="button"  value="查询全部材料" onClick="f_do1(insertform)">
    <input type="button" onClick="f_do2(insertform)"  value="查询未初始化材料">
    <input type="button" onClick="f_do3(insertform)"  value="查询地区未初始化材料">
