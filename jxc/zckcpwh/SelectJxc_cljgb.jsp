...
<tr align="center"> 
  <td colspan="4"> 
    <p>
      ...
      <input name="button2" type="button" onClick="f_do2(insertform)"  value="查询无价格材料">
      <input name="button" type="button" onClick="f_do1(insertform)"  value="全部未初始化材料">
      <input type="reset"  value="重输">  
      </p>
    <p>
      <input name="button32" type="button" onClick="f_dc(insertform)"  value="导出价格">
      <input name="button3" type="button" onClick="f_dr(insertform)"  value="导入价格">
      <BR>
      <BR> 
      <A HREF="维护地区材料价格.xls"><B>点击右键另存为，下载Excel报价模板</B></A>    </p></td>
</tr>
</table>
</form>
</body>
