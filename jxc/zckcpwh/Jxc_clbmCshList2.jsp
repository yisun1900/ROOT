...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and jxc_clbm.clbm not in(select clbm from jxc_cljgb where xsfs in('2','3'))";
    ls_sql+=wheresql;
    ls_sql+=" order by cldlbm,clxlbm,clmc,jxc_clbm.clbm";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Jxc_clbmCshList2.jsp","","","");
...
//设置按钮参数
	String[] buttonName={"地区材料初始化","删除材料"};//按钮的显示名称
	String[] buttonLink={"ChooseDqbmCsh1.jsp","DeleteClbm.jsp"};//按钮单击调用的网页，可以增加参数
