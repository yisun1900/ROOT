...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Jxc_clbmWhList.jsp?dqbm="+dqbm,"","","");
...
//设置按钮参数
	String[] buttonName={"删除地区材料","增加地区(含价格)","增加地区(不含价格)"};//按钮的显示名称
	String[] buttonLink={"DeleteDqJxc_clbm.jsp?dqbm="+dqbm,"ChooseDqbm.jsp?dqbm="+dqbm,"ChooseDqbm1.jsp?dqbm="+dqbm};//按钮单击调用的网页，可以增加参数
