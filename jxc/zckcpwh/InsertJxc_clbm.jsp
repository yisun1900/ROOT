...
<form method="post" action="" name="insertform" target="_blank">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF">
              <td width="18%" rowspan="3" align="right"><font color="#FF0000">*</font><font color="#0000CC">所属地区</font></td>
              <td width="32%" rowspan="3"> 
                <select name="dqbm" size="8" multiple style="FONT-SIZE:12PX;WIDTH:152PX" >
                  <%
...
%> 
              ...
              <td><%
	cf.radioToken(out, "xsfs","2+现货销售&3+期货销售","3");
%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="djzl" value="" size="20" maxlength="100" >
                KG</td>
              <td align="right"><font color="#FF0000">*</font>包装计量单位</td>
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="bzq" value="" size="10" maxlength="10" >
                天</td>
              <td align="right">保质期提醒</td>
              <td><input type="text" name="bztxq" value="" size="10" maxlength="10" >
                天 </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">采购周期</td>
              <td><input type="text" name="cgzq" value="" size="10" maxlength="10" >
                天</td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
...
%></td>
            ...
            <tr bgcolor="#CCCCFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="jsbl" value="0" size="12" maxlength="8" >
                % <font color="#0000CC">（百分比）</font></td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
...
有促销 </td>
            ...
            <tr bgcolor="#E8E8FF"> 
              ...
              <td><input type="text" name="cxjsbl" value="" size="10" maxlength="9" >
                % <font color="#0000CC">（百分比）</font></td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right">促销期计入活动比例</td>
              <td><input type="text" name="lscxhdbl" value="" size="10" maxlength="9" >
                % <font color="#0000CC">（百分比）</font> </td>
              <td align="right"><font color="#FF0000">*</font>促销期业绩记入比例</td>
              <td><input name="cxyjjrbl" type="text" value="" size="10" maxlength="9" >
                % <font color="#0000CC">（百分比）</font></td>
            </tr>
...
无货 </td>
            ...
            <tr bgcolor="#CCCCFF">
              <td align="right"><font color="#FF0000">*</font>最低库存数量</td>
              <td><input type="text" name="zdkcsl" value="0" size="20" maxlength="16" >              </td>
              <td align="right"><font color="#FF0000">*</font>最低库存金额</td>
              <td><input type="text" name="zdkcje" value="0" size="20" maxlength="16" ></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
function changeXl(FormName)
{
	...
	var sql;
	sql="select distinct jxc_ppxx.ppmc from jxc_ppxx where  jxc_ppxx.cldl='"+FormName.cldlbm.value+"' order by jxc_ppxx.ppmc";
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.zdkcsl, "最低库存数量"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.zdkcje, "最低库存金额"))) {
		return false;
	}
