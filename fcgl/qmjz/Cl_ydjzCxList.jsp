...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		dwbh=cf.GB2Uni(dwbh);
		if (!(dwbh.equals("")))	wheresql+=" and  (cl_ydjz.dwbh='"+dwbh+"')";
	}
	...
	ls_sql+=" FROM cl_ydjz,sq_dwxx ";
    ls_sql+=" where cl_ydjz.dwbh=sq_dwxx.dwbh ";
    ls_sql+=wheresql;
    ls_sql+=" order by jzrq desc,jzph";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_ydjzCxList.jsp","SelectCxCl_ydjz.jsp","","");
...
//设置列超级连接
	...
	coluParm.link="ViewCl_ydjz.jsp";//为列参数：coluParm.link设置超级链接
