    ...
    <tr> 
      <td colspan="4" > 
        <div align="center"> 
          ...
          <input type="button"  value="查看明细" onClick="f_ck(editform)" name="ck" disabled>
          <input type="button"  value="选择材料" onClick="f_lr(editform)" name="lr" disabled>
          <input type="button"  value="修改" onClick="f_xg(editform)" name="xg" disabled >
          <input type="button"  value=" 提 交 " onClick="f_tj(editform)" name="tj" disabled>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditWtgCl_djj.jsp";
	FormName.submit();
