...
<body bgcolor="#FFFFFF">
<form method="post" action="Cl_djjJmejshList.jsp" name="selectform">
<div align="center">减免二级审核</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="35%">
        <input type="radio" name="cl_djj_shzt" value="2" checked>
        一级审核
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="35%">
        <input type="radio" name="shjl" value="1" checked>
        同意</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
