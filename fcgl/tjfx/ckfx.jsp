...
%> 
	   ...
	   <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">施工队</td>
      <td width="34%"> 
		...
		<% 
			if (yhjs.equals("A0")||yhjs.equals("A1"))
			{
				...
				out.println(" <option value=\"\"></option>");
				cf.selectItem(out,"select sgd,sgdmc||'（'||dh||'）'||'（'||kjdsm||'）' sgdmc from sq_sgd order by sgdmc ","");
			}
			else
			{
				out.println(" <option value=\"\"></option>");
				cf.selectItem(out,"select sgd,sgdmc||'（'||dh||'）'||'（'||kjdsm||'）' sgdmc from sq_sgd where ssfgs='"+ssfgs+"' order by sgdmc","");
			}
%> 
        </select>
      </td>
      ...
      <td width="34%"> 
        <input type="text" name="hth" size="20" maxlength="100" >
      </td>
    </tr>
    <tr align="center"> 
      <td colspan="4"> 
