...
<form method="post" action="Cl_clbmCxList.jsp" name="selectform">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right" width="16%">入库时间 从</td>
      <td width="34%">
        <input type="text" name="rksj" size="20" maxlength="10" value="<%=cf.firstDay()%>">
      </td>
      <td align="right" width="16%">到</td>
      <td width="34%">
        <input type="text" name="rksj2" size="20" maxlength="10" value="<%=cf.lastDay()%>">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
