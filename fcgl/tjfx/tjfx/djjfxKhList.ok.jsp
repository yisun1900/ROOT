...
%>
<table width="<%=(140+dlsl*100+120)%>" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2" align="center">
	<tr bgcolor="CCCCCC" align="center"> 
		<td width="40"><B>序号</b></td>
		<td width="100"><B>客户</b></td>
<%
		//获取标题名称
...
<%
	...
	//取客户
	ls_sql="select distinct cl_djj.khbh,khxm  ";
	ls_sql+=" from cl_djj,crm_khxx  ";
	ls_sql+=" where cl_djj.khbh=crm_khxx.khbh and cl_djj.dwbh='"+ssfgs+"'  ";
	...
	while (rs2.next())
	{
		...
		while (rs.next())
		{
			...
			double djjsl=0;
			double djjje=0;
			ls_sql="select nvl(sum(cl_djjmx.sjsl),0),nvl(sum(cl_djjmx.sjje),0)  ";
