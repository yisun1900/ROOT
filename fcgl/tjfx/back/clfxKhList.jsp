...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="select '',crm_khxx.khbh khbh,crm_khxx.hth hth,crm_khxx.khxm khxm,crm_khxx.qye qye,sq_sgd.sgdmc sgdmc,crm_khxx.khjsje,cl_djjflmx.cldlmc,cl_djjflmx.ylqje,cl_djjflmx.sjje,cl_djjflmx.jmyy,cl_djjflmx.ylqje-cl_djjflmx.sjje jmje";
...
<tr bgcolor="CCCCCC" align="center"> 
	...
	<td width="6%"><B>客户编号</b></td>
	<td width="6%"><B>合同号</b></td>
	<td width="6%"><B>客户姓名</b></td>
	<td width="7%"><B>工程签约额</b></td>
	<td width="8%"><B>施工队（项目经理）</b></td>
	<td width="7%"><B>结算金额</b></td>
	<td width="9%"><B>材料大类</b></td>
	<td width="8%"><B>应领取金额</b></td>
	<td width="8%"><B>实际金额</b></td>
	<td width="18%"><B>减免原因</b></td>
