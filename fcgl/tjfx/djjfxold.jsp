...
%> 
    ...
    <tr align="center"> 
      <td colspan="4"> 
        <input type="button"  value="材料用量总计" onClick="f_do(selectform,'zj')" name="button3">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if (lx=='yl')
	{
		FormName.action="djjfxYlListold.jsp";
	}
	else if (lx=='kh')
	{
		...
		FormName.action="djjfxKhListold.jsp";
	}
	else 
	{
		FormName.action="djjfxYlTjListold.jsp";
	}
