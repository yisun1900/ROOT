...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_clsgdList.jsp","SelectCl_clsgd.jsp","ViewCl_clsgd.jsp","EditCl_clsgd.jsp");
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from cl_clsgd,cl_clsgmx where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="7%">录入时间</td>
	<td  width="7%">总部审核人</td>
	<td  width="7%">总部审核时间</td>
	<td  width="7%">供应商下单人</td>
	<td  width="7%">供应商下单时间</td>
	<td  width="7%">备注</td>
</tr>
<%
	pageObj.displayDate();
