  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        利润计算方式      </td>
      <td width="32%"> 
        <select name="lrjsfs" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="lrbfb.value=''">
          <%
	cf.selectToken(out,"1+差价方式&2+百分比方式",lrjsfs);
%> 
        </select>		</td>
      <td width="18%" align="right"> 
        利润百分比      </td>
      <td width="32%"> 
        <input type="text" name="lrbfb" value="<%=lrbfb%>" size="20" maxlength="10">
      % </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
<%
	...
	{
		%>
        <input type="text" name="wxr" value="<%=wxr%>" size="20" maxlength="20">
		<%
	}
	else{
		%>
        <input type="text" name="wxr" value="<%=wxr%>" size="20" maxlength="20" readonly>
		<%
	}
%>      </td>
