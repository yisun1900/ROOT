...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT '申购' sg,cl_clbm.clbm clbm,clmc,clgg,cl_clbm.cldlmc||'（'||qybfb||'%)',jldwmc,fgsdj,bz ";
	ls_sql+=" FROM cl_clbm,cl_jgmx,cl_cldlbm  ";
    ls_sql+=" where cl_clbm.clbm=cl_jgmx.clbm(+) and cl_clbm.cldlmc=cl_cldlbm.cldlmc(+)";
...
//设置列超级连接
	...
	coluParm.link="Cl_clbmmx.jsp?sgph="+sgph+"&dwbh="+dwbh;//为列参数：coluParm.link设置超级链接
