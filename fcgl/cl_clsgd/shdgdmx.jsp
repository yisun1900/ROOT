...
try {
	...
	ls_sql="SELECT sgph,cl_clsgmx.clbm clbm,cl_clsgmx.clmc,cl_clsgmx.clgg,sgsl,cl_clsgmx.cldlmc,jldwmc,fgsdj ";
...
%> 
    <tr bgcolor="<%if (i%2==0){out.print(bg1);}else {out.print(bg2);}%>" align="center"> 
     ...
     <td > 
        <input type="text" name="shsl" size="10" maxlength="13" value=<%=sgsl%> style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" onKeyUp="keyGo(shsl[<%=(row+1)%>])" >
      </td>
    </tr>
    <%
	row++;
...
//		alert(FormName.shsl.value+">>>>"+m+">>>>>"+len);
	...
	FormName.action="saveshdgdmx.jsp";
	FormName.submit();
	return true;
} 
function cf_submit(FormName)
{
	FormName.action="shdgdbtg.jsp";
	FormName.submit();
	return true;
} 
//-->
