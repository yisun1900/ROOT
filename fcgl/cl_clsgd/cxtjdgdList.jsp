...
String dwbh2=(String)session.getAttribute("ssfgs");
...
//	out.print(ls_sql);
//进行对象初始化
	pageObj.initPage("cxtjdgdList.jsp","SelectCxtjdgb.jsp","","");
...
//设置按钮参数
	...
	String[] buttonLink={"cxtjdgdList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]=" update cl_clsgd set sgzt='1' where "+chooseitem;
