...
<tr bgcolor="<%if (i%2==0){out.print(bg1);}else {out.print(bg2);}%>">
	 ...
	 <td><div align="center"><A HREF="#" onClick="window.open('Delsgmx.jsp?sgph=<%=sgph%>&clbm=<%=clbm%>')" target="_back">删除</A></div></td>
	<td><div align="center"><input type="text" name="sgph" size="10" maxlength="13" value="<%=sgph%>" class=xian readonly></div>
	</td>
    <td>
	<div align="center"><input type="text" name="clbm" size="10" maxlength="13" value="<%=clbm%>" class=xian readonly></div>
	</td>
    <td>
	<div align="center"><input type="text" name="sgsl" size="6" maxlength="8" value="<%=sgsl%>" onkeyup="keyGo(sgsl[<%=i%>])"></div>
	</td>    
