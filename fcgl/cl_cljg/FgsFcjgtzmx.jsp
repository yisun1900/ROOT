...
<form method="post" action="SaveFgsFcjgtzmx.jsp" name="selectform" target="_back">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2" align="center">
    ...
    <tr bgcolor="<%if (i%2==0){out.print(bg1);}else {out.print(bg2);}%>"> 
      ...
      <td > 
        <input type="text" name="ckmc" size="21" maxlength="50" value="<%=ckmc2%>" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" onKeyUp="keyGo(gdj[<%=i%>])">
           <input type="hidden" name="sfrk" value="<%=sfrk2%>">
     </td>
    </tr>
    <%
	}
