...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cl_psd.psdh,DECODE(cl_psd.lx,'1','配货','2','退货') lx,DECODE(cl_psd.pszt,'1','未提交','2','已提交','3','已配送') pszt,DECODE(cl_psd.psfs,'1','配送','2','自提','9','其它'),cl_psd.jhshsj,dwmc,cl_psd.khbh,crm_khxx.khxm,crm_khxx.hth,sq_sgd.sgdmc,cl_psd.pszsl,cl_psd.pszje,cl_psd.fkje,cl_psd.lrr,cl_psd.lrsj,cl_psd.bz ";
