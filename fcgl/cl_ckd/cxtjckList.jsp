...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cl_ckd.ckph,DECODE(cl_ckd.lx,'1','出库','2','退货') lx,DECODE(cl_ckd.ckzt,'1','未提交','2','已提交') ckzt,cl_ckd.psdh,cl_ckd.yf,cl_ckd.qtsf,dwmc,cl_ckd.khbh khbh,khxm,crm_khxx.hth,sq_sgd.sgdmc,cl_ckd.ckzsl,cl_ckd.ckzje,cl_ckd.ckr,cl_ckd.cksj,cl_ckd.lrr,cl_ckd.lrsj,cl_ckd.bz ";
