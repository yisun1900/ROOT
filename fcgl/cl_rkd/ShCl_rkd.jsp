...
try { 
	...
	ls_sql=" select dwbh,gysmc,rkr,rksj,lrr,lrsj,cl_rkd.bz,sgph,DECODE(rklx,'1','新货','2','退货') rklx,sgdmc";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">入库审核(入库批号:<%=rkph%>)</div> 
    </td>
  </tr>
  <tr>
	<td width="100%" > 
...
%></td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td> 
                <input type="text" name="shr" size="20" maxlength="13" value="<%=yhmc%>" readonly>
              </td>
              <td width="15%" bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <textarea name="shyj" cols="71" rows="3"></textarea>
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShCl_rkd.jsp";
	FormName.submit();
	return true;
}
