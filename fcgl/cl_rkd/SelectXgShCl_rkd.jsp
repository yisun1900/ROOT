...
<body bgcolor="#FFFFFF">
<form method="post" action="Cl_rkdXgShList.jsp" name="selectform">
<div align="center">修改审核</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
	<tr bgcolor="#FFFFFF">
	<td align="right" width="15%">入库批号</td>
      <td width="35%"> <input type="text" name="rkph" size="20" maxlength="11" > 
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><input type="text" name="rksj" size="20" maxlength="10" ></td>
      <td align="right">到</td>
      <td><input type="text" name="rksj2" size="20" maxlength="10" ></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="15%">入库总数量 从</td>
      <td width="35%"> <input type="text" name="rkzsl" size="20" maxlength="17" > 
        <BR> </td>
      <td align="right" width="15%">到</td>
      <td width="35%"> 
        <input type="text" name="rkzsl2" size="20" maxlength="17" > </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right">入库总金额 从</td>
      <td><input type="text" name="rkzje" size="20" maxlength="17" ></td>
      <td align="right">到 </td>
      <td><input type="text" name="rkzje2" size="20" maxlength="17" ></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="15%">录入时间 从</td>
      <td width="35%"><input type="text" name="lrsj" size="20" maxlength="10" > 
      </td>
      <td align="right" width="15%">到</td>
      <td width="35%"> 
	 ...
	 <tr bgcolor="#FFFFFF"> 
      ...
      <td width="35%"> 
        <input type="text" name="rkr" size="20" maxlength="20" ></td>
    </tr>
    <tr align="center"> 
