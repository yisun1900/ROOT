...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rkph,dwmc,gysmc,rkr,rksj,rkzsl,rkzje,DECODE(rkzt,'1','未提交','2','已提交'),sgph,lrr,lrsj,cl_rkd.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("cxtjrkList.jsp","SelectCxtjrk.jsp","","");
...
//设置按钮参数
	String[] buttonName={"撤销提交入库单"};//按钮的显示名称
	String[] buttonLink={"cxtjrkd.jsp"};//按钮单击调用的网页，可以增加参数
