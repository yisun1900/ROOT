...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rownum,cl_clsgd.sgph,dwmc,cl_clsgd.sgzsl,cl_clsgd.shzsl,DECODE(sgzt,'1','未提交','2','已提交','3','总部审核','4','供应商下单'),cl_clsgd.lrr,cl_clsgd.lrsj,cl_clsgd.zbshr,cl_clsgd.zbshsj,cl_clsgd.gysxdr,cl_clsgd.gysxdsj,cl_clsgd.bz  ";
...
//设置列超级连接
	...
	coluParm.link="Cl_clsgmxCxList.jsp?";//为列参数：coluParm.link设置超级链接
