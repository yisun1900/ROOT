...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and (crm_khxx.jzkfkcs!=9 OR crm_khxx.jzkfkcs is null)";//9:尾款全收
	...
	//Sytem.out.println(ls_sql);
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化

	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","","OrderZtList.jsp");
	pageObj.setPageRow(25);//设置每页显示记录数
	pageObj.setEditStr("跟踪");
	pageObj.setEditBolt("");
/*
//设置显示列
...
//设置列超级连接
	...
	coluParm.link="/boloniJK/OrderItemList.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
