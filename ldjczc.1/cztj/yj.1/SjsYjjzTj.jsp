...
<TR bgcolor="#CCCCCC"  align="center"  > 
  ...
  <td  width="4%" ><font color="#FF0000">合同业绩净值<BR>(签单－退单)</font></td>
  <td  width="4%" ><font color="#FF0000">最新业绩净值<BR>(签单－退单)</font></td>
  <td  width="3%" >签约数</td>
  <td  width="3%" >签单合同业绩净值</td>
  <td  width="3%" >签单最新业绩净值</td>
  <td  width="4%" >折前－合同额</td>
  <td  width="3%" >综合折扣</td>
  <td  width="4%" >折后－合同额</td>

  <td  width="2%" ><font color="#0000FF">退单客户数</font></td>
  <td  width="3%" >退单合同业绩净值</td>
  <td  width="3%" >退单最新业绩净值</td>
  <td  width="4%" ><font color="#0000FF">退单合同金额</font></td>
...
<%
		...
		if (sjs.equals(""))
		{
			...
			ls_sql+=" SELECT yhmc sjs,dwmc,sq_yhxx.dwbh,0 qys,0 yjjz,0 zxyjjz,0 wdzgce,0 qye,0 zhljzjx,0 zqgczjf,0 zhgczjf,0 zqsuijin,0 suijin,0 zqguanlif,0 guanlif  ,0 zqqtsf,0 zhqtsf ,0 zqwjrqyexm,0 zhwjrqyexm ,0 zqsjf,0 sjf    ,0 fwmj";
		...
		while (rs.next())
		{
			...
			<tr align="center"  bgcolor="<%=bgcolor%>" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
				...
				<td >
					...
					<A HREF="ViewSjsYjjzMx.jsp?sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>&sjs=<%=getsjs%>&dwbh=<%=getdwbh%>" target="_blank">
					<%=getsjs%>
					</A>
				</td>
				<td ><%=dwmc%></td>
