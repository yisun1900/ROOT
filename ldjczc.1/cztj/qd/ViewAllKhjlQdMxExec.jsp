...
try {
	...
	for (int i=0;i<khjl.length ;i++ )
	{
		...
		khjl[i]=cf.GB2Uni(khjl[i]);
		int pos=khjl[i].indexOf("+");
		lskhjl=khjl[i].substring(0,pos);
		lsdwbh=khjl[i].substring(pos+1);
		...
		ls_sql+=" and crm_khxx.khjl='"+lskhjl+"' and crm_khxx.dwbh='"+lsdwbh+"'";
...
//		out.println(ls_sql);
		...
		<tr bgcolor="#E8E8FF"  align="center" height="25">
			<td align="center" colspan="3"><B>[<%=lskhjl%>]小 计</B></td>
			<td >&nbsp;</td>
			<td >&nbsp;</td>
			<td >&nbsp;</td>
			<td >&nbsp;</td>
