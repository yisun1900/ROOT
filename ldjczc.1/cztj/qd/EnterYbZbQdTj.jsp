  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">店面签单统计</div>      </td>
    </tr>
    ...
    <tr> 
      ...
      <td height="43" colspan="3" width="70%"> 从 
        <input type="text" name="sjfw" size="11" maxlength="10" value='' onDblClick="JSCalendar(this)">
        ---->到 
        <input type="text" name="sjfw2" size="11" maxlength="10"  value='' onDblClick="JSCalendar(this)">      </td>
    </tr>
    ...
    <tr align="center"> 
      <td height="71" colspan="4"> 
        <p>
          <input type="button"  value="月报" onClick="f_yb(selectform)"  name="yb" >
          <input type="button"  value="周报" onClick="f_zb(selectform)"  name="zb" >
...
function f_yb(FormName)//参数FormName:Form的名称
{
...
function f_zb(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.sjfw)=="") {
		alert("请输入[签约时间 ]！");
		FormName.sjfw.focus();
