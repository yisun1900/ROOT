...
<%
	...
	ls_sql="SELECT '',jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),jc_zczjx.ppbm,jc_zczjx.qrsj,jc_zczjx.zqzjxze,jc_zczjx.zjxze,jc_zczjx.jzsjs,jc_zczjx.ddbh,crm_khxx.khxm,crm_khxx.fwdz,TO_CHAR(jc_zczjx.zjxzkl) zjxzkl,jc_zczjx.zjxcxhdje,jc_zczjx.ztjjgw,jc_zczjx.xmzy,jc_zczjx.zjxfssj,zczjxyymc,DECODE(jc_zczjx.sfjs,'N','未结算','C','已选择结算','Y','已结算','M','结算已审核'),jc_zczjx.jissj,jc_zczjx.jisr,jc_zczjx.lrsj,DECODE(jc_zczjx.sfjrht,'Y','计入','N','不计入') sfjrht,crm_khxx.khbh,jc_zczjx.gys,jc_zczjx.bz";
