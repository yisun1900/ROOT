...
<%
	...
	ls_sql="SELECT '',jc_zcdd.ddbh,clztmc,DECODE(jc_zcdd.ddlx,'1','代销品','3','补录合同','4','有库存订单','5','标准套餐','6','家具健康套餐','7','温暖静音套餐','8','窗帘套餐','9','代购主材','A','顶配升级','B','顶配独立收费','C','选配主材','D','套餐外主材'),ppbm,jc_zcdd.cbze,jc_zcdd.hkze,jc_zcdd.ddqrsj,jc_zcdd.tdsj,crm_khxx.khxm,crm_khxx.fwdz,jc_zcdd.clgw,zcdlbm,gys,DECODE(jc_zcdd.sfjrht,'Y','计入','N','不计入') sfjrht,ysgcjdmc,cxhdbm,crm_khxx.sjs,c.dwmc dm,jc_zcdd.ztjjgw,jc_zcdd.xmzy,TO_CHAR(jc_zcdd.zczkl) zczkl,jc_zcdd.zsje,jc_zcdd.zjxzsje,jc_zcdd.zqclf,jc_zcdd.zhclf,jc_zcdd.ycf,jc_zcdd.qtycf,jc_zcdd.qtf,jc_zcdd.htcxhdje,jc_zcdd.zjxcbze,jc_zcdd.zjhze,jc_zcdd.zqzjxclf,jc_zcdd.zhzjxclf,jc_zcdd.zjxycf,jc_zcdd.zjxqtf,jc_zcdd.zjxcxhdje,jc_zcdd.cbze+jc_zcdd.zjxcbze,jc_zcdd.hkze+jc_zcdd.zjhze,jc_zcdd.zqclf+jc_zcdd.zqzjxclf,jc_zcdd.zhclf+jc_zcdd.zhzjxclf,jc_zcdd.ycf+jc_zcdd.zjxycf,jc_zcdd.qtf+jc_zcdd.zjxqtf,jc_zcdd.htcxhdje+jc_zcdd.zjxcxhdje,jc_zcdd.qhtsj,jc_zcdd.wjsj,jc_zcdd.lrsj,jc_zcdd.khbh,jc_zcdd.jssj,jc_zcdd.bz";
	...
	ls_sql+=" and jc_zcdd.clzt>='11' and jc_zcdd.clzt!='98'";
...
<CENTER >
  <B><font size="3">材料员主材签单明细（<%=clgw%>）
  <BR>(订单确认时间：<%=sjfw%>--<%=sjfw2%>)</font></b>
</CENTER>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">订单类型</td>
	<td  width="2%">子品牌</td>
	<td  width="2%" bgcolor="#99FFFF"><strong>合同成本额</strong></td>
	...
	<td  width="2%"><strong>增减项成本额</strong></td>
	...
	<td  width="2%" bgcolor="#FFFFCC"><strong>全部成本额</strong></td>
