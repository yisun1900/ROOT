...
<%
	...
	ls_sql+=" order by jc_zcdd.ddqrsj";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%" bgcolor="#99FFFF"><strong>正常品材料费</strong></td>
	<td  width="2%" bgcolor="#99FFFF"><strong>特价品材料费</strong></td>
