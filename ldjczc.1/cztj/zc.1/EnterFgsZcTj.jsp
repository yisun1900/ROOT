  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">分公司主材统计</div>      </td>
    </tr>
    ...
    <tr> 
      <td align="right" width="30%" height="43">签合同时间</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.sjfw, "签合同时间 "))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.sjfw2, "签合同时间 "))) {
		return false;
	}

	FormName.action="FgsZcTj.jsp";
	FormName.target="";
	FormName.submit();
