...
<form method="post" action="" name="selectform">
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    ...
    <tr> 
      <td align="right" width="30%" height="44">施工队</td>
      <td height="44" colspan="3" width="70%"> 
		<select name="sgd" style="FONT-SIZE:12PX;WIDTH:152PX"  >
		  <%
			...
			{
				cf.selectItem(out,"select sgd,sgdmc from sq_sgd where cxbz='N' and ssfgs in(select ssfgs from sq_sqbm where ygbh='"+ygbh+"') order by sgdmc ","");
			}
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.sjfw, "记入业绩时间 "))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.sjfw2, "记入业绩时间 "))) {
		return false;
	}

	FormName.action="RgfTj.jsp";
	FormName.target="";
	FormName.submit();
