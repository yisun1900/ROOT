...
<%
	...
	ls_sql="SELECT '',sjs,khbh,khxm,fwdz,khjl,hth,sjhtje,qsjhtsj,fwmj,DECODE(sjfbz,'N','未交设计费','Y','已交费','T','退设计费'),sjf,jsjfsj,lrsj,sczbjsj,zjsmsj,smcs";
