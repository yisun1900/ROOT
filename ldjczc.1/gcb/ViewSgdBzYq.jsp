...
%>
<div align="center"><br><b>[<%=getsgbz%>]当月延期（<%=sjfw%>－－<%=sjfw2%>）</b></div>
...
String ys4=null;
	...
	int row=0;
	ls_sql="select crm_khxx.khbh,hdlxmc,khlxmc,hth,khxm,lxfs,fwdz,sjs,zjxm,sgdmc sgd,qyrq,pdsj,kgrq,sjkgrq,sybgcrq,szqsj,jgrq,crm_khxx.gcjdbm,ysgcjdmc,pdclzt,sjjgrq,hzts,jgrq-kgrq htgq,jgrq+NVL(hzts,0) yjgrq,zqgczjf,crm_tckhqye.tcsgze";
