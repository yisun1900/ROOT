...
<%			
		String 	tspp=null;	
		String 	clzt=null;	
		ls_sql=" SELECT crm_tspp.tspp,dwmc,tsyymc,tsxlmc,hfjgmc,DECODE(crm_tsbm.clzt,'0','未通知','1','已通知未处理','2','在处理','3','已解决') clzt,clqk,lrsj,lrr  ";
		ls_sql+=" FROM crm_tsbm,sq_dwxx,dm_hfjgbm,dm_tsxlbm,dm_tsyybm,crm_tspp";
