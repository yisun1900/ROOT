...
<%
  ...
  <tr>
    <td> 
      <CENTER >
        <B>（集成家居报修：木门报修）报修率统计(<%=sjfw%>--<%=sjfw2%>)</B> 
      </CENTER>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
        <tr bgcolor="#CCCCCC"  align="center"> 
          ...
          <td  width="22%">报修客户（人）</td>
          <td  width="22%">报修 / 签单</td>
        </tr>
...
<%
  ...
  <tr>
    <td> 
      <CENTER >
        <B>（集成家居报修：橱柜报修）报修率统计(<%=sjfw%>--<%=sjfw2%>)</B> 
      </CENTER>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
        <tr bgcolor="#CCCCCC"  align="center"> 
          <td  width="12%">时间范围</td>
...
<%
  ...
  <tr>
    <td> 
      <CENTER >
        <B>（集成家居报修：家具报修）报修率统计(<%=sjfw%>--<%=sjfw2%>)</B> 
      </CENTER>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
        <tr bgcolor="#CCCCCC"  align="center"> 
          <td  width="12%">时间范围</td>
...
<%
  ...
  <tr>
    <td> 
      <CENTER >
        <B>（集成家居报修：外主材问题）报修率统计(<%=sjfw%>--<%=sjfw2%>)</B> 
      </CENTER>
      <table border="1" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 14px'>
        <tr bgcolor="#CCCCCC"  align="center"> 
          <td  width="13%">时间范围</td>
