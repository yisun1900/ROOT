  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">问题处理统计</div>      </td>
    </tr>
    <tr>
      <td align="right" height="39">分公司</td>
      <td width="31%" height="39"><select name="fgs" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeFgs(selectform)">
          <%
      ...
      <td width="33%"><select name="dwbh" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeDwbh(selectform)">
          <%
    ...
    <tr>
      ...
      <td height="39"><select name="sgd" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
        </select>      </td>
    </tr>
    <tr>
      <td align="right" height="39">问题解决部门</td>
      <td height="39"><select name="zrbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="changeZrbm(selectform)">
          <option value=""></option>
          <%
...
%>
      ...
      <td height="39" align="right">问题解决人</td>
      <td height="39"><select name="zrr" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
        </select>      </td>
    </tr>
    <tr>
      <td align="right" height="39">问题提出部门</td>
...
%>
      ...
      <td height="39" align="right">问题提出人</td>
      <td height="39"><select name="lrr" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
        </select>      </td>
    </tr>
    <tr>
      <td align="right" height="39">统计时间 从</td>
      <td height="39"><input type="text" name="sjfw" size="20" maxlength="10" value="<%=cf.yearStart()%>">      </td>
      <td height="39" align="right">到</td>
      <td height="39"><input type="text" name="sjfw2" size="20" maxlength="10"  value="<%=cf.lastDay()%>"></td>
    </tr>
    
    
    <tr>
      <td align="right" height="37">问题来源</td>
      <td height="37" colspan="3"><input name="tjfl" type="radio" value="1" checked>
      客户投诉
		<input type="radio" name="tjfl" value="2">客户报修
		<input type="radio" name="tjfl" value="3">
		工地巡查验收服务
		<input type="radio" name="tjfl" value="4">
		客户回访 </td>
    </tr>
...
function f_hz(FormName,lx)//参数FormName:Form的名称
{
	...
	{
		FormName.action="WtclTjTs.jsp";
	}
	else if (FormName.tjfl[1].checked)
	{
		FormName.action="WtclTjBx.jsp";
	}
	else if (FormName.tjfl[2].checked)
	{
		FormName.action="WtclTjXc.jsp";
	}
	else{
		FormName.action="WtclTjHf.jsp";
	}
