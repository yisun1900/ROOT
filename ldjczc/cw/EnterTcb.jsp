...
<form method="post" action="" name="selectform">
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    ...
    <tr>
      ...
      <td height="43" colspan="3"><select name="gdjsjd" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%>
    ...
    <tr>
      ...
      <td height="43" colspan="3"><input type="radio" name="khjsbz" value="Y">
        结算
        <input type="radio" name="khjsbz" value="N">
        未结算</td>
    </tr>
    <tr>
      <td align="right" height="43">客户编号 </td>
      <td height="43" colspan="3"><input type="text" name="khbh" size="20" maxlength="7"  ></td>
    </tr>
    <tr>
      <td align="right" height="43">客户姓名 </td>
      <td height="43" colspan="3"><input type="text" name="khxm" size="20" maxlength="20"  ></td>
    </tr>
    <tr> 
    ...
    <tr align="center"> 
      <td height="71" colspan="4"> 
          ...
          <input type="button"  value="重输"  onClick="tj.disabled=false;">		  </td>
    </tr>
  </table>
</form>
</body>
