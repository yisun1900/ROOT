...
<form method="post" action="Crm_khxxCxSxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3" > 
                ...
                EXCEL &nbsp;&nbsp;&nbsp;显示数量 
                <input type="text" name="myxssl" size="7" maxlength="13" value="2000">              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
%>
            ...
            <tr bgcolor="#E8E8FF">
              ...
              <td align="right" class="STYLE1">施工队结算标志</td>
...
%>
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td><input name="tdyjjzsj" type="text" id="tdyjjzsj" onDblClick="JSCalendar(this)" value="" size="20" maxlength="10">              </td>
              <td align="right">到</td>
