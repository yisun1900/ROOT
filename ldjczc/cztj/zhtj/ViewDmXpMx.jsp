...
<%
	...
	ls_sql+=" and jc_zcdd.ddlx in('C','D')";//1：代销品；4：有库存订单；5：标准套餐；9：代购主材、C:选配主材；D：套餐外主材；E：散客
	ls_sql+=" order by jc_zcdd.ddqrsj,jc_zcdd.ddbh";
