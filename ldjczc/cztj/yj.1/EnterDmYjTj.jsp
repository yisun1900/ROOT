  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">店面业绩统计</div>      </td>
    </tr>
    ...
    <tr> 
      <td align="right" width="30%" height="43">记入业绩时间</td>
    ...
    <tr align="center"> 
      <td height="71" colspan="4"> 
        <p>
          ...
          <input type="button"  value="导出明细" onClick="f_do1(selectform)"  name="tj2" >
...
function f_do1(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="DmYjTjList.jsp";
	FormName.target="";
	FormName.submit();
	FormName.tj2.disabled=true;
	return true;
}
