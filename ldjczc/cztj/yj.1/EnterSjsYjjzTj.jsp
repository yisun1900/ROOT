  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">设计师业绩净值统计</div>      </td>
    </tr>
    <tr> 
 ...
 %> </td>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="家装产值统计" onClick="f_tj(selectform)" name="tj">
        <input type="button"  value="家装产值明细" onClick="f_mx(selectform)" name="mx">
...
function f_mx(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="ViewAllSjsYjjz.jsp";
	FormName.submit();
