...
String zwbm=(String)session.getAttribute("zwbm");//08:家居顾问;10:项目专员;12:家居客户经理;18:木门测量师
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">客户经理业绩统计</div>      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align="right" width="42%" height="39">客户经理</td>
      <td width="58%" height="39"> <%
	if (zwbm.equals("03"))//03:客户经理
	{
		%> 
        <input type="text" name="khjl" maxlength="20" size="20" value="<%=yhmc%>" readonly>
        <%
	}
	else{
		%> 
        <input type="text" name="khjl" maxlength="20" size="20">
        <%
	}
 %> </td>
    </tr>
    <tr> 
      <td align="right" width="42%" height="39">记入业绩时间 从</td>
      <td width="58%" height="39"> 
