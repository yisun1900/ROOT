...
String ssfgs=request.getParameter("dwbh");
...
<%
	...
	int row=0;
	ls_sql =" SELECT distinct khbh,jc_zcdd.ddlx,jc_zcdd.ddqrsj,ddbh";
	ls_sql+=" FROM jc_zcdd";
	...
	ls_sql+=" and jc_zcdd.qddm='"+ssfgs+"' and jc_zcdd.jzsjs='"+sjs+"'";

	ls_sql+=" order by jc_zcdd.ddlx,jc_zcdd.ddqrsj,jc_zcdd.ddbh";
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		ls_sql+=" and cw_khfkjl.fgsbh='"+ssfgs+"'";
		ls_sql+=" and cw_khfkjl.sjs='"+sjs+"'";
