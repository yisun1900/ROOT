...
<%
	...
	ls_sql="SELECT '',sjs,hth,khxm,fwdz,DECODE(crm_khxx.jzbz,'1','家装','2','公装'),sgdmc,zjxm,cxhdbm,crm_khqye.yjjz,crm_khqye.zxyjjz,wdzgce,TO_CHAR(zkl),qye,zhljzjx,zqgczjf,zhgczjf,suijinbfb||'%',zqsuijin,suijin,glfbfb||'%',zqguanlif,guanlif,zqqtsf,zhqtsf,zqwjrqyexm,zhwjrqyexm,NVL(zqsjf,0)+NVL(sjhtsjf,0),NVL(sjf,0)+NVL(sjhtsjf,0) ,cwsfke,TO_CHAR(jzkscsj,'YYYY-MM-DD'),TO_CHAR(cwjzkscsj,'YYYY-MM-DD'),crm_khxx.fjje,crm_khxx.gsfje,a.dwmc qydm,yjjzsj,tdsj,TO_CHAR(qyrq,'YYYY-MM-DD') ";
    ...
    ls_sql+=" and crm_khxx.sjs='"+sjs+"' and crm_khxx.fgsbh='"+ssfgs+"'";
	...
	ls_sql+=" SELECT '',sjs,hth,khxm,fwdz,'<B>已退单</B>',sgdmc,zjxm,cxhdbm,-1*crm_khqye.yjjz,-1*crm_khqye.zxyjjz,-1*wdzgce,TO_CHAR(zkl),-1*qye,0,zqgczjf,zhgczjf,suijinbfb||'%',zqsuijin,suijin,glfbfb||'%',zqguanlif,guanlif,zqqtsf,zhqtsf,zqwjrqyexm,zhwjrqyexm,NVL(zqsjf,0)+NVL(sjhtsjf,0),NVL(sjf,0)+NVL(sjhtsjf,0) ,cwsfke,TO_CHAR(jzkscsj,'YYYY-MM-DD'),TO_CHAR(cwjzkscsj,'YYYY-MM-DD'),crm_khxx.fjje,crm_khxx.gsfje,a.dwmc qydm,yjjzsj,tdsj,TO_CHAR(qyrq,'YYYY-MM-DD') ";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,crm_khqye";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)";
	ls_sql+=" and crm_khxx.khbh=crm_khqye.khbh(+) ";
    ls_sql+=" and crm_khxx.sjs='"+sjs+"' and crm_khxx.fgsbh='"+ssfgs+"'";
