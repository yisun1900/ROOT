  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0" style='FONT-SIZE: 14px'>
    <tr> 
      <td colspan="2" height="64"> 
        <div align="center">品牌销售统计</div>      </td>
    </tr>
    ...
    <tr> 
      <td align="right" width="30%" height="44"><font color="#0000CC"><b>品牌名称</b></font></td>
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <p>
          ...
          <input type="button"  value="销售统计" onClick="f_do(selectform)"  name="tj" >
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.sjfw, "签单时间 "))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.sjfw2, "签单时间 "))) {
		return false;
	}

	FormName.action="PpZcXseTj.jsp";
	FormName.submit();
