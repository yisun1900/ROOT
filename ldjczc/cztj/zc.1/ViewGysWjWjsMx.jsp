...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">子品牌</td>
	<td  width="2%">结算状态</td>
	<td  width="2%" bgcolor="#99FFFF"><strong>应结算金额</strong></td>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">子品牌</td>
	<td  width="3%">结算状态</td>
	<td  width="3%" bgcolor="#CC99FF">应结算金额</td>
...
<%
	...
	ls_sql+=" and jc_zczjx.clzt in('30')";
