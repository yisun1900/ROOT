...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">订单类型</td>
	<td  width="2%">子品牌</td>
	<td  width="2%" bgcolor="#FFFFCC"><strong>销售总额-折前</strong></td>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">订单类型</td>
	<td  width="5%">子品牌</td>
	<td  width="3%" bgcolor="#FFFFCC"><strong>增减项总额-折前</strong></td>
	<td  width="3%" bgcolor="#FFFFCC"><strong><font color="#0000CC">增减项总额-折后</font></strong></td>
...
<%
	ls_sql="SELECT '',jc_zczjx.zjxbh,DECODE(jc_zczjx.clzt,'00','录入未完成','01','录入完成','02','已确认','04','厂家已接收','03','已送货','05','部分送货','30','单项完结','99','退单'),DECODE(jc_zcdd.ddlx,'1','代销品','3','补录合同','4','有库存订单','5','标准套餐','6','家具健康套餐','7','温暖静音套餐','8','窗帘套餐','9','代购主材','A','顶配升级','B','顶配独立收费','C','选配主材','D','套餐外主材'),jc_zcdd.ppbm,jc_zczjx.zqzjxze,jc_zczjx.zjxze,jc_zczjx.qrsj,jc_zczjx.tdsj,crm_khxx.khxm,crm_khxx.fwdz,jc_zcdd.jzsjs,jc_zcdd.zcdlbm,jc_zcdd.gys,DECODE(jc_zcdd.sfjrht,'Y','计入','N','不计入') sfjrht,ysgcjdmc,cxhdbm,crm_khxx.sjs,c.dwmc dm,jc_zcdd.ztjjgw,jc_zcdd.xmzy,jc_zcdd.jjsjs,jc_zczjx.zjxfssj,jc_zczjx.wjsj,jc_zczjx.lrsj,jc_zcdd.khbh,DECODE(jc_zczjx.sfjs,'N','未结算','Y','已结算') sfjs,jc_zczjx.bz";
...
//设置列超级连接
	...
	coluParm=new ColuParm();//生成一个列参数对象
	String[] coluKey3={"zjxbh"};//设置列参数：coluParm.key的主键
