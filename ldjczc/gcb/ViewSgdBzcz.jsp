...
String getsgbz=cf.GB2Uni(cf.getParameter(request,"sgbz"));
...
%>
<div align="center"><br><b>[<%=getsgbz%>]接单统计（<%=sjfw%>－－<%=sjfw2%>）</b></div>
...
String ys4=null;
	...
	int row=0;
	ls_sql="select crm_khxx.khbh,hdlxmc,khlxmc,hth,khxm,lxfs,fwdz,sjs,zjxm,sgdmc sgd,sgbz,qyrq,pdsj,kgrq,sjkgrq,sybgcrq,szqsj,jgrq,crm_khxx.gcjdbm,ysgcjdmc,pdclzt,sjjgrq,hzts,jgrq-kgrq htgq,jgrq+NVL(hzts,0) yjgrq,zqgczjf,crm_tckhqye.tcsgze";
	ls_sql+=" from  crm_khxx,sq_sgd,dm_gcjdbm,crm_tckhqye,dm_hdlxbm,dm_khlxbm";
	...
	ls_sql+=" and  crm_khxx.sgd='"+sgd+"' and zt='2'";
	ls_sql+=" and  crm_khxx.sgbz='"+getsgbz+"'";
