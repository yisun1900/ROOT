...
%>
<div align="center"><br><b>在施工工地－异常（<%=fgsmc%>）</b></div>
...
String ys4=null;
	...
	int row=0;
	ls_sql="select qye,zqgczjf,fkcsmc,bjjb,bjjbmc,jhybgcrq,jhzqsj,crm_khxx.khbh,hth,khxm,lxfs,fwdz,sjs,zjxm,sgdmc sgd,qyrq,pdsj,kgrq,sjkgrq,sybgcrq,szqsj,jgrq,crm_khxx.gcjdbm,ysgcjdmc,pdclzt,sjjgrq,hzts,jgrq-kgrq htgq,jgrq+NVL(hzts,0) yjgrq,cwsfke";
	ls_sql+=" from  crm_khxx,sq_sgd,dm_gcjdbm,bdm_bjjbbm,cw_fkcs,crm_xmycgl";
