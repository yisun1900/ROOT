...
%>
<div align="center"><br><b>在施工工地－中期验收延期（<%=fgsmc%>）</b></div>
<table border="1" width="230%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#CCCCCC" align="center"> 
    ...
    <td width="3%">实开工日期</td>
    <td width="3%">计划隐蔽工程</td>
    <td width="3%">实际隐蔽工程</td>
    <td width="3%">计划中期验收</td>
    <td width="3%">实际中期验收</td>
...
String ys4=null;
	...
	int row=0;
	ls_sql="select crm_khxx.yqsm,qye,zqgczjf,fkcsmc,bjjb,bjjbmc,jhybgcrq,jhzqsj,khbh,hth,khxm,lxfs,fwdz,sjs,zjxm,sgdmc sgd,qyrq,pdsj,kgrq,sjkgrq,sybgcrq,szqsj,jgrq,crm_khxx.gcjdbm,ysgcjdmc,pdclzt,sjjgrq,hzts,jgrq-kgrq htgq,jgrq+NVL(hzts,0) yjgrq,cwsfke";
	...
	ls_sql+=" and crm_khxx.cwjzkfkcs=cw_fkcs.fkcs(+) ";
		ls_sql+=" and  crm_khxx.fgsbh='"+fgsbh+"' and zt='2' and crm_khxx.gcjdbm in('6')";
