...
<%
	...
	String yhqx=cf.executeQuery("select count(*)  from v_sqxx where yhdlm='"+xtrzyhdlm+"' and cdbh='170103'");
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'警告！非法侵入[设计师统计]："+xtrzyhmc+"') ";
		...
		String sql="insert into sq_ckxxrz ( xh,ip,yhdlm,yhmc,dlsj,bz ) ";
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'进入[设计师统计]："+xtrzyhmc+"') ";
		cf.executeUpdate(sql);
	}
%>
...
////////////////////////小计
		...
		<tr align="right"  bgcolor="#FFFFFF" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
			...
			<td><A HREF="ViewNewywykhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newywykhs%></A></td>

			<td><A HREF="ViewNewecddkhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newecddkhs%></A></td>
			...
			<td><A HREF="ViewNewhfkhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newhfkhs%></A></td>
			...
			<td><A HREF="ViewLjywykhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljywykhs%></A></td>

			<td><A HREF="ViewLjecddkhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljecddkhs%></A></td>
			...
			<td><A HREF="ViewLjhfkhs.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljhfkhs%></A></td>
