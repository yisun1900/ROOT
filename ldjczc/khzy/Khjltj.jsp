...
<%
	...
	String yhqx=cf.executeQuery("select count(*)  from v_sqxx where yhdlm='"+xtrzyhdlm+"' and cdbh='170105'");
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'警告！非法侵入[客户经理积单统计]："+xtrzyhmc+"') ";
		...
		String sql="insert into sq_ckxxrz ( xh,ip,yhdlm,yhmc,dlsj,bz ) ";
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'进入[客户经理积单统计]："+xtrzyhmc+"') ";
		cf.executeUpdate(sql);
	}
%>
...
while (rs.next())
{
	...
	while (rs2.next())
	{
		...
		ls_sql+=" and crm_zxkhxx.khjl='"+yhmc+"'";
...
////////////////////////小计
		...
		<tr align="right"  bgcolor="#FFFFFF" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
			...
			<td><A HREF="ViewKhjlNew.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newkhs%></A></td>
			<td><A HREF="ViewKhjlNewYwy.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newywykhs%></A></td>

			<td><A HREF="ViewKhjlNewEcdd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newecddkhs%></A></td>
			<td><A HREF="ViewKhjlNewCt.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newctkhs%></A></td>
			<td><%=newctl%>%</td>
			<td><A HREF="ViewKhjlNewSgt.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newsgtkhs%></A></td>

			<td><A HREF="ViewKhjlNewHf.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newhfkhs%></A></td>

			<td><A HREF="ViewKhjlNewFd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newfdkhs%></A></td>
			<td><A HREF="ViewKhjlNewDj.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newdjkhs%></A></td>
			<td><A HREF="ViewKhjlNewQd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=newqdkhs%></A></td>
			<td><%=newqdl%>%</td>


			<td><A HREF="ViewKhjlLj.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljkhs%></A></td>
			<td><A HREF="ViewKhjlLjYwy.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljywykhs%></A></td>

			<td><A HREF="ViewKhjlLjEcdd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljecddkhs%></A></td>
			<td><A HREF="ViewKhjlLjCt.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljctkhs%></A></td>
			<td><%=ljctl%>%</td>
			<td><A HREF="ViewKhjlLjSgt.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljsgtkhs%></A></td>

			<td><A HREF="ViewKhjlLjHf.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljhfkhs%></A></td>

			<td><A HREF="ViewKhjlLjFd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljfdkhs%></A></td>
			<td><A HREF="ViewKhjlLjDj.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljdjkhs%></A></td>
			<td><A HREF="ViewKhjlLjQd.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=ljqdkhs%></A></td>
			<td><%=ljqdl%>%</td>

			<td><A HREF="ViewKhjlZsg.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=zsgdkhs%></A></td>
			<td><A HREF="ViewKhjlWkg.jsp?fgsbh=<%=fgsbh%>&yhmc=<%=yhmc%>&sjfw=<%=sjfw%>&sjfw2=<%=sjfw2%>" target="_blank"><%=wkgkhs%></A></td>
