  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="4" height="64"> 
        <div align="center">报修原因统计</div>      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align="right" width="18%" height="39">责任部门</td>
      <td width="32%" height="39">
...
%>
      ...
      <td width="18%" height="39" align="right">负责人</td>
      <td width="32%" height="39">
    ...
    <tr> 
      <td align="right" width="18%" height="40">类别</td>
      <td height="40" colspan="3">
		<input type="radio" name="wxfl" value="1" >保修期内
		<input type="radio" name="wxfl" value="2">保修期外 </td>
    </tr>
