...
try {
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXz.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzCl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzJj.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzWc.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzWcsb.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzJa.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzJajs.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsXzJamy.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsQmDcl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsQmCl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewTsQmDwj.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
