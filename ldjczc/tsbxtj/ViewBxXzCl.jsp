...
<%
    ...
    ls_sql+=" and crm_tsbm.jsxbm=dm_jsxbm.jsxbm(+) ";
		...
		ls_sql+=wheresql;
		ls_sql+=" and crm_tsjl.lrsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
		ls_sql+=" and crm_tsjl.lrsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";

		ls_sql+=" and crm_tsbm.jssj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
