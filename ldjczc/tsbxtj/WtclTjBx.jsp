...
try {
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXz.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzCl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzJj.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzWc.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzWcsb.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzJa.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzJajs.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxXzJamy.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxQmDcl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxQmCl.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
	...
	for (int i=0;i<yuesl ;i++ )
	{
		...
		if (tssl==0)//不输出
		{
			...
			%>
			  <td><A HREF="ViewBxQmDwj.jsp?sjfw=<%=startDate%>&sjfw2=<%=endDate%>&wheresql=<%=wheresql%>" target="_blank"><%=tssl%></A></td>
			<%
		}
