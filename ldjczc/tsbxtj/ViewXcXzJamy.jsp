...
<%
    ...
    ls_sql+=" and gdm_gdjcjl.jcwtflbm=gdm_jcwtflbm.jcwtflbm(+)";
		ls_sql+=wheresql;
		ls_sql+=" and gdm_gdjcjl.qrjjsj>=TO_DATE('"+sjfw+"','YYYY-MM-DD')";
		ls_sql+=" and gdm_gdjcjl.qrjjsj<=TO_DATE('"+sjfw2+" 23:59:59','YYYY-MM-DD HH24:MI:SS')";
		
		ls_sql+=" and gdm_gdjcjl.clzt='5'";//5：结案
		ls_sql+=" and gdm_gdjcjl.zzjgbm='1'";//1：满意
