...
%> 
    ...
    <tr align="center"> 
      <td height="71" colspan="2"> 
        <input type="button"  value="解决力度统计" onClick="f_tsyy(selectform)" >
...
<!--
function f_tsyy(FormName)//参数FormName:Form的名称
{
