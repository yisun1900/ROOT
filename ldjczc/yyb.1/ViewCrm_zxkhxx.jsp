...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#CCCCFF"> 
    <td width="21%" align="right"> 
      咨询状态    </td>
    <td width="29%"> <%
	cf.selectToken(out,"0+未分配店面&1+分配店面&2+飞单审核未通过&3+已签约&4+飞单&5+飞单审核未通过",zxzt,true);
%></td>
...
%></td>
  ...
  <tr bgcolor="#CCCCFF"> 
    <td width="21%" align="right">希望参加公司促销活动</td>
    <td colspan="3"><%=cxhdbm%></td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="21%" align="right">希望参加小区促销活动</td>
    <td colspan="3"><%=cxhdbmxq%></td>
  </tr>
  <tr bgcolor="#CCCCFF"> 
    <td width="21%" align="right" height="19">希望参加展会促销活动</td>
