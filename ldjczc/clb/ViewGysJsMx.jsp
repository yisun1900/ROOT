...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="1%" bgcolor="#99FFFF"><strong>合同远程费</strong></td>
	<td  width="1%" bgcolor="#99FFFF"><strong>套餐订单远程费</strong></td>
	<td  width="1%" bgcolor="#99FFFF"><strong>合同其它费</strong></td>
...
<%
	...
	ls_sql+=" and jc_zcdd.sfjs in('Y','M','F')";//N：未结算；C：已选择结算；Y：已结算；M：结算已审核；F：结算付款
...
<%
	...
	ls_sql+=" and jc_zczjx.sfjs in('Y','M','F')";//N：未结算；C：已选择结算；Y：已结算；M：结算已审核；F：结算付款
