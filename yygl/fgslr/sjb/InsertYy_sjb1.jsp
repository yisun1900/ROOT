...
String ssfgs=request.getParameter("yy_sjb_ssfgs");
String lrbm=request.getParameter("yy_sjb_ssbm");
String zqs=request.getParameter("yy_sjb_zqs");
...
try {
	...
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		if (count>0)
		{
			out.println("<span class=\"STYLE1\">提醒！！！！！！！！！！！！！！！已经录入了数据</span>");
		}
	}
	else{
		if (count>0)
