...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from yy_sjb where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">主材产值上周计划</td>
	<td  width="3%">主材产值上周完成</td>
	<td  width="3%">主材产值本月预计</td>
	<td  width="3%">录入人</td>
	<td  width="4%">录入时间</td>
</tr>
<%
