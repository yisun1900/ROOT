...
<tr bgcolor="#FFFFFF"> 
   ...
   <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="4" height="35"><strong>《家庭居室装饰装修工程施工合同》全装修套餐合同标准附件</strong>   </td>
   </tr> 
   <tr bgcolor="#FFFFFF"> 
...
%> </u></td>
  ...
  <tr  bgcolor="#FFFFFF">
    ...
    <td>￥<u><%=cf.formatDouble(wdzgce+zqguanlif+zqsuijin)%></u>元</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr  bgcolor="#FFFFFF">
    <td height="30">&nbsp;</td>
    <td colspan="3">大写：<u><%=cf.NumToRMBStr(wdzgce+zqguanlif+zqsuijin)%></u></td>
  </tr>
  <tr  bgcolor="#FFFFFF">
    ...
    <td height="30" colspan="4" >
	 <table border="1" style='FONT-SIZE: 14px'>
	    <tr align="center">
		   <td width="25%">支付次数</td>
		   <td width="25%">支付时间</td>
		   <td width="25%">合同款支付比例</td>
		   <td width="25%">应支付金额</td>
		</tr>
		 <tr align="center">
		   <td>第一次</td>
		   <td>开工三日前</td>
		   <td>70%</td>
		   <td>￥<%=cf.formatDouble((wdzgce+zqguanlif+zqsuijin)*0.7)%></td>
		</tr>
		 <tr align="center">
		   <td>第二次</td>
		   <td>工期过半</td>
		   <td>25%</td>
		   <td>￥<%=cf.formatDouble((wdzgce+zqguanlif+zqsuijin)*0.25)%></td>
		</tr>
		 <tr align="center">
		   <td>第三次</td>
		   <td>竣工验收合格</td>
		   <td>5%</td>
		   <td>￥<%=cf.formatDouble((wdzgce+zqguanlif+zqsuijin)*0.05)%></td>
		</tr>
	 </table>
	</td>
  </tr>
