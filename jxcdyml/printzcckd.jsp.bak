...
try {
	...
	else if (wherecklx.equals("S"))//'D','订单出库','B','报废出库','T','退货出库','Q','调拨出库','S','申购出库','P','配送出库','J','代金券出库'
	{
	...
	else //'D','订单出库','B','报废出库','T','退货出库','Q','调拨出库','S','申购出库','P','配送出库','J','代金券出库'
	{
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="10%"> 
  <%
	  if (wherecklx.equals("D"))//'D','订单出库','B','报废出库','T','退货出库','Q','调拨出库','S','申购出库','P','配送出库','J','代金券出库'
		{out.print("订单出库：");}
...
<tr>
  ...
  <tr>
    ...
    <td width="33%"><font size="-1"><b>提货员：</b></font></td>
