...
try {
	...
	ls_sql+=" FROM jc_zcdd";
    ls_sql+=" where jc_zcdd.clzt>='09' and jc_zcdd.clzt not in('98')";
...
<table border="1" width="115%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	while (rs1.next())
	{
		...
		ls_sql+=" and jc_zcdd.clzt not in('98')  ";
		ls_sql+=" and jc_zcdd.khbh='"+khbh+"' and jc_zcdd.ppbm='"+ppbm+"' ";
		ls_sql+=" and jc_zczjxmx.zjsl!=0";
		ls_sql+=" and jc_zczjxmx.zjxbh=jc_zczjx.zjxbh and jc_zczjx.clzt not in('00')";

		ls_sql+=" UNION ALL ";
		
		ls_sql+=" SELECT '已退单' lx,jc_zcdd.ddbh,jc_zcddmx.zcpzwzbm,jc_zcddmx.zcmc,jc_zcddmx.dwbh,jc_zcddmx.gg,jc_zcddmx.xinghao,jc_zcddmx.jldwbm,-1*jc_zcddmx.sl,jc_zcddmx.dj||DECODE(jc_zcddmx.xzjg,'1','','2','(促)') dj,-1*NVL(jc_zcddmx.je,0) je,-1*NVL(jc_zcddmx.ycf,0) ycf,-1*NVL(jc_zcddmx.qtfyje,0) qtfy,cxhdbl||'%' cxhdbl,-1*ROUND(NVL(jc_zcddmx.je,0)*cxhdbl/100,2) cxhdje,jc_zcddmx.bz";
		ls_sql+=" FROM jc_zcddmx,jc_zcdd";
		ls_sql+=" where jc_zcddmx.ddbh=jc_zcdd.ddbh" ;
		...
		ls_sql+=" SELECT '已退单' lx,jc_zczjxmx.zjxbh ddbh,jc_zcddmx.zcpzwzbm,jc_zcddmx.zcmc,jc_zcddmx.dwbh,jc_zcddmx.gg,jc_zcddmx.xinghao,jc_zcddmx.jldwbm,-1*jc_zczjxmx.zjsl sl,jc_zcddmx.dj||DECODE(jc_zcddmx.xzjg,'1','','2','(促)') dj,-1*NVL(jc_zczjxmx.zjje,0) je,-1*NVL(jc_zczjxmx.zjycf,0) ycf,-1*NVL(jc_zczjxmx.zjqtfy,0) qtfy,cxhdbl||'%' cxhdbl,-1*ROUND(NVL(jc_zczjxmx.zjje,0)*cxhdbl/100,2) cxhdje,jc_zcddmx.bz";
		ls_sql+=" FROM jc_zcddmx,jc_zcdd,jc_zczjx,jc_zczjxmx";
		ls_sql+=" where jc_zcddmx.ddbh=jc_zcdd.ddbh and jc_zcdd.ddbh=jc_zczjxmx.ddbh and jc_zcddmx.xh=jc_zczjxmx.xh" ;
		ls_sql+=" and jc_zcdd.clzt='99'";
		ls_sql+=" and jc_zcdd.khbh='"+khbh+"' and jc_zcdd.ppbm='"+ppbm+"' ";
		ls_sql+=" and jc_zczjxmx.zjsl!=0";
		ls_sql+=" and jc_zczjxmx.zjxbh=jc_zczjx.zjxbh and jc_zczjx.clzt='99'";
		ls_sql+=" ) ";

		ls_sql+=" order by dwbh,zcmc,xinghao,gg,zcpzwzbm,ddbh,lx";
		ps= conn.prepareStatement(ls_sql);
