...
try {
	...
	ls_sql+=" ,zqhtzcbj,zhhtzcbj,gj,pgjsj,dd,pddsj,zqsuijin,zqzjxsuijin,sgdxm,ysy,ywyssxz,DECODE(NVL(jzwkqs,'N'),'Y','全收','N','否') jzwkqs";
	...
	ls_sql="select DECODE(zklx,'1','整单打折','2','单项打折','3','部分费用打折') zklx,zdzk,zjjmje,gcfqdzk,glfzk,sjzk,sjfzk,qtsfxmzk  ,zjxzklx";
...
*/
	...
	ls_sql+=" FROM bj_sfxmmx";
	ls_sql+=" where bj_sfxmmx.khbh='"+khbh+"' and bj_sfxmmx.sfcysgdjs='Y'";//是否参与施工队结算  Y：是；N：否  
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
...
<body bgcolor="#FFFFFF">
<div align="center">
  <input type="button" onClick="window.open('Jc_zcddCxCbList.jsp?khbh=<%=khbh%>')" value="主材订单" <%if (zcdd==0) out.print("disabled");%>>
  <input type="button" onClick="window.open('ViewJc_zcddMx.jsp?khbh=<%=khbh%>')" value="主材明细" >
  <input type="button" onClick="window.open('ViewZjxxx.jsp?khbh=<%=khbh%>')" value="增减项">
  <input type="button" <%if (zcdd==0 && mmdd==0 && cgdd==0 && jjdd==0) out.print("disabled");%> value="完结主材明细" onClick="window.open('Jc_zcddMxWjCxList.jsp?khbh=<%=khbh%>')" >
  <input type="button" <%if (zcdd==0 && mmdd==0 && cgdd==0 && jjdd==0) out.print("disabled");%> value="未完结主材明细" onClick="window.open('Jc_zcddMxWwjCxList.jsp?khbh=<%=khbh%>')" >
  <input type="button" value="派单" onClick="window.open('ViewPdxx.jsp?khbh=<%=khbh%>')">
  <input type="button" value="回访记录" onClick="window.open('ViewGchfxx.jsp?khbh=<%=khbh%>')">
...
<%
	...
	{
	%>
<input type="button" onClick="window.open('/dzbj/zxbjmx/Bj_khbjmxGztjList.jsp?khbh=<%=khbh%>','','toolbar=no,menubar=no,scrollbars=yes,resizable=yes')" value="工种统计">
<input type="button" value="合同报价" onClick="window.open('/dhzx/sjszxone/dybj.jsp?khbh=<%=khbh%>')">
<input type="button" onClick="window.open('/dzbj/zxbjmx/ViewAllBj.jsp?khbh=<%=khbh%>')" value="报价成本">
<input type="button" value="最新报价" onClick="window.open('ViewZxbj.jsp?khbh=<%=khbh%>')">
<input type="button" onClick="window.open('/dzbj/zxbjmx/Bj_khbjmxDyqlList.jsp?khbh=<%=khbh%>')" value="清零报价">
...
%> 
  ...
  <input type="button" onClick="window.open('/gcgl/bzgqgl/ViewCrm_khsglcb.jsp?khbh=<%=khbh%>')" value="施工流程表">
  ...
  <input type="button" onClick="window.open('/khxx/Jxc_clpsdCxList.jsp?khbh=<%=khbh%>')"  value="工长领料单">
  <input type="button" onClick="window.open('/khxx/Cw_sgdzqjsCxList.jsp?khbh=<%=khbh%>')" value="工长拨工费">
</div>
<HR>
<table width="100%" border="0" style="FONT-SIZE:14" cellpadding="2" cellspacing="2" bgcolor="#E8E8FF">
  <tr>
    ...
    <td width="31%" bgcolor="#FFFFFF"><%=crm_khxx_khxm%>（
      <input type="button" onClick="window.open('/khxx/ViewDh.jsp?khbh=<%=khbh%>')" value="查看电话" >
）(
<%
...
%>
        ...
        <tr>
          ...
          <td bgcolor="#CCFFCC"><b>实际完工</b>：<%=crm_khxx_sjjgrq%></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td bgcolor="#CCFFCC"><b>客户完结时间</b>:<%=sjwjrq%></td>
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td width="2%">&nbsp;</td>
          <td colspan="2" bgcolor="#CCFFCC"><b>合同工期</b>:<%=gqts%>天&nbsp;&nbsp;&nbsp;&nbsp;<b>延期单</b>：<%=hzts%>天</td>
          <td width="4%">&nbsp;</td>
          <td width="37%" bgcolor="#CCFFCC"><b>家居完结</b>:
          <% cf.radioToken(out, "Y+完结&N+否",jjwjbz,true);%></td>
          <td width="27%" bgcolor="#CCFFCC"><b>退单时间</b>:<%=tdsj%></td>
          <td width="2%">&nbsp; </td>
        </tr>
      </table>    </td>
  </tr>
    ...
    <td colspan="2" align="center" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="1" cellspacing="1">
      <tr>
        ...
        <td width="49%" valign="top"><table width="100%" border="0" style="FONT-SIZE:13" cellpadding="0" cellspacing="3">
            <tr align="center" bgcolor="#FFFFFF">
              <td width="35%">&nbsp;</td>
              <td width="32%" bgcolor="#E8E8FF"><strong>合同</strong></td>
              <td width="33%" bgcolor="#E8E8FF"><strong>最新</strong></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>人辅成本</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=sgcbj%></td>
              <td align="center" bgcolor="#CCFFCC"><%=zxsgcbj%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>人辅毛利额</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=mle%></td>
              <td align="center" bgcolor="#CCFFCC"><%=zxmle%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>人辅毛利率</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=mll%>%</td>
              <td align="center" bgcolor="#CCFFCC"><%=zxmll%>%</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>主材销售额</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=zchtje%></td>
              <td align="center" bgcolor="#CCFFCC"><%=zczxje%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>主材成本</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=zchtcb%></td>
              <td align="center" bgcolor="#CCFFCC"><%=zczxcb%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>主材毛利率</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=zchtml%>%</td>
              <td align="center" bgcolor="#CCFFCC"><%=zczxml%>%</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><strong>客户毛利率</strong></td>
              <td align="center" bgcolor="#CCFFCC"><%=khhtml%>%</td>
              <td align="center" bgcolor="#CCFFCC"><%=khzxml%>%</td>
            </tr>
            </table>
		  <P>
            <input  type="button" onClick="window.open('ViewAllBj.jsp?khbh=<%=khbh%>','','height=650, width=1000, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=n o, status=no')" value="合同成本明细">
            <input  type="button" onClick="window.open('ViewZxcbj.jsp?khbh=<%=khbh%>','','height=650, width=1000, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=n o, status=no')" value="最新成本明细">
            <input type="button" onClick="window.open('ViewZcysb.jsp?khbh=<%=khbh%>','','height=650, width=1000, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=n o, status=no')" value="主材预算表">
            <input type="button" onClick="window.open('ViewZcjsb.jsp?khbh=<%=khbh%>','','height=650, width=1000, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=n o, status=no')" value="主材结算表">
			<input  type="button" onClick="window.open('ViewYsspb.jsp?khbh=<%=khbh%>')" value="预算审批表">
...
<table width="100%" border="0" style="FONT-SIZE:13" cellpadding="0" cellspacing="1" bgcolor="#999999">
	...
	<table width="100%" border="0" style="FONT-SIZE:13" cellpadding="0" cellspacing="3">
      ...
      <tr bgcolor="#CCFFCC">
        <td align="right" bgcolor="#CCFFCC"><font color="#0000FF">设计费</font></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><table width="100%" border="0" style="FONT-SIZE:14" cellpadding="0" cellspacing="3">
      ...
      <tr bgcolor="#CCFFCC">
        ...
        <td>尾款全收:<%=jzwkqs%></td>
        <td width="16%" bgcolor="#CCFFCC">签单结转时间:<%=yjjzsj%></td>
        <td width="18%" align="center">退单结转时间:<%=tdyjjzsj%></td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="97%"><table width="100%" border="0" style="FONT-SIZE:14" cellpadding="0" cellspacing="3">
        ...
        <tr bgcolor="#CCFFCC"> 
          <td width="20%" align="center" bgcolor="#CCFFCC">增减项完成标志</td>
          <td width="20%" align="center" bgcolor="#CCFFCC">最近增减项序号</td>
          <td width="20%" align="center" bgcolor="#CCFFCC">最近增减项时间</td>
          <td width="20%" align="center" bgcolor="#CCFFCC">减项扣管理费</td>
          <td width="20%" align="center" bgcolor="#CCFFCC">减项项其它扣款</td>
        </tr>
        <tr bgcolor="#CCFFCC"> 
          <td width="20%" align="center" bgcolor="#CCFFCC"><%cf.selectToken(out,"1+未完成&2+已完成",zjxwcbz,true);%></td>
...
<table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#E8E8FF" align="center"> 
    <td colspan="4"> 
      <input type="button" value="换施工队记录" onClick="window.open('Pd_hsgdjlCxList.jsp?khbh=<%=khbh%>')"  >
      <input type="button" value="换质检记录" onClick="window.open('Pd_hzjjlCxList.jsp?khbh=<%=khbh%>')"  >
      <input type="button" value="关键信息修改记录" onClick="window.open('ViewCrm_sjsxgjl.jsp?khbh=<%=khbh%>')"  >    </td>
  </tr>
  <tr bgcolor="#E8E8FF" align="center"> 
    <td colspan="4"> 
      <input type="button" value="工程进度登记" onClick="window.open('Crm_gcjddjjlCxList.jsp?khbh=<%=khbh%>')"  >
      <input type="button" value="延期明细" onClick="window.open('Crm_gcyqyymxCxList.jsp?khbh=<%=khbh%>')"  >
      <input type="button" value="核增明细" onClick="window.open('/gcgl/gcjdgz/gqhz/ViewCrm_gcjddjjl.jsp?khbh=<%=khbh%>')"  >    </td>
  </tr>
...
<%
	if (ckjgbz.equals("Y"))
	{
		...
		ls_sql="SELECT sfxmmc,DECODE(bj_sfxmmx.sflx,'1','直接费百分比','2','固定金额(可改)','3','税金','4','固定金额(不可改)','5','管理费') sflx ";
