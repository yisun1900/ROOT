...
<%
	...
	if (zjxxh==null)
	{
		...
		{
			response.sendRedirect("/dzbj/zxbjmx/Bj_khbjmxYltjList.jsp?khbh="+khbh);
		}
		else{
			response.sendRedirect("/dzbj/zxbjmx/Bj_khbjmxYltjList.jsp?khbh="+khbh);
		}
		...
		if (jzbz.equals("1"))//1：家装；2：公装
		{
			response.sendRedirect("/gcgl/zjx/dzbj/zxbjmx/Bj_khbjmxYltjList.jsp?khbh="+khbh+"&zjxxh="+zjxxh);
		}
		else{
			response.sendRedirect("/gcgl/zjx/dzbj/zxbjmx/Bj_khbjmxYltjList.jsp?khbh="+khbh+"&zjxxh="+zjxxh);
		}
