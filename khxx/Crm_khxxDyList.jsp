...
ybl.common.PageObject pageObj=new ybl.common.PageObject();
	...
	{
		crm_khxx_wgbz=cf.GB2Uni(crm_khxx_wgbz);
		if (!(crm_khxx_wgbz.equals("")))	wheresql+=" and  (crm_khxx.wgbz='"+crm_khxx_wgbz+"')";
	}
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm, DECODE(crm_khxx.xb,'M','男','W','女'),crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.hth,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.qye,gcjdmc  ";
