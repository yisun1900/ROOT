...
<body bgcolor="#ffffff" text="#000000" style='FONT-SIZE: 12px'>
  <table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
    <tr bgcolor="#FFFFFF">
      <td height="29" colspan="3" align="center" class="STYLE2" ><B>地板补货清单</B></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
<%
	...
	ls_sql+=" FROM bdm_bjjbbm,crm_zjxdj,bj_zjxzcbgqd,jxc_clxlbm  ";
	ls_sql+=" where bj_zjxzcbgqd.bjjbbm=bdm_bjjbbm.bjjbbm(+)";
	ls_sql+=" and bj_zjxzcbgqd.tccplbbm=jxc_clxlbm.clxlbm(+)";
	ls_sql+=" and crm_zjxdj.zjxxh=bj_zjxzcbgqd.zjxxh  ";
	ls_sql+=" and bj_zjxzcbgqd.khbh='"+khbh+"'";
