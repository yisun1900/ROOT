...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_aqsgjlCxList.jsp" name="selectform">
<div align="center">安全事故记录－查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right">发生时间 从</td>
  <td><input type="text" name="crm_aqsgjl_fssj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_aqsgjl_fssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">工伤人数 从</td>
  <td><input type="text" name="crm_aqsgjl_gsrs" size="20" maxlength="8" ></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_aqsgjl_gsrs2" size="20" maxlength="8" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">工亡人数 从</td> 
  <td width="32%"> 
    <input type="text" name="crm_aqsgjl_gwrs" size="20" maxlength="8" >  </td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_aqsgjl_gwrs2" size="20" maxlength="8" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从</td>
  <td><input type="text" name="crm_aqsgjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_aqsgjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="crm_aqsgjl_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"> 
    <select name="crm_aqsgjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
{
	if(!(isDatetime(FormName.crm_aqsgjl_fssj, "发生时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_aqsgjl_fssj2, "发生时间"))) {
		return false;
	}
	if(!(isNumber(FormName.crm_aqsgjl_gsrs, "工伤人数"))) {
		return false;
	}
	if(!(isNumber(FormName.crm_aqsgjl_gsrs2, "工伤人数"))) {
		return false;
	}
	if(!(isNumber(FormName.crm_aqsgjl_gwrs, "工亡人数"))) {
		return false;
	}
	if(!(isNumber(FormName.crm_aqsgjl_gwrs2, "工亡人数"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_aqsgjl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_aqsgjl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
