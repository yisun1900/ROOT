...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xmycglXgFaList.jsp" name="selectform">
<div align="center">解决方案－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="crm_xmycgl_jjfazdr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">解决方案制订时间 从</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_jjfazdsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_jjfazdsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
