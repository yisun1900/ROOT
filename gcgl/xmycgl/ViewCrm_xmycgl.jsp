...
try {
	...
	if (rs.next())
	{
		...
		crm_xmycgl_wtsfjj=cf.fillNull(rs.getString("crm_xmycgl_wtsfjj"));
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%" bgcolor="#E8E8FF"> 
<%
	cf.radioToken(out, "Y+解决&N+未解决",crm_xmycgl_wtsfjj,true);
%>  </td>
