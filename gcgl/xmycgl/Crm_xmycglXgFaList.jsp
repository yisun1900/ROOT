...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_xmycgl.djbh, DECODE(crm_xmycgl.zt,'1','异常录入','2','制订方案','3','方案审核','4','已处理','5','停工申请','6','停工审批','7','办理停工','8','办理复工'),crm_xmycgl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_xmycgl.jjfazdr,crm_xmycgl.jjfazdsj,crm_xmycgl.jjfa,crm_xmycgl.cxwtsj,crm_xmycgl.dsr,ycflmc,crm_xmycgl.cxwt,crm_xmycgl.lrr,crm_xmycgl.lrsj,dwmc,crm_xmycgl.bz  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_xmycgl.jjfazdsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xmycglXgFaList.jsp","","","XgFaCrm_xmycgl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除解决方案"};//按钮的显示名称
	String[] buttonLink={"Crm_xmycglXgFaList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_xmycgl set zt='1',jjfazdsj=null,jjfazdr=null,jjfa=null where zt='2' and "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">合同号</td>
	<td  width="3%">设计师</td>
	<td  width="3%">解决方案制订人</td>
	<td  width="4%">解决方案制订时间</td>
	<td  width="15%">解决方案</td>
	<td  width="4%">出现问题时间</td>
	<td  width="3%">当事人</td>
	<td  width="4%">异常分类</td>
	<td  width="15%">出现问题</td>
	<td  width="3%">录入人</td>
