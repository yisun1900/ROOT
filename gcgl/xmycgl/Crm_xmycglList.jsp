...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	crm_xmycgl_lrbm=request.getParameter("crm_xmycgl_lrbm");
	if (crm_xmycgl_lrbm!=null)
	{
		crm_xmycgl_lrbm=cf.GB2Uni(crm_xmycgl_lrbm);
		if (!(crm_xmycgl_lrbm.equals("")))	wheresql+=" and  (crm_xmycgl.lrbm='"+crm_xmycgl_lrbm+"')";
	}
	ls_sql="SELECT crm_xmycgl.djbh, DECODE(crm_xmycgl.zt,'1','录入','2','制订方案','3','方案审核','4','已处理'),crm_xmycgl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_xmycgl.cxwtsj,crm_xmycgl.dsr,ycflmc,crm_khxx.hth,crm_khxx.sjs,crm_xmycgl.cxwt,crm_xmycgl.lrr,crm_xmycgl.lrsj,dwmc,crm_xmycgl.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xmycglList.jsp","","","EditCrm_xmycgl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_xmycglList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from crm_ycclqk where "+chooseitem;
		sql[1]="delete from crm_xmycgl where zt='1' and "+chooseitem;
