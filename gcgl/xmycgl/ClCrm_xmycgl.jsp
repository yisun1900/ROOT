...
try {
	...
	ls_sql+=" ,jjfazdr,jjfazdsj,jjfa,jjfashr,jjfashsj,clqklrr,clqklrsj,wtsfjj,sjclqk ";
...
<div align="center">实际处理（登记编号：<%=djbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="khyyts" size="20" maxlength="8"  value="" ></td>
  <td align="right">客户责任比例</td>
  <td><input type="text" name="khzrbl" size="10" maxlength="8"  value="" >
    %</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">非客户原因影响天数</td>
  <td><input type="text" name="fkhyyts" size="20" maxlength="8"  value="" ></td>
  <td align="right">非客户责任比例</td>
  <td><input type="text" name="fkhzrbl" size="10" maxlength="8"  value="" >
    %</td>
</tr>
<tr bgcolor="#FFFFFF">
