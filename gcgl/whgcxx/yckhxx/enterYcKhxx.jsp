...
<body bgcolor="#FFFFFF">
<form method="post" action="YcKHzL.jsp" name="selectform">
<div align="center">
  <p>客户信息移除</p>
  <p>当前数据库－－&gt;备份数据库 </p>
...
<tr bgcolor="#FFFFFF">
  <td height="36" colspan="2" align="center" bgcolor="#CCCCCC"><strong>请选择移除范围</strong></td>
  </tr>
<tr bgcolor="#FFFFFF">
...
<tr align="center"> 
  <td colspan="2"> 
    <input type="button"  value="开始移除" onClick="f_do(selectform)">
