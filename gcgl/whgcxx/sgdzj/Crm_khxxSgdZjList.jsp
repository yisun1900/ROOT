...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql=" SELECT hth,khxm,fwdz,DECODE(zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),ysgcjdmc,sgdmc,sjs,zjxm,qyrq,sjjgrq,sq_dwxx.dwmc,khbh ";
...
//进行对象初始化
	...
	pageObj.initPage("Crm_khxxSgdZjList.jsp","","","EditSgdZjCrm_khxx.jsp");
...
<CENTER >
  <B><font size="3">修改－施工队工程担当（退单客户不可改）</font></B>
</CENTER>
<%
	pageObj.out=out;
