...
<div align="center">
  <p>修改促销活动（修改记录号：<%=xgjlh%>）</p>
  <p><font color="#FF0000"><strong>注意：影响签约额，修改【促销活动】后，系统会根据活动折扣修改【客户折扣】，同时修改【折后金额】</strong></font>
</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right"><font color="#0000FF">合同额－折前</font></td>
      <td><%=wdzgce%></td>
      <td align="right"><font color="#0000FF">合同额－折后</font></td>
      <td><%=qye%></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
<BR>
<form method="post" action="SaveInsertCw_cxhdxgjl.jsp" name="insertform" target="_blank">
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
	<tr bgcolor="#FFFFFF">
