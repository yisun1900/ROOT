...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 查询－修改签约额记录</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Cw_qyexgjlCxList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">修改记录号</td> 
  <td width="35%"> 
    <input type="text" name="xgjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="15%">客户编号</td> 
  <td width="35%"> 
    <input type="text" name="khbh" size="20" maxlength="20" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">修改时间 从</td> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.lrsj2, "修改时间"))) {
		return false;
	}
