...
<form method="post" action="SaveInsertCw_qyexgjl.jsp" name="insertform" target="_blank">
<div align="center">修改－签约额（<font color="#FF0000"><strong>自动计算，全额打折</strong></font>）</div>
...
%>         </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%" bgcolor="#FFFFCC"> 
        <input type="text" name="xghwdzgce" value="<%=wdzgce%>" size="20" maxlength="10" onChange="calValue(insertform)">      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFCC"><input type="text" name="xghzkl" value="<%=zkl%>" size="10" maxlength="9" onChange="calValue(insertform)">
        （>0且<=10） </td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
（>0且<=10） </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="19%" align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><font color="#0000CC">签约额</font></td>
      <td width="31%" bgcolor="#FFFFCC"> 
        <input type="text" name="xghqye" value="<%=qye%>" size="20" maxlength="17" readonly>      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFCC"><input type="text" name="xghcdzwjmje" value="<%=cdzwjmje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#E8E8FF"><font color="#0000FF">管理费百分比</font></td>
      <td bgcolor="#E8E8FF"><input type="text" name="xgqglfbfb" value="<%=glfbfb%>" size="10" maxlength="17" readonly>
      %</td>
      <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font>管理费百分比</td>
      <td bgcolor="#FFFFCC"><input type="text" name="xghglfbfb" value="<%=glfbfb%>" size="10" maxlength="17" onChange="calValue(insertform)">
      %</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><font color="#0000CC">折前管理费</font></td>
      <td bgcolor="#FFFFCC"><input type="text" name="xghzqguanlif" value="<%=zqguanlif%>" size="20" maxlength="17" readonly></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><font color="#0000CC">折后管理费</font></td>
      <td bgcolor="#FFFFCC"><input type="text" name="xghguanlif" value="<%=guanlif%>" size="20" maxlength="17" readonly></td>
    </tr>
     <tr bgcolor="#FFFFFF">
       <td align="right" bgcolor="#E8E8FF"><font color="#0000FF">管理费减免额</font></td>
       <td bgcolor="#E8E8FF"><input type="text" name="xgqglfjmje" value="<%=glfjmje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
       <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font>管理费减免额</td>
       <td bgcolor="#FFFFCC"><input type="text" name="xghglfjmje" value="<%=glfjmje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
     </tr>
     <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%" bgcolor="#FFFFCC"> 
        <input type="text" name="xghsuijinbfb" value="<%=suijinbfb%>" size="10" maxlength="9" onChange="calValue(insertform)">
        % </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="19%" align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><font color="#0000CC">税金</font></td>
      <td width="31%" bgcolor="#FFFFCC"> 
        <input type="text" name="xghsuijin" value="<%=suijin%>" size="20" maxlength="17" readonly>      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#E8E8FF"><font color="#0000FF">税金减免额</font></td>
      <td bgcolor="#E8E8FF"><input type="text" name="xgqsjjmje" value="<%=sjjmje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
      <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font>税金减免额</td>
      <td bgcolor="#FFFFCC"><input type="text" name="xghsjjmje" value="<%=sjjmje%>" size="20" maxlength="17" onChange="calValue(insertform)"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFCC"><input type="text" name="xghzqwjrqyexm" size="20" maxlength="17"  value="<%=zqwjrqyexm%>" onChange="calValue(insertform)"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td align="right" bgcolor="#FFFFCC"><font color="#FF0000">*</font><font color="#0000CC">折后未记入签约额项目</font></td>
      <td bgcolor="#FFFFCC"><input type="text" name="xghzhwjrqyexm" size="20" maxlength="17"  value="<%=zhwjrqyexm%>" readonly></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
{  
	var yxghqye=FormName.xghwdzgce.value*FormName.xghzkl.value/10.0 ;
	yxghqye=round(yxghqye,2);

	var xghqye=yxghqye-FormName.xghcdzwjmje.value;
	xghqye=round(xghqye,2);
	FormName.xghqye.value=xghqye;


	var xghzqguanlif=FormName.xghwdzgce.value*FormName.xghglfbfb.value/100.0;
	xghzqguanlif=round(xghzqguanlif,2);
	FormName.xghzqguanlif.value=xghzqguanlif;

	var yxghguanlif=FormName.xghzqguanlif.value*FormName.xghzkl.value/10.0
	yxghguanlif=round(yxghguanlif,2);

	var xghguanlif=yxghguanlif-FormName.xghglfjmje.value
	xghguanlif=round(xghguanlif,2);
	FormName.xghguanlif.value=xghguanlif;

	var xghsuijin=(yxghqye+yxghguanlif)*FormName.xghsuijinbfb.value/100.0-FormName.xghsjjmje.value;
	xghsuijin=round(xghsuijin,2);
	FormName.xghsuijin.value=xghsuijin;      

	var xghzhwjrqyexm=FormName.xghzqwjrqyexm.value*FormName.xghzkl.value/10.0;
	xghzhwjrqyexm=round(xghzhwjrqyexm,2);
	FormName.xghzhwjrqyexm.value=xghzhwjrqyexm;      
}    
