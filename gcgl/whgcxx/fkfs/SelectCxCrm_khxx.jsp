...
<form method="post" action="Crm_khxxCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="34%"> 
                <input type="text" name="khjl" size="20" maxlength="20">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">付款方案</td>
              <td colspan="3"><select name="fkfabm" style="FONT-SIZE:12PX;WIDTH:352PX">
                  <%
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select cw_fkfabm.fkfabm,cw_fkfabm.fkfamc||'('||cw_fgsfkfa.fgsbh||')' from cw_fkfabm,cw_fgsfkfa where cw_fkfabm.fkfabm=cw_fgsfkfa.fkfabm order by cw_fgsfkfa.fgsbh,cw_fkfabm.fkfabm","");
%>
              </select></td>
            </tr>
            <tr align="center"> 
