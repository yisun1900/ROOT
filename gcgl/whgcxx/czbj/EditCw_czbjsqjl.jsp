...
////////////////
	...
	gxhzqwjrqyexm=dzbjje.getZqWjrJe(conn,khbh,"yz");//获取折前『不记入业绩其它费』，不包括税金、管理费、设计费
	gxhzhwjrqyexm=dzbjje.getZhWjrJe(conn,khbh,"yz");//获取折后『不记入业绩其它费』，不包括税金、管理费、设计费
	gxhwjrqyexmsm=dzbjje.getWjrJeMc(conn,khbh,"yz");//获取『其它收费项目名称』，不包括税金、管理费、设计费
	...
	gxhyjjz=dzbjje.getYjjz(conn,khbh,"yz");//获取业绩净值
	gxhyjjz=cf.round(gxhyjjz*100/gxhyjjzcs,2);//业绩净值=毛利额÷核算净值参数
...
{  
	...
	var gxhqye=FormName.gxhzhgczjf.value*1.0+FormName.gxhguanlif.value*1.0+FormName.gxhsuijin.value*1.0+FormName.gxhzhqtsf.value*1.0+FormName.gxhzhwjrqyexm.value*1.0+FormName.gxhsjf.value*1.0-FormName.gxhdjfxje.value*1.0-FormName.gxhzjjmje.value*1.0;
