...
<%
if (cf.check((String)session.getAttribute("yhdlm"),request.getRemoteHost(),"050211")==0) 
{
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,hth,sjs,zjxm,sgdmc sgd,qyrq,a.dwmc dm";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxTqList.jsp","","qrSC.jsp","");
...
<CENTER >
  <B><font size="3">维护工程信息-特权</font></B>
</CENTER>
<%
	pageObj.out=out;
