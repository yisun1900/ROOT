...
try {
	...
	ps.setString(33,"1");//1：有明细；2：无明细；3：套餐主材
...
//////////
	...
	if (oldzjxxh.equals(""))//目前无增减项，取原报价
	{
		...
		ls_sql="insert into bj_sfxmmxq (zjxxh,khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfssjf,sfkdz,zdzk,sfbfb,dj,cbjbfb,sgcbjbfb,gcjcbjbfb,jldw,sl,zqsfje,dxzkl,sfje,bz,sffqsk,cbjjsfs)";
		ls_sql+=" select          '"+zjxxh+"',khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfssjf,sfkdz,NVL(zdzk,0),sfbfb,dj,NVL(cbjbfb,100),NVL(sgcbjbfb,100),NVL(gcjcbjbfb,100),NVL(JLDW,'JLDW'),sl,zqsfje,dxzkl,sfje,bz,sffqsk,cbjjsfs";
		...
		ls_sql="insert into bj_sfxmmxh (zjxxh,khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfssjf,sfkdz,zdzk,sfbfb,dj,cbjbfb,sgcbjbfb,gcjcbjbfb,jldw,sl,zqsfje,dxzkl,sfje,bz,sffqsk,cbjjsfs)";
		ls_sql+=" select          '"+zjxxh+"',khbh,sfxmbm,sfxmmc,sflx,sfxmlx,sfcysgdjs,sfbxx,sfjrqye,jrsjbz,jrglfbz,sfssjf,sfkdz,NVL(zdzk,0),sfbfb,dj,NVL(cbjbfb,100),NVL(sgcbjbfb,100),NVL(gcjcbjbfb,100),NVL(JLDW,'JLDW'),sl,zqsfje,dxzkl,sfje,bz,sffqsk,cbjjsfs";
		ls_sql+=" from bj_sfxmmx ";
		ls_sql+=" where khbh='"+khbh+"' ";
		ps= conn.prepareStatement(ls_sql);
		...
		ls_sql+=" select            '"+zjxxh+"',khbh,tcbzjg,tcmjzjje,tczcsjcj,tczccljj,tcxsfzc,tczcjm,tcdpsj,tcdpdlsf,tcxpx,tcwsgzj,tcwgccljj,tcwzjzc,tcsgze,tcqtsf,zctcje,wntcje,jytcje,sctcje,jktcje";
