...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		ls_sql="SELECT ROUND(sum(bj_gclmx.sl*bj_jzglfxb.jqsfl),4) jqsfl,ROUND(sum(bj_gclmx.sl*bj_jzglfxb.bsfl),4) bsfl,ROUND(sum(bj_gclmx.sl*bj_jzglfxb.tvocsfl),4) tvocsfl";
