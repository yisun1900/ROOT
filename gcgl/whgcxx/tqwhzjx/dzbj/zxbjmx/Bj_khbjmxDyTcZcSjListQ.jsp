...
<%
		...
		String sjsfycx=null;
	int i=0;
	ls_sql="SELECT bj_khzcxmxjq.sjsfycx,jgwzbm,clxlmc,bj_khzcxmxjq.tcsjflbm,tcsjflmc,bzsl,sjsl,sjjshsl,bjjbmc,bj_khzcxmxjq.khbjjbbm,bj_khzcxmxjq.bjjbbm,bj_khzcxmxjq.sjsfsl,bj_khzcxmxjq.sjcj,bj_khzcxmxjq.sjsfje";
	ls_sql+=" FROM bj_khzcxmxjq,bj_tcsjflbm,jxc_clxlbm,bdm_bjjbbm ";
    ls_sql+=" where bj_khzcxmxjq.tcsjflbm=bj_tcsjflbm.tcsjflbm and bj_khzcxmxjq.tccplbbm=jxc_clxlbm.clxlbm";
    ls_sql+=" and bj_khzcxmxjq.bjjbbm=bdm_bjjbbm.bjjbbm ";
    ls_sql+=" and bj_khzcxmxjq.zjxxh='"+zjxxh+"' and bj_khzcxmxjq.khbjjbbm!=bj_khzcxmxjq.bjjbbm";
    ls_sql+=" and bj_khzcxmxjq.sfyxsj='Y' ";//升级是否收费  Y：是；N：否
	ls_sql+=" order by bj_khzcxmxjq.jgwzbm,bj_khzcxmxjq.tcsjflbm,bj_khzcxmxjq.tccplbbm";
	ps= conn.prepareStatement(ls_sql);
