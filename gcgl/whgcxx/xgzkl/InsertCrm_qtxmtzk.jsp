		...
		<tr align="center">
			<td>
                <select name="sfxmbm" style="FONT-SIZE:12PX;WIDTH:252PX">
				  <option value=''></option>
          <%
	cf.selectItem(out,"select sfxmbm,sfxmmc from bj_sfxmmx where khbh='"+khbh+"' and sfkdz='Y' and sfxmlx not in('5','6','7','8','A','B') order by sfxmbm",sfxmbm);
%> 
                </select>			</td>
			<td>
		...
		<tr align="center">
			<td>
                <select name="sfxmbm" style="FONT-SIZE:12PX;WIDTH:252PX">
				  <option value=''></option>
          <%
	cf.selectItem(out,"select sfxmbm,sfxmmc from bj_sfxmmx where khbh='"+khbh+"' and sfkdz='Y' and sfxmlx not in('5','6','7','8','A','B') order by sfxmbm","");
%> 
                </select>			</td>
			<td>
