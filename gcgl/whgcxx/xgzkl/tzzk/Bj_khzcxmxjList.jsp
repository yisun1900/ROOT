...
<%
	...
	ls_sql="SELECT jgwzbm,bj_khzcxmxj.tcsjflbm,tcsjflmc,'修改' xg,bj_khzcxmxj.tccplbbm,jxc_clxlbm.clxlmc,DECODE(sfbxx,'Y','是','N','否') sfbxx,DECODE(sfyxsj,'Y','收费','N','否') sfyxsj,a.bjjbmc khbjjbbm,b.bjjbmc,sjsfsl,DECODE(sjcj,0,'',sjcj) sjcj,DECODE(sjsfje,0,'',sjsfje) sjsfje,DECODE(sjsfycx,'1','无','2','无数量限制促销','3','有数量限制促销') sjsfycx  ,jldw,DECODE(bj_khzcxmxj.sfxzsl,'1','超量需加价','2','不可超量','3','无数量限制') sfxzsl,bzsl,DECODE(bj_khzcxmxj.sfkjm,'1','否','2','可以') sfkjm,bj_khzcxmxj.yxjmzdsl,jmdj,DECODE(sfkgh,'1','否','2','可换') sfkgh,khzdsl,ghzj,DECODE(sfyqxtpp,'Y','是','N','否') sfyqxtpp,sjsl,sjjshsl,sjjmsl,sjjmje";
...
//设置显示列
	String[] disColName={ "jgwzbm","tcsjflmc","clxlmc","xg","sfyxsj","khbjjbbm","bjjbmc","sjsfsl","sjcj","sjsfje","sjsfycx","sfbxx","jldw","sfxzsl","bzsl","sjsl","sjjshsl","sjjmsl","sjjmje","sfkjm","yxjmzdsl","jmdj","sfkgh","khzdsl","ghzj","sfyqxtpp"};
...
//设置列超级连接
	...
	String[] coluKey={"jgwzbm","tccplbbm"};//设置列参数：coluParm.key的主键
	coluParm.key=coluKey;//设置列参数：coluParm.key的主键
	coluParm.link="EditBj_khzcxmxj.jsp?khbh="+khbh;//为列参数：coluParm.link设置超级链接
