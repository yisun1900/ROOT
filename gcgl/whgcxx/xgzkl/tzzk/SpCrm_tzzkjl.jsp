...
try {
	...
	ls_sql="select khbh,tzyy,clzt,lrr,lrsj,dwmc,zklx,zdzk,gcfqdzk,glfzk,sjzk,sjfzk,qtsfxmzk,zjxzklx,tzhmll,spr,spsj,spsm ";
...
<div align="center">调整客户折扣－审批 </div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%=hdzsjz%></td><td align="right"><span class="STYLE2">特权赠送净值</span></td>
    <td><%=tqzsjz%></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
    <%
	cf.radioToken(out,"clzt","4+审批通过修改折扣&5+审批未通过","");
%>  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="spsm" cols="71" rows="2"><%=spsm%></textarea></td>
	...
	<div align="center">
	  ...
	  <input type="button" onClick="window.open('/dzbj/zxbjmx/ViewBj.jsp?khbh=<%=khbh%>')"  value="查看报价">
	  ...
	  <input type="button" onClick="f_bfdz(editform)"  value="部分工程项目打折">
      <input type="button" onClick="f_dxdz(editform)"  value="单个工程项目打折">
      <input type="button" onClick="f_qtdz(editform)"  value="其它收费项目打折">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveSpCrm_tzzkjl.jsp";
	FormName.submit();
	return true;
}
