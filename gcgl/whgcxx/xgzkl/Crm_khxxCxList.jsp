...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql=" SELECT hth,khxm,fwdz,fkcsmc,qye,zjxje,sfke,qyrq,sjjgrq,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,khbh ";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,cw_fkcs";
    ls_sql+=" where (crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+))";
    ls_sql+=" and crm_khxx.jzkfkcs=cw_fkcs.fkcs(+) and zt='2'";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertCrm_tzzkjlMain.jsp");
