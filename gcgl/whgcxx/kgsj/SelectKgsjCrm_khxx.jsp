...
<form method="post" action="Crm_khxxKgsjList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">开工时间</td>
              <td>
				<INPUT type="radio" name="kgsjqd" value="Y">已确定
				<INPUT type="radio" name="kgsjqd" value="N" checked>
				未确定			  </td>
