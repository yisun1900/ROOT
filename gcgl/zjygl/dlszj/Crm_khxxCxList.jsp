...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,sjs,kgrq,zjxm,sgdmc sgd,sgbz";
	ls_sql+=" ,DECODE(pdclzt,'1','申请派单','2','派单','3','拒绝派单','4','派单','5','保持原派','6','同意改派'),pdsj";
	ls_sql+=" ,a.dwmc sqdm,qyrq";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd  ";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) and zt='2' and gcjdbm not in('4','5')";
	ls_sql+=wheresql;
    ls_sql+=" order by pdclzt desc,pdsj desc,qyrq desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","","EditCrm_khxx.jsp");
	pageObj.setPageRow(50);//设置每页显示记录数
	pageObj.setEditStr("设工程担当");//设置每页显示记录数
/*
//设置显示列
