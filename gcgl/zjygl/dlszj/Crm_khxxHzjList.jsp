...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,DECODE(pdclzt,'1','申请派单','2','派单','3','拒绝派单','4','接受','5','保持原派','6','同意改派'),pdsj";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","","EditXgCrm_khxx.jsp");
	pageObj.setPageRow(50);//设置每页显示记录数
	pageObj.setEditStr("换工程担当");//设置每页显示记录数
/*
//设置显示列
