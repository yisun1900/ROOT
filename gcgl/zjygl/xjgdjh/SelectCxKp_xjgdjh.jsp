...
<form method="post" action="Kp_xjgdjhCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="kp_xjgdjh_xjr" value="<%=yhmc%>" size="20" maxlength="20" <% if (!yhmc.equals("")) out.println("readonly");%>>
              </td>
              <td width="18%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="31%"> 
                <input type="text" name="kp_xjgdjh_lrr" size="20" maxlength="20" >
              </td>
              <td width="18%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="kp_xjgdjh_wcbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"1+设置计划&2+完成计划&3+未完成","");
%> 
                </select>
              </td>
            </tr>
