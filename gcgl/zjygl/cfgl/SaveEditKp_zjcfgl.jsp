...
String wherecfjlh=null;
wherecfjlh=cf.GB2Uni(request.getParameter("wherecfjlh"));
Connection conn  = null;
PreparedStatement ps=null;
String ls_sql=null;
try {
	conn=cf.getConnection();
	ls_sql="update kp_zjcfgl set cfjlh=?,zjxm=?,fgsbh=?,cfr=?,cfsj=?,cflxbm=?,cfyybm=?,fkze=?,kf=?,lrr=?,lrsj=?,lrdw=?,bz=? ";
