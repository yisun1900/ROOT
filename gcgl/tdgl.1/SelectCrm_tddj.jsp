...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">是否退回全部礼品</td>
              <td width="32%"> 
                <input type="radio" name="sfthlp" value="Y">退回
                <input type="radio" name="sfthlp" value="N">未退回
                <input type="radio" name="sfthlp" value="W">未领礼品
              </td>
              <td width="18%">&nbsp;</td>
              <td width="32%">&nbsp;</td>
            </tr>
