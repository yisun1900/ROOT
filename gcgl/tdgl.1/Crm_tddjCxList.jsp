...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_tddj.tdxh as tdxh,DECODE(crm_tddj.sfthlp,'Y','退回','N','未退回','W','未领礼品') sfthlp,crm_tddj.tdsj,crm_tddj.lrr,crm_tddj.lrsj,crm_tddj.khbh as khbh,crm_tddj.khxm as crm_tddj_khxm,crm_tddj.fwdz as crm_tddj_fwdz,crm_tddj.sjs as crm_tddj_sjs,crm_tddj.zjxm as crm_tddj_zjxm,sgdmc as crm_tddj_sgd,qye,guanlif,suijin,qye+NVL(guanlif,0)+NVL(suijin,0) zs,qyrq,a.dwmc as sq_dwxx_dwmc,dm_tdyybm.tdyymc as dm_tdyybm_tdyymc,crm_tddj.tdyysm,crm_tddj.ytje as crm_tddj_ytje,crm_tddj.stje as crm_tddj_stje  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tddjCxList.jsp","SelectCxCrm_tddj.jsp","","");
//	pageObj.setPageRow(10);//设置每页显示记录数
//设置显示列
	String[] disColName={"tdxh","sfthlp","crm_tddj_khxm","crm_tddj_fwdz","crm_tddj_sjs","crm_tddj_zjxm","crm_tddj_sgd","zs","qye","guanlif","suijin","qyrq","tdsj","lrr","lrsj","sq_dwxx_dwmc","dm_tdyybm_tdyymc","tdyysm","crm_tddj_ytje","crm_tddj_stje"};
