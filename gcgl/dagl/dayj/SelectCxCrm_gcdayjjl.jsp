...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_gcdayjjlCxList.jsp" name="selectform">
<div align="center">档案出借记录查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">档案袋编号</td> 
  <td width="32%"><input name="dadbh" type="text" value="" size="20" maxlength="20"></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">档案明细</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">借阅人</td> 
  <td width="32%"> 
    <input type="text" name="jyr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">借阅人所属部门</td> 
  <td width="32%">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">归还录入人</td> 
  <td width="32%"> 
    <input type="text" name="ghlrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">归还录入人所属部门</td> 
  <td width="32%">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
	<INPUT type="radio" name="zt" value="1">借出
    <INPUT type="radio" name="zt" value="2">归返  
  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jysj2, "借阅时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.ghlrsj, "归还录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.ghlrsj2, "归还录入时间"))) {
		return false;
	}
