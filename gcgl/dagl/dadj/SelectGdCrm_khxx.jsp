...
<form method="post" action="Crm_khxxGdList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">家居完结标志</td>
              <td><input type="radio" name="jjwjbz" value="Y">
                完结
                <input type="radio" name="jjwjbz" value="N">
                未完结 </td>
              <td align="right">材料员</td>
              <td><input type="text" name="clgw" size="20" maxlength="20" value=""  ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">家居完结时间 从</td>
              <td><input type="text" name="jjwjsj" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
              <td><input type="text" name="jjwjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.jjwjsj, "家居完结时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.jjwjsj2, "家居完结时间"))) {
		return false;
	}
