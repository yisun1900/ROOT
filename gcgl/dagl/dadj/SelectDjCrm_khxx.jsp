          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td colspan="3">
				...
				<input type="radio" name="dalqbz" value="3">已归档			</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">家居完结标志</td>
              <td>
                <input type="radio" name="jjwjbz" value="Y">完结
                <input type="radio" name="jjwjbz" value="N">未完结              </td>
