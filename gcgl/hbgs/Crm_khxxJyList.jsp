...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,DECODE(sfcjq,'1','不需要','2','<font color=\"#FF0000\">需要</font>','3','<font color=\"#00FF00\">已完成</font>'),DECODE(sffby,'1','不需要','2','<font color=\"#FF0000\">需要</font>','3','<font color=\"#00FF00\">已完成</font>'),hbqye,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,jgrq";
    ...
    ls_sql+=" and (crm_khxx.sffby='2' or crm_khxx.sfcjq='2') and zt='2'";
    ls_sql+=wheresql;
...
//进行对象初始化
	pageObj.initPage("Crm_khxxJyList.jsp","SelectDjCrm_khxx.jsp","InsertCrm_gcjddjjl.jsp","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">是否除甲醛</td>
	<td  width="3%">是否防白蚁</td>
	<td  width="4%">环保项目签约额</td>
	<td  width="3%">停工</td>
	<td  width="4%">工程进度</td>
	<td  width="6%">隐蔽工程验收</td>
	<td  width="6%">中期验收</td>
	<td  width="15%">房屋地址</td>
	<td  width="10%">联系方式</td>
	<td  width="3%">设计师</td>
