...
//以上
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,DECODE(kgzbz,'Y','已出','N','<font color=\"#FF00FF\">未出</font>'),DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>'),ysgcjdmc,DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,crm_khxx.cxhdbm,crm_khxx.hth,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,DECODE(crm_khxx.gcsfyq,'1','未延期','2','延期'),crm_khxx.yqts,DECODE(czkbz,'0','','1','<font color=\"#FF0000\">未审核</font>','2','<font color=\"#00FF00\">已审核</font>'),zkl,ywy,a.dwmc qydm,crm_khxx.qyrq,jgrq,khlxmc";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxComList.jsp","SelectComCrm_khxx.jsp","","");
