...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		if (crm_khxx_wgbz.equals("1"))//1+未开工&2+已开工&3+已完工
		{
			wheresql+=" and  (crm_khxx.gcjdbm='1')";
		}
		else if (crm_khxx_wgbz.equals("2"))//1+未开工&2+已开工&3+已完工
		{
			wheresql+=" and  (crm_khxx.gcjdbm in('2','3','4'))";
		}
		else if (crm_khxx_wgbz.equals("3"))//1+未开工&2+已开工&3+已完工
		{
...
//显示风格
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm, crm_khxx.fwdz,crm_khxx.qyrq,crm_khxx.kgrq,crm_khxx.sjkgrq,crm_khxx.jgrq,crm_khxx.sjf,crm_khxx.glf,a.dwmc";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxListfwf.jsp","SelectCrm_khxxfwf.jsp","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">实际开工日期</td>
	<td  width="6%">合同竣工日期</td>
	<td  width="6%">设计费</td>
	<td  width="6%">服务费</td>
	<td  width="8%">签约店面</td>
</tr>
