...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">签单客户--查询毛利</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_khxxCxMlList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                ...
                <select name="tj1" style="FONT-SIZE:12PX;WIDTH:100PX" onChange="tj1name.value=tj1.options[tj1.selectedIndex].text">
                  <option value=""></option>
                  <option value="a.dwmc">所属分公司</option>
                  <option value="b.dwmc">店面</option>
                  <option value="khjl">客户经理</option>
                  <option value="sjs">设计师</option>
                  <option value="ysy">预算员</option>
                  <option value="sgdmc">施工队</option>
                  <option value="DECODE(sq_sgd.sgdlx,'S0','非直属','S1','直属')">施工队类型</option>
                  <option value="zjxm">工程担当</option>
                  <option value="ysgcjdmc">工程进度</option>
                  <option value="khlxmc">关系客户</option>
                  <option value="cqmc">城区</option>
                  <option value="xqbm">小区</option>
                  <option value="nlqjmc">年龄区间</option>
                  <option value="ysrmc">月收入</option>
                  <option value="zymc">职业</option>
                  <option value="hxmc">户型</option>
                  <option value="cxhdbm">参加促销活动</option>
                  <option value="DECODE(crm_khxx.jzbz,'1','家装','2','公装')">家装标志 
                  <option value="DECODE(crm_khxx.sffj,'Y','是','N','否')">是否返券 
                  <option value="DECODE(crm_khxx.sfyrz,'Y','是','N','否')">是否已认证 
                  <option value="c.dwmc">认证市场</option></option>
                </select>
                第二列 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="统计表" onClick="f_do(selectform,'tj')" >              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">合同毛利率 从 </span></td>
              <td><input name="mll" type="text" id="mll" size="10" maxlength="16" >
                百分比</td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="mll2" type="text" id="mll2" size="10" maxlength="16" >
              百分比</td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">合同毛利额 从</span></td>
              <td><input name="mle" type="text" id="mle" size="20" maxlength="16" ></td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="mle2" type="text" id="mle2" size="20" maxlength="16" ></td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">业绩净值参数 从</span></td>
              <td><input name="yjjzcs" type="text" id="yjjzcs" size="10" maxlength="16" >
              百分比</td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="yjjzcs2" type="text" id="yjjzcs2" size="10" maxlength="16" >
              百分比</td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">最新毛利率 从 </span></td>
              <td><input name="zxmll" type="text"  size="10" maxlength="16" >
                百分比</td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="zxmll2" type="text"  size="10" maxlength="16" >
                百分比</td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">最新毛利额 从</span></td>
              <td><input name="zxmle" type="text"  size="20" maxlength="16" ></td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="zxmle2" type="text"  size="20" maxlength="16" ></td>
            </tr>
            
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">毛利率差额 从</span></td>
              <td><input name="mllce" type="text"  size="10" maxlength="16" >
百分比</td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="mllce2" type="text"  size="10" maxlength="16" >
百分比</td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
          ...
          <table width="100%" border="0" style="FONT-SIZE:12;display:none" id="id1" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="统计表" onClick="f_do(selectform,'tj')" >
              </td>
            </tr>
          </table>
</form>
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.mll2, "毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.mle, "毛利额"))) {
		return false;
	}
	if(!(isFloat(FormName.mle2, "毛利额"))) {
		return false;
	}
	if(!(isFloat(FormName.yjjzcs, "业绩净值参数"))) {
		return false;
	}
	if(!(isFloat(FormName.yjjzcs2, "业绩净值参数"))) {
		return false;
	}
	
	if(!(isFloat(FormName.zxmll, "最新毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmll2, "最新毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmle, "最新毛利额"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmle2, "最新毛利额"))) {
		return false;
	}
	if(!(isFloat(FormName.mllce, "毛利率差额"))) {
		return false;
	}
	if(!(isFloat(FormName.mllce2, "毛利率差额"))) {
		return false;
	}
	...
	if (lx=='gccx')
	{
		...
		{
			FormName.action="Crm_khxxCxMlList.jsp";
		}
		else
		{
			if(	javaTrim(FormName.jcjjcp)=="") {
				alert("请输入[订购产品类型]！");
				FormName.jcjjcp.focus();
				return false;
			}
