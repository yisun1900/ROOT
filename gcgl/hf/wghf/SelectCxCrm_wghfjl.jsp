...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_wghfjlCxList.jsp" name="selectform">
<div align="center">完工回访－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="crm_wghfjl_hfjlh" size="20" maxlength="9" >  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
    <INPUT type="radio" name="crm_wghfjl_hfsfcg" value="Y">成功
    <INPUT type="radio" name="crm_wghfjl_hfsfcg" value="N">失败  </td> 
  <td align="right" width="18%">回访人</td> 
  <td width="32%"> 
    <input type="text" name="crm_wghfjl_hfr" size="20" maxlength="20" >  </td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">回访时间 从</td> 
  <td width="32%"><input type="text" name="crm_wghfjl_hfsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_wghfjl_hfsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从    </td>
  <td><input type="text" name="crm_wghfjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_wghfjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="crm_wghfjl_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"><select name="crm_wghfjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
{
	if(!(isDatetime(FormName.crm_wghfjl_hfsj, "回访时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_wghfjl_hfsj2, "回访时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_wghfjl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_wghfjl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
