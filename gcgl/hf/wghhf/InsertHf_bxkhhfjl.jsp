...
<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
  <div align="center">完工后关怀回访（回访记录号：<%=hfjlh%>） </div>

<form method="post" action="SaveInsertHf_bxkhhfjl.jsp" name="insertform">
...
<%
	...
	ls_sql="SELECT hf_bxkhhfjl.hfjlh,hfjgmc,hfwtmc,DECODE(hf_bxkhhfjl.wtclzt,'1','未处理','2','在处理','3','已解决'),hf_bxkhhfjl.hfr,hf_bxkhhfjl.hfsj,hf_bxkhhfjl.hfsm ";
	ls_sql+=" FROM hf_bxkhhfjl,dm_hfjgbm,dm_hfwtbm  ";
    ls_sql+=" where hf_bxkhhfjl.hfjgbm=dm_hfjgbm.hfjgbm(+)";
    ls_sql+=" and hf_bxkhhfjl.hfwtbm=dm_hfwtbm.hfwtbm(+)";
    ls_sql+=" and hf_bxkhhfjl.khbh='"+khbh+"'";
