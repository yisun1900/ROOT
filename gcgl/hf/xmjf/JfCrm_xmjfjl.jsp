...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveJfCrm_xmjfjl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="xmjfr" size="20" maxlength="20"  value="<%=yhmc%>" ></td>
  <td align="right"><span class="STYLE1">*</span><span class="STYLE2">项目交付时间</span></td>
  <td><input type="text" name="xmjfsj" size="20" maxlength="10"  value="<%=cf.today()%>" ></td>
</tr>
<tr bgcolor="#FFFFFF">
