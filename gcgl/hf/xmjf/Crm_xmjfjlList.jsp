...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (crm_xmjfjl_clzt!=null)
	{
		...
		if (!(crm_xmjfjl_clzt.equals("")))	wheresql+=" and  (crm_khxx.xmjfzt='"+crm_xmjfjl_clzt+"')";
	}
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xmjfjlList.jsp","","","EditCrm_xmjfjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_xmjfjl.jsp?"};//按钮单击调用的网页，可以增加参数
