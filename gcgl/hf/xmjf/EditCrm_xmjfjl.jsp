...
try {
	...
	ls_sql="select jfjlh,khbh,xmjfr,xmjfsj,xmjfsm,lrr,lrsj ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCrm_xmjfjl.jsp" name="editform">
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE1">*</span><span class="STYLE2">交付记录号</span></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="xmjfr" size="20" maxlength="20"  value="<%=xmjfr%>" >  </td>
  <td align="right" width="18%"><span class="STYLE1">*</span>交付时间</td> 
  <td width="32%"> 
    <input type="text" name="xmjfsj" size="20" maxlength="10"  value="<%=xmjfsj%>" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">交付说明</td> 
  <td colspan="3"> 
    <textarea name="xmjfsm" cols="71" rows="3"><%=xmjfsm%></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
