...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xmjfjlCxList.jsp" name="selectform">
<div align="center">项目交付－查询</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%">
    <INPUT type="radio" name="crm_xmjfjl_hfsfcg" value="Y">成功
    <INPUT type="radio" name="crm_xmjfjl_hfsfcg" value="N">失败
  </td> 
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<INPUT type="radio" name="crm_xmjfjl_clzt" value="S">交付
	<INPUT type="radio" name="crm_xmjfjl_clzt" value="Y">回访成功
	<INPUT type="radio" name="crm_xmjfjl_clzt" value="X">回访失败
	<INPUT type="radio" name="crm_xmjfjl_clzt" value="W">项目交付
  </td>
  </tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="crm_xmjfjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
{
	if(!(isDatetime(FormName.crm_xmjfjl_yjfsj, "交付时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_xmjfjl_yjfsj2, "交付时间"))) {
		return false;
	}
