...
try {
	...
	int count=0;
	ls_sql="select NVL(max(substr(jfjlh,8,3)),0)";
	...
	jfjlh=khbh+cf.addZero(count+1,3);
}
catch (Exception e) {
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_xmjfjl.jsp" name="insertform"  >
<div align="center">项目交付</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span><span class="STYLE2">交付记录号</span></td> 
  <td width="32%"> 
    <input type="text" name="jfjlh" value="<%=jfjlh%>" size="20" maxlength="9" readonly>  </td>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>交付人</td> 
  <td width="32%"> 
    <input type="text" name="xmjfr" value="<%=yhmc%>" size="20" maxlength="20" >  </td>
  <td align="right" width="18%"><span class="STYLE1">*</span>交付时间</td> 
  <td width="32%"> 
    <input type="text" name="xmjfsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">交付说明</td> 
  <td colspan="3"> 
    <textarea name="xmjfsm" cols="71" rows="3"></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.xmjfsj, "交付时间"))) {
		return false;
	}
