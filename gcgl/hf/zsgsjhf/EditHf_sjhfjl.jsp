...
<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
  <div align="center">随机回访记录－修改</div>

<form method="post" action="SaveEditHf_sjhfjl.jsp" name="insertform" >
...
<table width="100%" border="1" style="FONT-SIZE:12" cellpadding="1" cellspacing="0">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
      ...
      <tr bgcolor="#FFFFFF">
		...
		<input type="hidden" name="xchflxbm" value="<%=xchflxbm%>" size="20" maxlength="10"  >
        <input type="hidden" name="xchfrq" value="<%=xchfrq%>" size="20" maxlength="10"  >		</td>
...
%>
        ...
        <td width="33%" rowspan="5"><select name="zrbm" style="FONT-SIZE:12PX;WIDTH:252PX" size="11" multiple>
          <option value=""></option>
          <%
	...
	cf.mutilSelectItem(out,sql,"select zrbm from hf_sjhfwtbm where hfjlh='"+hfjlh+"'");
%>
        </select></td>
      </tr>
    <tr bgcolor="#FFFFFF"> 
