...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hf_sjhfjl.hfjlh,hflxmc,hfjgmc,hfwtmc,DECODE(hf_sjhfjl.wtclzt,'1','未处理','2','在处理','3','已解决'),hf_sjhfjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.gj,crm_khxx.dd,hf_sjhfjl.hfr,hf_sjhfjl.hfsj,hf_sjhfjl.hfsm, hf_sjhfjl.lrr,hf_sjhfjl.lrsj,dwmc ";
	ls_sql+=" FROM crm_khxx,hf_sjhfjl,dm_hfjgbm,dm_hfwtbm,sq_sgd,sq_dwxx,dm_hflxbm  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hf_sjhfjlList.jsp","","","EditHf_sjhfjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteHf_sjhfjl.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">随机回访记录－修改</font></B>
</CENTER>
<%
	pageObj.out=out;
