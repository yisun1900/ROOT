...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hf_sjhfjl.hfjlh,hflxmc,hf_sjhfwtbm.zrbm,dwmc,hfjgmc,hfwtmc,DECODE(hf_sjhfjl.wtclzt,'1','未处理','2','在处理','3','已解决') wtclzt,hf_sjhfjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.zjxm,hf_sjhfjl.hfr,hf_sjhfjl.hfsj,hf_sjhfjl.hfsm, hf_sjhfjl.lrr,hf_sjhfjl.lrsj ";
	ls_sql+=" FROM crm_khxx,hf_sjhfjl,dm_hfjgbm,dm_hfwtbm,sq_sgd,sq_dwxx,dm_hflxbm,hf_sjhfwtbm  ";
    ...
    ls_sql+=" and hf_sjhfjl.hflxbm=dm_hflxbm.hflxbm(+)";
    ls_sql+=" and hf_sjhfjl.hfjlh=hf_sjhfwtbm.hfjlh(+)";
    ls_sql+=" and hf_sjhfwtbm.zrbm=sq_dwxx.dwbh(+)";
    ls_sql+=" and hf_sjhfjl.wtclzt in('3')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by lrsj desc,hf_sjhfjl.hfjlh,hf_sjhfwtbm.zrbm";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hf_sjhfjlXgClList.jsp","","","ClHf_sjhfjl.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数

//设置显示列
	String[] disColName={"hfjlh","hflxmc","dwmc","hfjgmc","hfwtmc","wtclzt","khbh","khxm","fwdz","hth","sjs","sgdmc","zjxm","hfr","hfsj","hfsm","lrr","lrsj"};
	pageObj.setDisColName(disColName);


//设置主键
	String[] keyName={"hfjlh","zrbm"};
...
<CENTER >
  <B><font size="3">随机回访问题－修改处理</font></B>
</CENTER>
<%
	pageObj.out=out;
