...
<%
	...
	String getlrr=null;
	String getbz=null;
	ls_sql="select hf_sjhfwtbm.zrbm,dwmc,DECODE(hf_sjhfcljl.sfjj,'1','未处理','2','在处理','3','已解决') sfjj,hf_sjhfcljl.clr,hf_sjhfcljl.clsj,hf_sjhfcljl.clsm,hf_sjhfcljl.lrr,hf_sjhfcljl.bz";
