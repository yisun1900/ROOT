...
try {
	...
	ls_sql="insert into hf_sjhfcljl (hfjlh,zrbm,khbh,sfjj,clr,clsj,clsm,lrr,lrsj,lrbm,bz)";
	...
	ls_sql="update hf_sjhfwtbm set clzt=?";
	...
	ls_sql="update hf_sjhfjl set wtclzt=?";
