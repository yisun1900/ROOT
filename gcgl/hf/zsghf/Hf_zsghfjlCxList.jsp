...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hf_zsghfjl.hfjlh,a.hflxmc,hfjgmc,hfwtmc,DECODE(hf_zsghfjl.wtclzt,'1','未处理','2','在处理','3','已解决'),hf_zsghfjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.lxfs,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.gj,crm_khxx.dd,hf_zsghfjl.hfr,hf_zsghfjl.hfsj,hf_zsghfjl.hfsm,b.hflxmc xchflxbm,hf_zsghfjl.xchfrq,hf_zsghfjl.lrr,hf_zsghfjl.lrsj,dwmc ";
