...
<body bgcolor="#FFFFFF">
<form method="post" action="Hf_zsghfjlXgClList.jsp" name="selectform">
<div align="center">回访问题－修改处理</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="hf_zsghfjl_hfjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">回访人</td> 
  <td width="32%"><input type="text" name="hf_zsghfjl_hfr" size="20" maxlength="20" ></td>
</tr>


<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">回访时间 从</td> 
  <td width="32%"><input type="text" name="hf_zsghfjl_hfsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="hf_zsghfjl_hfsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="hf_zsghfjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="hf_zsghfjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="hf_zsghfjl_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"><select name="hf_zsghfjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
{
	if(!(isDatetime(FormName.hf_zsghfjl_hfsj, "回访时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.hf_zsghfjl_hfsj2, "回访时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.hf_zsghfjl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.hf_zsghfjl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
