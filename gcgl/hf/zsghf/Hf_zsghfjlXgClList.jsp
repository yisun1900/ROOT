...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hf_zsghfjl.hfjlh,hflxmc,hf_zsghfwtbm.zrbm,dwmc,hfjgmc,hfwtmc,DECODE(hf_zsghfjl.wtclzt,'1','未处理','2','在处理','3','已解决') wtclzt,hf_zsghfjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.zjxm,hf_zsghfjl.hfr,hf_zsghfjl.hfsj,hf_zsghfjl.hfsm, hf_zsghfjl.lrr,hf_zsghfjl.lrsj ";
	ls_sql+=" FROM crm_khxx,hf_zsghfjl,dm_hfjgbm,dm_hfwtbm,sq_sgd,sq_dwxx,dm_hflxbm,hf_zsghfwtbm  ";
    ...
    ls_sql+=" and hf_zsghfjl.hfjlh=hf_zsghfwtbm.hfjlh(+)";
    ls_sql+=" and hf_zsghfwtbm.zrbm=sq_dwxx.dwbh(+)";
    ls_sql+=" and hf_zsghfjl.wtclzt in('3')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by lrsj desc,hf_zsghfjl.hfjlh,hf_zsghfwtbm.zrbm";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Hf_zsghfjlXgClList.jsp","","","ClHf_zsghfjl.jsp");
...
<CENTER >
  <B><font size="3">回访问题－修改处理</font></B>
</CENTER>
<%
	pageObj.out=out;
