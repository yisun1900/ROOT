...
try {
	...
	ls_sql="select khbh,hf_zsghfjl.hflxbm,hfr,hfsj,hfsm,hfjgmc,hfwtmc,DECODE(wtclzt,'1','未处理','2','在处理','3','已解决') wtclzt,lrr,lrsj,lrbm,hf_zsghfjl.xchfrq,hf_zsghfjl.xchflxbm,hfszjlh";
...
<form method="post" action="SaveClHf_zsghfjl.jsp" name="insertform">
  
  <div align="center">回访问题－处理（回访记录号：<%=hfjlh%>）</div>
...
<%
	...
	String getlrr=null;
	String getbz=null;
	ls_sql="select dwmc,DECODE(hf_zsghfcljl.sfjj,'1','未处理','2','在处理','3','已解决') sfjj,hf_zsghfcljl.clr,hf_zsghfcljl.clsj,hf_zsghfcljl.clsm,hf_zsghfcljl.lrr,hf_zsghfcljl.bz";
