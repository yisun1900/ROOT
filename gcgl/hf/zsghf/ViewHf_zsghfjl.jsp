...
<%
	...
	String getlrr=null;
	String getbz=null;
	ls_sql="select hf_zsghfwtbm.zrbm,dwmc,DECODE(hf_zsghfcljl.sfjj,'1','未处理','2','在处理','3','已解决') sfjj,hf_zsghfcljl.clr,hf_zsghfcljl.clsj,hf_zsghfcljl.clsm,hf_zsghfcljl.lrr,hf_zsghfcljl.bz";
