...
<%
	...
	String yhmc=cf.fillNull(cf.executeQuery("select yhmc from sq_yhxx where zwbm='10' and yhdlm='"+yhdlm+"'"));
%>
...
%> 
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="18%" align="right">应回访日期 从</td>
              <td width="32%"> 
                <input type="text" name="hfrq" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)">              </td>
              <td width="15%" align="right">到</td>
              <td width="35%"> 
                <input type="text" name="hfrq2" size="20" maxlength="10" value="<%=cf.today()%>" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
              <td width="18%" align="right">项目专员</td>
              <td width="32%"> 
                <input type="text" name="xmzy" size="20" maxlength="20" value="<%=yhmc%>">
              </td>
