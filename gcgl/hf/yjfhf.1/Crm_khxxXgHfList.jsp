...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and (crm_khxx.xmjfzt='Y' OR crm_khxx.xmjfzt='X')";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_khxx.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgHfList.jsp","","","EditHf_khhfjg.jsp");
