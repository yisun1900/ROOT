...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_xmjfjl.jfjlh,DECODE(crm_xmjfjl.clzt,'S','预交付','Y','回访成功','X','回访失败','W','项目交付'),crm_xmjfjl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.gj,crm_khxx.dd,crm_xmjfjl.yjfr,crm_xmjfjl.yjfsj,crm_xmjfjl.yjfsm, crm_xmjfjl.lrr,crm_xmjfjl.lrsj,dwmc ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertHf_khhfjg.jsp");
