...
try {
	...
	ls_sql="select xmjfzt,khjl,gj,dd,fgsbh,khxm,fwdz,hth,sjs,crm_khxx.dwbh,dwmc,qyrq,jyjdrq,kgrq,jgrq,sjkgrq,sjjgrq,gcjdbm,sjwjrq,sybgcrq,szqsj   ,pdr,pdsj,jlbz,sgd,sgbz,zjxm";
	...
	if (!xmjfzt.equals("N") && !xmjfzt.equals("X") && !xmjfzt.equals("T"))
	{
	...
	int count=0;
	ls_sql="select NVL(max(substr(yjfjlh,8,3)),0)";
	...
	yjfjlh=khbh+cf.addZero(count+1,3);
}
catch (Exception e) {
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_xmyjfjl.jsp" name="insertform"  >
<div align="center">项目预交付</div>
...
//设置列超级连接
	...
	coluParm.link="/gcgl/hf/wghf/ViewCrm_wghfjl.jsp";//为列参数：coluParm.link设置超级链接
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="yjfjlh" value="<%=yjfjlh%>" size="20" maxlength="9" readonly>  </td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="yjfr" value="<%=yhmc%>" size="20" maxlength="20" >  </td>
  <td align="right" width="18%"><span class="STYLE1">*</span>预交付时间</td> 
  <td width="32%"> 
    <input type="text" name="yjfsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">预交付说明</td> 
  <td colspan="3"> 
    <textarea name="yjfsm" cols="71" rows="3"></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
