...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xmyjfjlCxList.jsp" name="selectform">
<div align="center">项目预交付－查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">预交付记录号</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmyjfjl_yjfjlh" size="20" maxlength="9" >  </td>
  <td align="right" width="18%">预交付人</td> 
  <td width="32%"><input type="text" name="crm_xmyjfjl_yjfr" size="20" maxlength="20" ></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">预交付时间 从</td> 
  <td width="32%"><input type="text" name="crm_xmyjfjl_yjfsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_xmyjfjl_yjfsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right">录入人</td>
  <td><input type="text" name="crm_xmyjfjl_lrr" size="20" maxlength="20" ></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="crm_xmyjfjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_xmyjfjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
...
{
	if(!(isDatetime(FormName.crm_xmyjfjl_yjfsj, "预交付时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_xmyjfjl_yjfsj2, "预交付时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_xmyjfjl_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_xmyjfjl_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
