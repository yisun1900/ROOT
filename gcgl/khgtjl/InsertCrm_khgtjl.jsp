...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_khgtjl.jsp" name="insertform" >
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE2">登记编号</span></td> 
  <td width="35%"> 
    <input type="text" name="djbh" value="<%=djbh%>" size="20" maxlength="10" readonly>  </td>
  <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE2">客户编号</span></td> 
  <td width="35%"> 
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="gtr" value="<%=yhmc%>" size="20" maxlength="20" >  </td>
  <td align="right" width="15%"><span class="STYLE1">*</span>沟通时间</td> 
  <td width="35%"> 
    <input type="text" name="gtsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>情况说明</td> 
  <td colspan="3"> 
    <textarea name="qksm" cols="72" rows="6"></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
...
%> 
  ...
  <td width="35%"><input type="radio" name="sfxcl"  value="N">
    不需处理
      <input type="radio" name="sfxcl"  value="Y">
      需处理 </td>
</tr>
    <tr align="center"> 
      <td colspan="4"> 
