...
try {
	...
	ls_sql="select cplx,cpazlx,ghf,jgpp,ghfhzsj,sfxdd,sfxhxgl,zxsfwz,cpsjs,sfxfb,sfxwx,sfyyc,sfxtx,txrq,txxs,txnr,cpztbm,lrr,lrsj,lrbm,bz ";
	...
	if (rs.next())
	{
		...
		sfxwx=cf.fillNull(rs.getString("sfxwx"));
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right"><span class="STYLE1">*</span>计划安装时间</td>
...
function f_lr(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="InsertCrm_cpztgzjl.jsp";
	FormName.submit();
	return true;
}
function f_ck(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_cpztgzjlList.jsp";
	FormName.submit();
	return true;
}
//-->
