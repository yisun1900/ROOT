...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveAzCrm_fbdgl.jsp" name="editform">
<div align="center">返补维修单－－安装（返补单编号：<%=fbdbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="sjazsj" size="20" maxlength="10"  value="<%=cf.today()%>" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>安装是否成功</td>
  <td><input type="radio" name="azsfcg" value="Y">成功
    <input type="radio" name="azsfcg" value="N">否</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="azqksm" cols="71" rows="3"></textarea></td>
  </tr>
