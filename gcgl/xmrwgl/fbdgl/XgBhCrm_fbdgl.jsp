...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgBhCrm_fbdgl.jsp" name="editform">
<div align="center">返补维修单－－修改备货（返补单编号：<%=fbdbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font>计划安装时间</td>
  <td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><font color="#FF0000">*</font><font color="#0000CC">备货录入人</font></td>
  <td><input type="text" name="bhlrr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>  </td>
  <td align="right"><font color="#FF0000">*</font><font color="#0000CC">备货完成日期</font></td>
  <td><input type="text" name="bhwcrq" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>  </td>
</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.bhlrr)=="") {
		alert("请输入[备货录入人]！");
		FormName.bhlrr.focus();
		return false;
	}
	if(	javaTrim(FormName.bhwcrq)=="") {
		alert("请输入[备货完成日期]！");
		FormName.bhwcrq.focus();
		return false;
	}
	if(!(isDatetime(FormName.bhwcrq, "备货完成日期"))) {
		return false;
	}
