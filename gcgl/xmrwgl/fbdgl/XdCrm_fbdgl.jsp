...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXdCrm_fbdgl.jsp" name="editform">
<div align="center">返补维修单－－下单（返补单编号：<%=fbdbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%"><font color="#0000CC">计划安装时间</font></td> 
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font><font color="#0000CC">下单人</font></td> 
  <td width="32%"> 
    <input type="text" name="xdr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>  </td>
  <td align="right" width="18%"><font color="#FF0000">*</font><font color="#0000CC">返补单下单日期</font></td> 
  <td width="32%"> 
    <input type="text" name="xdsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly>  </td>
</tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.xdsj, "返补单下单日期"))) {
		return false;
	}
