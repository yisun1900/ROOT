...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_fbdglXgXdList.jsp","","","");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_fbdglXgXdList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_fbdgl set xdr=null,xdsj=null,zt='2' where zt='3' and "+chooseitem;
...
<CENTER >
  <B><font size="3">返补维修单－－修改下单</font></B>
</CENTER>
<%
	pageObj.out=out;
