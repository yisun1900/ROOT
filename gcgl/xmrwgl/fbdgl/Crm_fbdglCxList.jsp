...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String crm_fbdgl_cpkf=null;
	String crm_fbdgl_fssj=null;
	String crm_fbdgl_cplhsj=null;
	...
	String crm_fbdgl_xdr=null;
	String crm_fbdgl_bhwcrq=null;
	String crm_fbdgl_bhlrr=null;
	String crm_fbdgl_sjazsj=null;
	String crm_fbdgl_azlrr=null;
	String crm_fbdgl_azsfcg=null;
	...
	crm_fbdgl_cpkf=request.getParameter("crm_fbdgl_cpkf");
	if (crm_fbdgl_cpkf!=null)
	{
		crm_fbdgl_cpkf=cf.GB2Uni(crm_fbdgl_cpkf);
		if (!(crm_fbdgl_cpkf.equals("")))	wheresql+=" and  (crm_fbdgl.cpkf='"+crm_fbdgl_cpkf+"')";
	}
	...
	crm_fbdgl_cplhsj=request.getParameter("crm_fbdgl_cplhsj");
	if (crm_fbdgl_cplhsj!=null)
	{
		crm_fbdgl_cplhsj=crm_fbdgl_cplhsj.trim();
		if (!(crm_fbdgl_cplhsj.equals("")))	wheresql+="  and (crm_fbdgl.cplhsj=TO_DATE('"+crm_fbdgl_cplhsj+"','YYYY/MM/DD'))";
	}
	...
	crm_fbdgl_xdr=request.getParameter("crm_fbdgl_xdr");
	if (crm_fbdgl_xdr!=null)
	{
		crm_fbdgl_xdr=cf.GB2Uni(crm_fbdgl_xdr);
		if (!(crm_fbdgl_xdr.equals("")))	wheresql+=" and  (crm_fbdgl.xdr='"+crm_fbdgl_xdr+"')";
	}
	...
	crm_fbdgl_bhlrr=request.getParameter("crm_fbdgl_bhlrr");
	if (crm_fbdgl_bhlrr!=null)
	{
		crm_fbdgl_bhlrr=cf.GB2Uni(crm_fbdgl_bhlrr);
		if (!(crm_fbdgl_bhlrr.equals("")))	wheresql+=" and  (crm_fbdgl.bhlrr='"+crm_fbdgl_bhlrr+"')";
	}
	crm_fbdgl_sjazsj=request.getParameter("crm_fbdgl_sjazsj");
	if (crm_fbdgl_sjazsj!=null)
	{
		crm_fbdgl_sjazsj=crm_fbdgl_sjazsj.trim();
		if (!(crm_fbdgl_sjazsj.equals("")))	wheresql+="  and (crm_fbdgl.sjazsj>=TO_DATE('"+crm_fbdgl_sjazsj+"','YYYY/MM/DD'))";
	}
	crm_fbdgl_sjazsj=request.getParameter("crm_fbdgl_sjazsj2");
	if (crm_fbdgl_sjazsj!=null)
	{
		crm_fbdgl_sjazsj=crm_fbdgl_sjazsj.trim();
		if (!(crm_fbdgl_sjazsj.equals("")))	wheresql+="  and (crm_fbdgl.sjazsj<=TO_DATE('"+crm_fbdgl_sjazsj+"','YYYY/MM/DD'))";
	}
	crm_fbdgl_azlrr=request.getParameter("crm_fbdgl_azlrr");
	if (crm_fbdgl_azlrr!=null)
	{
		crm_fbdgl_azlrr=cf.GB2Uni(crm_fbdgl_azlrr);
		if (!(crm_fbdgl_azlrr.equals("")))	wheresql+=" and  (crm_fbdgl.azlrr='"+crm_fbdgl_azlrr+"')";
	}
	crm_fbdgl_azsfcg=request.getParameter("crm_fbdgl_azsfcg");
	if (crm_fbdgl_azsfcg!=null)
	{
		crm_fbdgl_azsfcg=cf.GB2Uni(crm_fbdgl_azsfcg);
		if (!(crm_fbdgl_azsfcg.equals("")))	wheresql+=" and  (crm_fbdgl.azsfcg='"+crm_fbdgl_azsfcg+"')";
	}
	...
	ls_sql="SELECT crm_fbdgl.fbdbh,DECODE(crm_fbdgl.zt,'1','录入','2','出方案','3','下单','4','备货完成','9','安装完成'),DECODE(crm_fbdgl.azsfcg,'Y','成功','N','否'),cpflmc,crm_fbdgl.fssj,crm_fbdgl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_fbdgl.qksm,crm_fbdgl.cpjkr,crm_fbdgl.cpkf,crm_fbdgl.vipkf,crm_fbdgl.cplhsj,crm_fbdgl.jhbhwcsj,crm_fbdgl.jhazsj,crm_fbdgl.fbwxfa,crm_fbdgl.falrr,crm_fbdgl.falrsj,crm_fbdgl.xdsj,crm_fbdgl.xdr,crm_fbdgl.bhwcrq,crm_fbdgl.bhlrr,crm_fbdgl.sjazsj,crm_fbdgl.azlrr,crm_fbdgl.azqksm,crm_fbdgl.lrr,crm_fbdgl.lrsj,dwmc,crm_fbdgl.bz ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_fbdglCxList.jsp","","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="70px">返补单编号</td>
	<td  width="70px">状态</td>
	<td  width="70px">安装是否成功</td>
	<td  width="210px">产品分类</td>
	<td  width="90px">返补维修发生时间</td>
	<td  width="70px">客户编号</td>
	<td  width="90px">客户姓名</td>
	<td  width="270px">房屋地址</td>
	<td  width="90px">合同号</td>
	<td  width="70px">设计师</td>
	<td  width="410px">返补维修情况说明</td>
	<td  width="70px">产品接口人</td>
	<td  width="70px">产品客服</td>
	<td  width="70px">VIP客服</td>
	<td  width="90px">产品拉回时间</td>
	<td  width="90px">计划备货完成时间</td>
	<td  width="90px">计划安装时间</td>
	<td  width="410px">返补维修方案</td>
	<td  width="70px">方案录入人</td>
	<td  width="90px">方案录入时间</td>
	<td  width="90px">返补下单日期</td>
	<td  width="70px">下单人</td>
	<td  width="90px">备货完成日期</td>
	<td  width="70px">备货录入人</td>
	<td  width="90px">实际安装日期</td>
	<td  width="70px">安装录入人</td>
	<td  width="410px">安装情况说明</td>
	<td  width="70px">录入人</td>
	<td  width="90px">录入时间</td>
	<td  width="160px">录入部门</td>
