...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_fbdglXgAzList.jsp","","","XgAzCrm_fbdgl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除安装"};//按钮的显示名称
	String[] buttonLink={"DeleteAzCrm_fbdgl.jsp"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">返补维修单－－修改安装</font></B>
</CENTER>
<%
	pageObj.out=out;
