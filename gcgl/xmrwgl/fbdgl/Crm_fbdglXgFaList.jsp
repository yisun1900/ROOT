...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_fbdglXgFaList.jsp","","","XgFaCrm_fbdgl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除方案"};//按钮的显示名称
	String[] buttonLink={"Crm_fbdglXgFaList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_fbdgl set cpjkr=null,cpkf=null,vipkf=null,cplhsj=null,jhbhwcsj=null,jhazsj=null,fbwxfa=null,falrr=null,falrsj=null,zt='1' where "+chooseitem;
...
<CENTER >
  <B><font size="3">返补维修单－－修改方案</font></B>
</CENTER>
<%
	pageObj.out=out;
