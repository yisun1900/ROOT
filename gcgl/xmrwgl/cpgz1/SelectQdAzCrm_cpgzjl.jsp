...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_cpgzjlQdAzList.jsp" name="selectform">
<div align="center">确认可安装日期</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="crm_cpgzjl_cpflbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
%>  </td>
  <td align="right" width="18%">产品安装类型</td> 
  <td width="32%"> 
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_ghfhzsj" size="20" maxlength="10" >  </td>
  <td align="right" width="18%">是否交底后新订单</td> 
  <td width="32%"> 
<%
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">是否需后续管理</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_cpgzjl_sfxhxgl","Y+是&N+否","");
%>  </td>
  <td align="right" width="18%">选型是否完成</td> 
  <td width="32%"> 
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_cpsjs" size="20" maxlength="30" >  </td>
  <td align="right" width="18%">是否需返补</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_cpgzjl_sfxfb","N+无返补&Y+等待返补&W+返补完成","");
%>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">是否需维修</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_cpgzjl_sfxwx","N+无维修&Y+等待维修&W+维修完成","");
%>  </td>
  <td align="right" width="18%">是否有异常</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_cpgzjl_sfyyc","N+无异常&Y+等待处理&W+异常解决","");
%>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">是否需提醒</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_cpgzjl_sfxtx","Y+需提醒&N+否","");
%>  </td>
  <td align="right" width="18%">提醒日期</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_txrq" size="20" maxlength="10" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">提醒小时</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_txxs" size="20" maxlength="8" >  </td>
  <td align="right" width="18%">产品状态</td> 
  <td width="32%"> 
    <select name="crm_cpgzjl_cpztbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_lrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">录入时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_lrsj" size="20" maxlength="10" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"> 
    <select name="crm_cpgzjl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">返补单编号</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_fbdbh" size="20" maxlength="10" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">维修单编号</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_wxdbh" size="20" maxlength="10" >  </td>
  <td align="right" width="18%">异常单编号</td> 
  <td width="32%"> 
    <input type="text" name="crm_cpgzjl_ycdbh" size="20" maxlength="10" >  </td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.crm_cpgzjl_txxs, "提醒小时"))) {
		return false;
	}
