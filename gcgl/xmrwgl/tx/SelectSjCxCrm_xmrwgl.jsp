...
<tr bgcolor="#FFFFFF">
  ...
  <td>
<INPUT type="radio" name="sfxtx" value="Y" checked>需提醒
</td>
  <td align="right">报警级别</td>
  <td><select name="bjjbbm" style="FONT-SIZE:12PX;WIDTH:152PX"  >
    <%
		cf.selectItem(out,"select bjjbbm,bjjbmc from dm_bjjbbm where bjjbbm='3'","");
	%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_xmrwglSjCxList.jsp";
	FormName.submit();
	return true;
}
//-->
