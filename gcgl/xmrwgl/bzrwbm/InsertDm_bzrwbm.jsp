...
<tr bgcolor="#FFFFFF">
  ...
  <td bgcolor="#FFFFCC"><input type="radio" name="sjcpxx"  value="Y">
是
...
<tr bgcolor="#FFFFFF">
  ...
  <td bgcolor="#FFFFCC"><input type="radio" name="sfxys"  value="Y">
是
...
否 </td>
  ...
  <td rowspan="4" bgcolor="#FFFFCC"><select name="gcysxmbm" size="7" multiple style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select gcysxmbm,gcysxmmc from dm_gcysxm order by gcysxmbm","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE2">*</span>是否影响后续工期</td>
  <td><input type="radio" name="sfyxhxgq"  value="Y">
是
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="radio" name="sfyxfc"  value="Y">
是
...
否 </td>
  ...
  <td><input type="radio" name="zdjkrw"  value="1">
重点监控
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="gznr" cols="72" rows="4"></textarea></td>
</tr>
<tr bgcolor="#FFFFFF">
