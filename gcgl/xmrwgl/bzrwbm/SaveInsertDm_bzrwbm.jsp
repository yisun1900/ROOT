...
try {
	...
	ls_sql="insert into dm_bzrwbm ( rwbm,rwmc,rwflbm,zdjkrw,bjlb,sqtxnr,sqtxts,shtxnr,shtxts,sfyxhxgq,sfyxfc,sfxys,sfwlcb,zyrwbm,rwxh,bz,xgytg,gytgts,sjcpxx,sjcpfl,ysxm,bjjbbm,gznr ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,rwbm);
	ps.setString(2,rwmc);
