...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">异常分类</td> 
  <td width="32%"> 
...
%>
  ...
  <td align="right" width="18%">异常发生时间</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="radio" name="sfjj"  value="1">
    录入异常
      ...
      解决 </td>
  <td align="right" width="18%">完成时间</td> 
  <td width="32%"> 
