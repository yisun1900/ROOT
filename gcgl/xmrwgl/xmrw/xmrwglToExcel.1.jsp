  ...
  <div>
   <table width="100%" cellpadding="0" cellspacing="0" style='FONT-SIZE: 12px'>
	<tr>
	 ...
	 <table  border="1" width="<%=(15+145+15+60+60+25+rqsl*5)%>px" cellpadding="0" cellspacing="0" style='FONT-SIZE: 12px'>
	 <tr>
	   ...
	   <image src="/images/<%=logo%>" height='30px'> <span class="STYLE1">整体项目进度表</span></td>
		 ...
		 <td width="12%" colspan="11">家装设计师:<%=sjs%></td>
	   ...
	   <tr >
		 ...
		 <td colspan="11">项目管家:<%=gj%></td>
		 <td colspan="11">大工长姓名:<%=sgd%></td>
		 <td colspan="11">现场责任人:<%=sgbz%></td>
		 <td colspan="11">家装履约专员:<%=dd%></td>
	    </tr>
	 </table>
   </td></tr>
  </div>
<tr><td width="100%">
  <table border="1" width="<%=(15+145+15+60+60+25+rqsl*5)%>px" cellspacing="0" cellpadding="0"  style='FONT-SIZE:8px' >
...
<%
	...
	while (rs.next())
	{
		...
		{
			%>
			<td width="5px"><%=(ri-10)%></td>
			<%
		}
		else if (ri<30)
		{
			%>
			<td width="5px"><%=(ri-20)%></td>
			<%
		}
		else{
			%>
			<td width="5px"><%=(ri-30)%></td>
			<%
		}
	}
	rs.close();
