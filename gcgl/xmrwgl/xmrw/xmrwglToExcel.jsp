	...
	<tr>
	 ...
	 <tr>
	   ...
	   <image src="/images/<%=logo%>" height='30px'> <span class="STYLE1">整体项目进度表</span></td>
		 ...
		 <td width="12%" colspan="11">橱/内设计师:<%=cgsjs%><%=cgsjsdh%></td>
		 <td width="12%" colspan="11">卫浴设计师:<%=wysjs%><%=wysjsdh%></td>
		 <td width="12%" colspan="11">家具设计师:<%=jjsjs%><%=jjsjsdh%></td>
	    </tr>
	   <tr >
	     <td colspan="2" colspan="16">地址:<%=fwdz%></td>
		 <td width="11%" colspan="10"><%=jjrksgmc%></td>
		 <td colspan="11">项目管家:<%=gj%><%=gjdh%></td>
		 <td colspan="11">大工长姓名:<%=sgdmc%><%=sgddh%></td>
