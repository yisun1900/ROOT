...
<center><span class="STYLE2">修改计划时间</span> （<span class="STYLE3"><span class="STYLE4">节假日可施工</span>
	<INPUT type="radio" name="jjrksg" value="1" <%if (jjrksg.equals("1")) out.println("CHECKED");%> >节、假日不可施工
	<INPUT type="radio" name="jjrksg" value="2" <%if (jjrksg.equals("2")) out.println("CHECKED");%>  >节日不可施工
	<INPUT type="radio" name="jjrksg" value="9" <%if (jjrksg.equals("9")) out.println("CHECKED");%>  >不限制
  </span>
  ）     </center>
  <table border="0" cellspacing="0" cellpadding="1" width="200%" style='FONT-SIZE: 12px' >
    <tr align="left" bgcolor="#999999"> 
		<td colspan="9" align="center">
		<input type="button" onClick="f_jssj(insertform,1)"  value="[开始/结束]生成[工日]">
		<input type="button" onClick="f_jssj(insertform,2)"  value="[工日/结束]生成[开始]">
		<input type="button" onClick="f_jssj(insertform,3)"  value="[工日/开始]生成[结束]">
	</td> 
		<td>
    ...
    <tr align="center" bgcolor="#FFFFCC" height="25"> 
		...
		<td width="3%"><B><u>原工日</u></B></td>
		<td width="4%"><B><u>原开始时间</u></B></td>
		<td width="4%"><B><u>原结束时间</u></B></td>
...
<%
	...
	String qzrwmc="";
	ls_sql="select rwxh,rwbm,rwmc,changdu,jishu,jishucd,csjhkssj,csjhjssj,csjhgzr,jhkssj,jhjssj,jhgzr ";
	ls_sql+=" from  crm_xmrwgl";
	ls_sql+=" where khbh='"+khbh+"'";
	ls_sql+=" order by rwxh";
	ps= conn.prepareStatement(ls_sql);
...
function f_jssj(FormName,lx)//参数FormName:Form的名称
{
	FormName.action="cxjssj.jsp?lx="+lx;
...
{
	FormName.action="SaveEditXgJhSjCrm_xmrwgl.jsp";
	FormName.submit();
	return true;
}
//-->
