...
<center>
  <span class="STYLE2">录入－项目任务</span> （<span class="STYLE3">默认选择基础施工项目</span>）  
</center>
  <table border="0" cellspacing="0" cellpadding="1" width="200%" style='FONT-SIZE: 12px' >
    <tr align="left" bgcolor="#999999"> 
		...
		<td>
			...
			<input type="button"  value="全选" onClick="f_all(insertform)">
...
//					rightBolt+="号";
		...
		if (isFirst==0)//首次录入，自动选择基础施工项目
		{
			if (sjcpxx.equals("N"))//是否涉及产品信息 Y：是；N：否
			{
				%>
				<tr align="left"> 
					<td ><%=rwxh%></td>
...
<!--
var mark=1;
function f_all(FormName)//参数FormName:Form的名称
{
	var i = 0;
	if (<%=allrow%>==1)
	{
