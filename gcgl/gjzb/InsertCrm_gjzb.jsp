...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_gjzb.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="bgr" value="" size="20" maxlength="20" >  </td>
  <td align="right" width="15%">&nbsp;</td> 
  <td width="35%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>报告起始时间</td>
  <td><input type="text" name="bgqssj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right"><span class="STYLE1">*</span>报告截至时间</td>
  <td><input type="text" name="bgjzsj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>情况说明</td> 
  <td colspan="3"><textarea name="qksm" cols="72" rows="6"></textarea></td>
  </tr>
<tr bgcolor="#FFFFFF">
