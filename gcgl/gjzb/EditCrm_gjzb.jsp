...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>报告人</td> 
  <td width="35%"> 
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>报告起始时间</td>
  <td><input type="text" name="bgqssj" size="20" maxlength="10"  value="<%=bgqssj%>" onDblClick="JSCalendar(this)"></td>
  <td align="right"><span class="STYLE1">*</span>报告截至时间</td>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE4">录入人</span></td> 
  <td width="35%"> 
    <input type="text" name="lrr" size="20" maxlength="20"  value="<%=lrr%>" readonly>  </td>
  <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE4">录入时间</span></td> 
  <td width="35%"> 
    <input type="text" name="lrsj" size="20" maxlength="10"  value="<%=lrsj%>" readonly>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE4">录入部门</span></td> 
  <td width="35%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.bgqssj, "报告起始时间"))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.bgjzsj, "报告截至时间"))) {
		return false;
	}
