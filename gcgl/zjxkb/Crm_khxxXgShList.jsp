...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_zjxdj.zjxxh,'修改' sh, hth,crm_khxx.khxm,crm_khxx.fwdz,sgdmc,sjs ,DECODE(crm_zjxdj.zjxwcbz,'1','未完成','2','已完成') zjxwcbz,crm_zjxdj.gckk,DECODE(crm_khxx.gckkspbz,'N','未审批','Y','已审批') gckkspbz,zjxfsjdmc,crm_zjxdj.zjje,crm_zjxdj.jzjje,crm_zjxdj.kglf,crm_zjxdj.kqtk,fssj,crm_zjxdj.lrr,dm_zjxyybm.zjxyymc ";
...
//设置显示合并列
	...
	spanColHash.put("sh","1");//列参数对象加入Hash表
	...
	spanColHash.put("gckkspbz","1");//列参数对象加入Hash表
...
//设置列超级连接
	...
	coluParm.link="XgShCrm_zjxdj.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
	coluParmHash.put("sh",coluParm);//列参数对象加入Hash表
	pageObj.setColuLink(coluParmHash);//列参数对象加入Hash表
/*
//设置主键的显示方式
...
<CENTER >
  <B><font size="3">工程扣款--修改审核</font></B>
</CENTER>
<%
	pageObj.out=out;
