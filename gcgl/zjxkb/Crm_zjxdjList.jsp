...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  '修改' xg,'删除' sc,crm_zjxdj.zjxxh,DECODE(crm_zjxdj.sfwc,'N','未完成','Y','已完成'),fssj,crm_zjxdj.zjje,crm_zjxdj.jzjje,hth,crm_khxx.khxm,crm_khxx.fwdz,sgdmc,sjs,zjxfsjdmc,crm_zjxdj.zqguanlif,crm_zjxdj.zhguanlif,crm_zjxdj.zqzjxsuijin,crm_zjxdj.zjxsuijin,crm_zjxdj.kglf,crm_zjxdj.kqtk,crm_zjxdj.lrr";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">增减工程费－折前</td>
	<td  width="6%">增减工程费－折后</td>
	<td  width="5%">合同号</td>
	<td  width="5%">姓名</td>
	<td  width="12%">房屋地址</td>
	<td  width="4%">施工队</td>
	...
	<td  width="6%">增减项管理费－折后</td>
	<td  width="5%">增减项税金－折前</td>
	<td  width="5%">增减项税金－折后</td>
