...
//原有、未删除房间信息＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋＋
	...
	while (rs1.next())
	{
		...
		//输出增减后项目明细
		String xsxmbh=null;
		ls_sql="SELECT bj_bjxmmxh.xh xh,bj_bjxmmxh.xmbh,trim(bj_bjxmmxh.xmbh)||DECODE(bjlx,'1','','2','增') xsxmbh,xmmc,jldwmc,bj_bjxmmxh.dj,bj_gclmxh.sl,bj_gclmxh.sl*bj_bjxmmxh.dj as je,gycl";
...
//	out.println(ls_sql);
	...
	//	out.println(ls_sql);
		...
		<td align="center" width="13%" ><font color="<%=color%>"><%=cf.formatDouble(zqsfjeq,"#########.##")%></font></td>
		<td align="center" width="12%"><font color="<%=color%>"><%=cf.formatDouble(zqsfjeh,"#########.##")%></font></td>
...
%> 
  <tr bgcolor="#FFFFFF"> 
    ...
    <td align="center" width="13%" ><%=cf.formatDouble(allzqsfjeq,"#########.##")%></td>
    <td align="center" width="12%"><%=cf.formatDouble(allzqsfjeh,"#########.##")%></td>
    <td align="left" width="50%">&nbsp;</td>
  </tr>
</table>
<table width="100%" border="0">
