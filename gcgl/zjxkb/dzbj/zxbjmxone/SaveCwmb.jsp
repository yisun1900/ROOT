...
try {
	...
	ls_sql="insert into bj_bjmb(yhdlm,mbmc,dqbm,xmbh,xh,mblx)";
...
//	out.println(ls_sql);
	...
	ls_sql="insert into bj_bjmbfjxx (yhdlm,mbmc,jgwzbm,xuhao,mblx) ";
	...
	ls_sql+=" select '"+yhdlm+"','"+mbmc+"',dqbm,xmbh,jgwzbm,zjhsl,fjnxh,'2'";//1：公用模板；2：私人模板
