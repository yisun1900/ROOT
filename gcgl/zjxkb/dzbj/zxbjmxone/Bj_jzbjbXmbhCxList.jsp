...
<%
	...
	ls_sql="SELECT dqbm,bj_jzbjb.xmbh as xmbh,bj_jzbjb.xmmc,smmc,jdm_jldwbm.jldwmc,bj_jzbjb.bj,DECODE(bjlx,'1','标准','2','自定义') bjlx";
...
//设置显示列
	String[] disColName={"xmbh","xmmc","smmc","jldwmc","bj","bjlx"};
