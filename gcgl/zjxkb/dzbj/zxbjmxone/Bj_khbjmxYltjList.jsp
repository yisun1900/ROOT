...
try {
	...
	//获取电子报价金额
    zjqye=dzbj.getAllBjje(conn,khbh,"hmy");
...
<%
	...
	//输出项目明细
		...
		ls_sql="SELECT bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh||'、'||bj_khglfxb.gg xhgg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj,sum(bj_khglfxb.xhl*bj_gclmx.sl) xhl,sum(bj_khglfxb.xhl*bj_gclmx.sl*bj_khglfxb.dj) clf ";
		...
		ls_sql+=" group by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
		ls_sql+=" order by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
//		out.println(ls_sql);
	...
	<%
		...
		ls_sql+=" FROM jdm_jldwbm,bdm_glflbm,bj_khglfxb,bj_gclmx  ";
		ls_sql+=" where bj_khglfxb.glflbm=bdm_glflbm.glflbm(+) and bj_khglfxb.jldwbm=jdm_jldwbm.jldwbm(+)";
		ls_sql+=" and bj_gclmx.khbh='"+khbh+"'  and bj_khglfxb.glflbm='2'";//人工费
		ls_sql+=" and bj_gclmx.khbh=bj_khglfxb.khbh and bj_gclmx.dqbm=bj_khglfxb.dqbm and bj_gclmx.xmbh=bj_khglfxb.xmbh ";
		ls_sql+=" group by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
		ls_sql+=" order by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
//		out.println(ls_sql);
	...
	<%
		...
		ls_sql+=" FROM jdm_jldwbm,bdm_glflbm,bj_khglfxb,bj_gclmx  ";
		ls_sql+=" where bj_khglfxb.glflbm=bdm_glflbm.glflbm(+) and bj_khglfxb.jldwbm=jdm_jldwbm.jldwbm(+)";
		ls_sql+=" and bj_gclmx.khbh='"+khbh+"'  and bj_khglfxb.glflbm='3'";
		ls_sql+=" and bj_gclmx.khbh=bj_khglfxb.khbh and bj_gclmx.dqbm=bj_khglfxb.dqbm and bj_gclmx.xmbh=bj_khglfxb.xmbh ";
		ls_sql+=" group by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
		ls_sql+=" order by bj_khglfxb.glflbm,bdm_glflbm.glflmc,bj_khglfxb.glmc,bj_khglfxb.pp,bj_khglfxb.xh,bj_khglfxb.gg,bj_khglfxb.jldwbm,jdm_jldwbm.jldwmc,bj_khglfxb.dj";
//		out.println(ls_sql);
