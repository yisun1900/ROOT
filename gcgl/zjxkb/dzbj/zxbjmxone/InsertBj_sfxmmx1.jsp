...
<form method="post" action="SaveInsertBj_sfxmmx.jsp" name="insertform" target="_blank">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right"><font color="#FF0000">*</font><font color="#0000CC">客户编号</font></td>
              <td width="35%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td> 
                <select name="sfxmbm" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="getSfxm(insertform)" >
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select sfxmbm,sfxmmc||DECODE(sfbxx,'1','（必选）','2','') from bdm_sfxmbm where dqbm='"+dqbm+"' order by sfxmbm","");
%> 
                </select>              </td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">收费计算方式</font></td>
              <td> 
                <input name="sflx" type="text" id="sflx" value="" size="20" maxlength="17" readonly>              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="zqsfje" value="" size="20" maxlength="17" readonly>
              <strong><font color="#0000FF">不可修改</font></strong></td>
            </tr>
