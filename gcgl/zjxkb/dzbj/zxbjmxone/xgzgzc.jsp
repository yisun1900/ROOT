...
<%
	ls_sql="SELECT xh,xmbh,dqbm,xmmc,jldwmc,cldj,rgdj,bjjbmc,xmpx,DECODE(bj_bjxmmxh.sfzgzc,'Y','是','N','不是') sfzgzc";
	ls_sql+=" FROM bj_bjxmmxh,jdm_jldwbm,bdm_bjjbbm,bdm_xmdlbm   ";
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
        ...
        <tr bgcolor="<%=bgcolor%>" align="center">
          ...
          <td ><%=xmpx%></td>
          <td ><%=sfzgzc%></td>
          <td align="left"><a href="LrFjGcl1.jsp?zjxxh=<%=zjxxh%>&khbh=<%=khbh%>&dqbm=<%=dqbm%>&xmbh=<%=xmbh%>" target="lrbjframe"><%=xmbh%></a></td>
