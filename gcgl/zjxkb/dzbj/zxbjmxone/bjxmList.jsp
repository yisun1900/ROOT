...
<%
	ls_sql="SELECT xh,xmbh,dqbm,xmmc,jldwmc,cldj,rgdj,bjjbmc,xmpx";
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
        ...
        <tr bgcolor="<%=bgcolor%>" align="center">
          ...
          <td ><%=xmpx%></td>
          <td align="left"><a href="LrFjGcl1.jsp?khbh=<%=khbh%>&zjxxh=<%=zjxxh%>&dqbm=<%=dqbm%>&xmbh=<%=xmbh%>" target="lrbjframe"><%=xmbh%></a></td>
