...
try {
	...
	//获取电子报价金额
	zjqye=dzbj.getZjxHAllBjje(conn,khbh,zjxxh,"yz")+zcbjje;
    hbqye=dzbj.getZjxHBjje(conn,khbh,zjxxh,"yz","3");
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" bordercolor="#CCCCCC"  bgcolor="#FFFFFF" style='FONT-SIZE: 12px'>
  ...
  <tr bordercolor="#CCCCCC" bgcolor="#FFFFFF"> 
    <td colspan="7"  align="center"> <b><font size="5">（<%=bjjbmc%>）结算书</font></b> 
    </td>
  </tr>
</table>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
		...
		ls_sql+=" and bj_bjxmmxh.xmdlbm=bdm_xmdlbm.xmdlbm and bdm_xmdlbm.sftsxm in('1','2','3')";
		ls_sql+=" and bj_bjxmmxh.khbh=bj_gclmxh.khbh and bj_bjxmmxh.dqbm=bj_gclmxh.dqbm and bj_bjxmmxh.xmbh=bj_gclmxh.xmbh";
		ls_sql+=" and bj_gclmxh.sl*bj_bjxmmxh.dj!=0";
	...
	if (zcbjje>0)
	{
		%>
		  ...
		  <%  
			...
			ls_sql+=" FROM bj_zcbjmxh  ";
			ls_sql+=" where bj_zcbjmxh.khbh='"+khbh+"' and bj_zcbjmxh.zjxxh='"+zjxxh+"'";
			ls_sql+=" order by bj_zcbjmxh.xh";
		//	out.println(ls_sql);
			ps= conn.prepareStatement(ls_sql);
			rs =ps.executeQuery(ls_sql);
			while (rs.next())
