...
try {
	...
	ls_sql+=" select '"+khbh+"',dqbm,xmbh,jgwzbm,0,0,0,'N',fjnxh";
	...
	ls_sql+=" select '"+khbh+"',jgwzbm,xuhao,jgwzbm";
	...
	//报价项目明细
	ls_sql="select bj_bjmb.xh,bj_bjmb.xmbh,ckxm,bjlx,xmmc,xmdlbm,xmxlbm";
	ls_sql+=" from  bj_bjmb,bj_jzbjb";
	ls_sql+=" where bj_bjmb.yhdlm='"+yhdlm+"' and bj_bjmb.mbmc='"+mbmc+"' and bj_jzbjb.bjjbbm='"+bjjb+"'";
	...
	while (rs1.next())
	{
		...
		//报价项目明细
		ls_sql="insert into bj_bjxmmx (xh,khbh,xmbh,xmmc,xmdlbm,xmxlbm,smbm,jldwbm,cldj,rgdj,jxdj,dj,gycl,bz,dqbm,bjjb,bjlx,xmlx,cbenj,sgdbj,jzbz,ckxm,xmpx,sfxycl,SFZGZC ) ";
		ls_sql+=" select ?,?,xmbh,xmmc,xmdlbm,xmxlbm,smbm,jldwbm,clbj,rgbj,jxbj,bj,gycl,bz,dqbm,bjjbbm,bjlx,'1',cbenj,sgdbj,'1',ckxm,?,'2','N'";//1：需要；2：不需要
		ls_sql+=" from bj_jzbjb ";
		ls_sql+=" where dqbm='"+dqbm+"' and xmbh='"+xmbh+"' and bjjbbm='"+bjjb+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.setLong(1,xh);
		ps.setString(2,khbh);
		ps.setInt(3,xmpx);
