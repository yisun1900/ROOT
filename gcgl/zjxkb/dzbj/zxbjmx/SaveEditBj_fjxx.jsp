...
/*
		ls_sql="update bj_khzcxmxj set jgwzbm='"+cf.GB2Uni(jgwzbm[i])+"' where zjxxh='"+zjxxh+"' and khbh='"+khbh+"' and jgwzbm='"+cf.GB2Uni(oldjgwzbm[i])+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();

		ls_sql="update bj_khzcxm set jgwzbm='"+cf.GB2Uni(jgwzbm[i])+"' where zjxxh='"+zjxxh+"' and khbh='"+khbh+"' and jgwzbm='"+cf.GB2Uni(oldjgwzbm[i])+"'";
		ps= conn.prepareStatement(ls_sql);
		ps.executeUpdate();
		ps.close();
*/
