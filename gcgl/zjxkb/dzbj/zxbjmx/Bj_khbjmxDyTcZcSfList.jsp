...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="8" align="center" class="STYLE2" ><B>套餐－需收费主材清单（<%=bjjb%>）</B></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
	...
	<td  width="8%" align="center">加价金额</td>
...
<%
	...
	double je=0;
	double xjje=0;
	ls_sql="SELECT cpmc,sku,ppmc,jldw,sum(sl) sl,jjje";
	ls_sql+=" FROM bj_khzcxm";
	ls_sql+=" where bj_khzcxm.khbh='"+khbh+"' and bj_khzcxm.jjje>0";
	ls_sql+=" group by cpmc,sku,ppmc,jldw,jjje";
	ls_sql+=" order by sku";
//	out.println(ls_sql);
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
