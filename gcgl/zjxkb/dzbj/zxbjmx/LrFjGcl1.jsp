...
try {
	...
	ls_sql="select zcf,shf,ysf,qtf,cldj,rgdj,jxdj,xmmc,xmdlbm,xmxlbm,smbm,jldwbm,dj,gycl,DECODE(bjlx,'1','标准项目','2','自定义项目') bjlx,bjjbmc bjjb,glxmbh,DECODE(bj_bjxmmxh.sfbxx,'1','必报项','2','必列项','3','可选项','4','自定义','9','作废项') sfbxx,zdyxmyxq,flmcgg,bz";
