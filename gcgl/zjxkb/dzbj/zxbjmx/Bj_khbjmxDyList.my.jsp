...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="7" height="35"><b><font size="5">松下亿达装饰工程（大连）有限公司</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="7" height="35"><b><font size="3">住宅室内装饰装修工程预算报价书（各部位）</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="5" >客户姓名：<%=khxm%></td>
	<td align="center">客户电话：<%=lxfs%></td>
    <td align="left">合同号：&nbsp</td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="6" >工程地址：<%=fwdz%></td>
    <td align="left" >开工日期：&nbsp</td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="6" >户型说明：<%cf.selectItem(out,"select hxbm,hxmc from dm_hxbm order by hxbm",hxbm,true);%></td>
    <td align="left" >竣工日期：&nbsp</td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="5" >设计师：<%=sjs%></td>
	<td align="center">设计师电话：<%=dh%></td>
    <td align="left" >预算审核：</td>
  </tr>
</table>
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#CCCCCC"> 
    ...
    <td  width="32%" align="center">工艺做法及材料说明</td>
...
%> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="8" align="center"><b><i><font size="3">综合取费</font></i></b></td>
  </tr>
  <%  
	double allsfje=0;
	int temp=0;
...
%> 
  <tr bgcolor="#FFFFFF"> 
    <td align="right" colspan="8"><i><b><font size="3">综合取费合计：<%=cf.formatDouble(allsfje,"#########.##")%>元</font></b></i></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td align="right" colspan="8"><i><b><font size="3">总 计：<%=cf.formatDouble(allzj,"#########.##")%>元</font></b></i></td>
  </tr>
</table>
