...
<%
	...
	while (rs1.next())
	{
		...
		while (rs2.next())
		{
			...
			ls_sql="SELECT bj_khzcxmxj.khbjjbbm,bj_khzcxmxj.bjjbbm,bj_khzcxmxj.tccplbbm,clxlmc,sjsl,bzsl,DECODE(bj_khzcxmxj.sfxzsl,'1','可增项','2','不可增项','3','不控制') sfxzsl,ccbfjj,DECODE(sfbxx,'Y','必选','N','') sfbxx,sfyxsj,DECODE(sfyxsj,'Y','收费','N','否') sfyxsjMc,bjjbmc";
