...
//		return;
	...
	ls_sql="select gczxzk,gcjxzk,zxglfzk,jxglfzk,zxsjzk,jxsjzk";
	...
	if (rs.next())
	{
		gczxzk=rs.getDouble("gczxzk");//工程增项折扣
		gcjxzk=rs.getDouble("gcjxzk");//工程减项折扣
		zxglfzk=rs.getDouble("zxglfzk");//增项增项管理费折扣
		jxglfzk=rs.getDouble("jxglfzk");//减项增项管理费折扣
		zxsjzk=rs.getDouble("zxsjzk");//增项增项税金折扣
		jxsjzk=rs.getDouble("jxsjzk");//减项增项税金折扣
	}
	rs.close();
	ps.close();
	...
	if (kh_zjxxh.equals(""))
	{
		getZqgczjf=dzbj.getZqGczjf(conn,khbh,"yz");//工程直接费－折前
	}
	else{
		getZqgczjf=dzbj.getZjxHZqGczjf(conn,khbh,kh_zjxxh,"yz");
	}

	if ( (int)(zqgczjf+kh_zjxje)!=(int)getZqgczjf )
	{
		out.println("<font color='#FF0033' SIZE=4px><strong>提醒！【工程直接费＋工程费增减项＝"+cf.formatDouble(zqgczjf+kh_zjxje)+"】不等于【电子报价工程费:"+cf.formatDouble(getZqgczjf)+"】<BR>请录入(无明细)增建项</strong></font>");
		return;
	}
	//检查是否允许使用有明细增建项++++++++++++++++
    ...
    <BR>
        <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
          <tr bgcolor="#FFFFFF" align="center">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#0000CC">合同增减合计-折前</font></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#0000CC">合同增减合计-折后</font></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">工程增项－折前</font></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">工程减项－折前</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input name="gcjxzq" type="text" readonly value="0" size="10" maxlength="17">
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">增项管理费折扣</font></td>
              <td><font color="#CC0066"><strong>
                <input type="text" name="zxglfzk" size="10" maxlength="8" value="<%=zxglfzk%>" readonly>
              </strong></font></td>
              <td width="1%" align="center" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">增项税金折扣</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input type="text" name="zxsjzk" size="10" maxlength="8" value="<%=zxsjzk%>" readonly>
              </strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              ...
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">减项管理费折扣</font></td>
              <td><font color="#CC0066"><strong>
                <input type="text" name="jxglfzk" size="10" maxlength="8" value="<%=jxglfzk%>" readonly>
              </strong></font></td>
              <td width="1%" align="center" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">减项税金折扣</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input type="text" name="jxsjzk" size="10" maxlength="8" value="<%=jxsjzk%>" readonly>
              </strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">工程增项折扣</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">工程减项折扣</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input type="text" name="gcjxzk" size="10" maxlength="8" value="<%=gcjxzk%>" readonly>
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>工程费减免额</td>
              <td width="18%" bgcolor="#FFFFFF"><input type="text" name="zjxjme" size="10" maxlength="17" value="0" ></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
...
%>
                              ...
                              <td width="19%" rowspan="5" align="right"><font color="#FF0000">*</font>增减项原因</td>
                              <td width="31%" rowspan="5"><select name="zjxyybm" style="FONT-SIZE:12PX;WIDTH:162PX" size="8" multiple>
                        <%
...
%>
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="返回" onClick="f_scwc(insertform)" name="scwc" disabled>
                ...
                <P> 
                  ...
                  <input type="button"  value="预览打印变更明细" onClick="f_bgmx(insertform)" name="bgmx" disabled>
              </td>
            </tr>
  </table>
</form>
