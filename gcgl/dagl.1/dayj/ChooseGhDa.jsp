...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"><b>工程档案－归还(客户编号：<%=khbh%>)</b></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
	<tr align="center" bgcolor="#FFFFFF">
	  <td width="4%"><strong>归还</strong></td>
...
finally 
{
	...
	%>
           <tr > 
                ...
                <input type="button"  value="打勾档案归还" onClick="f_do(insertform)" name="save">
          </tr>
        </table>
</form>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if (choo == 0){
		...
		FormName.action="InsertGh.jsp?khbh=<%=khbh%>";
		FormName.submit();
		return true;
	}
