...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"><strong>工程档案－归还</strong></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveInsertGh.jsp" name="insertform">
		  ...
		  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2"> 
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right"> 
                <span class="STYLE1">*</span>接受分公司              </td>
              <td width="32%">
...
%>
              ...
              <td width="18%" align="right"> 
                <span class="STYLE1">*</span>接受单位              </td>
              <td width="32%"> 
                <select name="jsrdw" style="FONT-SIZE:12PX;WIDTH:152PX" >
				<option value=""></option>
                <%
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where ssfgs='"+bgrfgs+"' and  cxbz='N' order by dwlx,dwbh",dwbh);
%> 
              </select>              </td>
            </tr>
			<tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"> 
                <span class="STYLE1">*</span>接受人              </td>
              <td width="32%"> 
              <input type="text" name="jsr" size="20" maxlength="50" value="<%=yhmc%>">              </td>
              <td width="18%" align="right"> 
                <span class="STYLE1">*</span>移交时间              </td>
              <td width="32%"><input type="text" name="yjsj" size="20" maxlength="50" value="<%=cf.today()%>" onDblClick="JSCalendar(this)"></td>
            </tr>
			<tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"> 
