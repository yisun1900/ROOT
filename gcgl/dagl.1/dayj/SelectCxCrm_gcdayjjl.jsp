...
%> 
          ...
          <tr bgcolor="#FFFFFF">
            <td width="17%" align="right">档案明细</td>
...
%>
            ...
            <td width="16%" align="right"><div align="right">接收人</div></td>
            <td width="34%"><input name="jsr" type="text" id="bgr" onKeyUp="keyGo(lrr)" size="20" maxlength="50"></td>
          </tr>
          <tr bgcolor="#FFFFCC">
            <td width="19%"><div align="right">接收分公司</div></td>
            <td width="31%">
              <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
...
%>
            ...
            <td width="17%"><div align="right">接收单位</div></td>
...
%>
		            ...
		            <tr bgcolor="#FFFFCC">
            <td width="19%"><div align="right">移交分公司</div></td>
            <td width="31%">
              <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
...
%>
            ...
            <td width="17%"><div align="right">移交单位</div></td>
