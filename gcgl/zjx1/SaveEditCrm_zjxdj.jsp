...
try {
	...
	ls_sql="update crm_zjxdj set zqzjze=?,zhzjze=?,zjje=?,jzjje=?,gczxzq=?,gczxzh=?,gcjxzq=?,gcjxzh=? ";
	...
	ls_sql+=" ,zjxfsjd=?,zjxyysm=?,lrr=?,lrsj=?,lrdw=?";
	ls_sql+=" where  zjxxh='"+zjxxh+"'";
	ps= conn.prepareStatement(ls_sql);
	ps.setDouble(1,zqzjze);
	ps.setDouble(2,zhzjze);
	ps.setDouble(3,zjje);
	ps.setDouble(4,jzjje);
	ps.setDouble(5,gczxzq);
	ps.setDouble(6,gczxzh);
	ps.setDouble(7,gcjxzq);
	ps.setDouble(8,gcjxzh);

	ps.setDouble(9,zjxjme);
	ps.setDouble(10,zqguanlif);
	ps.setDouble(11,zhguanlif);
	ps.setDouble(12,glfjmje);
	ps.setDouble(13,zqzjxsuijin);
	ps.setDouble(14,zjxsuijin);
	ps.setDouble(15,sjjmje);
	ps.setDouble(16,zqqtsf);
	ps.setDouble(17,zhqtsf);
	ps.setDouble(18,zqwjrqyexm);

	ps.setDouble(19,zhwjrqyexm);
	ps.setDouble(20,zqsjf);
	ps.setDouble(21,zhsjf);
	ps.setDouble(22,0);//水电路增减项－折前
	ps.setDouble(23,0);//水电路增减项－折后
	ps.setDouble(24,kglf);
	ps.setDouble(25,zjxrzf);
	ps.setDouble(26,zjxdjjje);
	ps.setDouble(27,kqtk);
	ps.setDate(28,fssj);

	ps.setString(29,zjxfsjd);
	ps.setString(30,zjxyysm);
	ps.setString(31,lrr);
	ps.setDate(32,lrsj);
	ps.setString(33,lrdw);
	ps.executeUpdate();
	ps.close();
