...
double kh_zqgczjf=0;
double kh_zhgczjf=0;
double kh_zqsuijin=0;
double kh_zqzjxsuijin=0;
...
try {
	...
	ls_sql="select zjje,jzjje,zjxsuijin,zqguanlif,zhguanlif,zjxjme,glfjmje,sjjmje,kqtk,kglf,fssj,khbh,zjxfsjd,zjxyysm";
	ls_sql+=" ,gczxzq,gcjxzq,gczxzh,gcjxzh,zjxrzf,zjxdjjje,zqqtsf,zhqtsf,zqwjrqyexm,zhwjrqyexm,zqsjf,zhsjf,zqzjze,zhzjze,zqzjxsuijin";
	...
	if (rs.next())
	{
		kh_zqgczjf=rs.getDouble("zqgczjf");
		kh_zhgczjf=rs.getDouble("zhgczjf");
		kh_zqsuijin=rs.getDouble("zqsuijin");
		kh_zqzjxsuijin=rs.getDouble("zqzjxsuijin");
    ...
    <BR>
        <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><%=kh_zqgczjf%></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><%=kh_zqzjxsuijin%></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input name="gczxzq" type="text" value="<%=gczxzq%>" size="10" maxlength="17" onChange="f_jzjje(insertform)">
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">管理费-折前</font></td>
              <td><input name="zqguanlif" type="text" value="<%=zqguanlif%>" size="10" maxlength="17"  readonly></td>
              <td width="1%" align="center" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">税金-折前</font></td>
              <td bgcolor="#FFFFFF"><input name="zqzjxsuijin" type="text" value="<%=zqzjxsuijin%>" size="10" maxlength="17" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>工程减项－折前</td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input name="gcjxzq" type="text" value="<%=gcjxzq%>" size="10" maxlength="17" onChange="f_jzjje(insertform)">
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><p><font color="#CC0066"><strong>
                <input name="zjje" type="text" readonly value="<%=zjje%>" size="10" maxlength="17">
              </strong></font></p>              </td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>管理费减免额</td>
              <td><input type="text" name="glfjmje" size="10" maxlength="17" value="<%=glfjmje%>" onChange="f_jzjje(insertform)"></td>
              <td width="1%" align="center" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>税金减免额</td>
              <td bgcolor="#FFFFFF"><input type="text" name="sjjmje" size="10" maxlength="17" value="<%=sjjmje%>" onChange="f_jzjje(insertform)"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              ...
              <td><input name="zhguanlif" type="text" value="<%=zhguanlif%>" size="10" maxlength="17" readonly></td>
              <td width="1%" align="center" bgcolor="#000033">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">税金-折后</font></td>
              <td bgcolor="#FFFFFF"><input name="zjxsuijin" type="text" value="<%=zjxsuijin%>" size="10" maxlength="17" readonly></td>
            </tr>

            <tr bgcolor="#FFFFFF"> 
              <td width="15%" align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>工程减免额</td>
              <td width="18%" bgcolor="#FFFFFF"><input type="text" name="zjxjme" size="10" maxlength="17" value="<%=zjxjme%>" onChange="f_jzjje(insertform)"></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input name="gczxzh" type="text" readonly value="<%=gczxzh%>" size="10" maxlength="17">
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              ...
              <td bgcolor="#E8E8FF"><input type="text" name="kglf" value="<%=kglf%>" size="13" maxlength="17" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">工程减项－折后</font></td>
              <td bgcolor="#FFFFFF"><font color="#CC0066"><strong>
                <input name="gcjxzh" type="text" readonly value="<%=gcjxzh%>" size="10" maxlength="17">
              </strong></font></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              ...
              <td bgcolor="#E8E8FF"><input type="text" name="zjxrzf" value="<%=zjxrzf%>" size="13" maxlength="17" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">增减合计-折后</font></td>
              <td bgcolor="#FFFFFF"><input name="jzjje" type="text" value="<%=jzjje%>" size="10" maxlength="17" readonly></td>
              <td width="1%" align="right" bgcolor="#000033">&nbsp;</td>
              ...
              <td bgcolor="#E8E8FF"><input type="text" name="zjxdjjje" value="<%=zjxdjjje%>" size="13" maxlength="17" readonly></td>
            </tr>
  </table>
  <BR>
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><font color="#CC0066"><strong>
                <input name="zqqtsf" type="text" value="<%=zqqtsf%>" size="10" maxlength="17" onChange="f_jzjje(insertform)">
              </strong></font></td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">记入业绩其它费－折后</font></td>
              <td><font color="#CC0066"><strong>
                <input name="zhqtsf" type="text" readonly value="<%=zhqtsf%>" size="10" maxlength="17">
              </strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#FF0000">*</font>不记业绩其它费－折前</td>
              <td><font color="#CC0066"><strong>
                <input name="zqwjrqyexm" type="text" value="<%=zqwjrqyexm%>" size="10" maxlength="17" onChange="f_jzjje(insertform)">
              </strong></font></td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">不记业绩其它费－折后</font></td>
              <td><font color="#CC0066"><strong>
                <input name="zhwjrqyexm" type="text" readonly value="<%=zhwjrqyexm%>" size="10" maxlength="17">
              </strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#FF0000">*</font>设计费－折前</td>
              <td><font color="#CC0066"><strong>
                <input name="zqsjf" type="text" value="<%=zqsjf%>" size="10" maxlength="17" onChange="f_jzjje(insertform)">
              </strong></font></td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">设计费－折后</font></td>
              <td><font color="#CC0066"><strong>
                <input name="zhsjf" type="text" readonly value="<%=zhsjf%>" size="10" maxlength="17">
              </strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">增减总额－折前</font></td>
              <td><font color="#CC0066"><strong>
                <input name="zqzjze" type="text" value="<%=zqzjze%>" size="10" maxlength="17" readonly>
              </strong></font></td>
              <td align="right"><font color="#FF0000">*</font><font color="#0000CC">增减总额－折后</font></td>
              <td><font color="#CC0066"><strong>
              <input name="zhzjze" type="text" readonly value="<%=zhzjze%>" size="10" maxlength="17">
              </strong></font></td>
            </tr>
                            <tr bgcolor="#FFFFFF">
...
%>
							  ...
							  <select name="zjxyybm" style="FONT-SIZE:12PX;WIDTH:162PX" size="8" multiple>
                        <%
...
%>
                    ...
                    <tr bgcolor="#FFFFFF">
                      ...
                      <td bgcolor="#FFFFFF"><input type="text" name="kqtk" value="<%=kqtk%>" size="13" maxlength="17" >
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"><textarea name="zjxyysm" cols="74" rows="3"><%=zjxyysm%></textarea></td>
            </tr>
            <tr> 
