...
try {
	...
	if (kh_zjxwcbz.equals("3"))//1：未发生增减项；2：发生增减项；3：已完成增减项
	{
		%>
		<SCRIPT language=javascript >
		<!--
		alert("错误！[增减项]已完成，不能再[录入增减项]");
		//-->
		</SCRIPT>
		<%
		return;
...
%>
                              ...
                              <td width="19%" rowspan="4" align="right"><font color="#FF0000">*</font>增减项原因</td>
