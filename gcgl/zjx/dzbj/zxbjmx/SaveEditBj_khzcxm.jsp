	...
	while (rs.next())
	{
		...
		if (sfxzsl.equals("1"))//1:超量需加价;2:不可超量;3:无数量限制
		{
			...
			else if (sjsl<bzsl)//不收费数量<标准数量，(bzsl-sjsl)部分转为套餐内不收费
			{
				...
				ls_sql=" insert into bj_khzcxmh (sxh,zjxxh,khbh,jgwzbm,cpbm,sku,tccpdlbm,tccplbbm,tcsjflbm,cpmc,ppmc,gysmc,xh,gg,jldw,xdjldw,xdb,sfxclxs,sfyx,yxkssj,yxjzsj,tcndj,tccldj,dj   ,jsfs,jsj,jsbl,ddcljjfs,sh,sfcscp,bz,sfkgdj,zclx,sl,xdsl,ptcpsm,bjjbbm,fjddbh,oldsxh,lx,ywdhslbz,newzjxxh) ";
