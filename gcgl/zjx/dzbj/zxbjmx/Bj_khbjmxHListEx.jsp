...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="9" height="35"><b><font size="3">住宅室内装饰装修工程变更后报价书（各部位）</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	while (rs1.next())
	{
		...
		ls_sql="SELECT sum(bj_gclmxh.sl) sl,ROUND(sum(bj_gclmxh.sl*bj_bjxmmxh.dj),2) as je,ROUND(sum(bj_gclmxh.sl*bj_bjxmmxh.zqdj),2) as zqje";
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmxh.xh xh,bj_bjxmmxh.xmbh,xmmc,jldwmc,bj_bjxmmxh.zqdj,bj_bjxmmxh.zk,bj_bjxmmxh.dj,bj_gclmxh.sl,ROUND(bj_gclmxh.sl*bj_bjxmmxh.dj,2) as je,ROUND(bj_gclmxh.sl*bj_bjxmmxh.zqdj,2) as zqje,gycl,bj_bjxmmxh.flmcgg,bj_bjxmmxh.bz,bj_bjxmmxh.zcf,bj_bjxmmxh.cldj,bj_bjxmmxh.shf,bj_bjxmmxh.qtf,bj_bjxmmxh.ysf,bj_bjxmmxh.rgdj,bj_bjxmmxh.jxdj";
...
if  (djfxje!=0)
{
	...
	%>
	  <tr bgcolor="#FFFFFF" align="center"> 
		...
		<td align="left" colspan="6"><%=cxhdbm%></td>
	  </tr>
	<%
}
