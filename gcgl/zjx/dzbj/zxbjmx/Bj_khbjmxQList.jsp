...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  <tr bgcolor="#FFFFFF"> 
    <td align="center" colspan="7" height="35"><b><font size="5">增减项前－工程报价单</font></b></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  ...
  <%
	...
	while (rs1.next())
	{
		...
		ls_sql="SELECT sum(bj_gclmxq.sl) sl,sum(bj_gclmxq.sl*bj_bjxmmxq.zqdj) as je";
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmxq.xh xh,bj_bjxmmxq.xmbh,xmmc,jldwmc,bj_bjxmmxq.dj,bj_bjxmmxq.zqdj,bj_gclmxq.sl,bj_gclmxq.sl*bj_bjxmmxq.zqdj as je,gycl,bj_bjxmmxq.flmcgg,bj_bjxmmxq.bz";
