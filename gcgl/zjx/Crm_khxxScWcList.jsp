...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khxm,fwdz,DECODE(zjxwcbz,'1','未发生','2','发生增减项','3','已完成增减项'),bjjbmc,dwmc,sgdmc sgd,sjs,zjxm,ysgcjdmc,sjkgrq,sjjgrq,khbh ";
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_khxxScWcList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set zjxwcbz='2' where "+chooseitem;
