...
try {
	...
	ls_sql+=" ,jjfazdr,jjfazdsj,jjfa,jjfashr,jjfashsj,clqklrr,clqklrsj,sjcljg,sjclqk,tgsqr,tgsqsj,tgsqyy ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSqCrm_xmycgl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span><span class="STYLE2">停工申请人</span></td>
  <td><input type="text" name="tgsqr" size="20" maxlength="20"  value="<%=yhmc%>" readonly></td>
  <td align="right"><span class="STYLE1">*</span><span class="STYLE2">停工申请时间</span></td>
  <td><input type="text" name="tgsqsj" size="20" maxlength="10"  value="<%=cf.today()%>" readonly></td>
</tr>

<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>停工申请原因</td>
  <td colspan="3"><textarea name="tgsqyy" cols="75" rows="3"><%=tgsqyy%></textarea></td>
</tr>
    <tr> 
