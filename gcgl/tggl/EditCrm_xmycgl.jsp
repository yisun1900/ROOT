...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>出现问题时间</td> 
  <td width="35%"> 
    <input type="text" name="cxwtsj" size="20" maxlength="10"  value="<%=cxwtsj%>" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="15%"><span class="STYLE1">*</span>当事人</td> 
  <td width="35%"> 
    <input type="text" name="dsr" size="20" maxlength="20"  value="<%=dsr%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>出现问题</td> 
  <td colspan="3"> 
