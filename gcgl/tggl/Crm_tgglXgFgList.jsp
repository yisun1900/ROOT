...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_tggl.djbh, DECODE(crm_tggl.zt,'5','停工申请','6','停工审批','7','办理停工','8','办理复工'), DECODE(crm_tggl.tgshjg,'Y','通过','N','未通过'),crm_tggl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_tggl.tgsqr,crm_tggl.tgsqsj,crm_tggl.tgsqyy,crm_tggl.tgshr,crm_tggl.tgshsj,crm_tggl.tgshsm,crm_tggl.tgyybm,crm_tggl.tgkssj,crm_tggl.gjfgsj,crm_tggl.tglrr,crm_tggl.tglrsj,crm_tggl.sjfgsj,crm_tggl.fglrr,crm_tggl.fglrsj,crm_tggl.fgsm,crm_tggl.lrr,crm_tggl.lrsj,dwmc,crm_tggl.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tgglXgFgList.jsp","","","XgFgCrm_tggl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除复工"};//按钮的显示名称
	String[] buttonLink={"Crm_tgglXgFgList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set tgbz='Y',tgjzsj=null where khbh in(select khbh from crm_tggl where  zt='8' and "+chooseitem+")";
		sql[1]="update crm_tggl set zt='6',sjfgsj=null,fglrsj=null,fglrr=null,fgsm=null where  zt='8' and "+chooseitem;
