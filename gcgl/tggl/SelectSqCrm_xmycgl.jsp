...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xmycglSqList.jsp" name="selectform">
<div align="center">停工申请</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right"><font color="#0000CC">实际处理结果</font></td>
  <td><input name="crm_xmycgl_sjcljg" type="radio" value="N" checked>
未解决 </td>
</tr>
<tr bgcolor="#FFFFFF">
