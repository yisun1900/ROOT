...
try {
	...
	ls_sql="select khbh,tgsqr,tgsqsj,tgsqyy,lrr,lrsj,bz,tgshsj,tgshr,tgshjg,tgshsm,tgyybm,tgkssj,gjfgsj";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgTgShCrm_tggl.jsp" name="editform">
<div align="center">停工审核－维护（登记编号：<%=djbh%>）</div>
