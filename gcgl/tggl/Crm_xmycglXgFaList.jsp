...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_xmycgl.djbh, DECODE(crm_xmycgl.zt,'1','异常录入','2','制订方案','3','方案审核','4','已处理','5','停工申请','6','停工审批','7','办理停工','8','办理复工'),crm_xmycgl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_xmycgl.jjfazdr,crm_xmycgl.jjfazdsj,crm_xmycgl.jjfa,crm_xmycgl.cxwtsj,crm_xmycgl.dsr,crm_xmycgl.cxwt,crm_xmycgl.lrr,crm_xmycgl.lrsj,dwmc,crm_xmycgl.bz  ";
