...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE2"><span class="STYLE1">*</span>登记编号</span></td> 
  <td width="35%"> 
    <input type="text" name="djbh" value="<%=djbh%>" size="20" maxlength="10" readonly>  </td>
  <td align="right" width="15%"><span class="STYLE2"><span class="STYLE1">*</span>客户编号</span></td> 
  <td width="35%"> 
    <input type="text" name="khbh" value="<%=khbh%>" size="20" maxlength="20" readonly>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE2"><span class="STYLE1">*</span></span>出现问题时间</td> 
  <td width="35%"> 
    <input type="text" name="cxwtsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="15%"><span class="STYLE2"><span class="STYLE1">*</span></span>当事人</td> 
  <td width="35%"> 
    <input type="text" name="dsr" value="" size="20" maxlength="20" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE2"><span class="STYLE1">*</span></span>出现问题</td> 
  <td colspan="3"> 
