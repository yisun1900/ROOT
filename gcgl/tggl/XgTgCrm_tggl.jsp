...
try {
	...
	ls_sql="select khbh,tgsqr,tgsqsj,tgsqyy,lrr,lrsj,bz,tgshsj,tgshr,tgshjg,tgshsm";
	ls_sql+=" ,tgyybm,tgkssj,gjfgsj,tglrr,tglrsj";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgTgCrm_tggl.jsp" name="editform">
<div align="center">停工登记－维护（登记编号：<%=djbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE2"><span class="STYLE1">*</span>停工录入人</span></td>
  <td><input type="text" name="tglrr" size="20" maxlength="20"  value="<%=yhmc%>" readonly>  </td>
  <td align="right"><span class="STYLE2"><span class="STYLE1">*</span>停工录入时间</span></td>
