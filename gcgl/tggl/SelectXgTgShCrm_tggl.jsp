...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tgglXgTgShList.jsp" name="selectform">
<div align="center">停工审核－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%">停工申请人</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
	<INPUT type="radio" name="crm_tggl_tgshjg" value="Y">通过
    <INPUT type="radio" name="crm_tggl_tgshjg" value="N">未通过
  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">实际复工日期 从</td> 
...
{
	if(!(isDatetime(FormName.crm_tggl_tgsqsj, "停工申请时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_tgshsj, "停工审核时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_tgkssj, "停工开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_tgkssj2, "停工开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_gjfgsj, "估计复工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_gjfgsj2, "估计复工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_tglrsj, "停工录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_sjfgsj, "实际复工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_sjfgsj2, "实际复工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_fglrsj, "复工录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_tggl_lrsj, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
