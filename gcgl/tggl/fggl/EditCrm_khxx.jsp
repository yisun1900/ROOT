...
try {
	...
	ls_sql="select tgkssj,gjfgsj,tgyybm,tgsm,hth,jlbz,zjxm,pdsm,cgdz,hdr,sjs,cqbm,sgbz,pmjj,qye,ybjbh,khxm,fwdz,lxfs,qyrq,kgrq,sjkgrq,jgrq,sjjgrq,dwbh,lrsj,pdsj,pdr,sgd,sfxhf,hfrq,hflxbm,hdbz,khlxbm,bz,DECODE(ybjss,'0','未核实','Y','属实','N','不属实') ybjssmc,ybjss,DECODE(hdsfss,'0','未核实','Y','属实','N','不属实') hdsfssmc,hdsfss ";
...
%> </font></td>
            ...
            <tr> 
              <td width="19%" bgcolor="#FFFFFF"> 
                <div align="right"><font color="#000099">合同开工日期</font></div>
              </td>
              <td width="31%" bgcolor="#FFFFFF"> <font color="#000000"><%=kgrq%> 
                </font></td>
              <td width="18%" bgcolor="#FFFFFF"> 
                <div align="right"><font color="#000099">合同完工日期</font></div>
              </td>
            ...
            <tr> 
              <td width="19%" bgcolor="#FFFFFF"> 
                <div align="right"><font color="#000099">实际开工日期</font></div>
              </td>
              <td width="31%" bgcolor="#FFFFFF"> <font color="#000000"><%=sjkgrq%></font></td>
              <td width="18%" bgcolor="#FFFFFF"> 
                <div align="right"><font color="#000099">实际完工日期</font></div>
              </td>
            ...
            <tr> 
              <td width="19%" bgcolor="#FFFFCC"> 
                <div align="right"><font color="#000099">停工开始时间</font></div>
              </td>
              <td width="31%" bgcolor="#FFFFCC"> 
                <input type="text" name="tgkssj" size="20" maxlength="10"  value="<%=tgkssj%>" readonly>
              </td>
              <td width="18%" bgcolor="#FFFFCC"> 
                <div align="right"><font color="#000099">估计复工日期</font></div>
              </td>
              <td width="32%" bgcolor="#FFFFCC"> 
                <input type="text" name="gjfgsj" size="20" maxlength="10"  value="<%=gjfgsj%>" readonly>
              </td>
            </tr>
            <tr> 
              <td width="19%" bgcolor="#FFFFCC" align="right"><font color="#000099">停工原因</font></td>
              <td width="31%" bgcolor="#FFFFCC"> 
                <select name="tgyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectItem(out,"select tgyybm,tgyymc from dm_tgyybm where tgyybm='"+tgyybm+"'","");
%> 
                </select>
              </td>
              <td width="18%" bgcolor="#FFFFCC" align="right">停工截止时间</td>
              <td width="32%" bgcolor="#FFFFCC"> 
                <input type="text" name="tgjzsj" size="20" maxlength="10"  value="<%=cf.today()%>" >
              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
              <td width="19%"> 
                <div align="right">停工说明</div>
              </td>
              <td colspan="3"> 
                <textarea name="tgsm" cols="71" rows="4"><%=tgsm%></textarea>
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4" height="2"> 
                <input type="hidden" name="khbh"  value="<%=khbh%>" >
                <input type="button"  value="复工" onClick="f_do(editform)">
...
{
	if(	javaTrim(FormName.tgjzsj)=="") {
		alert("请输入[停工截止时间]！");
		FormName.tgjzsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.tgjzsj, "停工截止时间"))) {
		return false;
	}
