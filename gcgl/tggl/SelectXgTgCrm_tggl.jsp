...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tgglXgTgList.jsp" name="selectform">
<div align="center">停工登记－维护</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="crm_tggl_tgyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="crm_tggl_lrr" size="20" maxlength="20" ></td>
</tr>
