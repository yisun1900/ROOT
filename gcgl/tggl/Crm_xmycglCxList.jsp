...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_xmycgl.djbh, DECODE(crm_xmycgl.zt,'1','异常录入','2','制订方案','3','方案审核','4','已处理','5','停工申请','6','停工审批','7','办理停工','8','办理复工'), DECODE(crm_xmycgl.sjcljg,'Y','解决','N','未解决'), DECODE(crm_xmycgl.tgshjg,'Y','通过','N','未通过'),crm_xmycgl.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_xmycgl.cxwtsj,crm_xmycgl.dsr,crm_xmycgl.cxwt,crm_xmycgl.jjfazdr,crm_xmycgl.jjfazdsj,crm_xmycgl.jjfa,crm_xmycgl.jjfashr,crm_xmycgl.jjfashsj,crm_xmycgl.clqklrr,crm_xmycgl.clqklrsj,crm_xmycgl.sjclqk,crm_xmycgl.tgsqr,crm_xmycgl.tgsqsj,crm_xmycgl.tgsqyy,crm_xmycgl.tgshr,crm_xmycgl.tgshsj,crm_xmycgl.tgshsm,tgyymc,crm_xmycgl.tgkssj,crm_xmycgl.gjfgsj,crm_xmycgl.tglrr,crm_xmycgl.tglrsj,crm_xmycgl.sjfgsj,crm_xmycgl.fglrr,crm_xmycgl.fglrsj,crm_xmycgl.fgsm,crm_xmycgl.lrr,crm_xmycgl.lrsj,dwmc,crm_xmycgl.bz  ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="90px">停工申请人</td>
	<td  width="100px">停工申请时间</td>
	<td  width="730px">停工申请原因</td>
	<td  width="90px">停工审核人</td>
	<td  width="100px">停工审核时间</td>
	<td  width="730px">停工审核说明</td>
	<td  width="210px">停工原因</td>
	<td  width="100px">停工开始时间</td>
	<td  width="100px">估计复工日期</td>
	<td  width="90px">停工录入人</td>
	<td  width="100px">停工录入时间</td>
	<td  width="100px">实际复工日期</td>
	<td  width="90px">复工录入人</td>
	<td  width="100px">复工录入时间</td>
	<td  width="730px">复工说明</td>
