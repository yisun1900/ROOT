...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xmycglXgTgList.jsp","","","XgTgCrm_xmycgl.jsp");
...
//设置按钮参数
	String[] buttonName={"删除停工"};//按钮的显示名称
	String[] buttonLink={"Crm_xmycglXgTgList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set tgbz='W',tgkssj=null,gjfgsj=null,tgyybm=null where khbh in(select khbh from crm_xmycgl where  zt='7' and tgshjg='Y' and "+chooseitem+")";
		sql[1]="update crm_xmycgl set zt='6',tglrsj=null,tglrr=null,tgyybm=null,tgkssj=null,gjfgsj=null where  zt='7' and tgshjg='Y' and "+chooseitem;
