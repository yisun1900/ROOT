...
try {
	...
	ls_sql+=" ,tgsqr,tgsqsj,tgsqyy,tgshr,tgshsj,tgshjg,tgshsm,tgyybm,tgkssj,gjfgsj,tglrr,tglrsj,sjfgsj,fglrr,fglrsj,fgsm ";
	...
	if (rs.next())
	{
		...
		sjfgsj=cf.fillNull(rs.getDate("sjfgsj"));
		fglrr=cf.fillNull(rs.getString("fglrr"));
		fglrsj=cf.fillNull(rs.getDate("fglrsj"));
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgFgCrm_xmycgl.jsp" name="editform">
<div align="center">项目复工－维护（登记编号：<%=djbh%>）</div>
...
<tr>
  ...
  <td bgcolor="#FFFFCC"><input type="text" name="sjfgsj" size="20" maxlength="10"  value="<%=sjfgsj%>" onDblClick="JSCalendar(this)"></td>
