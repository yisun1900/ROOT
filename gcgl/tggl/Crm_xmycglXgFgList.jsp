...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_xmycgl.djbh,crm_xmycgl.sjfgsj,crm_xmycgl.fglrr,crm_xmycgl.fglrsj,crm_khxx.khxm,crm_khxx.fwdz,crm_xmycgl.cxwtsj,crm_xmycgl.dsr,crm_xmycgl.cxwt,crm_xmycgl.sjclqk,crm_xmycgl.tgsqr,crm_xmycgl.tgsqsj,crm_xmycgl.tgsqyy,crm_xmycgl.tgshsm,crm_xmycgl.tgkssj,crm_xmycgl.gjfgsj,tgyymc,crm_xmycgl.tglrr,crm_xmycgl.tglrsj,crm_xmycgl.lrsj,dwmc,crm_xmycgl.bz,crm_xmycgl.khbh, DECODE(crm_xmycgl.zt,'1','异常录入','2','制订方案','3','方案审核','4','已处理','5','停工申请','6','停工审批','7','办理停工','8','办理复工')  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_xmycgl.fglrsj desc ";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xmycglXgFgList.jsp","","","XgFgCrm_xmycgl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_xmycglXgFgList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set tgbz='Y',tgjzsj=null where khbh in(select khbh from crm_xmycgl where  zt='8' and "+chooseitem+")";
		sql[1]="update crm_xmycgl set zt='7',sjfgsj=null,fglrsj=null,fglrr=null,fgsm=null where  zt='8' and "+chooseitem;
