...
<tr align="center"> 
  ...
  <tr bgcolor="#FFFFFF">
  <td align="right" width="18%">登记编号</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_djbh" size="20" maxlength="10" >  </td>
  <td align="right" width="18%">状态</td> 
  <td width="32%"><select name="crm_xmycgl_zt" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">解决方案制订人</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_jjfazdr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">解决方案制订时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_jjfazdsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">解决方案审核人</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_jjfashr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">解决方案审核时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_jjfashsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">处理情况录入人</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_clqklrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">处理情况录入时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_clqklrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">实际处理结果</td> 
  <td width="32%"> 
    <INPUT type="radio" name="crm_xmycgl_sjcljg" value="Y">解决
    <INPUT type="radio" name="crm_xmycgl_sjcljg" value="N">未解决  </td>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">停工申请时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_tgsqsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="18%">停工审核人</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_tgshr" size="20" maxlength="20" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">停工审核时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_tgshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
  <td align="right" width="18%">停工审核结果</td> 
  <td width="32%"> 
    <INPUT type="radio" name="crm_xmycgl_tgshjg" value="Y">通过
    <INPUT type="radio" name="crm_xmycgl_tgshjg" value="N">未通过  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">停工开始时间 从</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_tgkssj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_tgkssj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">停工原因</td> 
  <td width="32%"><select name="crm_xmycgl_tgyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select tgyybm,tgyymc from dm_tgyybm order by tgyybm","");
%>
  </select></td>
  <td align="right" width="18%">估计复工日期</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_gjfgsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">停工录入人</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_tglrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">停工录入时间</td> 
  <td width="32%"><input type="text" name="crm_xmycgl_tglrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">复工录入人</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_fglrr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">复工录入时间</td> 
  <td width="32%"> 
    <input type="text" name="crm_xmycgl_fglrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="crm_xmycgl_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"> 
    <select name="crm_xmycgl_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
