...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCrm_tgglTg.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="tgsqr" size="20" maxlength="20"  value="<%=tgsqr%>" ></td>
  <td align="right"><span class="STYLE1">*</span>停工申请时间</td>
  <td><input type="text" name="tgsqsj" size="20" maxlength="10"  value="<%=tgsqsj%>" onDblClick="JSCalendar(this)"></td>
</tr>
<tr>
