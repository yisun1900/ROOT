...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xmycglTgList.jsp" name="selectform">
<div align="center">停工登记</div>
...
<tr align="center"> 
  ...
  <td align="right" width="20%"><font color="#0000CC">状态</font></td> 
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="right"><font color="#0000CC">停工审核结果</font></td>
    <td><input name="crm_xmycgl_tgshjg" type="radio" value="Y" checked>
      通过</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">停工审核时间 从</td>
    <td><input type="text" name="crm_xmycgl_tgshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
    </td>
    <td align="right">到</td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="20%">解决方案制订人</td> 
