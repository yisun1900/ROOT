...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveFgCrm_xmycgl.jsp" name="editform">
<div align="center">项目复工（登记编号：<%=djbh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="34%"><%=cxwtsj%></td>
  <td align="right" width="16%"><span class="STYLE2">当事人</span></td> 
  <td width="33%"><%=dsr%></td>
</tr>
<tr bgcolor="#FFFFFF">
