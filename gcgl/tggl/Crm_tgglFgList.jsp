...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,crm_tggl.djbh, DECODE(crm_tggl.zt,'5','停工申请','6','停工审批','7','办理停工','8','办理复工'), DECODE(crm_tggl.tgshjg,'Y','通过','N','未通过'),crm_tggl.tgsqr,crm_tggl.tgsqsj,crm_tggl.tgsqyy,crm_tggl.tgshr,crm_tggl.tgshsj,crm_tggl.tgshsm,crm_tggl.tgyybm,crm_tggl.tgkssj,crm_tggl.gjfgsj,crm_tggl.tglrr,crm_tggl.tglrsj,crm_tggl.sjfgsj,crm_tggl.fglrr,crm_tggl.fglrsj,crm_tggl.fgsm,crm_tggl.lrr,crm_tggl.lrsj,dwmc,crm_tggl.bz  ";
	ls_sql+=" FROM crm_khxx,crm_tggl,sq_dwxx  ";
    ls_sql+=" where crm_khxx.khbh=crm_tggl.khbh(+)";
    ls_sql+=" and crm_tggl.lrbm=sq_dwxx.dwbh(+)";
    ls_sql+=" and crm_khxx.tgbz='Y'";//W：正常；Y：已停工；N：复工
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tgglFgList.jsp","","","FgCrm_tggl.jsp");
