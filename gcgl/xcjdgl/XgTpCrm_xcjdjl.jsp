...
try {
	...
	ls_sql="select tpsftg,tpsm,khbh,sqrq,sqr,sqrlxdh,DECODE(sfxtp,'Y','是','N','否') sfxtp,jhjdrq,jhjdsj,sqsm,zcwcsj,lrr,lrsj,dwmc ";
...
<div align="center">交底申请－－修改特批审核 （交底记录号：<%=jdjlh%>）</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "tpsftg","Y+通过&N+未通过",tpsftg);
%></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="tpsm" cols="71" rows="3"><%=tpsm%></textarea></td>
  </tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgTpCrm_xcjdjl.jsp";
	FormName.submit();
	return true;
}
