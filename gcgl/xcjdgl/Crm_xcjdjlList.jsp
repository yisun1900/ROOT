...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" OR (crm_xcjdjl.clzt='1' ) ) ";//1：申请
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_xcjdjl.sqrq";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_xcjdjlList.jsp","","","EditCrm_xcjdjlMain.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_xcjdjl.jsp?"};//按钮单击调用的网页，可以增加参数
