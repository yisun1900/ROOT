...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xcjdjlFbList.jsp" name="selectform">
<div align="center">发布交底时间</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <td width="31%">
	<INPUT name="crm_xcjdjl_clzt" type="radio" value="2" >确认
	<INPUT name="crm_xcjdjl_clzt" type="radio" value="3" >特批完成
	</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="31%">
	  <INPUT name="crm_xcjdjl_sfxtp" type="radio" value="N" >否
	  <INPUT name="crm_xcjdjl_sfxtp" type="radio" value="Y" >是
  </td>
