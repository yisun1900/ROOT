...
<tr bgcolor="#FFFFFF">
  ...
  <td><input type="text" name="fbsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly></td>
    ...
    <input type="hidden" name="khbh" value="<%=khbh%>" readonly> 
	  ...
	  <input name="button2" type="button" onClick="window.open('/pdgl/psgd/EditCrm_khxxMain.jsp?khbh=<%=khbh%>')"  value="派工长">
	  <input name="button" type="button" onClick="window.open('/pdgl/pgj/EditCrm_khxx.jsp?khbh=<%=khbh%>')"  value="派管家">
      <input name="button" type="button" onClick="window.open('/pdgl/pdd/EditCrm_khxx.jsp?khbh=<%=khbh%>')"  value="派专员">
</div>      </td>
    </tr>
  </table>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.zzqrjdsj, "最终确认交底时间"))) {
		return false;
	}
	...
	FormName.action="SaveXgFbCrm_xcjdjl.jsp";
	FormName.submit();
	return true;
}
