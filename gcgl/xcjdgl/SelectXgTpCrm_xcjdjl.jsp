...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_xcjdjlXgTpList.jsp" name="selectform">
<div align="center">交底申请－－修改特批审核</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <td width="31%">
	<INPUT name="crm_xcjdjl_clzt" type="radio" value="4" checked>
	特批完成</td>
</tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="31%"><INPUT name="crm_xcjdjl_sfxtp" type="radio" value="Y" checked>
    是
  </td>
