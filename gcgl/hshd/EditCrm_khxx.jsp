...
<form method="post" action="SaveEditCrm_khxx.jsp" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="15%"> 
                <div align="right"><font color="#0000FF">回单标志</font></div>
              </td>
              <td width="35%"><%
	cf.selectToken(out,"1+非回单&2+设计师回单&3+施工队回单&4+老客户回单&5+员工回单&6+班长回单&7+售楼处&8+材料商&9+其他",hdbz,true);
%> </td>
              <td width="15%"> 
                <div align="right"><font color="#0000FF">回单人</font></div>
              </td>
              <td width="35%"><%=hdr%> </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="hdsfss" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectToken(out,"0+未核实&Y+属实&N+不属实",hdsfss);
%> 
                </select>
              </td>
              <td width="18%"> 
