...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh,ysgcjdmc,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_khxx.zjxm,dwmc  ";
    ...
    ls_sql+=" and crm_khxx.gcjdbm not in('4','5','7')";//1：未开工；2：工程开工；6：隐蔽工程完成；3：中期验收；4：工程完工；5：客户完结；7：合同异常终止
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","","","InsertCrm_htyczz.jsp");
...
<CENTER >
  <B><font size="3">合同异常终止－－录入申请</font></B>
</CENTER>
<%
	pageObj.out=out;
