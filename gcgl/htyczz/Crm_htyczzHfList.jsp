...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_htyczz.clzt in('2')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_htyczzHfList.jsp","","","HfCrm_htyczz.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSpCrm_htyczz.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">合同异常终止－－回访</font></B>
</CENTER>
<%
	pageObj.out=out;
