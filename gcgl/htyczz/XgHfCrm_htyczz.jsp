...
try {
	...
	ls_sql="select spsm,spr,spsj,clzt,yczzsj,yczzsm,lrr,lrsj,lrbm,hfr,hfsj,hfsm ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgHfCrm_htyczz.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="hfsm" cols="73" rows="3"><%=hfsm%></textarea>  </td>
</tr>
<tr bgcolor="#FFFFFF">
