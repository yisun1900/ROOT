...
try {
	...
	ls_sql="select spsm,clzt,yczzsj,yczzsm,lrr,lrsj,lrbm ";
...
<html>
<head>
<title>合同异常终止－－修改审批</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSpCrm_htyczz.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"><textarea name="spsm" cols="73" rows="3"><%=spsm%></textarea>  </td>
</tr>
<tr bgcolor="#FFFFFF">
