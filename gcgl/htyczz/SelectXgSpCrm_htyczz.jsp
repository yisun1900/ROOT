...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_htyczzXgSpList.jsp" name="selectform">
<div align="center">合同异常终止－－修改审批</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<INPUT name="crm_htyczz_clzt" type="radio" value="2">审批同意
	<INPUT name="crm_htyczz_clzt" type="radio" value="3">审批不同意
	</td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
