...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_htyczzCxList.jsp" name="selectform">
<div align="center">合同异常终止－－查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right">异常终止时间 从</td>
  <td><input type="text" name="crm_htyczz_yczzsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_htyczz_yczzsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">审批人</td> 
  <td width="32%"> 
    <input type="text" name="crm_htyczz_spr" size="20" maxlength="20" >  </td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">审批时间 从</td>
  <td><input type="text" name="crm_htyczz_spsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_htyczz_spsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">录入时间 从</td>
  <td><input type="text" name="crm_htyczz_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">到</td>
  <td><input type="text" name="crm_htyczz_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="crm_htyczz_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">录入部门</td> 
  <td width="32%"> 
    <select name="crm_htyczz_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<INPUT type="radio" name="crm_htyczz_clzt" value="1">未审批
	<INPUT type="radio" name="crm_htyczz_clzt" value="2">审批同意
	<INPUT type="radio" name="crm_htyczz_clzt" value="3">审批不同意 
	<INPUT type="radio" name="crm_htyczz_clzt" value="4">回访  </td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.crm_htyczz_yczzsj, "异常终止时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_htyczz_yczzsj2, "异常终止时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_htyczz_spsj, "审批时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_htyczz_spsj2, "审批时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_htyczz_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_htyczz_lrsj2, "录入时间"))) {
		return false;
	}
	FormName.submit();
	return true;
