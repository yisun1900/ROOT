...
<html>
<head>
<title>合同异常终止－－审批</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF">
<form method="post" action="SaveSpCrm_htyczz.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3">
	<input type="radio" name="clzt" value="2">同意
	<input type="radio" name="clzt" value="3">不同意
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">审批说明</td>
  <td colspan="3"><textarea name="spsm" cols="73" rows="3"></textarea>  </td>
</tr>
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font><font color="#0000CC">审批时间</font></td>
