...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_htyczz.jsp" name="insertform">
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><font color="#FF0000">*</font>异常终止时间</td>
    <td colspan="3"><input type="text" name="yczzsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font>异常终止说明</td> 
  <td colspan="3"><textarea name="yczzsm" cols="73" rows="14"></textarea></td>
  </tr>
<tr bgcolor="#FFFFFF">
