...
try {
	...
	ls_sql="select yczzsj,yczzsm,lrr,lrsj,lrbm ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditCrm_htyczz.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font>异常终止时间</td> 
  <td width="32%"><input type="text" name="yczzsj" size="20" maxlength="10"  value="<%=yczzsj%>" ></td>
  <td align="right" width="18%">&nbsp;</td> 
  <td width="32%">&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><font color="#FF0000">*</font>异常终止说明</td> 
  <td colspan="3"> 
    <textarea name="yczzsm" cols="73" rows="14"><%=yczzsm%></textarea>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.yczzsj)=="") {
		alert("请输入[异常终止时间]！");
		FormName.yczzsj.focus();
		return false;
	}
	if(!(isDatetime(FormName.yczzsj, "异常终止时间"))) {
		return false;
	}
	if(	javaTrim(FormName.yczzsm)=="") {
		alert("请输入[异常终止说明]！");
		FormName.yczzsm.focus();
		return false;
	}
