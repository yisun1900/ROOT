...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String crm_htyczz_spr=null;
	String crm_htyczz_spsj=null;
	...
	crm_htyczz_spr=request.getParameter("crm_htyczz_spr");
	if (crm_htyczz_spr!=null)
	{
		crm_htyczz_spr=cf.GB2Uni(crm_htyczz_spr);
		if (!(crm_htyczz_spr.equals("")))	wheresql+=" and  (crm_htyczz.spr='"+crm_htyczz_spr+"')";
	}
	crm_htyczz_spsj=request.getParameter("crm_htyczz_spsj");
	if (crm_htyczz_spsj!=null)
	{
		crm_htyczz_spsj=crm_htyczz_spsj.trim();
		if (!(crm_htyczz_spsj.equals("")))	wheresql+="  and (crm_htyczz.spsj>=TO_DATE('"+crm_htyczz_spsj+"','YYYY/MM/DD'))";
	}
	crm_htyczz_spsj=request.getParameter("crm_htyczz_spsj2");
	if (crm_htyczz_spsj!=null)
	{
		crm_htyczz_spsj=crm_htyczz_spsj.trim();
		if (!(crm_htyczz_spsj.equals("")))	wheresql+="  and (crm_htyczz.spsj<=TO_DATE('"+crm_htyczz_spsj+"','YYYY/MM/DD'))";
	...
	ls_sql="SELECT crm_htyczz.khbh, DECODE(crm_htyczz.clzt,'1','未审批','2','审批同意','3','审批不同意','4','回访'),crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_htyczz.yczzsj,crm_htyczz.yczzsm,crm_htyczz.spr,crm_htyczz.spsj,crm_htyczz.spsm,crm_htyczz.hfr,crm_htyczz.hfsj,crm_htyczz.hfsm,crm_htyczz.lrr,crm_htyczz.lrsj,b.dwmc lrbm  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_htyczzCxList.jsp","","","");
//	pageObj.setPageRow(10);//设置每页显示记录数
/*
//设置显示列
	String[] disColName={"khbh","crm_khxx_khxm","crm_khxx_fwdz","crm_khxx_hth","crm_khxx_sjs","crm_htyczz_yczzsj","crm_htyczz_yczzsm","crm_htyczz_spr","crm_htyczz_spsj","crm_htyczz_spsm","crm_htyczz_clzt","crm_htyczz_lrr","crm_htyczz_lrsj","crm_htyczz_lrbm"};
...
<CENTER >
  <B><font size="3">合同异常终止－－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">设计师</td>
	<td  width="2%">施工队</td>
	<td  width="4%">异常终止时间</td>
	<td  width="19%">异常终止说明</td>
	<td  width="3%">审批人</td>
	<td  width="4%">审批时间</td>
	<td  width="12%">审批说明</td>
	<td  width="3%">回访人</td>
