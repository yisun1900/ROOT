...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql=" SELECT hth,khxm,DECODE(kbxbz,'Y','保修','M','部分保修','N','不保修','0','未办理','1','预办理保修'),bxkssj,bxjzsj,fwdz,qyrq,sjjgrq,sq_dwxx.dwmc,sgdmc,sjs,zjxm,khbh ";
...
//设置按钮参数
	String[] buttonName={"删除保修信息"};//按钮的显示名称
	String[] buttonLink={"Crm_khxxXgBxList.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="7%">姓名</td>
	<td  width="6%">保修标志</td>
	<td  width="6%">保修开始时间</td>
	<td  width="6%">保修截止时间</td>
	<td  width="18%">房屋地址</td>
	<td  width="7%">签约日期</td>
	<td  width="7%">实竣工日期</td>
	<td  width="11%">签约店面</td>
