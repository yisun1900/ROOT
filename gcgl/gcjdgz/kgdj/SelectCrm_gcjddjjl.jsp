...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">实际开工时间 从</td>
              <td width="32%"> 
...
{
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj, "实际开工时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj2, "实际开工时间"))) {
		return false;
	}
