...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_gcfxysjlList.jsp","","","EditCrm_gcfxysjl.jsp");
	pageObj.setPageRow(Integer.parseInt(myxssl));
/*
//设置显示列
	String[] disColName={"ysjlh","crm_gcfxysjl_khbh","dm_gcyszxmbm_gcyszxmmc","crm_gcfxysjl_ysxmflbm","crm_gcfxysjl_yssj","crm_gcfxysjl_ysr","crm_gcfxysjl_lrr","crm_gcfxysjl_lrsj","crm_gcfxysjl_lrbm","crm_gcfxysjl_bz","crm_khxx_khxm","crm_khxx_fwdz","crm_khxx_hth"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCrm_gcfxysj.jsp"};//按钮单击调用的网页，可以增加参数
