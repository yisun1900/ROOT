...
try {
	...
	ls_sql="select gcjdbm,djsj,khbh,sfszhf,hfszjlh,ygcjdbm,ysfxhf,yhfrq,yhflxbm";
	...
	{
		out.println("错误！[实际竣工验收时间]不正确，不能删除");
		return;
	}
	...
	ls_sql="update crm_khxx set sjwjrq=null,gcjdbm=? ";
	ls_sql+=" where  khbh='"+khbh+"' ";
	ps= conn.prepareStatement(ls_sql);
