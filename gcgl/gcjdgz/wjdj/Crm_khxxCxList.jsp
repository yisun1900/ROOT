...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,DECODE(zjxwcbz,'1','未发生','2','发生增减项','3','已完成增减项'),qye,zjxje,ysgcjdmc,kgrq,jgrq,sjjgrq,sgdmc sgd,sjs,zjxm,sq_dwxx.dwmc,hth ";
    ...
    ls_sql+=" and crm_khxx.zt='2' and crm_khxx.gcjdbm='4' ";
...
<CENTER >
  <B><font size="3">竣工验收登记(<font color="#FF0000">注意：只有完工登记的客户才能被查询到</font>)</font></B> 
</CENTER>
<%
	pageObj.out=out;
