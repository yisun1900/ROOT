...
try {
	...
	ls_sql="select zt,gcjdbm,zjxwcbz,crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm,pdclzt,kgsjqd,fgsbh,sybgcrq,szqsj";
	...
	if (zjxwcbz.equals("2"))//1：未发生增减项；2：发生增减项；3：已完成增减项
	{
		out.println("<BR>！！！错误，已发生增减项，未完成增减项");
		return;
	}
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"><select name="gcjdbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                <%
	cf.selectItem(out,"select gcjdbm,gcjdmc from  dm_gcjdbm order by gcjdbm","5",false);
%>
              </select></td>
              <td width="18%" align="right"> 
                <font color="#CC0000">*</font>实际竣工验收日期</td>
              <td width="32%">
