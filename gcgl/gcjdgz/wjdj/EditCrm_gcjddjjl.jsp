...
%> </td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#FF0000">*</font>工程进度</td>
...
%>
              ...
              <td align="right"><font color="#FF0000">*</font>实际竣工验收时间 </td>
              <td><input type="text" name="djsj" size="20" maxlength="10"  value="<%=djsj%>" onDblClick="JSCalendar(this)"></td>
            </tr>
