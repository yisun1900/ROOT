...
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><%
	cf.radioToken(out, "zgysjg","5+验收通过&6+验收未通过",zgysjg);
%></td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"> 
	...
	<input name="cktp" type="button" id="cktp" onClick="window.open('/gcgl/hrgcys/ysjl/ViewZp1.jsp?ysjlh=<%=ysjlh%>')"  value="全部图片" > 
	  ...
	  <input name="sczp" type="button"  onClick="f_sczp(editform)"  value="上传验收照片">
      <input name="ckzp" type="button"  onClick="f_ckzp(editform)"  value="验收照片">
	</div>      </td>
    </tr>
  </table>
