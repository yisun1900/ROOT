...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
			...
			<tr bgcolor="#FFFFFF"> 
              ...
              <td width="16%" align="right">项目总监</td>
...
%>
			  ...
			  <td width="18%" align="right">项目总监</td>
			...
			<tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">验收记录号</td>
              <td width="32%"> 
                <input type="text" name="ysjlh" size="20" maxlength="11">              </td>
              <td width="16%" align="right">验收项目</td>
              <td width="34%"> 
			...
			<tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right">项目验收时间</td>
			...
			<tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">项目验收人</td>
              <td width="32%"> 
                <input type="text" name="ysr" size="20" maxlength="20">              </td>
              <td width="16%" align="right">录入人</td>
              <td width="34%"> 
			...
			<tr bgcolor="#FFFFFF">
			  ...
			  <td><select name="clbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="9">录入未完成</option>
                  <option value="0">没问题</option>
                  <option value="1">整改未接收</option>
                  <option value="2">接收</option>
                  <option value="3">在处理</option>
                  <option value="4">已解决</option>
                  <option value="5">验收通过</option>
                  <option value="6">验收未通过</option>
              </select></td>
			  <td align="right">整改处理状态</td>
			...
			<tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">照片筛选</td>
              <td width="32%"> 
                <input type="radio" name="zpsx" value="Y">
                有照片
                <input type="radio" name="zpsx" value="N">
                无照片</td>
              <td width="18%" align="right">验收结果</td>
              <td width="32%"> 
                <input type="radio" name="sjysjg" value="0">合格
				<input type="radio" name="sjysjg" value="1" >不合格              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Crm_ysjlXgJsList.jsp";
	FormName.submit();
	return true;
}
