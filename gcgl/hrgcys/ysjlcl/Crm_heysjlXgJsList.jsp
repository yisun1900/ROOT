...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_heysjl.ysjlh,DECODE(crm_heysjl.sjysjg,'0','合格','1','需整改') sjysjg,DECODE(crm_heysjl.clbz,'9','录入未完成','0','没问题','1','整改未接收','2','接收','3','在处理','4','已解决','5','验收通过','6','验收未通过') clbz,zpsl,dm_gcysxm.gcysxmmc,crm_heysjl.jsr,TO_CHAR(crm_heysjl.jssj,'YYYY-MM-DD'),crm_khxx.khxm,crm_khxx.fwdz,crm_heysjl.sjs,sq_sgd.sgdmc,crm_heysjl.zjxm,crm_heysjl.ysr,TO_CHAR(crm_heysjl.yssj,'YYYY-MM-DD'),crm_heysjl.zgcljlh ,TO_CHAR(jhjjsj,'YYYY-MM-DD'),crm_heysjl.jssm,DECODE(crm_heysjl.cljg,'3','在处理','4','已解决') cljg,crm_heysjl.jjr,TO_CHAR(crm_heysjl.jjsj,'YYYY-MM-DD'),crm_heysjl.jjsm,DECODE(crm_heysjl.zgysjg,'5','验收通过','6','验收未通过') zgysjg,crm_heysjl.zgysr,TO_CHAR(crm_heysjl.zgyssj,'YYYY-MM-DD'),crm_heysjl.zgyssm             ,crm_khxx.khbh,crm_heysjl.lrr,crm_heysjl.lrsj,sq_dwxx.dwmc,crm_heysjl.yscsjlh,crm_heysjl.bz  ";
    ...
    ls_sql+=" and crm_heysjl.clbz in('2')";
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by crm_heysjl.jssj desc,crm_heysjl.yscsjlh desc,crm_heysjl.ysjlh desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_heysjlXgJsList.jsp","","","XgJsCrm_heysjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJsCrm_heysjl.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="50px">项目总监</td>
	<td  width="50px">品质管理员</td>
