...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_heysjl.clbz in('5','6')";
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by crm_heysjl.zgyssj desc,crm_heysjl.yscsjlh desc,crm_heysjl.ysjlh desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_heysjlXgYsList.jsp","","","XgYsCrm_heysjl.jsp");
...
//	pageObj.setEditStr("验收");

//设置按钮参数
	String[] buttonName={"删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"DeleteYsCrm_heysjl.jsp?"};//按钮单击调用的网页，可以增加参数
