...
<form method="post" action="SaveXgJsCrm_heysjl.jsp" name="editform" >
<div align="center">整改接收－维护(处理记录号:<%=zgcljlh%>)</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"> 
    <textarea name="jssm" cols="71" rows="4" ><%=jssm%></textarea>  </td>
</tr>
    <tr> 
      <td colspan="4" >
	<div align="center">
