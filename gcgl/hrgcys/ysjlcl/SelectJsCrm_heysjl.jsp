...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_heysjlJsList.jsp" name="selectform">
<div align="center">工程验收记录－整改接收</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><select name="clbz" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectToken(out,"9+录入未完成&0+没问题&1+整改未接收&2+接收&3+在处理&4+已解决&5+验收通过&6+验收未通过","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
