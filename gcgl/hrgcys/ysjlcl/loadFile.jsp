...
String zpxm=cf.GB2Uni(cf.getParameter(request,"zpxm"));
String zpsm=cf.GB2Uni(cf.getParameter(request,"zpsm"));
...
uploadUrl.append("/gcgl/hrgcys/ysjlcl/SaveloadFile.jsp");
%>
...
SWFUpload.onload = function () 
{
	var settings = {
		...
		post_params: {
			"ysjlh" : "<%=ysjlh%>",
			"zplx" : "<%=zplx%>",
			"zpxm" : "<%=java.net.URLEncoder.encode(zpxm,"UTF-8")%>",
			"zpsm" : "<%=java.net.URLEncoder.encode(zpsm,"UTF-8")%>",
			"ext" : "<%=ext%>"
		},
...
<div id="content">
	<form id="form1" action="SaveloadFile.jsp" method="post" target="_blank" enctype="multipart/form-data">
