...
String zpxmbm=cf.GB2Uni(cf.getParameter(request,"zpxmbm"));
...
<form method="post" action="ViewYszxZp.jsp" name="editform">
...
<%
	...
	ls_sql+=" where  ysjlh='"+ysjlh+"'  and  zplx='3'  and zpxmbm='"+zpxmbm+"' ";
