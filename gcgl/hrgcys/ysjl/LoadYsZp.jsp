...
String zpsm=request.getParameter("zpsm");
...
uploadUrl.append("/gcgl/hrgcys/ysjl/SaveLoadYsZp.jsp");
%>
...
<div id="content">
	<form id="form1" action="saveLoadYsZp.jsp" method="post" target="_blank" enctype="multipart/form-data">
