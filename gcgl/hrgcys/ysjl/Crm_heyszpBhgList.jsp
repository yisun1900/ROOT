...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (zpshbz!=null)
	{
		...
		if (!(zpshbz.equals("")))	wheresql+=" and  (crm_heyszp.zpshbz='"+zpshbz+"')";
	}
	String shr=null;
	...
	{
		shr=cf.GB2Uni(shr);
		if (!(shr.equals("")))	wheresql+=" and  (crm_heyszp.shr='"+shr+"')";
	}
	String shsj=null;
	...
	{
		shsj=shsj.trim();
		if (!(shsj.equals("")))	wheresql+="  and (crm_heyszp.shsj>=TO_DATE('"+shsj+"','YYYY-MM-DD'))";
	}
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_heyszpBhgList.jsp","","","Editcrm_heyszpCp.jsp");
