...
<body bgcolor="#FFFFFF">
<form method="post" action="Dm_hegcysbbList.jsp" name="selectform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="15%">验收版本名称</td> 
  <td width="35%"> 
    <input type="text" name="gcysbbmc" size="20" maxlength="50" >
  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%">是否在用版本</td> 
  <td width="35%"> 
    <select name="sfzybb" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
<%
	cf.selectToken(out,"1+未启用&2+当前版&3+可用版&4+已停用","");
%>
    </select>
  </td>
