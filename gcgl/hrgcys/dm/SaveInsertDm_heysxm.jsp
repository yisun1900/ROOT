...
try {
	...
	ls_sql="insert into dm_heysxm ( gcysbbh,gcysxmbm,gcysxmmc,ysxmflbm,dygcjdbm,sfsgjdb,jdbm,sfhf,hflxbm,ljskbfb,yszxsl,byxsl,fbyxzxsl,ysbzsm,bz,yssx,xmlx,sfxzjg,ysjj,zgysjj ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
