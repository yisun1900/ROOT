...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdfkjlCxList.jsp" name="selectform">
<div align="center">施工队私单记录－查询</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFCC">
    ...
    <td><select name="cw_sgdfkjl_sgd" style="FONT-SIZE:12PX;WIDTH:152PX"  onChange="changeSgd(selectform)">
      <option value=""></option>
      <%
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <INPUT type="radio" name="cw_sgdfkjl_scbz" value="N">未删除
    <INPUT type="radio" name="cw_sgdfkjl_scbz" value="Y">已删除  </td>
  <td align="right" width="19%">状态</td> 
  <td width="31%"><input type="radio" name="cw_sgdfkjl_zt" value="1">
    未审核
      <input type="radio" name="cw_sgdfkjl_zt" value="2">
      审核
      <input type="radio" name="cw_sgdfkjl_zt" value="3">
      扣款 </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">删除人</td> 
  <td width="32%"><input type="text" name="cw_sgdfkjl_scr" size="20" maxlength="20" ></td>
  <td align="right" width="19%">删除时间 </td>
  <td width="31%"><input type="text" name="cw_sgdfkjl_scsj" size="20" maxlength="10" ></td>
</tr>
<tr align="center"> 
  <td colspan="4"> 
...
function changeSgd(FormName) 
{
	...
	if (FormName.cw_sgdfkjl_sgd.value=="")
	{
		return;
	}

	var sql;
	sql="select bzmc c1,bzmc c2 from sq_bzxx where sgd='"+FormName.cw_sgdfkjl_sgd.value+"' and tdbz in('N','Y') order by bzmc";
...
{
	if(!(isDatetime(FormName.cw_sgdfkjl_fksj, "私单时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.cw_sgdfkjl_fksj2, "私单时间"))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.cw_sgdfkjl_scsj, "删除时间"))) {
		return false;
	}
	FormName.submit();
	return true;
