...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertCrm_sgdsdjl.jsp" name="insertform" >
<div align="center">
  <DIV align="center">录入－施工队私单记录</DIV>
</div>
...
<%
	...
	ls_sql="SELECT cw_sgdfkjl.fkjlh,DECODE(cw_sgdfkjl.zt,'1','未审核','2','审核','3','扣款'),sgbz,cw_sgdfkjl.fksj,cw_sgdfkjl.fkyy";
	ls_sql+=" FROM cw_sgdfkjl  ";
...
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
  <td width="15%" align="right" bgcolor="#FFFFFF"><span class="STYLE2"><span class="STYLE1">*</span>记录号</span></td> 
  <td width="35%"> 
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><span class="STYLE2"><span class="STYLE1">*</span>施工队</span></td>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>私单时间</td>
  <td><input type="text" name="fksj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right">&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><span class="STYLE1">*</span>私单说明</td> 
  <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.fksj, "私单时间"))) {
		return false;
	}
