...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"><font color="#FFFF99">请修改增减项信息（增减项序号：<%=zjxxh%>）</font></div>    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right"> 
                <font color="#FF0000">*</font>增减项说明              </td>
              <td colspan="3"> 
            ...
            <tr> 
              <td height="2" colspan="4" align="center"> 
                ...
                <input type="button"  value="选报价项目" onClick="f_xzxm(insertform)" name="lr" >
                ...
                <input type="button"  value="修改自购主材" onClick="f_xgzgzc(insertform)" name="xgzgzc" >
                  <input type="reset"  value="重输">
                <P>
                  <input type="button"  value="完成增减项" onClick="f_wc(insertform)" name="wc" >
