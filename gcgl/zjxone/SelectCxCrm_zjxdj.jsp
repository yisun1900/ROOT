...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">增减项原因</td>
              <td width="32%"> 
...
%> 
              ...
              <td width="18%" align="right">工程扣款审批标志</td>
              <td width="32%"><input type="radio" name="gckkspbz" value="N">
未审批
  <input type="radio" name="gckkspbz" value="Y">
已审批 </td>
            </tr>
