...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  crm_khxx.khxm,crm_khxx.fwdz,sgdmc,sjs ,crm_zjxdj.zjxxh,DECODE(crm_zjxdj.zjxwcbz,'1','未完成','2','已完成') zjxwcbz,crm_zjxdj.zjje,crm_zjxdj.jzjje,crm_zjxdj.zqguanlif,crm_zjxdj.zhguanlif,crm_zjxdj.zjxsuijin,crm_zjxdj.kglf,crm_zjxdj.kqtk,zjxfsjdmc,fssj,crm_zjxdj.lrr,hth,dm_zjxyybm.zjxyymc ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="5%">折前增减项发生额</td>
	<td  width="5%">折后增减项发生额</td>
	<td  width="5%">折前增减项管理费</td>
	<td  width="5%">折后增减项管理费</td>
	<td  width="5%">增减项税金</td>
	<td  width="5%">扣管理费</td>
	<td  width="5%">扣其它款</td>
	<td  width="4%">发生阶段</td>
