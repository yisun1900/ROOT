...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  crm_zjxdj.zjxxh,DECODE(crm_zjxdj.sfwc,'N','未完成','Y','已完成') sfwc,'修改' xg,'删除' sc,'删除标志' scwc,hth,crm_khxx.khxm,crm_khxx.fwdz,sgdmc,sjs,zjxfsjdmc,crm_zjxdj.zjje,crm_zjxdj.jzjje,crm_zjxdj.zqguanlif,crm_zjxdj.zhguanlif,crm_zjxdj.zjxsuijin,crm_zjxdj.kglf,crm_zjxdj.kqtk,fssj";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by crm_zjxdj.lrsj desc,crm_zjxdj.zjxxh";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
...
//	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
	...
	coluParm=new ColuParm();//生成一个列参数对象
	String[] coluKey4={"zjxxh"};//设置列参数：coluParm.key的主键
	coluParm.key=coluKey4;//设置列参数：coluParm.key的主键
	coluParm.link="DeleteWcbz.jsp";//为列参数：coluParm.link设置超级链接
	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
	coluParmHash.put("scwc",coluParm);//列参数对象加入Hash表
	pageObj.setColuLink(coluParmHash);//列参数对象加入Hash表
/*
//设置主键的显示方式
...
<CENTER >
  <B><font size="3">增减项管理—维护(有明细)</font></B>
</CENTER>
<%
	pageObj.out=out;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">设计师</td>
	<td  width="4%">发生阶段</td>
	<td  width="6%">增减项发生额－折前</td>
	<td  width="6%">增减项发生额－折前</td>
	<td  width="6%">增减项管理费－折前</td>
	<td  width="6%">增减项管理费－折前</td>
	<td  width="6%">增减项税金</td>
	<td  width="5%">减项扣管理费</td>
	<td  width="5%">扣其它款</td>
