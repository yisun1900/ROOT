...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdjljlShList.jsp" name="selectform">
<div align="center">施工队奖励－审核</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <INPUT type="radio" name="cw_sgdjljl_scbz" value="N" checked>未删除
  </td>
  <td align="right" width="19%">状态</td> 
  <td width="31%"><input type="radio" name="cw_sgdjljl_zt" value="1" checked>
    未审核
 </td>
</tr>
<tr bgcolor="#FFFFFF">
