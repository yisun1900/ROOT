...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sgdfkjl.fkjlh,cw_sgdfkjl.fdbh,DECODE(cw_sgdfkjl.zt,'1','未审核','2','审核','3','结算'), DECODE(cw_sgdfkjl.scbz,'N','未删除','Y','已删除'),sgdmc,cw_sgdfkjl.fksj,cw_sgdfkjl.fkr,cw_sgdfkjl.fkje,cw_sgdfkjl.fkyy,cw_sgdfkjl.shr,cw_sgdfkjl.shsj,cw_sgdfkjl.shsm,cw_sgdfkjl.skkr,cw_sgdfkjl.skksj,cw_sgdfkjl.skksm, cw_sgdfkjl.lrr,cw_sgdfkjl.lrsj,dwmc,cw_sgdfkjl.bz";
...
//设置按钮参数
	String[] buttonName={"删除扣款"};//按钮的显示名称
	String[] buttonLink={"Cw_sgdfkjlXgKkList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">施工队罚款－修改扣款</font></B>
</CENTER>
<%
	pageObj.out=out;
