...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (jsjlh!=null)
	{
		...
		if (!(jsjlh.equals("")))	wheresql+=" and  (cw_sgdfkjl.jsjlh='"+jsjlh+"')";
	}
	...
	ls_sql="SELECT cw_sgdfkjl.fkjlh,cw_sgdfkjl.fdbh,DECODE(cw_sgdfkjl.zt,'1','未审核','2','审核','3','结算'), DECODE(cw_sgdfkjl.scbz,'N','未删除','Y','已删除'),sgdmc,sgbz,cw_sgdfkjl.fksj,cw_sgdfkjl.fkr,cw_sgdfkjl.fkje,cw_sgdfkjl.fkyy,cw_sgdfkjl.shr,cw_sgdfkjl.shsj,cw_sgdfkjl.shsm,cw_sgdfkjl.jsjlh,cw_sgdfkjl.skkr,cw_sgdfkjl.skksj,cw_sgdfkjl.skksm, cw_sgdfkjl.lrr,cw_sgdfkjl.lrsj,dwmc,cw_sgdfkjl.scr,cw_sgdfkjl.scsj,cw_sgdfkjl.bz";
