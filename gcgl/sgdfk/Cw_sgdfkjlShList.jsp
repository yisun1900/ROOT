...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cw_sgdfkjl.fkjlh,cw_sgdfkjl.fdbh,DECODE(cw_sgdfkjl.zt,'1','未审核','2','审核','3','结算'),sgdmc,cw_sgdfkjl.fksj,cw_sgdfkjl.fkr,cw_sgdfkjl.fkje,cw_sgdfkjl.fkyy, cw_sgdfkjl.lrr,cw_sgdfkjl.lrsj,dwmc,cw_sgdfkjl.bz";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cw_sgdfkjlShList.jsp","","","ShCw_sgdfkjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Cw_sgdfkjlShList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update cw_sgdfkjl set zt='2',shr='"+yhmc+"',shsj=TRUNC(SYSDATE),shsm='批量审核'  where zt='1' and "+chooseitem;
