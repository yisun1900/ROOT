...
<body bgcolor="#FFFFFF">
<form method="post" action="Cw_sgdfkjlXgKkList.jsp" name="selectform">
<div align="center">施工队罚款－修改扣款</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"> 
    <INPUT name="cw_sgdfkjl_scbz" type="radio" value="N" checked>
    未删除</td>
  <td align="right" width="19%">状态</td> 
  <td width="31%"><input name="cw_sgdfkjl_zt" type="radio" value="3" checked>
    扣款</td>
</tr>
