...
<form method="post" action="Crm_khxxJyList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="21%" align="right">打印标志</td>
              <td width="29%">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">是否已上保险</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">保险开始时间 从</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">保险终止时间 从</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">集成订单/合同日期 从</td>
              <td width="29%"> 
...
%> 
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">工厂/品牌</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">订单状态</td>
              <td width="29%"> 
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="查询" onClick="f_do(selectform,'gccx')" name="button">
                <input type="reset"  value="重输" name="reset">
                <input type="button"  value="统计表" onClick="f_do(selectform,'tj')" name="button22">
              </td>
            </tr>
          </table>
</form>
