...
try {
	...
	ls_sql="select dwdh ";
	ls_sql+=" from  sq_dwxx";
	ls_sql+=" where ssfgs='"+ssfgs+"' and dwflbm='04'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 16px'>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="35" colspan="2" >请您致电财务部：<u>&nbsp;<%=cwdh%>&nbsp;</u>，谢谢您的配合！</td>
  </tr>
  
  
  <tr  bgcolor="#FFFFFF">
    <td width="95%" height="35" align="right" ><%=cf.formatDate(cf.today())%></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 16px'>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="35" colspan="3" >请您致电财务部：<u>&nbsp;<%=cwdh%>&nbsp;</u>，谢谢您的配合！</td>
  </tr>
  <tr  bgcolor="#FFFFFF">
    <td height="35" >&nbsp;</td>
    <td ><strong>【</strong>客户签字确认已收到工程决算单<strong>】</strong></td>
    <td width="5%" height="35" >&nbsp;</td>
  </tr>
  <tr  bgcolor="#FFFFFF">
  <td width="3%" height="35" >&nbsp;</td>
  <td width="92%" ><strong>【</strong>客户签字：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>，日期：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>】</td>
  <td height="35" >&nbsp;</td>
  </tr>
