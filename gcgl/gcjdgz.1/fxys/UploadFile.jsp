...
<%
    ...
    double perMaxSize = 100;//单个文件允许的max大小
	...
	uploadUrl.append("/gcgl/gcjdgz/fxys/UploadFileSubmit.jsp");
%>
...
<div id="content">
	<form id="form1" action="UploadFileExampleSubmit.jsp" method="post" target="_blank" enctype="multipart/form-data">
