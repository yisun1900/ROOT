...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,gcjdmc,khxm,fwdz,sjkgrq,sgdmc,sjs,zjxm,kgzsj,sq_dwxx.dwmc,jgrq ";
    ...
    ls_sql+=" and crm_khxx.zt='2' and crm_khxx.gcjdbm='3'";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">姓名</td>
	<td  width="18%">房屋地址</td>
	<td  width="8%">实际开工日期</td>
	<td  width="6%">施工队</td>
	<td  width="6%">设计师</td>
	<td  width="6%">工程担当</td>
	<td  width="8%">出开工证时间</td>
	<td  width="11%">签约店面</td>
