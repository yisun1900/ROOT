...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">主材安装阶段－－维护</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">主材安装阶段时间 从</td>
              <td width="32%"> 
...
{
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj, "主材安装阶段时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj2, "主材安装阶段时间"))) {
		return false;
	}
