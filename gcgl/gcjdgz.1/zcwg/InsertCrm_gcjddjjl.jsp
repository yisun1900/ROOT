...
try {
	...
	ls_sql="select crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm,pdclzt,kgsjqd,fgsbh,sybgcrq,szqsj,szcwgsj";
	...
	if (rs.next())
	{
		...
		szcwgsj=cf.fillNull(rs.getDate("szcwgsj"));
	}
	rs.close();
	ps.close();
	...
	{
		out.println("错误！未进行[隐蔽工程验收登记]，不能进行[主材安装阶段登记]");
		return;
	}
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%"> 
      <div align="center">主材安装阶段登记（登记记录号：<%=djjlh%>）<%=hfcsbzStr%></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="18%" align="right">主材安装阶段日期</td>
              <td width="32%"><%=szcwgsj%></td>
            </tr>
			<tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right">主材安装阶段日期</td>
...
%> 
              ...
              <td width="18%" align="right"> 
                <font color="#CC0000">*</font>主材安装阶段日期              </td>
              <td width="32%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.djsj, "主材安装阶段时间"))) {
		return false;
	}
