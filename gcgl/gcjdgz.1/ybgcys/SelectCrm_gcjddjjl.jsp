...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">隐蔽工程完成－－维护</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">隐蔽工程完成时间 从</td>
              <td width="32%"> 
...
{
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj, "隐蔽工程完成时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj2, "隐蔽工程完成时间"))) {
		return false;
	}
