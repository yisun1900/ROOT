...
try {
	...
	ls_sql="select zjxwcbz,crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm,pdclzt,kgsjqd,fgsbh,sybgcrq,szqsj";
	...
	if (szqsj==null || szqsj.equals(""))
	{
		out.println("错误！未进行[中期验收登记]，不能进行[基础施工完工登记]");
		return;
	}
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%"> 
      <div align="center">基础施工完工登记（登记记录号：<%=djjlh%>）<%=hfcsbzStr%></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right">隐蔽工程完成日期</td>
              <td width="32%"><font color="#000000"><%=sybgcrq%></font></td>
              <td width="18%" align="right">中期验收日期</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <select name="gcjdbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
	cf.selectItem(out,"select gcjdbm,gcjdmc from  dm_gcjdbm where gcjdbm='4' order by gcjdbm","");
%> 
              </select>              </td>
              <td width="18%" align="right"> 
                <font color="#CC0000">*</font>实际完工日期              </td>
              <td width="32%"> 
              <input type="text" name="djsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#CC0000">*</font>是否发生增减项</td>
              <td><%
	cf.radioToken(out, "zjxwcbz","1+未发生增减项&2+发生增减项",zjxwcbz);
%></td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.djsj, "实际完工日期"))) {
		return false;
	}
