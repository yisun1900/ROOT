...
try {
	...
	ls_sql="select zjxwcbz,crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">修改完工日期（登记记录号：<%=djjlh%>）<%=hfcsbzStr%></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
              ...
              <td width="32%"> 
                <input type="text" name="djsj" size="20" maxlength="10"  value="<%=djsj%>" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
