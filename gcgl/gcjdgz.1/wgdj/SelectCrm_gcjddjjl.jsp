...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">基础施工完工登记－－维护</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">实际完工日期 从</td>
              <td width="32%"> 
...
{
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj, "实际完工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.crm_gcjddjjl_djsj2, "实际完工日期"))) {
		return false;
	}
