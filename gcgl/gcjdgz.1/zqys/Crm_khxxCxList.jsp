...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,gcjdmc,khxm,fwdz,sjkgrq,sybgcrq,jhzqsj,sgdmc,sjs,zjxm,sq_dwxx.dwmc,jgrq ";
    ...
    ls_sql+=" and crm_khxx.zt='2' and crm_khxx.gcjdbm='6'";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="7%">隐蔽工程验收日期</td>
	<td  width="7%">计划中期验收时间</td>
	<td  width="5%">施工队</td>
	<td  width="5%">设计师</td>
	<td  width="5%">工程担当</td>
	<td  width="10%">签约店面</td>
