...
try {
	...
	ls_sql="select jhybgcrq,jhzqsj,crm_khxx.khxm,fwdz,lxfs,hth,sjs,qye,qyrq,kgrq,jgrq,sjkgrq,sjjgrq,dwbh,sgd,sgbz,zjxm,pdclzt,kgsjqd,fgsbh,sybgcrq,szqsj";
	...
	if (sybgcrq==null || sybgcrq.equals(""))
	{
		out.println("错误！未进行[隐蔽工程验收登记]，不能进行[中期验收登记]");
		return;
	}
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%"> 
      <div align="center">中期验收登记（登记记录号：<%=djjlh%>）<%=hfcsbzStr%></div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="18%" align="right"><font color="#0000CC"><strong>计划隐蔽工程验收</strong></font></td>
              <td width="32%"><font color="#0000CC"><strong><%=jhybgcrq%></strong></font></td>
              <td width="18%" align="right"><font color="#0000CC"><strong>隐蔽工程完成日期</strong></font></td>
              <td width="32%"><strong><font color="#0000CC"><%=sybgcrq%></font></strong></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">&nbsp;</font></td>
              <td><font color="#0000CC">&nbsp;</font></td>
              <td align="right"><font color="#0000CC"><strong>计划中期验收时间</strong></font></td>
              <td><font color="#0000CC"><strong><%=jhzqsj%></strong></font></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"> 
...
%> 
              ...
              <td width="18%" align="right"> 
                <font color="#CC0000">*</font>中期验收时间              </td>
              <td width="32%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.djsj, "中期验收时间"))) {
		return false;
	}
