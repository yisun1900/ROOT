...
<CENTER >
  <B><font size="3">设置实际竣工验收日期(<font color="#FF0000">注意：只有完工登记的客户才能被查询到</font>)</font></font></B>
</CENTER>
...
<table border="1" width="120%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
    <tr bgcolor="#CCCCCC"> 
	  ...
	  <td  width="9%" align="center">实竣工验收日期 </td>
...
%>
    ...
    <tr bgcolor="#CC0000"> 
      ...
      <td colspan="9" bgcolor="#CC0000">数据不存在或已竣工验收</td>
	</tr>
<%
		}
	}
