...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT gdm_gdjcjl.jcjlh,DECODE(gdm_gdjcjl.cfspbz,'2','未审批','3','审批通过','4','审批未通过'),spr,spsj,sgdmc,fkze,kfzs,gdm_gdjcjl.kcjdebl||'%',crm_khxx.hth,crm_khxx.khxm,gdm_gdjcjl.xjr,gdm_gdjcjl.xjsj,xjlxmc,xjjgmc,gdm_gdjcjl.bz,crm_khxx.fwdz,crm_khxx.sjs,crm_khxx.zjxm  ";
    ...
    ls_sql+=" and gdm_gdjcjl.cfspbz in('3','4')";
    ls_sql+=wheresql;
    ls_sql+=" order by gdm_gdjcjl.jcjlh";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Gdm_gdjcjlXgSpList.jsp","SelectXgSpGdm_gdjcjl.jsp","","XgSpGdm_gdjcjl.jsp");
