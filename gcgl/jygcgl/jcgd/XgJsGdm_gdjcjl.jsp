...
<html>
<head>
<title>工地监察记录－接收－修改</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">工地监察记录－接收－修改（监察记录号：<%=jcjlh%>） </div>
...
<form method="post" action="SaveXgJsGdm_gdjcjl.jsp" name="editform">
        <div align="center"><b>工地监察记录－接收－修改</b></div>
...
%> 
    ...
    <tr>
      ...
      <td rowspan="2"><%
	cf.radioToken(out, "clzt","2+已接收等待出方案<BR>&D+已接收不需出方案",clzt);
%></td>
