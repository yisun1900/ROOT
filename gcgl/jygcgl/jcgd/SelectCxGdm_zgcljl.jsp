...
<form method="post" action="Gdm_zgcljlCxList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">监察记录号</td>
              <td><input type="text" name="gdm_gdjcjl_jcjlh" size="20" maxlength="10" >              </td>
              <td align="right">检查人</td>
              <td><input type="text" name="gdm_gdjcjl_xjr" size="20" maxlength="20" ></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">检查时间从</td>
              <td><input type="text" name="gdm_gdjcjl_xjsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
              <td><input type="text" name="gdm_gdjcjl_xjsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">信息来源</td>
              <td><select name="gdm_gdjcjl_xxlybm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectItem(out,"select xxlybm,xxlymc from gdm_xxlybm order by xxlybm","");
%>
                </select>              </td>
              <td align="right">监察类型</td>
              <td><select name="gdm_gdjcjl_jclxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">监察结果</td>
              <td><select name="gdm_gdjcjl_jcjgbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%>
              ...
              <td><select name="gdm_gdjcjl_jcwtflbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input type="text" name="gdm_gdjcjl_lrr" size="20" maxlength="20" >              </td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" >处理时间 从</td>
              <td><input type="text" name="clsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td  align="right">到</td>
              <td><input type="text" name="clsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
