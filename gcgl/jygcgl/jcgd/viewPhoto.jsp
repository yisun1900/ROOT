...
try 
{
	...
	//		out.println("filename="+ls+"\\"+filename[i]);
			...
			ls_sql=" delete from gdm_jcjlzp";
			ls_sql+=" where  jcjlh='"+jcjlh+"' and xjzpmc='"+filename[i]+"'";
...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF"> 
		  ...
		  <td width="60%"> 
			<div align="center"><img src="/gcgl/jygcgl/images/<%=yszpmc.toUpperCase() %>" width="300"></div>
		  </td>
		</tr>
<%
}
