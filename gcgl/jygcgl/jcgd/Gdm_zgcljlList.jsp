...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and gdm_gdjcjl.clzt in('3','B')";
...
//进行对象初始化
	...
	pageObj.initPage("Gdm_zgcljlList.jsp","","","EditGdm_zgcljl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteClGdm_gdjcjl.jsp"};//按钮单击调用的网页，可以增加参数
