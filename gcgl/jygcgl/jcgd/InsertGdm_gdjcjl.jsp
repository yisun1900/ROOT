...
//检查记录号
	...
	ls_sql="select khxm,fwdz,lxfs,sjkgrq,sjs,crm_khxx.sgd,sgdmc,zjxm,sgbz,fgsbh";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">精益工程管理（记录号：<%=jcjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><%
	cf.radioToken(out, "sffszg","Y+发生&N+未发生","");
%></td>
...
%>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
              <input type="text" name="xjr" value="<%=yhmc%>" size="20" maxlength="20">              </td>
              <td width="18%"> 
...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
                ...
                <input type="button"  value="录入项目" onClick="window.open('InsertGdm_jcjlmx.jsp?jcjlh=<%=jcjlh%>&khbh=<%=khbh%>&ssfgs=<%=ssfgs%>')" name="lr" disabled=true >
                <input type="button"  value="查看项目" onClick="window.open('Gdm_jcjlmxList.jsp?jcjlh=<%=jcjlh%>')" name="cx" disabled=true>
