...
try {
	...
	cljlh=jcjlh+cf.addZero(count+1,3);
%>
...
<div align="center">处理（监察记录号：<%=jcjlh%>） </div>
...
<form method="post" action="SaveInsertGdm_zgcljl.jsp" name="editform"  >
        <div align="center"><b>处理</b>（处理记录号：<%=cljlh%>）</div>
