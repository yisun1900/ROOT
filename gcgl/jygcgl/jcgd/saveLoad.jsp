...
//		out.println("<BR>filename="+filename);
		...
		ls_sql+=" where  jcjlh='"+jcjlh+"' and xjzpmc='"+loadname+"'";
		...
		if (count==0)
		{
			ls_sql="insert into gdm_jcjlzp(xjzpmc,jcjlh) values(?,?)";
			ps= conn.prepareStatement(ls_sql);
