...
myxssl=request.getParameter("myxssl");
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm,crm_khxx.lrr,htshr,htshsj,htshdf,htshyj,crm_khxx.sjs,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.lxfs,crm_khxx.fwdz,crm_khxx.qye,DECODE(htshbz,'N','未审核','Y','已审核')";
