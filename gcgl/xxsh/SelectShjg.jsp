...
%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="31%"> 
                <input type="text" name="xxshsj" size="20" maxlength="10" >
              </td>
              <td width="17%" align="right">到</td>
              <td width="33%"> 
                <input type="text" name="xxshsj2" size="20" maxlength="10" >
              </td>
            </tr>
            <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.xxshsj, "审核时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.xxshsj2, "审核时间"))) {
		return false;
	}
