...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tddjCxList.jsp","","","");
//	pageObj.setPageRow(10);//设置每页显示记录数
//设置显示列
	String[] disColName={"tdxh","sfthlp","crm_tddj_khxm","crm_tddj_fwdz","tdsj","dm_tdyybm_tdyymc","crm_tddj_ytje","crm_tddj_stje","tdyysm","crm_tddj_sjs","crm_tddj_zjxm","crm_tddj_sgd","qye","qyrq","lrr","lrsj","sq_dwxx_dwmc"};
...
<CENTER >
  <B><font size="3">施工合同退单－查询</font></B>
</CENTER>
<%
	pageObj.out=out;
