...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">施工合同退单－维护</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_tddjList.jsp" name="selectform">
...
%> 
              ...
              <td width="18%" align="right"> 
                退单原因说明              </td>
              <td width="32%"> 
                <input type="text" name="crm_tddj_tdyysm" size="20" value="">              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right"> 退单时间 从 </td>
              <td><input type="text" name="tdsj" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)" >              </td>
              <td align="right"> 到 </td>
              <td><input type="text" name="tdsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">退单序号</td>
              <td width="32%"><input type="text" name="crm_tddj_tdxh" size="20" maxlength="9" ></td>
              <td width="18%" align="right"> 
                录入人              </td>
              <td width="32%"> 
                <input type="text" name="crm_tddj_lrr" size="20" maxlength="20" >              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"> 
                录入时间 从              </td>
              <td width="32%"> 
                <input type="text" name="crm_tddj_lrsj" size="20" maxlength="10" value="" onDblClick="JSCalendar(this)" >              </td>
              <td width="18%" align="right"> 
                到              </td>
              <td width="32%"> 
                <input type="text" name="crm_tddj_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.tdsj2, "退单时间"))) {
		return false;
	}
