...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_baoxian.khbh,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.hth,crm_khxx.sjs,sgdmc,crm_baoxian.cdbxje,crm_baoxian.rybxje,crm_baoxian.baokssj,crm_baoxian.baozzsj,crm_baoxian.lrr,crm_baoxian.lrsj,a.dwmc lrbm,b.dwmc dm,crm_baoxian.bz  ";
    ...
    ls_sql+=" and crm_baoxian.zt='2'";//2：未结算；3：结算
    ls_sql+=wheresql;
    ls_sql+=" order by crm_baoxian.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_baoxianList.jsp","","","EditCrm_baoxian.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_baoxianList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set sfysbx='1' where "+chooseitem;
		sql[1]="delete from crm_baoxian where "+chooseitem;
