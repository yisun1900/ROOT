...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_zjxdj.lx='1' and crm_zjxdj.shbz in('N','M')";//N：未审核；Y：审核通过；S：审核未通过；M：不需审核
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zjxdjScWcList.jsp","","","");
...
//设置列超级连接
	...
	coluParm.link="EditScWcCrm_zjxdj.jsp";//为列参数：coluParm.link设置超级链接
//	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
