...
<body>
<div align="center">增减项审核（增减项序号：<%=zjxxh%>）</div> 
...
%></b></font></td>
  ...
  <tr bgcolor="#FFFFFF" align="center"> 
    <td colspan="4">  
      ...
      <input type="button" value="工程变更单" onClick="window.open('dzbj/zxbjmx/Bj_khbjmxBgdList.jsp?zjxxh=<%=zjxxh%>&khbh=<%=khbh%>')"></td>
  </tr>
</table>
...
<form method="post" action="" name="insertform" >
        <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td width="32%">
<%
	cf.radioToken(out,"shbz","1+审核通过&2+审核未通过",shbz);
%>
					</td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right"><font color="#FF0000">*</font>审核意见              </td>
              <td colspan="3"> 
                <textarea name="shyj" cols="74" rows="3"><%=shyj%></textarea>              </td>
            </tr>
            <tr> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditGcShCrm_zjxdj.jsp";
	FormName.submit();
	return true;
}
