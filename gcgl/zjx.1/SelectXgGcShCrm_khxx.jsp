...
<form method="post" action="Crm_zjxdjXgGcShList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
			...
			<tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">增减项序号</td>
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="19%" align="right">增减项发生时间 从</td>
              <td width="31%"> 
