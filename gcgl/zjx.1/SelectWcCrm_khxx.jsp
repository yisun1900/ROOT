...
<form method="post" action="Crm_khxxWcList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="34%"> 
                <input type="text" name="zjxm" value="<%=zjxm%>" size="20" maxlength="20" <% if (!zjxm.equals("")) out.println("readonly");%>>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
