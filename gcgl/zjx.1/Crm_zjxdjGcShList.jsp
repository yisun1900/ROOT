...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and crm_zjxdj.shbz='N'";//M：不需审核；N：未审核；Y：审核通过；S：审核未通过；1：工程部审核通过；2：工程部审核未通过；3：监理部审核通过；4：监理部审核未通过；5：财务部审核通过6：财务部审核未通过
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_zjxdjGcShList.jsp","","","EditGcShCrm_zjxdj.jsp");
