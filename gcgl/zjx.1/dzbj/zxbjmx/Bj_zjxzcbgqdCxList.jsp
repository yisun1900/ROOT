	...
	if (alljmjeh!=alljmjeq)
	{
			...
			while (rs.next())
			{
				...
				%> 
				  <tr bgcolor="#FFFFFF"  align="center"> 
					...
					<td><%=jmjldw%></td>
					<td><%=cf.formatDouble(jmdj*zcjmzk/10)%></td>
					<td><%=cf.formatDouble(-1*sjjmsl)%></td>
					<td><%=cf.formatDouble(-1*sjjmje*zcjmzk/10)%></td>
				  </tr>
		...
		%> 
		  ...
		  <tr bgcolor="#FFFFFF"  align="center"> 
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><%=cf.formatDouble(sjjmslBgq-sjjmslBgh)%></td>
			<td><%=cf.formatDouble((sjjmjeBgq-sjjmjeBgh)*zcjmzk/10)%></td>
		   </tr>
