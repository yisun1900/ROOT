...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px'>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="8" align="center" class="STYLE2" ><B>套餐－主材超量加价清单&nbsp;LWTC-04</B></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<%
	...
	ls_sql="SELECT jgwzbm,bj_khzcxmxjq.tccplbbm,clxlmc,bzsl,sjsl,sjjshsl";
    ...
    ls_sql+=" and bj_khzcxmxjq.sfxzsl='1' ";//1：可增项；2：不可增项；3：不控制
...
<%
	...
	String clxlmc=null;
	double getxlsl=0;
	ls_sql="SELECT bj_khzcxmxjq.tccplbbm,clxlmc,sum(sjsl)";
	ls_sql+=" FROM bj_khzcxmxjq,jxc_clxlbm";
    ls_sql+=" where bj_khzcxmxjq.tccplbbm=jxc_clxlbm.clxlbm and zjxxh='"+zjxxh+"'";//1：可增项；2：不可增项；3：不控制
	ls_sql+=" group by bj_khzcxmxjq.tccplbbm,clxlmc";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	while (rs.next())
	{
