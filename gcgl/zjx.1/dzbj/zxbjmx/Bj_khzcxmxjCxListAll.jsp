...
<input type="hidden" name="zjxxh" value="<%=zjxxh%>" >
  ...
  <table border="0" cellspacing="1" bgcolor="#999999" cellpadding="1" width="150%" style='FONT-SIZE: 12px'>
	...
	<tr bgcolor="#FFCCCC" align="center" height="25">
	  ...
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><a href="InsertBj_khzcxmTcwXp.jsp?zjxxh=<%=zjxxh%>" target="_blank">选择</a></td>
	...
	<tr bgcolor="#FFCCCC" align="center" height="25">
	  ...
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><a href="InsertBj_khzcxmTcwDljj.jsp?zjxxh=<%=zjxxh%>" target="_blank">选择</a></td>
...
<%
	...
	while (rs1.next())
	{
		...
		while (rs2.next())
		{
			...
			double khzdsl=0;
			ls_sql="SELECT bj_khzcxmxjh.sjsfycx,bj_khzcxmxjh.khbjjbbm,bj_khzcxmxjh.bjjbbm,bj_khzcxmxjh.tccplbbm,clxlmc,sjsl,bzsl,DECODE(bj_khzcxmxjh.sfxzsl,'1','超量加价','2','不可超量','3','无限制') sfxzsl,DECODE(sfbxx,'Y','必选','N','') sfbxx,sfyxsj,DECODE(sfyxsj,'Y','收费','N','否') sfyxsjMc,bjjbmc";
			...
			ls_sql+=" FROM bj_khzcxmxjh,jxc_clxlbm,bdm_bjjbbm ";
			ls_sql+=" where bj_khzcxmxjh.tccplbbm=jxc_clxlbm.clxlbm(+) and bj_khzcxmxjh.bjjbbm=bdm_bjjbbm.bjjbbm(+)";
			...
			while (rs.next())
			{
				...
				if (xlcpsl==0)//小类未选择产品
				{
						...
						<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
						  ...
						  <td align="right"  rowspan="<%=count1%>"><%=tcsjflmc%>：
							...
							if (sfkjm.equals("2"))//1：不可减免；2：可减免
							{
								...
								{
									%>
									  <td  rowspan="<%=count1%>"><a href="qxzcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tcsjflbm=<%=tcsjflbm%>" target="_blank">取消减免</a></td>
									<%
								}
								else{
									%>
									  <td  rowspan="<%=count1%>"><a href="zcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tcsjflbm=<%=tcsjflbm%>" target="_blank">减免</a></td>
									<%
								}
							}
							else{
						  ...
						  <td><%=tccplbmc%></td>
							  ...
							  <td>&nbsp;</td>
						  <td><%=sfbxx%></td>
						  <td><a href="InsertBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
							<%
							if (sfkgh.equals("2"))//1：不可换；2：可换
							{
								%>
							  <td><a href="InsertBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
								<%
							}
							else{
								%>
					...
					int row2=0;//小类产品行数
					ls_sql="SELECT bj_khzcxmh.sxh,bjjbmc,bj_khzcxmh.sl,bj_khzcxmh.cpbm,bj_khzcxmh.cpmc,bj_khzcxmh.ppmc,bj_khzcxmh.xh,bj_khzcxmh.zclx";
					...
					while (rs3.next())
					{
						...
						if (row==1)//房间内第一行
						{
							...
							<%
									...
									{
										%>
										  <td><A HREF=# onclick="f_del('DeleteBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>');return false;" target="_blank">删除</A></td>
										  <td><A HREF="EditBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>" target="_blank">修改</A></td>
										  <td><%=ppmc%></td>
										  <td><%=cpmc%></td>
										  <td><%=xh%></td>
										  <td><%=getsl%></td>
										...
										%>
										  <td><A HREF=# onclick="f_del('DeleteBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>');return false;" target="_blank">删除</A></td>
										  <td><A HREF="EditBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&sxh=<%=sxh%>" target="_blank">修改</A></td>
										  <td><%=ppmc%></td>
										  <td><%=cpmc%></td>
										  <td><%=xh%></td>
										  <td><%=getsl%></td>
							...
							%>
							  ...
							  <td rowspan="<%=xlcpsl%>"><a href="InsertBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
								<%
								if (sfkgh.equals("2"))//1：不可换；2：可换
								{
									%>
								  <td rowspan="<%=xlcpsl%>"><a href="InsertBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
									<%
								}
								else{
									%>
		...
		String sfkghStr=null;
		double khzdsl=0;
		ls_sql="SELECT bj_khzcxmxjh.khbjjbbm,bj_khzcxmxjh.bjjbbm,bj_khzcxmxjh.tccplbbm,clxlmc,sjsl,bzsl,DECODE(bj_khzcxmxjh.sfxzsl,'1','超量加价','2','不可超量','3','无限制') sfxzsl,DECODE(sfbxx,'Y','必选','N','') sfbxx,sfyxsj,DECODE(sfyxsj,'Y','收费','N','否') sfyxsjMc,bjjbmc";
		ls_sql+=" ,sjjmsl,jldw,bj_khzcxmxjh.sfkjm,DECODE(bj_khzcxmxjh.sfkjm,'1','不可','2','可减免') sfkjmStr,bj_khzcxmxjh.yxjmzdsl,sfkgh,DECODE(sfkgh,'1','不可换','2','可换') sfkghStr,khzdsl";
		ls_sql+=" FROM bj_khzcxmxjh,jxc_clxlbm,bdm_bjjbbm ";
		ls_sql+=" where bj_khzcxmxjh.tccplbbm=jxc_clxlbm.clxlbm(+) and bj_khzcxmxjh.bjjbbm=bdm_bjjbbm.bjjbbm(+)";
				...
				if (row==1)//第一行
				{
					...
					<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
					  ...
					  <td rowspan="<%=count1%>">&nbsp;</td>
						...
						{
							%>
						  <td ><a href="zcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">减免</a></td>
							<%
						}
						else{
							%>
						...
						<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
						  <td rowspan="<%=count1%>">&nbsp;</td>
							...
							if (sfkjm.equals("2"))//1：不可减免；2：可减免
							{
								...
								{
									%>
									  <td ><a href="qxzcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">取消减免</a></td>
									<%
								}
								else{
									%>
					...
					if (row==1)//第一行
					{
						...
						<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
						  ...
						  <td rowspan="<%=count1%>">&nbsp;</td>
							...
							{
								%>
							  <td  rowspan="<%=xlcpsl%>"><a href="zcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">减免</a></td>
								<%
							}
							else{
								%>
							...
							<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
							  <td rowspan="<%=count1%>">&nbsp;</td>
								...
								if (sfkjm.equals("2"))//1：不可减免；2：可减免
								{
									...
									{
										%>
										  <td  rowspan="<%=xlcpsl%>"><a href="qxzcjm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">取消减免</a></td>
										<%
									}
									else{
										%>
