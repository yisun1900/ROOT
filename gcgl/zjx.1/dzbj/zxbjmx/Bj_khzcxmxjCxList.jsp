...
<%
	...
	ls_sql+=" where bj_khzcxmh.zjxxh='"+zjxxh+"'";
	...
	while (rs1.next())
	{
		...
		while (rs2.next())
		{
			...
			double khzdsl=0;
			ls_sql="SELECT bj_khzcxmxjh.sjsfycx,bj_khzcxmxjh.khbjjbbm,bj_khzcxmxjh.bjjbbm,bj_khzcxmxjh.tccplbbm,clxlmc,sjsl,bzsl,DECODE(bj_khzcxmxjh.sfxzsl,'1','超量加价','2','不可超量','3','无限制') sfxzsl,DECODE(sfbxx,'Y','必选','N','') sfbxx,sfyxsj,DECODE(sfyxsj,'Y','收费','N','否') sfyxsjMc";
					...
					if (row==1)//房间内第一行
					{
						...
						<tr bgcolor="<%=bgcolor%>" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
						  ...
						  <td><a href="InsertBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">更换</a></td>
							...
							{
								%>
							  <td><a href="InsertBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">更换</a></td>
								<%
							}
							else{
								%>
...
*/
						...
						if (row==1)//房间内第一行
						{
							...
							%>
							  ...
							  <td rowspan="<%=xlcpsl%>"><a href="InsertBj_khzcxm.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">更换</a></td>
								...
								{
									%>
								  <td rowspan="<%=xlcpsl%>"><a href="InsertBj_khzcxmTcw.jsp?zjxxh=<%=zjxxh%>&jgwzbm=<%=jgwzbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">更换</a></td>
									<%
								}
								else{
									%>
		...
		String sfkghStr=null;
		double khzdsl=0;
		ls_sql="SELECT bj_khzcxmxjh.khbjjbbm,bj_khzcxmxjh.bjjbbm,bj_khzcxmxjh.tccplbbm,clxlmc,sjsl,bzsl,DECODE(bj_khzcxmxjh.sfxzsl,'1','超量加价','2','不可超量','3','无限制') sfxzsl,DECODE(sfbxx,'Y','必选','N','') sfbxx,sfyxsj,DECODE(sfyxsj,'Y','收费','N','否') sfyxsjMc";
		ls_sql+=" ,sjjmsl,jldw,bj_khzcxmxjh.sfkjm,DECODE(bj_khzcxmxjh.sfkjm,'1','不可','2','可减免') sfkjmStr,bj_khzcxmxjh.yxjmzdsl,sfkgh,DECODE(sfkgh,'1','不可换','2','可换') sfkghStr,khzdsl";
		ls_sql+=" FROM bj_khzcxmxjh,jxc_clxlbm ";
		ls_sql+=" where bj_khzcxmxjh.tccplbbm=jxc_clxlbm.clxlbm(+)";
