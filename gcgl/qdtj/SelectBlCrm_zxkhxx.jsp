...
<table width="100%">
  <tr>
    <td width="100%" > 
      <div align="center">
          补录签单信息 
        <BR><font color="#FF0000">请首先输入条件(如:客户姓名等)，查出签单客户</font>
      </div>
    </td>
  </tr>
  <tr>
...
<form method="post" action="Crm_zxkhxxBlList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <input type="text" name="crm_zxkhxx_fwdz" size="72" maxlength="100" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="17%"> 
                <div align="right">是否分配咨询店面</div>
              </td>
              <td width="33%"> 
                <select name="crm_zxkhxx_sffpdm" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <option value="N">未分配店面</option>
                  <option value="Y">已分配店面</option>
                </select>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
{
	if(!(isNumber(FormName.crm_zxkhxx_fwmj, "房屋面积"))) {
		return false;
	}
