...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT '签单' qd,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,hth,DECODE(ysshbz,'N','未审核','Y','通过','M','审核未通过'),DECODE(sfzdzbj,'N','未做','Y','已做'),dzbjze,bjjbmc,khjl,sjs,ywy,lrsj,b.dwmc as zxdm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,crm_zxkhxx.khbh as khbh  ";
    ...
    ls_sql+=" order by ysshbz desc,crm_zxkhxx.lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	//pageObj.initPage("","","","");
...
//设置列超级连接
	...
	coluParm.link="InsertCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">咨询客户信息（<font color="#FF0000">必须首先进行咨询登记</font>）</font></B> 
</CENTER>
<%
	pageObj.out=out;
