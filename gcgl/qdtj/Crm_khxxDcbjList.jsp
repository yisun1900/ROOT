...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,khxm, fwdz,DECODE(kgsjqd,'Y','已确定','N','<font color=\"#FF00FF\">未确定</font>'),qyrq,dwmc,sjs";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxDcbjList.jsp","","","/khxx/ViewZxbjDc.jsp");
