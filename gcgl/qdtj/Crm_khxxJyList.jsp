...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ckjgbz.equals("Y"))
	{
		ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz,ysgcjdmc,DECODE(zt,'2','家装','4','集成','5','设计','6','散客','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(crm_khxx.khjsbz,'N','未结算','Y','已结算','2','审批同意','3','审批不同意'),crm_khxx.khjl,crm_khxx.sjs,sgdmc||DECODE(sq_sgd.sgdlx,'S0','','S1','(直属)') sgd,sgbz,crm_khxx.zjxm,DECODE(kgzbz,'Y','已出','N','<font color=\"#FF00FF\">未出</font>'),DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.cxhdbm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),DECODE(crm_khxx.gcsfyq,'1','未延期','2','延期'),crm_khxx.yqts,zkl,ywy,bjjbmc,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.yjjzsj,crm_khxx.tdyjjzsj,crm_khxx.pdsj,crm_khxx.kgrq,crm_khxx.sjkgrq,crm_khxx.jgrq,kgrq+((jgrq-kgrq)+NVL(hzts,0)) as jhwgsj,crm_khxx.sjjgrq,crm_khxx.sjwjrq,crm_khxx.wdzgce,crm_khxx.qye,NVL(crm_tckhqye.tcsgze,0)+NVL(crm_tckhqye.tcsgzezjx,0),crm_khxx.zqgczjf,crm_khxx.zhgczjf,crm_khxx.glfbfb||'%',crm_khxx.zqguanlif,crm_khxx.guanlif,crm_khxx.suijinbfb||'%' suijinbfb,crm_khxx.zqsuijin,crm_khxx.suijin,crm_khxx.zqsjf+NVL(crm_khxx.sjhtsjf,0),crm_khxx.sjf+NVL(crm_khxx.sjhtsjf,0),crm_khxx.zjxje,crm_khxx.zhzjxje,crm_khxx.zqzjxguanlif,crm_khxx.zjxguanlif,crm_khxx.zqzjxsuijin,crm_khxx.zjxsuijin,crm_khxx.zjxje+crm_khxx.zqzjxguanlif+crm_khxx.zqzjxsuijin as zqzjxzj,crm_khxx.zhzjxje+crm_khxx.zjxguanlif+crm_khxx.zjxsuijin as zhzjxzj,crm_khxx.sgebfb||'%',crm_khxx.sge,crm_khxx.clf,DECODE(crm_khxx.sffj,'Y','是','N','否'),crm_khxx.fjje,crm_khxx.gsfje,DECODE(crm_khxx.sfyrz,'Y','是','N','否'),b.dwmc rzsc,khlxmc,decode(crm_khxx.xjf,1,'新房',2,'旧房',crm_khxx.xjf),crm_khxx.fwmj,hxmc,clgw";
	}
	else{
		ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,crm_khxx.hth,crm_khxx.fwdz,ysgcjdmc,DECODE(zt,'2','家装','4','集成','5','设计','6','散客','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(crm_khxx.khjsbz,'N','未结算','Y','已结算','2','审批同意','3','审批不同意'),crm_khxx.khjl,crm_khxx.sjs,sgdmc||DECODE(sq_sgd.sgdlx,'S0','','S1','(直属)') sgd,sgbz,crm_khxx.zjxm,DECODE(kgzbz,'Y','已出','N','<font color=\"#FF00FF\">未出</font>'),DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.cxhdbm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),DECODE(crm_khxx.gcsfyq,'1','未延期','2','延期'),crm_khxx.yqts,zkl,ywy,bjjbmc,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.yjjzsj,crm_khxx.tdyjjzsj,crm_khxx.pdsj,crm_khxx.kgrq,crm_khxx.sjkgrq,crm_khxx.jgrq,kgrq+((jgrq-kgrq)+NVL(hzts,0)) as jhwgsj,crm_khxx.sjjgrq,crm_khxx.sjwjrq,'' wdzgce,'' qye,'' tcsgze,'' zqgczjf,'' zhgczjf,'' glfbfb,'' zqguanlif,'' guanlif,'' suijinbfb,'' zqsuijin,'' suijin,'' zqsjf,'' sjf,'' zjxje,'' zhzjxje,'' zqzjxguanlif,'' zjxguanlif,'' zqzjxsuijin,'' zjxsuijin,'' zqzjxzj,'' zhzjxzj,'' sgebfb,'' sge,'' clf,DECODE(crm_khxx.sffj,'Y','是','N','否'),crm_khxx.fjje,crm_khxx.gsfje,DECODE(crm_khxx.sfyrz,'Y','是','N','否'),b.dwmc rzsc,khlxmc,decode(crm_khxx.xjf,1,'新房',2,'旧房',crm_khxx.xjf),crm_khxx.fwmj,hxmc,clgw";
	}
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_dwxx b,sq_sgd,dm_gcjdbm,dm_gcysxm,dm_khlxbm,crm_tckhqye,bdm_bjjbbm,dm_hxbm";
...
%>
<CENTER >
  <B><font size="3">签单查询-快速检索<span class="STYLE1"><BR>（注意：包括退单客户）</span></font></B>
</CENTER>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="120px">折前增减项管理费</td>
	<td  width="120px">折后增减项管理费</td>
	<td  width="120px">折前增减项税金</td>
	<td  width="120px">折后增减项税金</td>
	<td  width="180px">折前增减项(工程费+管理费+税金)</td>
	<td  width="180px">折后增减项(工程费+管理费+税金)</td>
	<td  width="90px">施工额百分比</td>
	<td  width="90px">施工额</td>
	<td  width="90px">材料费</td>
	<td  width="70px">是否返卷</td>
	<td  width="110px">返卷总金额</td>
	<td  width="110px">公司承担返卷额</td>
	<td  width="90px">是否已认证</td>
	<td  width="2%">认证市场</td>
	<td  width="120px">关系客户</td>
	<td  width="120px">新旧房</td>
	<td  width="120px">房屋面积</td>
	<td  width="120px">户型</td>
	<td  width="120px">材料顾问</td>
</tr>
<%
