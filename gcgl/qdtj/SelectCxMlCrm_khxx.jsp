...
<form method="post" action="Crm_khxxCxMlList.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">人辅最新毛利率 从 </span></td>
            ...
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">人辅最新毛利额 从</span></td>
              <td><input name="zxmle" type="text" size="20" maxlength="16" ></td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="zxmle2" type="text" size="20" maxlength="16" ></td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">主材最新毛利率 从 </span></td>
              <td><input name="zczxml" type="text" size="10" maxlength="16" >
                百分比</td>
              <td align="right"><span class="STYLE1">到</span></td>
              <td><input name="zczxml2" type="text" size="10" maxlength="16" >
                百分比</td>
            </tr>
            <tr bgcolor="#E8E8FF">
...
{
	if(!(isFloat(FormName.zxmll, "人辅毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmll2, "人辅毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zczxml, "主材毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zczxml2, "主材毛利率"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmle, "毛利额"))) {
		return false;
	}
	if(!(isFloat(FormName.zxmle2, "毛利额"))) {
		return false;
	}
