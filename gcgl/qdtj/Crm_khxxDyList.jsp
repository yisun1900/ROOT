...
*/
	if (ckjgbz.equals("Y"))
	{
		ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.lxfs,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,jgrq,crm_khxx.qye,crm_khxx.fwmj,DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc  ";
	}
	else{
		ls_sql="SELECT crm_khxx.hth,crm_khxx.khxm,crm_khxx.lxfs,crm_khxx.fwdz,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq,jgrq,0,crm_khxx.fwmj,DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc  ";
	}
