...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	crm_khxx_sjs=yhmc;
	wheresql+=" and  (crm_khxx.sjs='"+crm_khxx_sjs+"')";
	...
	ls_sql="SELECT '',crm_khxx.hth,crm_khxx.khxm,DECODE(zt,'2','未退','3','<font color=\"#FF00FF\">已退单</font>' ),crm_khxx.fwdz,a.dwmc qydm,crm_khxx.sjs ";
	...
	ls_sql+=" ,crm_khxx.sjf ";
	ls_sql+=",crm_khxx.qyrq,sgdmc sgd,crm_khxx.zjxm,c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,zkl,ywy,jgrq,crm_khxx.khbh,DECODE(kgzbz,'Y','已出','N','<font color=\"#FF00FF\">未出</font>'),DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),ysgcjdmc,khlxmc";

	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,dm_gcjdbm,dm_gcyszxmbm c,dm_gcyszxmbm d,dm_khlxbm";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by zt,lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxSjsyjList.jsp","","","");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%" bgcolor="#99FFFF">折前（工程签约额）</td>
	<td  width="3%" bgcolor="#99FFFF">折后（工程签约额）</td>
	<td  width="3%" bgcolor="#FFFF99">工程原报价（工程直接费）</td>
	<td  width="3%" bgcolor="#FFFF99">工程签约额（工程直接费）</td>
	<td  width="3%" bgcolor="#FFFF99">减免额（工程直接费）</td>
	<td  width="2%" bgcolor="#99FFFF">折前（管理费）</td>
	<td  width="2%" bgcolor="#99FFFF">折后（管理费）</td>
	<td  width="2%" bgcolor="#99FFFF">减免额（管理费）</td>
	<td  width="3%" bgcolor="#FFFFCC">税金</td>
	<td  width="3%" bgcolor="#FFFFCC">减免额（税金）</td>
	<td width="2%" >平米均价</td>
	<td  width="3%" bgcolor="#FFFFCC">工程增减（增减项后）</td>
	<td  width="3%" bgcolor="#FFFFCC">管理费增减（增减项后）</td>
	<td  width="3%" bgcolor="#FFFFCC">税金增减（增减项后）</td>
	<td width="3%"  bgcolor="#FFFF99">增减后总额 </td>
	<td width="2%" >设计费</td>

	<td  width="3%">签约日期</td>
	<td  width="2%">施工队</td>
	<td  width="2%">工程担当</td>
	<td  width="4%">隐蔽工程验收</td>
	<td  width="2%">中期验收</td>
	<td  width="2%">折扣率</td>
	<td  width="2%">业务员</td>
