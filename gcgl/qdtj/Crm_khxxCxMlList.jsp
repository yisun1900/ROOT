...
<%
if (cf.check((String)session.getAttribute("yhdlm"),request.getRemoteHost(),"050104")==0) 
{
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String zxmle=null;
	zxmle=request.getParameter("zxmle");
	if (zxmle!=null)
	{
		zxmle=cf.GB2Uni(zxmle);
		if (!(zxmle.equals("")))	wheresql+=" and  (crm_khqye.zxmle>="+zxmle+")";
	}
	zxmle=request.getParameter("zxmle2");
	if (zxmle!=null)
	{
		zxmle=cf.GB2Uni(zxmle);
		if (!(zxmle.equals("")))	wheresql+=" and  (crm_khqye.zxmle<="+zxmle+")";
	...
	String zxmll=null;
	zxmll=request.getParameter("zxmll");
	if (zxmll!=null)
	{
		zxmll=cf.GB2Uni(zxmll);
		if (!(zxmll.equals("")))	wheresql+=" and  (crm_khqye.zxmll>="+zxmll+")";
	}
	zxmll=request.getParameter("zxmll2");
	if (zxmll!=null)
	{
		zxmll=cf.GB2Uni(zxmll);
		if (!(zxmll.equals("")))	wheresql+=" and  (crm_khqye.zxmll<="+zxmll+")";
	...
	String zczxml=null;
	zczxml=request.getParameter("zczxml");
	if (zczxml!=null)
	{
		zczxml=cf.GB2Uni(zczxml);
		if (!(zczxml.equals("")))	wheresql+=" and  (crm_khqye.zczxml>="+zczxml+")";
	}
	zczxml=request.getParameter("zczxml2");
	if (zczxml!=null)
	{
		zczxml=cf.GB2Uni(zczxml);
		if (!(zczxml.equals("")))	wheresql+=" and  (crm_khqye.zczxml<="+zczxml+")";
	...
	String yjjzcs=null;
	yjjzcs=request.getParameter("yjjzcs");
	if (yjjzcs!=null)
	{
		yjjzcs=cf.GB2Uni(yjjzcs);
		if (!(yjjzcs.equals("")))	wheresql+=" and  (crm_khqye.yjjzcs>="+yjjzcs+")";
	}
	yjjzcs=request.getParameter("yjjzcs2");
	if (yjjzcs!=null)
	{
		yjjzcs=cf.GB2Uni(yjjzcs);
		if (!(yjjzcs.equals("")))	wheresql+=" and  (crm_khqye.yjjzcs<="+yjjzcs+")";
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,crm_khxx.hth,ysgcjdmc,crm_khxx.fwdz,crm_khqye.khhtml||'%',crm_khqye.khzxml||'%',crm_khqye.sgcbj,crm_khqye.mll||'%',crm_khqye.zxmll||'%',crm_khqye.zxmle,crm_khqye.zchtje,crm_khqye.zchtcb,crm_khqye.zchtml||'%',crm_khqye.zczxje,crm_khqye.zczxcb,crm_khqye.zczxml||'%',crm_khxx.khjl,crm_khxx.sjs,dm_gcysxm.gcysxmmc,crm_khxx.szqsj,crm_khxx.ysy,sgdmc||DECODE(sq_sgd.sgdlx,'S0','','S1','(直属)') sgd,crm_khxx.zjxm,crm_khxx.smhtbh,DECODE(kgzbz,'Y','已出','N','<font color=\"#FF00FF\">未出</font>'),DECODE(zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.cxhdbm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),DECODE(crm_khxx.gcsfyq,'1','未延期','2','延期'),crm_khxx.yqts,zkl,ywy,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.pdsj,crm_khxx.kgrq,crm_khxx.sjkgrq,crm_khxx.jgrq,crm_khxx.sjjgrq,crm_khxx.wdzgce,crm_khxx.qye,crm_khqye.hdzsjz,crm_khqye.djjje,crm_khqye.htjz,crm_khqye.gcjcbj,crm_khqye.cbj,crm_khqye.yjjzcs||'%',crm_khqye.yjjz,crm_khxx.zqgczjf,crm_khxx.zhgczjf,crm_khxx.glfbfb||'%',crm_khxx.zqguanlif,crm_khxx.guanlif,crm_khxx.suijinbfb||'%' suijinbfb,crm_khxx.zqsuijin,crm_khxx.suijin,crm_khxx.zqsjf,crm_khxx.sjf,crm_khxx.zjxje,crm_khxx.zhzjxje,crm_khxx.zqzjxguanlif,crm_khxx.zjxguanlif,crm_khxx.zqzjxsuijin,crm_khxx.zjxsuijin,crm_khxx.zjxje+crm_khxx.zqzjxguanlif+crm_khxx.zqzjxsuijin as zqzjxzj,crm_khxx.zhzjxje+crm_khxx.zjxguanlif+crm_khxx.zjxsuijin as zhzjxzj,crm_khxx.sgebfb||'%',crm_khxx.sge,crm_khxx.clf,DECODE(crm_khxx.sffj,'Y','是','N','否'),crm_khxx.fjje,crm_khxx.gsfje,DECODE(crm_khxx.sfyrz,'Y','是','N','否'),b.dwmc rzsc,khlxmc";

	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_dwxx b,sq_sgd,dm_gcjdbm,dm_gcysxm,dm_khlxbm,crm_khqye";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxCxMlList.jsp","","","");
	if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
	{
...
//设置列超级连接
	...
	coluParm.link="/khxx/ViewMllCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
...
%>
<CENTER >
  <B><font size="3">签单客户--查询毛利</font></B>
</CENTER>
...
<%
	...
	pageObj.printPageLink(880,2,2);
%>
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="70px">客户编号</td>
	<td  width="180px">客户姓名</td>
	<td  width="120px">合同号</td>
	<td  width="110px">工程进度</td>
	<td  width="400px">房屋地址</td>

	<td  width="80px">客户合同毛利</td>
	<td  width="80px">客户最新毛利</td>
	<td  width="120px">合同施工成本价</td>
	<td  width="80px">人辅合同毛利率</td>
	<td  width="80px">人辅最新毛利率</td>
	<td  width="120px">人辅最新毛利额</td>

	<td  width="120px">主材合同销售额</td>
	<td  width="120px">主材合同成本</td>
	<td  width="80px">主材合同毛利</td>
	<td  width="120px">主材最新销售额</td>
	<td  width="120px">主材最新成本</td>
	<td  width="80px">主材最新毛利</td>
	...
	<td  width="120px">合同赠送净值</td>
	<td  width="120px">合同赠送代金券</td>
	<td  width="120px">合同净值</td>
	<td  width="120px">合同工程基础报价</td>
	<td  width="120px">合同成本价</td>
	<td  width="80px">业绩净值参数</td>
	<td  width="120px">业绩净值</td>
