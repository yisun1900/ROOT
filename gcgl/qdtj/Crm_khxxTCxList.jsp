...
<%
if (cf.check((String)session.getAttribute("yhdlm"),request.getRemoteHost(),"050117")==0) 
{
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxTCxList.jsp","","","");
	if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
	{
...
%>
<CENTER >
  <B><font size="3">签单客户--特权查询</font></B>
</CENTER>
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="120px">工程费+管理费+税金(折前)</td>
	<td  width="120px">工程费+管理费+税金(折后)</td>
	...
	<td  width="120px">增减项+增减管理费+增减税金(折前)</td>
	<td  width="120px">增减项+增减管理费+增减税金(折后)</td>
