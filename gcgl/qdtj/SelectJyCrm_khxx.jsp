...
String ywy=yhmc;
if (!zwbm.equals("19")&&!zwbm.equals("46")&&!zwbm.equals("44")&&!zwbm.equals("43")&&!zwbm.equals("47"))
{
	ywy="";
}
String khjl=yhmc;
          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3" > 
                ...
                EXCEL &nbsp;&nbsp;&nbsp;每页显示数量 
                <input type="text" name="myxssl" size="7" maxlength="13" value="23">              </td>
            </tr>
            <%
			}
			%> 
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td align="right">是否退单</td>
              <td> 
                <input type="radio" name="sftd" value="1">
                退单
                <input type="radio" name="sftd" value="2">
                未退单</td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td><input name="ywy" type="text" value="<%=ywy%>" size="20" maxlength="20" <% if (!ywy.equals("")) out.println("readonly");%>></td>
            </tr>
            <tr bgcolor="#E8E8FF">
              <td align="right"><span class="STYLE1">客户结算标志</span></td>
              <td>
                  <input type="radio" name="khjsbz" value="N">未结算
				  <input type="radio" name="khjsbz" value="Y">已结算			  </td>
              <td align="right"><span class="STYLE1">施工队结算标志</span></td>
...
%>
            ...
            <tr bgcolor="#FFFFCC">
              <td align="right" bgcolor="#FFFFCC"><font color="#0000CC"><b>签单记入业绩时间</b></font> 从</td>
              <td><input name="yjjzsj" type="text" id="yjjzsj" onDblClick="JSCalendar(this)" value="" size="20" maxlength="10">              </td>
              <td align="right">到</td>
              <td><input name="yjjzsj2" type="text" id="yjjzsj2" onDblClick="JSCalendar(this)" value="" size="20" maxlength="10"></td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right" bgcolor="#FFFFCC"><font color="#0000CC"><b>退单记入业绩时间</b></font> 从</td>
			...
			<tr bgcolor="#E8E8FF">
			  <td bgcolor="#E8E8FF" align="right">套餐</td>
			  <td><input type="radio" name="lx" value="1">
			    否
                  <input type="radio" name="lx" value="2">
              是</td>
			  <td align="right">整装</td>
			  <td><input type="radio" name="zzbz" value="2">否
  <input type="radio" name="zzbz" value="1">是</td>
		    </tr>
			<tr bgcolor="#E8E8FF">
...
离职 </td>
          ...
          <table width="100%" border="0" style="FONT-SIZE:12;display:none" id="id1" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFCC"> 
              <td align="right" width="18%">延期单预计完工日期 从</td>
              <td width="32%"> 
                <input type="text" name="yqdwgrq" size="20" maxlength="10"  ondblclick="JSCalendar(this)">              </td>
              <td align="right" width="18%">到</td>
              <td width="32%"> 
                <input type="text" name="yqdwgrq2" size="20" maxlength="10"  ondblclick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
...
function f_do(FormName,lx)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.yqdwgrq, "延期单预计完工日期"))) {
		return false;
	}
	if(!(isDatetime(FormName.yqdwgrq2, "延期单预计完工日期"))) {
		return false;
	}
	...
	if(!(isDatetime(FormName.yjjzsj2, "签单记入业绩时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tdyjjzsj, "退单记入业绩时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.tdyjjzsj2, "退单记入业绩时间"))) {
		return false;
	}
