...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (smhtbh!=null)
	{
		...
		if (!(smhtbh.equals("")))	wheresql+=" and  (smhtbh='"+smhtbh+"')";
	}
	...
	if (czkbz!=null)
	{
		if (!(czkbz.equals("")))	wheresql+=" and  (czkbz!='2')";
	}
	...
	ls_sql="SELECT khbh,hth,khxm,fwdz,sjf,qyrq,dwmc,sjs";
	ls_sql+=" FROM crm_khxx,sq_dwxx  ";
    ls_sql+=" where (crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.zt in ('5'))";
...
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxSjList.jsp","","","EditSjCrm_khxx.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteKhxx.jsp"};//按钮单击调用的网页，可以增加参数
