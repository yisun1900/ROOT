...
<%
	...
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'警告！非法侵入[服务费查询]："+xtrzyhmc+"') ";
...
<form method="post" action="Crm_khxxCxListfwf.jsp" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td align="right" width="21%" height="2">显示风格</td>
...
%>
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right" bgcolor="#E8E8FF">关系客户</td>
...
%>
              ...
              <td width="20%" align="right">信息来源</td>
              <td width="30%"> 
...
%> </td>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="21%" align="right">折扣率（&gt;0且&lt;=10） 从</td>
              <td width="29%"> 
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="21%" align="right">合同竣工日期 从</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">实际竣工日期 从</td>
              <td width="29%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="21%" align="right">保修截止时间 从</td>
              <td width="29%"> 
...
%>
              ...
              <td width="30%"> 
                <select name="crm_khxx_wgbz" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <option value=""></option>
                  <%
	cf.selectToken(out,"1+未开工&2+已开工&3+已完工","");
%>
                </select>
              </td>
            </tr>
...
%>
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">派单类型</td>
              <td width="29%"> 
...
%>
              ...
              <td width="20%" align="right">派单奖励</td>
              <td width="30%"> 
...
%>
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">样板间登记时间 从</td>
              <td width="29%"> 
...
%>
            ...
            <tr bgcolor="#FFFFCC"> 
              <td width="21%" bgcolor="#FFFFCC" align="right">信息录入人</td>
              <td width="29%"> 
                <input type="text" name="crm_khxx_lrr" size="20" maxlength="20" >
              </td>
              <td width="20%" bgcolor="#FFFFCC" align="right">业务员</td>
              <td width="30%"> 
...
%>
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="21%" align="right">回访冻结标志</td>
              <td width="29%"> 
...
%>
              ...
              <td width="20%" align="right">冻结人</td>
              <td width="30%"> 
