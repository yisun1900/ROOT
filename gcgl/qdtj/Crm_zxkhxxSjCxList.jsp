...
<%
	...
	ls_sql="SELECT '签单' qd,crm_zxkhxx.khxm,crm_zxkhxx.fwdz,DECODE(ysshbz,'N','未审核','Y','通过','M','审核未通过'),DECODE(sfzdzbj,'N','未做','Y','已做'),dzbjze,bjjbmc,khjl,sjs,ywy,DECODE(shbz,'N','未审核','Y','审核'),lrsj,b.dwmc as zxdm,DECODE(crm_zxkhxx.zxzt,'0','未分配店面','1','分配店面','2','飞单审核未通过','3','已签约','4','飞单','5','飞单审核未通过') as crm_zxkhxx_zxzt,crm_zxkhxx.khbh as khbh  ";
...
//设置列超级连接
	...
	coluParm.link="InsertSjCrm_khxx.jsp";//为列参数：coluParm.link设置超级链接
...
<CENTER >
  <B><font size="3">设计客户--录入（<font color="#FF0000">必须首先进行咨询登记</font>）</font></B> 
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
