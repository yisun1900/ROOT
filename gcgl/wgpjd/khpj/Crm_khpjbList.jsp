...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT distinct crm_khpjb.lrsj,crm_khxx.khbh,hth,khxm,fwdz,a.dwmc sbdm,sgdmc sgd,sjs,zjxm,kgrq,jgrq";
	ls_sql+=" FROM crm_khxx,sq_dwxx a,sq_sgd,crm_khpjb ";
    ls_sql+=" where (crm_khxx.dwbh=a.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+)) ";
    ls_sql+=" and crm_khxx.khbh=crm_khpjb.khbh";
    ls_sql+=wheresql;
	ls_sql+=" order by crm_khpjb.lrsj desc";
    pageObj.sql=ls_sql;
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khpjbList.jsp","SelectCrm_khpjb.jsp","","EditCrm_khpjb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Crm_khpjbList.jsp"};//按钮单击调用的网页，可以增加参数
