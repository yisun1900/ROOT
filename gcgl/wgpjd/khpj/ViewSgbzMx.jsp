...
<%
	...
	String sgdmc=request.getParameter("sgdmc");
	...
	ls_sql+=" and crm_khpjb.spjrybm='07' and crm_khpjb.xmfl!='07' and crm_khpjb.pjjgbm!='1'";
	ls_sql+=" and sq_sgd.sgdmc='"+sgdmc+"' and crm_khxx.sgbz='"+sgbz+"'";
    ls_sql+=wheresql;
