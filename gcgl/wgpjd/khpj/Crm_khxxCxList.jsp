...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,hth,khxm,fwdz,a.dwmc sbdm,sgdmc,sgbz,sjs,zjxm,ysgcjdmc,kgrq,jgrq,sjkgrq,sjjgrq ";
...
//	out.println(ls_sql);
//进行对象初始化
	pageObj.initPage("Crm_khxxCxList.jsp","SelectCxCrm_khxx.jsp","InsertCrm_khpjb.jsp","");
