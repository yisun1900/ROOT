...
try {
	...
	while (rs1.next())
	{
		...
		if (xsfs.equals("1"))//1：项目分类多选；2：项目分类单选
		{
			...
			ls_sql="insert into crm_khpjb (khbh,pjxmbm,pjxm,spjrybm,spjry,xmflbm,xmfl,xsfs,xh,pjjgbm,pjjg,lrr,lrsj,sfkp) ";
			ls_sql+=" select ?,pjxmbm,pjxm,spjrybm,spjry,xmflbm,xmfl,xsfs,xh,?,?,?,TRUNC(SYSDATE),'N' ";
			ls_sql+=" from crm_pjxmbm";
