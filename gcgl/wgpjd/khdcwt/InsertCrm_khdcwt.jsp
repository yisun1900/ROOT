...
<form method="post" action="" name="insertform" >
  <div align="center">录入－客户调查问题</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr align="center"> 
      <td colspan="4"> 
        <input type="button" name="bc" value="存盘" onClick="f_do(insertform)">
        <input type="button"  value="下一个问题" name="ww2" onClick="f_do1(insertform)" >
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="wtmc" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td width="34%"> 
        <input type="text" name="dabh1" value="1" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc1" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">[答案2]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh2" value="2" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc2" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="16%">[答案3]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh3" value="3" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc3" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">[答案4]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh4" value="4" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc4" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="16%">[答案5]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh5" value="5" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc5" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">[答案6]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh6" value="6" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc6" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="16%">[答案7]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh7" value="7" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc7" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">[答案8]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh8" value="8" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc8" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
      <td align="right" width="16%">[答案9]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh9" value="9" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#E8E8FF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc9" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="16%">[答案10]编号</td>
      <td width="34%"> 
        <input type="text" name="dabh10" value="7" size="15" maxlength="8" >
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="damc10" value="" size="80" maxlength="100" >
      </td>
    </tr>
    <tr align="center"> 
      <td colspan="4"> 
...
{
	FormName.target=""
	FormName.action="InsertCrm_khdcwt.jsp";
	FormName.submit();
	return true;
...
function f_do(FormName)
{
	...
	FormName.action="SaveInsertCrm_khdcwt.jsp";
	FormName.submit();
