...
<body bgcolor="#FFFFFF">
  <div align="center">客户调查</div>

<form method="post" action="SaveInsertCrm_khdcb.jsp" name="insertform" target="_blank">
			...
			while (rs2.next())
			{
				...
				if (xsfs.equals("1"))//1：项目分类多选；2：项目分类单选
				{
					...
					<tr > 
					  ...
					  <td width="120px"><B><%cf.radioToken(out, "pjxmbm"+pjxmbm,"1+√&2+×&9+空","1");%></B></td>
					</tr>
					<%
				}
				else{
