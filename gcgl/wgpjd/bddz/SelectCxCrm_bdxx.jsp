...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_bdxxCxList.jsp" name="selectform">
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <input type="text" name="crm_bdxx_khbh" size="20" maxlength="20" >      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <input type="text" name="crm_bdxx_yjdz" size="20" maxlength="50" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">邮编</td>
      <td width="31%"> 
        <input type="text" name="crm_bdxx_yb" size="20" maxlength="10" >      </td>
      <td align="right" width="18%">收件人</td>
      <td width="32%"> 
        <input type="text" name="crm_bdxx_sjr" size="20" maxlength="20" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">电话</td>
      <td width="31%"> 
        <input type="text" name="crm_bdxx_dh" size="20" maxlength="20" >      </td>
      <td align="right" width="18%">录入人</td>
      <td width="32%"> 
        <input type="text" name="crm_bdxx_lrr" size="20" maxlength="20" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">录入时间 从</td>
      <td width="31%"> 
        <input type="text" name="crm_bdxx_lrsj" size="20" maxlength="10" >      </td>
      <td align="right" width="18%">到 </td>
      <td width="32%"> 
        <input type="text" name="crm_bdxx_lrsj2" size="20" maxlength="10" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
