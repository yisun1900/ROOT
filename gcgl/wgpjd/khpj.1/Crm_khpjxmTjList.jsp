...
<%
	...
	if (groupsl==0)
	{
		...
		selectgroupsql=" select "+selectgroupsql.substring(1)+",count(distinct crm_khpjb.khbh),'<img src=\"/images/ColuGif.gif\" width=\"'||count(distinct crm_khpjb.khbh)*5||'\" height=\"14\">'";
	}
%>
...
<%
	...
	ls_sql+=" FROM crm_khpjb,crm_khxx,sq_sgd";
    ls_sql+=" where crm_khxx.khbh=crm_khpjb.khbh and crm_khxx.sgd=sq_sgd.sgd(+)";
	ls_sql+=wheresql;
	ls_sql+=groupsql;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
