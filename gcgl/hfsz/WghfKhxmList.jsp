...
<CENTER >
  <B><font size="3">设完工回访日期</font></B>
</CENTER>
<form method="POST" name="listform" action="SaveWghfKhxm.jsp" target="_blank">
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
    <tr bgcolor="#CCCCCC"> 
	  ...
	  <td  width="8%" align="center">实中期验收</td>
	  <td  width="8%" align="center">实际完工日期</td>
	  <td  width="9%" align="center">完工回访日期</td>
...
try {
	...
	ls_sql="SELECT crm_khxx.khbh,khxm,DECODE(xb,'M','男','W','女') as xb,fwdz,crm_khxx.gcjdbm gcjdbm,gcjdmc,sjjgrq,szqsj,dwmc,hfrq,TRUNC(sjjgrq+1) yhfrq";
	ls_sql+=" FROM crm_khxx,sq_dwxx,dm_gcjdbm  ";
	ls_sql+=" where (crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.zt='2' and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm(+))";
	ls_sql+=" and crm_khxx.swghfbz='N'";
...
//			return;
		...
		if (szqsj.equals("&nbsp;"))
		{
			out.println("<BR>！！！警告，客户编号["+khbh+"]中期验收时间不存在");
//			return;
		}
