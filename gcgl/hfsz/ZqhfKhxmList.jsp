...
<CENTER >
  <B><font size="3">设中期回访日期</font></B>
</CENTER>
<form method="POST" name="listform" action="SaveZqhfKhxm.jsp" target="_blank">
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
    <tr bgcolor="#CCCCCC"> 
	  ...
	  <td  width="9%" align="center">中期回访日期</td>
...
try {
	...
	ls_sql="SELECT crm_khxx.khbh,khxm,DECODE(xb,'M','男','W','女') as xb,fwdz,crm_khxx.gcjdbm gcjdbm,gcjdmc,sybgcrq,szqsj,dwmc,hfrq,TRUNC(szqsj+1) yhfrq";
