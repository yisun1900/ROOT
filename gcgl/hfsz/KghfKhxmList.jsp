...
try {
	...
	ls_sql="SELECT crm_khxx.khbh,khxm,DECODE(xb,'M','男','W','女') as xb,fwdz,crm_khxx.gcjdbm gcjdbm,gcjdmc,qyrq,sjkgrq,dwmc,hfrq,TRUNC(sjkgrq+1) yhfrq";
...
//			return;
		...
		if (sjkgrq.equals("&nbsp;"))
		{
			out.println("<BR>！！！警告，客户编号["+khbh+"]实开工日期不存在");
//			return;
		}
