...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,DECODE(zt,'2','未退','3','<font color=\"#FF0000\">已退单</font>') zt,crm_khxx.khxm,crm_khxx.fwdz,crm_khxx.sjs,DECODE(sq_sgd.sgdlx,'S0','非直属','S1','直属') sgdlx,sgdmc,crm_khxx.zjxm,dwmc,crm_khxx.qyrq,crm_khxx.qye,gcjdmc  ";
    ...
    ls_sql+=" and (crm_khxx.kgzbz='N' OR crm_khxx.kgzbz is null) ";
...
//进行对象初始化
	...
	pageObj.setEditStr("出证");//设置每页显示记录数
//设置显示列
