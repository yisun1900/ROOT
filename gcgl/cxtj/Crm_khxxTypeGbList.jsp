...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and crm_khxx.kbxbz='Y' and crm_khxx.bxjzsj<SYSDATE ";
    ls_sql+=wheresql;
	ls_sql+=" order by crm_khxx.bxjzsj";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxTypeGbList.jsp","SelectTypeCrm_khxx.jsp","","");
	if (kkbbz.equals("Y"))//Y：可拷贝；N：不可拷贝
	{
...
<CENTER >
  <B><font size="3">过保客户（到今天为止已过保修期） </font></B>
</CENTER>
