...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditJhCrm_khsgjhb.jsp" name="editform" >
<div align="center">修改计划时间</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right"><font color="#CC0000">*</font>计划开始时间</td>
    <td><input type="text" name="zxjhkssj" size="20" maxlength="10"  value="<%=zxjhkssj%>" onDblClick="JSCalendar(this)"></td>
    <td align="right"><font color="#CC0000">*</font>计划结束时间</td>
    <td><input type="text" name="zxjhjssj" size="20" maxlength="10"  value="<%=zxjhjssj%>" onDblClick="JSCalendar(this)"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right"><font color="#CC0000">*</font>计划工作日</td>
    <td><input type="text" name="zxjhgzr" size="20" maxlength="10"  value="<%=zxjhgzr%>" ></td>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
{
	if(	javaTrim(FormName.zxjhkssj)=="") {
		alert("请输入[计划开始时间]！");
		FormName.zxjhkssj.focus();
		return false;
	}
	if(!(isDatetime(FormName.zxjhkssj, "计划开始时间"))) {
		return false;
	}
	if(	javaTrim(FormName.zxjhjssj)=="") {
		alert("请输入[计划结束时间]！");
		FormName.zxjhjssj.focus();
		return false;
	}
	if(!(isDatetime(FormName.zxjhjssj, "计划结束时间"))) {
		return false;
	}
	if(	javaTrim(FormName.zxjhgzr)=="") {
		alert("请输入[计划工作日]！");
		FormName.zxjhgzr.focus();
		return false;
	}
	if(!(isNumber(FormName.zxjhgzr, "计划工作日"))) {
		return false;
	}
