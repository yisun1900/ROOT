...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hth,khxm,fwdz,mbmc,sgdmc,zjxm,sjs,sq_dwxx.dwmc,ysgcjdmc,kgrq,sjkgrq,khbh ";
...
//进行对象初始化
	...
	pageObj.initPage("Crm_khxxMbList.jsp","","","EditMbCrm_khxx.jsp");
