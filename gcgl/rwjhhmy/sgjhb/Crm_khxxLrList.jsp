...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT hth,khxm,fwdz,mbmc,sjkgrq,sgdmc,zjxm,sjs,sq_dwxx.dwmc,ysgcjdmc,kgrq,khbh ";
	ls_sql+=" FROM crm_khxx,sq_dwxx,sq_sgd,dm_gcjdbm,gdm_sgjdmb ";
	ls_sql+=" where crm_khxx.dwbh=sq_dwxx.dwbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) ";
	ls_sql+=" and crm_khxx.gcjdbm=dm_gcjdbm.gcjdbm";
	ls_sql+=" and crm_khxx.mbbm=gdm_sgjdmb.mbbm(+)";
	ls_sql+=" and crm_khxx.zt='2'";
	ls_sql+=" and crm_khxx.gcjdbm!='5' ";
	ls_sql+=" and crm_khxx.mbbm is not null ";
...
//进行对象初始化
	...
	pageObj.initPage("Crm_khxxLrList.jsp","","SaveInsertCrm_khsgjhb.jsp","");
	pageObj.setPageRow(80);//设置每页显示记录数

//设置主键
	String[] keyName={"khbh"};
	pageObj.setKey(keyName);
	pageObj.setViewStr("生成计划");
//设置列超级连接
...
<CENTER >
  <B><font size="3">录入－客户施工计划表</font></B>
</CENTER>
<%
	pageObj.out=out;
