...
<form method="post" action="Crm_khsgjhbCxList.jsp" name="selectform">
...
%>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right">任务是否完成</td>
              <td><input type="radio" name="rwsfwc" value="Y">完成
                <input type="radio" name="rwsfwc" value="N">否</td>
              <td align="right">是否延期</td>
              <td><input type="radio" name="sfyq" value="Y">
                延期
                  <input type="radio" name="sfyq" value="N">
              否</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">计划开始时间 从 </td>
              <td><input name="zxjhkssj" type="text" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
              <td><input name="zxjhkssj2" type="text" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right">计划结束时间 从</td>
              <td><input name="zxjhjssj" type="text" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
              <td align="right">到</td>
              <td><input name="zxjhjssj2" type="text" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
            </tr>
            <tr align="center"> 
              <td colspan="4"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.zxjhkssj2, "计划开始时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.zxjhjssj, "计划结束时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.zxjhjssj2, "计划结束时间"))) {
		return false;
	}
