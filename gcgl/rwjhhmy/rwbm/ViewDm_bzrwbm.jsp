...
try {
	...
	ls_sql+=" from  gdm_rwbm,gdm_rwflbm,dm_zyrwbm,gdm_bjjbbm";
	ls_sql+=" where gdm_rwbm.rwflbm=gdm_rwflbm.rwflbm(+) and gdm_rwbm.zyrwbm=dm_zyrwbm.zyrwbm(+) and gdm_rwbm.bjjbbm=gdm_bjjbbm.bjjbbm(+) and rwbm='"+whererwbm+"'";
