...
try {
	...
	ls_sql="update gdm_rwbm set rwbm=?,rwmc=?,rwflbm=?,rwdx=?,sfsjysxm=?,gcysxmbm=?,sfsjzcxm=?,zcdlbm=?,sjzcjd=?,sfyxhxgq=?,zdjkrw=?,bjsj=?,bjjbbm=?,sqbjnr=?,sqbjts=?,shbjnr=?,shbjts=?,rwxh=?,bz=?";
