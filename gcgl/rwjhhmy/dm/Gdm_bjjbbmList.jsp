...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" FROM gdm_bjjbbm  ";
    ls_sql+=" where (1=1)";
    ls_sql+=wheresql;
    ls_sql+=" order by bjjbbm";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Gdm_bjjbbmList.jsp","","","EditGdm_bjjbbm.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Gdm_bjjbbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from gdm_bjjbbm where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="12%">&nbsp;</td>
	<td  width="24%">报警级别编码</td>
	<td  width="64%">报警级别名称</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
