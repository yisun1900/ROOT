...
try {
	...
	ls_sql="select rwflbm,rwflmc,rwdl ";
	...
	if (rs.next())
	{
		...
		rwdl=cf.fillNull(rs.getString("rwdl"));
	}
	rs.close();
	ps.close();
}
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditGdm_rwflbm.jsp" name="editform">
<div align="center">请修改信息</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  <tr bgcolor="#FFFFFF">
    <td align="right">大类</td>
    <td><select name="rwdl" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="rwflbm.value=this.value">
        <option value=""></option>
        <%
	cf.selectToken(out,"1+一般&2+交底&3+进场&4+验收&5+复尺&6+下单&7+入库&8+送货&9+安装",rwdl);
%>
      </select>
    </td>
    <td align="right">&nbsp;</td>
