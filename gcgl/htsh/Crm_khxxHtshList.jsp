...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String htshr=null;
	htshr=request.getParameter("htshr");
	if (htshr!=null)
	{
		htshr=cf.GB2Uni(htshr);
		if (!(htshr.equals("")))	wheresql+=" and  (crm_khxx.htshr='"+htshr+"')";
	}
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,DECODE(htshbz,'N','未审核','Y','已审核','P','可派单'),htshr,htshsj,htshdf,htshyj,crm_khxx.sjs,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq";
	ls_sql+=" FROM crm_khxx,sq_dwxx a";
    ls_sql+=" where crm_khxx.dwbh=a.dwbh(+) and (htshsj is not null)";
