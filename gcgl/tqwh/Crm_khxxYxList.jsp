...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,ysgcjdmc,wdzgce,zkl,qye,suijin,sjs,zjxm,sgdmc sgd,qyrq,a.dwmc dm, DECODE(hdbz,'1','非回单','2','设计师回单','3','施工队回单','4','老客户回单','5','员工回单','6','班长回单','7','售楼处','8','材料商','9','其他') as hdbz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxYxList.jsp","SelectYxCrm_khxx.jsp","","");
...
//设置主键
	...
	pageObj.setEditBolt("");
	pageObj.setEditStr("重新生成");

//设置按钮参数
	String[] buttonName={"允许重做报价"};//按钮的显示名称
	String[] buttonLink={"Yxczbj.jsp"};//按钮单击调用的网页，可以增加参数
