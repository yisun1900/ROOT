...
<%
	...
	if (yhqx.equals("0"))
	{
		...
		sql+=" values ( (select NVL(max(xh),0)+1 from sq_ckxxrz),'"+xtrzip+"','"+xtrzyhdlm+"','"+xtrzyhmc+"',SYSDATE,'警告！非法侵入[重做电子报价]："+xtrzyhmc+"') ";
...
<table width="100%" height="371">
  <tr>
    <td width="100%"> 
      <div align="center">
        重做电子报价
        <BR><b><font color="#CC0000">注意：只有经过允许才能重做电子报价</font></b>
      </div>
    </td>
  </tr>
  <tr>
