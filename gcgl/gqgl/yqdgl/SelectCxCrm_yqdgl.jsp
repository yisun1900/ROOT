...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_yqdglCxList.jsp" name="selectform">
<div align="center">
  <DIV align="center">延期单申请－查询</DIV>
</div>
<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#FFFFFF">
    <td align="right">工长</td>
    <td><select name="crm_khxx_sgd" style="FONT-SIZE:12PX;WIDTH:152PX">
                  <%
...
%> 
  ...
  <td width="31%">
	<INPUT type="radio" name="crm_yqdgl_clzt" value="1">申请	
	<INPUT type="radio" name="crm_yqdgl_clzt" value="2">审批</td>
</tr>
<tr bgcolor="#FFFFFF">
