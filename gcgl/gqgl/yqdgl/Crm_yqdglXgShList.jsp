...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=wheresql;
	ls_sql+=" order by crm_yqdgl.shsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_yqdglXgShList.jsp","","","XgShCrm_yqdgl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteShCrm_yqdgl.jsp?"};//按钮单击调用的网页，可以增加参数
