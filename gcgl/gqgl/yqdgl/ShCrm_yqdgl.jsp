...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveShCrm_yqdgl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE2">申请原因</span></td>
  <td><%=sqyy%></td>
...
<tr bgcolor="#FFFFFF">
  ...
  <td><%
	cf.radioToken(out, "shjg","Y+通过&N+未通过","");
%>  </td>
  <td align="right"><span class="STYLE1">*</span>审核增加天数</td>
  <td><input type="text" name="shts" size="20" maxlength="8"  value="<%=zjts%>" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right">审核说明</td>
  <td colspan="3"><textarea name="shsm" cols="71" rows="4"></textarea>  </td>
  </tr>
