...
<div align="center">请修改信息（序号：<%=yqdbh%>）</div>
...
%></td>
  ...
  <tr bgcolor="#FFFFFF">
    <td colspan="4" align="center" bgcolor="#E8E8FF"><strong>延期单申请（序号:<%=yqdbh%>）</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">延期单编号</td>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>申请原因</td> 
