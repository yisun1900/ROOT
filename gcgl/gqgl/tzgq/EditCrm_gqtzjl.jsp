...
try {
	...
	ls_sql="select khbh,tzlx,tzsjd,tzts,gqtzyybm,tzyysm,lrr,lrsj,lrdw ";
...
<tr bgcolor="#FFFFFF">
  ...
  <td colspan="3"> 
<%
	cf.radioToken(out, "tzlx","1+延期&2+工期缩减&3+工期合理增加",tzlx);
%>  </td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>调整天数</td>
  <td colspan="3"><input type="text" name="tzts" size="10" maxlength="8"  value="<%=tzts%>" >
    <span class="STYLE3">（增加为正、减少为负）</span></td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>工期调整原因</td> 
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>调整原因说明</td> 
  <td colspan="3"> 
