...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_gqtzjlList.jsp" name="selectform">
<div align="center">延期调整工期－维护</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">登记记录号</td> 
  <td width="32%"> 
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">调整类型</td> 
  <td width="32%"> 
<%
	cf.radioToken(out, "crm_gqtzjl_tzlx","1+延期","");
%>  </td>
  <td align="right" width="18%">延期原因</td> 
  <td width="32%"><select name="crm_gqtzjl_gqtzyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">延期天数</td> 
  <td width="32%"> 
    <input type="text" name="crm_gqtzjl_tzts" size="20" maxlength="8" >  </td>
  <td align="right" width="18%">延期类型</td> 
  <td width="32%"><select name="yqlx" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select yqlx c1,yqlx c2 from dm_yqlx  order by yqlxbm","");
%>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入时间 从</td> 
  <td width="32%"><input type="text" name="crm_gqtzjl_lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
  <td align="right" width="18%">到</td> 
  <td width="32%"><input type="text" name="crm_gqtzjl_lrsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">  </td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%">录入人</td> 
  <td width="32%"><input type="text" name="crm_gqtzjl_lrr" size="20" maxlength="20" ></td>
  <td align="right" width="18%">&nbsp;</td>
  <td width="32%">&nbsp;</td>
</tr>
<tr align="center"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isNumber(FormName.crm_gqtzjl_tzts, "延期天数"))) {
		return false;
	}
