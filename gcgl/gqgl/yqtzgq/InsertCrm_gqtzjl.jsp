...
%></td>
  ...
  <td colspan="3"><input type="radio" name="tzlx"  value="1" checked>
延期  </td>
  </tr>
<tr bgcolor="#FFFFFF">
  <td align="right" width="18%"><span class="STYLE1">*</span>延期天数</td> 
  <td><input type="text" name="tzts" value="" size="10" maxlength="8" ></td>
...
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>延期原因</td>
  <td><select name="gqtzyybm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value=""></option>
    <%
	cf.selectItem(out,"select gqtzyybm,gqtzyymc from dm_gqtzyybm where lx='1' order by lx,gqtzyybm","");
%>
  </select></td>
  <td align="right"><span class="STYLE1">*</span>调整时间</td>
  <td><input type="text" name="tzsjd" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td align="right"><span class="STYLE1">*</span>延期原因说明</td>
