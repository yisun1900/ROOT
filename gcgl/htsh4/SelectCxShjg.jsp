...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFCC">
              ...
              <td><input type="text" name="htshsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
              <td align="right">到</td>
              <td><input type="text" name="htshsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td align="right">记入业绩时间 从</td>
              <td><input type="text" name="yjjzsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
              <td align="right">到</td>
              <td><input type="text" name="yjjzsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
              </td>
            </tr>
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="打印审核结果" onClick="f_do1(selectform)">
                <input type="button"  value="打印得分排名" onClick="f_do2(selectform)">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.htshsj, "审核时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.htshsj2, "审核时间"))) {
		return false;
	}


	FormName.action="Crm_khxxCxHtshList.jsp";
