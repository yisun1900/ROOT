...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(htshbz,'N','未审核','P','可派单','Y','审核完成'),crm_khxx.khbh,crm_khxx.hth,crm_khxx.khxm,crm_khxx.fwdz,yjjzsj,htshr,htshsj,htshdf,htshyj,crm_khxx.sjs,crm_khxx.zjxm,a.dwmc qydm,crm_khxx.qyrq";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxXgHtshList.jsp","","","HtshCrm_khxx.jsp");
