...
try {
	...
	ls_sql="select sfke,cwsfke,yjjzsj,crm_khxx.guanlif,zqsuijin,crm_khxx.qtdh,crm_khxx.email,htshsj,htshr,htshyj,rzsc,sfyrz,glftd,suijin,suijinbfb,zjxje,khxm,fwdz,lxfs,hth,sjs,qye,kgrq,jgrq,a.dwmc dm,sgdmc sgd,xxshr,xxshsj,xxshyj,htshbz,zjxm,qyrq,jyjdrq,wdzgce,zkl,sfyyh,cxhdbm,yhyy";
	ls_sql+=" ,zqgczjf,zhgczjf,zqguanlif";
...
<div align="center">合同审核 </div>
  <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#E8E8FF">
      <td align="right"><span class="STYLE1"><span class="STYLE2">*</span></span>记入业绩时间</td>
      <td><input name="yjjzsj" type="text" value="<%=yjjzsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
      <td bgcolor="#E8E8FF" align="right">签约日期</td>
      <td><%=qyrq%></td>
    </tr>
    <tr bgcolor="#E8E8FF"> 
