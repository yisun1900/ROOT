...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT kp_xjgdjl.xjjlh,crm_khxx.hth,crm_khxx.khxm,kp_xjgdjl.xjr,kp_xjgdjl.xjsj,xjlxmc,dm_xjjgbm.xjjgmc,DECODE(cfspbz,'1','无处罚','2','处罚未审批','3','已审批需处罚','4','已审批不需处罚'),kpcfmc,kp_xjgdjl.bz,crm_khxx.fwdz,crm_khxx.sjs,sgdmc,crm_khxx.zjxm  ";
