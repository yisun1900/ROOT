...
<form method="post" action="" name="insertform" target="_blank">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              <td width="18%"> 
                <div align="right"><font color="#0000CC">考评记录号</font></div>
              </td>
              <td width="32%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="qssj" value="<%=cf.addMonth(-3)%>" size="20" maxlength="10" >
              </td>
              <td width="18%"> 
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="计算机考评" onClick="f_kp(insertform)" name="kp" disabled=true>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveInsertKp_kpjl.jsp";
	FormName.submit();
...
function f_ckkp(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Kp_yzfsgdkpjgCxList.jsp";
	FormName.submit();
	return true;
}
