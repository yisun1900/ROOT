...
try {
	...
	ls_sql+=" where kp_sgdkpjg.sgdjbbm=sq_sgdjbbm.sgdjbbm(+) and kp_sgdkpjg.sgd=sq_sgd.sgd and  (kp_sgdkpjg.kpjlh="+kpjlh+") and  (kp_sgdkpjg.sgd='"+sgd+"')  ";
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center"> 特殊奖励或处罚（考评记录号：<%=kp_sgdkpjg_kpjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="SaveEditKp_sgdkpjg.jsp" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:14" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="27%"><%=sq_dwxx_dwmc%> </td>
              <td width="22%"> 
                <div align="right">施工队级别</div>
              </td>
              <td width="29%"><%=sq_sgdjbbm_sgdjbmc%> </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="22%"> 
                <div align="right">质保金</div>
              </td>
              <td width="27%"><%=kp_sgdkpjg_zbj%> </td>
              <td width="22%"> 
                <div align="right">班组数</div>
              </td>
              <td width="29%"><%=kp_sgdkpjg_bzs%> </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="22%"> 
                <div align="right">基础分</div>
              </td>
              <td width="27%"><%=kp_sgdkpjg_jcf%> </td>
              <td width="22%"> 
                <div align="right">考评工地数</div>
              </td>
              <td width="29%"><%=kp_sgdkpjg_kpgds%> </td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%" align="right">重大投诉扣大单</td>
              <td width="27%"> 
                <input type="text" name="kdds" size="20" maxlength="8"  value="<%=kp_sgdkpjg_kdds%>" >
              </td>
              <td width="22%" align="right">特殊奖励或处罚大单</td>
              <td width="29%"> 
                <input type="text" name="tsjcdd" size="20" maxlength="8"  value="<%=kp_sgdkpjg_tsjcdd%>" >
              </td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%"> 
              ...
              <td width="27%"> 
                <input type="text" name="kzds" size="20" maxlength="8"  value="<%=kp_sgdkpjg_kzds%>" >
              </td>
              <td width="22%"> 
                <div align="right">特殊奖励或处罚中单</div>
              </td>
              <td width="29%"> 
                <input type="text" name="tsjczd" size="20" maxlength="8"  value="<%=kp_sgdkpjg_tsjczd%>" >
              </td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%"> 
              ...
              <td width="27%"> 
                <input type="text" name="kxds" size="20" maxlength="8"  value="<%=kp_sgdkpjg_kxds%>" >
              </td>
              <td width="22%"> 
                <div align="right">特殊奖励或处罚小单</div>
              </td>
              <td width="29%"> 
                <input type="text" name="tsjcxd" size="20" maxlength="8"  value="<%=kp_sgdkpjg_tsjcxd%>" >
              </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
              ...
              <td width="27%"> <%=kp_sgdkpjg_kjdds%> </td>
              <td width="22%"> 
                <div align="right">下周期可接中单总数</div>
              </td>
              <td width="29%"> <%=kp_sgdkpjg_kjzds%> </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
                <div align="right">下周期可接小单总数</div>
              </td>
              <td width="27%"> <%=kp_sgdkpjg_kjxds%> </td>
              <td width="22%"> 
                <div align="right"></div>
              </td>
              <td width="29%">&nbsp; </td>
            ...
            <tr bgcolor="#FFCCFF"> 
              ...
              <td width="27%"><%=kp_sgdkpjg_kjdzs%></td>
              <td width="22%" align="right">下周期可接单总额</td>
              <td width="29%"><%=kp_sgdkpjg_kjdze%></td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
              ...
              <td width="29%"><%=kp_sgdkpjg_ddbzs%> </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
              ...
              <td width="29%"><%=kp_sgdkpjg_zdbzs%> </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
              ...
              <td width="29%"><%=kp_sgdkpjg_xdbzs%> </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
                <div align="right">大单回单奖励数</div>
              </td>
              <td width="27%"><%=kp_sgdkpjg_ddjls%> </td>
              <td width="22%"> 
                <div align="right">中单回单奖励数</div>
              </td>
              <td width="29%"><%=kp_sgdkpjg_zdjls%> </td>
            </tr>
            <tr bgcolor="#FFCCFF"> 
              <td width="22%"> 
                <div align="right">小单回单奖励数</div>
              </td>
              <td width="27%"><%=kp_sgdkpjg_xdjls%> </td>
              <td width="22%" bgcolor="#CCFFCC"> 
                <div align="right">非常严重投诉次数</div>
              </td>
              <td width="29%" bgcolor="#CCFFCC"><%=fcyztscs%> </td>
            </tr>
            <tr bgcolor="#CCFFCC"> 
              <td width="22%" align="right" height="19">特别严重投诉次数</td>
              <td width="27%" height="19"><%=tbyztscs%></td>
              <td width="22%" align="right" height="19" bgcolor="#CCFFCC">严重投诉次数</td>
              <td width="29%" height="19"><%=yztscs%></td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%" align="right">本期得分</td>
              <td width="27%"><%=kp_sgdkpjg_bqdf%></td>
              <td width="22%" align="right">历史总得分</td>
              <td width="29%"><%=kp_sgdkpjg_sqzf%></td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%"> 
                <div align="right">本期总分</div>
              </td>
              <td width="27%"><%=kp_sgdkpjg_bqzf%> </td>
              <td width="22%"> 
                <div align="right">本期排名</div>
              </td>
              <td width="29%"><%=kp_sgdkpjg_bqpm%> </td>
            </tr>
            <tr bgcolor="#CCCCFF"> 
              <td width="22%"> 
                <div align="right">上期排名</div>
              </td>
              <td width="27%"> <%=kp_sgdkpjg_sqpm%> </td>
              <td width="22%"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isInt(FormName.tsjcdd, "特殊奖励或处罚大单"))) {
		return false;
	}
	if(!(isInt(FormName.tsjczd, "特殊奖励或处罚中单"))) {
		return false;
	}
	if(!(isInt(FormName.tsjcxd, "特殊奖励或处罚小单"))) {
		return false;
	}
	FormName.submit();
	return true;
