...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Kp_pfzxmbmList.jsp","SelectKp_pfzxmbm.jsp","","EditKp_pfzxmbm.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Kp_pfzxmbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from kp_pfzxmbm where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	<td  width="10%">&nbsp;</td>
	<td  width="15%">评分项目编码</td>
	<td  width="25%">评分项目名称</td>
	<td  width="15%">巡检类型编码</td>
	<td  width="25%">巡检类型名称</td>
	<td  width="10%">分值</td>
</tr>
<%
