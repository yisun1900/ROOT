...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rs_yggzbg.sjqd,rs_yggzbg.sjzd,a.dwmc ssbm,rs_yggzbg.xm,rs_yggzbg.xzzwbm,rs_yggzbg.gzsm,rs_yggzbg.lrr,rs_yggzbg.lrsj,b.dwmc ssfgs,rs_yggzbg.ygbh  ";
...
/*
//设置显示列
	String[] disColName={"ygbh","sjqd","rs_yggzbg_sjzd","rs_yggzbg_xm","rs_yggzbg_xzzwbm","rs_yggzbg_ssfgs","rs_yggzbg_dwbh","rs_yggzbg_gzsm","rs_yggzbg_lrr","rs_yggzbg_lrsj","sq_dwxx_dwmc"};
