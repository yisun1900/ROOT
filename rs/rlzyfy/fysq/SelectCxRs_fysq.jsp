...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_fysqCxList.jsp" name="selectform">
...
<table width="100%" border="1" style="FONT-SIZE:12" bordercolor="#FFFFFF" bordercolorlight="#666666" bgcolor="#E0E0E0">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><input type="text" name="fysqbh" size="20" maxlength="10" >    </td>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><input type="text" name="sqsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
     </td>
    <td align="right" width="15%">申请时间 到</td>
    <td width="35%"><input type="text" name="sqsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>	
  </tr>
  <tr bgcolor="#FFFFFF">
...
%>
    ...
    <td width="35%"><input type="text" name="ytxs" size="20" maxlength="100" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">费用</td>
    <td width="35%"><input type="text" name="fy" size="20" maxlength="9" >    </td>
    <td align="right" width="15%">汇总编号</td>
    <td width="35%"><input type="text" name="hzbh" size="20" maxlength="11" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">是否可改</td>
    <td width="35%"><select name="sfkg" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <option value="Y">可改</option>
      <option value="N">不可改</option>
    </select>    </td>
    <td align="right" width="15%">录入人</td>
    <td width="35%"><input type="text" name="lrr" size="20" maxlength="20" >    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">录入时间 从</td>
    <td width="35%"><input type="text" name="lrsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">    </td>
