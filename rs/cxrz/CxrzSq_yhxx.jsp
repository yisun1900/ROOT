...
<div align="center">离职员工重新入职（申请序号：<%=sqxh%>）</div>
<div align="center">
  <input type="button" value="录入教育经历" onClick="window.open('/rs/yghmcgl/InsertRs_jyjl.jsp?ygbh=<%=ygbh%>')">
  <input type="button" value="录入工作经历" onClick="window.open('/rs/yghmcgl/InsertRs_gzjl.jsp?ygbh=<%=ygbh%>')">
  <input type="button" value="录入家庭资料" onClick="window.open('/rs/yghmcgl/InsertRs_jtzl.jsp?ygbh=<%=ygbh%>')">
    <input type="button"  value="上传照片" onClick="window.open('/rs/yghmcgl/loadPhoto.jsp?ygbh=<%=ygbh%>')">
    <input type="button"  value="查看照片" onClick="window.open('/rs/yghmcgl/viewPhoto.jsp?ygbh=<%=ygbh%>')">
...
%> 
      ...
      <td align="right" width="15%"><span class="STYLE1">*</span>员工状态 </td>
      <td width="15%"> 
        <select name="sfzszg" style="FONT-SIZE:12PX;WIDTH:114PX">
          <option value=""></option>
          <%
	cf.selectToken(out,"M+实习生&Y+转正&N+试用期","");
%> 
        </select>      </td>
    </tr>
    <tr bgcolor="#E0F5FF"> 
...
%> 
      ...
      <td align="right" width="15%">主要资质证书</td>
      <td width="15%"> 
...
%> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td align="right" width="15%"><span class="STYLE1">*</span>户籍所在地</td>
      <td width="15%" colspan="3"> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td align="right" width="15%"><span class="STYLE1">*</span>电话是否公布</td>
      <td width="15%"> 
...
%> </td>
      <td align="right" width="15%">体检日期</td>
      <td width="15%"> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td align="right" width="15%"><span class="STYLE1">*</span>工号</td>
      <td width="15%"> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td align="right" width="15%">紧急联系人电话</td>
      <td width="15%"> 
...
%> </td>
      ...
      <td align="right" width="15%">设计师职称</td>
      <td width="15%"> 
...
%> 
    ...
    <tr bgcolor="#E0F5FF"> 
      <td align="right" width="10%">业务专长和自我评价</td>
      <td colspan="7"> 
...
%> 
      ...
      <td align="right" width="15%"><span class="STYLE1">*</span>行政职务</td>
      <td width="15%"> 
...
%> 
    ...
    <tr bgcolor="#DFE3E9"> 
      ...
      <td align="right" width="15%">工作年限</td>
      <td width="15%"> 
...
%></td>
      ...
      <td align="right" width="15%">岗前培训 到</td>
      <td width="15%"> 
