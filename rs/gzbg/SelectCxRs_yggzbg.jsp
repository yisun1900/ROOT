...
%>
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_yggzbgCxList.jsp" name="selectform">
<div align="center"><strong>员工工作报告-查询</strong></div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="33%"> 
    <input type="text" name="rs_yggzbg_lrr" size="20" maxlength="20" >  </td>
</tr>
<tr bgcolor="#FFFFFF">
