...
try {
	...
	ls_sql="select ygbh,sjqd,sjzd,xm,xzzwbm,ssfgs,dwbh,gzsm,gzsj,lrr,lrsj ";
	...
	if (rs.next())
	{
		...
		gzsj=cf.fillNull(rs.getString("gzsj"));
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    <td width="18%" align="right">工作时间</td>
    <td width="32%"><input type="text" name="gzsj" value="<%=gzsj%>"  size="20" maxlength="20">
      （小时）    </td>
    <td align="right" width="15%"><span class="STYLE1">*</span><span class="STYLE2">录入人</span></td>
    <td width="35%"><input type="text" name="lrr" value="<%=lrr%>" size="20" maxlength="20" readonly>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%"><span class="STYLE1"><span class="STYLE2">*</span>录入时间</span></td>
    <td width="35%"><input type="text" name="lrsj" size="20" maxlength="10"  value="<%=lrsj%>" readonly>
    </td>
  <td align="right"  >&nbsp;</td> 
  <td align="right" >&nbsp;</td> 
  </tr>
