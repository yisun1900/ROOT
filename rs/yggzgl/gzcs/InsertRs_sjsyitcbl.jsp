...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveInsertRs_sjsyitcbl.jsp" name="insertform" target="_blank">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="radio" name="qdlx"  value="1">非市场部家装
    <input type="radio" name="qdlx"  value="2">市场部家装
    <input type="radio" name="qdlx"  value="3">工装
  </td>
</tr>
<tr bgcolor="#FFFFFF">
