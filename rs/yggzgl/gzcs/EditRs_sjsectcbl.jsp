...
try {
	...
	ls_sql="select xh,fdmc,qd,zd,tcbfb,qdlx,fgsbh,sjsjb ";
	ls_sql+=" from  rs_sjsectcbl";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditRs_sjsectcbl.jsp" name="editform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
<%
	cf.radioToken(out, "qdlx","1+非市场部家装&2+市场部家装&3+工装",qdlx);
%>
  </td>
</tr>
<tr bgcolor="#FFFFFF">
