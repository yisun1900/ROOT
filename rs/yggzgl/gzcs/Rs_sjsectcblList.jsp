...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT xh,dwmc,sjsjbmc,fdmc,qd,zd, DECODE(qdlx,'1','非市场部家装','2','市场部家装','3','工装'),tcbfb||'%'";
...
//设置按钮参数
	...
	String[] buttonLink={"Rs_sjsectcblList.jsp?"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">序号</td>
	<td  width="14%">分公司</td>
	<td  width="15%">设计师级别</td>
	<td  width="15%">分段名称</td>
	<td  width="10%">起点</td>
	<td  width="10%">终点</td>
	<td  width="13%">签单类型</td>
	<td  width="10%">提成百分比</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
