...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT xh,fdmc,qd,zd,tcbfb, DECODE(qdlx,'1','非市场部家装','2','市场部家装','3','工装'),fgsbh,sjsjb  ";
	ls_sql+=" FROM rs_sjsyitcbl  ";
    ls_sql+=" where (1=1)";
    ls_sql+=wheresql;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_sjsyitcblList.jsp","","","EditRs_sjsyitcbl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Rs_sjsyitcblList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from rs_sjsyitcbl where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="11%">签单类型</td>
	<td  width="11%">分公司编号</td>
	<td  width="11%">设计师级别</td>
</tr>
<%
	pageObj.displayDate();
	pageObj.displayFoot();
