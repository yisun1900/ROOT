            ...
            <tr align="center"> 
              <td colspan="4" height="94"> 
                <p> 
                  ...
                  <input type="button"  value="修改工资" onClick="f_xggz(insertform)" name="xggz" disabled>
                  <input type="reset"  value="重输" name="reset">
                </p>
                <p> 
                  <input type="button"  value="自动计算工资" onClick="f_jsgz(insertform)" name="jsgz" disabled>
                  <input type="button"  value="查看工资" onClick="f_ckgz(insertform)" name="ckgz" disabled>
                </p>
              </td>
            </tr>
          </table>
