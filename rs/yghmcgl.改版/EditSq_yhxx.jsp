...
try {
	...
	ls_sql="select xuhao,khgz,buzhu,bianhao,yhmc,xb,csrq,sfzszg,mz,sg,tz,xx,hf,zzmm,sjsjb,zcmc,zyzzzs,xlbm,zy,cjgzsj,xuewei,byyx,zz,yzbm,dh,bgdh,jtdh,email,sfzh,sfzdz,gznx,jjlxr,jjlxrdz,lxrdh,zwbm,xzzwbm,sfytj,tjrq,sfqs,dhsfgb,zwpj,ssfgs,dwbh,lrr,lrsj,bz,sfydbs,qgzdw,wgzsj,syjzrq,gzlb,syqgz,zzgz,jbgz,glgz,gwgz,jtbt,cb,dhbt,kqhm,sfcjbx,hjszd,dacfd,dazrsj,dazcsj,dazchc,dabgfjs,sjsbh,rzcs,rzsj,gqpxkssj,gqpxjssj ";
	ls_sql+=" from  sq_yhxx";
	...
	if (rs.next())
	{
		...
		syqgz=rs.getDouble("syqgz");
		zzgz=rs.getDouble("zzgz");
...
<div align="center">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#E0F5FF"> 
      ...
      <td width="15%"> 
        <input type="text" name="yhmc" size="15" maxlength="50"  value="<%=yhmc%>" readonly>
      </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>性别</td>
      <td width="15%"> 
...
%> 
      ...
      <td align="right" width="10%"><span class="STYLE1">*</span>出生日期</td>
      <td width="15%"> 
        <input type="text" name="csrq" size="15" maxlength="10"  value="<%=csrq%>" onDblClick="JSCalendar(this)">
      </td>
...
%> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td width="15%"> 
        <input type="text" name="mz" size="15" maxlength="20"  value="<%=mz%>" >
      </td>
      <td align="right" width="10%">身高(cm)</td>
      <td width="15%"> 
        <input type="text" name="sg" size="15" maxlength="8"  value="<%=sg%>" >
      </td>
      <td align="right" width="10%">体重(KG)</td>
      <td width="15%"> 
        <input type="text" name="tz" size="15" maxlength="8"  value="<%=tz%>" >
      </td>
...
%> 
      ...
      <td align="right" width="10%">技术职称</td>
      <td width="15%"> 
...
%> 
      ...
      <td align="right" width="10%">所学专业</td>
      <td width="15%"> 
        <input type="text" name="zy" size="15" maxlength="50"  value="<%=zy%>" >
      </td>
      <td align="right" width="10%">毕业时间</td>
      <td width="15%"> 
        <input type="text" name="cjgzsj" size="15" maxlength="10"  value="<%=cjgzsj%>" onDblClick="JSCalendar(this)">
      </td>
...
%> 
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td width="15%" colspan="3"> 
        <input type="text" name="byyx" size="50" maxlength="50"  value="<%=byyx%>" >
      </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>是否已体检</td>
      <td width="15%"><%
	cf.radioToken(out, "sfytj","Y+是&N+否",sfytj);
%></td>
      <td align="right" width="10%">体检日期</td>
      <td width="15%"> 
        <input type="text" name="tjrq" size="15" maxlength="10"  value="<%=tjrq%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#E0F5FF"> 
      <td align="right" width="10%">现详细住址</td>
      <td width="15%" colspan="3"> 
        <input type="text" name="zz" size="50" maxlength="200"  value="<%=zz%>" >
      </td>
      <td align="right" width="10%">邮政编码</td>
      <td width="15%"> 
        <input type="text" name="yzbm" size="15" maxlength="10"  value="<%=yzbm%>" >
      </td>
      <td align="right" width="10%">email</td>
      <td width="15%"> 
        <input type="text" name="email" size="15" maxlength="50"  value="<%=email%>" >
      </td>
    </tr>
    <tr bgcolor="#E0F5FF"> 
      <td align="right" width="10%">手机</td>
      <td width="15%"> 
        <input type="text" name="dh" size="15" maxlength="50"  value="<%=dh%>" >
      </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>办公电话</td>
      <td width="15%"> 
        <input type="text" name="bgdh" size="15" maxlength="50"  value="<%=bgdh%>" >
      </td>
      <td align="right" width="10%">家庭电话</td>
      <td width="15%"> 
        <input type="text" name="jtdh" size="15" maxlength="50"  value="<%=jtdh%>" >
      </td>
    ...
    <tr bgcolor="#E0F5FF"> 
      ...
      <td width="15%"> 
        <input type="text" name="sfzh" size="15" maxlength="18"  value="<%=sfzh%>" >
      </td>
      <td align="right" width="10%">身份证地址</td>
      <td width="15%" colspan="3"> 
        <input type="text" name="sfzdz" size="50" maxlength="100"  value="<%=sfzdz%>" >
      </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>工号</td>
      <td width="15%"> 
        <input type="text" name="bianhao" size="15" maxlength="20"  value="<%=bianhao%>" >
      </td>
    </tr>
    <tr bgcolor="#E0F5FF"> 
      <td align="right" width="10%">紧急联系人</td>
      <td width="15%"> 
        <input type="text" name="jjlxr" size="15" maxlength="20"  value="<%=jjlxr%>" >
      </td>
      <td align="right" width="10%">紧急联系人住址</td>
      <td width="15%" colspan="3"> 
        <input type="text" name="jjlxrdz" size="50" maxlength="100"  value="<%=jjlxrdz%>" >
      </td>
      <td align="right" width="10%">紧急联系人电话</td>
      <td width="15%"> 
        <input type="text" name="lxrdh" size="15" maxlength="50"  value="<%=lxrdh%>" >
      </td>
    </tr>
    <tr bgcolor="#E0F5FF"> 
...
%> </td>
      ...
      <td align="right" width="10%">考勤号码</td>
      <td width="15%"> 
        <input type="text" name="kqhm" size="15" maxlength="8"  value="<%=kqhm%>" >
      </td>
...
%> 
    ...
    <tr bgcolor="#E0F5FF"> 
      <td align="right" width="10%" bgcolor="#E0F5FF">业务专长<BR>
        自我评价</td>
      <td colspan="7"> 
        <textarea name="zwpj" cols="118" rows="3"><%=zwpj%></textarea>
      </td>
    </tr>
    ...
    <tr bgcolor="#DFE3E9"> 
      ...
      <td width="15%" colspan="3"> 
        <input type="text" name="hjszd" size="50" maxlength="100"  value="<%=hjszd%>" >
      </td>
      <td align="right" width="10%">档案存放地</td>
      <td colspan="3"> 
        <input type="text" name="dacfd" size="50" maxlength="50"  value="<%=dacfd%>" >
      </td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%">档案转入时间</td>
      <td width="15%"> 
        <input type="text" name="dazrsj" size="15" maxlength="10"  value="<%=dazrsj%>" onDblClick="JSCalendar(this)">
      </td>
      <td align="right" width="10%">档案转出时间</td>
      <td width="15%"> 
        <input type="text" name="dazcsj" size="15" maxlength="10"  value="<%=dazcsj%>" onDblClick="JSCalendar(this)">
      </td>
      <td align="right" width="10%">档案转出何处</td>
      <td width="15%"> 
        <input type="text" name="dazchc" size="15" maxlength="50"  value="<%=dazchc%>">
      </td>
...
%> 
      ...
      <td align="right" width="10%"><span class="STYLE1">*</span>所属部门</td>
      <td width="15%"> 
...
%> 
      ...
      <td align="right" width="10%">所属部门小组</td>
      <td width="15%"> 
...
%> 
    ...
    <tr bgcolor="#DFE3E9"> 
      ...
      <td width="15%"> 
        <input type="text" name="rzsj" size="15" maxlength="10"  value="<%=rzsj%>" onDblClick="JSCalendar(this)">
      </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>入职次数</td>
      <td width="15%"> 
        <input type="text" name="rzcs" size="15" maxlength="8"  value="<%=rzcs%>" >
      </td>
      <td align="right" width="10%">试用截至日期</td>
      <td width="15%"> 
        <input type="text" name="syjzrq" size="15" maxlength="10"  value="<%=syjzrq%>" onDblClick="JSCalendar(this)">
      </td>
    ...
    <tr bgcolor="#DFE3E9"> 
      ...
      <td width="15%"> 
        ...
        年 </td>
      <td align="right" width="10%"><span class="STYLE1">*</span>是否有担保书</td>
      <td width="15%"><%
	cf.radioToken(out, "sfydbs","Y+是&N+否",sfydbs);
%></td>
      <td align="right" width="10%">岗前培训 从</td>
      <td width="15%"> 
        <input type="text" name="gqpxkssj" size="15" maxlength="10"  value="<%=gqpxkssj%>" onDblClick="JSCalendar(this)">
      </td>
      <td align="right" width="10%">岗前培训 到</td>
      <td width="15%"> 
        <input type="text" name="gqpxjssj" size="15" maxlength="10"  value="<%=gqpxjssj%>" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%">前工作单位</td>
      <td colspan="7"> 
        <input type="text" name="qgzdw" size="120" maxlength="100"  value="<%=qgzdw%>" >
      </td>
    </tr>
    <tr bgcolor="#DFE3E9" align="center"> 
      <td colspan="8"><b>*工资* </b></td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%"><span class="STYLE1">*</span>工资类别</td>
      <td width="15%"> 
        <select name="gzlb" style="FONT-SIZE:12PX;WIDTH:114PX">
          <option value=""></option>
          <%
	cf.selectToken(out,"1+固定工资&2+浮动工资",gzlb);
%> 
        </select>
      </td>
      <td align="right" width="10%">试用期工资</td>
      <td width="15%"> 
        <input type="text" name="syqgz" size="15" maxlength="16"  value="<%=syqgz%>" >
      </td>
      <td align="right" width="10%">转正工资</td>
      <td width="15%"> 
        <input type="text" name="zzgz" size="15" maxlength="16"  value="<%=zzgz%>" >
      </td>
      <td align="right" width="10%">基本工资</td>
      <td width="15%"> 
        <input type="text" name="jbgz" size="15" maxlength="9"  value="<%=jbgz%>" >
      </td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%">工龄工资</td>
      <td width="15%"> 
        <input type="text" name="glgz" size="15" maxlength="9"  value="<%=glgz%>" >
      </td>
      <td align="right" width="10%">岗位工资</td>
      <td width="15%"> 
        <input type="text" name="gwgz" size="15" maxlength="9"  value="<%=gwgz%>" >
      </td>
      <td align="right" width="10%">考核工资</td>
      <td width="15%"> 
        <input type="text" name="khgz" value="<%=khgz%>" size="15" maxlength="9" >
      </td>
      <td align="right" rowspan="3">备注</td>
      <td rowspan="3"><b>
        <textarea name="bz" cols="14" rows="5"><%=bz%></textarea>
        </b> </td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%">补助</td>
      <td width="15%"> 
        <input type="text" name="buzhu" value="<%=buzhu%>" size="15" maxlength="9" >
      </td>
      <td align="right" width="10%">交通补贴</td>
      <td width="15%"> 
        <input type="text" name="jtbt" size="15" maxlength="9"  value="<%=jtbt%>" >
      </td>
      <td align="right" width="10%">餐补</td>
      <td width="15%"> 
        <input type="text" name="cb" size="15" maxlength="9"  value="<%=cb%>" >
      </td>
    </tr>
    <tr bgcolor="#DFE3E9"> 
      <td align="right" width="10%"><span class="STYLE1">*</span><span class="STYLE2">录入人</span></td>
      <td width="15%"> 
        <input type="text" name="lrr" size="15" maxlength="20"  value="<%=lrr%>" readonly>
      </td>
      <td width="10%" align="right" class="STYLE2"><span class="STYLE1">*</span>录入时间</td>
      <td width="15%"> 
        <input type="text" name="lrsj" size="15" maxlength="10"  value="<%=lrsj%>" readonly>
      </td>
      <td align="right" width="10%">电话补贴</td>
      <td width="15%"> 
        <input type="text" name="dhbt" size="15" maxlength="9"  value="<%=dhbt%>" >
      </td>
    </tr>
...
//	}
	...
	if(	javaTrim(FormName.gzlb)=="") {
		alert("请选择[工资类别]！");
		FormName.gzlb.focus();
		return false;
	}
//	if(	javaTrim(FormName.syqgz)=="") {
//		alert("请输入[试用期工资]！");
//		FormName.syqgz.focus();
//		return false;
//	}
	if(!(isFloat(FormName.syqgz, "试用期工资"))) {
		return false;
	}
//	if(	javaTrim(FormName.zzgz)=="") {
//		alert("请输入[转正工资]！");
//		FormName.zzgz.focus();
//		return false;
//	}
	if(!(isFloat(FormName.zzgz, "转正工资"))) {
		return false;
	}
	...
	if(!(isFloat(FormName.buzhu, "补助"))) {
		return false;
	}
	if(!(isFloat(FormName.jtbt, "交通补贴"))) {
		return false;
	}
	if(!(isFloat(FormName.cb, "餐补"))) {
		return false;
	}
	if(!(isFloat(FormName.dhbt, "电话补贴"))) {
		return false;
	}
