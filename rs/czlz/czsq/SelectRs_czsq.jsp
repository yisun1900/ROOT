...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_czsqList.jsp" name="selectform">
...
<%
	...
	if (yhjs.equals("A0"))
	{
        ...
        out.println("        <select name=\"rs_czsq_fgsbh\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" onChange=\"selectItem(rs_czsq_fgsbh,rs_czsq_dwbh,"+dwstr+");\">");
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx in('A0','F0') order by dwbh","");
        out.println("        </select>");
	}
	else{
        out.println("        <select name=\"rs_czsq_fgsbh\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" >");
...
%>
      ...
      <td width="32%"> 
        <select name="rs_czsq_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	if (yhjs.equals("A0"))
	{
		out.println("<option value=\"\"></option>");
...
<%
	...
	else if ( (yhjs.equals("F0") || yhjs.equals("F1")) && dwflbm.equals("04"))//04：人事部
	{
		...
		%>
        <input type="text" name="rs_czsq_lrr" size="20" maxlength="20" value="<%=yhmc%>" readonly>
		<%
	}
%>
      </td>
