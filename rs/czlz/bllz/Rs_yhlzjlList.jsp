...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(lzlx,'S','辞职','T','辞退') lzlx,xh,ygbh,yhmc,bianhao,sfzh,xzzwbm,lzrq,lzyyflmc,lzyy,dwmc,rs_yhlzjl.lrr,rs_yhlzjl.lrsj  ";
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by rs_yhlzjl.xh desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_yhlzjlList.jsp","SelectRs_yhlzjl.jsp","","EditRs_yhlzjl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRs_yhlzjl.jsp?"};//按钮单击调用的网页，可以增加参数
