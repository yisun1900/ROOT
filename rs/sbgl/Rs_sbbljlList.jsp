...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" and rs_sbbljl.lx='1'";//1：办理；2：变更；3：停保；4：转出
    ...
    ls_sql+=wheresql;
    ls_sql+=" order by 1 desc";
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_sbbljlList.jsp","SelectRs_sbbljl.jsp","","EditRs_sbbljl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRs_sbbljl.jsp"};//按钮单击调用的网页，可以增加参数
