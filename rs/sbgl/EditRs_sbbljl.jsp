...
try {
	...
	ls_sql="select ygbh,shbxh,sbblsj,ylbx,jylbx,sybx,gsby,syx,jbxdd,sbzrjs,sbzcjs,bxtjsj,bxzcsj,yjsxe,gsjbfe,grjbfe,sfjgjj,gsjgjj,grjgjj,lrr,lrsj,lrbm,bz,jndbtc ";
	...
	ls_sql="select shbxh,sbblsj,ylbx,jylbx,sybx,gsby,syx,jbxdd,sbzrjs,yjsxe,gsjbfe,grjbfe,jndbtc";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditRs_sbbljl.jsp" name="editform">
<div align="center">办理社保－维护（社保办理记录号：<%=sbbljlh%>）</div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <input type="text" name="sbzrjs" size="20" maxlength="8"  value="<%=sbzrjs%>" >      </td>
      <td align="right" width="20%"><font color="#CC0000">*</font>交纳基数</td>
      <td width="30%">
