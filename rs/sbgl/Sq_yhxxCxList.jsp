...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ylbx!=null)
	{
		if (!(ylbx.equals("")))	wheresql+=" and  (rs_ygsbxx.ylbx='"+ylbx+"')";
	}
	String jylbx=null;
	jylbx=request.getParameter("jylbx");
	if (jylbx!=null)
	{
		if (!(jylbx.equals("")))	wheresql+=" and  (rs_ygsbxx.jylbx='"+jylbx+"')";
	}
	String sybx=null;
	sybx=request.getParameter("sybx");
	if (sybx!=null)
	{
		if (!(sybx.equals("")))	wheresql+=" and  (rs_ygsbxx.sybx='"+sybx+"')";
	}
	String gsby=null;
	gsby=request.getParameter("gsby");
	if (gsby!=null)
	{
		if (!(gsby.equals("")))	wheresql+=" and  (rs_ygsbxx.gsby='"+gsby+"')";
	}
	String syx=null;
	syx=request.getParameter("syx");
	if (syx!=null)
	{
		if (!(syx.equals("")))	wheresql+=" and  (rs_ygsbxx.syx='"+syx+"')";
	}
	String shbxh=null;
	...
	if (shbxh!=null)
	{
		...
		if (!(shbxh.equals("")))	wheresql+=" and  (rs_ygsbxx.shbxh='"+shbxh+"')";
	}
	String yjsxe=null;
	...
	if (yjsxe!=null)
	{
		...
		if (!(yjsxe.equals("")))	wheresql+=" and  (rs_ygsbxx.yjsxe='"+yjsxe+"')";
	}
	String sbblsj=null;
	...
	{
		sbblsj=sbblsj.trim();
		if (!(sbblsj.equals("")))	wheresql+="  and (rs_ygsbxx.sbblsj>=TO_DATE('"+sbblsj+"','YYYY/MM/DD'))";
	}
	...
	ls_sql+=" and rs_ygsbxx.sfcjbx not in('Y')";
	ls_sql+=" and sq_yhxx.sfzszg in('N','Y','D')";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Sq_yhxxCxList.jsp","SelectCxSq_yhxx.jsp","","InsertRs_sbbljl.jsp");
