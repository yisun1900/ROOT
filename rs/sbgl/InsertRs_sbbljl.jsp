...
try {
	...
	ls_sql="select sbbljlh,shbxh,sbblsj,ylbx,jylbx,sybx,gsby,syx,jbxdd,sbzrjs,yjsxe,gsjbfe,grjbfe,jndbtc";
...
<form method="post" action="SaveInsertRs_sbbljl.jsp" name="insertform" target="_blank">
  <div align="center"> 办理社保 </div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <input type="text" name="sbblsj" value="<%=cf.today()%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <input type="text" name="jbxdd" value="" size="20" maxlength="50" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>转入基数</td>
      <td width="31%"> 
        <input type="text" name="sbzrjs" value="0" size="20" maxlength="8" >      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>交纳基数</td>
      <td width="31%"> 
        <input type="text" name="yjsxe" value="" size="20" maxlength="17" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>公司交保费额</td>
      <td width="31%"> 
        <input type="text" name="gsjbfe" value="" size="20" maxlength="17" >      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>个人交保费额</td>
      <td width="31%"> 
        <input type="text" name="grjbfe" value="" size="20" maxlength="17" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>是否缴住房公积金</td>
      <td width="31%"> 
        <input type="radio" name="sfjgjj"  value="Y">
        是 
        <input type="radio" name="sfjgjj"  value="N">
        否 </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>交纳大病统筹</td>
      <td width="31%"><input type="text" name="jndbtc" value="" size="20" maxlength="17" ></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">公司交住房公积金</td>
      <td width="31%"> 
        <input type="text" name="gsjgjj" value="" size="20" maxlength="17" >      </td>
      <td align="right" width="19%">个人交住房公积金</td>
      <td width="31%"> 
        <input type="text" name="grjgjj" value="" size="20" maxlength="17" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.sbzrjs)=="") {
		alert("请输入[转入基数]！");
		FormName.sbzrjs.focus();
		return false;
	}
	if(!(isFloat(FormName.sbzrjs, "转入基数"))) {
		return false;
	}
