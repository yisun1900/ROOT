...
<%
	...
	ls_sql="SELECT pxmxbh,DECODE(pxlx,'0','内训','1','外训') pxlx,rs_pxskxsbm.skxsmc skxs,rs_pxkclxbm.lxmc kclx,pxrs,pxfy,shhrs,shhfy,pxjs,pxkssj,pxjssj,lrr,lrsj,bz  ";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">审核后费用</td>
	<td  width="7%">培训讲师</td>
	<td  width="7%">培训开始时间</td>
	<td  width="7%">培训结束时间</td>
	<td  width="5%">录入人</td>
	<td  width="8%">录入时间</td>
	<td  width="20%">备注</td>
</tr>
