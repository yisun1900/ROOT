...
try {
	...
	ls_sql="select pxjhbh,shjl,shyj,shr,shsj ";
	ls_sql+=" from  rs_pxsh";
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><font color="#0000FF">培训计划编号</font></td> 
  <td width="35%"> 
    <input type="text" name="pxjhbh" size="20" maxlength="8"  value="<%=pxjhbh%>" readonly>
  </td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditRs_pxsh.jsp";
	FormName.submit();
	return true;
}
function f_mx(FormName)//参数FormName:Form的名称
{
	FormName.action="Rs_ShEditpxjhmxList.jsp";
	FormName.submit();
	return true;
}
