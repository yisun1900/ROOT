...
//从流程控制里读取，下一流程状态
	...
	ls_sql="insert into rs_pxsh ( shbh,shjl,shyj,shr,shsj,pxjhbh,yjhzt,yshjl,yshyj,yshr,yshsj,yztbm,yshbh ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
