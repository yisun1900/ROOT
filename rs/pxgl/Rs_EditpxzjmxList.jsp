...
<%
String jhbh=cf.GB2Uni(request.getParameter("wherepxjhbh"));
%>
<%
...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String wheresql="";
	String pxjhbh=null;
	pxjhbh=request.getParameter("wherepxjhbh");
	if (pxjhbh!=null)
	{
    ...
    ls_sql+=" where rs_pxjhmx.skxs=rs_pxskxsbm.skxs and rs_pxjhmx.kclx=rs_pxkclxbm.kclx and mxwc is null";
    ls_sql+=wheresql;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_pxjhmxList.jsp","","","InsertRs_pxzjmx.jsp");
...
<CENTER >
  <b><font size="3" color=black>培训计划编号（<%=jhbh%>）</font></b>
</CENTER>
<%
	pageObj.out=out;
