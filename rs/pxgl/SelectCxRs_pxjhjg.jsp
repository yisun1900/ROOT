...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_pxjhjgCxList.jsp" name="selectform">
<div align="center">培训结果查询</div>
...
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><font color=red>培训计划名称</font></td> 
  <td width="35%"> 
    <input type="text" name="pxjhmc" size="20" maxlength="50" >
  </td>
  <td align="right" width="15%"><font color=red>计划结果</font></td> 
  <td width="35%"> 
