...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and rs_ygbdsqb.clzt in('00','01')";
    ls_sql+=wheresql;
	ls_sql+=" order by rs_ygbdsqb.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_ygydspbList.jsp","SelectRs_ygydspb.jsp","","EditRs_ygbdsqb.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRs_ygydspb.jsp"};//按钮单击调用的网页，可以增加参数
