...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" FROM rs_ygbdsqb,sq_dwxx a,sq_dwxx b,sq_dwxx c,rs_ztbm,sq_yhxx,rs_shjlbm,rs_bdsh  ";
    ...
    ls_sql+=" and rs_ygbdsqb.spxh=rs_bdsh.spxh";

	if ( !yhjs.equals("A0") && !yhjs.equals("A1") )
	{
		ls_sql+=" and  (rs_ygbdsqb.fgsbh='"+ssfgs+"')";
	}
	
	ls_sql+=" and rs_ygbdsqb.shr='"+yhmc+"'";
	ls_sql+=" and rs_bdsh.yztbm='"+ztbm+"'";
...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_ygbdsqbXgSpList.jsp","","","XgSpRs_ygbdsqb.jsp?ztbm="+ztbm);
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteSpRs_ygbdsqb.jsp?ztbm="+ztbm};//按钮单击调用的网页，可以增加参数
...
<CENTER >
  <B><font size="3">人事变动－修改审批</font></B>
</CENTER>
<%
	pageObj.out=out;
