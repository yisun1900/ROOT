...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT b.dwmc fgs,a.dwmc bm,xzzwbm,DECODE(sq_yhxx.sfzszg,'M','<font color=\"#009999\">实习生</font>','Y','转正','N','<font color=\"#0000CC\">试用期</font>','D','<font color=\"#CCCC00\">待岗</font>','S','<font color=\"#CC0000\">辞职</font>','T','<font color=\"#CC00CC\">辞退</font>'),sq_yhxx.yhmc,sq_yhxx.ygbh, DECODE(sq_yhxx.xb,'M','男','W','女'),sq_yhxx.csrq,sq_yhxx.sfzh,sq_yhxx.hjszd,sq_yhxx.rzsj,sq_yhxx.lrsj,sq_yhxx.bz ";
