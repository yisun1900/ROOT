...
<CENTER >
  ...
  <table width="<%=(dwflsl+qxflsl)*50+800%>" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr align="center" bgcolor="#CCCCCC"> 
      <td  width="40"  rowspan="3" >序号</td>
      <td  width="60"  rowspan="3">大区</td>
      <td  width="120"  rowspan="3">分公司</td>
...
//			ls_sql+=" and rzsj<=TO_DATE('"+sjfw2+"','YYYY-MM-DD')";
			...
			%>
			<tr align="center" <%if(row%2==0){out.print(" bgcolor=\"#FFFFFF\"");} else {out.print(" bgcolor=\"#ccccee\"");}%>> 
			  <td ><%=row%></td>
			  <td ><%=ssdqmc%></td>
			  <td ><%=fgsmc%></td>
			  <td ><%=ycrs%></td>
			  ...
			  <%
				...
				while (rs2.next())
				{
					...
					ls_sql=" select distinct xzzwbm from rs_yhxxqmjz";
...
%>
    <tr align="center" bgcolor="#E8E8FF"> 
      <td colspan="3" ><font color="red"><B>『<%=ssdqmc%>』合计</B></font></td>
...
%>
    ...
    <tr align="center" bgcolor="#CCCCCC"> 
      <td colspan="3" ><font color=red><B>总 计</B></font></td>
