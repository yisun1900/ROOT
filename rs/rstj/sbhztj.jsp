...
<%
	...
	ls_sql="SELECT count(*)";
	ls_sql+=" FROM sq_yhxx,rs_ygsbxx";
	ls_sql+=" where sq_yhxx.ygbh=rs_ygsbxx.ygbh and sq_yhxx.sfzszg in('Y','N') and sfzszg in ('Y','N') and sfcjbx='Y'";
	ls_sql+=wheresql;
	...
	while (rs.next())
	{
		...
		ls_sql+=" FROM sq_yhxx,rs_ygsbxx";
		ls_sql+=" where sq_yhxx.ygbh=rs_ygsbxx.ygbh and sq_yhxx.sfzszg in('Y','N') and sfzszg in ('Y','N') and rs_ygsbxx.sfcjbx='Y' and ssfgs='"+dwbh+"'";
		ls_sql+=wheresql;
