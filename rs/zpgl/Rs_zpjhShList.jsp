...
try {
	...
	ls_sql="SELECT rs_zpsq.zpsqbh zpsqbh,a.dwmc fgs,b.dwmc sqbm,dm_xzzwbm.xzzwmc zbzw,zprs,zpfy,DECODE(zbly,'0','其他','1','缺员补充','2','扩大编制','3','储备人力') zbly,TO_CHAR(xwdgsj,'YYYY-MM-DD') xwdgsj,rygznr,rs_ztbm.ztmc ztbm,lrr,c.dwmc ssfgs,TO_CHAR(lrsj,'YYYY-MM-DD') lrsj ";
...
<div style='FONT-SIZE: 12px'><font color=red>注意不要重复审核！</font></div>
</body>
</html>
