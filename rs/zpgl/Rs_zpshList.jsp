...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rs_zpsh.shbh shbh,rs_zpsh.zpsqbh zpsqbh,rs_ztbm.ztmc ztbm,DECODE(rs_zpsh.shjl,'0','取消申请','1','审核通过')  shjl,rs_zpsh.shr shr,rs_zpsh.shsj shsj,rs_zpsh.shyj shyj ";
	ls_sql+=" FROM rs_zpsh,rs_zpsq,rs_ztbm  ";
    ls_sql+=" where  rs_zpsq.shbh=rs_zpsh.shbh and rs_zpsq.sqzt!='05' and rs_ztbm.ztbm=rs_zpsh.yztbm";
	ls_sql+=wheresql;
...
/*
//设置显示列
	String[] disColName={"shbh","zpsqbh","shjl","shr","shsj"};
