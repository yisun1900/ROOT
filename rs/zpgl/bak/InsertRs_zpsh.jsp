...
try {
	...
	ls_sql="SELECT rs_zpsh.shbh shbh,rs_zpsh.zpjhbh zpjhbh,rs_ztbm.ztmc yztbm,rs_zpshbm.shjlmc shjl,rs_zpsh.shr shr,TO_CHAR(shsj,'YYYY-MM-DD') shsj,rs_zpsh.shyj shyj ";
	ls_sql+=" FROM rs_zpsh,rs_zpshbm,rs_ztbm  ";
    ls_sql+=" where rs_zpsh.shjl=rs_zpshbm.shjl and rs_ztbm.ztbm=rs_zpsh.yztbm and rs_zpsh.zpjhbh='"+zpjhbh+"'";
...
%> 
  <tr align="center" bgcolor="<%=ys%>">
    <td><%=row%></td>
    <td><A HREF="viewzpjhmx.jsp?zpjhbh=<%=jhbh%>" target="_blank"><%=jhbh%></A></td>
	<td><%=yztbm%></td>
    <td><%=shjl%></td>
    <td><%=shr%></td>
    <td><%=shsj%></td>
...
<div align="center">招聘计划审核</div>

<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFFFF">
  <td align="right" width="15%"><font color="#0000FF">计划编号</font></td> 
  <td width="35%"> 
    <input type="text" name="zpjhbh" value="<%=zpjhbh%>" size="20" maxlength="8" readonly>
  </td>
