...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (zpjhbh!=null)
	{
		...
		if (!(zpjhbh.equals("")))	wheresql+=" and  (rs_zpsh.zpjhbh='"+zpjhbh+"')";
	}
	...
	ls_sql="SELECT rs_zpsh.shbh shbh,rs_zpsh.zpjhbh zpjhbh,rs_zpshbm.shjlmc shjl,rs_zpsh.shr shr,rs_zpsh.shsj shsj,rs_zpsh.shyj shyj ";
	ls_sql+=" FROM rs_zpsh,rs_zpshbm,rs_zpjh  ";
    ls_sql+=" where rs_zpsh.shjl=rs_zpshbm.shjl and rs_zpjh.shbh=rs_zpsh.shbh and rs_zpjh.jhzt!='3'";
	ls_sql+=wheresql;
...
//	out.print(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_zpshList.jsp","SelectRs_zpsh.jsp","","EditRs_zpsh.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数
/*
//设置显示列
	String[] disColName={"shbh","zpjhbh","shjl","shr","shsj"};
...
//		sql[0]="delete from rs_zpsh where "+chooseitem;
