...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT zpjhbh,zprs,zpfy,a.dwmc fgs,DECODE(jhzt,'0','录入未完成','1','等待审批','2','审批流程中','3','招聘完成','4','审批未通过','5','修改计划','6','审核完成'),rs_ztbm.ztmc ztbm,rs_zpshbm.shjlmc shjl,jhkssj,jhjssj,lrr,b.dwmc ssfgs,lrsj,rs_zpjh.bz bz ";
...
//进行对象初始化
	pageObj.initPage("Rs_zpjhCxList.jsp","SelectCxRs_zpjh.jsp","","");
