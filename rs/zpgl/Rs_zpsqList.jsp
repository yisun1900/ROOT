...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT zpsqbh,a.dwmc fgs,b.dwmc sqbm,dm_xzzwbm.xzzwmc zbzw,zprs,zpfy, DECODE(zbly,'0','其他','1','缺员补充','2','扩大编制','3','储备人力'),zbqt,xwdgsj, DECODE(xbyq,'0','不限','1','男','2','女'), DECODE(hyyq,'0','不限','1','已婚','2','未婚'),nlyq, DECODE(xl,'0','高中','1','大专','2','大学','3','硕士'),zy,wy,jsjnl,gzjy,gx,jn,qt,rygznr, DECODE(rs_zpsq.sqzt,'01','等待审批','02','正在审批','03','审批取消','04','开始招聘','05','招聘结束'),rs_ztbm.ztmc ztbm,lrr,lrsj,c.dwmc ssfgs,rs_zpsq.bz  ";
...
//设置按钮参数
	...
	String[] buttonLink={"Rs_zpsqList.jsp?"};//按钮单击调用的网页，可以增加参数
