...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditWcRs_zpsq.jsp" name="editform">
<div align="center">修改招聘结果</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="35%"> 
    <input type="text" name="zpjglrr" size="20" maxlength="20"  value="<%=zpjglrr%>" readonly>  </td>
  <td align="right" width="15%"><span class="STYLE1">结果录入时间</span></td> 
  <td width="35%"> 
    <input type="text" name="zpjglsj" size="20" maxlength="10"  value="<%=zpjglsj%>" readonly>  </td>
</tr>
