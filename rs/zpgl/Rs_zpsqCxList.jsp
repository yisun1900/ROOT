...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT zpsqbh,a.dwmc fgs,b.dwmc sqbm,dm_xzzwbm.xzzwmc zbzw,zprs,zpfy, DECODE(zbly,'0','其他','1','缺员补充','2','扩大编制','3','储备人力'),zbqt,xwdgsj, DECODE(rs_zpsq.sqzt,'01','等待审批','02','正在审批','03','审批取消','04','开始招聘','05','招聘结束'),rs_zpsq.lrr,rs_zpsq.lrsj,c.dwmc ssfgs  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_zpsqCxList.jsp","SelectCxRs_zpsq.jsp","","");
