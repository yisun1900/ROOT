...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_zpsqList.jsp" name="selectform">
<div align="center">招聘申请查询条件</div>
<table width="100%" border="1" style="FONT-SIZE:12" bordercolor="#FFFFFF" bordercolorlight="#666666" bgcolor="#E0E0E0">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><input type="text" name="zpsqbh" size="20" maxlength="10" >
    </td>
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><select name="fgs" style="FONT-SIZE:12PX;WIDTH:152PX" onChange="selectItem(fgs,sqbm,<%=dwstr%>)">
      <%
...
%>
    ...
    <td width="35%"><select name="sqbm" style="FONT-SIZE:12PX;WIDTH:152PX">
      <%
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		out.println("<option value=\"\"></option>");
...
%>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><input type="text" name="zprs" size="20" maxlength="8" >
    </td>
    <td align="right" width="15%">招聘费用</td>
    <td width="35%"><input type="text" name="zpfy" size="20" maxlength="9" >
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">增补理由</td>
    <td width="35%"><select name="zbly" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <%
...
%>
    ...
    <td width="35%"><input type="text" name="zbqt" size="20" maxlength="20" >
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><select name="xbyq" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <%
...
%>
    ...
    <td width="35%"><select name="hyyq" style="FONT-SIZE:12PX;WIDTH:152PX">
      <option value=""></option>
      <%
...
%>
    ...
    <td width="35%"><input type="text" name="nlyq" size="20" maxlength="50" >
    </td>	
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">专业要求</td>
    <td width="35%"><input type="text" name="zy" size="20" maxlength="50" >
    </td>  
    <td align="right" width="15%">工作经验要求</td>
    <td width="35%"><input type="text" name="gzjy" size="20" maxlength="50" >
    </td>
  </tr>  
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">外语能力要求</td>
    <td width="35%"><input type="text" name="wy" size="20" maxlength="50" >
    </td>
    <td align="right" width="15%">计算机能力要求</td>
    <td width="35%"><input type="text" name="jsjnl" size="20" maxlength="50" >
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">技能要求</td>
    <td width="35%"><input type="text" name="jn" size="20" maxlength="50" >
    </td>
    <td align="right" width="15%">个性要求</td>
    <td width="35%"><input type="text" name="gx" size="20" maxlength="50" >
    </td>	
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">其他要求</td>
    <td width="35%"><input type="text" name="qt" size="20" maxlength="200" >
    </td>  
    <td align="right" width="15%">招聘申请状态</td>
    <td width="35%"><select name="sqzt" style="FONT-SIZE:12PX;WIDTH:152PX">
      <%
	cf.selectToken(out,"01+等待审批","");
%>
    </select>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right" width="15%">工作职责</td>
    <td width="35%" colspan="3">
	<input type="text" name="rygznr" size="72" maxlength="10" >
    </td>	 
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="35%"><input type="text" name="lrr" size="20" maxlength="20" >
    </td>
