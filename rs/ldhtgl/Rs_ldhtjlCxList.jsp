...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
		lx=cf.GB2Uni(lx);
		if (!(lx.equals("")))	wheresql+=" and  (rs_ldhtjl.lx='"+lx+"')";
	}
	...
	ls_sql="SELECT DECODE(lx,'1','新签','2','续签'),rs_ldhtjl.ldhtbh,rs_ldhtjl.ldhtlx,rs_ldhtjl.ldhtqx,rs_ldhtjl.htksrq,rs_ldhtjl.htdqrq,rs_ldhtjl.ygbh,rs_ldhtjl.yhmc,rs_ldhtjl.bianhao,rs_ldhtjl.sfzh,rs_ldhtjl.xzzwbm,a.dwmc ssbm,b.dwmc ssfgs,rs_ldhtjl.rzsj,rs_ldhtjl.lrr,rs_ldhtjl.lrsj,c.dwmc lrbm,rs_ldhtjl.bz  ";
	ls_sql+=" FROM rs_ldhtjl,sq_dwxx a,sq_dwxx b,sq_dwxx c  ";
    ls_sql+=" where rs_ldhtjl.dwbh=a.dwbh(+) and rs_ldhtjl.ssfgs=b.dwbh(+) and rs_ldhtjl.dwbh=c.dwbh(+)";
    ls_sql+=wheresql;
