...
String yldhtbh=cf.GB2Uni(request.getParameter("yldhtbh"));
...
try {
	...
	ls_sql="insert into rs_ldhtjl ( ldhtbh,ygbh,yhmc,bianhao,sfzh,xzzwbm,dwbh,ssfgs,rzsj,ldhtlx,ldhtqx,htksrq,htdqrq,lrr,lrsj,lrbm,bz,lx,yldhtbh ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ";
	...
	ps.setString(17,bz);
	ps.setString(18,lx);//1：新签；2：续签
	ps.setString(19,yldhtbh);
	ps.executeUpdate();
	ps.close();
