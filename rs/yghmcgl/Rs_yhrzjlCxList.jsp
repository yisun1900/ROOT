...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rs_yhrzjl.xh,DECODE(lx,'1','新入职','2','重新入职'),sqxh,rs_yhrzjl.ygbh,rs_yhrzjl.yhmc,rs_yhrzjl.bianhao,rs_yhrzjl.sfzh,dm_xzzwbm.xzzwmc,rs_yhrzjl.rzsj,rs_yhrzjl.rzcs,a.dwmc ssdw,b.dwmc ssfgs,rs_yhrzjl.lrr,rs_yhrzjl.lrsj  ";
