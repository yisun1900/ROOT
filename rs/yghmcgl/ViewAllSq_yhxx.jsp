...
<body bgcolor="#FFFFFF">
<div align="center"> 员工登记表（员工序号：<%=ygbh%>）</div>
...
%> </td>
  ...
  <tr bgcolor="#E0F5FF"> 
    ...
    <td width="15%"><%=sg%> <span class="STYLE1">(cm)</span></td>
...
%></td>
  ...
  <tr > 
    <td width="10%" align="right" class="STYLE1"> 工资类别 </td>
    <td width="15%"><%
	cf.selectToken(out,"1+固定工资&2+浮动工资",gzlb,true);
%> </td>
    <td width="10%" align="right" class="STYLE1">基本工资</td>
    <td width="15%"><%=jbgz%></td>
    <td width="10%" align="right" class="STYLE1">岗位工资</td>
    <td width="15%"><%=gwgz%></td>
    <td width="10%" align="right" class="STYLE1">工龄工资</td>
    <td width="15%"><%=glgz%></td>
  </tr>
  <tr > 
    <td width="10%" align="right" class="STYLE1">交通补贴</td>
    <td width="15%"><%=jtbt%></td>
    <td width="10%" align="right" class="STYLE1">电话补贴</td>
    <td width="15%"><%=dhbt%></td>
    <td width="10%" align="right" class="STYLE1">餐饮补贴</td>
    <td width="15%"><%=cb%></td>
    <td width="10%" align="right" class="STYLE1">其它补贴</td>
    <td width="15%"><%=buzhu%></td>
  </tr>
  <tr > 
    <td width="10%" align="right" class="STYLE1">绩效工资基数</td>
    <td width="15%"><%=khgz%></td>
    <td width="10%" align="right" class="STYLE1">考勤号码</td>
    <td width="15%"><%=kqhm%></td>
    <td width="10%" align="right" class="STYLE1">&nbsp;</td>
    <td width="15%">&nbsp;</td>
    <td width="10%" align="right" class="STYLE1">&nbsp;</td>
