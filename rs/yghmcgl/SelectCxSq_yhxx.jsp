...
<form method="post" action="" name="selectform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr align="center"> 
              <td colspan="4"> 
                <input type="button"  value="查询员工信息" onClick="f_do(selectform,'cxhmc')">
                <input type="button"  value="查询通讯录" onClick="f_do(selectform,'cxtxl')" >
                <input type="reset"  value="员工花名册" onClick="f_do(selectform,'cxrymd')">
            ...
            <tr bgcolor="#FFFFCC"> 
              ...
              <td colspan="3"> 第一列 
                ...
                <select name="tj1" style="FONT-SIZE:12PX;WIDTH:100PX" onChange="tj1name.value=tj1.options[tj1.selectedIndex].text">
                  ...
                  <option value="sq_yhxx.xzzwbm">行政职务</option>
                  <option value="DECODE(sq_yhxx.kdlxtbz,'Y','是','N','否')">可登陆</option>
                  <option value="DECODE(sq_yhxx.yhjs,'A0','总部','A1','总部部门','F0','分公司','F1','分公司部门','F2','分公司店面','F3','设计室','G0','供应商','J0','加盟商')">用户角色</option>
                  ...
                  <option value="DECODE(sq_yhxx.xb,'M','男','W','女')">性别</option>
                  <option value="DECODE(sq_yhxx.hf,'Y','是','N','否')">婚否</option>
                  <option value="DECODE(sq_yhxx.sfzszg,'M','实习生','Y','转正','N','试用期','D','待岗','S','辞职','T','辞退')">员工状态</option>
                  <option value="DECODE(sq_yhxx.gzlb,'1','固定工资','2','浮动工资')">工资类别</option>
                  <option value="sq_yhxx.xzzwbm">行政职务</option>
