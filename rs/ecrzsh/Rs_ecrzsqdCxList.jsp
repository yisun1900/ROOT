...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rs_ecrzsqd.sqxh,DECODE(rs_ecrzsqd.clzt,'00','不需审批','01','等待审批','02','正在审批','03','审批通过','04','审批取消','05','已入职'),ztmc,a.dwmc fgsbh,rs_ecrzsqd.ygbh,rs_ecrzsqd.yhmc, DECODE(rs_ecrzsqd.xb,'M','男','W','女'),b.dwmc yfgsbh,c.dwmc ydwbh,rs_ecrzsqd.yxzzwbm,rs_ecrzsqd.yrzsj,rs_ecrzsqd.ylzrq,rs_ecrzsqd.ylzyy,d.dwmc xdwbh,rs_ecrzsqd.xxzzwbm,rs_ecrzsqd.xrzyy,rs_ecrzsqd.sqrq,rs_ecrzsqd.lrr,rs_ecrzsqd.lrsj,e.dwmc lrbm,rs_ecrzsqd.bz,rs_ecrzsqd.spxh,rs_ecrzsqd.shr,rs_ecrzsqd.shsj,shjlmc,rs_ecrzsqd.shyj";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_ecrzsqdCxList.jsp","SelectCxRs_ecrzsqd.jsp","","");
