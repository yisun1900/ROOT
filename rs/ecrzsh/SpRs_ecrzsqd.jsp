...
<form method="post" action="SaveSpRs_ecrzsqd.jsp" name="editform">
  <div align="center">
    重新入职申请审批（申请序号：<%=sqxh%>）
    <BR>
    <b><font color="#FF0000">提醒！审批通过后，请到『</font>人事管理－>员工管理－>入职－>入职<font color="#FF0000">』中做重新入职</font></b> 
  </div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%"><font color="#0000CC">申请二次入职部门</font></td>
      <td width="32%"> <%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwbh='"+xdwbh+"'",xdwbh,true);
%> </td>
      <td align="right" width="18%"><font color="#0000CC">申请二次入职职位</font></td>
      <td width="32%"><%=xxzzwbm%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%"><font color="#0000CC">二次入职原因</font></td>
