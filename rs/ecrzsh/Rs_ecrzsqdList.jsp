...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and rs_ecrzsqd.shjl=rs_shjlbm.shjl(+) and rs_ecrzsqd.clzt in('00','01')";
    ls_sql+=wheresql;
    ls_sql+=" order by rs_ecrzsqd.lrsj desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_ecrzsqdList.jsp","SelectRs_ecrzsqd.jsp","","EditRs_ecrzsqd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteRs_ecrzsqd.jsp?"};//按钮单击调用的网页，可以增加参数
