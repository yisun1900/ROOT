...
<form method="post" action="SaveInsertRs_qjsqd.jsp" name="insertform" target="_blank">
  <div align="center">请假申请</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font><font color="#0000CC">申请序号</font></td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <select name="qjlx" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
	cf.selectItem(out,"select qjlx,qjlxmc from rs_qjlx order by qjlx","");
%> 
        </select>
      </td>
      <td align="right" width="20%"><font color="#CC0000">*</font>请假期间联系电话</td>
      <td width="30%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="20%"><font color="#CC0000">*</font>截至时间</td>
      <td width="30%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td align="right" width="20%"><font color="#CC0000">*</font>请假期间职务代理人</td>
      <td width="30%"> 
