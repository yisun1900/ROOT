...
try {
	...
	ls_sql="select fgsbh,dwbh,ygbh,yhmc,xb,xzzwbm,kssj,jzsj,ljts,yysm,lrr,lrsj,lrbm,bz,sqrq,clzt,ztbm,shjl,shyj,spxh,qjlx,lxdh,zwdlr ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSpRs_qjsqd.jsp" name="editform">
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">请假类型</font></td>
      <td width="33%"> <%
	cf.selectItem(out,"select qjlx,qjlxmc from rs_qjlx order by qjlx",qjlx,true);
%> </td>
      <td align="right" width="19%"><font color="#0000CC">请假期间联系电话</font></td>
      <td width="31%"><%=lxdh%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">开始时间</font></td>
      <td width="33%"><%=kssj%> </td>
      <td align="right" width="19%"><font color="#0000CC">截至时间</font></td>
      <td width="31%"><%=jzsj%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%"><font color="#0000CC">累计天数</font></td>
      <td width="33%"><%=ljts%> </td>
      <td align="right" width="19%"><font color="#0000CC">请假期间职务代理人</font></td>
      <td width="31%"><%=zwdlr%></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
