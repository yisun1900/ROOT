...
try {
	...
	ls_sql="insert into rs_qjsqd ( sqxh,fgsbh,dwbh,ygbh,yhmc,xb,xzzwbm,kssj,jzsj,ljts   ,yysm,sqrq,lrr,lrsj,lrbm,bz,clzt,ztbm,qjlx,lxdh,zwdlr ) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?  ,?,?,?,?,?,?,'01','1001',?,?,? ) ";
	...
	ps.setString(16,bz);
	ps.setString(17,qjlx);
	ps.setString(18,lxdh);
	ps.setString(19,zwdlr);
