...
try {
	...
	ls_sql="select fgsbh,dwbh,ygbh,yhmc,xb,xzzwbm,kssj,jzsj,ljts,yysm,lrr,lrsj,lrbm,bz,sqrq,qjlx,lxdh,zwdlr ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditRs_qjsqd.jsp" name="editform">
  <div align="center">修改申请（申请序号：<%=sqxh%>）</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#0000CC">员工序号</font></td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#0000CC">性别</font></td>
      <td width="31%"> <%
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font><font color="#0000CC">所属分公司</font></td>
      <td width="31%"> 
...
%> 
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right" width="19%"><font color="#CC0000">*</font>请假类型</td>
      <td width="31%"> 
        <select name="qjlx" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
	cf.selectItem(out,"select qjlx,qjlxmc from rs_qjlx order by qjlx",qjlx);
%> 
        </select>
      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>请假期间联系电话</td>
      <td width="31%"> 
        <input type="text" name="lxdh" value="<%=lxdh%>" size="20" maxlength="50" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>开始时间</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>累计天数</td>
      <td width="31%"> 
        <input type="text" name="ljts" value="<%=ljts%>" size="20" maxlength="10">
      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>请假期间职务代理人</td>
      <td width="31%"> 
        <input type="text" name="zwdlr" value="<%=zwdlr%>" size="20" maxlength="50" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>原因说明</td>
      <td colspan="3"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	javaTrim(FormName.qjlx)=="") {
		alert("请选择[请假类型]！");
		FormName.qjlx.select();
		return false;
	}
	if(	javaTrim(FormName.lxdh)=="") {
		alert("请选择[请假期间联系电话]！");
		FormName.lxdh.select();
		return false;
	}
