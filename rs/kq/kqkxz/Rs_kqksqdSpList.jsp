...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ztbm!=null)
	{
		if (!(ztbm.equals("")))	wheresql+=" and  (rs_kqksqd.ztbm='"+ztbm+"')";
	}

	if ( !yhjs.equals("A0") && !yhjs.equals("A1") )
	{
		wheresql+=" and  (rs_kqksqd.fgsbh='"+ssfgs+"')";
	}

	ls_sql="SELECT rs_kqksqd.sqxh,rs_kqksqd.ztbm,DECODE(rs_kqksqd.clzt,'01','等待审批','02','正在审批','03','审批通过','04','审批取消') clzt,ztmc,a.dwmc fgsbh,rs_kqksqd.ygbh,rs_kqksqd.yhmc, DECODE(rs_kqksqd.xb,'M','男','W','女') xb,b.dwmc dwbh,rs_kqksqd.xzzwbm,rs_kqksqd.kssj,rs_kqksqd.jzsj,rs_kqksqd.ljts,rs_kqksqd.yysm,rs_kqksqd.sqrq,rs_kqksqd.lrr,rs_kqksqd.lrsj,c.dwmc lrbm,rs_kqksqd.bz,rs_kqksqd.spxh,rs_kqksqd.shr,rs_kqksqd.shsj,shjlmc";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_kqksqdSpList.jsp","","","SpRs_kqksqd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"PlSpRs_kqksqd.jsp?"};//按钮单击调用的网页，可以增加参数
