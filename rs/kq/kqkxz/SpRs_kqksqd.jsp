...
try {
	...
	ls_sql="select fgsbh,dwbh,ygbh,yhmc,xb,xzzwbm,kssj,jzsj,ljts,yysm,lrr,lrsj,lrbm,bz,sqrq,clzt,ztbm ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveSpRs_kqksqd.jsp" name="editform">
  <div align="center">考勤卡修正申请审批（申请序号：<%=sqxh%>）</div>
