...
try {
	...
	ls_sql="select fgsbh,dwbh,ygbh,yhmc,xb,xzzwbm,kssj,jzsj,ljts,yysm,lrr,lrsj,lrbm,bz,sqrq,clzt,ztbm,shjl,shyj,spxh,txzsm,jtgj,zwdlr,xcsm,btbz,zsbz ";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSpRs_ccsqd.jsp" name="editform">
