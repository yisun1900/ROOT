...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_ccsqdCxList.jsp" name="selectform">
  <div align="center">查询出差申请</div>
...
%> 
      ...
      <td width="32%"> 
        <select name="rs_ccsqd_ztbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
	cf.selectItem(out,"select ztbm,ztmc from rs_ztbm where ztlx='11' order by ztbm","");
%> 
        </select>
      </td>
    </tr>
