...
<body bgcolor="#FFFFFF">
<form method="post" action="Rs_jbsqdList.jsp" name="selectform">
...
<%
	...
	if (yhjs.equals("A0"))
	{
        ...
        out.println("        <select name=\"rs_jbsqd_fgsbh\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" onChange=\"selectItem(rs_jbsqd_fgsbh,rs_jbsqd_dwbh,"+dwstr+");\">");
		out.println("<option value=\"\"></option>");
		cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwlx in('A0','F0') order by dwbh","");
        out.println("        </select>");
	}
	else{
        out.println("        <select name=\"rs_jbsqd_fgsbh\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" >");
...
%>
      ...
      <td width="32%"> 
        <select name="rs_jbsqd_dwbh" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	if (yhjs.equals("A0"))
	{
		out.println("<option value=\"\"></option>");
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> <%
	cf.radioToken(out, "rs_jbsqd_xb","M+男&W+女","");
%> </td>
      <td align="right" width="18%">职务</td>
      <td width="32%"> 
        <select name="rs_jbsqd_xzzwbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="rs_jbsqd_sqxh" size="20" maxlength="10" >
      </td>
...
<%
	...
	{
		%>
        <input type="text" name="rs_jbsqd_lrr" size="20" maxlength="20" >
		<%
	}
	else if (yhjs.equals("A1") && dwflbm.equals("04"))//04：人事部
	{
	...
	else if ( (yhjs.equals("F0") || yhjs.equals("F1")) && dwflbm.equals("04"))//04：人事部
	{
		...
		%>
        <input type="text" name="rs_jbsqd_lrr" size="20" maxlength="20" value="<%=yhmc%>" readonly >
		<%
	}
%>
      </td>
      ...
      <td width="32%"> 
        <select name="rs_jbsqd_lrbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <select name="rs_jbsqd_clzt" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value="01">等待审批</option>
        </select>
      </td>
      <td align="right" width="18%">审批状态</td>
      <td width="32%"> 
        <select name="rs_jbsqd_ztbm" style="FONT-SIZE:12PX;WIDTH:152PX">
          <%
	cf.selectItem(out,"select ztbm,ztmc from rs_ztbm where ztbm='0801'","");
%> 
        </select>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="rs_jbsqd_spxh" size="20" maxlength="16" >
      </td>
      <td align="right" width="18%">审核结论</td>
      <td width="32%"> 
        <select name="rs_jbsqd_shjl" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
...
%> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="33%"> 
        <input type="text" name="rs_jbsqd_shsj" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
      <td align="right" width="18%">到</td>
      <td width="32%"> 
        <input type="text" name="rs_jbsqd_shsj2" size="20" maxlength="10" onDblClick="JSCalendar(this)">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">审核人</td>
      <td width="33%"> 
        <input type="text" name="rs_jbsqd_shr" size="20" maxlength="20" >
      </td>
      <td align="right" width="18%">&nbsp;</td>
      <td width="32%">&nbsp; </td>
    </tr>
...
{
	if(!(isNumber(FormName.rs_jbsqd_ygbh, "员工序号"))) {
		return false;
	}

	if(!(isDatetime(FormName.rs_jbsqd_lrsj, "录入时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.rs_jbsqd_lrsj2, "录入时间"))) {
		return false;
	}
	...
	if(!(isNumber(FormName.rs_jbsqd_spxh, "审批序号"))) {
		return false;
	}
	if(!(isDatetime(FormName.rs_jbsqd_shsj, "审核时间"))) {
		return false;
	}
	if(!(isDatetime(FormName.rs_jbsqd_shsj2, "审核时间"))) {
		return false;
	}
	FormName.submit();
	return true;
