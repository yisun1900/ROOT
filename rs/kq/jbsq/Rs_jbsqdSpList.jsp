...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	if (ztbm!=null)
	{
		if (!(ztbm.equals("")))	wheresql+=" and  (rs_jbsqd.ztbm='"+ztbm+"')";
	}

	if ( !yhjs.equals("A0") && !yhjs.equals("A1") )
	{
		wheresql+=" and  (rs_jbsqd.fgsbh='"+ssfgs+"')";
	}

	ls_sql="SELECT rs_jbsqd.sqxh,rs_jbsqd.ztbm,DECODE(rs_jbsqd.clzt,'01','等待审批','02','正在审批','03','审批通过','04','审批取消') clzt,ztmc,a.dwmc fgsbh,rs_jbsqd.ygbh,rs_jbsqd.yhmc, DECODE(rs_jbsqd.xb,'M','男','W','女') xb,b.dwmc dwbh,rs_jbsqd.xzzwbm,rs_jbsqd.kssj,rs_jbsqd.jzsj,rs_jbsqd.ljts,rs_jbsqd.yysm,rs_jbsqd.sqrq,rs_jbsqd.lrr,rs_jbsqd.lrsj,c.dwmc lrbm,rs_jbsqd.bz,rs_jbsqd.spxh,rs_jbsqd.shr,rs_jbsqd.shsj,shjlmc";
	...
	ls_sql+=" and rs_ztbm.ztlx='08' and rs_ztbm.ztbm=rs_shsq.ztbm";
    ls_sql+=" ) ";

	ls_sql+=" order by rs_jbsqd.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Rs_jbsqdSpList.jsp","","","SpRs_jbsqd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"PlSpRs_jbsqd.jsp?"};//按钮单击调用的网页，可以增加参数
