...
//以上
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm,DECODE(zt,'2','家装','4','集成','5','设计','3','<font color=\"#FF00FF\">已退单</font>'),DECODE(crm_khxx.jzbz,'1','家装','2','公装'),crm_khxx.fwdz,ysgcjdmc,crm_khxx.sjkgrq,crm_khxx.sjjgrq,crm_khxx.bxkssj,crm_khxx.bxjzsj,crm_khxx.sjs,sgdmc sgd,crm_khxx.zjxm,DECODE(NVL(tgbz,'W'),'W','正常','N','<font color=\"#00FF00\">复工</font>','Y','<font color=\"#FF0000\">已停工</font>'),c.gcyszxmmc ybysxmbm,d.gcyszxmmc zqysxmbm,DECODE(crm_khxx.gcsfyq,'1','未延期','2','延期'),crm_khxx.yqts,zkl,a.dwmc qydm,crm_khxx.qyrq,crm_khxx.kgrq,jgrq,khlxmc";
...
//设置主键
	...
	String[] buttonLink={"dx_dxnr.jsp"};//按钮单击调用的网页，可以增加参数
