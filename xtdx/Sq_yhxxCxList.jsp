...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT b.dwmc fgs,a.dwmc bm,DECODE(sq_yhxx.sfzszg,'M','<font color=\"#009999\">实习生</font>','Y','转正','N','<font color=\"#0000CC\">试用期</font>','D','<font color=\"#CCCC00\">待岗</font>','S','<font color=\"#CC0000\">辞职</font>','T','<font color=\"#CC00CC\">辞退</font>'),sq_yhxx.bianhao,sq_yhxx.yhmc,sq_yhxx.xzzwbm,sq_yhxx.ygbh,dm_zwbm.zwmc, DECODE(sq_yhxx.yhjs,'A0','总部','A1','总部部门','F0','分公司','F1','分公司部门','F2','分公司店面','F3','设计室','G0','供应商','J0','加盟商'),sq_yhxx.sjsbh, DECODE(sq_yhxx.gzlb,'1','固定','2','浮动工资'),kqhm, DECODE(sq_yhxx.kdlxtbz,'Y','是','N','否'), DECODE(sq_yhxx.xb,'M','男','W','女'),sq_yhxx.csrq, DECODE(sq_yhxx.hf,'Y','是','N','否'),sq_yhxx.mz,sq_yhxx.sfzh,sq_yhxx.hjszd,sq_yhxx.dacfd,sq_yhxx.byyx,sq_yhxx.zy,dm_xlbm.xueli,DECODE(sq_yhxx.dhsfgb,'1','本公司内','2','不受限制','9','不公布'),sq_yhxx.dh,sq_yhxx.bgdh,sq_yhxx.jtdh,sq_yhxx.email,sq_yhxx.zz,sq_yhxx.cjgzsj,ROUND((SYSDATE-sq_yhxx.cjgzsj)/365,1)-sq_yhxx.wgzsj,sq_yhxx.rzsj,sq_yhxx.syjzrq,sq_yhxx.htksrq,sq_yhxx.htdqrq,sq_yhxx.lzrq, DECODE(sq_yhxx.sfqs,'Y','是','N','否'), DECODE(sq_yhxx.ylbx,'Y','是','N','否'), DECODE(sq_yhxx.jylbx,'Y','是','N','否'), DECODE(sq_yhxx.sybx,'Y','是','N','否'), DECODE(sq_yhxx.gsby,'Y','是','N','否'), DECODE(sq_yhxx.syx,'Y','是','N','否') ,sq_yhxx.shbxh,sq_yhxx.jbxdd,sq_yhxx.jjlxr,sq_yhxx.lxrdh,sq_yhxx.zkl, DECODE(sq_yhxx.ckjgbz,'Y','可看','N','不可'), DECODE(sq_yhxx.zdyhbz,'Y','是','N','否'), sq_yhxx.bjjb,sq_yhxx.glgz,sq_yhxx.gwgz,sq_yhxx.jbgz,rs_sjsjb.sjsjbmc,sq_yhxx.yjsxe,sq_yhxx.jtbt,sq_yhxx.cb,sq_yhxx.dhbt, DECODE(sq_yhxx.sfydbs,'Y','是','N','否'), DECODE(sq_yhxx.sfytj,'Y','是','N','否'),sq_yhxx.tjrq,sq_yhxx.qgzdw,sq_yhxx.lrsj,sq_yhxx.bz ";
...
//设置按钮参数
	String[] buttonName={"发送短信"};//按钮的显示名称
	String[] buttonLink={"dx_dxnryg.jsp"};//按钮单击调用的网页，可以增加参数
