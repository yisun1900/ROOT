...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_nbtsjl.tsjlh,DECODE(crm_nbtsjl.clzt,'1','未处理','2','在处理','3','已解决'),c.dwmc btsfgs,b.dwmc btsbm,crm_nbtsjl.btsr,crm_nbtsjl.tsnr,crm_nbtsjl.tsr,crm_nbtsjl.tssj,crm_nbtsjl.slr,crm_nbtsjl.slsj,a.dwmc slbm";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_nbtsjlClList.jsp","SelectClCrm_nbtsjl.jsp","","ClCrm_nbtsjl.jsp");
