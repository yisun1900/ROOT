...
<form method="post" action="Crm_nbtsjlCxList.jsp" name="selectform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right">被反馈分公司</td>
              <td width="34%"> <%
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right">反馈时间 从</td>
              <td width="34%"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              <td width="16%" align="right">处理人</td>
              <td width="34%">
