...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tsbmCfaList.jsp" name="selectform">
          
        <div align="center">投诉处理－出方案</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td width="18%" align="right" >责任部门处理状态</td>
      <td colspan="3" >
		<input type="radio" name="clzt" value="2" >已接收等待出方案
		<input type="radio" name="clzt" value="6" >已出现场等待方案
		<input type="radio" name="clzt" value="A" >方案审核未通过
	  </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
