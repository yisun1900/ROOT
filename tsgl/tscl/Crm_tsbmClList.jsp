...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.shr,crm_tsbm.shsj,crm_tsbm.jjfa,crm_tsbm.jhjjsj,crm_tsbm.sjcfasj";
...
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","shr","shsj","jhjjsj","sjcfasj","jjfa","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
