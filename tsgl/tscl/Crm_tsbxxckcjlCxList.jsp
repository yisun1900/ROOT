...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT  crm_tsbxxckcjl.kcjlh,crm_tsjl.tsjlh,crm_tsbm.zrr,crm_tsjl.khbh,tsxlmc,dm_slfsbm.slfsmc,crm_khxx.khxm";
	...
	ls_sql+=" ,crm_tsbm.sjcxcr,crm_tsbm.sjcxcsj,crm_tsbm.cxcsm,crm_tsbm.jhcfasj";

	ls_sql+=" FROM crm_tsjl,crm_khxx,dm_slfsbm,dm_tsxlbm,crm_tsbm,sq_dwxx,sq_sgd,crm_tsbxxckcjl ";
    ...
    ls_sql+=" and crm_tsbm.tsjlh=crm_tsbxxckcjl.tsjlh  ";
    ls_sql+=" and crm_tsbm.tsyybm=crm_tsbxxckcjl.tsyybm  ";
	ls_sql+=" and crm_tsjl.lx='1'";//1：投诉；2：报修
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.sjcxcsj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbxxckcjlCxList.jsp","","","");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "kcjlh","tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","sjcxcr","sjcxcsj","jhcfasj","cxcsm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">负责人</td>
	<td  width="7%">投诉原因</td>
	<td  width="3%">实际出现场人</td>
	<td  width="4%">实际出现场时间</td>
	<td  width="4%">计划出方案时间</td>
	<td  width="22%">出现场说明</td>
	<td  width="3%">设计师</td>
	<td  width="3%">施工队</td>
	<td  width="6%">投诉来源</td>
	<td  width="4%">受理时间</td>
