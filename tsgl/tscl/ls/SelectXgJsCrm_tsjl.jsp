...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tsjlXgJsList.jsp" name="selectform">
          
        <div align="center">接收投诉－修改</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <input type="text" name="fwdz" size="73" maxlength="100">      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right"> 
        房屋地址      </td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td ><input name="tsjlh" type="text" size="20" maxlength="10" ></td>
      <td  align="right">接收人</td>
      <td >
	  <select name="jsr" style="FONT-SIZE:12PX;WIDTH:152PX" >
		<%
			if (yhjs.equals("A0"))
			{
				out.println("<option value=\"\"></option>");
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right" bgcolor="#FFFFFF">投诉品牌</td>
      <td width="32%"> 
      <input type="text" name="crm_tsbm_tspp" size="20" maxlength="50" >      </td>
      <td width="18%" align="right">投诉品牌</td>
      <td width="32%"> 
...
function changeFgs(FormName) 
{
	...
	var sql;
	sql="select dwbh,dwmc from sq_dwxx where cxbz='N' and ssfgs='"+FormName.fgs.value+"' order by dwbh";
