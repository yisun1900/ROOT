...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,DECODE(crm_tsbm.clzt,'1','未接收','2','已接收等待出方案','D','已接收不需出方案','4','已出方案不需审核','6','已出方案需审核','7','等待出现场后出方案','8','已出现场方案不需审核','9','已出现场方案需审核','3','已解决','5','结案') as clzt,crm_khxx.sjs";
	...
	ls_sql+=" and crm_tsbm.clzt in('2','4','6','7')";//1：未接收；2：接收后直接出方案不需审核；4：接收后直接出方案需审核；6：已接收等待出方案；7：等待出现场后出方案；8：已出现场方案不需审核；9：已出现场方案需审核；3：已解决；5：结案
