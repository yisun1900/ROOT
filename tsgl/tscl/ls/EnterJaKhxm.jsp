            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="53%" valign="top" bgcolor="#FFFFFF"> 
                <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="1">
                  <tr bgcolor="#FFFFFF"> 
                    <td align="right" width="32%">客户姓名</td>
                    <td width="68%"> 
                  ...
                  <tr bgcolor="#FFFFFF"> 
                    <td align="right" width="32%">结案日期</td>
                    <td width="68%"> 
                      <input type="text" name="sjkgrq" size="16" maxlength="10"  onKeyUp="singleAdd(selectform)">
                    </td>
                  </tr>
                </table>
                <p>&nbsp; </p>
...
{               
	if (event.keyCode==13)//回车
	{
		...
		if(!(isDatetime(FormName.sjkgrq, "结案日期"))) {
			return false;
		}
...
function add(FormName)//参数FormName:Form的名称
{
	...
	op1.value=FormName.khxm.value+":"+FormName.sjkgrq.value;
	op1.text=FormName.khxmlist.options.length+1+":"+FormName.khxm.value+":"+FormName.sjkgrq.value;
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="JaKhxmList.jsp";
	FormName.submit();
	return true;
}
