...
%> </td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="18%"> 
      <div align="right"><font color="#006666">投诉来源</font></div>
    </td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="18%"> 
      <div align="right"><font color="#006666">投诉大类</font></div>
    </td>
    <td width="32%"><%=dm_tslxbm_tslxmc%> </td>
    <td width="17%"> 
      <div align="right"><font color="#006666">投诉小类</font></div>
    </td>
    <td width="33%"><%=dm_tsyybm_tsyymc%> </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width="18%" bgcolor="#FFFFFF" align="right"><font color="#006666">投诉内容</font></td>
...
%> 
	...
	while (rs.next())
	{
		...
		%> 
          <tr bgcolor="#FFFFFF"> 
			<td align="center" width="16%" ><%=hfsj%></td>
			<td width="58%" ><%=khhfqk%></td>
  ...
  <table width="100%" border="1" style="FONT-SIZE:12"  cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="4" height="36"> 
        <div align="center"><b>（<%=cldwmc%>）处理投诉回访反馈问题 </b></div>
      </td>
    </tr>
    <tr> 
