...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsjl.slsj desc,crm_tsjl.tsjlh,crm_tsbm.dwbh" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbmJsList.jsp","","","JsCrm_tsbm.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","zrbm","zrr","tsxlmc","khxm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
