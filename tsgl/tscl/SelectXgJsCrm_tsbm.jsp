...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tsbmXgJsList.jsp" name="selectform">
          
        <div align="center">投诉处理－接收－修改</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td width="18%" align="right" >责任部门处理状态</td>
      <td colspan="3" >
		<input type="radio" name="clzt" value="2" >已接收等待出方案
		<input type="radio" name="clzt" value="4" >已接收等待出现场
