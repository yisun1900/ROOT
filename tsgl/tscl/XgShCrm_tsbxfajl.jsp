...
try {
	...
	ls_sql+=" ,sfpfkh,sfnbcf,khpfze,nbcfze,jhjjsj,jjfa,sjcfar,sjcfasj,shsm";
...
<html>
<head>
<title>投诉处理－方案审核－修改</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">投诉处理－方案审核－修改（投诉记录号：<%=tsjlh%>） </div>
...
<form method="post" action="" name="editform"  >
        <div align="center"><b>投诉处理－方案审核－修改</b>（出方案记录号：<%=cfajlh%>）</div>
