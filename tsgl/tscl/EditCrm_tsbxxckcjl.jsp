...
try {
	...
	ls_sql+=" ,crm_tsbm.cxcsm,crm_tsbm.jhcfasj,crm_tsbm.jhcxcsj,crm_tsbm.sjcxcsj,crm_tsbm.sjcxcr,kcjlh";
	...
	if (rs.next())
	{
		...
		sjcxcr=cf.fillNull(rs.getString("sjcxcr"));
...
<html>
<head>
<title>投诉处理－出现场－修改</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">投诉处理－出现场－修改（投诉记录号：<%=tsjlh%>） </div>
...
<form method="post" action="SaveEditCrm_tsbxxckcjl.jsp" name="editform" target="_blank">
        <div align="center"><b>投诉处理－出现场－修改</b>（出现场记录号：<%=kcjlh%>）</div>
...
%> 
    ...
    <tr> 
      ...
      <td width="32%"> 
        <input type="text" name="cxcr" value="<%=sjcxcr%>" size="20" maxlength="20" >      </td>
      <td width="17%" align="right"><font color="#FF0000">*</font>出现场时间</td>
      <td width="33%"> 
        <input type="text" name="cxcsj" value="<%=sjcxcsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>现场情况</td>
      <td colspan="3"><textarea name="xcqk" cols="71" rows="9"><%=cxcsm%></textarea>      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
