...
<html>
<head>
<title>投诉处理－出方案</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">投诉处理－出方案（投诉记录号：<%=tsjlh%>） </div>
...
<form method="post" action="SaveInsertcrm_tsbxfajl.jsp" name="editform"  >
        <div align="center"><b>投诉处理－出方案</b>（出方案记录号：<%=cfajlh%>）</div>
...
%></td>
    ...
    <tr>
      ...
      <td><%
	cf.radioToken(out, "sfpfkh","1+不需赔付&2+需赔付","");
%></td>
...
%></td>
    ...
    <tr>
      ...
      <td><input type="text" name="khpfze" value="" size="20" maxlength="20" ></td>
