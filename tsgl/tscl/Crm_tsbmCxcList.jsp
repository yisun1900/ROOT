...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.jsr,crm_tsbm.jssj,crm_tsbm.jssm,crm_tsbm.jhcxcsj";
...
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","jsr","jssj","jhcxcsj","jssm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
