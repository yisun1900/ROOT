...
try {
	...
	ls_sql+=" ,sfpfkh,sfnbcf,khpfze,nbcfze,jhjjsj,jjfa,sjcfar,sjcfasj";
	...
	if (rs.next())
	{
		...
		sfpfkh=cf.fillNull(rs.getString("sfpfkh"));
...
<html>
<head>
<title>投诉处理－出方案－修改</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">投诉处理－出方案－修改（投诉记录号：<%=tsjlh%>） </div>
...
<table width="90%" border="1" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="0">
  <tr bgcolor="#FFFFFF" align="center"> 
	...
	<td width="6%"><strong>客户赔付总额</strong></td>
...
<form method="post" action="SaveEditCrm_tsbxfajl.jsp" name="editform"  >
        <div align="center"><b>投诉处理－出方案－修改</b>（出方案记录号：<%=cfajlh%>）</div>
...
%></td>
    ...
    <tr>
      <td align="right"><font color="#FF0000">*</font>是否赔付客户</td>
      <td><%
	cf.radioToken(out, "sfpfkh","1+不需赔付&2+需赔付",sfpfkh);
%></td>
...
%></td>
    ...
    <tr>
      ...
      <td><input type="text" name="khpfze" value="<%=khpfze%>" size="20" maxlength="20" ></td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(	!radioChecked(FormName.sfpfkh)) {
		alert("请选择[是否赔付客户]！");
		FormName.sfpfkh[0].focus();
		return false;
	}
	if (FormName.sfpfkh[1].checked)
	{
		...
		if(!(isFloat(FormName.khpfze, "客户赔付总额"))) {
			return false;
		}
	}
	else{
		FormName.khpfze.value="0";
	}
	...
	if (FormName.sfpfkh[1].checked || FormName.sfnbcf[1].checked)
	{
