...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.shr,crm_tsbm.shsj,crm_tsbm.shsm,crm_tsbm.jhjjsj";
	...
	ls_sql+=" and crm_tsbm.clzt in('9','A')";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.jhcxcsj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbxfajlXgShList.jsp","","","XgShCrm_tsbxfajl.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","shr","shsj","jhjjsj","shsm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
