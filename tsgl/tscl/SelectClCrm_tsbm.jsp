...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tsbmClList.jsp" name="selectform">
          
        <div align="center">投诉处理</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFCC"> 
      <td width="18%" align="right" >责任部门处理状态</td>
      <td colspan="3" >
		<input type="radio" name="clzt" value="9" >方案审核通过
		<input type="radio" name="clzt" value="8" >已出方案不需审核
		<input type="radio" name="clzt" value="D" >已接收不需出方案
		<input type="radio" name="clzt" value="B" >在处理
		<input type="radio" name="clzt" value="C" >回访未解决
	  </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
