...
try {
	...
	ls_sql="select sfxnbgz,nbgzsj,tsbxsj,lrr,lrsj,zrbmclzt,slsj,tsnr,slbm,crm_tsjl.bz,yzcdbm,slfsbm,khbh,crm_tsjl.sfxhf,crm_tsjl.hfsj,slr,clzt,crm_tsjl.yqjjsj";
	...
	if (dzyy>0)
	{
		txxx="<BR><font color=\"#FF0000\">（注意：["+lrr+"]录入了多种原因，请点击按钮『查看投诉原因』，确认是否正确）</font>";
	}
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%" height="22"> 
      <div align="center">受理－－非客服登记的投诉信息（投诉记录号：<%=tsjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> </td>
          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#E8E8FF" align="center"> 
              <td colspan="4" height="26"><b>下述为[<%=lrr%>]录入的投诉信息</b></td>
            </tr>
            <tr bgcolor="#E8E8FF"> 
...
%> 
            ...
            <tr bgcolor="#FFFFCC" align="center"> 
              <td colspan="4" height="31"><b><font color="#0000FF">＋＋请注意下述信息是否正确＋＋</font><%=txxx%></b></td>
            </tr>
            <tr bgcolor="#FFFFCC"> 
