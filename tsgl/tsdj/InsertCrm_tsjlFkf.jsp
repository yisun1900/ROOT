...
%> </td>
          ...
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%"> 
                <div align="right"><font color="#FF0033">*</font>投诉来源</div>              </td>
              <td width="31%"> 
...
%> 
              ...
              <td width="14%"> 
                <div align="right"><font color="#FF0033">*</font>客户投诉时间</div>              </td>
              <td width="38%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="14%" align="right"><font color="#FF0033">*</font><font color="#0000CC">录入时间</font></td>
              <td width="38%"> 
...
%> 
              ...
              <td width="14%" align="right">要求解决时间</td>
              <td width="38%"> 
...
%> 
              ...
              <td width="14%" rowspan="5" align="right" valign="top">涉及厂商</td>
