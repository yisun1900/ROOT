...
try {
	...
	ls_sql="select sfxnbgz,nbgzsj,kszy,khldcs,sfxtz,tsbxsj,lrr,lrsj,zrbmclzt,slsj,tsnr,slbm,crm_tsjl.bz,yzcdbm,slfsbm,khbh,crm_tsjl.sfxhf,crm_tsjl.hfsj,slr,clzt,crm_tsjl.yqjjsj";
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%" height="22"> 
      <div align="center"> 请修改客户投诉信息（投诉记录号：<%=tsjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"> 
                <input type="text" name="slr" value="<%=slr%>" size="20" maxlength="20">              </td>
              <td width="17%" align="right"><font color="#FF0033">*</font>客服受理时间</td>
              <td width="38%"> 
                <input type="text" name="slsj" value="<%=slsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right"><font color="#0000CC">客诉专员</font></td>
              <td><input type="text" name="kszy" value="<%=kszy%>" size="20" maxlength="20" readonly></td>
              <td align="right"><font color="#0000CC">客户来电次数</font></td>
              <td><input type="text" name="khldcs" value="<%=khldcs%>" size="20" maxlength="20" readonly></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right"><font color="#FF0033">*</font>投诉内容</td>
              <td colspan="3"> 
                <textarea name="tsnr" cols="66" rows="7"><%=tsnr%></textarea>              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="28%"><%
					cf.radioToken(out, "sfxtz","Y+人工通知&N+自动通知",sfxtz);
				%></td>
              ...
              <td width="38%"><%
					...
					cf.radioToken(out, "sfla","Y+是&N+否",sfla);
				%> </td>
            </tr>
            <tr bgcolor="#FFFFFF">
...
%> </td>
              <td width="17%"> 
                <div align="right"><font color="#FF0033">*</font>回访时间</div>              </td>
              <td width="38%"> 
                <input type="text" name="hfsj" size="20" maxlength="10"  value="<%=hfsj%>" onDblClick="JSCalendar(this)">              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right">备注</td>
              <td colspan="3"> 
                <textarea name="bz" cols="66" rows="2"><%=bz%></textarea>              </td>
            </tr>
...
*/
	...
	FormName.action="SaveEditCrm_tsjl.jsp";
	FormName.submit();
	return true;
}
