...
//进行对象初始化
	pageObj.initPage("Crm_tsjlFkfList.jsp","SelectFkfCrm_tsjl.jsp","","EditCrm_tsjlFkf.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数
//设置显示列
	String[] disColName={"hth","khxm","fwdz","sjs","sgd","tsjlh","clzt","slfsmc","tsnr","slsj","hfsj"};
