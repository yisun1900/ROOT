...
try {
	...
	ls_sql="insert into crm_tsjl ( tsjlh,khbh,slfsbm,yzcdbm,yqjjsj  ,sfxhf,tsbxsj,lrr  ,lrsj,slbm,bz,clzt,lx   ,zrbmclzt,tsnr,ssfgs,sfxtz,sfpz,sfxnbgz,sfxldcl,sfpfkh,khpfze,sfnbcf,nbcfze,sffswxf,wxfze) ";
	ls_sql+=" values ( ?,?,?,?,?  ,?,?,?  ,SYSDATE,?,?,?,'1'  ,'1',?,?,?,'N','N','N','1',0,'1',0,'1',0) ";//1：未处理；2：在处理；3：已解决
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,tsjlh);
	ps.setString(2,khbh);
