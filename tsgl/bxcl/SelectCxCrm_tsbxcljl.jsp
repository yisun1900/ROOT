...
<body bgcolor="#FFFFFF">
<form method="post" action="Crm_tsbxcljlCxList.jsp" name="selectform">
          
        <div align="center">报修处理－查询</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right" >报修记录号</td>
      <td ><input type="text" name="tsjlh" size="20" maxlength="10"  ></td>
      <td  align="right" bgcolor="#FFFFFF">处理记录号</td>
      <td ><input type="text" name="cljlh" size="20" maxlength="13"  ></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td  align="right" bgcolor="#FFFFFF">报修是否结案</td>
      <td >
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="18%"  align="right" bgcolor="#FFFFFF">报修小类</td>
      <td width="32%" > 
    ...
    <tr bgcolor="#999999"> 
      <td width="18%" bgcolor="#FFFFFF" align="right">报修报修品牌</td>
      <td width="32%" bgcolor="#FFFFFF"> 
