...
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbxxckcjlList.jsp","","","EditCrm_tsbxxckcjl.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","sjcxcr","sjcxcsj","jhcfasj","cxcsm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCxcCrm_tsbm.jsp"};//按钮单击调用的网页，可以增加参数
