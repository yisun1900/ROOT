...
<html>
<head>
<title>报修处理－方案审核</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">报修处理－方案审核（报修记录号：<%=tsjlh%>） </div>
...
<form method="post" action="" name="editform"  >
        <div align="center"><b>报修处理－方案审核</b>（出方案记录号：<%=cfajlh%>）</div>
...
%> 
    ...
    <tr> 
      <td width="18%" align="right"><strong>实际出方案人</strong></td>
      <td width="32%"><%=sjcfar%>     </td>
      <td width="17%" align="right"><strong>实际出方案时间</strong></td>
...
%></td>
    ...
    <tr>
      ...
      <td colspan="3"><%
	cf.radioToken(out, "shjl","Y+通过&N+未通过","");
%></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#FFFFFF"><font color="#FF0000">*</font>审核说明</td>
      <td colspan="3"><textarea name="shsm" cols="71" rows="9"></textarea></td>
    </tr>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveShCrm_tsbxfajl.jsp";
	FormName.submit();
	return true;
}
