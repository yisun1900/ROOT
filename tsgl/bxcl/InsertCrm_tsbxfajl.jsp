...
<html>
<head>
<title>报修处理－出方案</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">报修处理－出方案（报修记录号：<%=tsjlh%>） </div>
...
<form method="post" action="SaveInsertcrm_tsbxfajl.jsp" name="editform"  >
        <div align="center"><b>报修处理－出方案</b>（出方案记录号：<%=cfajlh%>）</div>
...
%> 
    ...
    <tr>
      <td align="right"><strong>方案审核人</strong></td>
      <td><%=shr%></td>
      <td align="right"><strong>方案审核时间</strong></td>
      <td><%=shsj%></td>
    </tr>
    <tr>
      <td align="right"><strong>方案审核说明</strong></td>
      <td colspan="3"><%=shsm%></td>
    </tr>
    <tr>
      <td align="right"><font color="#FF0000">*</font>处理状态</td>
      <td colspan="3"><%
	cf.radioToken(out, "clzt","7+已出方案等待审核&8+已出方案不需审核","");
%></td>
    </tr>
    ...
    <tr>
      ...
      <td><%
	cf.radioToken(out, "sffswxf","1+未发生&2+发生","");
%></td>
      <td align="right"><font color="#FF0000">      *</font>是否内部处罚</td>
      <td><%
	cf.radioToken(out, "sfnbcf","1+不需处罚&2+需处罚","");
%></td>
    </tr>
    <tr>
