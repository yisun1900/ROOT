...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,dm_tshfjgbm.hfjgmc,crm_tsbm.qrjjsj,DECODE(crm_tsbm.sfjslx,'Y','及时联系','N','未及时联系','W','情况未知') sfjslx,dm_zzjgbm.zzjgmc,dm_jsxbm.jsxmc";
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="80px">实际解决时间</td>
	<td  width="80px">最新处理时间</td>
	<td  width="1%">最新处理人</td>
	<td  width="9%">最新处理情况</td>

	<td  width="2%">客服回访结果编码</td>
	<td  width="80px">确认解决时间</td>
	<td  width="2%">是否及时联系</td>
