...
try {
	...
	ls_sql+=" ,sffswxf,sfnbcf,wxfze,nbcfze,jhjjsj,jjfa,sjcfar,sjcfasj,shsm";
...
<html>
<head>
<title>报修处理－方案审核－修改</title>
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
</head>

<body bgcolor="#FFFFFF" style="FONT-SIZE:14">
<div align="center">报修处理－方案审核－修改（报修记录号：<%=tsjlh%>） </div>
...
<form method="post" action="" name="editform"  >
        <div align="center"><b>报修处理－方案审核－修改</b>（出方案记录号：<%=cfajlh%>）</div>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgShCrm_tsbxfajl.jsp";
	FormName.submit();
	return true;
}
