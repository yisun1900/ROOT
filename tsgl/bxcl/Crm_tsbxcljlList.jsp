...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.clr,crm_tsbm.clsj,crm_tsbm.clqk,crm_tsbm.jhjjsj,crm_tsbm.sjcfasj,crm_tsbm.sjjjsj";
	...
	ls_sql+=" and crm_tsbm.clzt in('3','B')";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.jhcxcsj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbxcljlList.jsp","","","EditCrm_tsbxcljl.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","clr","clsj","sjjjsj","jhjjsj","sjcfasj","clqk","sjs","sgdmc","slfsmc","jazt","tspp"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteClCrm_tsbm.jsp"};//按钮单击调用的网页，可以增加参数
