...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.sjcxcr,crm_tsbm.sjcxcsj,crm_tsbm.cxcsm,crm_tsbm.jhcfasj,crm_tsjl.wxsgd";
	...
	ls_sql+=" and crm_tsbm.clzt in('2','6','A')";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.jhcxcsj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbmCfaList.jsp","","","InsertCrm_tsbxfajl.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","wxsgd","sjcxcr","sjcxcsj","jhcfasj","cxcsm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
