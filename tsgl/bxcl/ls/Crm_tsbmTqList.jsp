...
<CENTER ><B>处理报修－特权（<font color="#FF0000">已结案记录不再显示</font>）</B></CENTER>
<%
    ...
    ls_sql+=" and crm_tsbm.tsxlbm=dm_tsxlbm.tsxlbm and crm_tsbm.dwbh=sq_dwxx.dwbh and crm_tsjl.lx='2'";
