...
try {
	...
	ls_sql="select clqk,clr,clsj,dwmc,tslxbm,tsxlbm";
...
%> </td>
  ...
  <tr bgcolor="#FFFFCC">
    <td align="right"><font color="#0000CC">手机</font></td>
    <td><%=lxfs%></td>
    <td align="right"><font color="#0000CC">其它电话</font></td>
    <td><%=qtdh%></td>
  </tr>
  <tr bgcolor="#FFFFCC"> 
...
%></td>
    <td rowspan="9" align="right">报修内容</td>
    <td rowspan="9"><%=tsnr%> </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td width="17%" align="right">处理状态</td>
    <td width="33%"><%
	cf.selectToken(out,"0+非客服登记&1+客服受理&2+在处理&3+结案&9+不立案",clzt,true);
%></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
%> </td>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="17%" align="right"> 
      <div align="right"><font color="#660033">录入部门</font></div>    </td>
    <td width="33%"><%
  ...
  <tr bgcolor="#FFFFFF"> 
	...
	<table width="100%" border="1" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="0">
          <tr bgcolor="#FFFFFF" align="center"> 
            ...
            <td width="8%"> 
              <div align="center"><font color="#006666">录入时间</font></div>
            </td>
            <td width="6%"> 
              <div align="center"><font color="#006666">录入人</font></div>
            </td>
          </tr>
<%
	ybl.common.PageObject pageObj=new ybl.common.PageObject();
	
	ls_sql="select dwmc,'（'||tsxlmc||'）'||tsyymc,DECODE(clzt,'1','未处理','2','在处理','3','已解决') clzt,NVL2(crm_tsbm.clqk,'（'||TO_CHAR(crm_tsbm.clsj,'YYYY-MM-DD')||'，'||crm_tsbm.clr||'）：'||crm_tsbm.clqk,'') clqk,crm_tsbm.lrsj,crm_tsbm.lrr";
  ...
  <table width="100%" border="1" style="FONT-SIZE:12"  cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="4" height="36"> 
        <div align="center"><b>（<%=cldwmc%>）处理报修情况</b></div>
      </td>
    </tr>
    <tr>
      <td width="18%" align="right">报修报修大类</td>
      <td width="32%">
...
%> 
      ...
      <td width="17%" align="right">报修报修小类</td>
      <td width="33%">
...
%> 
      ...
      <td width="17%" align="right">报修报修原因</td>
      <td width="33%">
...
%> 
    ...
    <tr> 
      ...
      <td width="33%"> 
        <input type="text" name="clsj" size="20" maxlength="10" value="<%=cf.today()%>" >
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td colspan="3"> 
        <textarea name="clqk" cols="87" rows="10"><%=clqk%></textarea>
      </td>
    </tr>
    <tr> 
      <td colspan="4"> 
