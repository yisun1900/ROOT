...
%></td>
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="33%"><%
	cf.selectToken(out,"1+受理&2+在处理&3+结案",crm_tsjl_clzt,true);
%> </td>
  </tr>
  <tr bgcolor="#FFFFCC"> 
...
%> </td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td colspan="3"><%=bz%></td>
        ...
        <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
          <tr bgcolor="#FFFFFF" align="center"> 
            <td width="12%"> 
              <div align="center"><font color="#006666">报修部门</font></div>
            </td>
            <td width="62%"> 
	...
	ls_sql+=" where crm_tsclqk.dwbh=sq_dwxx.dwbh and tsjlh='"+wherecrm_tsjl_tsjlh+"'";
	rs =stmt.executeQuery(ls_sql);
	while (rs.next())
	{
...
%> 
	...
	ls_sql+=" where tsjlh='"+wherecrm_tsjl_tsjlh+"'";
	rs =stmt.executeQuery(ls_sql);
	while (rs.next())
	{
  ...
  <table width="100%" border="1" style="FONT-SIZE:12"  cellpadding="1" cellspacing="0">
    <tr> 
      <td colspan="4" height="36"> 
        <div align="center">处理报修信息</div>
      </td>
    </tr>
    <tr> 
      <td width="18%" align="right">处理人</td>
      <td width="32%"> 
        <input type="text" name="clr" value="<%=yhdlm%>" size="20" maxlength="20" readonly>
        <input type="hidden" name="tsjlh" value="<%=tsjlh%>" >
        <input type="hidden" name="dwbh" value="<%=dwbh%>" >
      </td>
      <td width="17%" align="right">处理时间</td>
      <td width="33%"> 
        <input type="text" name="clsj" value="<%=cf.today()%>" size="20" maxlength="10" readonly>
      </td>
    </tr>
    <tr> 
