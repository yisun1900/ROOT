...
try {
	...
	ls_sql+=" ,crm_tsjl.wxsgd,crm_tsjl.sfxtz,tsnr,slbm,crm_tsjl.bz,yzcdbm,slfsbm,hth,crm_khxx.khbh,khxm,fwdz,lxfs,qtdh,sjs,sgd,sgbz,crm_khxx.dwbh,zjxm,sjkgrq,sjjgrq,crm_tsjl.sfxhf,crm_tsjl.hfsj,crm_tsjl.yqjjsj";
	...
	ls_sql+=" ,sffswxf,sfnbcf,wxfze,nbcfze,jhjjsj,jjfa,sjcfar,sjcfasj,shsm,shr,shsj,clqk,clr,clsj,sjjjsj";
	...
	if (rs.next())
	{
		...
		sffswxf=cf.fillHtml(rs.getString("sffswxf"));
		...
		sjjjsj=cf.fillNull(rs.getDate("sjjjsj"));
	}
	rs.close();
...
<div align="center">报修处理－修改（报修记录号：<%=tsjlh%>） </div>
...
<table width="90%" border="1" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="0">
  <tr bgcolor="#FFFFFF" align="center"> 
	...
	<td width="7%"><strong>维修费总额</strong></td>
...
<form method="post" action="" name="editform"  >
        <div align="center"><b>报修处理</b>（处理记录号：<%=cljlh%>）</div>
...
%> 
    ...
    <tr>
      <td align="right">是否发生维修费</td>
      <td><%
	cf.radioToken(out,"1+未发生&2+发生",sffswxf,true);
%></td>
...
%></td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><%=shr%>      </td><td align="right">审核时间</td>
      <td><%=shsj%>     </td></tr>
    <tr>
...
%></td>
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right" bgcolor="#FFFFFF">审核说明</td>
...
%></td>
      ...
      <td><input type="text" name="sjjjsj" value="<%=sjjjsj%>" size="20" maxlength="10" onDblClick="JSCalendar(this)"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveEditCrm_tsbxcljl.jsp";
	FormName.submit();
	return true;
}
