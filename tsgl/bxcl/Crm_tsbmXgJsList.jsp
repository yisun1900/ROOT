...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.jsr,crm_tsbm.jssj,crm_tsbm.jssm,crm_tsbm.jhcxcsj,crm_tsbm.jhcfasj,crm_tsbm.jhjjsj,crm_tsjl.wxsgd";
	...
	ls_sql+=" and crm_tsbm.clzt in('2','4','D')";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.jssj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbmXgJsList.jsp","","","XgJsCrm_tsbm.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","wxsgd","jsr","jssj","jhcxcsj","jhcfasj","jhjjsj","jssm","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteJsCrm_tsbm.jsp"};//按钮单击调用的网页，可以增加参数
