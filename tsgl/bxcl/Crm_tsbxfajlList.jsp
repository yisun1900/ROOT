...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" ,crm_tsbm.sjcfar,crm_tsbm.sjcfasj,crm_tsbm.jjfa,crm_tsbm.jhjjsj";
	...
	ls_sql+=" and crm_tsbm.clzt in('7','8')";
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsbm.jhcxcsj" ;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_tsbxfajlList.jsp","","","EditCrm_tsbxfajl.jsp");
//	pageObj.setPageRow(2);//设置每页显示记录数
//设置显示列
	String[] disColName={ "tsjlh","clzt","khxm","zrbm","zrr","tsxlmc","sjcfar","sjcfasj","jhjjsj","jjfa","sjs","sgdmc","slfsmc","slsj","jazt","tspp"};
...
//	pageObj.setEditStr("出方案"); 


//设置按钮参数
	String[] buttonName={"删除选中的信息"};//按钮的显示名称
	String[] buttonLink={"DeleteFaCrm_tsbm.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%">负责人</td>
	<td  width="7%">报修原因</td>
	<td  width="3%">实际出方案人</td>
	<td  width="4%">实际出方案时间</td>
