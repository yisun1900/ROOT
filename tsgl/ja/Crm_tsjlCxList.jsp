...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_tsjl.tsjlh,DECODE(crm_tsjl.lx,'1','投诉','2','报修') lx,DECODE(crm_tsjl.clzt,'0','未受理','1','已受理','4','已接收','5','已出现场','6','已出方案','7','方案审核通过','2','在处理','3','结案','9','不立案') as clzt,DECODE(crm_tsjl.zrbmclzt,'1','未接收','2','已接收等待出方案','4','已接收等待出现场','6','已出现场等待出方案','7','已出方案等待审核','8','已出方案不需审核','9','方案审核通过','A','方案审核未通过','3','已解决','C','回访未解决','B','在处理','5','结案') as zrbmclzt,khxm,fwdz,tsnr,slfsmc,crm_tsjl.lrr,crm_tsjl.lrsj,crm_tsjl.slr,crm_tsjl.slsj,yqjjsj,crm_tsjl.khbh";
	...
	ls_sql+=wheresql;
    ls_sql+=" order by crm_tsjl.zrbmclzt desc,crm_tsjl.slsj,crm_tsjl.tsjlh ";
    pageObj.sql=ls_sql;

//进行对象初始化
	pageObj.initPage("Crm_tsjlCxList.jsp","","","EnterJa.jsp");
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="4%">姓名</td>
	<td  width="12%">房屋地址</td>
	<td  width="31%">投诉报修内容</td>
	<td  width="4%">投诉来源</td>
	<td  width="4%">客服受理人</td>
	<td  width="5%">客服受理时间</td>
	<td  width="4%">录入人</td>
	<td  width="5%">录入时间</td>
	<td  width="5%">要求解决时间</td>
	<td  width="4%">客户编号</td>
