...
try {
	...
	if (count>0)
	{
		out.println("错误！该客户有未受理的投诉报修记录，必须先受理，才能办理结案");
		return;
	}
...
<body bgcolor="#FFFFFF">
<div align="center"><b>请输入结案信息 </b></div>
...
%> 
        ...
        <form method="post" action="SaveEnterJa.jsp" name="insertform" >
...
//		String clzt=null;
		...
		ls_sql="select crm_tsbm.hfjgbm,crm_tsbm.sfjslx,tsxlmc,crm_tsbm.tsyybm,tsyymc,dwmc  ";
		...
		%> </td>
              ...
              <td align="center" width="25%" valign="middle" > <b><font color="#FF0000">*</font>结案时间</b>： 
                <input type="text" name="jasj" value="<%=cf.today()%>" size="12" maxlength="10" ondblclick="JSCalendar(this)" style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" onDblClick="JSCalendar(this)">
