...
String tsbxsl=(String)session.getAttribute("tsbxsl");
...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">特权维护－修改报修信息</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="Crm_tsjlXgBxList.jsp" name="selectform">
...
{
	if(!(isNumber(FormName.crm_tsjl_tsjlh, "报修记录号"))) {
		return false;
	}
