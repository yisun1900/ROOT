...
<form method="post" action="Crm_khwtclgzClList.jsp" name="selectform">
...
<%
	...
	{
        out.println("        <select name=\"fgs\" style=\"FONT-SIZE:12PX;WIDTH:152PX\" onChange=\"selectItem(fgs,crm_khwtclgz_slbm,"+dwstr+");\">");
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="33%"> 
                <input type="radio" name="crm_khwtclgz_clzt" value="1" checked>未处理
                <input type="radio" name="crm_khwtclgz_clzt" value="2">在处理
                <input type="radio" name="crm_khwtclgz_clzt" value="3">已解决
              </td>
              <td width="18%"> 
