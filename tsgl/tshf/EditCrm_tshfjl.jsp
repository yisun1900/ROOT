...
try {
	...
	ls_sql="select clzt";
	ls_sql+=" from  crm_tshffkbm ";
	ls_sql+=" where hfjlh='"+hfjlh+"' ";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
		hffkbmclzt=cf.fillNull(rs.getString("clzt"));
	}
	rs.close();
	ps.close();
...
<form method="post" action="SaveEditCrm_tshfjl.jsp" name="insertform">
<%
	String tsjlh=null;
	String slfsbm=null;
	String yqjjsj=null;
	...
	int row=0;
	ls_sql="select crm_tsjlhfmx.tsjlh,slfsmc,tsbxsj,slsj,slr,lrsj,lrr,yqjjsj,ldyqjjsj,tsnr,lx,DECODE(lx,'1','投诉','2','报修') lxmc,crm_tsjlhfmx.sfjxhf,crm_tsjlhfmx.jasj";
...
//		String dwmc=null;
		...
		ls_sql+=" ,tsyymc,dwmc,DECODE(sfytz,'0','(未通知)','1','(已通知)','3','(不需通知)') sfytz ";
		...
		ls_sql+=" ,crm_tsbm.tzsj,crm_tsbm.jssj,crm_tsbm.jhcfasj,crm_tsbm.sjcfasj,crm_tsbm.jhjjsj";
                    ...
                    <td colspan="4" width="47%" valign="top" align="center">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" style='FONT-SIZE: 12px'>
						...
						<select name="hfjgbm<%=tsjlh%><%=tsyybm%>" style="FONT-SIZE:12PX;WIDTH:132PX">
							<option value=""></option>
							<%
								cf.selectItem(out,"select hfjgbm,hfjgmc from dm_tshfjgbm  order by hfjgbm",hfjgbm);
							%> 
						</select>
                      ...
                      <table width="100%"  bgcolor="#FFFFCC" border="0" cellpadding="0" cellspacing="0"  id="id<%=tsjlh%><%=tsyybm%>" style="display:<%=lsStr%>" style='FONT-SIZE: 12px'>
                        <tr>
                          <td align="center">
						<BR><B>若结案请选择</B>↘↘↘<BR>
		...
		%> </td>
            ...
            <tr> 
              <td align="left" width="32%" valign="top" > <b><font color="#FF0000">*</font>是否结案</b>： 
                ...
                <input type="radio" name="sfjxhf<%=tsjlh%>" <%if (sfjxhf.equals("Y")) out.print("checked");%> value="Y" onclick="<%=nonestr%>" >
                不结案 
                <input type="radio" name="sfjxhf<%=tsjlh%>" <%if (sfjxhf.equals("N")) out.print("checked");%> value="N" onclick="<%=blockstr%>">
                结案 
				<IMG SRC="/images/169.gif" >
				<BR>
                <b><font color="#FF0000">*</font>结案时间</b>： 
                <input type="text" name="jasj<%=tsjlh%>" value="<%=jasj%>" size="12" maxlength="10"  style="border-color: #FFFFFF #FFFFFF #000000;border-style:solid" onDblClick="JSCalendar(this)">
		...
		<b>客服回访时填写</b><img src="/images/168.gif" > 
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <textarea name="khhfqk" cols="81" rows="3"><%=khhfqk%></textarea>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%"> 
              ...
              <td colspan="3"> 
                <textarea name="cxxwt" cols="81" rows="3"><%=cxxwt%></textarea>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td width="34%">
<%
				cf.radioToken(out, "hffkbmclzt","0+需要&1+不需要",hffkbmclzt);
%>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
              ...
              <td width="34%">
                <input type="text" name="xchfrq" value="<%=xchfrq%>" size="20" maxlength="10" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#FF0000">*</font>回访人</td>
              <td width="34%"> 
                <input type="text" name="hfr" value="<%=hfr%>" size="20" maxlength="10" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="16%" align="right"><font color="#FF0000">*</font>回访时间</td>
              <td width="34%"> 
                <input type="text" name="hfsj" value="<%=hfsj%>" size="20" maxlength="10" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
