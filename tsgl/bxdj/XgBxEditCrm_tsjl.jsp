...
try {
	...
	ls_sql="select tsbxsj,lrr,lrsj,zrbmclzt,slsj,tsnr,slbm,crm_tsjl.bz,yzcdbm,slfsbm,khbh,crm_tsjl.sfxhf,crm_tsjl.hfsj,slr,clzt,crm_tsjl.yqjjsj,crm_tsjl.wxsgd";
...
<table width="100%" style="FONT-SIZE:14">
  <tr>
    <td width="100%" height="22"> 
      <div align="center"> 特权维护－修改报修信息（报修记录号：<%=tsjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <textarea name="tsnr" cols="73" rows="5"><%=tsnr%></textarea>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="37%"> 
                <input type="text" name="wxsgd" value="<%=wxsgd%>" size="20" maxlength="30" >
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="17%"> 
...
%> </td>
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <textarea name="bz" cols="73" rows="2"><%=bz%></textarea>
              </td>
            </tr>
...
*/
	...
	FormName.action="SaveXgBxEditCrm_tsjl.jsp";
	FormName.submit();
	return true;
}
