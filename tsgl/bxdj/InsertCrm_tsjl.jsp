...
//	out.println(ls_sql);
	...
	if (zt.equals("2") && !gcjdbm.equals("4") && !gcjdbm.equals("5"))//2：家装客户；3：家装已退单 ；4：非家装客户
	{
//		out.println("错误！家装客户只有完工才能进行报修登记");
//		return;
	}

	if (kbxbz.equals("Y"))//Y+保修&M+部分保修&N+不保修&0+未办理&1+预办理保修
	{
		wxfl="1";//1：保修；2：非保修
	}
	else{
...
<table width="100%" style="FONT-SIZE:12">
  <tr>
    <td width="100%"> 
      <div align="center"> 请录入报修信息（报修记录号：<%=tsjlh%>）</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
<form method="post" action="" name="insertform" target="_blank">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#E8E8FF"> 
              <td width="25%" align="left" bgcolor="#E8E8FF"><font color="#0000CC">签约店面：</font><%=dwmc%> 
              </td>
...
<%
	if (kbxbz.equals("N"))
	{
		...
		<script language="javascript">
			var ie = "<marquee onmouseover='this.stop()' onmouseout='this.start()' scrollDelay=180 ><b><font color='#0000CC' class='3dfont' size='2' >注意！该客户[不能保修]</font></b></marquee><br>";
			document.write(ie);
		</script>
		<%
	}
	else if (kbxbz.equals("M"))
	{
		%> 
		<script language="javascript">
			var ie = "<marquee onmouseover='this.stop()' onmouseout='this.start()' scrollDelay=180 ><b><font color='#0000CC' class='3dfont' size='2' >注意！该客户[部分保修]</font></b></marquee><br>";
			document.write(ie);
		</script>
		<%
	}
	else if (kbxbz.equals("0"))
	{
		%> 
		<script language="javascript">
			var ie = "<marquee onmouseover='this.stop()' onmouseout='this.start()' scrollDelay=180 ><b><font color='#0000CC' class='3dfont' size='2' >注意！该客户[未办理保修]</font></b></marquee><br>";
			document.write(ie);
		</script>
		<%
	}
	else if (kbxbz.equals("Y") && syts<0)
	{
		%> 
		<script language="javascript">
			var ie = "<marquee onmouseover='this.stop()' onmouseout='this.start()' scrollDelay=180 ><b><font color='#0000CC' class='3dfont' size='2' >注意！该客户保修已过期，保修截止时间："+bxjzsj+"</font></b></marquee><br>";
			document.write(ie);
		</script>
		<%
	}
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="17%" align="right"> 
                <font color="#FF0033">*</font>报修来源              </td>
              <td width="27%"> 
...
%> 
              ...
              <td width="18%" align="right"> 
                <font color="#FF0033">*</font>客户报修时间              </td>
              <td width="38%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right"><font color="#FF0033">*</font>客服受理时间</td>
              <td width="38%"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="18%" align="right"><font color="#FF0033">*</font><font color="#0000CC">录入时间</font></td>
              <td width="38%"> 
...
%>
              ...
              <td align="right" bgcolor="#FFFFFF"><font color="#FF0033">*</font>客户来电次数</td>
              <td bgcolor="#FFFFFF"><input type="text" name="khldcs" value="1" size="20" maxlength="8"></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="27%"> 
                ...
                自动通知 </td>
              <td width="18%" align="right"><font color="#FF0033">*</font>是否立案</td>
              <td width="38%"> 
...
%> 
              ...
              <td width="18%" rowspan="6" align="right" valign="top">涉及厂商</td>
...
%>			  </td>
            ...
            <tr> 
              <td colspan="4" align="center"> 
                ...
                <input type="button"  value="查看报修原因" onClick="f_ck(insertform)" name="ck" disabled>
                <input name="button" type="button" onClick="window.open('/gcgl/jygcgl/jcgd/InsertGdm_gdjcjl.jsp?khbh=<%=khbh%>')"  value="违反精益工程" >
