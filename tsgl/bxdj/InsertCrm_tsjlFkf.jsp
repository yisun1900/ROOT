...
if (count>0)
{
	...
	<tr bgcolor="#CCCCCC"  align="center">
		...
		<td  width="52%">报修报修内容</td>
	</tr>
	<%
	ls_sql="SELECT tsjlh,tsbxsj,slfsmc,DECODE(crm_tsjl.clzt,0,'未受理',1,'已受理',2,'在处理',3,'结案','9','不立案') as clzt,DECODE(crm_tsjl.sfxtz,'Y','需通知','N','不需通知') sfxtz,DECODE(crm_tsjl.zrbmclzt,'1','未接收','2','已接收等待出方案','D','已接收不需出方案','E','不属实','4','已接收等待出现场','6','已出现场等待出方案','7','已出方案等待审核','8','已出方案不需审核','9','方案审核通过','A','方案审核未通过','3','已解决','C','回访未解决','B','在处理','5','结案') zrbmclzt,tsnr";
...
%> 
              ...
              <td width="18%" align="right"><font color="#FF0033">*</font>客户保修时间</td>
              <td width="38%"> 
...
%> 
              ...
              <td width="18%" rowspan="5" align="right" valign="top">涉及厂商</td>
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isDatetime(FormName.tsbxsj, "客户保修时间"))) {
		return false;
	}
