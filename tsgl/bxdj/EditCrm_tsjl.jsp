...
try {
	...
	ls_sql="select ysgd,ysgdsflz,sfxnbgz,nbgzsj,kszy,khldcs,wxfl,sfxtz,tsbxsj,lrr,lrsj,zrbmclzt,slsj,tsnr,slbm,crm_tsjl.bz,yzcdbm,slfsbm,khbh,crm_tsjl.sfxhf,crm_tsjl.hfsj,slr,clzt,crm_tsjl.yqjjsj,crm_tsjl.wxsgd";
...
%> 
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td>
                <input type="text" name="kszy" value="<%=kszy%>" size="20" maxlength="20" readonly>              </td>
              <td align="right"><font color="#0000CC">客户来电次数</font></td>
               <td>
                <input type="text" name="khldcs" value="<%=khldcs%>" size="20" maxlength="20" readonly>              </td>
            </tr>
...
%> </td>
              <td width="17%" align="right"> 
                <font color="#FF0033">*</font>回访时间              </td>
              <td width="37%"> 
