...
try {
	...
	while (rs3.next())
	{
		...
		while (rs2.next())
		{
			...
			ls_sql="SELECT distinct cl_clbm.clbm,clmc,clgg,cldlmc,jldwmc,cl_jgmx.gdj";
			...
			while (rs.next())
			{
				...
				ls_sql+=" group by cl_clsgd.sgzt";//注意起点不包括等于
				ls_sql+=" having cl_clsgd.sgzt='3' ";//注意起点不包括等于
