...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    ls_sql+=" and cl_djj.shzt!='1' and (cl_djj.shjl='2' or cl_djj.ejshjl='2')";
    ls_sql+=wheresql;
    ls_sql+=" order by cl_djj.lrsj desc";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_djjShWtgList.jsp","SelectShWtgCl_djj.jsp","","EditWtgCl_djj.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"DeleteCl_djj.jsp"};//按钮单击调用的网页，可以增加参数
