...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	String ejshjl=null;
	ejshjl=request.getParameter("ejshjl");
	if (ejshjl!=null)
	{
		if (!(ejshjl.equals("")))	wheresql+=" and  (cl_djj.ejshjl='"+ejshjl+"')";
	}
	String shr=null;
	...
	{
		shr=cf.GB2Uni(shr);
		if (!(shr.equals("")))	wheresql+=" and  (cl_djj.shr='"+shr+"')";
	}
	String ejshr=null;
	ejshr=request.getParameter("ejshr");
	if (ejshr!=null)
	{
		ejshr=cf.GB2Uni(ejshr);
		if (!(ejshr.equals("")))	wheresql+=" and  (cl_djj.ejshr='"+ejshr+"')";
	}
	...
	{
		dysj=dysj.trim();
		if (!(dysj.equals("")))	wheresql+="  and (cl_djj.dysj>=TO_DATE('"+dysj+"','YYYY/MM/DD'))";
	}
	...
	zflrsj=request.getParameter("zflrsj");
	if (zflrsj!=null)
	{
		zflrsj=zflrsj.trim();
		if (!(zflrsj.equals("")))	wheresql+="  and (cl_djj.zflrsj>=TO_DATE('"+zflrsj+"','YYYY/MM/DD'))";
	}
	zflrsj=request.getParameter("zflrsj2");
	if (zflrsj!=null)
	{
		zflrsj=zflrsj.trim();
		if (!(zflrsj.equals("")))	wheresql+="  and (cl_djj.zflrsj<=TO_DATE('"+zflrsj+"','YYYY/MM/DD'))";
	...
	if (cl_djj_czzt!=null)
	{
		...
		if (cl_djj_czzt.equals("9"))
		{
			wheresql+=" and cl_djj.czzt in('1','2')";
		}
		else if (!(cl_djj_czzt.equals("")))
		{
			wheresql+=" and  (cl_djj.czzt='"+cl_djj_czzt+"')";
		}
	}

	ls_sql="SELECT cl_djj.czxh, DECODE(cl_djj.czzt,'1','未提交','2','已提交','3','已打印','8','作废'), DECODE(cl_djj.sfjm,'1','不申请','2','申请减免'), DECODE(cl_djj.shzt,'1','未审核','2','一级审核','3','二级审核'),DECODE(shjl,'1','同意','2','不同意') shjl,DECODE(ejshjl,'1','同意','2','不同意') ejshjl,crm_khxx.khxm,crm_khxx.hth,cl_djj.qye,DECODE(cl_djj.czzt,'8',0,cl_djj.sqlqsl) ,DECODE(cl_djj.czzt,'8',0,cl_djj.sqlqje) ,DECODE(cl_djj.czzt,'8',0, cl_djj.sjsl),DECODE(cl_djj.czzt,'8',0, cl_djj.sjje),DECODE(cl_djj.czzt,'8',0,cl_djj.ylqze),DECODE(cl_djj.czzt,'8',0,cl_djj.ylqze-cl_djj.sjje) ,cl_djj.shr,cl_djj.shsj,cl_djj.shyj,cl_djj.ejshr,cl_djj.ejshsj,cl_djj.ejshyj,cl_djj.dysj,cl_djj.dyr,cl_djj.khbh,crm_khxx.fwdz,sgdmc,sq_dwxx.dwmc  ,cl_djj.lrr,cl_djj.lrsj,cl_djj.bz,zflrsj";
//	ls_sql="SELECT cl_djj.czxh, DECODE(cl_djj.czzt,'1','未提交','2','已提交','3','已打印','8','作废'), DECODE(cl_djj.sfjm,'1','不申请','2','申请减免'), DECODE(cl_djj.shzt,'1','未审核','2','一级审核','3','二级审核'),DECODE(shjl,'1','同意','2','不同意') shjl,DECODE(ejshjl,'1','同意','2','不同意') ejshjl,crm_khxx.khxm,cl_djj.qye,cl_djj.sqlqsl,cl_djj.sqlqje,cl_djj.sjsl,cl_djj.sjje,cl_djj.ylqze,cl_djj.ylqze-cl_djj.sjje,cl_djj.shr,cl_djj.shsj,cl_djj.shyj,cl_djj.ejshr,cl_djj.ejshsj,cl_djj.ejshyj,cl_djj.dysj,cl_djj.dyr,cl_djj.khbh,crm_khxx.fwdz,sgdmc,sq_dwxx.dwmc  ,cl_djj.lrr,cl_djj.lrsj,cl_djj.bz";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_djjCxList.jsp","SelectCxCl_djj.jsp","","");
