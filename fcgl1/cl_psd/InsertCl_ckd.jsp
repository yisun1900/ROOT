...
try { 
	...
	ls_sql="select khbh,khxm,fwdz,lxfs,dwbh,sjs,sgd,zjxm,hth,kgrq,jgrq,sgbz,qye,fgsbh,crm_khxx.bjjb,bjjbmc";
	ls_sql+=" from  crm_khxx,bdm_bjjbbm";
	ls_sql+=" where khbh='"+khbh+"' and crm_khxx.bjjb=bdm_bjjbbm.bjjbbm(+) ";
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="34%"> 
        <input type="text" name="psdh" value="<%=psdh%>" size="20" maxlength="11" readonly>      </td>
...
%> 
    ...
    <tr bgcolor="#FFFFFF">
      <td align="right"><font color="#0000CC">报价级别</font></td>
      <td><%=bjjbmc%></td>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr align="center"> 
      <td colspan="4"> 
        ...
        <input type="hidden" name="cksj" value="" size="20" maxlength="10" onDblClick="JSCalendar(this)">      </td>
    </tr>
  </table>
</form>
</body>
