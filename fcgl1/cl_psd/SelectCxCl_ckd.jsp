...
<body bgcolor="#FFFFFF">
<form method="post" action="Cl_ckdCxList.jsp" name="selectform">
<div align="center">请输入查询条件</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">配送状态</td>
      <td width="33%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">配送总数量 从</td>
      <td width="33%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">配送总金额 从</td>
      <td width="33%"> 
