...
<div align="center">
    ...
    <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
      <tr bgcolor="#FFFFFF"> 
        <td width="18%" align="right"><span class="STYLE1"><span class="STYLE2">*</span>配送单价</span></td>
        <td width="32%" > 
          <input type="text" name="gdj" value="<%=ckdj%>" size="20" maxlength="20" readonly>
        <td width="17%" align="right"><span class="STYLE1"><span class="STYLE2">*</span>计量单位</span></td>
        <td width="33%" > 
      ...
      <tr bgcolor="#FFFFFF"> 
        <td width="18%" align="right"> 
          <span class="STYLE1"><span class="STYLE2">*</span></span>配送数量        </td>
        <td width="32%" > 
          <input type="text" name="pssl" value="" size="20" maxlength="20"  onKeyup="sl(insertform);" >
        <td width="17%" align="right"> 
          <span class="STYLE1"><span class="STYLE2">*</span>配送金额</span> </td>
        <td width="33%" > 
          <input type="text" name="psje" value="" size="20" maxlength="20" readonly>
        </td>
      </tr>
      <tr align="center"> 
        <td colspan="4"> 
