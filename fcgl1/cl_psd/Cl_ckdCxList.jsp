...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cl_psd.psdh,crm_khxx.hth,DECODE(cl_psd.lx,'1','配货','2','退货') lx,DECODE(cl_psd.pszt,'1','未提交','2','已提交','3','已配送') pszt,DECODE(cl_psd.psfs,'1','配送','2','自提','9','其它'),cl_psd.jhshsj,cl_psd.pszsl,DECODE(cl_psd.lx,'1',1,'2',-1)*cl_psd.pszje,ROUND(DECODE(cl_psd.lx,'1',1,'2',-1)*cl_psd.pszje*100/wdzgce,2),cl_psd.fkje,cl_psd.yf,cl_psd.qtsf,cl_psd.khbh,crm_khxx.khxm,sq_sgd.sgdmc,cl_psd.lrr,cl_psd.lrsj,dwmc,cl_psd.bz ";
