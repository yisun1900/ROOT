...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql+=" FROM cl_clbm,cl_jgmx,cl_clbmzl";
    ls_sql+=" where cl_clbm.clbm=cl_jgmx.clbm and cl_clbm.clbm=cl_clbmzl.clbm(+)";
	ls_sql+=" and cl_jgmx.dwbh='"+ssfgs+"' ";
//	ls_sql+=" and cl_jgmx.clbm in(select clbm from cl_clbmzl where xmzl='"+bjjb+"') ";
    ls_sql+=wheresql;
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
