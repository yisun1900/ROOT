...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT cl_clbm.clbm,clmc,cl_jgmx.gdj,wxr,clgg,cldlmc,jldwmc,DECODE(lx,'1','常用','2','非常用'),DECODE(lrjsfs,'1','差价方式','2','百分比方式'),lrbfb||'%',lrr,lrsj,bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_clbmCxList.jsp","","","InsertCl_jgmx.jsp?dwbh="+fgs);
