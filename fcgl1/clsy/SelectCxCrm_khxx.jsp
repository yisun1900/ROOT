...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">录入－材料使用明细</div>
    </td>
  </tr>
  <tr>
    <td width="100%" > 
...
{
	if(	javaTrim(FormName.hth)=="" && javaTrim(FormName.khbh)=="" && javaTrim(FormName.sjs)=="" && javaTrim(FormName.zjxm)=="" && javaTrim(FormName.khxm)=="" && javaTrim(FormName.khxm2)=="" && javaTrim(FormName.fwdz)=="" && javaTrim(FormName.fwdz2)=="" && javaTrim(FormName.lxfs)=="" && javaTrim(FormName.lxfs2)=="") {
		alert("请输入[合同号、客户编号、客户姓名、房屋地址、联系方式]！");
		FormName.khxm.focus();
		return false;
	}
