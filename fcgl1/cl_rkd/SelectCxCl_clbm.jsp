...
String dwbh=cf.executeQuery("select dwbh from cl_rkd where rkph='"+rkph+"'");
%>
...
<div align="center">请输入查询条件</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">材料名称</td>
      <td width="33%"> 
        <input type="text" name="clmc" size="20" maxlength="100" >
      </td>
      <td align="right" width="17%">材料规格</td>
      <td width="33%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">利润计算方式</td>
      <td width="33%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">利润百分比 从</td>
      <td width="33%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="17%">材料单价 从</td>
      <td width="33%"> 
