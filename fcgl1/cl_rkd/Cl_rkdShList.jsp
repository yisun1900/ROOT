...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT rkph,dwmc,gysmc,rkr,rksj,rkzsl,rkzje,DECODE(rkzt,'1','未提交','2','已提交','3','已审核'),sgph,lrr,lrsj,cl_rkd.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Cl_rkdShList.jsp","SelectShCl_rkd.jsp","","ShCl_rkd.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"Cl_rkdShList.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update cl_rkd set rkzt='3',shr='"+yhmc+"',shsj=TRUNC(SYSDATE),shyj='批量审核' where rkzt='2' and "+chooseitem;
