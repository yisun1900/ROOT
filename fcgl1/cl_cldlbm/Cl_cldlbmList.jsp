...
//设置按钮参数
	...
	String[] buttonLink={"Cl_cldlbmList.jsp?"};//按钮单击调用的网页，可以增加参数
...
//	coluParm.link="ViewCl_clbm.jsp?";//为列参数：coluParm.link设置超级链接
//	coluParm.bolt="target='_blank'";//为列参数：coluParm.link设置超级链接
//	coluParmHash.put("clbm",coluParm);//列参数对象加入Hash表
