...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT '出库' sg,cl_clbm.clbm clbm,clmc,clgg,cldlmc,gdj,jldwmc,bz ";
...
//设置列超级连接
	...
	coluParm.link="Cl_clbmmx.jsp?ckph="+ckph+"&khbh="+khbh+"&ssfgs="+ssfgs+"&leixing="+leixing;//为列参数：coluParm.link设置超级链接
