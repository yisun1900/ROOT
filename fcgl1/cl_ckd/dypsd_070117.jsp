...
try {
	...
	ls_sql="SELECT hth,khxm,lxfs,fwdz,sgdmc,sq_sgd.dh,cksj  ";
	ls_sql+=" FROM cl_ckd,crm_khxx,sq_sgd ";
	ls_sql+=" where cl_ckd.khbh=crm_khxx.khbh(+) and crm_khxx.sgd=sq_sgd.sgd(+) and cl_ckd.ckph='"+whereckph+"' ";
...
<table width="100%" border="0">
  ...
  <tr> 
    <td colspan="2">房屋地址：<%=fwdz%></td>
    <td width="28%">送货时间：<%=cksj%></td>
  </tr>
  <tr> 
