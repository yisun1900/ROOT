...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	{
	  bjjb=cf.GB2Uni(bjjb);
	  if(!(bjjb.equals("")))  wheresql=" and (cl_jgmx.bjjbbm='"+bjjb+"')";
	}
	...
	ls_sql="SELECT distinct paixu,DECODE(lx,'1','常用','2','非常用'),cl_clbm.clbm,clmc,bjjb,clgg,cldlmc,jldwmc,wxr,lrr,lrsj,bz  ";
