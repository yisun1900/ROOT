...
<body bgcolor="#FFFFFF">
<form method="post" action="Cl_clbmCxList1.jsp" name="selectform">
<div align="center">查询材料编码表(维护人)</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="18%">材料名称</td>
      <td width="32%"> 
      <input type="text" name="clmc" size="20" maxlength="100" >      </td>
      <td align="right" width="18%">材料规格</td>
      <td width="32%"> 
      <input type="text" name="clgg" size="20" maxlength="100" >      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      非常用 </td>
      <td align="right" width="18%"><b><font color="#0000CC">维护人</font></b></td>
      <td width="32%">
        <input type="text" name="wxr" size="20" maxlength="20" value="<%=yhmc%>" readonly>
      </td>
    </tr>
    <tr align="center"> 
      <td colspan="4"> 
