...
%></td>
      <td align="right" width="19%">报价级别</td>
...
%>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><select name="cldlmc" style="FONT-SIZE:12px;WIDTH:152px">
        <option value=""></option>
        <%
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"><input type="text" name="clmc" size="20" maxlength="100" ></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="18%" align="right">材料规格</td>
      <td width="32%"><input type="text" name="clgg" size="20" maxlength="100" ></td>
      <td width="19%" align="right">维护人</td>
      <td width="31%"><input type="text" name="wxr" size="20" maxlength="20" value=""></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
