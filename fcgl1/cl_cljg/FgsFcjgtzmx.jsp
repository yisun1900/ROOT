...
<form method="post" action="SaveFgsFcjgtzmx.jsp" name="selectform" target="_back">
  ...
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2" align="center">
	...
	String bjjbbm=null;
	String bjjbmc=null;
	ls_sql=" SELECT cl_clbm.clbm,cl_jgmx.bjjbbm,bdm_bjjbbm.bjjbmc,clmc,clgg,jldwmc,cj,cjjsj,fgsdj,gdj,ckmc,sfrk ";
	ls_sql+=" FROM cl_clbm,cl_jgmx,bdm_bjjbbm ";
	ls_sql+=" where cl_clbm.clbm=cl_jgmx.clbm and  cl_jgmx.dwbh='"+ssfgs+"'";
	ls_sql+=" and cl_jgmx.bjjbbm=bdm_bjjbbm.bjjbbm";
	ls_sql+=wheresql;
	ls_sql+=" order by cl_clbm.clbm,cl_jgmx.bjjbbm";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	while (rs.next())
	{
