...
try { 
	...
	ls_sql="select dwbh,ckr,cksj,lrr,lrsj,bz,khbh,ckzje,ckzsl,psfs,jhshsj,fkje,shsj,yf,pslrr,pslrsj";
	ls_sql+=" from  cl_ckd";
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#0000CC">出库批号</font></td>
      <td width="31%"> <%=ckph%> </td>
      <td align="right" width="19%"><font color="#0000CC"></font><font color="#0000CC">分公司</font></td>
      <td width="31%"> <%
	cf.selectItem(out,"select dwbh,dwmc from sq_dwxx where dwbh='"+ckdw+"'",ckdw,true);
%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#0000CC"></font>出库人</td>
      <td width="31%"> <%=ckr%> </td>
      <td align="right" width="19%"><font color="#0000CC"></font>出库时间</td>
      <td width="31%"> <%=cksj%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">出库总数量</td>
      <td width="31%"><%=ckzsl%></td>
      <td align="right" width="19%">出库总金额</td>
      <td width="31%"><%=ckzje%></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#0000CC"></font><font color="#0000CC">录入人</font></td>
      <td width="31%"> <%=lrr%> </td>
      <td align="right" width="19%"><font color="#0000CC"></font><font color="#0000CC">录入时间</font></td>
      <td width="31%"> <%=lrsj%> </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
%> </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>计划送货时间</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font>实际送货时间</td>
      <td width="31%"> 
        <input type="text" name="shsj" value="<%=shsj%>" size="20" maxlength="10" ondblclick="JSCalendar(this)">
      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font>运费</td>
      <td width="31%"> 
        <input type="text" name="yf" value="<%=yf%>" size="20" maxlength="10" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%"><font color="#CC0000">*</font><font color="#0000CC">配送录入人</font></td>
      <td width="31%"> 
        <input type="text" name="pslrr" value="<%=pslrr%>" size="20" maxlength="20" readonly>
      </td>
      <td align="right" width="19%"><font color="#CC0000">*</font><font color="#0000CC">配送录入时间</font></td>
      <td width="31%"> 
        <input type="text" name="pslrsj" value="<%=pslrsj%>" size="20" maxlength="10" readonly>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="SaveXgPsCl_ckd.jsp";
	FormName.submit();
