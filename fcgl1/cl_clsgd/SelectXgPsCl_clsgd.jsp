...
<div align="center">修改配送</div>
  <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">申购批号</td>
      <td width="31%"> 
        <input type="text" name="sgph" size="20" maxlength="11" >
      </td>
      <td align="right" width="19%">申购状态</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">申购总数量 从</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">配送方式</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">计划送货时间 从</td>
      <td width="31%"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">实际送货时间 从</td>
      <td width="31%"> 
