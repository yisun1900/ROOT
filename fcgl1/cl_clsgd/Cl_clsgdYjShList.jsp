...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT '<a href=shdgdmx.jsp?sgph=\'||sgph||\'&sgdw=\'||cl_clsgd.dwbh||\' target=_back>审核</a>'sh,sgph,dwmc,sgzsl,DECODE(sgzt,'1','未提交','2','已提交','3','一级审核','4','二级审核','5','三级审核','8','供应商下单','9','审核不通过'),lrr,lrsj,cl_clsgd.bz  ";
...
//	out.print(ls_sql);
//进行对象初始化
	pageObj.initPage("Cl_clsgdYjShList.jsp","SelectYjShSgd.jsp","","");
