...
//	out.print(ls_sql);
//进行对象初始化
	pageObj.initPage("Cl_clsgdCxEjShList.jsp","SelectCxEjShSgd.jsp","","");
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update cl_clsgd set sgzt='3',ejshr=null,ejshsj=null,ejshyj=null where "+chooseitem;
