...
<table width="100%" border="1" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="1" cellspacing="1">
  <tr>
    <td>
		<table  width="100%" border="0" style="FONT-SIZE:12" bgcolor="#FFFFFF" cellpadding="1" cellspacing="5">
		  <tr width="100%">
			<td width="20%"><div align="right" class="STYLE2">分公司名称：</div></td>
			<td width="80%"><span class="STYLE2"><%=dwmc%></span></td>
		  </tr>
		  <tr>
			<td width="20%"><div align="right" class="STYLE2">订货日期：</div></td>
  ...
  <tr>
    <td>
		<table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
		  <tr>
			<td width="20%" class="STYLE2"><div align="right">订货明细：</div></td>
			<td width="80%">&nbsp;</td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
  ...
  <tr>
    <td><table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
      <tr>
        <td width="19%" height="51" class="STYLE2"><div align="right">备注：</div></td>
        <td width="81%" class="STYLE4"><%=bz%></td>
      </tr>
  ...
  <tr>
    <td height="76"><table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
      <tr>
        <td width="31%" height="71" class="STYLE2"><div align="left">集团辅材管理中心审批：</div></td>
        </tr>
    </table></td>
  </tr>
</table>
<p align="right"><span class="STYLE3">集团辅材管理中心</span> </p>
<p align="center">&nbsp;</p>
</body>
</html>
  <%
