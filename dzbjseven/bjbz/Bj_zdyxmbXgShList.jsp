...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT DECODE(bj_zdyxmb.shbz,'N','申请','S','受理','Y',' 审核通过','W','未通过','C','重新申请') shbz,DECODE(bj_zdyshjl.sfbxg,'Y','是','N','否') sfbxg,bj_zdyxmb.xmbh,bj_zdyxmb.xmmc,bjjbmc,bj_zdyxmb.zdyxmyxq,yhmc,bj_zdyxmb.lrr,bj_zdyxmb.lrsj,dqmc,jdm_jldwbm.jldwmc,bj_zdyxmb.bj,bj_zdyxmb.clbj,bj_zdyxmb.zcf,bj_zdyxmb.rgbj,bj_zdyxmb.ysf,bj_zdyxmb.jxbj,bj_zdyxmb.shf,bj_zdyxmb.qtf,bj_zdyxmb.gycl,bj_zdyxmb.flmcgg,bj_zdyxmb.bz,xmdlmc,xmxlmc,xmflmc,smmc,bj_zdyxmb.ckxm,bj_zdyxmb.sqjl,bj_zdyshjl.slr,bj_zdyshjl.slsj,bj_zdyshjl.slsm,bj_zdyshjl.shr,bj_zdyshjl.shsj,bj_zdyshjl.shyj,DECODE(bj_zdyxmb.sfxycl,'Y','需要','N','否') sfxycl,DECODE(bj_zdyxmb.sfxyyjd,'Y','需要','N','否') sfxyyjd";
	ls_sql+=" FROM bj_zdyxmb,bdm_xmdlbm,bdm_xmxlbm,bdm_smbm,dm_dqbm,jdm_jldwbm,bdm_bjjbbm,bj_zdyshjl,bdm_xmflbm,sq_yhxx   ";
	...
	ls_sql+=" and bj_zdyxmb.shbz in('Y','W')";//N; 申请审核；S:受理申请；Y:审核通过；W:审核未通过；C:重新申请
	ls_sql+=wheresql;
...
//设置显示列
	String[] disColName={"shbz","sfbxg","yhmc","xmbh","xmmc","bjjbmc","zdyxmyxq","lrsj","dqmc","jldwmc","bj","clbj","zcf","rgbj","ysf","jxbj","shf","qtf","gycl","flmcgg","bz","xmdlmc","xmxlmc","xmflmc","smmc","ckxm","sqjl","slr","slsj","slsm","shr","shsj","shyj","sfxycl","sfxyyjd"};
	pageObj.setDisColName(disColName);

//设置按钮参数
	String[] buttonName={"删除审核"};//按钮的显示名称
	String[] buttonLink={"deletezdysh.jsp"};//按钮单击调用的网页，可以增加参数
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="2%">损耗费</td>
	<td  width="2%">其它费</td>
	<td  width="8%">工艺材料简介</td>
	<td  width="6%">辅料名称规格</td>
	<td  width="6%">备注</td>
	<td  width="3%">项目大类</td>
	<td  width="4%">项目小类</td>
	<td  width="3%">项目分类</td>
