...
//进行对象初始化
	pageObj.initPage("Bj_zdyxmbGlfxList.jsp","","","EditGlfxBj_zdyxmb.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数

//设置显示列
	String[] disColName={"shbz","dqmc","bjjbmc","xmbh","xmmc","jldwmc","sgcbj","sgdbj","bj","clbj","zcf","rgbj","ysf","jxbj","shf","qtf","clcb","rgcb","jxcb","cbenj","zdyxmyxq","gycl","flmcgg","bz","xmdlmc","xmxlmc","xmflmc","smmc","lrr","lrsj","sfxycl","sfxyyjd"};
