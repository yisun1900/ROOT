...
%></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#E8E8FF"><font color="#FF0000">*</font><font color="#0000CC">机械成本</font></td>
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#CCCCFF"><font color="#FF0000">*</font>工程基础报价</td>
              <td colspan="3" bgcolor="#CCCCFF"><input name="sgdbj" type="text" onChange="f_jsjg(editform)" value="<%=sgdbj%>" size="20" maxlength="17">
              工程基础报价=工程预算价/参数</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#CCCCFF"><font color="#FF0000">*</font>施工成本价</td>
