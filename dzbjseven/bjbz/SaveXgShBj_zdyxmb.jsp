...
try {
	...
	ls_sql="update bj_zdyxmb set xmmc=?,xmdlbm=?,xmxlbm=?,smbm=?,jldwbm=?,clbj=?,rgbj=?,jxbj=?,zcf=?,shf=?   ,ysf=?,qtf=?,bj=?,gycl=?,zdyxmyxq=?,flmcgg=?,bz=?,sfxycl=?,sfxyyjd=?,xmflbm=?,sgdbj=?,sgcbj=?,shbz=?,cbenj=?,clcb=? ";
