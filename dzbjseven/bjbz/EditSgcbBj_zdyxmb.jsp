...
<table width="100%">
  <tr>
    <td width="100%"> 
      <div align="center">维护施工成本（项目编号：<%=xmbh%>）</div>    </td>
  </tr>
  <tr>
    <td width="100%" > 
      <div align="center">
...
<form method="post" action="" name="editform" >
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">*</span>工程基础报价</td>
              <td colspan="3" bgcolor="#FFFFFF"><input name="sgdbj" type="text" value="<%=sgdbj%>" size="20" maxlength="17">
                工程基础报价=工程预算价/参数</td>
            </tr>
            <tr bgcolor="#FFFFFF">
              <td align="right" bgcolor="#FFFFFF"><span class="STYLE1">*</span>施工成本价</td>
