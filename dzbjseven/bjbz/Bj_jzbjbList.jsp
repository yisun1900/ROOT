...
//设置显示列
	String[] disColName={"xmbh","xmmc","bjbbh","bjjbmc","jldwmc","sfbxx","bj","clbj","zcf","rgbj","ysf","jxbj","shf","qtf","sgdbj","sfyxdz","zdzk","clcb","rgcb","jxcb","cbenj","sgcbj","glxmbh","xmdlmc","xmxlmc","xmflmc","smmc","gycl","flmcgg","bz","sfxycl","sfxyyjd","lrr","lrsj","xh","dqmc"};
