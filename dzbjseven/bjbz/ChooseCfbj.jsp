...
%> 
            ...
            <tr align="center"> 
              <td colspan="4"> 
				<BR>
				<input name="button2" type="button" onClick="LoadCfbj(insertform)"  value="导入拆分报价-Excel">
				<input name="button3" type="button" onClick="LoadCfbjTxt(insertform)"  value="导入拆分报价-Txt" >
				<BR>
				<BR> 
				<A HREF="CSH06-电子报价拆分项.xls"><B>下载【拆分报价Excel】模板</B></A>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<A HREF="CSH06-电子报价拆分项.txt"><B>下载【拆分报价Txt】模板</B></A>
			  </td>
            </tr>
        </table>
</form>
...
function LoadCfbj(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="LoadCfData.jsp";
	FormName.submit();
	return true;
}

function LoadCfbjTxt(FormName)//参数FormName:Form的名称
{
	if(	javaTrim(FormName.bjbbh)=="") {
		alert("请选择[报价版本号]！");
		FormName.bjbbh.focus();
	...
	FormName.action="LoadCfDataTxt.jsp";
	FormName.submit();
	return true;
}
