...
<form method="post" action="SaveEditAllBjjb.jsp" name="editform">
          <table width="100%" border="0" style="FONT-SIZE:12" bgcolor="#999999" cellpadding="2" cellspacing="2">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td colspan="3"><select name="hxbm" style="FONT-SIZE:12PX;WIDTH:152PX">
                <%
	cf.selectItem(out,"select hxbm,hxmc from dm_hxbm order by hxbm",hxbm);
%>
              </select>
              <font color="#0000FF"><strong>注意：若是精装，请注意户型是否正确</strong> </font></td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
...
%>
            ...
            <tr> 
              <td height="2" colspan="4" align="center"> 
                <input type="hidden" name="czfs"  value="2" >
                <input type="hidden" name="xmclfs"  value="1" >
                  <input type="hidden" name="oldbjjb"  value="<%=bjjb%>" >
                  <input type="hidden" name="khbh"  value="<%=khbh%>" >
                  <input type="button"  value="调报价级别" onClick="f_do(editform)">
                  <input type="button" onClick="f_zcxm(editform)"  value="重置精装报价项目">
