...
<input type="hidden" name="khbh" value="<%=khbh%>" >
  ...
  <tr bgcolor="#CCCCCC"  align="center" style="FONT-WEIGHT: bold; Z-INDEX: 5; POSITION: relative;TOP: expression(this.offsetParent.scrollTop)"> 
    ...
    <td width="253"style="POSITION: relative; BACKGROUND-COLOR: #CC6600">项目名称</td>
...
<%
	...
	ls_sql+=" FROM bj_fjxx";
    ls_sql+=" where khbh='"+khbh+"'";
	ls_sql+=" order by bj_fjxx.xuhao,bj_fjxx.jgwzbm ";
	ps= conn.prepareStatement(ls_sql);
...
<%
    ...
    ls_sql+=" and bj_bjxmmx.tcnxmbz='Y'";//套餐内项目标志
