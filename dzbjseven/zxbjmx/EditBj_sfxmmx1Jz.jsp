            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td colspan="3"> 
                <select name="sfxmbm" style="FONT-SIZE:12PX;WIDTH:522PX" onChange="getSfxm(insertform)">
                  <%
	cf.selectItem(out,"select sfxmbm,sfxmmc||DECODE(sfbxx,'1','（必选）','2','') from bdm_sfxmbm where sfjzsf='Y' and dqbm='"+dqbm+"' and (sfxsq='1' OR (sfxsq='2' and sfxmbm in(select sfxmbm from sq_sfxmsq where ygbh='"+ygbh+"'))) order by sfxmbm",sfxmbm);
%> 
                </select>              </td>
            </tr>
            <tr bgcolor="#FFFFFF">
