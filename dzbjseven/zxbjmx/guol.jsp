...
function f_gl(FormName)//参数FormName:Form的名称
{
	...
	FormName.action="Bj_jzbjbXmbhCxList.jsp?jzbz=<%=jzbz%>&dqbm=<%=dqbm%>&khbh=<%=khbh%>";
	FormName.submit();
	return true;
}
...
{
	FormName.target="main";
	FormName.action="Bj_khbjmxList3.jsp?khbh=<%=khbh%>";
	FormName.submit();
...
{
	FormName.target="main";
	FormName.action="/dzbjseven/bjbz/InsertBj_zdyxmb1.jsp?dqbm=<%=dqbm%>&khbh=<%=khbh%>";
	FormName.submit();
	return true;
}
...
{
	FormName.target="main";
	FormName.action="EnetrExcelCopy.jsp?khbh=<%=khbh%>";
	FormName.submit();
	return true;
}
