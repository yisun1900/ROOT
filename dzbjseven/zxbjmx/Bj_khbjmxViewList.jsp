...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>
  <tr bgcolor="#FFFFFF"> 
	...
	<td  width="5%" align="center">折前单价</td>
	<td  width="5%" align="center">折前金额</td>
...
<%
	...
	while (rs1.next())
	{
		...
		ls_sql="SELECT sum(bj_gclmx.sl) sl,sum(bj_gclmx.sl*bj_bjxmmx.zqdj) as zqje,sum(bj_gclmx.sl*bj_bjxmmx.dj) as je";
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,xmmc,jldwmc,bj_bjxmmx.zqdj,bj_bjxmmx.zk,bj_bjxmmx.dj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.zqdj as zqje,bj_gclmx.sl*bj_bjxmmx.dj as je,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz,bj_bjxmmx.zcf,bj_bjxmmx.cldj,bj_bjxmmx.shf,bj_bjxmmx.qtf,bj_bjxmmx.ysf,bj_bjxmmx.rgdj,bj_bjxmmx.jxdj";
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td  align="center"> <%=zcf%>&nbsp;</td>
				<td  align="center"><%=cldj%> &nbsp;</td>
				<td align="center"><%=rgdj%> &nbsp;</td>
				<td align="center"> <%=shf%> &nbsp;</td>
				
				<td align="center"> <%=ysf%> &nbsp;</td>
				<td align="center"> <%=jxdj%> &nbsp;</td>
				<td align="center"> <%=qtf%> &nbsp;</td>
...
%> 
 ...
 <tr bgcolor="#FFFFFF" align="center"  height="25"> 
	...
	<td >&nbsp; </td>
	<td >&nbsp;<%=cf.formatDouble(allzqqye,"#########.##")%></td>
	<td >&nbsp; </td>
  </tr>
...
*/      
  ...
  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
	...
	<td align="left" colspan="6" >&nbsp;</td>
	<td align="left"  colspan="2">&nbsp;<%=bz2%> </td>
  </tr> 
 		<%
	}
  }else	{ %> 
...
%> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="left" colspan="15">工程总价：<%=cf.formatDouble(allzj,"#########.##")%>元</td>
  </tr>
</table>
