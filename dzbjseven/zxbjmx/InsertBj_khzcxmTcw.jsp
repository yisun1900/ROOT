...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="3%"><span class="STYLE2">单价</span></td>
	<td  width="5%"><span class="STYLE2">结构位置</span></td>
	<td  width="15%"><span class="STYLE2">配套说明</span></td>
	<td  width="4%">编组名称</td>
	<td  width="10%">产品名称</td>
	<td  width="6%">品牌</td>
	<td  width="8%">型号</td>
...
//				zp="<img src=\"\\tc\\csrjtc\\zck\\images\\"+nbbm+".JPG\" width=\"100\">";
			...
			<tr bgcolor="#FFFFFF"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
			  <td rowspan="<%=count%>">
				<A HREF="SaveInsertBj_khzcxmDb.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>&bzmc=<%=bzmc%>&jgwzbm=<%=jgwzbm%>">选择</A>
			  </td>
...
//			zp="<img src=\"\\tc\\csrjtc\\zck\\images\\"+nbbm+".JPG\" width=\"100\">";
		...
		<tr bgcolor="#FFFFFF"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  <td>
			<A  HREF="SaveInsertBj_khzcxmDb.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>&cpbm=<%=cpbm%>&jgwzbm=<%=jgwzbm%>">选择</A>
		  </td>
		  <td>&nbsp;</td>
		  <td><%=nbbm%></td>
		  <td><%=ppmc%></td>
