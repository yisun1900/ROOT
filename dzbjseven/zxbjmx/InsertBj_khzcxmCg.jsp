...
try {
	...
	ls_sql="select zdsl,sjjmsl,sjsl";
...
<div align="center">录入客户主材项目－－橱柜</div>
...
<%
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF" align='center'>
		  <td>
			<A HREF="DeleteBj_khzcxmCg.jsp?khbh=<%=khbh%>&sxh=<%=sxh%>" target="_blank">删除</A>
			<A HREF="EditBj_khzcxmCg.jsp?khbh=<%=khbh%>&sxh=<%=sxh%>" target="_blank">修改</A>
		  </td>
		  <td><%=sxh%></td>
		  <td><%=sl%></td>
		  <td><%=dj%></td>
...
//	String ppmc=null;
	...
	while (rs1.next())
	{
		...
		if (rs.next())
		{
			...
			<tr bgcolor="#FFFFFF"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
			  <td rowspan="<%=count%>">
				<A HREF="SaveInsertBj_khzcxmCg.jsp?khbh=<%=khbh%>&tccplbbm=<%=tccplbbm%>&tccpdlbm=<%=tccpdlbm%>&jgwzbm=<%=jgwzbm%>&bzmc=<%=bzmc%>">选择</A>
			  </td>
	...
	while (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  <td>
			<A  HREF="SaveInsertBj_khzcxmCg.jsp?khbh=<%=khbh%>&tccplbbm=<%=tccplbbm%>&tccpdlbm=<%=tccpdlbm%>&jgwzbm=<%=jgwzbm%>&cpbm=<%=cpbm%>">选择</A>
		  </td>
		  <td>&nbsp;</td>
		  <td><%=nbbm%></td>
		  <td><%=ppmc%></td>
