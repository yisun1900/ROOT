	...
	while (rs.next())
	{
		...
		%> 
		  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
			...
			<td colspan="9" align="left"><%=cf.formatDouble(sfje1,"#########.##")%>元</td>
			<td>&nbsp;</td>
		 </tr>
 		<%
	}
...
//	out.println(ls_sql);
	...
	while (rs.next())
	{
		...
		%> 
		  ...
		  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
			...
			<td ><%=jldwmc%></td>
			<td ><%=qtfsl%></td>
			<td colspan="6"><%=cf.formatDouble(sfje,"#########.##")%>元</td>	
			<td>&nbsp;</td>
			<td align="left"  ><%=bz%></td>
		  </tr>
	...
	<td colspan="2">小计：</td>
	<td colspan="2">&nbsp;</td>
	<td colspan="6"><%=cf.formatDouble(allsfje,"#########.##")%>元</td>	
	<td>&nbsp;</td>
	<td>&nbsp;</td>
  </tr>
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF" align="center"  height="31"> 
				...
				<td >项</td>
				<td >1</td>
				<td colspan="6" > <%=cf.formatDouble(sfje2,"#########.##")%>元</td>
				<td>&nbsp;</td>
