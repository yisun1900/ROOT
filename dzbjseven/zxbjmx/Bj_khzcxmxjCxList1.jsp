...
<input type="hidden" name="khbh" value="0000526" >
  ...
  <table border="0" cellspacing="1" bgcolor="#999999" cellpadding="1" width="100%" style='FONT-SIZE: 12px'>
	<tr bgcolor="#CCCCCC"  align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
	  ...
	  <td width="12%" align="center">项目</td>
	  <td width="15%" align="center">产品类别</td>
	  <td width="7%" align="center">选主材</td>
	  <td width="8%" align="center">实际数量</td>
	  <td width="7%" align="center">减免</td>
	  <td  width="7%" align="center">实际减免数量</td>
	  <td width="29%" align="center">说明</td>
    </tr>
					...
					<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
					  ...
					  <td rowspan="4" align="center">洁具</td>
					  <td rowspan="4" align="center">卫生间</td>
					  ...
					  <td align="left">&nbsp;</td>
					    ...
					    <tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
					      <td rowspan="10" align="center">三</td>
					      <td rowspan="10" align="center">瓷砖</td>
					...
					<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
					  ...
					  <td align="left">&nbsp;</td>
						...
						<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
						  ...
						  <td rowspan="2" align="center">铝扣板</td>
