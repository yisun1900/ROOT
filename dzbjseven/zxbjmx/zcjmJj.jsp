...
try {
	...
	ls_sql="select sjjmsl,bzsl,sjsl";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveZcjmJj.jsp" name="insertform">
<div align="center">洁具减免</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td align="right" width="18%"><span class="STYLE1">*</span><span class="STYLE3">结构位置</span></td> 
  <td width="32%"><select name="jgwzbm" style="FONT-SIZE:12PX;WIDTH:152PX">
    <option value="<%=jgwzbm%>"><%=jgwzbm%></option>
  </select></td>
</tr>
<tr bgcolor="#FFFFFF">
