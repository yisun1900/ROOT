...
<%
	ls_sql="SELECT jgwzbm,fjmj,fjg,zdyxmmj,zdybzmj,xuhao,bz,fjzcxq,fjlx";
	ls_sql+=" FROM bj_fjxx";
...
//	out.println(ls_sql);
	...
	<td>
		<select name="fjlx" style="FONT-SIZE:12PX;WIDTH:82PX">
			<option value=""></option>
		  <%
			cf.selectToken(out,"1+厨房&2+卫生间&4+阳台",fjlx);
		%>
		</select>	
	</td>
	<td>
