...
.STYLE3 {font-size: 12px}
 ...
 td,th{border:1px solid #000;border-width:0 1px 1px 0;margin:2px 0 2px 0;text-align:center;}
...
<table border="0" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 14px;'>
 ...
 <td colspan="9"  style='FONT-SIZE: 24px;' ><B style="">城市人家装饰公司</B> &nbsp;&nbsp;<B  style="font-size:20px">工程（预）结算表</B></td>
  </tr>
  
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2" >客户姓名：<%=khxm%></td>
    <td colspan="6" >联系电话：<%=lxfs%></td>
    <td colspan="1" >工程地址：<%=fwdz%></td>
</tr>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px'>-->
  <tr bgcolor="#FFFFFF"> 
    ...
    <td  width="52%" align="center" >工艺做法及材料说明</td>
  </tr>
</table>
...
<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px;border:1px solid #000;border-width:1px 1px 0 1px;'>
...
<%
	...
	//	out.println(ls_sql);
		...
		//输出项目明细
		ls_sql="SELECT bj_bjxmmx.xh xh,trim(bj_bjxmmx.xmbh)||DECODE(bjlx,'1','','2','增') xmbh,xmmc,jldwmc,bj_bjxmmx.dj,bj_gclmx.sl,bj_gclmx.sl*bj_bjxmmx.dj as je,gycl,bj_bjxmmx.flmcgg,bj_bjxmmx.bz,bj_bjxmmx.zcf,bj_bjxmmx.cldj,bj_bjxmmx.shf,bj_bjxmmx.qtf,bj_bjxmmx.rgdj";
		...
		while (rs.next())
		{
			...
			%> 
			  <tr bgcolor="#FFFFFF"> 
				...
				<td width="52%"  style="text-align:left" ><%=gycl%></td>
			  </tr>
...
%> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td  style="text-align:left" colspan="11">工程总价：<%=cf.formatDouble(allzj,"#########.##")%>元</td>
  </tr>
</table>

<table border="1" width="100%" cellspacing="0" cellpadding="1"  bgcolor="#000000" style='FONT-SIZE: 12px;border:1px solid #000;border-width:0px 1px  0px 1px;'>
  <tr bgcolor="#FFFFFF"> 
  <td colspan="1" >温馨提示</td>
  <td colspan="6" height="42">
  <table width="100%" height="107"  style='FONT-SIZE: 12px;border:1px solid #000;border-width:0px 0 0 0px; '>
  <tr ><td width="948" style="border-width:0px 0px 1px 0px;text-align:left">1、所有物业押金及各种形式的管理款项敬请您承担，我方承担因施工违反物业规定而扣出的部分费用。</td>
  </tr>
   <tr><td style="border-width:0px 0px 1px 0px;text-align:left">2、施工中如有漏报项目或增加项目，则按实际施工项目结算工程款。</td><tr>
   <tr><td style="border-width:0px 0px 1px 0px;text-align:left">3、乳胶漆每户除白色外可另选两色（浅色），另外每增加一色按150元/色收费，深色按450元/色收费。</td><tr>
    <tr>
      <td style="border-width:0px 0px 1px 0px;text-align:left">4、水电路改造费用在中期时按实际发生工程量结算。电路施工：明走管26元/米；原墙线管抽线20元/米（长度计量若走线不足0.5米忽略不计，大于0.5米按一米计算；新安装暗盒7元/个，更改暗盒4元/个）水电施工；PPR管走65元/米、暗走管80元/米。（祥见合同附件）</td>
    <tr>
	<tr>
      <td style="border-width:0px 0px  0px 0px;text-align:left">5、本报价不含税金。（税金按工程总价的百分之七收取）开机打发票，不再收取费用。</td>
    <tr>
  </table>
  </td>
  </tr>
...
<tr style="border-width:0px 0px  0px 0px;"><td style="border-width:0px 0px  0px 0px;">

<table border="0" width="100%" cellspacing="0" cellpadding="1"  style='FONT-SIZE: 12px;border-width:0px 0px  0px 0px;'>
<tr style="border-width:0px 0px  0px 0px;">
<td  style="border-width:0px 0px  0px 0px;" height="10"></td>
</tr>
<tr style="border-width:0px 0px  0px 0px;">
   <td  style="border-width:0px 0px  0px 0px;" width="300px"></td>
   <td style="border-width:0px 0px  0px 0px;"><b>甲方签字：</b></td>
   <td style="border-width:0px 0px  0px 0px;"> <b>乙方签字：</b></td>
    <td style="border-width:0px 0px  0px 0px;"><b></b></td>
 </tr>
</table>
