...
//		out.println(ls_sql);
		...
		if (rowsl>0)
		{
			ls_sql="SELECT bdm_glflbm.glflmc,bj_khglfxb.glbxh,bj_khglfxb.glfxclmc,jdm_jldwbm.jldwmc,bj_khglfxb.xhl,bj_khglfxb.dj,jxc_clbm.ppmc,jxc_clbm.gg,bj_khglfxb.jqsfl,bj_khglfxb.bsfl,bj_khglfxb.tvocsfl  ";
			ls_sql+=" FROM jdm_jldwbm,bdm_glflbm,bj_khglfxb,jxc_clbm  ";
			...
			if (rs1.next())
			{
				...
				pp=cf.fillHtml(rs1.getString("ppmc"));
