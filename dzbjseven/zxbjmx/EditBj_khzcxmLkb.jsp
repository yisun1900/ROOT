...
try {
	...
	ls_sql="select cpbm,nbbm,tccpdlbm,tccplbbm,bjjbbm,ppmc,cpmc,xh,gg,jldw,ptcpsm,sl,jgwzbm,dj";
...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveEditBj_khzcxmLkb.jsp" name="insertform">
...
<tr bgcolor="#FFFFFF">
  ...
  <td>
	<select name="jgwzbm" style="FONT-SIZE:12PX;WIDTH:152PX">
		<%
		cf.selectItem(out,"select jgwzbm c1,jgwzbm c2 from bj_fjxx where khbh='"+khbh+"' and jgwzbm='"+jgwzbm+"'",jgwzbm);
	%>
	  </select>  </td>
</tr>
<tr bgcolor="#FFFFFF">
