...
<%
		...
		if (rs.next())
		{
			...
			if (row==1)
			{
				...
				<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
				  ...
				  <td align="center" rowspan="<%=fjsl%>"><%=jgwzbm%></td>
				  <td align="center"><%=clxlmc%></td>
				  <td align="center"><a href="InsertBj_khzcxmLkb.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>&tccplbbm=<%=tccplbbm%>&jgwzbm=<%=jgwzbm%>" target="_blank">选择</a></td>
				  <td>&nbsp</td>
				  <td><%=cf.formatDouble(sjsl)%></td>
	...
	if (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  ...
		  <td align="center"><%=clxlmc%></td>
		  <td align="center"><a href="InsertBj_khzcxmDb.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
		  <td>&nbsp</td>
		  <td><%=cf.formatDouble(sjsl)%></td>
		  <td align="center"><a href="zcjmDb.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>" target="_blank">减免</a></td>
		  <td><%=cf.formatDouble(sjjmsl)%></td>
		  <td align="left"></td>
		</tr>
		<%
	...
	int tcwsl=0;
	ls_sql="select count(*)";
	ls_sql+=" from  tc_khcytcwxm,jxc_cldlbm,jxc_clxlbm";
    ls_sql+=" where tc_khcytcwxm.tccpdlbm=jxc_cldlbm.cldlbm(+) and tc_khcytcwxm.tccplbbm=jxc_clxlbm.clxlbm(+)";
	ls_sql+=" and tc_khcytcwxm.khbh='"+khbh+"'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
	...
	ls_sql="select tccplbbm,tccpdlbm,jxc_clxlbm.clxlmc,jxc_cldlbm.cldlmc,sjsl";
	ls_sql+=" from  tc_khcytcwxm,jxc_cldlbm,jxc_clxlbm";
    ls_sql+=" where tc_khcytcwxm.tccpdlbm=jxc_cldlbm.cldlbm(+) and tc_khcytcwxm.tccplbbm=jxc_clxlbm.clxlbm(+)";
	ls_sql+=" and tc_khcytcwxm.khbh='"+khbh+"'";
	...
	if (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  ...
		  <td align="center"><%=clxlmc%></td>
		  <td align="center"><a href="InsertBj_khzcxmTcw.jsp?khbh=<%=khbh%>&tccpdlbm=<%=tccpdlbm%>&tccplbbm=<%=tccplbbm%>" target="_blank">选择</a></td>
		  <td >&nbsp;</td>
		  <td><%=cf.formatDouble(sjsl)%></td>
		  <td >&nbsp;</td>
		  <td >&nbsp;</td>
...
%>
	...
	<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
	  ...
	  <td align="center"><a href="InsertBj_khzcxmTcwQt.jsp?khbh=<%=khbh%>" target="_blank">选择</a></td>
	  <td align="center">&nbsp;</td>
	  <td >&nbsp;</td>
	  <td >&nbsp;</td>
	  <td >&nbsp;</td>
...
<%
	...
	String yqsh="";
	int yqyssl=0;
	ls_sql="select yqpp,yqsh,yqyssl";
	ls_sql+=" from  tc_khjgb";
	ls_sql+=" where khbh='"+khbh+"'";
	ps= conn.prepareStatement(ls_sql);
	rs =ps.executeQuery();
	if (rs.next())
	{
		yqpp=cf.fillNull(rs.getString("yqpp"));
		yqsh=cf.fillNull(rs.getString("yqsh"));
		yqyssl=rs.getInt("yqyssl");
	}
	rs.close();
	ps.close();
%>
	<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
	  ...
	  <td align="center"><a href="InsertTc_khjgb.jsp?khbh=<%=khbh%>" target="_blank">选择</a></td>
	  <td >&nbsp;</td>
	  <td >&nbsp;</td>
	  <td  rowspan="1" align="center">&nbsp;</td>
	  <td align="center">&nbsp;</td>
	  <td align="left"><%=yqpp%>;<%=yqsh%>;油漆颜色数量:<%=yqyssl%></td>
	</tr>
...
<%
	...
	String bz=null;
//	String lx=null;
	ls_sql="select lbxmbm,lbmc,xmmc,ppmc,xh,jldw,dj,bzsl,sjsl,bz,lx ";
	ls_sql+=" from  tc_khlbmx";
    ls_sql+=" where khbh='"+khbh+"'";
	...
	if (rs.next())
	{
		...
		<tr bgcolor="#FFFFFF" align="center" onMouseOver="inTr(this)" onMouseOut="outTr(this)"  onclick="onclickTr(this)">
		  ...
		  <td align="center"><%=ppmc%></td>
			...
			{
				%>
				  <td><a href="InsertLbxm.jsp?khbh=<%=khbh%>&lbxmbm=<%=lbxmbm%>" target="_blank">选择</a></td>
				<%
			}
			else{
				%>
