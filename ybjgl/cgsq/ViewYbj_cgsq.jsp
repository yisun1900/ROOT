...
String whereybj_cgsq_sqbh=null;
whereybj_cgsq_sqbh=cf.GB2Uni(request.getParameter("sqbh"));
...
try {
	...
	ls_sql+=" from  sq_dwxx,ybj_cgsq,crm_khxx";
	ls_sql+=" where ybj_cgsq.dwbh=sq_dwxx.dwbh and  (ybj_cgsq.sqbh="+whereybj_cgsq_sqbh+")  ";
...
<%
	...
	ls_sql+=" and (ybj_fpybj.sqbh="+whereybj_cgsq_sqbh+") ";
    ls_sql+=wheresql;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("","","","");
