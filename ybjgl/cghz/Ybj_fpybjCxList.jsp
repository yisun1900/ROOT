...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT ybj_fpybj.sqbh as sqbh,d.khxm cgkhxm,a.dwmc sbdm,ybj_fpybj.fpsj,ybj_fpybj.khbh as khbh,sgdmc sgd,c.khxm as crm_khxx_khxm,c.fwdz as crm_khxx_fwdz,c.sjs  ";
	ls_sql+=" FROM crm_khxx c,crm_khxx d,ybj_cgsq,ybj_fpybj,sq_dwxx a,sq_sgd";
    ls_sql+=" where ybj_fpybj.khbh=c.khbh and ybj_fpybj.sqbh=ybj_cgsq.sqbh and ybj_cgsq.khbh=d.khbh";
    ls_sql+=" and ybj_cgsq.dwbh=a.dwbh and c.sgd=sq_sgd.sgd";
    ls_sql+=wheresql;
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Ybj_fpybjCxList.jsp","SelectCxYbj_fpybj.jsp","","EditYbj_fpybj.jsp");
