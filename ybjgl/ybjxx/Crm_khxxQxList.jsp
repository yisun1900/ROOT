...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxQxList.jsp","SelectQxCrm_khxx.jsp","","InsertYbj_ybjqx.jsp");
...
//设置按钮参数
	String[] buttonName={"批量取消"};//按钮的显示名称
	String[] buttonLink={"Crm_khxxQxList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update crm_khxx set ybjbz='N' where "+chooseitem;

		sql[1] =" insert into ybj_ybjqx ( khbh,ssfgs,qxr,qxsj,lrr,lrsj,lrbm,bz )";
		sql[1]+=" select khbh,fgsbh,'"+yhmc+"',TRUNC(SYSDATE),'"+yhmc+"',TRUNC(SYSDATE),'"+lrbm+"','批量取消'";
		sql[1]+=" from crm_khxx";
		sql[1]+=" where "+chooseitem;
...
<tr bgcolor="#CCCCCC"  align="center">
	...
	<td  width="6%">施工队</td>
	<td  width="8%">签约店面</td>
	<td  width="8%">样板间登记时间</td>
	<td  width="8%">样板间有效期</td>
	<td  width="6%">材质</td>
	<td  width="5%">风格</td>
	<td  width="7%">价位</td>
	<td  width="7%">面积</td>
