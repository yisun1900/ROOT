...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT khbh,khxm,fwdz,sjs,sgdmc sgd,a.dwmc sbdm,sjkgrq,sjjgrq,czmc,fgflmc,zxjwmc,hxmjmc,ysmc ";
	...
	ls_sql+=" and crm_khxx.ybjbz='N' and crm_khxx.czbm=dm_czbm.czbm(+)";
    ls_sql+=wheresql;
	ls_sql+=" order by khbh desc";
//	out.println(ls_sql);
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Crm_khxxDjList.jsp","SelectDjCrm_khxx.jsp","EditCrm_khxx.jsp","");
