...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT ybj_fpybj.sqbh as sqbh,d.khxm cgkhxm,a.dwmc sbdm,ybj_fpybj.fpsj,sgdmc sgd,DECODE(ybj_fpybj.clzt,'N','未写回执','Y','已写回执','H','已核实'),DECODE(ybj_fpybj.cgmyd,'Y','满意','N','不满意'),DECODE(ybj_fpybj.hsjg,'Y','属实','N','不属实'),ybj_fpybj.khbh as khbh,c.khxm,c.fwdz  ";
...
//    ls_sql+=" order by ybj_fpybj.sqbh";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Ybj_fpybjCxList.jsp","SelectCxYbj_fpybj.jsp","","");
