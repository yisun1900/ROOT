...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
	...
	ls_sql="SELECT crm_khxx.khbh,crm_khxx.khxm, DECODE(ybj_ybjsb.clzt,'1','未审核','2','已审核'),crm_khxx.fwdz,crm_khxx.sjs,sgdmc,crm_khxx.zjxm,sq_dwxx.dwmc ssfgs,ybj_ybjsb.sbr,ybj_ybjsb.sbsj,ybj_ybjsb.ybjyxq,ybj_ybjsb.lrr,ybj_ybjsb.lrsj,ybj_ybjsb.bz  ";
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Ybj_ybjsbSpList.jsp","SelectSpYbj_ybjsb.jsp","","SpEditYbj_ybjsb.jsp");
//	pageObj.setPageRow(10);//设置每页显示记录数
	pageObj.setEditStr("审批");//设置每页显示记录数
/*
//设置显示列
...
//设置按钮参数
	...
	String[] buttonLink={"Ybj_ybjsbSpList.jsp"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="update ybj_ybjsb set shr='"+yhmc+"',shsj=TRUNC(SYSDATE),shjl='Y',shsm='批量审批',clzt='2' where "+chooseitem;
