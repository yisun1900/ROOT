...
<form method="post" action="Crm_khxxSbList.jsp" name="selectform">
...
%> 
	...
	if (yhjs.equals("A0") || yhjs.equals("A1"))
	{
		cf.selectItem(out,"select yhmc,yhmc||'（'||dwmc||'）' from sq_yhxx,sq_dwxx where sq_yhxx.ssfgs=sq_dwxx.dwbh and zwbm='05' and sfzszg in('Y','N') order by sq_yhxx.ssfgs,yhmc","");
	}
	else{
