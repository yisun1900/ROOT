...
<form method="post" action="SaveXgFbEditYbj_ybjsb.jsp" name="editform">
...
%> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="32%"> 
                <input type="text" name="fbr" value="<%=fbr%>" size="20" maxlength="20" readonly>
              </td>
              <td width="17%"> 
                <div align="right"><font color="#FF0000">*</font><font color="#0000CC">发布时间</font></div>
              </td>
              <td width="33%"> 
                <input type="text" name="fbsj" value="<%=fbsj%>" size="20" maxlength="10" readonly>
              </td>
            </tr>
            <tr bgcolor="#FFFFFF"> 
              <td width="18%" align="right">发布说明</td>
              <td colspan="3"> 
                <textarea name="fbsm" cols="71" rows="3"><%=fbsm%></textarea>
              </td>
            </tr>
            <tr align="center"> 
