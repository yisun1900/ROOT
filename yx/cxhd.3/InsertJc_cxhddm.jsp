...
<form method="post" action="" name="editform">
          ...
          <%
	cf.mutilSelectItem(out,"select dwbh c1,dwmc c2 from sq_dwxx where ssfgs='"+fgsbh+"' and cxbz='N' and dwlx='F2' order by dwbh","select dwbh from jc_cjhddm where cxhdbm='"+cxhdbm+"'");
%> 
                </select>
              </td>
            </tr>
