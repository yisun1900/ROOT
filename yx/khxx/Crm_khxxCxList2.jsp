...
<%
	...
	ls_sql="SELECT crm_zxkhxx.khbh as khbh,crm_zxkhxx.ywy as crm_zxkhxx_ywy,crm_zxkhxx.sjs as crm_zxkhxx_sjs,sq_dwxx.dwmc as sq_dwxx_dwmc,crm_zxkhxx.khxm as crm_zxkhxx_khxm,crm_zxkhxx.fwdz as crm_zxkhxx_fwdz,crm_zxkhxx.lxfs as crm_zxkhxx_lxfs,crm_zxkhxx.lfsj as crm_zxkhxx_lfsj,crm_zxkhxx.bz as crm_zxkhxx_bz";
	
	ls_sql+=" FROM crm_zxkhxx,sq_dwxx  ";
    ls_sql+=" where crm_zxkhxx.zxdjbm=sq_dwxx.dwbh  ";
	ls_sql+=" and crm_zxkhxx.khbh not in (select crm_khxx.khbh from crm_khxx) ";
    ls_sql+=wheresql;
...
<CENTER >
  <B><font size="3">营销部在谈单统计表</font></B>
</CENTER>
<%
	pageObj.out=out;
	pageObj.getDate(1);
