...
try {
	...
	ls_sql="update yx_lsdcb set dqbm=?,xqmc=?,cqbm=?,dz=?,jw=?,xz=?,wyxs=?,zlhx=?,zlhxmj=?,lxsj=?,fyssj=?,jfhs=?,xqfzr=?,xqfzrdh=?,kfs=?,kfslxr=?,kfslxrzw=?,kfslxrdh=?,wygsmc=?,wydh=?,wylxr=?,wylxrzw=?,lrr=?,lrsj=?,fgsbh=? ";
