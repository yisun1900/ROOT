...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgSpYx_xqcxhdgl.jsp" name="editform">
<div align="center">修改－审批</div>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="32%"> 
        <select name="spjl" style="FONT-SIZE:12PX;WIDTH:152PX">
          <option value=""></option>
          <%
	cf.selectToken(out,"Y+同意&N+不同意",spjl);
%> 
        </select>
      </td>
      <td align="right" width="18%">&nbsp;</td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"> 
        <textarea name="spyj" cols="72" rows="3"><%=spyj%></textarea>
      </td>
    </tr>
