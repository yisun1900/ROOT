...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_cxhdJsList.jsp" name="selectform">
<div align="center">促销活动管理－活动结束</div>
...
%> 
      ...
      <td align="right" width="20%">最低订金</td>
      <td width="30%"> 
        <input type="text" name="jc_cxhd_dj" size="20" maxlength="8" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td align="right" width="19%">签单折扣</td>
      <td width="31%"> 
        <input type="text" name="jc_cxhd_qdhdzk" size="20" maxlength="9" >
      </td>
      <td align="right" width="20%">增减项折扣</td>
      <td width="30%"> 
        <input type="text" name="jc_cxhd_zjxhdzk" size="20" maxlength="9" >
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3">
        ...
        结算打折(按折前收家装款) 
        <input type="radio" name="zklx" value="3">
        结算打折(按折后收家装款) 
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> <%
	cf.radioToken(out, "jc_cxhd_jsbz","N+未结束&Y+结束","N");
%> </td>
...
{
	if(!(isNumber(FormName.jc_cxhd_dj, "最低订金"))) {
		return false;
	}
	if(!(isFloat(FormName.jc_cxhd_qdhdzk, "签单折扣"))) {
		return false;
	}
	if(!(isFloat(FormName.jc_cxhd_zjxhdzk, "增减项折扣"))) {
		return false;
	}
