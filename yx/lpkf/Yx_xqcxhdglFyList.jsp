...
//    ls_sql+=" and yx_xqcxhdgl.fasfwc='N' ";
    ls_sql+=wheresql;
    ls_sql+=" order by yx_xqcxhdgl.fgsbh,yx_xqcxhdgl.lrsj";
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Yx_xqcxhdglFyList.jsp","SelectFyYx_xqcxhdgl.jsp","","InsertYx_xqhdfygl.jsp");
...
//设置显示列,yx_xqcxhdgl.jzsj,yx_xqcxhdgl.yjfy,yx_xqcxhdgl.yjcc,yx_xqcxhdgl.sjfy,yx_xqcxhdgl.sjcc, DECODE(yx_xqcxhdgl.spjl,'Y','同意','N','不同意'),yx_xqcxhdgl.spr,yx_xqcxhdgl.spsj,yx_xqcxhdgl.spyj,yx_xqcxhdgl.lrr,yx_xqcxhdgl.lrsj,dqmc,yx_lsdcb.kfs,yx_lsdcb.fyssj,yx_lsdcb.jw,yx_xqcxhdgl.bz  
	String[] disColName={"spzt","spjl","xqmc","xqhdmc","dwmc","yjfy","yjcc","sjfy","sjcc","scbfzr","scbfzrdh","scbzrs","scbsffz","gjjzgwrs","ryydl","kfql","fasfwc","kfxs","spr","spsj","spyj","lrr","lrsj","dqmc","kfs","fyssj","jw","bz"};
	pageObj.setDisColName(disColName);


//设置主键
	String[] keyName={"xqbh","xqhdmc"};
	pageObj.setKey(keyName);
	pageObj.setEditStr("费用");
