...
<body bgcolor="#FFFFFF">
<form method="post" action="SaveXgFyYx_xqcxhdgl.jsp" name="editform">
<div align="center">修改－活动费用 </div>
...
%> </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="34%"> 
        <input type="text" name="sjfy" size="20" maxlength="16"  value="<%=sjfy%>" >
      </td>
      <td align="right" width="17%"><font color="#CC0000">*</font>实际产出</td>
      <td width="33%"> 
        <input type="text" name="sjcc" size="20" maxlength="16"  value="<%=sjcc%>" >
      </td>
    </tr>
