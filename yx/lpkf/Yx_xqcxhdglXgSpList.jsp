...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Yx_xqcxhdglXgSpList.jsp","SelectXgSpYx_xqcxhdgl.jsp","","XgSpYx_xqcxhdgl.jsp");
...
//设置按钮参数
	...
	String[] buttonLink={"deleteYx_xqcxhdglXgSp.jsp?"};//按钮单击调用的网页，可以增加参数
