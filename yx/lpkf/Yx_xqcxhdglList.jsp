...
if (pageObj.needInit(pageStr))//判断是否需要初始化，若第一次进入此页，则需要初始化
{
    ...
    pageObj.sql=ls_sql;
//进行对象初始化
	pageObj.initPage("Yx_xqcxhdglList.jsp","SelectYx_xqcxhdgl.jsp","","EditYx_xqcxhdgl.jsp");
...
//设置显示列,yx_xqcxhdgl.jzsj,yx_xqcxhdgl.yjfy,yx_xqcxhdgl.yjcc,yx_xqcxhdgl.sjfy,yx_xqcxhdgl.sjcc, DECODE(yx_xqcxhdgl.spjl,'Y','同意','N','不同意'),yx_xqcxhdgl.spr,yx_xqcxhdgl.spsj,yx_xqcxhdgl.spyj,yx_xqcxhdgl.lrr,yx_xqcxhdgl.lrsj,dqmc,yx_lsdcb.kfs,yx_lsdcb.fyssj,yx_lsdcb.jw,yx_xqcxhdgl.bz  
	String[] disColName={"spzt","xqmc","xqhdmc","dwmc","yjfy","yjcc","sjfy","sjcc","scbfzr","scbfzrdh","scbzrs","scbsffz","gjjzgwrs","ryydl","kfql","fasfwc","kfxs","spjl","spr","spsj","spyj","lrr","lrsj","dqmc","kfs","fyssj","jw","bz"};
...
//设置按钮参数
	...
	String[] buttonLink={"deleteYx_xqcxhdgl.jsp?"};//按钮单击调用的网页，可以增加参数
...
else//非第一次进入此页，不需要初始化
{
	...
	if (pageObj.needDelete(chooseitem))//判断是否需要执行删除操作
	{
		...
		sql[0]="delete from yx_xqcxhdgl where "+chooseitem;
