...
<body bgcolor="#FFFFFF">
<form method="post" action="Jc_cxhdList.jsp" name="selectform">
<div align="center">促销活动管理－维护</div>
...
%></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="31%"> 
        <INPUT type="radio" name="jc_cxhd_jsbz" value="N" checked>
        未结束<INPUT type="radio" name="jc_cxhd_jsbz" value="Y" >
        结束 </td>
...
%> </td>
    ...
    <tr align="center"> 
      <td colspan="4"> 
        ...
        <input name="button" type="button" onClick="window.open('pljs.jsp')"  value="过期批量结束">
...
function f_do(FormName)//参数FormName:Form的名称
{
	...
	if(!(isFloat(FormName.jc_cxhd_gcfzk, "签单折扣"))) {
		return false;
	}
	if(!(isFloat(FormName.jc_cxhd_gczxzk, "增减项折扣"))) {
		return false;
	}
