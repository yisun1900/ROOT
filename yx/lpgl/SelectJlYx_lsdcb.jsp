...
<body bgcolor="#FFFFFF">
<form method="post" action="Yx_lsdcbJlList.jsp" name="selectform">
<div align="center">维护楼盘信息</div>
...
<tr bgcolor="#FFFFFF">
  ...
  <td width="32%"><input type="text" name="yx_lsdcb_lrr" size="20" maxlength="20" ></td>
