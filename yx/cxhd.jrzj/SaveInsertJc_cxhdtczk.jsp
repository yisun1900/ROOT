...
try {
	...
	ls_sql="delete from jc_cxhdtczk  ";
	ls_sql+=" where cxhdbm='"+cxhdbm+"'";
	ps= conn.prepareStatement(ls_sql);
	ps.executeUpdate();
	ps.close();

	ls_sql="insert into jc_cxhdtczk ( cxhdbm,bzjgzk,mjzjzk,zcsjzk,zcclzk,zcsfzk,zcjmzk,ddzccjzk,ddzcclzk,tcwgczk,tcgcclzk) ";
	ls_sql+=" values ( ?,?,?,?,?,?,?,?,?,?,?) ";
	ps= conn.prepareStatement(ls_sql);
	ps.setString(1,cxhdbm);
	ps.setDouble(2,bzjgzk);
	ps.setDouble(3,mjzjzk);
	ps.setDouble(4,zcsjzk);
	ps.setDouble(5,zcclzk);
	ps.setDouble(6,zcsfzk);
	ps.setDouble(7,zcjmzk);
	ps.setDouble(8,ddzccjzk);
	ps.setDouble(9,ddzcclzk);
	ps.setDouble(10,tcwgczk);
	ps.setDouble(11,tcgcclzk);
